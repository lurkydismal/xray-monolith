...
void CRenderTarget::accum_direct_cascade( u32 sub_phase,
    ...
    // //******************************************************************
    {
        ...
        u32 i_offset;
        {
            ...
            FVF::L* pv = ( FVF::L* )RCache.Vertex.Lock(
...
#define FOURCC_GET4 MAKEFOURCC( 'G', 'E', 'T', '4' )
        ...
        // setup stencil
        if ( SE_SUN_NEAR == sub_phase ||
             sub_phase == SE_SUN_MIDDLE /*|| SE_SUN_FAR==sub_phase*/ )
            RCache.set_Stencil( TRUE, D3DCMP_LESSEQUAL, dwLightMarkerID, 0xff,
                                0xFE, D3DSTENCILOP_KEEP, D3DSTENCILOP_ZERO,
                                D3DSTENCILOP_KEEP );
        else
            RCache.set_Stencil( TRUE, D3DCMP_LESSEQUAL, dwLightMarkerID, 0xff,
                                0x00 );
...
void CRenderTarget::accum_direct_volumetric( u32 sub_phase,
    ...
    if ( ( sub_phase != SE_SUN_NEAR ) && ( sub_phase != SE_SUN_MIDDLE ) &&
         ( sub_phase != SE_SUN_FAR ) )
        return;

    if ( !( RImplementation.o.advancedpp &&
            ( ps_sunshafts_mode == R2SS_VOLUMETRIC ||
    ...
    //	It's slow. Make this when shader is created
    {
        ...
        STextureList* _T =
            &*s_accum_direct_volumetric_cascade->E[ 0 ]->passes[ 0 ]->T;
