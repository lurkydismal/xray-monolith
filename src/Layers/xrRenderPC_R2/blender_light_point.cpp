...
void CBlender_accum_point::Compile( CBlender_Compile& C ) {
    ...
    switch ( C.iElement ) {
        ...
        case SE_L_UNSHADOWED: // unshadowed
            C.r_Pass( "accum_volume", "accum_omni_unshadowed", false, FALSE,
        ...
        case SE_L_NORMAL: // normal
            C.r_Pass( "accum_volume", "accum_omni_normal", false, FALSE, FALSE,
        ...
        case SE_L_TRANSLUENT: // shadowed + transluency
            C.r_Pass( "accum_volume", "accum_omni_transluent", false, FALSE,
                      FALSE, blend, D3DBLEND_ONE, dest );
            C.r_Sampler_rtf( "s_position", r2_RT_P );
            C.r_Sampler_rtf( "s_normal", r2_RT_N );
            C.r_Sampler_rtf( "s_diffuse", r2_RT_albedo );
