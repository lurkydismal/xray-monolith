...
void CRenderTarget::accum_spot_geom_create() {
    ...
    // vertices
    {
        ...
        u32 vSize = 3 * 4;
        R_CHK( HW.pDevice->CreateVertexBuffer( vCount * vSize, dwUsage, 0,
                                               D3DPOOL_MANAGED,
                                               &g_accum_spot_vb, 0 ) );
    ...
    // Indices
    {
        ...
        BYTE* pData = 0;
        R_CHK( HW.pDevice->CreateIndexBuffer( iCount * 2, dwUsage,
