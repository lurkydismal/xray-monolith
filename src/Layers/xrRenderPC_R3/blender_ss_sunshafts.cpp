...
void CBlender_sunshafts::Compile( CBlender_Compile& C ) {
    ...
    switch ( C.iElement ) {
        case 0: // generation of sunshafts mask
            C.r_Pass( "ssss_notransform", "ogse_sunshafts_mask", FALSE, FALSE,
                      FALSE );
            ...
            break;
        case 1: // first pass
            C.r_Pass( "ssss_notransform", "ogse_sunshafts_blur", FALSE, FALSE,
                      FALSE );
        ...
        case 3: // third pass
            ...
            break;
        case 4: // combine pass
            C.r_Pass( "ssss_notransform", "ogse_sunshafts_final", FALSE, FALSE,
                      FALSE );
            C.r_dx10Texture( "s_position", r2_RT_P );
            C.r_dx10Texture( "s_sun_shafts", r2_RT_sunshafts1 );
            C.r_dx10Texture( "s_image", r2_RT_generic0 );
