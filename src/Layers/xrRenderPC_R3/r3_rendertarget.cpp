...
CRenderTarget::CRenderTarget() {
    ...
    //	NORMAL
    {
        ...
        if ( RImplementation.o.mrtmixdepth ) {
            ...
            if ( RImplementation.o.fp16_blend ) {
                // NV40
                {
                    ...
                    rt_Accumulator.create( r2_RT_accum, w, h,
        ...
        if ( RImplementation.o.dx10_msaa )
            rt_Generic_temp.create( "$user$generic_temp", w, h, D3DFMT_A8R8G8B8,
                                    SampleCount );
        else
            rt_Generic_temp.create( "$user$generic_temp", w, h, D3DFMT_A8R8G8B8,
                                    1 );
        ...
        rt_blur_2.create( r2_RT_blur_2, u32( w / 2 ), u32( h / 2 ),
                          D3DFMT_A8R8G8B8 );
        rt_blur_2_zb.create( r2_RT_blur_2_zb, u32( w / 2 ), u32( h / 2 ),
                             D3DFMT_D24S8 );
        ...
        rt_blur_4.create( r2_RT_blur_4, u32( w / 4 ), u32( h / 4 ),
                          D3DFMT_A8R8G8B8 );
        rt_blur_4_zb.create( r2_RT_blur_4_zb, u32( w / 4 ), u32( h / 4 ),
                             D3DFMT_D24S8 );
        ...
        rt_blur_8.create( r2_RT_blur_8, u32( w / 8 ), u32( h / 8 ),
                          D3DFMT_A8R8G8B8 );
        rt_blur_8_zb.create( r2_RT_blur_8_zb, u32( w / 8 ), u32( h / 8 ),
                             D3DFMT_D24S8 );

        rt_pp_bloom.create( r2_RT_pp_bloom, w, h, D3DFMT_A8R8G8B8 );

        if ( RImplementation.o.dx10_msaa ) {
            rt_Generic_0_r.create( r2_RT_generic0_r, w, h, D3DFMT_A8R8G8B8,
                                   SampleCount );
            rt_Generic_1_r.create( r2_RT_generic1_r, w, h, D3DFMT_A8R8G8B8,
                                   SampleCount );
    ...
    // TONEMAP
    {
        ...
        for ( u32 it = 0; it < 2; it++ ) {
            ...
            HW.pDevice->ClearRenderTargetView( rt_LUM_pool[ it ]->pRT,
                                               ColorRGBA );
        }
    ...
    if ( RImplementation.o.ssao_blur_on ) {
        ...
        if ( RImplementation.o.dx10_msaa ) {
            int bound = RImplementation.o.dx10_msaa_opt
                            ? 1
    ...
    // Build textures
    {
        ...
        if ( 1 ) {
            ...
            //	Create noise mipped
            {
                ...
                HW.pDevice->CopySubresourceRegion( t_noise_surf_mipped, 0, 0, 0,
                                                   0, t_noise_surf[ 0 ], 0, 0 );

                D3DX10FilterTexture( t_noise_surf_mipped, 0,
                                     D3DX10_FILTER_POINT );
            }
        }
    }
...
bool CRenderTarget::use_minmax_sm_this_frame() {
    switch ( RImplementation.o.dx10_minmax_sm ) {
        ...
        case CRender::MMSM_AUTODETECT: {
            u32 dwScreenArea = HW.m_ChainDesc.BufferDesc.Width *
