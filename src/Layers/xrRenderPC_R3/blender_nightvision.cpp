...
void CBlender_nightvision::Compile( CBlender_Compile& C ) {
    IBlender::Compile( C );
    switch ( C.iElement ) {
        case 0: // Dummy shader - because IDK what gonna happen when
                // r2_nightvision will be 0
            ...
            break;
        case 1:
            C.r_Pass( "stub_screen_space", "nightvision_gen_1", FALSE, FALSE,
                      FALSE );
            ...
            break;
        case 2:
            C.r_Pass( "stub_screen_space", "nightvision_gen_2", FALSE, FALSE,
                      FALSE );
            C.r_dx10Texture( "s_position", r2_RT_P );
            C.r_dx10Texture( "s_image", r2_RT_generic0 );
            C.r_dx10Texture( "s_bloom_new", r2_RT_pp_bloom );
            ...
            break;
        case 3:
            C.r_Pass( "stub_screen_space", "nightvision_gen_3", FALSE, FALSE,
                      FALSE );
            C.r_dx10Texture( "s_position", r2_RT_P );
            C.r_dx10Texture( "s_image", r2_RT_generic0 );
            C.r_dx10Texture( "s_bloom_new", r2_RT_pp_bloom );
