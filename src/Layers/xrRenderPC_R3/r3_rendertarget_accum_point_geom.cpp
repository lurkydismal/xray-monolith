...
void CRenderTarget::accum_point_geom_create() {
    ...
    // vertices
    {
        ...
        //(pData,du_sphere_vertices,vCount*vSize); 		g_accum_point_vb->Unlock
        //();

        R_CHK( dx10BufferUtils::CreateVertexBuffer(
            &g_accum_point_vb, du_sphere_vertices, vCount * vSize ) );
    ...
    // Indices
    {
        ...
        // R_CHK
        // (g_accum_point_ib->Lock(0,0,(void**)&pData,0)); CopyMemory
        // (pData,du_sphere_faces,iCount*2); g_accum_point_ib->Unlock	();

        R_CHK( dx10BufferUtils::CreateIndexBuffer(
            &g_accum_point_ib, du_sphere_faces, iCount * 2 ) );
