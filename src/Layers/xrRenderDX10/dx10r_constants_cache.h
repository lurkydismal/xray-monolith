...
public:
    ...
    // ICF void				set		(R_constant* C, const
    // Fmatrix& A)		{ 	if (C->destination&RC_dest_pixel)	{ set
    //(C,C->ps,A, BT_PixelBuffer); }	// a_pixel.b_dirty=TRUE; } 	if
    //(C->destination&RC_dest_vertex)	{ set	(C,C->vs,A, BT_VertexBuffer); }
    ////  a_vertex.b_dirty=TRUE;		} 	if
    //(C->destination&RC_dest_geometry){ set	(C,C->gs,A, BT_GeometryBuffer);
    //}	//  a_vertex.b_dirty=TRUE;		} 	if
    //(C->destination&RC_dest_hull)	{ set	(C,C->hs,A, BT_HullBuffer); }
    ////  a_vertex.b_dirty=TRUE;		} 	if
    //(C->destination&RC_dest_domain)	{ set	(C,C->ds,A, BT_DomainBuffer); }
    ////  a_vertex.b_dirty=TRUE;		}
    // }
    // ICF void				set		(R_constant* C, const
    // Fvector4& A)		{ 	if (C->destination&RC_dest_pixel)	{ set
    //(C,C->ps,A, BT_PixelBuffer); }	//  a_pixel.b_dirty=TRUE; } 	if
    //(C->destination&RC_dest_vertex)	{ set	(C,C->vs,A, BT_VertexBuffer); }
    ////  a_vertex.b_dirty=TRUE;		} 	if
    //(C->destination&RC_dest_geometry){ set	(C,C->gs,A, BT_GeometryBuffer);
    ...
    //BT_PixelBuffer); }	//  a_pixel.b_dirty=TRUE;		} 	if
    //(C->destination&RC_dest_vertex)	{ set	(C,C->vs,A, BT_VertexBuffer); }
    ////  a_vertex.b_dirty=TRUE;		} 	if
    //(C->destination&RC_dest_geometry){ set	(C,C->gs,A, BT_GeometryBuffer);
    //}	//  a_vertex.b_dirty=TRUE;		} 	if
    ...
    // fp, array versions
    // ICF void				seta	(R_constant* C, u32 e, const
    // Fmatrix& A)		{ 	if (C->destination&RC_dest_pixel)	{ seta
    //(C,C->ps,e,A, BT_PixelBuffer); }	//  a_pixel.b_dirty=TRUE;	} 	if
    //(C->destination&RC_dest_vertex)	{ seta	(C,C->vs,e,A, BT_VertexBuffer);
    //}	//  a_vertex.b_dirty=TRUE;	} 	if (C->destination&RC_dest_geometry){
    //seta	(C,C->gs,e,A, BT_GeometryBuffer); }	//
    //a_vertex.b_dirty=TRUE;	}
    //}
    // ICF void				seta	(R_constant* C, u32 e, const
    // Fvector4& A)		{ 	if (C->destination&RC_dest_pixel)	{ seta
    //(C,C->ps,e,A, BT_PixelBuffer); }	//  a_pixel.b_dirty=TRUE;	} 	if
    //(C->destination&RC_dest_vertex)	{ seta	(C,C->vs,e,A, BT_VertexBuffer);
    //}	//  a_vertex.b_dirty=TRUE;	} 	if (C->destination&RC_dest_geometry){
    //seta	(C,C->gs,e,A, BT_GeometryBuffer); }	//
    ...
    ICF void access_direct( R_constant* C,
                            u32 DataSize,
                            void** ppVData,
                            void** ppGData,
                            void** ppPData ) {
...
private:
    ...
    void access_direct( R_constant* C,
                        R_constant_load& L,
                        void** ppData,
                        u32 DataSize,
                        BufferType BType ) {
