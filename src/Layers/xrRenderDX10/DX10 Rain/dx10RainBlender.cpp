...
void CBlender_rain::Compile( CBlender_Compile& C ) {
    ...
    switch ( C.iElement ) {
        case 0: // Test
            // C.r_Pass	("stub_notransform_2uv", "rain_layer", false,	TRUE,
            // FALSE, TRUE, D3DBLEND_ONE, D3DBLEND_ONE); C.r_Pass
            // ("stub_notransform_2uv", "rain_layer", false,	TRUE,	FALSE,
            // TRUE, D3DBLEND_SRCALPHA, D3DBLEND_INVSRCALPHA);
            C.r_Pass( "stub_notransform_2uv", "rain_layer", false, TRUE, FALSE,
                      FALSE );
        ...
        case 1: // Patch normals
            ...
            // ("stub_notransform_2uv", "rain_layer", false,	TRUE,	FALSE,
            // TRUE, D3DBLEND_SRCALPHA, D3DBLEND_INVSRCALPHA);
            C.r_Pass( "stub_notransform_2uv", "rain_patch_normal_nomsaa", false,
                      TRUE, FALSE, FALSE );
            C.PassSET_ZB( TRUE, FALSE, TRUE ); // force inverted Z-Buffer
        ...
        case 2: // Apply normals
            ...
            // ("stub_notransform_2uv", "rain_layer", false,	TRUE,	FALSE,
            // TRUE, D3DBLEND_SRCALPHA, D3DBLEND_INVSRCALPHA);
            C.r_Pass( "stub_notransform_2uv", "rain_apply_normal_nomsaa", false,
                      TRUE, FALSE, FALSE );
            C.PassSET_ZB( TRUE, FALSE, TRUE ); // force inverted Z-Buffer
        ...
        case 3: // Apply gloss
            ...
            // ("stub_notransform_2uv", "rain_layer", false,	TRUE,	FALSE,
            // TRUE, D3DBLEND_SRCALPHA, D3DBLEND_INVSRCALPHA);
            C.r_Pass( "stub_notransform_2uv", "rain_apply_gloss_nomsaa", false,
                      TRUE, FALSE, TRUE, D3DBLEND_ONE, D3DBLEND_ONE );
            C.PassSET_ZB( TRUE, FALSE, TRUE ); // force inverted Z-Buffer
...
void CBlender_rain_msaa::Compile( CBlender_Compile& C ) {
    ...
    switch ( C.iElement ) {
        case 0: // Patch normals
            ...
            // ("stub_notransform_2uv", "rain_layer", false,	TRUE,	FALSE,
            // TRUE, D3DBLEND_SRCALPHA, D3DBLEND_INVSRCALPHA);
            C.r_Pass( "stub_notransform_2uv", "rain_patch_normal_msaa", false,
                      TRUE, FALSE, FALSE );
            C.PassSET_ZB( TRUE, FALSE, TRUE ); // force inverted Z-Buffer
        ...
        case 1: // Apply normals
            ...
            // ("stub_notransform_2uv", "rain_layer", false,	TRUE,	FALSE,
            // TRUE, D3DBLEND_SRCALPHA, D3DBLEND_INVSRCALPHA);
            C.r_Pass( "stub_notransform_2uv", "rain_apply_normal_msaa", false,
                      TRUE, FALSE, FALSE );
            C.PassSET_ZB( TRUE, FALSE, TRUE ); // force inverted Z-Buffer
        ...
        case 2: // Apply gloss
            ...
            // ("stub_notransform_2uv", "rain_layer", false,	TRUE,	FALSE,
            // TRUE, D3DBLEND_SRCALPHA, D3DBLEND_INVSRCALPHA);
            C.r_Pass( "stub_notransform_2uv", "rain_apply_gloss_msaa", false,
                      TRUE, FALSE, TRUE, D3DBLEND_ONE, D3DBLEND_ONE );
            C.PassSET_ZB( TRUE, FALSE, TRUE ); // force inverted Z-Buffer
