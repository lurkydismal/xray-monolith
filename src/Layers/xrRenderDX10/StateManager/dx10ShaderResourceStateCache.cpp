...
void dx10ShaderResourceStateCache::Apply() {
    if ( m_bUpdatePSViews ) {
        HW.pContext->PSSetShaderResources( m_uiMinPSView,
                                           m_uiMaxPSView - m_uiMinPSView + 1,
                                           &m_PSViews[ m_uiMinPSView ] );
        m_uiMinPSView = 0xFFFFFFFF;
        m_uiMaxPSView = 0xFFFFFFFF;
        m_bUpdatePSViews = false;
    }
    ...
    if ( m_bUpdateGSViews ) {
        HW.pContext->GSSetShaderResources( m_uiMinGSView,
                                           m_uiMaxGSView - m_uiMinGSView + 1,
                                           &m_GSViews[ m_uiMinGSView ] );
        m_uiMinGSView = 0xFFFFFFFF;
        m_uiMaxGSView = 0xFFFFFFFF;
        m_bUpdateGSViews = false;
    }
    ...
    if ( m_bUpdateVSViews ) {
        HW.pContext->VSSetShaderResources( m_uiMinVSView,
                                           m_uiMaxVSView - m_uiMinVSView + 1,
                                           &m_VSViews[ m_uiMinVSView ] );
        m_uiMinVSView = 0xFFFFFFFF;
        m_uiMaxVSView = 0xFFFFFFFF;
        m_bUpdateVSViews = false;
    }
...
#ifdef USE_DX11
    if ( m_bUpdateHSViews ) {
        HW.pContext->HSSetShaderResources( m_uiMinHSView,
                                           m_uiMaxHSView - m_uiMinHSView + 1,
                                           &m_HSViews[ m_uiMinHSView ] );
        m_uiMinHSView = 0xFFFFFFFF;
        m_uiMaxHSView = 0xFFFFFFFF;
        m_bUpdateHSViews = false;
    }
    ...
    if ( m_bUpdateDSViews ) {
        HW.pContext->DSSetShaderResources( m_uiMinDSView,
                                           m_uiMaxDSView - m_uiMinDSView + 1,
                                           &m_DSViews[ m_uiMinDSView ] );
        m_uiMinDSView = 0xFFFFFFFF;
        m_uiMaxDSView = 0xFFFFFFFF;
        m_bUpdateDSViews = false;
    }
    ...
    if ( m_bUpdateCSViews ) {
        HW.pContext->CSSetShaderResources( m_uiMinCSView,
                                           m_uiMaxCSView - m_uiMinCSView + 1,
                                           &m_CSViews[ m_uiMinCSView ] );
...
void dx10ShaderResourceStateCache::SetPSResource(
    u32 uiSlot,
...
void dx10ShaderResourceStateCache::SetGSResource(
    u32 uiSlot,
    ID3DShaderResourceView* pRes ) {
...
void dx10ShaderResourceStateCache::SetVSResource(
    u32 uiSlot,
    ID3DShaderResourceView* pRes ) {
...
#ifdef USE_DX11
void dx10ShaderResourceStateCache::SetHSResource(
    u32 uiSlot,
    ID3DShaderResourceView* pRes ) {
...
void dx10ShaderResourceStateCache::SetDSResource(
    u32 uiSlot,
    ID3DShaderResourceView* pRes ) {
    VERIFY( uiSlot < CBackend::mtMaxHullShaderTextures );
...
void dx10ShaderResourceStateCache::SetCSResource(
    u32 uiSlot,
    ID3DShaderResourceView* pRes ) {
