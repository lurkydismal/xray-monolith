...
void dx10StateManager::Apply() {
    ...
    if ( m_bDSSNeedApply || m_bDSSChanged ) {
        ...
        HW.pContext->OMSetDepthStencilState( m_pDepthStencilState,
                                             m_uiStencilRef );
    ...
    if ( m_bBSNeedApply || m_bBSChanged ) {
        ...
        static const FLOAT BlendFactor[ 4 ] = { 0.000f, 0.000f, 0.000f,
                                                0.000f };

        HW.pContext->OMSetBlendState( m_pBlendState, BlendFactor,
                                      m_uiSampleMask );
        m_bBSNeedApply = false;
    }
}

void dx10StateManager::SetStencil( u32 Enable,
                                   u32 Func,
                                   u32 Ref,
                                   u32 Mask,
                                   u32 WriteMask,
    ...
    // if (stencil_func		!= _func)		{ stencil_func=_func;
    ...
    // if (stencil_mask		!= _mask)		{ stencil_mask=_mask;
    ...
    // if (stencil_writemask	!= _writemask)	{ stencil_writemask=_writemask;
    ...
    // if (stencil_fail		!= _fail)		{ stencil_fail=_fail;
    ...
    // if (stencil_pass		!= _pass)		{ stencil_pass=_pass;
...
void dx10StateManager::SetFillMode( u32 Mode ) {
    ...
    D3D_FILL_MODE CMode =
        dx10StateUtils::ConvertFillMode( ( D3DFILLMODE )Mode );
