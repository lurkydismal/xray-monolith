...
template <>
void dx10StateCache< ID3DRasterizerState,
                     D3D_RASTERIZER_DESC >::ClearStateArray() {
...
template <>
void dx10StateCache< ID3DDepthStencilState,
                     D3D_DEPTH_STENCIL_DESC >::ClearStateArray() {
    for ( u32 i = 0; i < m_StateArray.size(); ++i ) {
        _RELEASE( m_StateArray[ i ].m_pState );
    }
...
template <>
void dx10StateCache< ID3DDepthStencilState, D3D_DEPTH_STENCIL_DESC >::
    CreateState( D3D_DEPTH_STENCIL_DESC desc,
