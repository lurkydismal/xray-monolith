...
void CHudInitializer::SetHudMode() {
    ...
    Device.m_pRender->SetCacheXform_prev( Device.mViewHud_prev,
                                          Device.mProjectHud_prev );
}
...
void CHudInitializer::SetCamMode() {
    ...
    Device.m_pRender->SetCacheXform( Device.mView, Device.mProject );
    Device.m_pRender->SetCacheXform_prev( Device.mViewCam_prev,
                                          Device.mProjectCam_prev );
}
...
void CHudInitializer::SetDefaultMode() {
    ...
    Device.m_pRender->SetCacheXform( Device.mView, Device.mProject );
    Device.m_pRender->SetCacheXform_prev( Device.mView_prev,
                                          Device.mProject_prev );
}
