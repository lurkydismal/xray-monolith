...
struct PFloat {
    ...
    PFloat( float _val, float _mn, float _mx )
        : val( _val ), mn( _mn ), mx( _mx ) {}
...
struct PVector {
    ...
    PVector( EType t, Fvector _val, float _mn, float _mx )
...
struct EParticleAction {
    ...
    struct SOrder {
        ...
        SOrder( EValType _type, AnsiString _name )
