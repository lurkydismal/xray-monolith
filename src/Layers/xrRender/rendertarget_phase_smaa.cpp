...
void CRenderTarget::phase_smaa() {
    ...
    RCache.set_Stencil( TRUE, D3DCMP_ALWAYS, 0x1, 0, 0, D3DSTENCILOP_KEEP,
    ...
    RCache.set_CullMode( CULL_NONE );
    RCache.set_Stencil( TRUE, D3DCMP_EQUAL, 0x1, 0, 0, D3DSTENCILOP_KEEP,
                        D3DSTENCILOP_REPLACE, D3DSTENCILOP_KEEP );
#if defined( USE_DX10 ) || defined( USE_DX11 )
...
void CRenderTarget::phase_ssfx_taa() {
    ...
    HW.pContext->CopyResource( rt_ssfx_taa->pTexture->surface_get(),
    ...
    // Accumulate
    HW.pContext->CopyResource( rt_ssfx_prev_frame->pTexture->surface_get(),
                               dest_rt->pTexture->surface_get() );
