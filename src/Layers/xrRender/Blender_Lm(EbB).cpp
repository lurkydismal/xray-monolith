    ...
    if ( C.bEditor ) {
        ...
        switch ( C.iElement ) {
            ...
            case SE_R1_NORMAL_LQ:
                ...
                ("lmapE_dt","lmapE_dt",TRUE); C.r_Sampler	("s_base",
                C.L_textures[0]); C.r_Sampler	("s_lmap",
                C.L_textures[1]); C.r_Sampler	("s_env",
                oT2_Name,false,D3DTADDRESS_CLAMP); C.r_Sampler
                ("s_detail",C.detail_texture); C.r_End		(); } else
                {
                */
                if ( oBlend.value )
                    C.r_Pass( "lmapE", "lmapE", TRUE, TRUE, FALSE, TRUE,
                ...
                break;
            case SE_R1_LPOINT:
                C.r_Pass( "lmap_point", "add_point", FALSE, TRUE, FALSE, TRUE,
                ...
                break;
            case SE_R1_LSPOT:
                C.r_Pass( "lmap_spot", "add_spot", FALSE, TRUE, FALSE, TRUE,
                          D3DBLEND_ONE, D3DBLEND_ONE, TRUE );
                C.r_Sampler( "s_base", C.L_textures[ 0 ] );
...
void CBlender_LmEbB::Compile( CBlender_Compile& C ) {
    if ( oBlend.value )
        C.r_Pass( "lmapE", "lmapE", TRUE, TRUE, FALSE, TRUE, D3DBLEND_SRCALPHA,
