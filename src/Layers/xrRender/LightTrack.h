...
#if !defined( \
    AFX_LIGHTTRACK_H__89914D61_AC0B_4C7C_BA8C_D7D810738CE7__INCLUDED_ )
...
public:
    ...
    virtual float get_luminocity() {
        float result =
            _max( approximate.x, _max( approximate.y, approximate.z ) );
...
private:
    ...
    static inline void accum_hemi( float* hemi_cube,
                                   Fvector3& dir,
                                   float scale );
