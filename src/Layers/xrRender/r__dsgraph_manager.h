...
public:
    ...
    FixedMAP< CSector*,
              std::pair< xr_vector< CFrustum >, FixedSet< CPortal* > > >
        m_sector_frustums;
    ...
    CDSGraphManager( u32 options, u32 doptions, bool ( &&mask )[ 7 ] )
    ...
    virtual void add_Static( IRenderVisual* pVisual,
                             CFrustum& frustum,
                             u32 planes );
    virtual void add_Static_MultiFrustum( IRenderVisual* pVisual,
    ...
    void add_leafs_Dynamic( xr_vector< dxRender_Visual* >& children,
                            Fmatrix* xform );
    void add_leafs_Dynamic( xr_vector< IRenderVisual* >& children,
                            Fmatrix* xform );
    void r_dsgraph_insert_dynamic( dxRender_Visual* pVisual, Fmatrix* xform );

    void AddToRenderQueue( R_dsgraph::RenderQueue& queue,
                           const R_dsgraph::DSGraphItem< u32, false >& item,
                           const SPass& pass );
    void r_dsgraph_render_graph( R_dsgraph::RenderQueueArray& queue,
                                 u32 _priority,
                                 bool _clear = true,
    ...
    void r_dsgraph_render_graph_sorted(
    ...
    void r_dsgraph_capture( bool lights = false,
                            bool dynamic = false,
                            CObject* O = nullptr );
