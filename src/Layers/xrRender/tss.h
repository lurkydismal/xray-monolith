...
public:
    ...
    IC void SetColor( SimulatorStates& container,
                      u32 S,
                      u32 A1,
                      u32 OP,
                      u32 A2 ) {
    ...
    IC void SetColor3( SimulatorStates& container,
                       u32 S,
                       u32 A1,
                       u32 OP,
                       u32 A2,
    ...
    IC void SetAlpha( SimulatorStates& container,
                      u32 S,
                      u32 A1,
                      u32 OP,
                      u32 A2 ) {
    ...
    IC void SetAlpha3( SimulatorStates& container,
                       u32 S,
                       u32 A1,
                       u32 OP,
                       u32 A2,
