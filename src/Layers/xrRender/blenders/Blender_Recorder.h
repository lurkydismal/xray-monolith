...
#if !defined( \
    AFX_BLENDER_RECORDER_H__1F549674_8674_4EB2_95E6_E6BC19218A6C__INCLUDED_ )
...
public:
    ...
    ShaderElement* SH;
#ifdef USE_DX11
    enum { NO_TESS = 0, TESS_PN = 1, TESS_HM = 2, TESS_PN_HM = 3 };
...
public:
    ...
    void PassSET_Blend( BOOL bABlend,
                        u32 abSRC,
                        u32 abDST,
                        BOOL aTest,
                        u32 aRef );
    ...
    void PassSET_Blend_BLEND( BOOL bAref = FALSE, u32 ref = 0 ) {
        PassSET_Blend( TRUE, D3DBLEND_SRCALPHA, D3DBLEND_INVSRCALPHA, bAref,
                       ref );
    }
    ...
    void PassSET_Blend_MUL2X( BOOL bAref = FALSE, u32 ref = 0 ) {
        PassSET_Blend( TRUE, D3DBLEND_DESTCOLOR, D3DBLEND_SRCCOLOR, bAref,
                       ref );
    }
    ...
    void Stage_Texture( LPCSTR name,
                        ...
                        u32 fmin = D3DTEXF_LINEAR,
                        u32 fmip = D3DTEXF_LINEAR,
                        u32 fmag = D3DTEXF_LINEAR );
...
#endif
    void r_Stencil( BOOL Enable,
                    u32 Func = D3DCMP_ALWAYS,
                    u32 Mask = 0x00,
                    u32 WriteMask = 0x00,
                    u32 Fail = D3DSTENCILOP_KEEP,
                    u32 Pass = D3DSTENCILOP_KEEP,
    ...
    u32 r_Sampler( LPCSTR name,
                   LPCSTR texture,
                   bool b_ps1x_ProjectiveDivide = false,
                   u32 address = D3DTADDRESS_WRAP,
                   u32 fmin = D3DTEXF_LINEAR,
                   u32 fmip = D3DTEXF_LINEAR,
                   u32 fmag = D3DTEXF_LINEAR );
    ...
    u32 r_Sampler( LPCSTR name,
                   ...
                   u32 fmip = D3DTEXF_LINEAR,
                   u32 fmag = D3DTEXF_LINEAR ) {
        return r_Sampler( name, texture.c_str(), b_ps1x_ProjectiveDivide,
                          address, fmin, fmip, fmag );
    }

    void r_Sampler_rtf( LPCSTR name,
                        LPCSTR texture,
                        bool b_ps1x_ProjectiveDivide = false );
    void r_Sampler_clf( LPCSTR name,
                        LPCSTR texture,
                        bool b_ps1x_ProjectiveDivide = false );
    void r_Sampler_clw( LPCSTR name,
                        LPCSTR texture,
                        bool b_ps1x_ProjectiveDivide = false );
#endif //	USE_DX10
    void r_ColorWriteEnable( bool cR = true,
                             bool cG = true,
                             bool cB = true,
                             bool cA = true );
    void r_End();
