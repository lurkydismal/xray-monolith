...
void CBlender_Screen_SET::Compile( CBlender_Compile& C ) {
    IBlender::Compile( C );
    // C.r_Pass			("stub_notransform_t", "Blender_Screen_SET",
    // false);
    ...
    if ( oBlend.IDselected == 6 ) {
        ...
        if ( 9 == oBlend.IDselected ) {
            ...
            // C.StageSET_Color	(D3DTA_TEXTURE,	  D3DTOP_MODULATE4X,
            // D3DTA_DIFFUSE); C.StageSET_Alpha	(D3DTA_TEXTURE,
            ...
            if ( ( 7 == oBlend.IDselected ) || ( 8 == oBlend.IDselected ) ) {
                ...
                // C.StageSET_Color	(D3DTA_TEXTURE,	  D3DTOP_MODULATE2X,
                // D3DTA_DIFFUSE); C.StageSET_Alpha	(D3DTA_TEXTURE,
                // D3DTOP_SELECTARG1,	D3DTA_DIFFUSE);
            } else {
                // 1x R
                C.r_Pass( "stub_notransform_t", "stub_default", false );
                // C.StageSET_Color	(D3DTA_TEXTURE,	  D3DTOP_MODULATE,
                // D3DTA_DIFFUSE); C.StageSET_Alpha	(D3DTA_TEXTURE,
    ...
    switch ( oBlend.IDselected ) {
        ...
        case 1: // BLEND
            ...
            break;
        case 2: // ADD
            C.PassSET_Blend( TRUE, D3DBLEND_ONE, D3DBLEND_ONE, FALSE,
                             oAREF.value );
            break;
        case 3: // MUL
            C.PassSET_Blend( TRUE, D3DBLEND_DESTCOLOR, D3DBLEND_ZERO, FALSE,
                             oAREF.value );
            break;
        case 4: // MUL_2X
            C.PassSET_Blend( TRUE, D3DBLEND_DESTCOLOR, D3DBLEND_SRCCOLOR, FALSE,
                             oAREF.value );
            break;
        case 5: // ALPHA-ADD
            C.PassSET_Blend( TRUE, D3DBLEND_SRCALPHA, D3DBLEND_ONE, TRUE,
                             oAREF.value );
            break;
...
void CBlender_Screen_SET::Compile( CBlender_Compile& C ) {
    ...
    C.PassBegin();
    {
        ...
        if ( oBlend.IDselected == 6 ) {
            // Usually for wallmarks
            C.StageBegin();
            C.StageSET_Address( oClamp.value ? D3DTADDRESS_CLAMP
                                             : D3DTADDRESS_WRAP );
            ...
            C.StageSET_Address( oClamp.value ? D3DTADDRESS_CLAMP
                                             : D3DTADDRESS_WRAP );
            C.StageSET_Color( D3DTA_DIFFUSE, D3DTOP_BLENDDIFFUSEALPHA,
                              D3DTA_CURRENT );
            ...
            if ( 9 == oBlend.IDselected ) {
                ...
                C.StageSET_Color( D3DTA_TEXTURE, D3DTOP_MODULATE4X,
                                  D3DTA_DIFFUSE );
                C.StageSET_Alpha( D3DTA_TEXTURE, D3DTOP_SELECTARG1,
                                  D3DTA_DIFFUSE );
            } else {
                if ( ( 7 == oBlend.IDselected ) ||
                     ( 8 == oBlend.IDselected ) ) {
                    // 2x R
                    C.StageSET_Color( D3DTA_TEXTURE, D3DTOP_MODULATE2X,
                                      D3DTA_DIFFUSE );
                    ...
                    C.StageSET_Color( D3DTA_TEXTURE, D3DTOP_MODULATE,
                                      D3DTA_DIFFUSE );
                    C.StageSET_Alpha( D3DTA_TEXTURE, D3DTOP_MODULATE,
                                      D3DTA_DIFFUSE );
                }
            }
            C.Stage_Texture( oT_Name );
