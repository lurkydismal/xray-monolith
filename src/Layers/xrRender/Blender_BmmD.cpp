    ...
    if ( C.bEditor ) {
        ...
        switch ( C.iElement ) {
            ...
            case SE_R1_NORMAL_LQ:
                ...
                break;
            case SE_R1_LPOINT:
                C.r_Pass( "impl_point", "add_point", FALSE, TRUE, FALSE, TRUE,
                          D3DBLEND_ONE, D3DBLEND_ONE, TRUE );
                C.r_Sampler( "s_base", C.L_textures[ 0 ] );
                ...
                break;
            case SE_R1_LSPOT:
                C.r_Pass( "impl_spot", "add_spot", FALSE, TRUE, FALSE, TRUE,
                          D3DBLEND_ONE, D3DBLEND_ONE, TRUE );
                C.r_Sampler( "s_base", C.L_textures[ 0 ] );
...
void CBlender_BmmD::Compile( CBlender_Compile& C ) {
    ...
    switch ( C.iElement ) {
        case SE_R2_NORMAL_HQ: // deffer
            ...
            uber_deffer( C, true, "impl", "impl", false,
            ...
            C.r_Sampler( "s_dt_r", oR_Name, false, D3DTADDRESS_WRAP,
                         D3DTEXF_ANISOTROPIC, D3DTEXF_LINEAR,
                         D3DTEXF_ANISOTROPIC );
            C.r_Sampler( "s_dt_g", oG_Name, false, D3DTADDRESS_WRAP,
                         D3DTEXF_ANISOTROPIC, D3DTEXF_LINEAR,
                         D3DTEXF_ANISOTROPIC );
            C.r_Sampler( "s_dt_b", oB_Name, false, D3DTADDRESS_WRAP,
                         D3DTEXF_ANISOTROPIC, D3DTEXF_LINEAR,
                         D3DTEXF_ANISOTROPIC );
            C.r_Sampler( "s_dt_a", oA_Name, false, D3DTADDRESS_WRAP,
                         D3DTEXF_ANISOTROPIC, D3DTEXF_LINEAR,
                         D3DTEXF_ANISOTROPIC );

            C.r_Sampler( "s_dn_r",
                         strconcat( sizeof( mask ), mask, oR_Name, "_bump" ) );
            C.r_Sampler( "s_dn_g",
                         strconcat( sizeof( mask ), mask, oG_Name, "_bump" ) );
            C.r_Sampler( "s_dn_b",
                         strconcat( sizeof( mask ), mask, oB_Name, "_bump" ) );
            C.r_Sampler( "s_dn_a",
                         strconcat( sizeof( mask ), mask, oA_Name, "_bump" ) );
        ...
        case SE_R2_NORMAL_LQ: // deffer
            ...
            uber_deffer( C, false, "base", "impl", false,
                         oT2_Name[ 0 ] ? oT2_Name : 0, true, z_prepass );
            if ( z_prepass )
                C.RS.SetRS( D3DRS_ZFUNC, D3DCMP_EQUAL );
            C.r_Sampler( "s_lmap", C.L_textures[ 1 ] );
        ...
        case SE_R2_SHADOW: // smap
            if ( RImplementation.o.HW_smap )
                C.r_Pass( "shadow_direct_base", "dumb", FALSE, TRUE, TRUE,
                          FALSE );
            else
                C.r_Pass( "shadow_direct_base", "shadow_direct_base", FALSE );
            C.r_Sampler( "s_base", C.L_textures[ 0 ] );
    ...
    switch ( C.iElement ) {
        case SE_R2_NORMAL_HQ: // deffer
            ...
            if ( RImplementation.o.ssfx_terrain ) {
                ...
                uber_deffer( C, true, "terrain", "terrain_high", false,
                             oT2_Name[ 0 ] ? oT2_Name : 0, true, z_prepass );
            } else
#endif
            {
            ...
            // C.r_Sampler		("s_dt_r",	oR_Name,	false,
            // D3DTADDRESS_WRAP,	D3DTEXF_ANISOTROPIC,D3DTEXF_LINEAR,
            // D3DTEXF_ANISOTROPIC); C.r_Sampler		("s_dt_g",
            // oG_Name,	false,	D3DTADDRESS_WRAP,
            // D3DTEXF_ANISOTROPIC,D3DTEXF_LINEAR,	D3DTEXF_ANISOTROPIC);
            // C.r_Sampler		("s_dt_b",	oB_Name,	false,
            // D3DTADDRESS_WRAP,	D3DTEXF_ANISOTROPIC,D3DTEXF_LINEAR,
            // D3DTEXF_ANISOTROPIC); C.r_Sampler		("s_dt_a",
            // oA_Name,	false,	D3DTADDRESS_WRAP,
            // D3DTEXF_ANISOTROPIC,D3DTEXF_LINEAR,	D3DTEXF_ANISOTROPIC);

            // C.r_Sampler		("s_dn_r",
            // strconcat(sizeof(mask),mask,oR_Name,"_bump")	); C.r_Sampler
            // ("s_dn_g",	strconcat(sizeof(mask),mask,oG_Name,"_bump") );
            // C.r_Sampler		("s_dn_b",
            // strconcat(sizeof(mask),mask,oB_Name,"_bump") ); C.r_Sampler
            // ("s_dn_a",	strconcat(sizeof(mask),mask,oA_Name,"_bump") );
            ...
            C.r_dx10Texture(
                "s_dn_r", strconcat( sizeof( mask ), mask, oR_Name, "_bump" ) );
            C.r_dx10Texture(
                "s_dn_g", strconcat( sizeof( mask ), mask, oG_Name, "_bump" ) );
            C.r_dx10Texture(
                "s_dn_b", strconcat( sizeof( mask ), mask, oB_Name, "_bump" ) );
            C.r_dx10Texture(
                "s_dn_a", strconcat( sizeof( mask ), mask, oA_Name, "_bump" ) );
            ...
            if ( RImplementation.o.ssfx_terrain ) {
                C.r_dx10Texture(
                    "s_height_r",
                    strconcat( sizeof( mask ), mask, oR_Name, "_height" ) );
                C.r_dx10Texture(
                    "s_height_g",
                    strconcat( sizeof( mask ), mask, oG_Name, "_height" ) );
                C.r_dx10Texture(
                    "s_height_b",
                    strconcat( sizeof( mask ), mask, oB_Name, "_height" ) );
                C.r_dx10Texture(
                    "s_height_a",
                    strconcat( sizeof( mask ), mask, oA_Name, "_height" ) );
            }
#endif
            ...
            C.r_dx10Texture(
                "s_puddles_mask",
                strconcat( sizeof( mask ), mask, C.L_textures[ 0 ].c_str(),
                           "_puddles_mask" ) );
        ...
        case SE_R2_NORMAL_LQ: // deffer
            ...
            if ( RImplementation.o.ssfx_terrain ) {
                C.SH->flags.isLandscape = TRUE;
                uber_deffer( C, false, "base", "terrain_mid", false,
                             oT2_Name[ 0 ] ? oT2_Name : 0, true, z_prepass );
            } else
#endif
            {
            ...
            if ( RImplementation.o.ssfx_terrain ) {
                ...
                if ( FS.exist( fn, "$game_textures$", LodTexture, ".dds" ) ) {
                    ...
                    C.r_dx10Texture( "s_lod_texture",
                                     "terrain\\default_lod_textures" );
                }
            }
#endif
        ...
        case 3: // SSFX Low quality terrain
            ...
            uber_deffer( C, false, "base", "terrain_low", false,
                         oT2_Name[ 0 ] ? oT2_Name : 0, true, z_prepass );
            if ( z_prepass )
                C.RS.SetRS( D3DRS_ZFUNC, D3DCMP_EQUAL );
...
// ("shadow_direct_base","dumb",	FALSE,TRUE,TRUE,FALSE); else
// C.r_Pass	("shadow_direct_base","shadow_direct_base",FALSE);
#if RENDER == R_R4
            if ( RImplementation.o.ssfx_terrain ) {
                C.r_Pass( "shadow_direct_terrain", "dumb", FALSE, TRUE, TRUE,
                          FALSE );
            } else
#endif
            {
