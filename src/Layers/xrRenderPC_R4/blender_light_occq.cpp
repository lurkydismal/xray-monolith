    ...
    switch ( C.iElement ) {
        ...
        case 2: // Stencil clear in case we've ran out of markers.
            ...
            if ( RImplementation.o.dx10_msaa )
                C.r_Stencil( TRUE, D3DCMP_ALWAYS, 0x00, 0x7E, D3DSTENCILOP_ZERO,
                             D3DSTENCILOP_ZERO, D3DSTENCILOP_ZERO );
            else {
                //	Clear all bits except the last one
                C.r_Stencil( TRUE, D3DCMP_ALWAYS, 0x00, 0xFE, D3DSTENCILOP_ZERO,
                             D3DSTENCILOP_ZERO, D3DSTENCILOP_ZERO );
            }
            // C.r_Stencil
            // (TRUE,D3DCMP_ALWAYS,0x00,0xFF, D3DSTENCILOP_ZERO,
            // D3DSTENCILOP_ZERO, D3DSTENCILOP_ZERO);	// keep/keep/keep
            C.r_End();
            break;
    }
}
