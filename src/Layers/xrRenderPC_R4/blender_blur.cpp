...
void CBlender_ssfx_ssr::Compile( CBlender_Compile& C ) {
    ...
    switch ( C.iElement ) {
        ...
        case 1: // Blur Phase 1
            C.r_Pass( "stub_screen_space", "ssfx_ssr_blur", FALSE, FALSE,
                      FALSE );
        ...
        case 3: // Combine
            C.r_Pass( "stub_screen_space", "ssfx_ssr_combine", FALSE, FALSE,
                      FALSE );
        ...
        case 4: // No blur just direct to [r2_RT_ssfx_temp2]
            C.r_Pass( "stub_screen_space", "ssfx_ssr_noblur", FALSE, FALSE,
                      FALSE );
        ...
        case 5:
            C.r_Pass( "stub_screen_space", "ssfx_ssr_gloss", FALSE, FALSE,
                      FALSE );
...
void CBlender_ssfx_volumetric_blur::Compile( CBlender_Compile& C ) {
    ...
    switch ( C.iElement ) {
        case 0: // Blur Phase 1
            C.r_Pass( "stub_screen_space", "ssfx_volumetric_blur", FALSE, FALSE,
                      FALSE );
        ...
        case 5: // Combine
            C.r_Pass( "stub_screen_space", "ssfx_volumetric_combine", FALSE,
                      FALSE, FALSE );
...
void CBlender_ssfx_ao::Compile( CBlender_Compile& C ) {
    ...
    switch ( C.iElement ) {
        ...
        case 1: // Blur Phase 1
            C.r_Pass( "stub_screen_space", "ssfx_ao_blur", FALSE, FALSE,
                      FALSE );
        ...
        case 4: // Blur Phase 1
            C.r_Pass( "stub_screen_space", "ssfx_il_blur", FALSE, FALSE,
                      FALSE );
...
void CBlender_ssfx_sss::Compile( CBlender_Compile& C ) {
    ...
    switch ( C.iElement ) {
        ...
        case 1: // SSS Blur Occ Mask - Phase 1
            C.r_Pass( "stub_screen_space", "ssfx_sss_blur", FALSE, FALSE,
                      FALSE );
...
void CBlender_ssfx_sss_ext::Compile( CBlender_Compile& C ) {
    ...
    switch ( C.iElement ) {
        case 0: // SSS Ext
            C.r_Pass( "stub_screen_space", "ssfx_sss_ext", FALSE, FALSE,
                      FALSE );
        ...
        case 2: // SSS Ext Combine
            ...
            C.r_Pass( "stub_screen_space", "ssfx_sss_ext_combine", FALSE, FALSE,
                      FALSE );
...
void CBlender_ssfx_water_blur::Compile( CBlender_Compile& C ) {
    ...
    switch ( C.iElement ) {
        case 0: // Blur Phase 1
            C.r_Pass( "stub_screen_space", "ssfx_water_blur", FALSE, FALSE,
                      FALSE );
        ...
        case 2: // No Blur
            C.r_Pass( "stub_screen_space", "ssfx_water_noblur", FALSE, FALSE,
                      FALSE );
        ...
        case 5: // Water Waves
            C.r_Pass( "stub_screen_space", "ssfx_water_waves", FALSE, FALSE,
                      FALSE );
...
void CBlender_ssfx_motion_blur::Compile( CBlender_Compile& C ) {
    ...
    switch ( C.iElement ) {
        case 0:
            C.r_Pass( "stub_screen_space", "ssfx_motion_blur", FALSE, FALSE,
                      FALSE );
...
void CBlender_ssfx_fog_scattering::Compile( CBlender_Compile& C ) {
    ...
    switch ( C.iElement ) {
        case 0:
            C.r_Pass( "stub_screen_space", "ssfx_fog_scattering", FALSE, FALSE,
                      FALSE );
        ...
        case 2:
            C.r_Pass( "stub_screen_space", "ssfx_fog_scattering_blur", FALSE,
                      FALSE, FALSE );
            C.r_dx10Texture( "s_image", r2_RT_generic0 );
