...
void CBlender_luminance::Compile( CBlender_Compile& C ) {
    ...
    switch ( C.iElement ) {
        case 0: // 256x256	=> 64x64
            C.r_Pass( "stub_notransform_build", "bloom_luminance_1", false,
                      FALSE, FALSE, FALSE );
            ...
            break;
        case 1: // 64x64	=> 8x8
            C.r_Pass( "stub_notransform_filter", "bloom_luminance_2", false,
                      FALSE, FALSE, FALSE );
        ...
        case 2: // 8x8		=> 1x1, blending with old result
            C.r_Pass( "stub_notransform_filter", "bloom_luminance_3", false,
                      FALSE, FALSE, FALSE );
