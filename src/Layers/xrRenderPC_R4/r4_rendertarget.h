...
public:
    ...
    ref_rt rt_Generic;
    ref_rt rt_Position; // 64bit,	fat	(x,y,z,?)
                        // (eye-space)
    ref_rt rt_Color;    // 64/32bit,fat	(r,g,b,specular-gloss)	(or decompressed
                        // MET-8-8-8-8)
    ...
    ref_rt rt_Generic_0;        // 32bit		(r,g,b,a)
                                // // post-process, intermidiate results, etc.
    ref_rt rt_Generic_1;        // 32bit		(r,g,b,a)
                                // // post-process, intermidiate results, etc.
    ...
    ref_rt rt_Generic_2; // 32bit		(r,g,b,a)
                         // // post-process, intermidiate results, etc.
    ...
    ID3DTexture2D* t_ss_async; // 32bit		(r,g,b,a) is situated in the
                               // system memory
...
public:
    ...
    void u_calc_tc_duality_ss( Fvector2& r0,
                               Fvector2& r1,
                               Fvector2& l0,
                               Fvector2& l1 );
    BOOL u_need_PP();
    ...
    void accum_direct_cascade( u32 sub_phase,
                               Fmatrix& xform,
                               Fmatrix& xform_prev,
                               float fBias );
    ...
    void accum_direct_volumetric( u32 sub_phase,
                                  const u32 Offset,
