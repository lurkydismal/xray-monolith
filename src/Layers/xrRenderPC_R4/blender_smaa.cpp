...
void CBlender_ssfx_taa::Compile( CBlender_Compile& C ) {
    ...
    switch ( C.iElement ) {
        case 0: // Motion Vectors
            C.r_Pass( "stub_screen_space", "ssfx_taa_prepare", FALSE, FALSE,
                      FALSE );
        ...
        case 1: // TAA
            ...
            C.r_dx10Texture( "s_ssfx_temp",
                             r2_RT_ssfx_temp ); // 3DSS Scope Mask
        ...
        case 2: // TAA Sharp
            ...
            C.r_Pass( "stub_screen_space", "ssfx_taa_sharp", FALSE, FALSE,
                      FALSE );
            C.r_dx10Texture( "s_current",
                             r2_RT_ssfx_prev_frame ); // rt_Generic_0

            C.r_dx10Texture( "s_motion_vectors",
                             r2_RT_ssfx_motion_vectors ); // Debug
