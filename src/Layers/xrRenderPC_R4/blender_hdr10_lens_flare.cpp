...
void CBlender_hdr10_lens_flare_downsample::Compile( CBlender_Compile& C ) {
    ...
    C.r_Pass( "stub_screen_space", "hdr10_lens_flare_downsample", FALSE, FALSE,
              FALSE );
...
void CBlender_hdr10_lens_flare_fgen::Compile( CBlender_Compile& C ) {
    ...
    C.r_Pass( "stub_screen_space", "hdr10_lens_flare_fgen", FALSE, FALSE,
              FALSE );
...
void CBlender_hdr10_lens_flare_blur::Compile( CBlender_Compile& C ) {
    ...
    C.r_Pass( "stub_screen_space", "hdr10_lens_flare_blur", FALSE, FALSE,
              FALSE );
...
void CBlender_hdr10_lens_flare_upsample::Compile( CBlender_Compile& C ) {
    ...
    C.r_Pass( "stub_screen_space", "hdr10_lens_flare_upsample", FALSE, FALSE,
              FALSE );
