...
/*
        ...
        Problem was in that state created with DepthEnable=0 and
   DepthFunc=D3D11_COMPARISON_NEVER returned in the GetDesc method other values.

        Anomaly:
        Most likely this problem was fixed in
   df5de3b3e40135a39af3a4bc56d0dbe44a2c18a6 commit Right now, let's set disable
   depth buffer at this stage.
*/
...
void CRenderTarget::mark_msaa_edges() {
    ...
    StateManager.SetStencil( TRUE, D3DCMP_ALWAYS, 0x80, 0xFF, 0x80,
