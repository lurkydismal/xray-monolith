...
void CBlender_bloom_build::Compile( CBlender_Compile& C ) {
    ...
    switch ( C.iElement ) {
        case 0: // transfer into bloom-target
            C.r_Pass( "stub_notransform_build", "bloom_build", FALSE, FALSE,
                      FALSE, FALSE, D3DBLEND_SRCALPHA, D3DBLEND_INVSRCALPHA );
            ...
            break;
        case 1: // X-filter
            C.r_Pass( "stub_notransform_filter", "bloom_filter", FALSE, FALSE,
                      FALSE );
            // C.r_Sampler_clf		("s_bloom",
            // r2_RT_bloom1);
        ...
        case 2: // Y-filter
            ...
            break;
        case 3: // FF-filter_P0
            C.r_Pass( "stub_notransform_build", "bloom_filter_f", FALSE, FALSE,
                      FALSE );
            // C.r_Sampler_clf		("s_bloom",
            // r2_RT_bloom1);
            C.r_dx10Texture( "s_bloom", r2_RT_bloom1 );
...
void CBlender_postprocess_msaa::Compile( CBlender_Compile& C ) {
    ...
    switch ( C.iElement ) {
        case 0: // transfer into bloom-target
            C.r_Pass( "stub_notransform_postpr", "postprocess", FALSE, FALSE,
                      FALSE, FALSE, D3DBLEND_SRCALPHA, D3DBLEND_INVSRCALPHA );
        ...
        case 4: // use color map
            C.r_Pass( "stub_notransform_postpr", "postprocess_CM", FALSE, FALSE,
                      FALSE, FALSE, D3DBLEND_SRCALPHA, D3DBLEND_INVSRCALPHA );
            C.r_dx10Texture( "s_base0", r2_RT_generic );
            C.r_dx10Texture( "s_base1", r2_RT_generic );
            C.r_dx10Texture( "s_noise", "fx\\fx_noise2" );
...
void CBlender_ssfx_bloom_build::Compile( CBlender_Compile& C ) {
    ...
    switch ( C.iElement ) {
        ...
        case 1: // Combine ( Finish )
            C.r_Pass( "stub_screen_space", "ssfx_bloom_combine", FALSE, FALSE,
                      FALSE );

            C.r_dx10Texture( "s_bloom", r2_RT_ssfx_bloom_tmp2 );
            C.r_dx10Texture( "s_emissive", r2_RT_ssfx_bloom_emissive );

            C.r_dx10Texture( "s_ssfx_lensdirt", "fx\\lens_dirt" );
            C.r_dx10Texture( "s_starburst", "fx\\starburst" );
...
void CBlender_ssfx_bloom_lens::Compile( CBlender_Compile& C ) {
    ...
    switch ( C.iElement ) {
        case 0: // Lens Build
            C.r_Pass( "stub_screen_space", "ssfx_bloom_flares", FALSE, FALSE,
                      FALSE );
        ...
        case 1: // Flares Blur
            C.r_Pass( "stub_screen_space", "ssfx_bloom_upsample", FALSE, FALSE,
                      FALSE );
...
void CBlender_ssfx_bloom_downsample::Compile( CBlender_Compile& C ) {
    ...
    switch ( C.iElement ) {
        case 0:
            C.r_Pass( "stub_screen_space", "ssfx_bloom_downsample", FALSE,
                      FALSE, FALSE );
