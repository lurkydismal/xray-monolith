...
void CBlender_accum_spot::Compile( CBlender_Compile& C ) {
    ...
    switch ( C.iElement ) {
        ...
        case SE_L_UNSHADOWED: // unshadowed
            C.r_Pass( "accum_volume", "accum_spot_unshadowed_nomsaa", false,
                      FALSE, FALSE, blend, D3DBLEND_ONE, dest );
            // C.r_Sampler_rtf		("s_position",		r2_RT_P);
            // C.r_Sampler_rtf		("s_normal",		r2_RT_N);
            // C.r_Sampler_clw		("s_material",		r2_material);
            // C.r_Sampler			("s_lmap",
            // C.L_textures[0],false,D3DTADDRESS_CLAMP); C.r_Sampler_rtf
        ...
        case SE_L_NORMAL: // normal
            C.r_Pass( "accum_volume", "accum_spot_normal_nomsaa", false, FALSE,
            ...
            // (C); C.r_Sampler_rtf		("s_accumulator",
            // r2_RT_accum		);
            C.r_dx10Texture( "s_position", r2_RT_P );
            C.r_dx10Texture( "s_diffuse", r2_RT_albedo );
        ...
        case SE_L_FULLSIZE: // normal-fullsize
            C.r_Pass( "accum_volume", "accum_spot_fullsize_nomsaa", false,
                      FALSE, FALSE, blend, D3DBLEND_ONE, dest );
            // C.r_Sampler_rtf		("s_position",		r2_RT_P);
            // C.r_Sampler_rtf		("s_normal",		r2_RT_N);
            // C.r_Sampler_clw		("s_material",		r2_material);
        ...
        case SE_L_TRANSLUENT: // shadowed + transluency
            ...
            // ("s_accumulator",	r2_RT_accum		); jitter
            // (C);
            C.r_dx10Texture( "s_position", r2_RT_P );
            C.r_dx10Texture( "s_diffuse", r2_RT_albedo );
...
void CBlender_accum_spot_msaa::Compile( CBlender_Compile& C ) {
    ...
    switch ( C.iElement ) {
        case SE_L_FILL: // masking
            ...
            break;
        case SE_L_UNSHADOWED: // unshadowed
            C.r_Pass( "accum_volume", "accum_spot_unshadowed_msaa", false,
                      FALSE, FALSE, blend, D3DBLEND_ONE, dest );
            // C.r_Sampler_rtf		("s_position",		r2_RT_P);
            // C.r_Sampler_rtf		("s_normal",		r2_RT_N);
            // C.r_Sampler_clw		("s_material",		r2_material);
            ...
            break;
        case SE_L_NORMAL: // normal
            C.r_Pass( "accum_volume", "accum_spot_normal_msaa", false, FALSE,
                      FALSE, blend, D3DBLEND_ONE, dest );
            // C.r_Sampler_rtf		("s_position",		r2_RT_P);
            // C.r_Sampler_rtf		("s_normal",		r2_RT_N);
            // C.r_Sampler_clw		("s_material",		r2_material);
            ...
            break;
        case SE_L_FULLSIZE: // normal-fullsize
            C.r_Pass( "accum_volume", "accum_spot_fullsize_msaa", false, FALSE,
                      FALSE, blend, D3DBLEND_ONE, dest );
            // C.r_Sampler_rtf		("s_position",		r2_RT_P);
            // C.r_Sampler_rtf		("s_normal",		r2_RT_N);
            // C.r_Sampler_clw		("s_material",		r2_material);
...
void CBlender_accum_volumetric_msaa::Compile( CBlender_Compile& C ) {
    ...
    switch ( C.iElement ) {
        case 0: // masking
            C.r_Pass( "accum_volumetric", "accum_volumetric_msaa", false, FALSE,
                      FALSE );
