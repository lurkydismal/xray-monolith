...
void CPHJoint::SetAnchorVsFirstElement( const float x,
                                        const float y,
                                        const float z ) {
    vs_anchor = vs_first;
    anchor.set( x, y, z );
...
void CPHJoint::SetAnchorVsSecondElement( const float x,
                                         const float y,
                                         const float z ) {
    vs_anchor = vs_second;
    anchor.set( x, y, z );
...
void CPHJoint::SetAxisDir( const float x,
                           const float y,
                           const float z,
                           const int axis_num ) {
    int ax = axis_num;
...
void CPHJoint::SetAxisDirDynamic( const Fvector& orientation,
                                  const int axis_num ) {
    VERIFY( axis_num >= 0 );
    VERIFY( axis_num <= 2 );
    ...
    switch ( eType ) {
        case hinge2:
            switch ( axis_num ) {
                case 0:
                    dJointSetHinge2Axis1( m_joint, orientation[ 0 ],
                                          orientation[ 1 ], orientation[ 2 ] );
                    break;
                case 1:
                    dJointSetHinge2Axis2( m_joint, orientation[ 0 ],
                                          orientation[ 1 ], orientation[ 2 ] );
                    break;
                default:
                    NODEFAULT;
        ...
        case slider:
            switch ( axis_num ) {
                case 0:
                    dJointSetSliderParam( m_joint, dParamFMax,
                                          axes[ 0 ].force );
                    break;
                case 1:
                    dJointSetAMotorParam( m_joint1, dParamFMax,
                                          axes[ 1 ].force );
                    break;
                default:
                    NODEFAULT;
        ...
        case ball:
            break;
        case hinge:
            dJointSetHingeAxis( m_joint, orientation[ 0 ], orientation[ 1 ],
                                orientation[ 2 ] );
            break;
        case full_control:
            dJointSetAMotorAxis( m_joint1, axis_num, 1, orientation[ 0 ],
                                 orientation[ 1 ], orientation[ 2 ] );
            break;
        default:
            R_ASSERT2( false, "type not supported" );
    }
}

void CPHJoint::SetAxisDirVsFirstElement( const float x,
                                         const float y,
                                         const float z,
                                         const int axis_num ) {
    int ax = axis_num;
...
void CPHJoint::SetAxisDirVsSecondElement( const float x,
                                          const float y,
                                          const float z,
                                          const int axis_num ) {
    int ax = axis_num;
...
void CPHJoint::SetLimits( const float low,
                          const float high,
                          const int axis_num ) {
...
CPHJoint::CPHJoint( CPhysicsJoint::enumType type,
...
void CPHJoint::SetLimitsVsFirstElement( const float low,
                                        const float high,
                                        const int axis_num ) {}

void CPHJoint::SetLimitsVsSecondElement( const float low,
                                         const float high,
                                         const int axis_num ) {}
...
void CPHJoint::SetForceAndVelocity( const float force,
...
void CPHJoint::GetMaxForceAndVelocity( float& force,
                                       float& velocity,
                                       int axis_num ) {
...
void CPHJoint::SetForceActive( const int axis_num ) {
    switch ( eType ) {
        case hinge2:
            switch ( axis_num ) {
                case -1:
                    dJointSetHinge2Param( m_joint, dParamFMax,
                                          axes[ 0 ].force );
                    dJointSetHinge2Param( m_joint, dParamFMax2,
                                          axes[ 1 ].force );
                case 0:
                    dJointSetHinge2Param( m_joint, dParamFMax,
                                          axes[ 0 ].force );
        ...
        case full_control:
            switch ( axis_num ) {
                case -1:
                    dJointSetAMotorParam( m_joint1, dParamFMax,
                                          axes[ 0 ].force );
                    dJointSetAMotorParam( m_joint1, dParamFMax2,
                                          axes[ 1 ].force );
                    dJointSetAMotorParam( m_joint1, dParamFMax3,
                                          axes[ 2 ].force );
                case 0:
                    dJointSetAMotorParam( m_joint1, dParamFMax,
                                          axes[ 0 ].force );
...
void CPHJoint::SetVelocityActive( const int axis_num ) {
    switch ( eType ) {
        case hinge2:
            switch ( axis_num ) {
                case -1:
                    dJointSetHinge2Param( m_joint, dParamVel,
                                          axes[ 0 ].velocity );
                    dJointSetHinge2Param( m_joint, dParamVel2,
                                          axes[ 1 ].velocity );
                case 0:
                    dJointSetHinge2Param( m_joint, dParamVel,
                                          axes[ 0 ].velocity );
        ...
        case slider:
            switch ( axis_num ) {
                case -1:
                    dJointSetSliderParam( m_joint, dParamVel,
                                          axes[ 0 ].velocity );
                    dJointSetAMotorParam( m_joint1, dParamVel,
                                          axes[ 1 ].velocity );
                case 0:
                    dJointSetSliderParam( m_joint, dParamVel,
                                          axes[ 0 ].velocity );
        ...
        case full_control:
            switch ( axis_num ) {
                case -1:
                    dJointSetAMotorParam( m_joint1, dParamVel,
                                          axes[ 0 ].velocity );
                    dJointSetAMotorParam( m_joint1, dParamVel2,
                                          axes[ 1 ].velocity );
                    dJointSetAMotorParam( m_joint1, dParamVel3,
                                          axes[ 2 ].velocity );
                case 0:
                    dJointSetAMotorParam( m_joint1, dParamVel,
                                          axes[ 0 ].velocity );
...
void CPHJoint::SetLoLimitDynamic( int axis_num, float limit ) {
    ...
    switch ( eType ) {
        ...
        case full_control:
            ...
            break;
        default:
            R_ASSERT2( false, "type is not supported" );
    }
}
...
float CPHJoint::GetAxisAngle(int axis_num)
{
        ...
        switch(eType){
                                                case hinge2:
ret= dJointGetHinge2Angle1(m_joint);break; case ball:
ret= dInfinity;break; case hinge:					ret=
dJointGetHingeAngle(m_joint);break; case full_control:			ret=
dJointGetAMotorAngle(m_joint1,axis_num);break; case slider: switch (axis_num){
                                                                case 0:	ret=
dJointGetSliderPosition(m_joint);break; case 1: ret=
dJointGetAMotorAngle(m_joint1,0);break;
                                                        };break;
                                                default: R_ASSERT2( false, "type
not supported" ); break;
    ...
    switch ( eType ) {
        case hinge2:
            switch ( axis_num ) {
                ...
                case 0:
                case 1:
                    dJointSetHinge2Param( m_joint, dParamLoStop,
                                          axes[ 0 ].low );
                    dJointSetHinge2Param( m_joint, dParamHiStop,
                                          axes[ 0 ].high );
                    break;
            }
            break;
        case slider:
            switch ( axis_num ) {
                case -1:
                    dJointSetSliderParam( m_joint, dParamLoStop,
                                          axes[ 0 ].low );
                    dJointSetSliderParam( m_joint, dParamHiStop,
                                          axes[ 0 ].high );
                    dJointSetAMotorParam( m_joint1, dParamLoStop,
                                          axes[ 1 ].low );
        ...
        case full_control:
            switch ( axis_num ) {
                case -1:
                    ...
                    dJointSetAMotorParam( m_joint1, dParamLoStop,
                                          axes[ 0 ].low );
                    dJointSetAMotorParam( m_joint1, dParamLoStop2,
                                          axes[ 1 ].low );
                    dJointSetAMotorParam( m_joint1, dParamHiStop2,
                                          axes[ 1 ].high );
                    dJointSetAMotorParam( m_joint1, dParamHiStop3,
                                          axes[ 2 ].high );
                    dJointSetAMotorParam( m_joint1, dParamHiStop3,
                                          axes[ 2 ].high );
                case 0:
                ...
                case 1:
                    ...
                    break;
                case 2:
                    dJointSetAMotorParam( m_joint1, dParamLoStop3,
                                          axes[ 2 ].low );
                    dJointSetAMotorParam( m_joint1, dParamHiStop3,
                                          axes[ 2 ].high );
                    break;
...
void CPHJoint::SetAxisSDfactors( float spring_factor,
    ...
    if ( ax == -1 ) {
        switch ( eType ) {
            case ball:
                break;
            case hinge:
                axes[ 0 ].set_sd_factors( spring_factor, damping_factor,
                                          eType );
                break;
            case hinge2:;
            case slider:;
                axes[ 0 ].set_sd_factors( spring_factor, damping_factor,
                                          eType );
                axes[ 1 ].set_sd_factors( spring_factor, damping_factor,
                                          eType );
                break;
            ...
            case full_control:
                ...
                axes[ 1 ].set_sd_factors( spring_factor, damping_factor,
                                          eType );
                axes[ 2 ].set_sd_factors( spring_factor, damping_factor,
                                          eType );
                break;
        }
...
void CPHJoint::SetJointSDfactors( float spring_factor, float damping_factor ) {
    switch ( eType ) {
        case hinge2:
            m_cfm = CFM( hinge2_spring * spring_factor,
                         hinge2_damping * damping_factor );
            m_erp = ERP( hinge2_spring * spring_factor,
                         hinge2_damping * damping_factor );
            break;
        case ball:;
        case hinge:;
        case full_control:;
        case slider:;
            m_erp = ERP( world_spring * spring_factor,
                         world_damping * damping_factor );
            m_cfm = CFM( world_spring * spring_factor,
                         world_damping * damping_factor );
            break;
    }
    if ( bActive )
...
void CPHJoint::SetAxisSDfactorsActive( int axis_num ) {
    ...
    switch ( eType ) {
        ...
        case full_control:
            switch ( axis_num ) {
                case 0:
                    dJointSetAMotorParam( m_joint1, dParamStopERP,
                                          axes[ axis_num ].erp );
                    dJointSetAMotorParam( m_joint1, dParamStopCFM,
                                          axes[ 0 ].cfm );
                    break;
                case 1:
                    dJointSetAMotorParam( m_joint1, dParamStopERP2,
                                          axes[ 1 ].erp );
                    dJointSetAMotorParam( m_joint1, dParamStopCFM2,
                                          axes[ 1 ].cfm );
                    break;
                case 2:
                    dJointSetAMotorParam( m_joint1, dParamStopERP3,
                                          axes[ 2 ].erp );
                    dJointSetAMotorParam( m_joint1, dParamStopCFM3,
                                          axes[ 2 ].cfm );
                    break;
            }
            break;
        case slider:
            switch ( axis_num ) {
                case 0:
                    dJointSetSliderParam( m_joint, dParamStopERP,
                                          axes[ 0 ].erp );
                    dJointSetSliderParam( m_joint, dParamStopCFM,
                                          axes[ 0 ].cfm );
                case 1:
                    dJointSetAMotorParam( m_joint1, dParamStopERP,
                                          axes[ 1 ].erp );
...
void CPHJoint::GetJointSDfactors( float& spring_factor,
                                  float& damping_factor ) {
...
void CPHJoint::GetAxisSDfactors( float& spring_factor,
                                 float& damping_factor,
                                 int axis_num ) {
    LimitAxisNum( axis_num );
    spring_factor =
        SPRING( axes[ axis_num ].cfm, axes[ axis_num ].erp ) / world_spring;
    damping_factor =
        DAMPING( axes[ axis_num ].cfm, axes[ axis_num ].erp ) / world_damping;
}
...
void CPHJoint::CalcAxis( int ax_num,
                         Fvector& axis,
                         float& lo,
                         float& hi,
