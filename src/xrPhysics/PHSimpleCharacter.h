...
#ifdef DEBUG
    SCollisionDamageInfo& dbg_get_collision_dmg_info() {
...
private:
    ...
    static void TestRestrictorContactCallbackFun( bool& do_colide,
                                                  bool bo1,
                                                  dContact& c,
                                                  SGameMtl* material_1,
                                                  SGameMtl* material_2 );
...
public:
    ...
    // (dBodyID body,const dReal* anchor); virtual		void
    // CapturedSetPosition					(const dReal*
    // position); virtual		void		doCaptureExist
    // (bool&	do_exist);
...
private:
    ...
    virtual void UpdateStaticDamage( dContact* c,
                                     SGameMtl* tri_material,
                                     bool bo1 );
    void UpdateDynamicDamage( dContact* c,
    ...
    static void TestPathCallback( bool& do_colide,
                                  bool bo1,
                                  dContact& c,
                                  SGameMtl* /*material_1*/,
                                  SGameMtl* /*material_2*/ );
