...
void CPHCollideValidator::Init() {
    ...
    ClassFlags.set( cbClassDynamic | cbClassCharacter | cbClassSmall |
                        cbClassRagDoll | cbClassAnimated,
                    TRUE );
    ClassNCFlags.set( cbNCClassCharacter | cbNCClassSmall | cbNCClassDynamic |
                          cbNCClassRagDoll | cbNCClassAnimated,
                      TRUE );
}
