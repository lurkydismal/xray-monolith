...
public:
    ...
    virtual void SetAirResistance( dReal linear = default_k_l,
                                   dReal angular = default_k_w ) {
...
public:
    ...
    virtual _flags< CLClassBits >& collide_class_bits() {
        return CPHObject::collide_class_bits();
    }
    virtual const CLBits& collide_bits() const {
        return CPHObject::collide_bits();
    };
    virtual const _flags< CLClassBits >& collide_class_bits() const {
        return CPHObject::collide_class_bits();
    }
    ...
    IPhysicsShellHolder* PhysicsRefObject() {
        return ( *elements.begin() )->PhysicsRefObject();
    }
...
private:
    ...
    void AddSplitter( CPHShellSplitter::EType type,
                      u16 element,
                      u16 joint,
                      u16 position );
    /////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    void AddElementRecursive( CPhysicsElement* root_e,
                              u16 id,
                              Fmatrix global_parent,
                              u16 element_number,
                              bool* vis_check );
    void PlaceBindToElFormsRecursive( Fmatrix parent,
                                      u16 id,
                                      u16 element,
                                      Flags64& mask );
    ...
    void ReanableObject();
    void ExplosionHit( const Fvector& pos,
                       const Fvector& dir,
                       float val,
                       const u16 id );
    void ClearBreakInfo();
