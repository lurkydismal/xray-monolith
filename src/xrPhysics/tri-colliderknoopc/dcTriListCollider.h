...
public:
    ...
    int CollideSphere( dxGeom* Sphere,
                       int Flags,
                       dContactGeom* Contact,
                       int Stride );
    int CollideCylinder( dxGeom* Cylinder,
                         int Flags,
...
private:
    ...
    IC int dSortTriPrimitiveCollide( T primitive,
                                     ...
                                     int skip,
                                     const Fvector& AABB );
    IC dReal PointSphereTest( const dReal* center,
                              const dReal radius,
                              const dReal* pt,
                              dReal* norm );
    IC dReal FragmentonSphereTest( const dReal* center,
                                   const dReal radius,
                                   const dReal* pt1,
                                   const dReal* pt2,
                                   dReal* norm );
    IC bool FragmentonSphereTest( const dReal* center,
                                  const dReal radius,
                                  const dReal* pt1,
                                  const dReal* pt2,
                                  dReal* norm,
                                  dReal& depth );
    IC bool PointSphereTest( const dReal* center,
                             const dReal radius,
                             const dReal* pt,
                             dReal* norm,
                             dReal& depth );
    int dSortedTriSphere( const dReal* /**v1/**/,
                          const dReal* /**v2/**/,
                          const dReal* triAx,
                          CDB::TRI* T,
                          dReal dist,
    ...
    IC void CrossProjLine( const dReal* pt1,
                           const dReal* vc1,
                           const dReal* pt2,
                           const dReal* vc2,
                           dReal* proj );
    IC void CrossProjLine1( const dReal* pt1,
                            const dReal* vc1,
                            const dReal* pt2,
                            const dReal* vc2,
                            dReal* proj );
    IC bool CrossProjLine14( const dReal* pt1,
                             const dReal* vc1,
                             const dReal* pt2,
                             const dReal* vc2,
                             dReal hside,
                             dReal* proj );
    IC bool IsPtInBx( const dReal* Pt,
                      const dReal* BxP,
                      const dReal* BxEx,
                      const dReal* BxR );
    IC dReal FragmentonBoxTest( const dReal* Pt1,
                                const dReal* Pt2,
                                const dReal* BxP,
                                const dReal* BxEx,
                                const dReal* R,
                                dReal* norm,
                                dReal* pos );
    int dSortedTriBox( const dReal* triSideAx0,
    ...
    int dTriBox( const dReal* v0,
                 ...
                 dContactGeom* contact,
                 int skip );
    IC bool circleLineIntersection( const dReal* cn,
                                    const dReal* cp,
                                    dReal r,
                                    const dReal* lv,
                                    const dReal* lp,
    ...
    int dSortedTriCyl( const dReal* triSideAx0,
                       const dReal* triSideAx1,
                       const dReal* triAx,
                       // const dReal* v0,
                       // const dReal* v1,
    ...
    int dTriCyl( const dReal* v0,
                 ...
                 dContactGeom* contact,
                 int skip );
    IC bool cylinderCrossesLine( const dReal* p,
                                 const dReal* R,
                                 dReal hlz,
                                 const dReal* v0,
                                 const dReal* v1,
    ...
    IC int Collide( const dReal* v0,
                    ...
                    dContactGeom* contact,
                    int skip );
    IC int CollidePlain( const dReal* triSideAx0,
                         const dReal* triSideAx1,
                         const dReal* triAx,
                         CDB::TRI* T,
                         dReal dist,
...
IC void dcTriListCollider::SideToGlClTriState( u32 v0,
                                               u32 v1,
                                               CDB::TRI* T_array ) {
