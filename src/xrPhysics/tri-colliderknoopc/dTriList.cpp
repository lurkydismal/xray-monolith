...
int dCollideSTL( dxGeom* TriList,
                 dxGeom* Sphere,
                 int Flags,
                 dContactGeom* Contact,
                 int Stride ) throw() {
    if ( ValidateCollision( Sphere, TriList ) ) {
        return GetData( TriList )->CollideSphere( Sphere, Flags, Contact,
                                                  Stride );
    }
...
int dCollideBTL( dxGeom* TriList,
                 dxGeom* Box,
                 int Flags,
                 dContactGeom* Contact,
                 int Stride ) throw() {
...
int dCollideCTL( dxGeom* TriList,
                 dxGeom* Cyl,
                 int Flags,
                 dContactGeom* Contact,
                 int Stride ) throw() {
    if ( ValidateCollision( Cyl, TriList ) ) {
        return GetData( TriList )->CollideCylinder( Cyl, Flags, Contact,
                                                    Stride );
    }
