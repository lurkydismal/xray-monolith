...
inline bool TriContainPoint( const dReal* v0,
                             ...
                             const dReal* v2,
                             const dReal* pos ) {
    dVector3 triSideAx0 = { v1[ 0 ] - v0[ 0 ], v1[ 1 ] - v0[ 1 ],
                            v1[ 2 ] - v0[ 2 ] };
    dVector3 triSideAx1 = { v2[ 0 ] - v1[ 0 ], v2[ 1 ] - v1[ 1 ],
                            v2[ 2 ] - v1[ 2 ] };
    dVector3 triSideAx2 = { v0[ 0 ] - v2[ 0 ], v0[ 1 ] - v2[ 1 ],
                            v0[ 2 ] - v2[ 2 ] };
...
inline bool TriPlaneContainPoint( const dReal* v0,
                                  const dReal* v1,
                                  const dReal* v2,
                                  const dReal* pos ) {
    dVector3 triSideAx0 = { v1[ 0 ] - v0[ 0 ], v1[ 1 ] - v0[ 1 ],
...
inline bool TriPlaneContainPoint( const dReal* triAx,
                                  const dReal* v0,
                                  const dReal* pos ) {
    if ( dDOT( triAx, pos ) - dDOT( triAx, v0 ) > 0.f )
        return true;
...
inline void PlanePoint( const Triangle& tri,
                        const dReal* from,
                        const dReal* to,
                        float from_dist,
                        dReal* point ) {
    dVector3 dir = { to[ 0 ] - from[ 0 ], to[ 1 ] - from[ 1 ],
                     to[ 2 ] - from[ 2 ] };
...
ICF void InitTriangle( CDB::TRI* XTri,
                       Triangle& triangle,
                       const Fvector* V_array ) {
    const Point vertices[ 3 ] = {
        Point( ( dReal* )&V_array[ XTri->verts[ 0 ] ] ),
        Point( ( dReal* )&V_array[ XTri->verts[ 1 ] ] ),
        Point( ( dReal* )&V_array[ XTri->verts[ 2 ] ] ) };
    InitTriangle( XTri, triangle, vertices );
}

ICF void CalculateTri( CDB::TRI* XTri,
                       const float* pos,
                       Triangle& triangle,
                       const Fvector* V_array ) {
