...
void get_user_data( dxGeomUserData*& gd1,
                    dxGeomUserData*& gd2,
                    bool bo1,
...
//  bool dGeomUserDataHasCallback(dxGeom* geom,ObjectContactCallbackFun
//  *obj_callback)
//{
//	geom=retrieveGeom(geom);
//	if(geom&&dGeomGetUserData(geom)&&(dGeomGetUserData(geom))->object_callbacks)
//				return
//(dGeomGetUserData(geom))->object_callbacks->HasCallback(obj_callback); 	else
//return false;
//}
