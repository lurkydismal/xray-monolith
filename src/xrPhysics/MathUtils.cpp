...
EBoxSideNearestPointCode GetNearestPointOnOBBSide(const Fmatrix &xform,const
Fvector	&center,const Fvector &sides,u16 side,const Fvector &p,Fvector &point)
{
        //to plane dist
...
IC bool RAYvsCYLINDER( const Fcylinder& c_cylinder,
    ...
    float sq_nearest_dist =
        v_smag + tr * tr + tc * tc - 2 * ( cs * tc * tr - Lc * tc + Lr * tr );
