...
class CPHStaticGeomShell : public CPHGeometryOwner,
                           public CPHObject,
                           public CPHUpdateObject,
                           public IPHStaticGeomShell {
#ifdef DEBUG
    virtual IPhysicsShellHolder* ref_object() {
        return CPHGeometryOwner::PhysicsRefObject();
    }
#endif
...
// CPHStaticGeomShell* P_BuildStaticGeomShell(CGameObject*
// obj,ObjectContactCallbackFun* object_contact_callback); CPHStaticGeomShell*
// P_BuildStaticGeomShell(CGameObject* obj,ObjectContactCallbackFun*
// object_contact_callback,Fobb &b); void
// P_BuildStaticGeomShell(CPHStaticGeomShell* shell,CGameObject*
// obj,ObjectContactCallbackFun* object_contact_callback,Fobb &b);
#endif
