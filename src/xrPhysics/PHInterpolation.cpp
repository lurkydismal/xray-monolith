...
CPHInterpolation::CPHInterpolation() : m_body( nullptr ) {}
...
void CPHInterpolation::InterpolatePosition( Fvector& pos ) {
    pos.lerp( qPositions[ 0 ], qPositions[ 1 ],
              ph_world->m_frame_time / fixed_step );
}
