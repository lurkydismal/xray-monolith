...
#include "../3rd_party/ode/include/ode/compatibility.h"
#include "../3rd_party/ode/include/ode/matrix.h"
#include "../3rd_party/ode/include/ode/objects.h"
#include "../3rd_party/ode/include/ode/odemath.h"
#include "../3rd_party/ode/include/ode/rotation.h"
#include "MathUtils.h"
...
IC void dVectorInterpolate( float* res,
                            const float* from,
                            const float* to,
                            float k ) // changes to
{
