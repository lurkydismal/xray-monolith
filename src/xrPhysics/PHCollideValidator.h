...
public:
    ...
    static IC bool DoCollide( const CPHObject& obj1, const CPHObject& obj2 ) {
        ...
        //	return false;
        // #endif // DEBUG
        return ( CollideType( obj1.collide_class_bits().flags,
                              obj2.collide_class_bits().flags ) !=
                     cbNCGroupObject ||
...
protected:
private:
    static IC bool DoCollideNonMatched( const CPHObject& obj1,
                                        const CPHObject& obj2 ) {
        return !( ( ( obj1.collide_class_bits().flags & ClassNCFlags.flags ) &
                    ( ( obj2.collide_class_bits().flags & ClassFlags.flags )
                      << 1 ) ) ||
                  ( ( obj2.collide_class_bits().flags & ClassNCFlags.flags ) &
                    ( ( obj1.collide_class_bits().flags & ClassFlags.flags )
                      << 1 ) ) );
    }

    static IC bool DoCollideGroup( const CPHObject& obj1,
                                   const CPHObject& obj2 ) {
