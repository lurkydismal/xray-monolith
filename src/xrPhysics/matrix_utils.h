...
IC bool clamp_change( Fmatrix& m,
                      const Fmatrix& start,
                      float ml,
                      float ma,
                      float tl,
...
IC void get_diff_value( const Fmatrix& m0,
                        const Fmatrix& m1,
                        float& l,
                        float& a ) {
    Fmatrix diff;
...
IC void cmp_matrix( bool& eq_linear,
                    bool& eq_angular,
                    const Fmatrix& m0,
                    const Fmatrix& m1,
                    float tl,
...
IC void linear_diff( Fvector& lv,
                     const Fvector& mc1,
                     const Fvector& mc0,
                     float dt ) {
...
IC void matrix_diff( Fvector& lv,
                     Fvector& aw,
                     const Fmatrix& m0,
                     const Fmatrix& m1,
                     float dt ) {
