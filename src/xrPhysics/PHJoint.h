...
#ifndef PH_JOINT
#define PH_JOINT
#include "../3rd_party/ode/include/ode/common.h"
...
class CPHJoint : public CPhysicsJoint, public cphysics_scripted {
    ...
    virtual void SetAxisDirVsFirstElement( const Fvector& orientation,
                                           const int axis_num ) {
        SetAxisDirVsFirstElement( orientation.x, orientation.y, orientation.z,
                                  axis_num );
    }

    virtual void SetAxisDirVsSecondElement( const Fvector& orientation,
                                            const int axis_num ) {
        SetAxisDirVsSecondElement( orientation.x, orientation.y, orientation.z,
                                   axis_num );
    }

    virtual void SetAxisDirDynamic( const Fvector& orientation,
                                    const int axis_num );
    
...
IC void axis_angleB( const Fmatrix& m, const Fvector& axis, float& angle ) {
    ...
    ort_r.set( pr1 * ort1.x + pr2 * ort2.x, pr1 * ort1.y + pr2 * ort2.y,
