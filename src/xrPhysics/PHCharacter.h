...
public:
    ...
    virtual void ChooseRestrictionType( ERestrictionType my_type,
                                        float my_depth,
                                        CPHCharacter* ch ) {}
    ...
    virtual void ApplyImpulse( const Fvector& /**dir/**/,
                               const dReal /**P/**/ ) {}
    ...
    virtual void SetObjectContactCallback(
        ObjectContactCallbackFun* callback ) = 0;
    virtual void SetWheelContactCallback(
        ObjectContactCallbackFun* callback ) = 0;
    ...
    virtual void BringToDesired( float /**time/**/,
                                 float /**velocity/**/,
                                 float force = 1.f ) {}
...
XRPHYSICS_API void virtual_move_collide_callback( bool& do_collide,
                                                  bool bo1,
                                                  dContact& c,
                                                  SGameMtl* material_1,
                                                  SGameMtl* material_2 );
