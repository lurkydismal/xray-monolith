...
void IGame_ObjectPool::prefetch() {
    ...
    string256 section;
    // prefetch objects
    strconcat( sizeof( section ), section, "prefetch_objects_",
...
// prefetch objects
strconcat
(section,"prefetch_objects_",g_pGamePersistent->m_game_params.m_game_type);
...
Msg ("* [Object-prefetch] average: %2.2f ms, %lld bytes", a_time,
p_mem/p_count);
}
}
