...
public:
    ...
    INGAME_EDITOR_VIRTUAL void lerp( CEnvironment* parent,
                                     CEnvDescriptor& A,
                                     CEnvDescriptor& B,
                                     float f,
                                     CEnvModifier& M,
...
public:
    ...
    void mods_load();
    void mods_unload();
    static void PrepareLevelModifiers( LPCSTR canonical_level_path,
...
protected:
    INGAME_EDITOR_VIRTUAL CEnvDescriptor* create_descriptor(
        shared_str const& identifier,
        CInifile* config );
    void load_sun();
...
public:
    INGAME_EDITOR_VIRTUAL SThunderboltDesc* thunderbolt_description(
        CInifile& config,
