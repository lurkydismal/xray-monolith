...
public:
    ...
    INGAME_EDITOR_VIRTUAL void create_top_gradient( CInifile& pIni,
                                                    shared_str const& sect );
    INGAME_EDITOR_VIRTUAL void create_center_gradient( CInifile& pIni,
                                                       shared_str const& sect );
};
...
public:
    ...
    shared_str AppendDef( CEnvironment& environment,
                          CInifile* pIni,
