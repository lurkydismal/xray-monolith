...
#define xrPREAD_PROP( fs, ID, data )                         \
    {                                                        \
        ...
        switch ( ID ) {                                      \
            case xrPID_TOKEN:                                \
                fs.advance( ( ( xrP_TOKEN* )&data )->Count * \
                            sizeof( xrP_TOKEN::Item ) );     \
                break;                                       \
            case xrPID_CLSID:                                \
                fs.advance( ( ( xrP_CLSID* )&data )->Count * \
                            sizeof( CLASS_ID ) );            \
                break;                                       \
        };                                                   \
    }
...
//  switch (ID)
//  {
//  case xrPID_TOKEN: FS.Advance(((xrP_TOKEN*)&data)->Count *
//  sizeof(xrP_TOKEN::Item)); break; case xrPID_CLSID:
//  FS.Advance(((xrP_CLSID*)&data)->Count * sizeof(CLASS_ID)); break;
//  };
// }
#pragma pack( pop )
