...
#ifdef TRIVIAL_ENCRYPTOR_ENCODER
public:
    IC static void encode( pcvoid source,
...
#ifdef TRIVIAL_ENCRYPTOR_DECODER
public:
    IC static void decode( pcvoid source,
                           const u32& source_size,
                           pvoid destination ) {
#ifndef TRIVIAL_ENCRYPTOR_ENCODER
        static bool m_initialized = false;
...
#ifdef TRIVIAL_ENCRYPTOR_ENCODER
trivial_encryptor::type
    trivial_encryptor::m_alphabet[ trivial_encryptor::alphabet_size ];
#endif // TRIVIAL_ENCRYPTOR_ENCODER

#ifdef TRIVIAL_ENCRYPTOR_DECODER
trivial_encryptor::type
    trivial_encryptor::m_alphabet_back[ trivial_encryptor::alphabet_size ];
#endif // TRIVIAL_ENCRYPTOR_DECODER
