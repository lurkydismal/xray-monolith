...
public:
    ...
    CStatTimer AI_Vis_Query;    // visibility detection - portal traversal and
                                // frustum culling
    CStatTimer AI_Vis_RayTests; // visibility detection - ray casting

    CStatTimer RenderTOTAL; //
    CStatTimer RenderTOTAL_Real;
    CStatTimer RenderCALC;     // portal traversal, frustum culling, entities
                               // "renderable_Render"
    ...
    CStatTimer
        RenderDUMP_Wait; // ...waiting something back (queries results, etc.)
    ...
    CStatTimer Sound; // total time taken by sound subsystem (accurate only in
                      // single-threaded mode)
    CStatTimer Input; // total time taken by input subsystem (accurate only in
                      // single-threaded mode)
