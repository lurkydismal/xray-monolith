...
void IGame_Persistent::Prefetch() {
    ...
    prefetch_task.run( [ this ]() {
        ...
        }
        {
            ...
            if ( m_textures_prefetch_config->section_exist(
                     "prefetch_folders" ) ) {
                CInifile::Sect const& sect_f =
                    m_textures_prefetch_config->r_section( "prefetch_folders" );
                for ( CInifile::SectCIt I = sect_f.Data.begin();
                      I != sect_f.Data.end(); I++ ) {
            ...
            if ( m_textures_prefetch_config->section_exist(
                     "prefetch_textures" ) ) {
                CInifile::Sect const& sect =
                    m_textures_prefetch_config->r_section(
                        "prefetch_textures" );
                for ( CInifile::SectCIt I = sect.Data.begin();
                      I != sect.Data.end(); I++ )
                    Device.m_pRender->ResourcesPrefetchCreateTexture(
                        I->first.c_str() );
            }
