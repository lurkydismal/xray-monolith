...
#define ShaderVec shared_str
    ...
    void __stdcall OnParentClick( ButtonValue* sender,
                                  bool& bModif,
                                  bool& bSafe );
    void __stdcall OnCommandClick( ButtonValue* sender,
                                   bool& bModif,
                                   bool& bSafe );
...
public:
    ...
    SGameMtlPair* CreateMaterialPair( int m0,
                                      int m1,
                                      SGameMtlPair* parent = 0 );
    SGameMtlPair* AppendMaterialPair( int m0,
                                      int m1,
                                      SGameMtlPair* parent = 0 );
...
#define CLONE_MTL_SOUND_DO( _res_, _mtl_pair_, _a_vector_ )             \
    {                                                                   \
        _res_.clone( GET_RANDOM( _mtl_pair_##->_a_vector_ ), st_Effect, \
                     sg_SourceType );                                   \
    }
