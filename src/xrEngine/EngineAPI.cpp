...
#pragma comment( lib, "nvapi.lib" )
    ...
    !defined( STATIC_RENDERER_R3 ) && !defined( STATIC_RENDERER_R4 )
#error Select one of the renderers R1, R2, R3, or R4
#endif

#ifdef STATIC_RENDERER_R1
#if defined( STATIC_RENDERER_R2 ) || defined( STATIC_RENDERER_R3 ) || \
    defined( STATIC_RENDERER_R4 )
...
#if defined( STATIC_RENDERER_R1 ) || defined( STATIC_RENDERER_R3 ) || \
    defined( STATIC_RENDERER_R4 )
#error Only one of the renderers R1, R2, R3, and R4 can be selected at once
#endif
...
ENGINE_API bool is_enough_address_space_available() {
    ...
    //     return (*(u32*)&system_info.lpMaximumApplicationAddress) >
    //     0x90000000;
}

#ifndef DEDICATED_SERVER

extern BOOL DllMainXrRenderR1( HANDLE hModule,
                               DWORD ul_reason_for_call,
                               LPVOID lpReserved );
extern BOOL DllMainXrRenderR2( HANDLE hModule,
                               DWORD ul_reason_for_call,
                               LPVOID lpReserved );
extern BOOL DllMainXrRenderR3( HANDLE hModule,
                               DWORD ul_reason_for_call,
                               LPVOID lpReserved );
extern BOOL DllMainXrRenderR4( HANDLE hModule,
                               DWORD ul_reason_for_call,
                               LPVOID lpReserved );
...
extern BOOL DllMainXrGame( HANDLE hModule,
...
void CEngineAPI::Initialize( void ) {
    ...
    // game
    {
        ...
        // R_ASSERT2(hGame, "Game DLL raised exception during loading or there
        // is no game DLL at all"); pCreate =
        // (Factory_Create*)GetProcAddress(hGame, "xrFactory_Create");
        pCreate = xrFactory_Create;
        R_ASSERT( pCreate );
        // pDestroy = (Factory_Destroy*)GetProcAddress(hGame,
        // "xrFactory_Destroy");
...
void CEngineAPI::CreateRendererList() {
    ...
    if ( Core.ParamsData.test( ECoreParams::perfhud_hack ) ) {
        ...
        {
            bSupports_r2 = true;
            // SupportsAdvancedRenderingREF* test_rendering =
            // (SupportsAdvancedRenderingREF*)GetProcAddress(hRender,
        ...
        // if (hRender)
        {
            // SupportsDX10RenderingREF* test_dx10_rendering =
            // (SupportsDX10RenderingREF*)GetProcAddress(hRender,
            // "SupportsDX10Rendering");
            SupportsDX10RenderingREF* test_dx10_rendering =
                SupportsDX10Rendering;
        ...
        // if (hRender)
        {
            // SupportsDX11RenderingREF* test_dx11_rendering =
            // (SupportsDX11RenderingREF*)GetProcAddress(hRender,
            // "SupportsDX11Rendering");
            SupportsDX11RenderingREF* test_dx11_rendering =
                SupportsDX11Rendering;
    ...
    R_ASSERT2( _tmp.size() != 0,
               "No valid renderer found, please use a render system that's "
