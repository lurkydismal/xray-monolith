...
private:
    ...
    // OA option handling
    // void DescribeOption(char* pszOptionName, const oaOptionDependency&
    // Dependency); oaOptionDataType GetOptionType(char* pszOptionName); void
    // GetOption(char* pszOptionName); void SetOption(oaNamedOption* pOption);
...
private:
    ...
    // Guards
    bool m_bExecutingConsoleCommand; // Guard to pass to OA only those command
                                     // that were issued by OA
    // Native benchmarking
