...
protected:
    ...
    IC virtual void SendTo_LL( void* data,
                               u32 size,
...
public:
    ...
    IC GameDescriptionData const& get_net_DescriptionData() const {
    ...
    // receive
    IC void StartProcessQueue() {
        net_Queue.Lock();
    }; // WARNING ! after Start mast be End !!! <-
