...
void animation_planner::setup( CAI_Stalker* object,
...
void animation_planner::add_evaluators() {
    add_evaluator( eWorldPropertySmartCoverEntered,
                   xr_new< evaluators::cover_entered_evaluator >(
                       m_object, "smart cover entered" ) );
    add_evaluator( eWorldPropertySmartCoverActual,
                   xr_new< evaluators::cover_actual_evaluator >(
                       m_object, "smart cover actual" ) );
    add_evaluator( eWorldPropertyReadyToKill,
                   xr_new< CStalkerPropertyEvaluatorReadyToKillSmartCover >(
                       m_object, "ready to kill", 6 ) );
    add_evaluator(
        eWorldPropertyLookedOut,
        xr_new< CStalkerPropertyEvaluatorConst >( false, "looked out" ) );
    add_evaluator( eWorldPropertyLoopholeActual,
                   xr_new< evaluators::loophole_actual_evaluator >(
                       m_object, "loophole actual", this, 0 ) );
    add_evaluator(
        eWorldPropertyExitSmartCover,
        xr_new< CStalkerPropertyEvaluatorConst >( false, "exit smart cover" ) );
    add_evaluator(
        eWorldPropertyLoopholeIdle,
        xr_new< CStalkerPropertyEvaluatorConst >( false, "loophole idle" ) );
    add_evaluator(
        eWorldPropertyLoopholeFire,
        xr_new< CStalkerPropertyEvaluatorConst >( false, "loophole fire" ) );
    add_evaluator( eWorldPropertyLoopholeFireNoLookout,
                   xr_new< CStalkerPropertyEvaluatorConst >(
                       false, "loophole fire no lookout" ) );
    add_evaluator( eWorldPropertyReadyToIdle,
                   xr_new< CStalkerPropertyEvaluatorMember >(
                       ( CPropertyStorage* )0, eWorldPropertyReadyToIdle, true,
                       true, "ready to idle" ) );
    add_evaluator( eWorldPropertyReadyToLookout,
                   xr_new< CStalkerPropertyEvaluatorMember >(
                       ( CPropertyStorage* )0, eWorldPropertyReadyToLookout,
                       true, true, "ready to lookout" ) );
    add_evaluator( eWorldPropertyReadyToFire,
                   xr_new< CStalkerPropertyEvaluatorMember >(
                       ( CPropertyStorage* )0, eWorldPropertyReadyToFire, true,
                       true, "ready to fire" ) );
    add_evaluator(
        eWorldPropertyReadyToFireNoLookout,
        xr_new< CStalkerPropertyEvaluatorMember >(
            ( CPropertyStorage* )0, eWorldPropertyReadyToFireNoLookout, true,
            true, "ready to fire_no_lookout" ) );
    add_evaluator( eWorldPropertyLoopholeExitable,
                   xr_new< evaluators::loophole_exitable_evaluator >(
                       m_object, "loophole exitable" ) );
    add_evaluator( eWorldPropertyLoopholeCanExitWithAnimation,
                   xr_new< evaluators::can_exit_loophole_with_animation >(
                       m_object, "can exit loophole with animation" ) );
}
...
void animation_planner::add_actions() {
    ...
    action = xr_new< non_animated_change_loophole >(
        m_object, "non-animated change loophole" );
    add_condition( action, eWorldPropertySmartCoverEntered, true );
    add_condition( action, eWorldPropertyLoopholeActual, false );
    add_condition( action, eWorldPropertyReadyToIdle, true );
    ...
    action = xr_new< idle_2_lookout_transition >(
        m_object, "idle_2_lookout", "idle", "lookout",
        eWorldPropertyReadyToIdle, eWorldPropertyReadyToLookout, this );
    add_condition( action, eWorldPropertySmartCoverActual, true );
    add_condition( action, eWorldPropertySmartCoverEntered, true );
    add_condition( action, eWorldPropertyLoopholeActual, true );
    add_condition( action, eWorldPropertyReadyToIdle, true );
    ...
    action = xr_new< lookout_2_idle_transition >(
        m_object, "lookout_2_idle", "lookout", "idle",
    ...
    action = xr_new< idle_2_fire_transition >(
        m_object, "idle_2_fire", "idle", "fire", eWorldPropertyReadyToIdle,
    ...
    action = xr_new< fire_2_idle_transition >(
        m_object, "fire_2_idle", "fire", "idle", eWorldPropertyReadyToFire,
    ...
    action = xr_new< idle_2_fire_transition >(
        m_object, "idle_2_fire_no_lookout", "idle", "fire_no_lookout",
        eWorldPropertyReadyToIdle, eWorldPropertyReadyToFireNoLookout, this,
        true );
    add_condition( action, eWorldPropertySmartCoverActual, true );
    add_condition( action, eWorldPropertySmartCoverEntered, true );
    add_condition( action, eWorldPropertyLoopholeActual, true );
    ...
    action = xr_new< fire_2_idle_transition >(
        m_object, "fire_no_lookout_2_idle", "fire_no_lookout", "idle",
...
#ifndef MASTER_GOLD
    if ( hit->who && smart_cast< CActor* >( hit->who ) &&
