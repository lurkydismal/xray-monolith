...
public:
    typedef xr_delegate< void( CObject* ) > CALLBACK_TYPE;
...
public:
    ...
    void remove( ALife::_OBJECT_ID requesting_id,
                 ALife::_OBJECT_ID requested_id );
    ...
    const CSpawnCallback* callback( ALife::_OBJECT_ID requesting_id,
