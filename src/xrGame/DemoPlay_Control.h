...
public:
    ...
    enum EAction {
        ...
        on_artefactloosing // param contains the name of a player that loosed
                           // the art
    };
...
private:
    ...
    enum ECurrentControlMode { not_active = 0, rewinding, waiting_for_actions };
    ...
    void process_action(); // pause game and changes demo play speed if it's
                           // need

    void __stdcall on_round_start_impl( u32 message,
                                        u32 subtype,
                                        NET_Packet& packet );
    ...
    void __stdcall on_artefactdelivering_impl( u32 message,
                                               u32 subtype,
                                               NET_Packet& packet );
    void __stdcall on_artefactcapturing_impl( u32 message,
                                              u32 subtype,
                                              NET_Packet& packet );
    void __stdcall on_artefactloosing_impl( u32 message,
                                            u32 subtype,
                                            NET_Packet& packet );
}; // class demoplay_control
