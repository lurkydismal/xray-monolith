...
IC CGameLevelCrossTable::CGameLevelCrossTable( LPCSTR fName ) {
    ...
    R_ASSERT2( m_tCrossTableHeader.version() == XRAI_CURRENT_VERSION,
...
IC CGameLevelCrossTable::CGameLevelCrossTable( const void* buffer,
                                               const u32& buffer_size ) {
    Memory.mem_copy( &m_tCrossTableHeader, buffer,
                     sizeof( m_tCrossTableHeader ) );
...
IC const CGameLevelCrossTable::CCell& CGameLevelCrossTable::vertex(
