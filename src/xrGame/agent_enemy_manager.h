...
protected:
    template < typename T >
    IC void setup_mask( xr_vector< T >& objects,
                        CMemberEnemy& enemy,
    ...
    float evaluate( const CEntityAlive* object0,
...
private:
    void wounded_processor( const CEntityAlive* object,
...
public:
    ...
    bool assigned_wounded( const CEntityAlive* wounded,
                           const CAI_Stalker* member );
    bool useful_enemy( const CEntityAlive* enemy,
