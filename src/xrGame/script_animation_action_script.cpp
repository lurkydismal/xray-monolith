        ...
        [ class_< CScriptAnimationAction >( "anim" )
              ...
              .enum_( "monster" )
                  [ value( "stand_idle", int( MonsterSpace::eAA_StandIdle ) ),
                    value( "capture_prepare",
                           int( MonsterSpace::eAA_CapturePrepare ) ),
              ...
              // Monster specific
              .def(
                  constructor< MonsterSpace::EScriptMonsterAnimAction, int >() )

              .def( "anim", &CScriptAnimationAction::SetAnimation )
              .def( "type", &CScriptAnimationAction::SetMentalState )
              .def( "completed", ( bool ( CScriptAnimationAction::* )() )(
                                     &CScriptAnimationAction::completed ) ) ];
}
