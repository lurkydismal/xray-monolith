...
int ATLAS_GET_STAT( char* statName ) {
    ...
    if ( !strcmp( "STAT_AwardOwerwhelmingSuperiorityLastRewardDate",
                  statName ) )
...
int ATLAS_GET_STAT_PAGE_BY_ID( int statId ) {
    ...
    // PlayerStats
    if ( statId == 1 || statId == 2 || statId == 3 || statId == 4 ||
         statId == 5 || statId == 6 || statId == 7 || statId == 8 ||
         statId == 9 || statId == 10 || statId == 11 || statId == 12 ||
         statId == 13 || statId == 14 || statId == 15 || statId == 16 ||
         statId == 17 || statId == 18 || statId == 19 || statId == 20 ||
         statId == 21 || statId == 22 || statId == 23 || statId == 24 ||
         statId == 25 || statId == 26 || statId == 27 || statId == 28 ||
         statId == 29 || statId == 30 || statId == 31 || statId == 32 ||
         statId == 33 || statId == 34 || statId == 35 || statId == 36 ||
         statId == 37 || statId == 38 || statId == 39 || statId == 40 ||
         statId == 41 || statId == 42 || statId == 43 || statId == 44 ||
         statId == 45 || statId == 46 || statId == 47 || statId == 48 ||
         statId == 49 || statId == 50 || statId == 51 || statId == 52 ||
         statId == 53 || statId == 54 || statId == 55 || statId == 56 ||
         statId == 57 || statId == 58 || statId == 59 || statId == 60 ||
         statId == 61 || statId == 62 || statId == 63 || statId == 64 ||
         statId == 65 || statId == 66 || statId == 67 || statId == 68 )
        return 1;
...
int ATLAS_GET_STAT_PAGE_BY_NAME( char* statName ) {
    ...
    // PlayerStats
    if ( !strcmp( "STAT_AwardAchillesHeel", statName ) ||
         !strcmp( "STAT_AwardAchillesHeelLastRewardDate", statName ) ||
         !strcmp( "STAT_AwardAvenger", statName ) ||
         !strcmp( "STAT_AwardAvengerLastRewardDate", statName ) ||
         !strcmp( "STAT_AwardBlackList", statName ) ||
         !strcmp( "STAT_AwardBlackListLastRewardDate", statName ) ||
         !strcmp( "STAT_AwardBlitzkrieg", statName ) ||
         !strcmp( "STAT_AwardBlitzkriegLastRewardDate", statName ) ||
         !strcmp( "STAT_AwardCherub", statName ) ||
         !strcmp( "STAT_AwardCherubLastRewardDate", statName ) ||
         !strcmp( "STAT_AwardClimber", statName ) ||
         !strcmp( "STAT_AwardClimberLastRewardDate", statName ) ||
         !strcmp( "STAT_AwardDeadlyAccuracy", statName ) ||
         !strcmp( "STAT_AwardDeadlyAccuracyLastRewardDate", statName ) ||
         !strcmp( "STAT_AwardDignity", statName ) ||
         !strcmp( "STAT_AwardDignityLastRewardDate", statName ) ||
         !strcmp( "STAT_AwardDoubleShotDoubleKill", statName ) ||
         !strcmp( "STAT_AwardDoubleShotDoubleKillLastRewardDate", statName ) ||
         !strcmp( "STAT_AwardDryVictory", statName ) ||
         !strcmp( "STAT_AwardDryVictoryLastRewardDate", statName ) ||
         !strcmp( "STAT_AwardFasterThanBullets", statName ) ||
         !strcmp( "STAT_AwardFasterThanBulletsLastRewardDate", statName ) ||
         !strcmp( "STAT_AwardHarvestTime", statName ) ||
         !strcmp( "STAT_AwardHarvestTimeLastRewardDate", statName ) ||
         !strcmp( "STAT_AwardInvincibleFury", statName ) ||
         !strcmp( "STAT_AwardInvincibleFuryLastRewardDate", statName ) ||
         !strcmp( "STAT_AwardLightingReflexes", statName ) ||
         !strcmp( "STAT_AwardLightingReflexesLastRewardDate", statName ) ||
         !strcmp( "STAT_AwardLucky", statName ) ||
         !strcmp( "STAT_AwardLuckyLastRewardDate", statName ) ||
         !strcmp( "STAT_AwardMad", statName ) ||
         !strcmp( "STAT_AwardMadLastRewardDate", statName ) ||
         !strcmp( "STAT_AwardMarksman", statName ) ||
         !strcmp( "STAT_AwardMarksmanLastRewardDate", statName ) ||
         !strcmp( "STAT_AwardMasscare", statName ) ||
         !strcmp( "STAT_AwardMasscareLastRewardDate", statName ) ||
         !strcmp( "STAT_AwardMultichampion", statName ) ||
         !strcmp( "STAT_AwardMultichampionLastRewardDate", statName ) ||
         !strcmp( "STAT_AwardOculist", statName ) ||
         !strcmp( "STAT_AwardOculistLastRewardDate", statName ) ||
         !strcmp( "STAT_AwardOpener", statName ) ||
         !strcmp( "STAT_AwardOpenerLastRewardDate", statName ) ||
         !strcmp( "STAT_AwardOwerwhelmingSuperiority", statName ) ||
         !strcmp( "STAT_AwardOwerwhelmingSuperiorityLastRewardDate",
                  statName ) ||
         !strcmp( "STAT_AwardParanoia", statName ) ||
         !strcmp( "STAT_AwardParanoiaLastRewardDate", statName ) ||
         !strcmp( "STAT_AwardPeaceAmbassador", statName ) ||
         !strcmp( "STAT_AwardPeaceAmbassadorLastRewardDate", statName ) ||
         !strcmp( "STAT_AwardRemembrance", statName ) ||
         !strcmp( "STAT_AwardRemembranceLastRewardDate", statName ) ||
         !strcmp( "STAT_AwardSilentDeath", statName ) ||
         !strcmp( "STAT_AwardSilentDeathLastRewardDate", statName ) ||
         !strcmp( "STAT_AwardSkewer", statName ) ||
         !strcmp( "STAT_AwardSkewerLastRewardDate", statName ) ||
         !strcmp( "STAT_AwardSprinterStopper", statName ) ||
         !strcmp( "STAT_AwardSprinterStopperLastRewardDate", statName ) ||
         !strcmp( "STAT_AwardStalkerFlair", statName ) ||
         !strcmp( "STAT_AwardStalkerFlairLastRewardDate", statName ) ||
         !strcmp( "STAT_AwardToughy", statName ) ||
         !strcmp( "STAT_AwardToughyLastRewardDate", statName ) ||
         !strcmp( "STAT_BestScore_BackstabsKillsInRow", statName ) ||
         !strcmp( "STAT_BestScore_BleedKillsInRow", statName ) ||
         !strcmp( "STAT_BestScore_ExplosiveKillsInRow", statName ) ||
         !strcmp( "STAT_BestScore_EyeKillsInRow", statName ) ||
         !strcmp( "STAT_BestScore_HeadshotsKillsInRow", statName ) ||
         !strcmp( "STAT_BestScore_KillsInRow", statName ) ||
         !strcmp( "STAT_BestScore_KnifeKillsInRow", statName ) ||
