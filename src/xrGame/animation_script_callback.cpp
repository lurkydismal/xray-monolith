...
CBlend* PlayMotionByParts( IKinematicsAnimated* sa,
    ...
    if ( md->bone_or_part != BI_NONE )
        return sa->LL_PlayCycle( md->bone_or_part, motion_ID, bMixIn, Callback,
                                 CallbackParam );

    for ( u16 i = 0; i < MAX_PARTS; ++i ) {
        CBlend* blend =
            sa->LL_PlayCycle( i, motion_ID, bMixIn, Callback, CallbackParam );
        if ( blend && !ret )
            ret = blend;
        // m_anim_blend =
...
CBlend* anim_script_callback::play_cycle( IKinematicsAnimated* sa,
                                          const shared_str& anim ) {
...
void anim_script_callback::anim_callback( CBlend* B ) {
    ...
    // bool	at_end			=	running_fwrd && ( timeCurrent >
    // ( timeTotal-END_EPS ) ); bool	at_begin		=
    // !running_fwrd && ( timeCurrent < 0.f );
    ////..............................
    ////..............................
    ////..............................
    // if( at_end )
