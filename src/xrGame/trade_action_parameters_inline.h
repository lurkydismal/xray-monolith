...
IC CTradeActionParameters::CTradeActionParameters(
    const CTradeFactors& default_factors ) {
...
IC void CTradeActionParameters::enable( const shared_str& section,
...
IC const CTradeFactors& CTradeActionParameters::factors(
...
IC void CTradeActionParameters::default_factors(
    const CTradeFactors& trade_factors ) {
