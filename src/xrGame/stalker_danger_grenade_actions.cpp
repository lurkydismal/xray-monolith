...
CStalkerActionDangerGrenadeTakeCover::CStalkerActionDangerGrenadeTakeCover(
    CAI_Stalker* object,
    LPCSTR action_name )
...
void CStalkerActionDangerGrenadeTakeCover::execute() {
    ...
    EMentalState temp;
    {
        if ( !object().inventory().ActiveItem() ) {
            ...
            CWeapon* weapon = smart_cast< CWeapon* >(
                &object().inventory().ActiveItem()->object() );
            if ( weapon && weapon->can_be_strapped() &&
                 object().best_weapon() &&
                 ( object().best_weapon()->object().ID() == weapon->ID() ) ) {
                object().CObjectHandler::set_goal(
                    eObjectActionStrapped, object().inventory().ActiveItem() );
...
CStalkerActionDangerGrenadeWaitForExplosion::
    CStalkerActionDangerGrenadeWaitForExplosion( CAI_Stalker* object,
                                                 LPCSTR action_name )
    : inherited( object, action_name ) {}
...
CStalkerActionDangerGrenadeTakeCoverAfterExplosion::
    CStalkerActionDangerGrenadeTakeCoverAfterExplosion( CAI_Stalker* object,
                                                        LPCSTR action_name )
    : inherited( object, action_name ) {}
...
CStalkerActionDangerGrenadeLookAround::CStalkerActionDangerGrenadeLookAround(
    CAI_Stalker* object,
    LPCSTR action_name )
    : inherited( object, action_name ) {}
...
CStalkerActionDangerGrenadeSearch::CStalkerActionDangerGrenadeSearch(
    CAI_Stalker* object,
    LPCSTR action_name )
    : inherited( object, action_name ) {}
