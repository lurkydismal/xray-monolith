...
public:
    ...
    /* Find a way to export CCarDrone to LUA then
     * obj:get_car():CarDrone():CCarDrone_function() instead of doing these. */
...
public:
    ...
    Fvector VisualCamera_GetDesireAngle() {
        return m_visual_camera.GetDesireAngle();
    }
