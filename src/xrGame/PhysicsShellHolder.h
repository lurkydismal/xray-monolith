...
public:
    ...
    virtual bool ActivationSpeedOverriden( Fvector& dest,
                                           bool clear_override ) {
        return false;
    }
...
protected:
    virtual bool has_shell_collision_place(
...
public:
    static void IgnoreCollisionCallback( bool& do_colide,
                                         bool bo1,
                                         dContact& c,
                                         SGameMtl* material_1,
                                         SGameMtl* material_2 );
