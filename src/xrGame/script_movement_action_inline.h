...
IC CScriptMovementAction::CScriptMovementAction( const EInputKeys tInputKeys,
                                                 float fSpeed ) {
...
// --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
IC void CScriptMovementAction::SetBodyState(
    const MonsterSpace::EBodyState tBodyState ) {
    m_tBodyState = tBodyState;
    m_bCompleted = false;
}

IC void CScriptMovementAction::SetMovementType(
    const MonsterSpace::EMovementType tMovementType ) {
    m_tMovementType = tMovementType;
    m_bCompleted = false;
}

IC void CScriptMovementAction::SetPathType(
    const DetailPathManager::EDetailPathType tPathType ) {
    m_tPathType = tPathType;
    m_bCompleted = false;
}

IC void CScriptMovementAction::SetPatrolPath( const CPatrolPath* path,
                                              const shared_str& path_name ) {
    m_path = path;
...
IC void CScriptMovementAction::SetPatrolStart(
    PatrolPathManager::EPatrolStartType tPatrolPathStart ) {
    m_tPatrolPathStart = tPatrolPathStart;
    m_bCompleted = false;
}

IC void CScriptMovementAction::SetPatrolStop(
