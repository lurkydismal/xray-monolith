...
protected:
    ...
    u32 m_state_fire_object; // 0 : standard object navigation, 1 : vis_point
                             // navigation
...
public:
    IC CSightAction();
    IC CSightAction( const ESightType& sight_type,
    ...
    IC CSightAction( const CGameObject* object_to_look,
                     bool torso_look = false,
                     bool fire_object = false,
                     bool no_pitch = false );
    IC CSightAction( const CMemoryInfo* memory_object,
                     bool torso_look = false );
    void initialize();
    void execute();
    void finalize();
