...
public:
    ...
    CDistanceFunction( CEF_Storage* storage ) : CBaseFunction( storage ) {
        ...
        OUT_MESSAGE( "* Evaluation function \"%s\" is successfully initalized",
                     m_caName );
    };
...
public:
    ...
    CPersonalCreatureTypeFunction( CEF_Storage* storage )
...
public:
    ...
    CPersonalWeaponTypeFunction( CEF_Storage* storage )
        : CBaseFunction( storage ) {
        m_fMinResultValue = 1.0;
...
public:
    ...
    CPersonalAccuracyFunction( CEF_Storage* storage )
        : CBaseFunction( storage ) {
        m_fMinResultValue = 0.0;
        m_fMaxResultValue = 100.0;
...
public:
    ...
    CPersonalIntelligenceFunction( CEF_Storage* storage )
        : CBaseFunction( storage ) {
        m_fMinResultValue = 0.0;
        m_fMaxResultValue = 100.0;
...
public:
    ...
    CPersonalRelationFunction( CEF_Storage* storage )
        : CBaseFunction( storage ) {
        m_fMinResultValue = 0.0;
        m_fMaxResultValue = 100.0;
...
public:
    ...
    CPersonalAggressivenessFunction( CEF_Storage* storage )
        : CBaseFunction( storage ) {
        m_fMinResultValue = 0.0;
        m_fMaxResultValue = 100.0;
...
public:
    ...
    CEnemyEquipmentCostFunction( CEF_Storage* storage )
        : CBaseFunction( storage ) {
        m_fMinResultValue = 0.0;
        m_fMaxResultValue = 12.0;
...
public:
    ...
    CEnemyRukzakWeightFunction( CEF_Storage* storage )
        : CBaseFunction( storage ) {
        m_fMinResultValue = 1.0;
        m_fMaxResultValue = 12.0;
...
public:
    ...
    CEnemyDistanceToGraphPoint( CEF_Storage* storage )
        : CBaseFunction( storage ) {
        m_fMinResultValue = 0.0;
        m_fMaxResultValue = 4.0;
