...
//Maksimchuk 	Description : Group hierarchy holder inline functions
////////////////////////////////////////////////////////////////////////////

#pragma once

IC CGroupHierarchyHolder::CGroupHierarchyHolder(
    CSquadHierarchyHolder* squad ) {
    VERIFY( squad );
    m_squad = squad;
...
IC const GroupHierarchyHolder::MEMBER_REGISTRY& CGroupHierarchyHolder::members()
    const {
    return ( m_members );
}
...
IC GroupHierarchyHolder::VISIBLE_OBJECTS&
CGroupHierarchyHolder::visible_objects() const {
    VERIFY( m_visible_objects );
    return ( *m_visible_objects );
}

IC GroupHierarchyHolder::SOUND_OBJECTS& CGroupHierarchyHolder::sound_objects()
    const {
    VERIFY( m_sound_objects );
    return ( *m_sound_objects );
}

IC GroupHierarchyHolder::HIT_OBJECTS& CGroupHierarchyHolder::hit_objects()
    const {
