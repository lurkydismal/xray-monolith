...
void CScriptActionWrapper::setup( CScriptGameObject* object,
                                  CPropertyStorage* storage ) {
    ::luabind::call_member< void >( this, "setup", object, storage );
}

void CScriptActionWrapper::setup_static( CScriptActionBase* action,
...
// CScriptActionWrapper::_edge_value_type CScriptActionWrapper::weight	(const
...
// }
//
// CScriptActionWrapper::_edge_value_type CScriptActionWrapper::weight_static
