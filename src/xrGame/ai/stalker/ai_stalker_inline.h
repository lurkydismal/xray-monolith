...
IC const CAI_Stalker::CRITICAL_WOUND_WEIGHTS&
CAI_Stalker::critical_wound_weights() const {
...
IC void CAI_Stalker::set_aim_params( float max_angle,
                                     float min_angle,
                                     float min_speed,
                                     float predict_time ) {
...
IC float CAI_Stalker::aim_predict_time() const {
    ...
    return ( m_aim_predict_time < 0.f ? g_aim_predict_time
                                      : m_aim_predict_time );
}
...
// IC	float CAI_Stalker::pstl_queue_fire_dist_close
// () const
//{
...
// IC	float CAI_Stalker::shtg_queue_fire_dist_close
// () const
//{
...
// IC	float CAI_Stalker::snp_queue_fire_dist_close
// () const
//{
...
// IC	float CAI_Stalker::mchg_queue_fire_dist_close
// () const
//{
...
// IC	float CAI_Stalker::auto_queue_fire_dist_close
// () const
//{
