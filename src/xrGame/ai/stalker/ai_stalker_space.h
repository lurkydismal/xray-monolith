...
enum EStalkerSoundMasks {
    ...
    eStalkerSoundMaskFree =
        eStalkerSoundMaskNoHumming | eStalkerSoundMaskNonTriggered,
    eStalkerSoundMaskHumming = 1 | eStalkerSoundMaskFree,
    eStalkerSoundMaskNoDanger = ( 1 << 28 ),
    eStalkerSoundMaskDanger =
        eStalkerSoundMaskNoDanger | eStalkerSoundMaskNonTriggered,
    eStalkerSoundMaskAlarm = ( 1 << 0 ) | eStalkerSoundMaskDanger,
    eStalkerSoundMaskAttackNoAllies = ( 1 << 1 ) | eStalkerSoundMaskDanger,
    eStalkerSoundMaskAttackAlliesSingleEnemy =
        ( 1 << 2 ) | eStalkerSoundMaskDanger,
    eStalkerSoundMaskAttackAlliesSeveralEnemies =
        ( 1 << 3 ) | eStalkerSoundMaskDanger,
    ...
    eStalkerSoundMaskEnemyCriticallyWounded =
        ( 1 << 13 ) | eStalkerSoundMaskDanger,
    eStalkerSoundMaskEnemyKilledOrWounded =
        ( 1 << 14 ) | eStalkerSoundMaskDanger,
