...
CStateManagerPoltergeist::CStateManagerPoltergeist( CPoltergeist* obj )
    : inherited( obj ) {
    add_state( eStateRest,
               xr_new< CPoltergeistStateRest< CPoltergeist > >( obj ) );
    ...
    add_state( eStatePanic,
               xr_new< CStateMonsterPanic< CPoltergeist > >( obj ) );
    add_state( eStateHitted,
               xr_new< CStateMonsterHitted< CPoltergeist > >( obj ) );
    add_state(
        eStateHearInterestingSound,
        xr_new< CStateMonsterHearInterestingSound< CPoltergeist > >( obj ) );
    add_state(
        eStateHearDangerousSound,
        xr_new< CStateMonsterHearDangerousSound< CPoltergeist > >( obj ) );
}
...
void CStateManagerPoltergeist::polter_attack() {
    ...
    // (object->EnemyMan.get_enemy_time_last_seen() + TIME_SEEN_FOR_FIRE >
    // cur_time)) {
    //
