...
public:
    ...
    virtual const char* get_monster_class_name() { return "poltergeist"; }
...
class CPolterFlame : public CPolterSpecialAbility {
    ...
    enum EFlameState { ePrepare, eFire, eStop };
...
private:
    ...
    bool get_valid_flame_position( const CObject* target_object,
                                   Fvector& res_pos );
...
private:
    void tele_find_objects( xr_vector< CObject* >& objects,
                            const Fvector& pos );
