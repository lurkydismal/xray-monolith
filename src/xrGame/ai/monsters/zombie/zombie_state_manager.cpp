...
CStateManagerZombie::CStateManagerZombie( CZombie* obj ) : inherited( obj ) {
    ...
    add_state( eStateAttack,
               xr_new< CStateMonsterAttack< CZombie > >(
                   obj, xr_new< CStateZombieAttackRun< CZombie > >( obj ),
    ...
    add_state( eStateHearInterestingSound,
               xr_new< CStateMonsterHearInterestingSound< CZombie > >( obj ) );
    add_state( eStateControlled,
               xr_new< CStateMonsterControlled< CZombie > >( obj ) );
    add_state( eStateHearHelpSound,
               xr_new< CStateMonsterHearHelpSound< CZombie > >( obj ) );
}
