...
void CAI_Boar::Load( LPCSTR section ) {
    ...
    anim().AddAnim( eAnimStandLieDown, "stand_lie_down_", -1, &velocity_none,
                    PS_STAND, "fx_stand_f", "fx_stand_b", "fx_stand_l",
                    "fx_stand_r" );
    anim().AddAnim( eAnimLieStandUp, "lie_stand_up_", -1, &velocity_none,
    ...
    anim().AddAnim( eAnimDie, "stand_idle_", -1, &velocity_none, PS_STAND,
                    "fx_stand_f", "fx_stand_b", "fx_stand_l", "fx_stand_r" );
    anim().AddAnim( eAnimJumpLeft, "stand_jump_left_", -1, &velocity_turn,
                    PS_STAND, "fx_stand_f", "fx_stand_b", "fx_stand_l",
                    "fx_stand_r" );
    anim().AddAnim( eAnimJumpRight, "stand_jump_right_", -1, &velocity_turn,
                    PS_STAND, "fx_stand_f", "fx_stand_b", "fx_stand_l",
                    "fx_stand_r" );

    anim().AddAnim( eAnimRunTurnLeft, "stand_run_look_left_", -1, &velocity_run,
                    PS_STAND, "fx_stand_f", "fx_stand_b", "fx_stand_l",
                    "fx_stand_r" );
    anim().AddAnim( eAnimRunTurnRight, "stand_run_look_right_", -1,
                    &velocity_run, PS_STAND, "fx_stand_f", "fx_stand_b",
                    "fx_stand_l", "fx_stand_r" );
...
void CAI_Boar::reinit() {
    ...
    com_man().add_rotation_jump_data(
        ...
        SControlRotationJumpData::eStopAtOnce |
...
void CAI_Boar::CheckSpecParams( u32 spec_params ) {
    ...
    //	float yaw, pitch;
    //	Fvector().sub(EnemyMan.get_enemy()->Position(),
    //Position()).getHP(yaw,pitch); 	yaw *= -1; 	yaw = angle_normalize(yaw);
