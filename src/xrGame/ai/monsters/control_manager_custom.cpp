                                           ...
                                           u32 vel_mask_ground, u32 flags)
{
	...
	if (s2)
	{
		...
		m_jump->setup_data().flags.assign_or(SControlJumpData::ePrepareInMove);
	}
	...
	m_jump->setup_data().flags.assign_or(SControlJumpData::eGlidePlayAnimOnce);
	m_jump->setup_data().flags.assign_or(SControlJumpData::eGlideOnPrepareFailed);
