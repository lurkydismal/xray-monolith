...
#define CBloodsuckerStateAttackHideAbstract \
    CBloodsuckerStateAttackHide< _Object >

TEMPLATE_SPECIALIZATION
CBloodsuckerStateAttackHideAbstract::CBloodsuckerStateAttackHide( _Object* obj )
    : inherited( obj ) {
    add_state( eStateAttack_HideInCover,
               xr_new< CStateMonsterMoveToPointEx< _Object > >( obj ) );
    add_state( eStateAttack_CampInCover,
               xr_new< CStateBloodsuckerPredatorLite< _Object > >( obj ) );
}
