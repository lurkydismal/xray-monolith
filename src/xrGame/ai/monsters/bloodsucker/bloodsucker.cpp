...
char const* const partial_visibility_radius_string =
    "partial_visibility_radius";
char const* const visibility_state_change_min_delay_string =
...
void CAI_Bloodsucker::Load( LPCSTR section ) {
    ...
    if ( pSettings->line_exist( section, "is_no_fx" ) ) {
        anim().AddAnim( eAnimStandIdle, "stand_idle_", -1, &velocity_none,
                        PS_STAND );
        anim().AddAnim( eAnimStandDamaged, "stand_damaged_", -1, &velocity_none,
                        PS_STAND );
        anim().AddAnim( eAnimStandTurnLeft, "stand_turn_ls_", -1,
                        &velocity_turn, PS_STAND );
        anim().AddAnim( eAnimStandTurnRight, "stand_turn_rs_", -1,
                        &velocity_turn, PS_STAND );
        anim().AddAnim( eAnimSleep, "lie_sleep_", -1, &velocity_none, PS_LIE );
        anim().AddAnim( eAnimSleepStanding, { "stand_sleep_", true }, -1,
                        &velocity_none, PS_STAND );
        anim().AddAnim( eAnimWalkFwd, "stand_walk_fwd_", -1, &velocity_walk,
                        PS_STAND );
        anim().AddAnim( eAnimWalkDamaged, "stand_walk_fwd_dmg_", -1,
                        &velocity_walk_dmg, PS_STAND );
        anim().AddAnim( eAnimRun, "stand_run_", -1, &velocity_run, PS_STAND );
        anim().AddAnim( eAnimRunDamaged, "stand_run_dmg_", -1,
                        &velocity_run_dmg, PS_STAND );

        anim().AddAnim( eAnimRunTurnLeft, "stand_run_turn_left_", -1,
                        &velocity_run, PS_STAND );
        anim().AddAnim( eAnimRunTurnRight, "stand_run_turn_right_", -1,
                        &velocity_run, PS_STAND );
        anim().AddAnim( eAnimScared, "stand_scared_", -1, &velocity_none,
                        PS_STAND );

        anim().AddAnim( eAnimCheckCorpse, "stand_check_corpse_", -1,
                        &velocity_none, PS_STAND );
        ...
        anim().AddAnim( eAnimAttack, "stand_attack_", -1, &velocity_turn,
                        PS_STAND );
        anim().AddAnim( eAnimAttackRun, "stand_attack_run_", -1, &velocity_run,
                        PS_STAND );

        anim().AddAnim( eAnimLookAround, "stand_look_around_", -1,
                        &velocity_none, PS_STAND );
        anim().AddAnim( eAnimSitIdle, "sit_idle_", -1, &velocity_none, PS_SIT );
        anim().AddAnim( eAnimSitStandUp, "sit_stand_up_", -1, &velocity_none,
                        PS_SIT );
        anim().AddAnim( eAnimSitToSleep, "sit_sleep_down_", -1, &velocity_none,
                        PS_SIT );
        anim().AddAnim( eAnimStandSitDown, "stand_sit_down_", -1,
                        &velocity_none, PS_STAND );

        anim().AddAnim( eAnimSteal, "stand_steal_", -1, &velocity_steal,
                        PS_STAND );

        anim().AddAnim( eAnimThreaten, "stand_threaten_", -1, &velocity_none,
                        PS_STAND );
        anim().AddAnim( eAnimMiscAction_00, "stand_to_aggressive_", -1,
                        &velocity_none, PS_STAND );
    } else {
        anim().AddAnim( eAnimStandIdle, "stand_idle_", -1, &velocity_none,
                        PS_STAND, "fx_run_f", "fx_stand_b", "fx_stand_l",
                        "fx_stand_r" );
        anim().AddAnim( eAnimStandDamaged, "stand_damaged_", -1, &velocity_none,
                        PS_STAND, "fx_run_f", "fx_stand_b", "fx_stand_l",
                        "fx_stand_r" );
        anim().AddAnim( eAnimStandTurnLeft, "stand_turn_ls_", -1,
                        &velocity_turn, PS_STAND, "fx_run_f", "fx_stand_b",
                        "fx_stand_l", "fx_stand_r" );
        anim().AddAnim( eAnimStandTurnRight, "stand_turn_rs_", -1,
                        &velocity_turn, PS_STAND, "fx_run_f", "fx_stand_b",
                        "fx_stand_l", "fx_stand_r" );
        anim().AddAnim( eAnimSleep, "lie_sleep_", -1, &velocity_none, PS_LIE,
                        "fx_run_f", "fx_stand_b", "fx_stand_l", "fx_stand_r" );
        anim().AddAnim( eAnimSleepStanding, { "stand_sleep_", true }, -1,
                        &velocity_none, PS_STAND, "fx_run_f", "fx_stand_b",
                        "fx_stand_l", "fx_stand_r" );
        anim().AddAnim( eAnimWalkFwd, "stand_walk_fwd_", -1, &velocity_walk,
                        PS_STAND, "fx_run_f", "fx_stand_b", "fx_stand_l",
                        "fx_stand_r" );
        anim().AddAnim( eAnimWalkDamaged, "stand_walk_fwd_dmg_", -1,
                        &velocity_walk_dmg, PS_STAND, "fx_run_f", "fx_stand_b",
                        "fx_stand_l", "fx_stand_r" );
        anim().AddAnim( eAnimRun, "stand_run_", -1, &velocity_run, PS_STAND,
                        "fx_run_f", "fx_stand_b", "fx_stand_l", "fx_stand_r" );
        anim().AddAnim( eAnimRunDamaged, "stand_run_dmg_", -1,
                        &velocity_run_dmg, PS_STAND, "fx_run_f", "fx_stand_b",
                        "fx_stand_l", "fx_stand_r" );

        anim().AddAnim( eAnimRunTurnLeft, "stand_run_turn_left_", -1,
                        &velocity_run, PS_STAND, "fx_run_f", "fx_stand_b",
                        "fx_stand_l", "fx_stand_r" );
        anim().AddAnim( eAnimRunTurnRight, "stand_run_turn_right_", -1,
                        &velocity_run, PS_STAND, "fx_run_f", "fx_stand_b",
                        "fx_stand_l", "fx_stand_r" );
        ...
        anim().AddAnim( eAnimSitIdle, "sit_idle_", -1, &velocity_none, PS_SIT,
                        "fx_run_f", "fx_stand_b", "fx_stand_l", "fx_stand_r" );
        anim().AddAnim( eAnimSitStandUp, "sit_stand_up_", -1, &velocity_none,
                        PS_SIT, "fx_run_f", "fx_stand_b", "fx_stand_l",
                        "fx_stand_r" );
        anim().AddAnim( eAnimSitToSleep, "sit_sleep_down_", -1, &velocity_none,
                        PS_SIT, "fx_run_f", "fx_stand_b", "fx_stand_l",
                        "fx_stand_r" );
    ...
    invisible_vel.set(
        pSettings->r_float( section, "Velocity_Invisible_Linear" ),
        pSettings->r_float( section, "Velocity_Invisible_Angular" ) );
    movement().detail().add_velocity(
        MonsterMovement::eVelocityParameterInvisible,
        CDetailPathManager::STravelParams( invisible_vel.linear,
                                           invisible_vel.angular ) );
    ...
    m_vampire_gain_health = READ_IF_EXISTS( pSettings, r_float, section,
                                            "Vampire_GainHealth", 0.5f );
    m_vampire_distance =
        READ_IF_EXISTS( pSettings, r_float, section, "Vampire_Distance", 1.0f );
    m_sufficient_hits_before_vampire = READ_IF_EXISTS(
        pSettings, r_u32, section, "Vampire_Sufficient_Hits", 5 );
    m_sufficient_hits_before_vampire_random = -1 + ( rand() % 3 );

    invisible_particle_name =
        pSettings->r_string( section, "Particle_Invisible" );

    using namespace detail::bloodsucker;

    READ_IF_EXISTS( pSettings, r_float, section, "separate_factor", 0.f );

    m_critical_hit_chance =
        READ_IF_EXISTS( pSettings, r_float, section, "critical_hit_chance",
                        default_critical_hit_chance );
    m_visibility_state_change_min_delay = READ_IF_EXISTS(
        pSettings, r_u32, section, "visibility_state_change_min_delay",
    ...
    m_partial_visibility_radius = READ_IF_EXISTS(
        pSettings, r_float, section, partial_visibility_radius_string,
...
void CAI_Bloodsucker::reinit() {
    ...
    com_man().ta_fill_data(
        anim_triple_vampire, "vampire_0", "vampire_1", "vampire_2",
        TA_EXECUTE_LOOPED, TA_DONT_SKIP_PREPARE,
    ...
    // com_man().add_rotation_jump_data("run_turn_r_0","run_turn_r_1","run_turn_r_0","run_turn_r_1",
    // PI - 0.01f, SControlRotationJumpData::eStopAtOnce |
    // SControlRotationJumpData::eRotateOnce);
    com_man().add_rotation_jump_data( "run_turn_l_0", "run_turn_l_1",
                                      "run_turn_r_0", "run_turn_r_1",
                                      PI_DIV_2 );

    com_man().load_jump_data(
        "boloto_jump_prepare", 0, "boloto_jump_fly", "boloto_jump_end",
        u32( -1 ), MonsterMovement::eBloodsuckerVelocityParameterJumpGround,
        0 );
...
void CAI_Bloodsucker::reload( LPCSTR section ) {
    ...
    sound().add( pSettings->r_string( section, "Sound_Vampire_Grasp" ),
                 DEFAULT_SAMPLE_COUNT, SOUND_TYPE_MONSTER_ATTACKING,
                 MonsterSound::eHighPriority + 4, MonsterSound::eBaseChannel,
                 eVampireGrasp, "bip01_head" );
    sound().add( pSettings->r_string( section, "Sound_Vampire_Sucking" ),
                 DEFAULT_SAMPLE_COUNT, SOUND_TYPE_MONSTER_ATTACKING,
                 MonsterSound::eHighPriority + 3, MonsterSound::eBaseChannel,
                 eVampireSucking, "bip01_head" );
    sound().add( pSettings->r_string( section, "Sound_Vampire_Hit" ),
                 DEFAULT_SAMPLE_COUNT, SOUND_TYPE_MONSTER_ATTACKING,
                 MonsterSound::eHighPriority + 2, MonsterSound::eBaseChannel,
                 eVampireHit, "bip01_head" );
    sound().add( pSettings->r_string( section, "Sound_Vampire_StartHunt" ),
                 DEFAULT_SAMPLE_COUNT, SOUND_TYPE_MONSTER_ATTACKING,
                 MonsterSound::eHighPriority + 5, MonsterSound::eBaseChannel,
                 eVampireStartHunt, "bip01_head" );
    sound().add(
        pSettings->r_string( section, "Sound_Invisibility_Change_State" ),
        DEFAULT_SAMPLE_COUNT, SOUND_TYPE_MONSTER_ATTACKING,
        MonsterSound::eNormalPriority, MonsterSound::eChannelIndependent << 1,
        eChangeVisibility, "bip01_head" );
    sound().add( pSettings->r_string( section, "Sound_Growl" ),
                 DEFAULT_SAMPLE_COUNT, SOUND_TYPE_MONSTER_ATTACKING,
                 MonsterSound::eHighPriority + 6, MonsterSound::eBaseChannel,
                 eGrowl, "bip01_head" );
    sound().add(
        pSettings->r_string( section, "Sound_Alien" ), DEFAULT_SAMPLE_COUNT,
        SOUND_TYPE_MONSTER_ATTACKING, MonsterSound::eCriticalPriority,
...
void CAI_Bloodsucker::LoadVampirePPEffector( LPCSTR section ) {
    ...
    pp_vampire_effector.noise.intensity =
        pSettings->r_float( section, "noise_intensity" );
    pp_vampire_effector.noise.grain =
        pSettings->r_float( section, "noise_grain" );
    pp_vampire_effector.noise.fps = pSettings->r_float( section, "noise_fps" );
    VERIFY( !fis_zero( pp_vampire_effector.noise.fps ) );

    sscanf( pSettings->r_string( section, "color_base" ), "%f,%f,%f",
            &pp_vampire_effector.color_base.r,
            &pp_vampire_effector.color_base.g,
            &pp_vampire_effector.color_base.b );
    sscanf( pSettings->r_string( section, "color_gray" ), "%f,%f,%f",
            &pp_vampire_effector.color_gray.r,
            &pp_vampire_effector.color_gray.g,
            &pp_vampire_effector.color_gray.b );
    sscanf( pSettings->r_string( section, "color_add" ), "%f,%f,%f",
            &pp_vampire_effector.color_add.r, &pp_vampire_effector.color_add.g,
            &pp_vampire_effector.color_add.b );
}

void CAI_Bloodsucker::BoneCallback( CBoneInstance* B ) {
    CAI_Bloodsucker* this_class =
        static_cast< CAI_Bloodsucker* >( B->callback_param() );
...
void CAI_Bloodsucker::vfAssignBones() {
    ...
    bone_spine =
        &smart_cast< IKinematics* >( Visual() )
             ->LL_GetBoneInstance( smart_cast< IKinematics* >( Visual() )
                                       ->LL_BoneID( "bip01_spine" ) );
    bone_head =
        &smart_cast< IKinematics* >( Visual() )
             ->LL_GetBoneInstance( smart_cast< IKinematics* >( Visual() )
                                       ->LL_BoneID( "bip01_head" ) );
    if ( !PPhysicsShell() ) // нельзя ставить колбеки, если создан физ шел - у
                            // него стоят свои колбеки!!!
    {
...
void CAI_Bloodsucker::LookDirection( Fvector to_dir, float bone_turn_speed ) {
    ...
    // // текущий мировой угол монстра float bone_angle;
    // // угол для боны

    // float dy = _abs(angle_normalize_signed(yaw - cur_yaw));		//
    // дельта, на которую нужно поворачиваться
    ...
    // Bones.SetMotion(bone_head,	AXIS_X, bone_angle, bone_turn_speed,
    // 100);
...
void CAI_Bloodsucker::ActivateVampireEffector() {
    Actor()->Cameras().AddCamEffector( xr_new< CVampireCameraEffector >(
        6.0f, get_head_position( this ), get_head_position( Actor() ) ) );
    Actor()->Cameras().AddPPEffector(
        xr_new< CVampirePPEffector >( pp_vampire_effector, 6.0f ) );
}
...
float CAI_Bloodsucker::get_full_visibility_radius() {
    using namespace detail::bloodsucker;
    return override_if_debug( full_visibility_radius_string,
                              m_full_visibility_radius );
}

float CAI_Bloodsucker::get_partial_visibility_radius() {
    using namespace detail::bloodsucker;
    return override_if_debug( partial_visibility_radius_string,
                              m_partial_visibility_radius );
}

TTime CAI_Bloodsucker::get_visibility_state_change_min_delay() {
    using namespace detail::bloodsucker;
    return override_if_debug( visibility_state_change_min_delay_string,
                              m_visibility_state_change_min_delay );
}

CAI_Bloodsucker::visibility_t CAI_Bloodsucker::get_visibility_state() const {
    return m_force_visibility_state != unset ? m_force_visibility_state
                                             : m_visibility_state;
}
...
void CAI_Bloodsucker::update_invisibility() {
    ...
    } else if ( Device.dwTimeGlobal < m_runaway_invisible_time +
                                          default_runaway_invisible_time / 6 ) {
        set_visibility_state( partial_visibility );
    } else if ( Device.dwTimeGlobal <
                m_runaway_invisible_time + default_runaway_invisible_time ) {
...
void CAI_Bloodsucker::UpdateCL() {
    ...
    character_physics_support()->movement()->CollisionEnable(
        !is_collision_off() );
...
void CAI_Bloodsucker::set_drag_jump( CEntityAlive* e,
                                     LPCSTR s,
...
void CAI_Bloodsucker::start_drag() {
    if ( m_animated ) {
        ...
        smart_cast< IKinematicsAnimated* >( Visual() )
            ->PlayCycle( "boloto_attack_link_bone", TRUE, animation_end_jump,
                         this );
        m_animated = false;
    }
}
...
void CAI_Bloodsucker::animation_end_jump( CBlend* B ) {
    ...
    ( ( CAI_Bloodsucker* )B->CallbackParam )
        ->jump( ( ( CAI_Bloodsucker* )B->CallbackParam )->j_position,
...
void CAI_Bloodsucker::predator_start() {
    ...
    CParticlesPlayer::StartParticles( invisible_particle_name,
                                      Fvector().set( 0.0f, 0.1f, 0.0f ), ID() );
    sound().play( CAI_Bloodsucker::eChangeVisibility );
...
void CAI_Bloodsucker::move_actor_cam( float angle ) {
    if ( Actor()->cam_Active() ) {
        Actor()->cam_Active()->Move( Random.randI( 2 ) ? kRIGHT : kLEFT,
                                     angle );
        Actor()->cam_Active()->Move( Random.randI( 2 ) ? kUP : kDOWN, angle );
    }
}

void CAI_Bloodsucker::HitEntity( const CEntity* pEntity,
                                 float fDamage,
                                 float impulse,
                                 Fvector& dir,
...
bool CAI_Bloodsucker::done_enough_hits_before_vampire() {
    return ( int )m_hits_before_vampire >=
           ( int )m_sufficient_hits_before_vampire +
...
CBaseMonster::SDebugInfo CAI_Bloodsucker::show_debug_info() {
    ...
    string128 text;
    xr_sprintf( text, "Vampire Want Value = [%f] Speed = [%f]",
                m_vampire_want_value, m_vampire_want_speed );
    DBG().text( this ).add_item( text, info.x, info.y += info.delta_y,
                                 info.color );
    DBG().text( this ).add_item( "---------------------------------------",
                                 info.x, info.y += info.delta_y,
...
void CAI_Bloodsucker::debug_on_key( int key ) {
    switch ( key ) {
        case DIK_MINUS:
            ...
            break;
        case DIK_EQUALS:
            Actor()->cam_Active()->Move( Random.randI( 2 ) ? kUP : kDOWN,
                                         PI_DIV_2 );
