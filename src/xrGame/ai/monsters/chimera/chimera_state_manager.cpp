...
CStateManagerChimera::CStateManagerChimera( CChimera* obj ) : inherited( obj ) {
    ...
    add_state( eStateHearInterestingSound,
               xr_new< CStateMonsterHearInterestingSound< CChimera > >( obj ) );
    add_state( eStateHearDangerousSound,
               xr_new< CStateMonsterHearDangerousSound< CChimera > >( obj ) );
    // 	add_state(eStateHitted,
    // xr_new<CStateMonsterHitted<CChimera> >
    // (obj)); 	add_state(eStateThreaten,
    // xr_new<CStateChimeraThreaten<CChimera> >				(obj));
    // 	add_state(eStateCustom,
    // xr_new<CStateMonsterTestState<CChimera> >
    // (obj));
}
