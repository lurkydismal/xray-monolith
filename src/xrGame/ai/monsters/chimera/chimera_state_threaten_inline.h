...
CStateChimeraThreatenAbstract::CStateChimeraThreaten( _Object* obj )
    ...
    this->add_state( eStateWalk,
                     xr_new< CStateChimeraThreatenWalk< _Object > >( obj ) );
    this->add_state( eStateThreaten,
                     xr_new< CStateChimeraThreatenRoar< _Object > >( obj ) );
    this->add_state( eStateSteal,
                     xr_new< CStateChimeraThreatenSteal< _Object > >( obj ) );
}
