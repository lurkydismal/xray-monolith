...
CStateChimeraHuntingAbstract::CStateChimeraHunting( _Object* obj )
    : inherited( obj ) {
    add_state( eStateMoveToCover,
               xr_new< CStateChimeraHuntingMoveToCover< _Object > >( obj ) );
    add_state( eStateComeOut,
               xr_new< CStateChimeraHuntingComeOut< _Object > >( obj ) );
}
