...
CStateManagerSnork::CStateManagerSnork( CSnork* obj ) : inherited( obj ) {
    ...
    add_state( eStateHearInterestingSound,
               xr_new< CStateMonsterHearInterestingSound< CSnork > >( obj ) );
    add_state( eStateHearDangerousSound,
               xr_new< CStateMonsterHearDangerousSound< CSnork > >( obj ) );
    add_state( eStateHitted, xr_new< CStateMonsterHitted< CSnork > >( obj ) );

    add_state( eStateFindEnemy,
               xr_new< CStateMonsterTestCover< CSnork > >( obj ) );
    add_state( eStateHearHelpSound,
               xr_new< CStateMonsterHearHelpSound< CSnork > >( obj ) );
}
...
void CStateManagerSnork::execute() {
    ...
    if ( ( current_substate == eStateAttack ) &&
         ( current_substate != prev_substate ) ) {
