...
CStateManagerController::CStateManagerController( CController* obj )
    : inherited( obj ) {
    ...
    add_state( eStateCustom,
               xr_new< CStateControlHide< CController > >( obj ) );
}

bool CStateManagerController::check_control_start_conditions(
