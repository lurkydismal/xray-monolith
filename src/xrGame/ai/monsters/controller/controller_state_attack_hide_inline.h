...
void CStateControllerHideAbstract::select_target_point() {
    ...
    m_state_fast_run =
        ( target.position.distance_to( this->object->Position() ) > 20.f );
