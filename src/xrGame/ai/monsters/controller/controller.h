...
public:
    ...
    void OnFreedFromControl(
        const CEntity* ); // если монстр сам себя освободил (destroyed || die)
...
public:
    enum EMentalState { eStateIdle, eStateDanger } m_mental_state;
...
public:
    ...
    virtual const char* get_monster_class_name() { return "controller"; }
