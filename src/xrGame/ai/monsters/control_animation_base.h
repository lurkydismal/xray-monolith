...
public:
    ...
    void AddTransition( EMotionAnim from,
                        EMotionAnim to,
                        EMotionAnim trans,
                        bool chain,
                        bool skip_aggressive = false );
    void AddTransition( EMotionAnim from,
                        EPState to,
                        EMotionAnim trans,
                        bool chain,
                        bool skip_aggressive = false );
    void AddTransition( EPState from,
                        EMotionAnim to,
                        EMotionAnim trans,
                        bool chain,
                        bool skip_aggressive = false );
    ...
    void AddReplacedAnim( bool* b_flag,
...
public:
    ...
    bool accel_chain_get( float cur_speed,
...
public:
    ...
    float get_animation_length( EMotionAnim anim,
                                u32 index ) const; // anim must exist
    bool get_animation_info( EMotionAnim anim,
                             u32 index,
                             MotionID& motion,
                             float& length ) const;
    ...
    void set_override_animation( EMotionAnim anim = eAnimUndefined,
                                 u32 index = -1 );
    void set_override_animation_script( EMotionAnim anim = eAnimUndefined,
                                        u32 index = -1 );
