...
Fvector get_bone_position( CObject* object, LPCSTR bone_name ) {
    u16 bone_id =
        smart_cast< IKinematics* >( object->Visual() )->LL_BoneID( bone_name );
    CBoneInstance& bone = smart_cast< IKinematics* >( object->Visual() )
