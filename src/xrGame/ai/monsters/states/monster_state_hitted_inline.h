...
CStateMonsterHittedAbstract::CStateMonsterHitted( _Object* obj )
    : inherited( obj ) {
    add_state( eStateHitted_Hide,
               xr_new< CStateMonsterHittedHide< _Object > >( obj ) );
    add_state( eStateHitted_MoveOut,
               xr_new< CStateMonsterHittedMoveOut< _Object > >( obj ) );
    add_state( eStateHitted_Home,
