...
CStateMonsterTestStateAbstract::CStateMonsterTestState( _Object* obj )
    : inherited( obj ) {
...
TEMPLATE_SPECIALIZATION
CStateMonsterTestCoverAbstract::CStateMonsterTestCover( _Object* obj )
    : inherited( obj ) {
    this->add_state( eStateAttack_HideInCover,
                     xr_new< CStateMonsterMoveToPointEx< _Object > >( obj ) );
    this->add_state( eStateAttack_CampInCover,
