...
CStateMonsterEatAbstract::CStateMonsterEat( _Object* obj ) : inherited( obj ) {
    ...
    this->add_state( eStateEat_Eat,
                     xr_new< CStateMonsterEating< _Object > >( obj ) );
    ...
    this->add_state( eStateEat_Drag,
                     xr_new< CStateMonsterDrag< _Object > >( obj ) );
}
...
void CStateMonsterEatAbstract::initialize() {
    ...
    monster_squad()
        ...
        ->lock_corpse( this->object->CorpseMan.get_corpse() );
}
...
void CStateMonsterEatAbstract::finalize() {
    ...
    monster_squad()
        .get_squad( this->object )
        ->unlock_corpse( this->object->CorpseMan.get_corpse() );
}
...
void CStateMonsterEatAbstract::setup_substates() {
    ...
    if ( this->current_substate == eStateEat_CorpseApproachRun ) {
        ...
        DBG().level_info( this ).add_item( nearest_bone_pos, pos1,
                                           COLOR_GREEN );
#endif
...
bool CStateMonsterEatAbstract::check_start_conditions() {
    return ( this->object->CorpseMan.get_corpse() &&
             this->object->Home->at_home(
                 this->object->CorpseMan.get_corpse()->Position() ) &&
             hungry() &&
             !monster_squad()
                  .get_squad( this->object )
                  ->is_locked_corpse( this->object->CorpseMan.get_corpse() ) );
}
