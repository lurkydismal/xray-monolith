...
#define CStateMonsterHearDangerousSoundAbstract \
    CStateMonsterHearDangerousSound< _Object >

TEMPLATE_SPECIALIZATION
CStateMonsterHearDangerousSoundAbstract::CStateMonsterHearDangerousSound(
    _Object* obj )
    : inherited( obj ) {
    add_state( eStateHearDangerousSound_Hide,
               xr_new< CStateMonsterHideFromPoint< _Object > >( obj ) );
    add_state( eStateHearDangerousSound_FaceOpenPlace,
               xr_new< CStateMonsterLookToUnprotectedArea< _Object > >( obj ) );
    add_state( eStateHearDangerousSound_StandScared,
