...
CStateMonsterSquadRestAbstract::CStateMonsterSquadRest( _Object* obj )
    : inherited( obj ) {
    this->add_state( eStateSquad_Rest_Idle,
                     xr_new< CStateMonsterCustomAction< _Object > >( obj ) );
    this->add_state( eStateSquad_Rest_WalkAroundLeader,
...
void CStateMonsterSquadRestAbstract::reselect_state() {
    this->select_state( Random.randI( 2 ) ? eStateSquad_Rest_Idle
                                          : eStateSquad_Rest_WalkAroundLeader );
}
