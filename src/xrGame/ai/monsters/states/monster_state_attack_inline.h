...
CStateMonsterAttackAbstract::CStateMonsterAttack( _Object* obj )
    : inherited( obj ) {
    this->add_state( eStateAttack_Run,
                     xr_new< CStateMonsterAttackRun< _Object > >( obj ) );
    ...
    this->add_state( eStateAttack_Steal,
                     xr_new< CStateMonsterSteal< _Object > >( obj ) );
    this->add_state( eStateAttackCamp,
                     xr_new< CStateMonsterAttackCamp< _Object > >( obj ) );
    this->add_state(
...
bool CStateMonsterAttackAbstract::check_find_enemy_state() {
    ...
    if ( this->object->EnemyMan.get_enemy_time_last_seen() + FIND_ENEMY_DELAY <
         Device.dwTimeGlobal )
        return true;
    return false;
}
...
bool CStateMonsterAttackAbstract::check_run_away_state() {
    ...
    } else if ( ( this->object->EnemyMan.get_enemy() != Actor() ) &&
                this->object->Morale.is_despondent() &&
...
bool CStateMonsterAttackAbstract::check_run_attack_state() {
    ...
    if ( this->prev_substate == eStateAttack_Run ) {
        if ( this->get_state( eStateAttack_RunAttack )
                 ->check_start_conditions() )
            return true;
