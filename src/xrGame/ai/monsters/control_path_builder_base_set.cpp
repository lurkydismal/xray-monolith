...
//////////////////////////////////////////////////////////////////////////
void CControlPathBuilderBase::set_target_point( const Fvector& position,
                                                u32 node ) {
    // обновить актуальность
    m_target_actual =
        m_target_actual && ( m_target_set.position().similar( position ) &&
                             ( m_target_set.node() == node ) );
...
void CControlPathBuilderBase::set_retreat_from_point(
