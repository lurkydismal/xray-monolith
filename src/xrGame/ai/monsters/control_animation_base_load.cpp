...
void CControlAnimationBase::AddAnim( EMotionAnim ma,
                                     std::pair< LPCSTR, bool > target,
                                     int s_id,
                                     SVelocityParam* vel,
                                     EPState p_s,
                                     std::pair< LPCSTR, bool > fx_front,
                                     std::pair< LPCSTR, bool > fx_back,
                                     std::pair< LPCSTR, bool > fx_left,
                                     std::pair< LPCSTR, bool > fx_right ) {
...
void CControlAnimationBase::AddAnim( EMotionAnim ma,
                                     ...
                                     std::pair< LPCSTR, bool > fx_left,
                                     std::pair< LPCSTR, bool > fx_right ) {
    AddAnim( ma, { tn, false }, s_id, vel, p_s, fx_front, fx_back, fx_left,
             fx_right );
}
...
void CControlAnimationBase::AddAnim( EMotionAnim ma,
                                     ...
                                     LPCSTR fx_left,
                                     LPCSTR fx_right ) {
    AddAnim( ma, { tn, false }, s_id, vel, p_s, { fx_front, false },
             { fx_back, false }, { fx_left, false }, { fx_right, false } );
...
void CControlAnimationBase::AddAnim( EMotionAnim ma,
                                     ...
                                     LPCSTR fx_left,
                                     LPCSTR fx_right ) {
    AddAnim( ma, target, s_id, vel, p_s, { fx_front, false },
             { fx_back, false }, { fx_left, false }, { fx_right, false } );
    m_anim_storage[ ma ]->fxs.may_not_exist.reset();
}
...
void CControlAnimationBase::AddTransition( EMotionAnim from,
                                           EMotionAnim to,
                                           EMotionAnim trans,
                                           bool chain,
...
void CControlAnimationBase::AddTransition( EPState from,
                                           EMotionAnim to,
                                           EMotionAnim trans,
                                           bool chain,
                                           bool skip_aggressive ) {
...
void CControlAnimationBase::LinkAction( EAction act,
...
void CControlAnimationBase::AddReplacedAnim( bool* b_flag,
                                             EMotionAnim pmt_cur_anim,
                                             EMotionAnim pmt_new_anim ) {
    SReplacedAnim ra;
