...
// Verdatim: Flag for allowing falling state to count for dodging Earthquake
// ability
...
void CPseudoGigant::Load( LPCSTR section ) {
    ...
    // anim().AddReplacedAnim(&m_bRunTurnLeft,		eAnimRun,
    // eAnimRunTurnLeft); anim().AddReplacedAnim(&m_bRunTurnRight,
    // eAnimRun,		eAnimRunTurnRight);

    anim().accel_load( section );
    // anim().accel_chain_add		(eAnimWalkFwd,		eAnimRun);
    // anim().accel_chain_add		(eAnimWalkFwd,
    // eAnimRunTurnLeft); anim().accel_chain_add		(eAnimWalkFwd,
    // eAnimRunTurnRight); anim().accel_chain_add
    // (eAnimWalkDamaged,	eAnimRunDamaged);

    step_effector.time = pSettings->r_float( section, "step_effector_time" );
    step_effector.amplitude =
        pSettings->r_float( section, "step_effector_amplitude" );
    step_effector.period_number =
        pSettings->r_float( section, "step_effector_period_number" );
    ...
    anim().AddAnim( eAnimStandTurnLeft, "stand_turn_ls_", -1, &velocity_turn,
                    PS_STAND, "fx_stand_f", "fx_stand_b", "fx_stand_l",
                    "fx_stand_r" );
    anim().AddAnim( eAnimStandTurnRight, "stand_turn_rs_", -1, &velocity_turn,
                    PS_STAND, "fx_stand_f", "fx_stand_b", "fx_stand_l",
                    "fx_stand_r" );
    anim().AddAnim( eAnimLieIdle, "stand_sleep_", -1, &velocity_none, PS_LIE,
                    "fx_stand_f", "fx_stand_b", "fx_stand_l", "fx_stand_r" );
    anim().AddAnim( eAnimSitIdle, "sit_idle_", -1, &velocity_none, PS_SIT,
                    "fx_stand_f", "fx_stand_b", "fx_stand_l", "fx_stand_r" );
    anim().AddAnim( eAnimSleep, "stand_sleep_", -1, &velocity_none, PS_LIE,
                    "fx_stand_f", "fx_stand_b", "fx_stand_l", "fx_stand_r" );
    anim().AddAnim( eAnimWalkFwd, "stand_walk_fwd_", -1, &velocity_walk,
                    PS_STAND, "fx_stand_f", "fx_stand_b", "fx_stand_l",
                    "fx_stand_r" );
    anim().AddAnim( eAnimWalkDamaged, "stand_walk_fwd_dmg_", -1,
                    &velocity_walk_dmg, PS_STAND, "fx_stand_f", "fx_stand_b",
                    "fx_stand_l", "fx_stand_r" );
    anim().AddAnim( eAnimRun, "stand_walk_fwd_", -1, &velocity_walk, PS_STAND,
                    "fx_stand_f", "fx_stand_b", "fx_stand_l", "fx_stand_r" );
    anim().AddAnim( eAnimRunDamaged, "stand_walk_fwd_dmg_", -1,
                    &velocity_walk_dmg, PS_STAND, "fx_stand_f", "fx_stand_b",
                    "fx_stand_l", "fx_stand_r" );
    anim().AddAnim( eAnimEat, "stand_eat_", -1, &velocity_none, PS_STAND,
                    "fx_stand_f", "fx_stand_b", "fx_stand_l", "fx_stand_r" );
    anim().AddAnim( eAnimAttack, "stand_attack_", -1, &velocity_none, PS_STAND,
                    "fx_stand_f", "fx_stand_b", "fx_stand_l", "fx_stand_r" );
    anim().AddAnim( eAnimLookAround, "stand_idle_", -1, &velocity_none,
                    PS_STAND, "fx_stand_f", "fx_stand_b", "fx_stand_l",
                    "fx_stand_r" );
    ...
    anim().AddAnim( eAnimDie, "stand_idle_", -1, &velocity_none, PS_STAND,
                    "fx_stand_f", "fx_stand_b", "fx_stand_l", "fx_stand_r" );
    anim().AddAnim( eAnimStandLieDown, "stand_lie_down_", -1, &velocity_none,
                    PS_STAND, "fx_stand_f", "fx_stand_b", "fx_stand_l",
                    "fx_stand_r" );
    anim().AddAnim( eAnimLieToSleep, "lie_to_sleep_", -1, &velocity_none,
                    PS_LIE, "fx_stand_f", "fx_stand_b", "fx_stand_l",
                    "fx_stand_r" );
    ...
    // -1, &velocity_turn,		PS_STAND,	"fx_stand_f",
    // "fx_stand_b", "fx_stand_l", "fx_stand_r");
    // anim().AddAnim(eAnimStandTurnRight,	"stand_turn_rs_",
    // -1, &velocity_turn,		PS_STAND,	"fx_stand_f",
    // "fx_stand_b", "fx_stand_l", "fx_stand_r"); anim().AddAnim(eAnimLieIdle,
    // "stand_sleep_",			-1, &velocity_none,		PS_LIE,
    // "fx_stand_f", "fx_stand_b", "fx_stand_l", "fx_stand_r");
    // anim().AddAnim(eAnimSitIdle,		"sit_idle_",
    // -1, &velocity_none,		PS_SIT,		"fx_stand_f",
    // "fx_stand_b", "fx_stand_l", "fx_stand_r"); anim().AddAnim(eAnimSleep,
    // "stand_sleep_",			-1, &velocity_none,		PS_LIE,
    // "fx_stand_f", "fx_stand_b", "fx_stand_l", "fx_stand_r");
    // anim().AddAnim(eAnimWalkFwd,		"stand_walk_fwd_",
    // -1, &velocity_walk,		PS_STAND,	"fx_stand_f",
    // "fx_stand_b", "fx_stand_l", "fx_stand_r");
    // anim().AddAnim(eAnimWalkDamaged,	"stand_walk_fwd_dmg_",	-1,
    // &velocity_walk_dmg,	PS_STAND,	"fx_stand_f", "fx_stand_b",
    // "fx_stand_l", "fx_stand_r"); anim().AddAnim(eAnimRun,
    // "stand_run_fwd_",		-1,	&velocity_run, PS_STAND,
    // "fx_stand_f", "fx_stand_b", "fx_stand_l", "fx_stand_r");
    // anim().AddAnim(eAnimRunDamaged,		"stand_run_dmg_",
    // -1,	&velocity_run_dmg,	PS_STAND,	"fx_stand_f",
    // "fx_stand_b", "fx_stand_l", "fx_stand_r"); anim().AddAnim(eAnimEat,
    // "stand_eat_",			-1, &velocity_none, PS_STAND,
    // "fx_stand_f", "fx_stand_b", "fx_stand_l", "fx_stand_r");
    // anim().AddAnim(eAnimAttack,			"stand_attack_",
    // -1, &velocity_turn,		PS_STAND,	"fx_stand_f",
    // "fx_stand_b", "fx_stand_l", "fx_stand_r");
    // anim().AddAnim(eAnimLookAround,		"stand_idle_",
    // -1, &velocity_none,		PS_STAND,	"fx_stand_f",
    // "fx_stand_b", "fx_stand_l", "fx_stand_r"); anim().AddAnim(eAnimSteal,
    // "stand_steal_",			-1, &velocity_steal,	PS_STAND,
    // "fx_stand_f", "fx_stand_b", "fx_stand_l", "fx_stand_r");
    // anim().AddAnim(eAnimDie,			"stand_idle_",
    // -1, &velocity_none,		PS_STAND,	"fx_stand_f",
    // "fx_stand_b", "fx_stand_l", "fx_stand_r");
    // anim().AddAnim(eAnimStandLieDown,	"stand_lie_down_",
    // -1, &velocity_none,		PS_STAND,	"fx_stand_f",
    // "fx_stand_b", "fx_stand_l", "fx_stand_r");
    // anim().AddAnim(eAnimLieToSleep,		"lie_to_sleep_",
    // -1, &velocity_none,		PS_LIE,		"fx_stand_f",
    // "fx_stand_b", "fx_stand_l", "fx_stand_r"); anim().AddAnim(eAnimThreaten,
    // "stand_kick_",			-1, &velocity_none, PS_STAND,
    // "fx_stand_f", "fx_stand_b", "fx_stand_l", "fx_stand_r");

    // 	anim().AddAnim(eAnimRunTurnLeft,	"stand_run_left_",
    // -1, &velocity_run,		PS_STAND);
    // 	anim().AddAnim(eAnimRunTurnRight,	"stand_run_right_",
    // -1, &velocity_run,		PS_STAND);
    ...
    // define transitions
    anim().AddTransition( eAnimStandLieDown, eAnimSleep, eAnimLieToSleep,
                          false );
    ...
    m_threaten_effector.ppi.duality.h =
        pSettings->r_float( ppi_section, "duality_h" );
    m_threaten_effector.ppi.duality.v =
    ...
    m_threaten_effector.ppi.noise.intensity =
        pSettings->r_float( ppi_section, "noise_intensity" );
    m_threaten_effector.ppi.noise.grain =
        pSettings->r_float( ppi_section, "noise_grain" );
    m_threaten_effector.ppi.noise.fps =
    ...
    m_threaten_effector.ce_power =
        pSettings->r_float( ppi_section, "ce_power" );

    // --------------------------------------------------------------------------------

    ::Sound->create( m_sound_threaten_hit,
                     pSettings->r_string( section, "sound_threaten_hit" ),
                     st_Effect, SOUND_TYPE_WORLD );
    ::Sound->create( m_sound_start_threaten,
                     pSettings->r_string( section, "sound_threaten_start" ),
                     st_Effect, SOUND_TYPE_MONSTER_ATTACKING );

    m_kick_damage = pSettings->r_float( section, "HugeKick_Damage" );
    m_kick_particles = pSettings->r_string( section, "HugeKick_Particles" );
    read_distance( section, "HugeKick_MinMaxDist", m_threaten_dist_min,
                   m_threaten_dist_max );
    read_delay( section, "HugeKick_MinMaxDelay", m_threaten_delay_min,
                m_threaten_delay_max );

    m_time_kick_actor_slow_down =
        pSettings->r_u32( section, "HugeKick_Time_SlowDown" );
...
void CPseudoGigant::reinit() {
    ...
    move().load_velocity( *cNameSect(), "Velocity_JumpPrepare",
                          MonsterMovement::eGiantVelocityParameterJumpPrepare );
    move().load_velocity( *cNameSect(), "Velocity_JumpGround",
                          MonsterMovement::eGiantVelocityParameterJumpGround );

    // com_man().load_jump_data(0,"jump_attack_0", "jump_attack_1",
    // "jump_attack_2", MonsterMovement::eGiantVelocityParameterJumpPrepare,
    ...
    if ( pActor ) {
        ...
        if ( dist_to_actor < max_dist )
            Actor()->Cameras().AddCamEffector(
                xr_new< CPseudogigantStepEffector >(
                    step_effector.time, step_effector.amplitude,
                    step_effector.period_number,
...
void CPseudoGigant::on_activate_control( ControlCom::EControlType type ) {
    if ( type == ControlCom::eControlThreaten ) {
        ...
        m_time_next_threaten =
            time() + Random.randI( m_threaten_delay_min, m_threaten_delay_max );
        ...
        for ( u32 i = 0; i < m_nearest.size(); i++ ) {
            CPhysicsShellHolder* obj =
                smart_cast< CPhysicsShellHolder* >( m_nearest[ i ] );
            if ( obj && obj->ID() != 0 && obj->ID() != ID() ) {
                ::luabind::functor< void > funct;
                if ( ai().script_engine().functor(
                         "_G.CPseudoGigant__OnStartStompAnimation", funct ) ) {
...
void CPseudoGigant::on_threaten_execute() {
    ...
    for ( u32 i = 0; i < m_nearest.size(); i++ ) {
        ...
        if ( pseudogiantCanDamageObjects && obj && obj->ID() != 0 &&
             obj->ID() != ID() ) {
            float dist_to_enemy = obj->Position().distance_to( Position() );
            float hit_value;
            hit_value = m_kick_damage -
                        m_kick_damage * dist_to_enemy / m_threaten_dist_max;
            ...
            HS.power = hit_value;
            HS.boneID =
                smart_cast< IKinematics* >( obj->Visual() )->LL_GetBoneRoot();
            HS.p_in_bone_space = Fvector().set( 0.f, 0.f, 0.f );

            HS.impulse =
                obj->cast_entity_alive() && obj->cast_entity_alive()->g_Alive()
                    ? 80 * 80
                    : 0; // 0 impulse for not alive objects, they will receive
                         // the impulse later
            // HS.impulse = 80 *
            // obj->character_physics_support()->movement()->GetMass();
            ...
            if ( ai().script_engine().functor(
                     "_G.CPseudoGigant__BeforeHitCallback", funct ) ) {
                doHit = funct( obj->lua_game_object(), this->lua_game_object(),
                               &tLuaHit, HS.boneID );
                if ( doHit ) {
            ...
            if ( doHit ) {
                // Msg("hit entity %d, name %s, damage %f", obj->ID(),
                // obj->Name(), hit_value);
                obj->Hit( &HS );

                ::luabind::functor< void > hitFunct;
                if ( ai().script_engine().functor(
                         "_G.CPseudoGigant__HitCallback", hitFunct ) ) {
                    hitFunct( obj->lua_game_object(), this->lua_game_object(),
                              &tLuaHit, HS.boneID );
                }
        ...
        dir.normalize();
        obj->m_pPhysicsShell->applyImpulse(
            dir, 20 * obj->m_pPhysicsShell->getMass() );
    }
    ...
    g_pGamePersistent->GrassBendersAddExplosion(
        ID(), pos, Fvector().set( 0, -99, 0 ), 1.33f, 5.0f,
        ps_ssfx_grass_interactive.w, 20 );
    ...
    if ( ( pA->MovingState() & ACTOR_DEFS::mcJump ) != 0 )
        return;
    if ( pseudogiantDodgeWhileFalling &&
         ( pA->MovingState() & ACTOR_DEFS::mcFall ) != 0 )
        return;

    float dist_to_enemy = pA->Position().distance_to( Position() );
    float hit_value;
    hit_value =
        m_kick_damage - m_kick_damage * dist_to_enemy / m_threaten_dist_max;
    clamp( hit_value, 0.f, 1.f );

    // запустить эффектор
    Actor()->Cameras().AddCamEffector( xr_new< CMonsterEffectorHit >(
        m_threaten_effector.ce_time,
    ...
    Actor()->Cameras().AddPPEffector( xr_new< CMonsterEffector >(
        m_threaten_effector.ppi, m_threaten_effector.time,
        m_threaten_effector.time_attack, m_threaten_effector.time_release,
        hit_value ) );

    // развернуть камеру
    if ( pA->cam_Active() ) {
        pA->cam_Active()->Move( Random.randI( 2 ) ? kRIGHT : kLEFT,
                                Random.randF( 0.3f * hit_value ) );
        pA->cam_Active()->Move( Random.randI( 2 ) ? kUP : kDOWN,
                                Random.randF( 0.3f * hit_value ) );
    }
    ...
    HS.GenHeader( GE_HIT,
                  pA->ID() ); //	u_EventGen	(l_P,GE_HIT, pA->ID());
    HS.whoID = ( ID() );      //	l_P.w_u16	(ID());
    HS.weaponID = ( ID() );   //	l_P.w_u16	(ID());
    HS.dir = ( Fvector().set(
        0.f, 1.f, 0.f ) );    //	l_P.w_dir	(Fvector().set(0.f,1.f,0.f));
    HS.power = ( hit_value ); //	l_P.w_float	(m_kick_damage);
    HS.boneID =
        ( smart_cast< IKinematics* >( pA->Visual() )->LL_GetBoneRoot() );
    //	l_P.w_s16
    //(smart_cast<IKinematics*>(pA->Visual())->LL_GetBoneRoot());
    HS.p_in_bone_space = ( Fvector().set(
        0.f, 0.f, 0.f ) ); //	l_P.w_vec3	(Fvector().set(0.f,0.f,0.f));
    HS.impulse =
