...
CStateManagerCat::CStateManagerCat( CCat* obj ) : inherited( obj ) {
    ...
    add_state( eStateHearInterestingSound,
               xr_new< CStateMonsterHearInterestingSound< CCat > >( obj ) );
    add_state( eStateHearDangerousSound,
               xr_new< CStateMonsterHearDangerousSound< CCat > >( obj ) );
    add_state( eStateHitted, xr_new< CStateMonsterHitted< CCat > >( obj ) );

    add_state( eStateThreaten,
               xr_new< CStateMonsterLookActor< CCat > >( obj ) );
    add_state( eStateHearHelpSound,
               xr_new< CStateMonsterHearHelpSound< CCat > >( obj ) );
