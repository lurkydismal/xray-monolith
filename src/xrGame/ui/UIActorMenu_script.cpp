...
bool CUIActorMenu::CanRepairItem( PIItem item ) {
    ...
    if ( EItm ) {
        bool allow_repair = !!READ_IF_EXISTS( pSettings, r_bool, item_name,
                                              "allow_repair", false );
        if ( !allow_repair )
            return false;
    }
    ...
    R_ASSERT2( ai().script_engine().functor(
                   "inventory_upgrades.can_repair_item", funct ),
               make_string( "Failed to get functor "
                            "<inventory_upgrades.can_repair_item>, item = %s",
                            item_name ) );
...
LPCSTR CUIActorMenu::RepairQuestion( PIItem item, bool can_repair ) {
    ...
    R_ASSERT2(
        ai().script_engine().functor( "inventory_upgrades.question_repair_item",
                                      funct2 ),
        make_string( "Failed to get functor "
                     "<inventory_upgrades.question_repair_item>, item = %s",
                     item_name ) );
    LPCSTR question = funct2( item->m_section_id.c_str(), item->GetCondition(),
                              can_repair, partner );
...
void CUIActorMenu::TryRepairItem( CUIWindow* w, void* d ) {
    ...
    R_ASSERT2(
        ai().script_engine().functor(
            "inventory_upgrades.can_afford_repair_item", funct ),
        make_string( "Failed to get functor "
                     "<inventory_upgrades.can_afford_repair_item>, item = %s",
                     item_name ) );
...
void CUIActorMenu::RepairEffect_CurItem() {
    ...
    R_ASSERT( ai().script_engine().functor(
        "inventory_upgrades.effect_repair_item", funct ) );
...
bool CUIActorMenu::CanUpgradeItem( PIItem item ) {
    ...
    ::luabind::functor< bool > funct;
    R_ASSERT2(
        ai().script_engine().functor( "inventory_upgrades.can_upgrade_item",
                                      funct ),
        make_string(
            "Failed to get functor <inventory_upgrades.can_upgrade_item>, item "
            "= %s, mechanic = %s",
            item_name, partner ) );
...
void CUIActorMenu::CurModeToScript() {
    ...
    ::luabind::functor< void > funct;
    R_ASSERT(
        ai().script_engine().functor( "actor_menu.actor_menu_mode", funct ) );
    funct( mode );
}

void CUIActorMenu::HighlightSectionInSlot( LPCSTR section,
                                           u8 type,
                                           u16 slot_id ) {
...
void CUIActorMenu::HighlightForEachInSlot(
    ...
    for ( u32 i = 0; i < cnt; ++i ) {
        ...
        if ( functor( item->object().cast_game_object()->lua_game_object() ) ==
             false )
            continue;
        ...
        [ class_< enum_exporter< EDDListType > >( "EDDListType" )
              .enum_( "EDDListType" )
                  [ value( "iActorBag", int( EDDListType::iActorBag ) ),
                    ...
                    value( "iPartnerTradeBag",
                           int( EDDListType::iPartnerTradeBag ) ),
          ...
          class_< CUIActorMenu, CUIDialogWnd, CUIWndCallback >( "CUIActorMenu" )
              ...
              .def( "highlight_section_in_slot",
                    &CUIActorMenu::HighlightSectionInSlot )
              .def( "highlight_for_each_in_slot",
                    &CUIActorMenu::HighlightForEachInSlot )
              .def( "refresh_current_cell_item",
                    &CUIActorMenu::RefreshCurrentItemCell )
          ...
          class_< CUIPdaWnd, CUIDialogWnd >( "CUIPdaWnd" )
              ...
              .def( "SetActiveSubdialog",
                    &CUIPdaWnd::SetActiveSubdialog_script )
          ...
          class_< CUIMainIngameWnd, CUIWindow >( "CUIMainIngameWnd" )
              .def( constructor<>() )
              .def_readonly( "UIStaticDiskIO",
                             &CUIMainIngameWnd::UIStaticDiskIO )
              .def_readonly( "UIStaticQuickHelp",
                             &CUIMainIngameWnd::UIStaticQuickHelp )
              .def_readonly( "UIMotionIcon", &CUIMainIngameWnd::UIMotionIcon )
              .def_readonly( "UIZoneMap", &CUIMainIngameWnd::UIZoneMap )
              .def_readonly( "m_ui_hud_states",
                             &CUIMainIngameWnd::m_ui_hud_states )
              .def_readonly( "m_ind_bleeding",
                             &CUIMainIngameWnd::m_ind_bleeding )
              .def_readonly( "m_ind_radiation",
                             &CUIMainIngameWnd::m_ind_radiation )
              .def_readonly( "m_ind_starvation",
                             &CUIMainIngameWnd::m_ind_starvation )
              .def_readonly( "m_ind_weapon_broken",
                             &CUIMainIngameWnd::m_ind_weapon_broken )
              .def_readonly( "m_ind_helmet_broken",
                             &CUIMainIngameWnd::m_ind_helmet_broken )
              .def_readonly( "m_ind_outfit_broken",
                             &CUIMainIngameWnd::m_ind_outfit_broken )
              .def_readonly( "m_ind_overweight",
                             &CUIMainIngameWnd::m_ind_overweight )
              .def_readonly( "m_ind_boost_psy",
                             &CUIMainIngameWnd::m_ind_boost_psy )
              .def_readonly( "m_ind_boost_radia",
                             &CUIMainIngameWnd::m_ind_boost_radia )
              .def_readonly( "m_ind_boost_chem",
                             &CUIMainIngameWnd::m_ind_boost_chem )
              .def_readonly( "m_ind_boost_wound",
                             &CUIMainIngameWnd::m_ind_boost_wound )
              .def_readonly( "m_ind_boost_weight",
                             &CUIMainIngameWnd::m_ind_boost_weight )
              .def_readonly( "m_ind_boost_health",
                             &CUIMainIngameWnd::m_ind_boost_health )
              .def_readonly( "m_ind_boost_power",
                             &CUIMainIngameWnd::m_ind_boost_power )
              .def_readonly( "m_ind_boost_rad",
                             &CUIMainIngameWnd::m_ind_boost_rad )
              .def( "GetQuickSlotIcons",
                    &CUIMainIngameWnd::GetQuickSlotIconsScript )
              .def_readonly( "m_QuickSlotText1",
                             &CUIMainIngameWnd::m_QuickSlotText1 )
              .def_readonly( "m_QuickSlotText2",
                             &CUIMainIngameWnd::m_QuickSlotText2 )
              .def_readonly( "m_QuickSlotText3",
                             &CUIMainIngameWnd::m_QuickSlotText3 )
              .def_readonly( "m_QuickSlotText4",
                             &CUIMainIngameWnd::m_QuickSlotText4 ),
          ...
          class_< CUIHudStatesWnd, CUIWindow >( "CUIHudStatesWnd" )
              ...
              .def_readonly( "m_ui_weapon_ammo_color_active",
                             &CUIHudStatesWnd::m_ui_weapon_ammo_color_active )
              .def_readonly( "m_ui_weapon_ammo_color_inactive",
                             &CUIHudStatesWnd::m_ui_weapon_ammo_color_inactive )
              .def_readonly( "m_ui_weapon_cur_ammo",
                             &CUIHudStatesWnd::m_ui_weapon_cur_ammo )
              .def_readonly( "m_ui_weapon_fmj_ammo",
                             &CUIHudStatesWnd::m_ui_weapon_fmj_ammo )
              .def_readonly( "m_ui_weapon_ap_ammo",
                             &CUIHudStatesWnd::m_ui_weapon_ap_ammo )
              .def_readonly( "m_ui_weapon_third_ammo",
                             &CUIHudStatesWnd::m_ui_weapon_third_ammo )
              .def_readonly( "m_fire_mode", &CUIHudStatesWnd::m_fire_mode )
              .def_readonly( "m_ui_grenade", &CUIHudStatesWnd::m_ui_grenade )
              .def_readonly( "m_ui_weapon_icon",
                             &CUIHudStatesWnd::m_ui_weapon_icon )
              .def_readonly( "m_ui_health_bar",
                             &CUIHudStatesWnd::m_ui_health_bar )
              .def_readonly( "m_ui_stamina_bar",
                             &CUIHudStatesWnd::m_ui_stamina_bar )
              .def_readonly( "m_ui_psy_bar", &CUIHudStatesWnd::m_ui_psy_bar )
              .def_readonly( "m_radia_damage",
                             &CUIHudStatesWnd::m_radia_damage )

              // Tronex
              .def_readwrite( "m_ui_health_bar_show",
                              &CUIHudStatesWnd::m_ui_health_bar_show )
              .def_readwrite( "m_ui_stamina_bar_show",
                              &CUIHudStatesWnd::m_ui_stamina_bar_show )
              .def_readwrite( "m_ui_psy_bar_show",
                              &CUIHudStatesWnd::m_ui_psy_bar_show ) ];

    module( L, "ActorMenu" )[ def( "get_pda_menu", &GetPDAMenu ),
