...
private:
    ...
    void PropertiesBoxForWeapon( CUICellItem* cell_item,
                                 PIItem item,
                                 bool& b_show );
    ...
    void PropertiesBoxForDrop( CUICellItem* cell_item,
                               PIItem item,
                               bool& b_show );
...
private:
    ...
    void highlight_ammo_for_weapon( PIItem weapon_item,
                                    CUIDragDropListEx* ddlist );
    void highlight_weapons_for_ammo( PIItem ammo_item,
                                     CUIDragDropListEx* ddlist );
    bool highlight_addons_for_weapon( PIItem weapon_item, CUICellItem* ci );
    void highlight_weapons_for_addon( PIItem addon_item,
                                      CUIDragDropListEx* ddlist );
...
protected:
    ...
    // void						SetCurrentItem
    // (CUICellItem* itm); //Alundaio: Made public CUICellItem*
    // CurrentItem					();
    ...
    u32 CalcItemsPrice( CUIDragDropListEx* pList,
                        CTrade* pTrade,
                        bool bBuying );
    void UpdatePrices();
    bool CanMoveToPartner( PIItem pItem );
    void TransferItems( CUIDragDropListEx* pSellList,
...
public:
    ...
    bool SetInfoCurUpgrade( Upgrade_type* upgrade_type,
    ...
    void HighlightForEachInSlot( const ::luabind::functor< bool >& functor,
                                 u8 type,
                                 u16 slot_id );

    //-AxelDominator && Alundaio consumable use condition
    void DonateCurrentItem(
        CUICellItem* cell_item ); // Alundaio: Donate item via context menu
                                  // while in trade menu
