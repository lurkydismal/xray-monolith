...
void CUIWindow::script_register( lua_State* L ) {
    module( L )
        [ def( "GetARGB", &GetARGB ), def( "ClrGetA", &ClrGetA ),
          def( "ClrGetR", &ClrGetR ), def( "ClrGetG", &ClrGetG ),
          def( "ClrGetB", &ClrGetB ), def( "ClrSetA", &ClrSetA ),
          def( "ClrSetR", &ClrSetR ), def( "ClrSetG", &ClrSetG ),
          def( "ClrSetB", &ClrSetB ),
          ...
          class_< CUIWindow >( "CUIWindow" )
              ...
              */
              ...
              .def( "SetWndRect", ( void ( CUIWindow::* )(
                                      Frect ) )&CUIWindow::SetWndRect_script )
              .def( "SetWndPos", ( void ( CUIWindow::* )(
                                     Fvector2 ) )&CUIWindow::SetWndPos_script )
              .def( "SetWndSize",
                    ( void ( CUIWindow::* )(
                        Fvector2 ) )&CUIWindow::SetWndSize_script )
    ...
    module( L )
        [ class_< CDialogHolder >( "CDialogHolder" )
              ...
              .def( "RemoveDialogToRender",
                    &CDialogHolder::RemoveDialogToRender ),
          ...
          class_< CUIMMShniaga, CUIWindow >( "CUIMMShniaga" )
              .enum_( "enum_page_id" )
                  [ value( "epi_main", CUIMMShniaga::epi_main ),
                    ...
                    value( "epi_new_network_game",
                           CUIMMShniaga::epi_new_network_game ) ]
          ...
          class_< enum_exporter< EUIMessages > >( "ui_events" )
              .enum_( "events" )[
                  ...
                  value( "WINDOW_MOUSE_WHEEL_UP",
                         int( WINDOW_MOUSE_WHEEL_UP ) ),
                  value( "WINDOW_MOUSE_WHEEL_DOWN",
                         int( WINDOW_MOUSE_WHEEL_DOWN ) ),
                  value( "WINDOW_LBUTTON_DB_CLICK",
                         int( WINDOW_LBUTTON_DB_CLICK ) ),
                  value( "WINDOW_KEY_PRESSED", int( WINDOW_KEY_PRESSED ) ),
                  value( "WINDOW_KEY_RELEASED", int( WINDOW_KEY_RELEASED ) ),
                  value( "WINDOW_KEYBOARD_CAPTURE_LOST",
                         int( WINDOW_KEYBOARD_CAPTURE_LOST ) ),
                  ...
                  // CUIMessageBox
                  value( "MESSAGE_BOX_OK_CLICKED",
                         int( MESSAGE_BOX_OK_CLICKED ) ),
                  value( "MESSAGE_BOX_YES_CLICKED",
                         int( MESSAGE_BOX_YES_CLICKED ) ),
                  value( "MESSAGE_BOX_NO_CLICKED",
                         int( MESSAGE_BOX_NO_CLICKED ) ),
                  value( "MESSAGE_BOX_CANCEL_CLICKED",
                         int( MESSAGE_BOX_CANCEL_CLICKED ) ),
                  value( "MESSAGE_BOX_COPY_CLICKED",
                         int( MESSAGE_BOX_COPY_CLICKED ) ),
                  value( "MESSAGE_BOX_QUIT_GAME_CLICKED",
                         int( MESSAGE_BOX_QUIT_GAME_CLICKED ) ),
                  value( "MESSAGE_BOX_QUIT_WIN_CLICKED",
                         int( MESSAGE_BOX_QUIT_WIN_CLICKED ) ),
