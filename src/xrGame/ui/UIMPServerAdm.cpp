...
void CUIMpServerAdm::Init( CUIXml& xml_doc ) {
    ...
    CUIXmlInit::Init3tButton( xml_doc, "server_adm:back_button", 0,
                              m_pBackBtn );

    CUIXmlInit::InitWindow( xml_doc, "server_adm:main_selection_wnd", 0,
                            m_pMainSelectionWnd );
    CUIXmlInit::Init3tButton( xml_doc,
                              "server_adm:main_selection_wnd:restart_button", 0,
                              m_pRestartBtn );
    CUIXmlInit::Init3tButton(
        xml_doc, "server_adm:main_selection_wnd:fast_restart_button", 0,
        m_pFastRestartBtn );
    CUIXmlInit::Init3tButton(
        xml_doc, "server_adm:main_selection_wnd:change_weather_button", 0,
        m_pChangeWeatherBtn );
    CUIXmlInit::Init3tButton(
        xml_doc, "server_adm:main_selection_wnd:change_game_type_button", 0,
        m_pChangeGameTypeBtn );
    CUIXmlInit::Init3tButton(
        xml_doc, "server_adm:main_selection_wnd:change_game_limits_button", 0,
        m_pChangeGameLimitsBtn );
    CUIXmlInit::Init3tButton( xml_doc,
                              "server_adm:main_selection_wnd:vote_stop_button",
                              0, m_pVoteStopBtn );

    CUIXmlInit::InitWindow( xml_doc, "server_adm:weather_selection_wnd", 0,
                            m_pWeatherSelectionWnd );
    CUIXmlInit::Init3tButton(
        xml_doc, "server_adm:weather_selection_wnd:clear_weather_button", 0,
        m_pClearWeatherBtn );
    CUIXmlInit::Init3tButton(
        xml_doc, "server_adm:weather_selection_wnd:cloudy_weather_button", 0,
        m_pCloudyWeatherBtn );
    CUIXmlInit::Init3tButton(
        xml_doc, "server_adm:weather_selection_wnd:rain_weather_button", 0,
        m_pRainWeatherBtn );
    CUIXmlInit::Init3tButton(
        xml_doc, "server_adm:weather_selection_wnd:night_weather_button", 0,
        m_pNightWeatherBtn );
    CUIXmlInit::InitSpin(
        xml_doc, "server_adm:weather_selection_wnd:weather_change_rate_spin", 0,
        m_pWeatherChangeRateSpin );
    CUIXmlInit::Init3tButton(
        xml_doc, "server_adm:weather_selection_wnd:set_weather_rate_button", 0,
        m_pWeatherChangeRateBtn );

    CUIXmlInit::InitWindow( xml_doc, "server_adm:game_type_selection_wnd", 0,
                            m_pGameTypeSelectionWnd );
    CUIXmlInit::Init3tButton(
        xml_doc, "server_adm:game_type_selection_wnd:dm_button", 0, m_pDMBtn );
    CUIXmlInit::Init3tButton( xml_doc,
                              "server_adm:game_type_selection_wnd:tdm_button",
                              0, m_pTDMBtn );
    CUIXmlInit::Init3tButton( xml_doc,
                              "server_adm:game_type_selection_wnd:cta_button",
                              0, m_pCTABtn );
    CUIXmlInit::Init3tButton(
        xml_doc, "server_adm:game_type_selection_wnd:ah_button", 0, m_pAHBtn );

    CUIXmlInit::InitWindow( xml_doc, "server_adm:game_limits_selection_wnd", 0,
                            m_pGameLimitsSelectionWnd );
    CUIXmlInit::Init3tButton(
        xml_doc, "server_adm:game_limits_selection_wnd:time_limit_button", 0,
        m_pSetTimeLimitBtn );
    CUIXmlInit::InitEditBox(
        xml_doc, "server_adm:game_limits_selection_wnd:time_limit_edit", 0,
        m_pTimeLimitEdit );
    CUIXmlInit::Init3tButton(
        xml_doc, "server_adm:game_limits_selection_wnd:frag_limit_button", 0,
        m_pSetFragLimitBtn );
    CUIXmlInit::InitEditBox(
        xml_doc, "server_adm:game_limits_selection_wnd:frag_limit_edit", 0,
        m_pFragLimitEdit );
    CUIXmlInit::Init3tButton(
        xml_doc, "server_adm:game_limits_selection_wnd:art_limit_button", 0,
        m_pSetArtLimitBtn );
    CUIXmlInit::InitEditBox(
        xml_doc, "server_adm:game_limits_selection_wnd:art_limit_edit", 0,
        m_pArtLimitEdit );
    CUIXmlInit::Init3tButton(
        xml_doc, "server_adm:game_limits_selection_wnd:warm_up_button", 0,
        m_pSetWarmUpBtn );
    CUIXmlInit::InitEditBox(
        xml_doc, "server_adm:game_limits_selection_wnd:warm_up_edit", 0,
        m_pWarmUpEdit );
    CUIXmlInit::InitCheck(
        xml_doc, "server_adm:game_limits_selection_wnd:spectator_fe_check", 0,
        m_pSpectatorFECheck );
    CUIXmlInit::InitCheck(
        xml_doc, "server_adm:game_limits_selection_wnd:spectator_ff_check", 0,
        m_pSpectatorFFCheck );
    CUIXmlInit::InitCheck(
        xml_doc, "server_adm:game_limits_selection_wnd:spectator_fl_check", 0,
        m_pSpectatorFLCheck );
    CUIXmlInit::InitCheck(
        xml_doc, "server_adm:game_limits_selection_wnd:spectator_la_check", 0,
        m_pSpectatorLACheck );
    CUIXmlInit::InitCheck(
        xml_doc, "server_adm:game_limits_selection_wnd:spectator_tc_check", 0,
        m_pSpectatorTCCheck );
    CUIXmlInit::InitEditBox(
        xml_doc, "server_adm:game_limits_selection_wnd:invincible_time_edit", 0,
        m_pInvincibleTimeEdit );
    CUIXmlInit::Init3tButton(
        xml_doc, "server_adm:game_limits_selection_wnd:invincible_time_button",
        0, m_pSetInvincibleTimeBtn );
    CUIXmlInit::InitEditBox(
        xml_doc, "server_adm:game_limits_selection_wnd:damage_block_time_edit",
        0, m_pDamageBlockTimeEdit );
    CUIXmlInit::Init3tButton(
        xml_doc,
        "server_adm:game_limits_selection_wnd:damage_block_time_button", 0,
        m_pSetDamageBlockTimeBtn );
    CUIXmlInit::InitEditBox(
        xml_doc, "server_adm:game_limits_selection_wnd:reinforcement_time_edit",
        0, m_pReinforcementTimeEdit );
    CUIXmlInit::Init3tButton(
        xml_doc,
        "server_adm:game_limits_selection_wnd:reinforcement_time_button", 0,
        m_pSetReinforcementTimeBtn );
    CUIXmlInit::InitCheck(
        xml_doc, "server_adm:game_limits_selection_wnd:vote_enabled_check", 0,
        m_pVoteEnabledCheck );
    CUIXmlInit::InitCheck(
        xml_doc, "server_adm:game_limits_selection_wnd:dam_block_indic_check",
        0, m_pDamBlockIndicCheck );
    CUIXmlInit::InitCheck(
        xml_doc, "server_adm:game_limits_selection_wnd:friendly_names_check", 0,
        m_pFriendlyNamesCheck );
    CUIXmlInit::InitCheck(
        xml_doc, "server_adm:game_limits_selection_wnd:friendly_indic_check", 0,
        m_pFriendlyIndicCheck );
    CUIXmlInit::InitCheck(
        xml_doc,
        "server_adm:game_limits_selection_wnd:bearer_cant_sprint_check", 0,
    ...
    switch ( msg ) {
        case BUTTON_CLICKED: {
            if ( pWnd == m_pBackBtn )
                ...
                xr_sprintf( tmp_string, "ra mm_net_weather_rateofchange %d",
                            m_pWeatherChangeRateSpin->Value() );
                ...
                if ( xr_strcmp( m_pTimeLimitEdit->GetText(), "" ) != 0 ) {
                    string512 tmp_string;
                    xr_sprintf( tmp_string, "ra sv_timelimit %s",
                                m_pTimeLimitEdit->GetText() );
                    Console->Execute( tmp_string );
                ...
                if ( xr_strcmp( m_pFragLimitEdit->GetText(), "" ) != 0 ) {
                    string512 tmp_string;
                    xr_sprintf( tmp_string, "ra sv_fraglimit %s",
                                m_pFragLimitEdit->GetText() );
                    Console->Execute( tmp_string );
                ...
                if ( xr_strcmp( m_pArtLimitEdit->GetText(), "" ) != 0 ) {
                    string512 tmp_string;
                    xr_sprintf( tmp_string, "ra sv_artefacts_count %s",
                                m_pArtLimitEdit->GetText() );
                    Console->Execute( tmp_string );
                ...
                if ( xr_strcmp( m_pWarmUpEdit->GetText(), "" ) != 0 ) {
                    string512 tmp_string;
                    xr_sprintf( tmp_string, "ra sv_warm_up %s",
                                m_pWarmUpEdit->GetText() );
                    Console->Execute( tmp_string );
                    m_pWarmUpEdit->ClearText();
                }
            } else if ( pWnd == m_pSpectatorFECheck ) {
                string512 tmp_string;
                xr_sprintf( tmp_string, "ra sv_spectr_firsteye %d",
                            m_pSpectatorFECheck->GetCheck() ? 1 : 0 );
                Console->Execute( tmp_string );
            } else if ( pWnd == m_pSpectatorFFCheck ) {
                string512 tmp_string;
                xr_sprintf( tmp_string, "ra sv_spectr_freefly %d",
                            m_pSpectatorFFCheck->GetCheck() ? 1 : 0 );
                Console->Execute( tmp_string );
            } else if ( pWnd == m_pSpectatorFLCheck ) {
                string512 tmp_string;
                xr_sprintf( tmp_string, "ra sv_spectr_freelook %d",
                            m_pSpectatorFLCheck->GetCheck() ? 1 : 0 );
                Console->Execute( tmp_string );
            } else if ( pWnd == m_pSpectatorLACheck ) {
                string512 tmp_string;
                xr_sprintf( tmp_string, "ra sv_spectr_lookat %d",
                            m_pSpectatorLACheck->GetCheck() ? 1 : 0 );
                Console->Execute( tmp_string );
            } else if ( pWnd == m_pSpectatorTCCheck ) {
                string512 tmp_string;
                xr_sprintf( tmp_string, "ra sv_spectr_teamcamera %d",
                            m_pSpectatorTCCheck->GetCheck() ? 1 : 0 );
                Console->Execute( tmp_string );
            } else if ( pWnd == m_pSetInvincibleTimeBtn ) {
                if ( xr_strcmp( m_pInvincibleTimeEdit->GetText(), "" ) != 0 ) {
                    string512 tmp_string;
                    xr_sprintf( tmp_string, "ra sv_invincible_time %s",
                                m_pInvincibleTimeEdit->GetText() );
                    Console->Execute( tmp_string );
                ...
                if ( xr_strcmp( m_pDamageBlockTimeEdit->GetText(), "" ) != 0 ) {
                    string512 tmp_string;
                    xr_sprintf( tmp_string, "ra sv_dmgblocktime %s",
                                m_pDamageBlockTimeEdit->GetText() );
                    Console->Execute( tmp_string );
                    m_pDamageBlockTimeEdit->ClearText();
                }
            } else if ( pWnd == m_pSetReinforcementTimeBtn ) {
                if ( xr_strcmp( m_pReinforcementTimeEdit->GetText(), "" ) !=
                     0 ) {
                    string512 tmp_string;
                    xr_sprintf( tmp_string, "ra sv_reinforcement_time %s",
                                m_pReinforcementTimeEdit->GetText() );
                    Console->Execute( tmp_string );
                    m_pReinforcementTimeEdit->ClearText();
                }
            } else if ( pWnd == m_pVoteEnabledCheck ) {
                string512 tmp_string;
                xr_sprintf( tmp_string, "ra sv_vote_enabled %d",
                            m_pVoteEnabledCheck->GetCheck() ? 0x00ff : 0 );
                Console->Execute( tmp_string );
            } else if ( pWnd == m_pDamBlockIndicCheck ) {
                string512 tmp_string;
                xr_sprintf( tmp_string, "ra sv_dmgblockindicator %d",
                            m_pDamBlockIndicCheck->GetCheck() ? 1 : 0 );
                Console->Execute( tmp_string );
            } else if ( pWnd == m_pFriendlyNamesCheck ) {
                string512 tmp_string;
                xr_sprintf( tmp_string, "ra sv_friendly_names %d",
                            m_pFriendlyNamesCheck->GetCheck() ? 1 : 0 );
                Console->Execute( tmp_string );
            } else if ( pWnd == m_pFriendlyIndicCheck ) {
                string512 tmp_string;
                xr_sprintf( tmp_string, "ra sv_friendly_indicators %d",
                            m_pFriendlyIndicCheck->GetCheck() ? 1 : 0 );
                Console->Execute( tmp_string );
            } else if ( pWnd == m_pBearerCantSprintCheck ) {
                string512 tmp_string;
                xr_sprintf( tmp_string, "ra sv_bearercantsprint %d",
                            m_pBearerCantSprintCheck->GetCheck() ? 1 : 0 );
                Console->Execute( tmp_string );
            }
            break;
        }
