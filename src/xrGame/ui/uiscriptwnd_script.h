...
struct CWrapperBase : public T, public ::luabind::wrap_base {
    ...
    static bool OnKeyboard_static( inherited* ptr,
                                   int dik,
                                   EUIMessages keyboard_action ) {
        return ptr->self_type::inherited::OnKeyboardAction( dik,
                                                            keyboard_action );
    }
    ...
    static bool OnMouse_static( inherited* ptr,
                                float x,
                                float y,
...
typedef luabind::
    class_< CUIDialogWndEx, luabind::bases< CUIDialogWnd, DLL_Pure >, WrapType >
        export_class;
