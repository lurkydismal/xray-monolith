...
void _make_rot_pos( Fvector2& pt,
                    float sin_a,
                    float cos_a,
                    float R1,
                    float R2 ) {
...
void CUIProgressShape::Draw() {
    ...
    UIRender->StartPrimitive( m_sectorCount * 3, IUIRender::ptTriList,
    ...
    for ( u32 i = 0; i < m_sectorCount; ++i ) {
        ...
        UIRender->PushPoint( center_pos.x, center_pos.y, 0, color, center_tex.x,
                             center_tex.y );
