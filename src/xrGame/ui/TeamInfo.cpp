...
u32 CTeamInfo::GetTeam1_color() {
    ...
    team1_color = color_argb( 155, atoi( _GetItem( tm_col, 0, _buff ) ),
                              atoi( _GetItem( tm_col, 1, _buff ) ),
...
u32 CTeamInfo::GetTeam2_color() {
    ...
    team2_color = color_argb( 155, atoi( _GetItem( tm_col, 0, _buff ) ),
                              atoi( _GetItem( tm_col, 1, _buff ) ),
                              atoi( _GetItem( tm_col, 2, _buff ) ) );
...
LPCSTR CTeamInfo::GetTeam_color_tag( int team ) {
    ...
    // team1_color = color_argb(155,atoi(_GetItem(tm_col, 0,
    // _buff)),atoi(_GetItem(tm_col, 1, _buff)),atoi(_GetItem(tm_col, 2,
    // _buff)));
    xr_string str;
    str = "%c[255,";
