...
bool CUIMessageBox::OnMouseAction( float x,
                                   float y,
...
void CUIMessageBox::InitMessageBox( LPCSTR box_template ) {
    ...
    switch ( m_eMessageBoxStyle ) {
        ...
        case MESSAGEBOX_DIRECT_IP:
            ...
            // m_message_box_yes_no->func_on_ok = CUIWndCallback::void_function(
            // this, &CUIActorMenu::OnMesBoxYes );
        ...
        case MESSAGEBOX_PASSWORD: {
            ...
            strconcat( sizeof( str ), str, box_template,
                       ":edit_user_password" );
...
void CUIMessageBox::OnYesOk() {
    switch ( m_eMessageBoxStyle ) {
        case MESSAGEBOX_OK:
        case MESSAGEBOX_INFO:
            GetMessageTarget()->SendMessage( m_UIButtonYesOk,
        ...
        switch ( m_eMessageBoxStyle ) {
            ...
            case MESSAGEBOX_QUIT_WINDOWS:
                if ( pWnd == m_UIButtonYesOk ) {
                    ...
                    GetMessageTarget()->SendMessage( m_UIButtonNo,
            ...
            case MESSAGEBOX_YES_NO_CANCEL:
                if ( pWnd == m_UIButtonYesOk ) {
                    ...
                    GetMessageTarget()->SendMessage(
                        m_UIButtonCancel, MESSAGE_BOX_CANCEL_CLICKED );
                    GetMessageTarget()->SendMessage(
                        this, MESSAGE_BOX_CANCEL_CLICKED );
                }
                break;
            case MESSAGEBOX_YES_NO_COPY:
                if ( pWnd == m_UIButtonYesOk ) {
                    ...
                    GetMessageTarget()->SendMessage( m_UIButtonCopy,
