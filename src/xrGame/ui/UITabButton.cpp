...
float CUITabButton::CapWidthUI() const {
    ...
    return ( art.width() > 0.0f ) ? art.height() * GetWndSize().x / art.width()
                                  : 0.0f;
}
...
CUITabButton* CUITabButton::Clone( const Fvector2& pos,
                                   const Fvector2& size ) const {
...
u32 CUITabButton::SlantPoly( Fvector2* out,
                             u32 max,
                             const Fvector2& pos,
                             const Fvector2& size,
                             float slant ) {
