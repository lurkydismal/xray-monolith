...
// Description: template class designed for UI controls to represent their
// state;
//              there are 4 states: Enabled, Disabled, Hightlighted and Touched.
//              As a rule you can use one of 3 background types:
//              Normal Texture, String Texture, Frame Texture (CUIStatic,
//              CUIFrameLineWnd, CUIFrameWindow)
// Created:     29.12.2004
...
template < class T >
void CUIInteractiveBackground< T >::InitIB( LPCSTR texture,
                                            Fvector2 pos,
                                            Fvector2 size ) {
    CUIWindow::SetWndPos( pos );
    CUIWindow::SetWndSize( size );
