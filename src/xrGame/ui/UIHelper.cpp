...
CUIStatic* UIHelper::CreateStatic( CUIXml& xml,
                                   LPCSTR ui_path,
                                   CUIWindow* parent ) {
...
CUITextWnd* UIHelper::CreateTextWnd( CUIXml& xml,
                                     LPCSTR ui_path,
                                     CUIWindow* parent ) {
...
CUIEditBox* UIHelper::CreateEditBox( CUIXml& xml,
                                     LPCSTR ui_path,
                                     CUIWindow* parent ) {
...
CUIProgressBar* UIHelper::CreateProgressBar( CUIXml& xml,
                                             LPCSTR ui_path,
                                             CUIWindow* parent ) {
...
CUIFrameLineWnd* UIHelper::CreateFrameLine( CUIXml& xml,
                                            LPCSTR ui_path,
                                            CUIWindow* parent ) {
...
CUIFrameWindow* UIHelper::CreateFrameWindow( CUIXml& xml,
                                             LPCSTR ui_path,
                                             CUIWindow* parent ) {
...
CUI3tButton* UIHelper::Create3tButton( CUIXml& xml,
                                       LPCSTR ui_path,
                                       CUIWindow* parent ) {
...
CUICheckButton* UIHelper::CreateCheck( CUIXml& xml,
                                       LPCSTR ui_path,
                                       CUIWindow* parent ) {
...
CUIDragDropListEx* UIHelper::CreateDragDropListEx( CUIXml& xml,
                                                   LPCSTR ui_path,
                                                   CUIWindow* parent ) {
