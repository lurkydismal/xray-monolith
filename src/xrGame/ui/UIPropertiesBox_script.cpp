...
void CUIPropertiesBox::script_register( lua_State* L ) {
    module(
        L )[ class_< CUIPropertiesBox, CUIFrameWindow >( "CUIPropertiesBox" )
                 .def( constructor<>() )
                 //		.def("AddItem",
                 //&CUIPropertiesBox::AddItem)
                 .def( "RemoveItem", &CUIPropertiesBox::RemoveItemByTAG )
                 .def( "RemoveAll", &CUIPropertiesBox::RemoveAll )
                 .def( "Show", ( void ( CUIPropertiesBox::* )(
                                   int, int ) )&CUIPropertiesBox::Show )
                 ...
                 .def( "InitPropertiesBox",
                       &CUIPropertiesBox::InitPropertiesBox )
             //		.def("",
             //&CUIPropertiesBox::)
    ];
}
