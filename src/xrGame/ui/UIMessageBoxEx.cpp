...
void CUIMessageBoxEx::InitMessageBox( LPCSTR xml_template ) {
    ...
    AddCallback(
        m_pMessageBox, MESSAGE_BOX_YES_CLICKED,
...
void CUIMessageBoxEx::SendMessage( CUIWindow* pWnd,
                                   s16 msg,
                                   void* pData /* = NULL */ ) {
    ...
    if ( keyboard_action == WINDOW_KEY_PRESSED ) {
        if ( dik == DIK_NUMPADENTER || dik == DIK_RETURN || dik == DIK_SPACE ) {
            ...
            /*
                                    ...
                                    if ( dik == DIK_ESCAPE )
                            {
                                    CUIMessageBox::E_MESSAGEBOX_STYLE style =
               m_pMessageBox->GetBoxStyle(); if(style !=
               CUIMessageBox::MESSAGEBOX_INFO) HideDialog(); return true;
            */
        } else
