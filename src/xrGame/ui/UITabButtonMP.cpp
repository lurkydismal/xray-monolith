...
void CUITabButtonMP::Update() {
    ...
    if ( m_hint ) {
        if ( !m_bIsEnabled ) {
            hintColor = m_bUseTextColor[ S_Disabled ]
                            ? m_dwTextColor[ S_Disabled ]
                            : m_dwTextColor[ S_Enabled ];
        } else if ( CUIButton::BUTTON_PUSHED == GetButtonState() ) {
            hintColor = m_bUseTextColor[ S_Touched ]
                            ? m_dwTextColor[ S_Touched ]
                            : m_dwTextColor[ S_Enabled ];
        } else if ( m_bCursorOverWindow ) {
            hintColor = m_bUseTextColor[ S_Highlighted ]
