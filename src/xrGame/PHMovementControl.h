...
public:
    ...
    void Jump( const Fvector& start_point,
...
public:
    ...
    void CalcMaximumVelocity( Fvector& /**dest/**/,
                              Fvector& /**accel/**/,
                              float /**friction/**/ ) {};

    void CalcMaximumVelocity( float& /**dest/**/,
                              float /**accel/**/,
                              float /**friction/**/ ) {};
    ...
    float VelocityLimit();
    void PathNearestPoint(
        const xr_vector< DetailPathManager::STravelPathPoint >& path,
        const Fvector& new_position,
        int& index,
        bool& type );
    void PathNearestPointFindUp(
        const xr_vector< DetailPathManager::STravelPathPoint >& path,
        const Fvector& new_position,
        int& index,
        float radius,
        bool& near_line );
    void PathNearestPointFindDown(
        const xr_vector< DetailPathManager::STravelPathPoint >& path,
        const Fvector& new_position,
        int& index,
        float radius,
    ...
    void ApplyHit( const Fvector& dir,
                   const float P,
    ...
    static BOOL BorderTraceCallback( collide::rq_result& result,
                                     LPVOID params );
...
private:
    void actor_calculate( Fvector& vAccel,
                          const Fvector& camDir,
                          float ang_speed,
                          float jump,
                          float dt,
