...
#define KEY_BestScore_KnifeKillsInRow \
    4 // [TYPE: int] [DESC: knife kills in row]
#define KEY_BestScore_BackstabsKillsInRow \
    5 // [TYPE: int] [DESC: knife backstabs kills in row]
#define KEY_BestScore_HeadshotsKillsInRow \
    6 // [TYPE: int] [DESC: headshots kills in row]
#define KEY_BestScore_EyeKillsInRow 7 // [TYPE: int] [DESC: eye kills in row]
#define KEY_BestScore_BleedKillsInRow \
    8 // [TYPE: int] [DESC: bleed kills in row]
#define KEY_BestScore_ExplosiveKillsInRow \
    9                        // [TYPE: int] [DESC: explosive kills in row]
