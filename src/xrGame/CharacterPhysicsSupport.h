...
public:
    enum EType { etActor, etStalker, etBitting };

    enum EState { esDead, esAlive, esRemoved };
...
public:
    ...
    bool is_hit_anim_playing() const {
        return m_hit_animations.is_hit_anim_playing();
    }
...
private:
    ...
    void bone_fix_clear();
    void EndActivateFreeShell( CObject* who,
    ...
    bool CollisionCorrectObjPos( const Fvector& start_from,
