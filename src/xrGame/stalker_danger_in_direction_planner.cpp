...
CStalkerDangerInDirectionPlanner::CStalkerDangerInDirectionPlanner(
    CAI_Stalker* object,
    LPCSTR action_name )
    : inherited( object, action_name ) {}

void CStalkerDangerInDirectionPlanner::setup( CAI_Stalker* object,
...
void CStalkerDangerInDirectionPlanner::add_evaluators() {
    add_evaluator(
        ...
        xr_new< CStalkerPropertyEvaluatorDangers >( m_object, "danger" ) );
...
void CStalkerDangerInDirectionPlanner::add_actions() {
    ...
    action = xr_new< CStalkerActionDangerInDirectionLookOut >( m_object,
                                                               "look out" );
    ...
    action = xr_new< CStalkerActionDangerInDirectionHoldPosition >(
        m_object, "hold position" );
    ...
    action =
        xr_new< CStalkerActionDangerInDirectionDetour >( m_object, "detour" );
    ...
    action =
        xr_new< CStalkerActionDangerInDirectionSearch >( m_object, "search" );
