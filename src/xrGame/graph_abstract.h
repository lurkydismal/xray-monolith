...
template < typename _data_type = xr_empty,
...
public:
    ...
    IC void clear();
    IC void add_vertex( const _data_type& data,
                        const _vertex_id_type& vertex_id );
    IC void remove_vertex( const _vertex_id_type& vertex_id );
    IC void add_edge( const _vertex_id_type& vertex_id0,
    ...
    IC void remove_edge( const _vertex_id_type& vertex_id0,
                         const _vertex_id_type& vertex_id1 );
