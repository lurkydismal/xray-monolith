...
//Maksimchuk 	Description : Seniority hierarchy holder inline functions
////////////////////////////////////////////////////////////////////////////
...
IC const CSeniorityHierarchyHolder::TEAM_REGISTRY&
CSeniorityHierarchyHolder::teams() const {
    return ( m_teams );
}
