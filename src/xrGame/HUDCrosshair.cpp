...
bool CHUDCrosshair::InitShaderCrosshair() {
    ...
    if ( strcmp( lastCrosshairShader, *crosshairShader ) ||
         strcmp( lastCrosshairTexture, *crosshairTexture ) ) {
...
void CHUDCrosshair::PushVerts( Fvector* verts,
                               Fvector* uvs,
                               int count,
                               Fmatrix mat,
                               Fvector4 pos ) const {
...
void CHUDCrosshair::RenderShaderCrosshair() {
    ...
    UIRender->StartPrimitive( 4, IUIRender::ptTriStrip,
...
void CHUDCrosshair::RenderWireCrosshair() {
    ...
    UIRender->StartPrimitive( 8, IUIRender::ptLineList,
                              UI().m_currentPointType );
