...
void CCar::script_register( lua_State* L ) {
        ...
        class_< CCar, bases< CGameObject, CHolderCustom > >( "CCar" )
            ...
            .enum_( "wpn_action" )
                [ value( "eWpnDesiredDir", int( CCarWeapon::eWpnDesiredDir ) ),
                  ...
                  value( "eWpnToDefaultDir",
                         int( CCarWeapon::eWpnToDefaultDir ) ) ]
            .def( "Action", &CCar::Action )
            //		.def("SetParam",		(void
            //(CCar::*)(int,Fvector2)) &CCar::SetParam)
            .def( "SetParam",
                  ( void ( CCar::* )( int, Fvector ) )&CCar::SetParam )
     ...
     * (aka Shadows) END ***************************************************/
            ...
            .def( "CCarDrone_GetPowerEfficiency",
                  &CCar::CCarDrone_GetPowerEfficiency )
            .def( "CCarDrone_SetPowerEfficiency",
                  &CCar::CCarDrone_SetPowerEfficiency )

            .def( "VisualCamera_GetDesireAngle",
                  &CCar::VisualCamera_GetDesireAngle )
