...
Fvector CScriptGameObject::Center( bool bHud ) {
    if ( bHud ) {
        ...
        if ( itm )
            return itm->HudItemData()
                ->m_model->dcast_RenderVisual()
                ->getVisData()
                .sphere.P;
    }
...
Fmatrix CScriptGameObject::Xform( bool bHud ) {
    ...
    if ( !xform ) {
        Msg( "!CScriptGameObject::XForm xform is null for %s",
             object().Name() );
...
BIND_FUNCTION10( &object(),
                 CScriptGameObject::Position,
                 CGameObject,
                 Position,
                 Fvector,
                 Fvector() );
BIND_FUNCTION10( &object(),
                 CScriptGameObject::Direction,
                 CGameObject,
                 Direction,
                 Fvector,
                 Fvector() );
BIND_FUNCTION10( &object(),
                 CScriptGameObject::Mass,
                 CPhysicsShellHolder,
                 GetMass,
                 float,
                 float( -1 ) );
BIND_FUNCTION10( &object(),
                 CScriptGameObject::ID,
                 CGameObject,
                 ID,
                 u16,
                 u16( -1 ) );
BIND_FUNCTION10( &object(),
                 ...
                 BOOL,
                 FALSE );
// BIND_FUNCTION01	(&object(),	CScriptGameObject::setVisible,
// CGameObject,	setVisible,			BOOL,
// BOOL);
BIND_FUNCTION10( &object(),
                 ...
                 BOOL,
                 FALSE );
// BIND_FUNCTION01	(&object(),	CScriptGameObject::setEnabled,
// CGameObject,	setEnabled,			BOOL,
// BOOL);
BIND_FUNCTION10( &object(),
                 CScriptGameObject::story_id,
                 CGameObject,
                 story_id,
                 ALife::_STORY_ID,
                 ALife::_STORY_ID( -1 ) );
BIND_FUNCTION10( &object(),
                 CScriptGameObject::DeathTime,
                 CEntity,
                 GetLevelDeathTime,
                 u32,
                 0 );
BIND_FUNCTION10( &object(),
                 CScriptGameObject::MaxHealth,
                 CEntity,
                 GetMaxHealth,
                 float,
                 -1 );
BIND_FUNCTION10( &object(),
                 CScriptGameObject::Accuracy,
                 CInventoryOwner,
                 GetWeaponAccuracy,
                 float,
                 -1 );
...
BIND_FUNCTION10( &object(),
                 CScriptGameObject::Squad,
                 CEntity,
                 g_Squad,
                 int,
                 -1 );
BIND_FUNCTION10( &object(),
                 CScriptGameObject::Group,
                 CEntity,
                 g_Group,
                 int,
                 -1 );
BIND_FUNCTION10( &object(),
                 CScriptGameObject::GetFOV,
                 CEntityAlive,
                 ffGetFov,
                 float,
                 -1 );
BIND_FUNCTION10( &object(),
                 CScriptGameObject::GetRange,
                 CEntityAlive,
                 ffGetRange,
                 float,
                 -1 );
...
BIND_FUNCTION10( &object(),
                 ...
                 CEntityAlive,
                 conditions().GetHealth,
                 float,
                 -1 );
BIND_FUNCTION01( &object(),
                 CScriptGameObject::SetHealth,
                 CEntityAlive,
                 conditions().SetHealth,
                 float,
                 float );
BIND_FUNCTION01( &object(),
                 CScriptGameObject::ChangeHealth,
                 CEntityAlive,
...
BIND_FUNCTION10( &object(),
                 CScriptGameObject::GetPsyHealth,
                 CEntityAlive,
                 conditions().GetPsyHealth,
                 float,
                 -1 );
BIND_FUNCTION01( &object(),
                 CScriptGameObject::SetPsyHealth,
                 CEntityAlive,
                 conditions().SetPsyHealth,
                 float,
                 float );
BIND_FUNCTION01( &object(),
                 CScriptGameObject::ChangePsyHealth,
                 CEntityAlive,
                 conditions().ChangePsyHealth,
                 float,
                 float );

BIND_FUNCTION10( &object(),
                 CScriptGameObject::GetPower,
                 CEntityAlive,
                 conditions().GetPower,
                 float,
                 -1 );
...
BIND_FUNCTION01( &object(),
                 ...
                 CEntityAlive,
                 conditions().SetSatiety,
                 float,
                 float );
BIND_FUNCTION01( &object(),
                 CScriptGameObject::ChangeSatiety,
                 CEntityAlive,
...
BIND_FUNCTION10( &object(),
                 CScriptGameObject::GetRadiation,
                 CEntityAlive,
                 conditions().GetRadiation,
                 float,
                 -1 );
BIND_FUNCTION01( &object(),
                 CScriptGameObject::SetRadiation,
                 CEntityAlive,
                 conditions().SetRadiation,
                 float,
                 float );
BIND_FUNCTION01( &object(),
                 CScriptGameObject::ChangeRadiation,
                 CEntityAlive,
...
BIND_FUNCTION10( &object(),
                 CScriptGameObject::GetMorale,
                 CEntityAlive,
                 conditions().GetEntityMorale,
                 float,
                 -1 );
BIND_FUNCTION01( &object(),
                 CScriptGameObject::SetMorale,
                 CEntityAlive,
                 conditions().SetEntityMorale,
                 float,
                 float );
BIND_FUNCTION01( &object(),
                 CScriptGameObject::ChangeMorale,
                 CEntityAlive,
                 conditions().ChangeEntityMorale,
                 float,
                 float );
...
BIND_FUNCTION01( &object(),
                 CScriptGameObject::ChangeCircumspection,
                 CEntityAlive,
                 conditions().ChangeCircumspection,
                 float,
                 float );

BIND_FUNCTION02( &object(),
                 CScriptGameObject::SetScriptControl,
                 CScriptEntity,
                 SetScriptControl,
                 bool,
                 LPCSTR,
                 ...
                 shared_str );
BIND_FUNCTION10( &object(),
                 CScriptGameObject::GetScriptControl,
                 CScriptEntity,
                 GetScriptControl,
                 bool,
                 false );
BIND_FUNCTION10( &object(),
                 CScriptGameObject::GetScriptControlName,
                 CScriptEntity,
                 GetScriptControlName,
                 LPCSTR,
                 "" );
BIND_FUNCTION10( &object(),
                 CScriptGameObject::GetEnemyStrength,
                 CScriptEntity,
                 get_enemy_strength,
                 int,
                 0 );
BIND_FUNCTION10( &object(),
                 CScriptGameObject::GetActionCount,
                 CScriptEntity,
                 GetActionCount,
                 u32,
                 0 );
BIND_FUNCTION10( &object(),
                 CScriptGameObject::can_script_capture,
                 CScriptEntity,
                 can_script_capture,
                 bool,
                 0 );
...
void CScriptGameObject::ResetActionQueue() {
    ...
    if ( !l_tpScriptMonster )
        ai().script_engine().script_log(
            ...
            make_string( "CSciptEntity [%s]: cannot access class member "
                         "ResetActionQueue!",
...
CScriptEntityAction* CScriptGameObject::GetCurrentAction() const {
    ...
    if ( !l_tpScriptMonster )
        ...
        return ( xr_new< CScriptEntityAction >(
            l_tpScriptMonster->GetCurrentAction() ) );
    return ( 0 );
}
...
void CScriptGameObject::AddAction( const CScriptEntityAction* tpEntityAction,
    ...
    if ( !l_tpScriptMonster )
        ai().script_engine().script_log(
            ScriptStorage::eLuaMessageTypeError,
            make_string(
                "CSciptEntity [%s]: cannot access class member AddAction!",
                object().cNameSect().c_str() )
                .c_str() );
    else
...
const CScriptEntityAction* CScriptGameObject::GetActionByIndex(
    u32 action_index ) {
    CScriptEntity* l_tpScriptMonster =
        smart_cast< CScriptEntity* >( &object() );
    if ( !l_tpScriptMonster ) {
        ai().script_engine().script_log(
            ScriptStorage::eLuaMessageTypeError,
            make_string( "CScriptEntity [%s]: cannot access class member "
                         "GetActionByIndex!",
                         object().cNameSect().c_str() )
                .c_str() );
        return ( 0 );
...
cphysics_shell_scripted* CScriptGameObject::get_physics_shell() const {
    CPhysicsShellHolder* ph_shell_holder =
        smart_cast< CPhysicsShellHolder* >( &object() );
    if ( !ph_shell_holder )
        return NULL;
    if ( !ph_shell_holder->PPhysicsShell() )
        return NULL;
    return get_script_wrapper< cphysics_shell_scripted >(
        *ph_shell_holder->PPhysicsShell() );
}
...
CHelicopter* CScriptGameObject::get_helicopter() {
    ...
    if ( !helicopter ) {
        ai().script_engine().script_log(
            ScriptStorage::eLuaMessageTypeError,
            make_string(
                "CGameObject [%s]: cannot access class member get_helicopter!",
                object().cNameSect().c_str() )
                .c_str() );
        NODEFAULT;
    }
...
CHolderCustom* CScriptGameObject::get_custom_holder() {
    ...
    if ( !holder ) {
        ai().script_engine().script_log( ScriptStorage::eLuaMessageTypeError,
                                         "CGameObject : it is not a holder!" );
    }
    return holder;
}
...
bool CScriptGameObject::CheckObjectVisibility(
    const CScriptGameObject* tpLuaGameObject ) {
    CEntityAlive* entity_alive = smart_cast< CEntityAlive* >( &object() );
    ...
    if ( !script_entity ) {
        ...
        if ( !actor ) {
            ai().script_engine().script_log(
                ScriptStorage::eLuaMessageTypeError,
                make_string( "CScriptGameObject [%s]: cannot access class "
                             "member CheckObjectVisibility!",
                             object().cNameSect().c_str() )
                    .c_str() );
            return ( false );
        }
        return ( actor->memory().visual().visible_now(
            &tpLuaGameObject->object() ) );
    }

    return (
        script_entity->CheckObjectVisibility( &tpLuaGameObject->object() ) );
}
...
void CScriptGameObject::set_start_point( int point_index ) {
    ...
    if ( !monster )
        ai().script_engine().script_log(
            ScriptStorage::eLuaMessageTypeError,
            make_string(
                "CGameObject [%s]: cannot access class member set_start_point!",
                object().cNameSect().c_str() )
                .c_str() );
    else
...
// demonized: manipulate hud fire bone/point data per weapon, must be called
// each time hud item changes or disappears
static attachable_hud_item* get_script_hud_item( CScriptGameObject* object,
                                                 LPCSTR member ) {
...
static void validate_and_set_hud_fire_bone( attachable_hud_item* item,
                                            u16 bone_id,
                                            u16& target,
                                            Flags8::TYPE flag ) {
    ...
    if ( bone_id == BI_NONE || bone_id >= item->m_model->LL_BoneCount() ) {
        Msg( "![%s] Invalid HUD fire bone id %u", item->m_sect_name.c_str(),
             bone_id );
        return;
    }
...
Fvector CScriptGameObject::hud_fire_point() {
    ...
    return item ? item->m_measures.m_fire_point_offset
...
Fvector CScriptGameObject::hud_fire_point2() {
    ...
    return item ? item->m_measures.m_fire_point2_offset
                : Fvector().set( 0.f, 0.f, 0.f );
}

Fvector CScriptGameObject::hud_fire_point_silencer() {
    attachable_hud_item* item =
        get_script_hud_item( this, "hud_fire_point_silencer" );
    return item ? item->m_measures.m_fire_point_silencer
                : Fvector().set( 0.f, 0.f, 0.f );
}

void CScriptGameObject::set_hud_fire_point( Fvector value ) {
    attachable_hud_item* item =
        get_script_hud_item( this, "set_hud_fire_point" );
    if ( !item )
        return;
...
void CScriptGameObject::set_hud_fire_point2( Fvector value ) {
    attachable_hud_item* item =
        get_script_hud_item( this, "set_hud_fire_point2" );
    if ( !item )
        return;
...
void CScriptGameObject::set_hud_fire_point_silencer( Fvector value ) {
    attachable_hud_item* item =
        get_script_hud_item( this, "set_hud_fire_point_silencer" );
    if ( !item )
        return;

    item->m_measures.m_fire_point_silencer = value;
    item->m_measures.m_prop_flags.set( hud_item_measures::e_fire_point_silencer,
                                       TRUE );
}

u16 CScriptGameObject::hud_fire_bone() {
    attachable_hud_item* item = get_script_hud_item( this, "hud_fire_bone" );
    return item && item->m_measures.m_prop_flags.test(
                       hud_item_measures::e_fire_point )
               ? item->m_measures.m_fire_bone
               : BI_NONE;
}
...
u16 CScriptGameObject::hud_fire_bone2() {
    ...
    return item && item->m_measures.m_prop_flags.test(
                       hud_item_measures::e_fire_point2 )
               ? item->m_measures.m_fire_bone2
               : BI_NONE;
}

u16 CScriptGameObject::hud_fire_bone_silencer() {
    attachable_hud_item* item =
        get_script_hud_item( this, "hud_fire_bone_silencer" );
...
void CScriptGameObject::set_hud_fire_bone( u16 bone_id ) {
    attachable_hud_item* item =
        get_script_hud_item( this, "set_hud_fire_bone" );
    if ( !item )
        return;

    validate_and_set_hud_fire_bone( item, bone_id, item->m_measures.m_fire_bone,
                                    hud_item_measures::e_fire_point );
}
...
void CScriptGameObject::set_hud_fire_bone2( u16 bone_id ) {
    attachable_hud_item* item =
        get_script_hud_item( this, "set_hud_fire_bone2" );
    if ( !item )
        return;

    validate_and_set_hud_fire_bone( item, bone_id,
                                    item->m_measures.m_fire_bone2,
                                    hud_item_measures::e_fire_point2 );
}
...
void CScriptGameObject::set_hud_fire_bone_silencer( u16 bone_id ) {
    attachable_hud_item* item =
        get_script_hud_item( this, "set_hud_fire_bone_silencer" );
    if ( !item )
        return;

    validate_and_set_hud_fire_bone( item, bone_id,
                                    item->m_measures.m_fire_bone_silencer,
                                    hud_item_measures::e_fire_point_silencer );
}
...
Fmatrix CScriptGameObject::bone_transform( u16 bone_id, bool bHud ) {
    ...
    if ( bHud ) {
        ...
        if ( itm ) {
            ...
            k = ( bone_id > 20 ) ? g_player_hud->m_model->dcast_PKinematics()
                                 : g_player_hud->m_model_2->dcast_PKinematics();
            xform = ( bone_id > 20 ) ? &g_player_hud->m_transform
                                     : &g_player_hud->m_transform_2;
        }
    } else {
        k = object().Visual()->dcast_PKinematics();
        xform = &object().XFORM();
    ...
    // demonized: backwards compatibility with scripts, get root bone if bone_id
    // is BI_NONE
    if ( bone_id == BI_NONE ) {
        if ( Core.isDebug() && print_bone_warnings ) {
            Msg( "![bone_position] Incorrect bone_id provided for %s (%d), "
                 "fallback to root bone",
                 object().cNameSect_str(), object().ID() );
...
u16 CScriptGameObject::bone_parent( u16 bone_id, bool bHud ) {
    ...
    if ( !k || bone_id == k->LL_GetBoneRoot() || bone_id >= k->LL_BoneCount() )
        return BI_NONE;
...
void CScriptGameObject::set_bone_visible( u16 bone_id,
                                          bool bVisibility,
                                          bool bRecursive,
                                          bool bHud ) {
    if ( bone_id == BI_NONE )
...
int CScriptGameObject::GetAmmoCount( u8 type ) {
    ...
    if ( stm ) {
        return ( type < stm->m_ammoTypes.size() )
                   ? stm->GetAmmoCount_forType( stm->m_ammoTypes[ type ] )
                   : 0;
    }
#endif
...
u32 CScriptGameObject::Cost() const {
    ...
    if ( !inventory_item ) {
        ai().script_engine().script_log(
            ScriptStorage::eLuaMessageTypeError,
            make_string( "CSciptEntity [%s]: cannot access class member Cost!",
                         object().cNameSect().c_str() )
                .c_str() );
        return ( false );
    }
...
float CScriptGameObject::GetCondition() const {
    ...
    if ( !inventory_item ) {
        ai().script_engine().script_log(
            ScriptStorage::eLuaMessageTypeError,
            make_string(
                "CSciptEntity [%s]: cannot access class member GetCondition!",
                object().cNameSect().c_str() )
                .c_str() );
        return ( false );
    }
...
void CScriptGameObject::SetCondition( float val ) {
    ...
    if ( !inventory_item ) {
        ai().script_engine().script_log(
            ScriptStorage::eLuaMessageTypeError,
            make_string(
                "CSciptEntity [%s]: cannot access class member SetCondition!",
                object().cNameSect().c_str() )
                .c_str() );
        return;
    }
...
float CScriptGameObject::GetPsyFactor() const {
    ...
    if ( !pda ) {
        ai().script_engine().script_log(
            ScriptStorage::eLuaMessageTypeError,
            make_string(
                "CSciptEntity [%s]: cannot access class member GetPsyFactor!",
                object().cNameSect().c_str() )
                .c_str() );
        return 0.f;
    }
...
void CScriptGameObject::SetPsyFactor( float val ) {
    ...
    if ( !pda ) {
        ai().script_engine().script_log(
            ScriptStorage::eLuaMessageTypeError,
            make_string(
                "CSciptEntity [%s]: cannot access class member SetPsyFactor!",
                object().cNameSect().c_str() )
                .c_str() );
        return;
    }
...
bool CScriptGameObject::IsDeviceEnabled() const {
    ...
    CCustomDevice* custom_device =
        smart_cast< CCustomDevice* >( m_game_object );
    if ( custom_device )
...
void CScriptGameObject::eat( CScriptGameObject* item ) {
    if ( !item ) {
        ai().script_engine().script_log(
            ScriptStorage::eLuaMessageTypeError,
            make_string( "CSciptEntity [%s]: cannot access class member eat!",
                         object().cNameSect().c_str() )
                .c_str() );
        return;
    }
...
bool CScriptGameObject::inside( const Fvector& position, float epsilon ) const {
    CSpaceRestrictor* space_restrictor =
        smart_cast< CSpaceRestrictor* >( &object() );
    if ( !space_restrictor ) {
        ai().script_engine().script_log(
            ScriptStorage::eLuaMessageTypeError,
            make_string(
                "CSpaceRestrictor [%s]: cannot access class member inside!",
                object().cNameSect().c_str() )
                .c_str() );
        return ( false );
    }
...
void CScriptGameObject::set_fov( float new_fov ) {
    ...
    if ( !monster ) {
        ai().script_engine().script_log(
            ScriptStorage::eLuaMessageTypeError,
            make_string(
                "CCustomMonster [%s]: cannot access class member set_fov!",
                object().cNameSect().c_str() )
                .c_str() );
        return;
    }
...
void CScriptGameObject::set_range( float new_range ) {
    ...
    if ( !monster ) {
        ai().script_engine().script_log(
            ScriptStorage::eLuaMessageTypeError,
            make_string(
                "CCustomMonster [%s]: cannot access class member set_range!",
                object().cNameSect().c_str() )
                .c_str() );
        return;
    }
...
u32 CScriptGameObject::vertex_in_direction( u32 level_vertex_id,
                                            Fvector direction,
    ...
    if ( !monster->movement().restrictions().accessible( level_vertex_id ) ) {
        ai().script_engine().script_log(
            ScriptStorage::eLuaMessageTypeError,
            "CCustomMonster::vertex_in_direction - start vertex id is not "
            "accessible!" );
        return ( u32( -1 ) );
    }
    ...
    u32 result = u32( -1 );
    monster->movement().restrictions().add_border( level_vertex_id,
                                                   max_distance );
    ai().level_graph().farthest_vertex_in_direction(
        level_vertex_id, start_position, finish_position, result, 0, true );
...
bool CScriptGameObject::invulnerable() const {
    ...
    if ( !monster ) {
        ai().script_engine().script_log(
            ScriptStorage::eLuaMessageTypeError,
            make_string(
                "CCustomMonster [%s]: cannot access class member invulnerable!",
                object().cNameSect().c_str() )
                .c_str() );
        return ( false );
    }
...
LPCSTR CScriptGameObject::get_smart_cover_description() const {
    smart_cover::object* smart_cover_object =
        smart_cast< smart_cover::object* >( &object() );
    if ( !smart_cover_object ) {
        ai().script_engine().script_log(
            ScriptStorage::eLuaMessageTypeError,
            "smart_cover::object : cannot access class member "
...
script_attachment* CScriptGameObject::AddAttachment( LPCSTR name,
                                                     LPCSTR model_name ) {
...
void CScriptGameObject::IterateAttachments(
...
CGameObject& CScriptGameObject::object() const {
    ...
    ai().script_engine().script_log(
        eLuaMessageTypeError, "you are trying to use a destroyed object [%x]",
        m_game_object );
...
::luabind::object CScriptGameObject::GetShaders( bool bHud ) {
    ...
    xr_vector< IRenderVisual* >* children_invisible =
        vis->get_children_invisible();

    if ( !children && !children_invisible ) {
        ::luabind::object subtable =
            ::luabind::newtable( ai().script_engine().lua() );
...
void set_shader_tex( IRenderVisual* vis,
                     int id,
                     LPCSTR shader,
                     LPCSTR texture ) {
    xr_vector< IRenderVisual* >* children = vis->get_children();
...
void CScriptGameObject::SetShaderTexture( int id,
                                          LPCSTR shader,
                                          LPCSTR texture,
                                          bool bHud ) {
    IKinematics* k = nullptr;
    ...
    if ( bHud ) {
        ...
        if ( itm )
            ...
            set_shader_tex( g_player_hud->m_model->dcast_RenderVisual(), id,
                            shader, texture );
            set_shader_tex( g_player_hud->m_model_2->dcast_RenderVisual(), id,
                            shader, texture );
            return;
        }
    }
...
void CScriptGameObject::ResetShaderTexture( int id, bool bHud ) {
    ...
    if ( bHud ) {
        ...
        if ( itm )
            ...
            reset_shader_tex( g_player_hud->m_model_2->dcast_RenderVisual(),
                              id );
            return;
        }
    }
