...
public:
    CStalkerActionReachEnemyLocation( CAI_Stalker* object,
...
public:
    CStalkerActionReachAmbushLocation( CAI_Stalker* object,
                                       CPropertyStorage* combat_storage,
                                       LPCSTR action_name = "" );
    virtual void initialize();
    virtual void execute();
...
public:
    CStalkerActionHoldAmbushLocation( CAI_Stalker* object,
                                      CPropertyStorage* combat_storage,
                                      LPCSTR action_name = "" );
    virtual void initialize();
    virtual void execute();
