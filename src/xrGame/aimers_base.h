...
protected:
    ...
    inline void fill_bones( u32 const ( &bones )[ bone_count0 ],
                            u16 const ( &bones_ids )[ bone_count1 ],
                            Fmatrix ( &local_bones )[ bone_count1 ],
                            Fmatrix ( &global_bones )[ bone_count1 ] );
    void aim_at_position( Fvector const& bone_position,
                          Fvector const& object_position,
                          Fvector object_direction,
                          Fmatrix& result );
    void aim_at_direction( Fvector const& bone_position,
                           Fvector const& object_position,
