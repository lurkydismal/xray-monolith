...
class CALifeCombatManager : public virtual CALifeSimulatorBase, CRandom {
    ...
    protected:
            u32
    m_dwMaxCombatIterationCount; ALife::ECombatType
    m_combat_type;
    ...
    protected:
                            void
    vfFillCombatGroup			(CSE_ALifeSchedulable
    *tpALifeSchedulable,		int
    iGroupIndex); bool					bfCheckObjectDetection
    (CSE_ALifeSchedulable		*tpALifeSchedulable1,
    CSE_ALifeSchedulable	*tpALifeSchedulable2); bool
    bfCheckForInteraction		(CSE_ALifeSchedulable
    *tpALifeSchedulable1,		CSE_ALifeSchedulable
    *tpALifeSchedulable2,			int
    &iCombatGroupIndex,			bool
    &bMutualDetection); void
    vfPerformAttackAction		(int
    iCombatGroupIndex); bool
    bfCheckIfRetreated			(int
    iCombatGroupIndex); void					vfFinishCombat
...
public:
    ...
    /**
            virtual
    ~CALifeCombatManager		(); IC		ALife::ECombatType
    combat_type					() const; ALife::ECombatAction
    choose_combat_action		(int
    iCombatGroupIndex); ALife::ERelationType	relation_type
    (CSE_ALifeMonsterAbstract	*tpALifeMonsterAbstract1,
    CSE_ALifeMonsterAbstract*tpALifeMonsterAbstract2) const;
    /**/
    void kill_entity( CSE_ALifeMonsterAbstract* l_tpALifeMonsterAbstract,
