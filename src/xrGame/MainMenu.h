...
public:
    ...
    // CGameSpy_Full*						GetGS
    // ()	{return m_pGameSpyFull;}; gamespy_gp::account_manager*
    // GetAccountMngr	()	{ return m_account_mngr; };
    // gamespy_gp::login_manager*			GetLoginMngr	()
    // { return m_login_mngr; }; gamespy_profile::profile_store*
    // GetProfileStore	()	{ return m_profile_store; };
    // gamespy_profile::stats_submitter*	GetStatsSubmitter()	{ return
    // m_stats_submitter; }; atlas_submit_queue*
    // GetSubmitQueue	()	{ return m_atlas_submit_queue; };
protected:
...
public:
    ...
    void Screenshot(
        IRender_interface::ScreenshotMode mode = IRender_interface::SM_NORMAL,
        LPCSTR name = 0 );
