...
static u32 days_in_month[ 12 ] = { 31u, 28u, 31u, 30u, 31u, 30u,
                                   31u, 31u, 30u, 31u, 30u, 31u };

u64 generate_time( u32 years,
                   u32 months,
                   u32 days,
                   u32 hours,
                   u32 minutes,
    ...
    u64 result = years_minus_1 * 365 + years_minus_1 / 4 - years_minus_1 / 100 +
                 years_minus_1 / 400;
...
void split_time( u64 time,
    ...
    for ( u32 it = 0; it < months; it++ ) {
        if ( ( it == 1 ) &&
             days_in_month[ it ] + extra_day_count( years ) < time ) {
            ++months;
