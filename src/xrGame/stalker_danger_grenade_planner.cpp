...
CStalkerDangerGrenadePlanner::CStalkerDangerGrenadePlanner( CAI_Stalker* object,
                                                            LPCSTR action_name )
    : inherited( object, action_name ) {}

void CStalkerDangerGrenadePlanner::setup( CAI_Stalker* object,
...
void CStalkerDangerGrenadePlanner::initialize() {
    ...
    CScriptActionPlanner::m_storage.set_property( eWorldPropertyCoverReached,
                                                  false );
    CScriptActionPlanner::m_storage.set_property( eWorldPropertyLookedAround,
                                                  false );
}
...
void CStalkerDangerGrenadePlanner::add_evaluators() {
    ...
    add_evaluator( eWorldPropertyCoverActual,
                   xr_new< CStalkerPropertyEvaluatorDangerUnknownCoverActual >(
                       m_object, "danger grenade : cover actual" ) );
    add_evaluator( eWorldPropertyCoverReached,
                   xr_new< CStalkerPropertyEvaluatorMember >(
                       ( CPropertyStorage* )0, eWorldPropertyCoverReached, true,
                       true, "danger grenade : cover reached" ) );
    add_evaluator( eWorldPropertyGrenadeExploded,
                   xr_new< CStalkerPropertyEvaluatorDangerGrenadeExploded >(
                       m_object, "grenade exploded" ) );
    add_evaluator( eWorldPropertyLookedAround,
                   xr_new< CStalkerPropertyEvaluatorMember >(
                       ( CPropertyStorage* )0, eWorldPropertyLookedAround, true,
                       true, "danger grenade : looked around" ) );
}

void CStalkerDangerGrenadePlanner::add_actions() {
    CStalkerActionBase* action;

    action = xr_new< CStalkerActionDangerGrenadeTakeCover >( m_object,
                                                             "take cover" );
    ...
    action = xr_new< CStalkerActionDangerGrenadeWaitForExplosion >(
        m_object, "wait for explosion" );
    ...
    action = xr_new< CStalkerActionDangerGrenadeTakeCoverAfterExplosion >(
        m_object, "take cover after explosion" );
    ...
    action = xr_new< CStalkerActionDangerGrenadeLookAround >( m_object,
                                                              "look around" );
    add_condition( action, eWorldPropertyGrenadeExploded, true );
    add_condition( action, eWorldPropertyCoverActual, true );
    add_condition( action, eWorldPropertyCoverReached, true );
