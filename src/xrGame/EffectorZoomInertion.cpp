...
BOOL CEffectorZoomInertion::ProcessCam( SCamEffectorInfo& info ) {
    ...
    m_vCurrentPoint.lerp( m_vLastPoint, m_vTargetPoint,
                          float( m_dwTimePassed ) / m_dwDeltaTime );
