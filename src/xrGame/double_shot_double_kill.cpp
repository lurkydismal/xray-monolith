...
double_shot_double_kill::double_shot_double_kill(
...
void double_shot_double_kill::OnWeapon_Fire( u16 sender,
...
void double_shot_double_kill::OnPlayerKilled(
    ...
    if ( !m_owner->is_item_in_group( m_owner->get_object_id( weapon_id ),
