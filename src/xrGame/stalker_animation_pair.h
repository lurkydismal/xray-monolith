...
private:
    void select_animation( const ANIM_VECTOR& array,
                           const ANIMATION_WEIGHTS* weights );
#ifndef USE_HEAD_BONE_PART_FAKE
    void play_global_animation( IKinematicsAnimated* skeleton_animated,
...
public:
    ...
    void synchronize(
        ...
        const CStalkerAnimationPair& stalker_animation_pair ) const;
    MotionID select( const ANIM_VECTOR& array,
                     const ANIMATION_WEIGHTS* weights = 0 );
...
public:
#ifndef USE_HEAD_BONE_PART_FAKE
    void play( IKinematicsAnimated* skeleton_animated,
               PlayCallback callback,
               const bool& use_animation_movement_control,
               const bool& local_animation,
...
public:
    ...
    BLEND_ID* blend_id( IKinematicsAnimated* skeleton_animated,
                        BLEND_ID& result ) const;
#endif // DEBUG
...
public:
    ...
    bool use_animation_movement_control( IKinematicsAnimated* skeleton_animated,
