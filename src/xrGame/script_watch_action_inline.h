...
// Searchlight look ///////////////////////////////////////////////
IC CScriptWatchAction::CScriptWatchAction( const Fvector& tTarget,
                                           float vel1,
                                           float vel2 )
...
IC CScriptWatchAction::CScriptWatchAction( CScriptGameObject* tpObjectToWatch,
                                           float vel1,
                                           float vel2 ) {
    SetWatchObject( tpObjectToWatch );
    vel_bone_x = vel1;
...
IC void CScriptWatchAction::SetWatchType(
    SightManager::ESightType tWatchType ) {
