...
struct CEdgePath {
    ...
    class CDataStorage
        : public CVertexPath< bEuclidianHeuristics >::template CDataStorage<
              DataStorageEdgePath< _vertex >::_vertex > {
    public:
        typedef
            typename CVertexPath< bEuclidianHeuristics >::template CDataStorage<
                DataStorageEdgePath< _vertex >::_vertex >
                inherited;
    ...
    public:
        ...
        IC void assign_parent( CGraphVertex& neighbour,
                               CGraphVertex* parent,
                               const _edge_type& edge );
        IC void get_edge_path( xr_vector< _edge_type >& path,
                               CGraphVertex* best,
