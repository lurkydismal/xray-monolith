...
public:
    CStalkerActionGetReadyToKillLowCover( CAI_Stalker* object,
                                          LPCSTR action_name = "" );
...
public:
    CStalkerActionKillEnemyLowCover( CAI_Stalker* object,
                                     LPCSTR action_name = "" );
    virtual void initialize();
    virtual void execute();
    virtual void finalize();
...
public:
    CStalkerActionHoldPositionLowCover( CAI_Stalker* object,
                                        LPCSTR action_name = "" );
    virtual void initialize();
    virtual void execute();
    virtual void finalize();
