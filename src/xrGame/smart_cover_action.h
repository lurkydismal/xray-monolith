...
class action : private debug::make_final< action >, private xray::noncopyable {
private:
...
public:
    ...
    typedef associative_vector< shared_str, Animations*, animation_predicate >
        AnimationList;
...
public:
    ...
    IC Animations const& animations( shared_str const& cover_id,
                                     shared_str const& id ) const;
