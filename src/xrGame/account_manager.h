...
typedef mixed_delegate< void( bool, char const* ), account_operation_cb_tag >
    account_operation_cb;

typedef mixed_delegate< void( u32 const, char const* ),
                        account_profiles_cb_tag >
    account_profiles_cb;

typedef mixed_delegate< void( bool, char const* ), found_emails_cb_tag >
    found_email_cb;

typedef mixed_delegate< void( u32 const, char const* ), suggest_nicks_cb_tag >
    suggest_nicks_cb;
...
public:
    ...
    void search_for_email( char const* email, found_email_cb found_email_cb );
...
private:
    ...
    void __stdcall only_log_creation_cb( bool success, char const* descr );

    account_operation_cb m_profile_deleting_cb;
    void __stdcall only_log_profdel_cb( bool success, char const* descr );
    ...
    queued_async_method< account_manager,
                         get_account_params_t,
                         account_profiles_cb,
                         &account_manager::get_account_profiles_raw,
                         &account_manager::release_account_profiles >
        m_get_account_profiles_qam;
    ...
    queued_async_method< account_manager,
                         ...
                         &account_manager::release_found_email >
        m_search_for_email_qam;
    void stop_search_for_email();
    found_email_cb m_found_email_cb;
    void __stdcall only_log_found_email( bool found, char const* user_name );
    ...
    queued_async_method< account_manager,
                         ...
                         &account_manager::release_suggest_uniqie_nicks >
        m_suggest_uniqie_nicks_qam;
    ...
    static void __cdecl search_profile_cb( GPConnection* connection,
                                           void* arg,
                                           void* param );
    /*static void __cdecl			profiles_cb
       (GPConnection * connection, void * arg, void * param);*/
