...
#define CEdgePathBuilder \
    CEdgePath< _edge_type, bEuclidianHeuristics >::CDataStorage< _vertex >
...
TEMPLATE_SPECIALIZATION
IC void CEdgePathBuilder::assign_parent( CGraphVertex& neighbour,
                                         CGraphVertex* parent ) {
...
TEMPLATE_SPECIALIZATION
IC void CEdgePathBuilder::get_edge_path( xr_vector< _edge_type >& path,
                                         CGraphVertex* best,
                                         bool reverse_order ) {
