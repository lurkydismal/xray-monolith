...
typedef CWrapperAbstract2< CAI_Stalker, CPropertyEvaluator >
    CStalkerPropertyEvaluator;
typedef CWrapperAbstract2< CAI_Stalker, CPropertyEvaluatorConst >
    CStalkerPropertyEvaluatorConst;
typedef CWrapperAbstract2< CAI_Stalker, CPropertyEvaluatorMember >
    CStalkerPropertyEvaluatorMember;
...
public:
    CStalkerPropertyEvaluatorALife( CAI_Stalker* object = 0,
...
public:
    CStalkerPropertyEvaluatorAlive( CAI_Stalker* object = 0,
                                    LPCSTR evaluator_name = "" );
    virtual _value_type evaluate();
};
...
public:
    CStalkerPropertyEvaluatorItems( CAI_Stalker* object = 0,
                                    LPCSTR evaluator_name = "" );
    virtual _value_type evaluate();
};
...
public:
    CStalkerPropertyEvaluatorEnemies( CAI_Stalker* object = 0,
                                      LPCSTR evaluator_name = "",
                                      u32 time_to_wait = 0,
...
public:
    CStalkerPropertyEvaluatorSeeEnemy( CAI_Stalker* object = 0,
                                       LPCSTR evaluator_name = "" );
    virtual _value_type evaluate();
};
...
public:
    CStalkerPropertyEvaluatorEnemySeeMe( CAI_Stalker* object = 0,
                                         LPCSTR evaluator_name = "" );
    virtual _value_type evaluate();
};
...
public:
    CStalkerPropertyEvaluatorItemToKill( CAI_Stalker* object = 0,
                                         LPCSTR evaluator_name = "" );
    virtual _value_type evaluate();
};
...
public:
    CStalkerPropertyEvaluatorItemCanKill( CAI_Stalker* object = 0,
                                          LPCSTR evaluator_name = "" );
    virtual _value_type evaluate();
};
...
class CStalkerPropertyEvaluatorFoundItemToKill
    : public CStalkerPropertyEvaluator {
protected:
    typedef CStalkerPropertyEvaluator inherited;

public:
    CStalkerPropertyEvaluatorFoundItemToKill( CAI_Stalker* object = 0,
                                              LPCSTR evaluator_name = "" );
    virtual _value_type evaluate();
};
...
public:
    CStalkerPropertyEvaluatorFoundAmmo( CAI_Stalker* object = 0,
                                        LPCSTR evaluator_name = "" );
    virtual _value_type evaluate();
};
...
public:
    CStalkerPropertyEvaluatorReadyToKill( CAI_Stalker* object = 0,
                                          LPCSTR evaluator_name = "",
...
class CStalkerPropertyEvaluatorReadyToKillSmartCover
    : public CStalkerPropertyEvaluatorReadyToKill {
protected:
    typedef CStalkerPropertyEvaluatorReadyToKill inherited;

public:
    CStalkerPropertyEvaluatorReadyToKillSmartCover( CAI_Stalker* object = 0,
                                                    LPCSTR evaluator_name = "",
                                                    u32 min_ammo_count = 0 );
    virtual _value_type evaluate();
};
...
class CStalkerPropertyEvaluatorReadyToDetour
    : public CStalkerPropertyEvaluator {
protected:
    typedef CStalkerPropertyEvaluator inherited;

public:
    CStalkerPropertyEvaluatorReadyToDetour( CAI_Stalker* object = 0,
                                            LPCSTR evaluator_name = "" );
    virtual _value_type evaluate();
};
...
public:
    CStalkerPropertyEvaluatorAnomaly( CAI_Stalker* object = 0,
                                      LPCSTR evaluator_name = "" );
    virtual _value_type evaluate();
};
...
class CStalkerPropertyEvaluatorInsideAnomaly
    : public CStalkerPropertyEvaluator {
protected:
    typedef CStalkerPropertyEvaluator inherited;

public:
    CStalkerPropertyEvaluatorInsideAnomaly( CAI_Stalker* object = 0,
                                            LPCSTR evaluator_name = "" );
    virtual _value_type evaluate();
};
...
public:
    CStalkerPropertyEvaluatorPanic( CAI_Stalker* object = 0,
                                    LPCSTR evaluator_name = "" );
    virtual _value_type evaluate();
};
...
class CStalkerPropertyEvaluatorSmartTerrainTask
    : public CStalkerPropertyEvaluator {
protected:
    typedef CStalkerPropertyEvaluator inherited;

public:
    CStalkerPropertyEvaluatorSmartTerrainTask( CAI_Stalker* object = 0,
                                               LPCSTR evaluator_name = "" );
    virtual _value_type evaluate();
};
...
public:
    CStalkerPropertyEvaluatorEnemyReached( CAI_Stalker* object = 0,
                                           LPCSTR evaluator_name = "" );
    virtual _value_type evaluate();
};
...
class CStalkerPropertyEvaluatorPlayerOnThePath
    : public CStalkerPropertyEvaluator {
protected:
    typedef CStalkerPropertyEvaluator inherited;

public:
    CStalkerPropertyEvaluatorPlayerOnThePath( CAI_Stalker* object = 0,
                                              LPCSTR evaluator_name = "" );
    virtual _value_type evaluate();
};
...
class CStalkerPropertyEvaluatorEnemyCriticallyWounded
    : public CStalkerPropertyEvaluator {
protected:
    typedef CStalkerPropertyEvaluator inherited;
...
class CStalkerPropertyEvaluatorShouldThrowGrenade
    : public CStalkerPropertyEvaluator {
protected:
    typedef CStalkerPropertyEvaluator inherited;

public:
    CStalkerPropertyEvaluatorShouldThrowGrenade( CAI_Stalker* object = 0,
                                                 LPCSTR evaluator_name = "" );
    virtual _value_type evaluate();
};
...
class CStalkerPropertyEvaluatorTooFarToKillEnemy
    : public CStalkerPropertyEvaluator {
protected:
    typedef CStalkerPropertyEvaluator inherited;

public:
    CStalkerPropertyEvaluatorTooFarToKillEnemy( CAI_Stalker* object = 0,
                                                LPCSTR evaluator_name = "" );
    virtual _value_type evaluate();
};
...
public:
    CStalkerPropertyEvaluatorLowCover( CAI_Stalker* object = 0,
                                       LPCSTR evaluator_name = "" );
    virtual _value_type evaluate();
};
