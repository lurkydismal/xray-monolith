...
#define CLevelFlooderPathManager                                        \
    CPathManager< CLevelGraph, _DataStorage,                            \
                  SFlooder< _dist_type, _index_type, _iteration_type >, \
...
TEMPLATE_SPECIALIZATION
IC void CLevelFlooderPathManager::setup( const _Graph* _graph,
...
TEMPLATE_SPECIALIZATION
IC bool CLevelFlooderPathManager::is_goal_reached(
...
TEMPLATE_SPECIALIZATION
IC _dist_type
CLevelFlooderPathManager::evaluate( const _index_type& node_index1,
...
TEMPLATE_SPECIALIZATION
IC _dist_type
CLevelFlooderPathManager::estimate( const _index_type& node_index ) const {
    VERIFY( graph );
    return ( _dist_type( 0 ) );
}

TEMPLATE_SPECIALIZATION
IC bool CLevelFlooderPathManager::is_accessible(
...
TEMPLATE_SPECIALIZATION
IC bool CLevelFlooderPathManager::is_limit_reached(
