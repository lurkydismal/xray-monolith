...
public:
    ...
    struct CSoundCollectionParamsFull : public CSoundParams,
    ...
    struct CInappropriateSoundPredicate {
        ...
        CInappropriateSoundPredicate( u32 sound_mask )
...
public:
    typedef std::pair< CSoundCollectionParamsFull, CSoundCollection* >
        SOUND_COLLECTION;
