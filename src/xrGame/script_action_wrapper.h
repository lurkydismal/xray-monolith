...
class CScriptActionWrapper : public CScriptActionBase,
                             public ::luabind::wrap_base {
public:
    IC CScriptActionWrapper( CScriptGameObject* object = 0,
                             LPCSTR action_name = "" );
    virtual void setup( CScriptGameObject* object, CPropertyStorage* storage );
    static void setup_static( CScriptActionBase* action,
