...
void CWeaponKnife::script_register( lua_State* L ) {
    module( L )[ class_< CWeaponKnife, CGameObject >( "CWeaponKnife" )
                     .def( constructor<>() )
                     .def( "GetHit1Power", &CWeaponKnife::GetHit1Power )
                     .def( "GetHit2Power", &CWeaponKnife::GetHit2Power )
                     .def( "GetHit1PowerCritical",
                           &CWeaponKnife::GetHit1PowerCritical )
                     .def( "GetHit2PowerCritical",
                           &CWeaponKnife::GetHit2PowerCritical )
                     ...
                     .def( "SetHit1PowerCritical",
                           &CWeaponKnife::SetHit1PowerCritical )
                     .def( "SetHit2PowerCritical",
                           &CWeaponKnife::SetHit2PowerCritical )
