...
CAgentManagerActionNoOrders::CAgentManagerActionNoOrders( CAgentManager* object,
                                                          LPCSTR action_name )
...
CAgentManagerActionGatherItems::CAgentManagerActionGatherItems(
    CAgentManager* object,
    LPCSTR action_name )
    : inherited( object, action_name ) {}
...
CAgentManagerActionKillEnemy::CAgentManagerActionKillEnemy(
    CAgentManager* object,
    LPCSTR action_name )
    : inherited( object, action_name ) {}
...
CAgentManagerActionReactOnDanger::CAgentManagerActionReactOnDanger(
    CAgentManager* object,
    LPCSTR action_name )
    : inherited( object, action_name ) {}
