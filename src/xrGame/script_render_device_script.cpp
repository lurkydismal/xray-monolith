...
void CScriptRenderDevice::script_register( lua_State* L ) {
    module(
        L )[ class_< CRenderDevice >( "render_device" )
                 ...
                 //			.def_readonly("view",
                 //&CRenderDevice::mView) 			.def_readonly("projection",
                 //&CRenderDevice::mProject) 			.def_readonly("full_transform",
                 //&CRenderDevice::mFullTransform)
