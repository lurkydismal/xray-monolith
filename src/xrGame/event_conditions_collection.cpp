...
event_condition_t* event_conditions_collection::add_condition(
    ...
    for ( buffer_vector< event_argument_type >::const_iterator
              i = arguments.begin(),
              ie = arguments.end();
          i != ie; ++i ) {
...
void event_conditions_collection::add_event( event_condition_t* root_condition,
...
bool event_conditions_collection::logical_and( arguments_t& arguments ) {
    ...
    bool result = true;
    for ( arguments_t::iterator i = arguments.begin(), ie = arguments.end();
          i != ie; ++i ) {
...
bool event_conditions_collection::hit_params( arguments_t& arguments ) {
    ...
    VERIFY( arguments[ hpa_hit_count ].m_argument_type_tag ==
            event_argument_type::at_u32 );
    VERIFY( arguments[ hpa_hit_wpn_group_id ].m_argument_type_tag ==
            event_argument_type::at_u16 );
    VERIFY( arguments[ hpa_hit_bone_group_id ].m_argument_type_tag ==
            event_argument_type::at_u16 );
    VERIFY( arguments[ hpa_bfunc ].m_argument_type_tag ==
            event_argument_type::at_float_bfunction );
    VERIFY( arguments[ hpa_hit_distance ].m_argument_type_tag ==
            event_argument_type::at_float );

    return m_player_state_accum->check_hit_params(
        arguments[ hpa_hit_count ].m_argument_value.u32_value,
        static_cast< ammunition_group::enum_group_id >(
            arguments[ hpa_hit_wpn_group_id ].m_argument_value.u16_value ),
        static_cast< bone_group::enum_group_id >(
            arguments[ hpa_hit_bone_group_id ].m_argument_value.u16_value ),
...
bool event_conditions_collection::kill_params( arguments_t& arguments ) {
    ...
    VERIFY( arguments[ kpa_kill_count ].m_argument_type_tag ==
            event_argument_type::at_u32 );
    VERIFY( arguments[ kpa_kill_wpn_group_id ].m_argument_type_tag ==
            event_argument_type::at_u16 );
    VERIFY( arguments[ kpa_kill_kill_type ].m_argument_type_tag ==
            event_argument_type::at_u16 );
    VERIFY( arguments[ kpa_kill_spec_kill_type ].m_argument_type_tag ==
            event_argument_type::at_u16 );
    VERIFY( arguments[ kpa_kill_time_period ].m_argument_type_tag ==
            event_argument_type::at_u32 );

    return m_player_state_accum->check_kill_params(
        arguments[ kpa_kill_count ].m_argument_value.u32_value,
        static_cast< ammunition_group::enum_group_id >(
            arguments[ kpa_kill_wpn_group_id ].m_argument_value.u16_value ),
        static_cast< KILL_TYPE >(
            arguments[ kpa_kill_kill_type ].m_argument_value.u16_value ),
        static_cast< SPECIAL_KILL_TYPE >(
            arguments[ kpa_kill_spec_kill_type ].m_argument_value.u16_value ),
...
bool event_conditions_collection::accumul_params( arguments_t& arguments ) {
    ...
    VERIFY( arguments[ cpa_param_id ].m_argument_type_tag ==
            event_argument_type::at_u16 );
    VERIFY( ( arguments[ cpa_bfunc ].m_argument_type_tag ==
              event_argument_type::at_float_bfunction ) ||
            ( arguments[ cpa_bfunc ].m_argument_type_tag ==
              event_argument_type::at_u32_bfunction ) );
    VERIFY( ( arguments[ cpa_value ].m_argument_type_tag ==
              event_argument_type::at_float ) ||
            ( arguments[ cpa_value ].m_argument_type_tag ==
              event_argument_type::at_u32 ) );
    if ( arguments[ cpa_value ].m_argument_type_tag ==
         event_argument_type::at_float ) {
        return m_player_state_accum->check_accumulative_value(
            static_cast< enum_accumulative_player_values >(
                arguments[ cpa_param_id ].m_argument_value.u16_value ),
...
bool event_conditions_collection::execute_condition( event_condition_t* cond ) {
    ...
    switch ( cond->m_operation ) {
        case eo_logical_and:
            result = logical_and( cond->m_arguments );
            break;
        case eo_logical_or:
            result = logical_or( cond->m_arguments );
            break;
        case eo_hit_params:
            result = hit_params( cond->m_arguments );
            break;
        case eo_kill_params:
            result = kill_params( cond->m_arguments );
            break;
        case eo_accumul_value_params:
            result = accumul_params( cond->m_arguments );
            break;
    }; // switch (cond->m_operation)
    return result;
}

void event_conditions_collection::execute_root_condtiion(
    event_root_conditions_t::value_type& rcond ) {
...
event_condition_t* event_conditions_collection::add_and_condition(
    event_condition_t* left,
    event_condition_t* right ) {
    buffer_vector< event_argument_type > args_buffer(
        _alloca( sizeof( event_argument_type ) * 2 ), 2 );
