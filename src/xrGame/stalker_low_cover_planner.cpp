...
stalker_low_cover_planner::stalker_low_cover_planner( CAI_Stalker* object,
                                                      LPCSTR action_name )
    : inherited( object, action_name ) {}

void stalker_low_cover_planner::setup( CAI_Stalker* object,
...
void stalker_low_cover_planner::add_evaluators() {
    add_evaluator(
        ...
        xr_new< CStalkerPropertyEvaluatorConst >( true, "using low cover" ) );
...
void stalker_low_cover_planner::add_actions() {
    ...
    action = xr_new< CStalkerActionGetReadyToKillLowCover >(
        m_object, "get_ready_to_kill" );
    ...
    action =
        xr_new< CStalkerActionKillEnemyLowCover >( m_object, "kill_enemy" );
    ...
    action = xr_new< CStalkerActionHoldPositionLowCover >( m_object,
                                                           "hold_position" );
    add_condition( action, eWorldPropertyReadyToKill, true );
