...
public:
    ...
    typedef xr_delegate< R( Param1, Param2 ) > fastdelegate_type;
    ...
    mixed_delegate( ThisRef* ptr_this,
...
#define DEFINE_MIXED_DELEGATE_SCRIPT( type, name_str )                        \
    ...
    void type::script_register( lua_State* L ) {                              \
        using callback_t = void ( type::* )( type::lua_object_type,           \
                                             type::lua_function_type );       \
        module(                                                               \
            L )[ class_< type >( name_str )                                   \
                     .def( constructor<>() )                                  \
                     .def( constructor< type::lua_object_type,                \
                                        type::lua_function_type >() )         \
