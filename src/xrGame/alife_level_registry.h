...
class CALifeLevelRegistry
    : public CSafeMapIterator< ALife::_OBJECT_ID, CSE_ALifeDynamicObject > {
protected:
...
public:
    ...
    IC void remove( CSE_ALifeDynamicObject* tpALifeDynamicObject,
    ...
    IC CSE_ALifeDynamicObject* object( const ALife::_OBJECT_ID& id,
                                       bool no_assert = false ) const;
};
