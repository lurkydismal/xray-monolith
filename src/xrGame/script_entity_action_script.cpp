...
void CScriptEntityAction::script_register( lua_State* L ) {
    module( L )
        [ class_< CScriptEntityAction >( "entity_action" )
              ...
              .def( "set_action", ( void ( CScriptEntityAction::* )(
                                      CScriptMovementAction& ) )(
                                      &CScriptEntityAction::SetAction ) )
              .def( "set_action",
                    ( void ( CScriptEntityAction::* )( CScriptWatchAction& ) )(
                        &CScriptEntityAction::SetAction ) )
              .def( "set_action", ( void ( CScriptEntityAction::* )(
                                      CScriptAnimationAction& ) )(
                                      &CScriptEntityAction::SetAction ) )
              .def( "set_action",
                    ( void ( CScriptEntityAction::* )( CScriptSoundAction& ) )(
                        &CScriptEntityAction::SetAction ) )
              .def( "set_action", ( void ( CScriptEntityAction::* )(
                                      CScriptParticleAction& ) )(
                                      &CScriptEntityAction::SetAction ) )
              .def( "set_action",
                    ( void ( CScriptEntityAction::* )( CScriptObjectAction& ) )(
                        &CScriptEntityAction::SetAction ) )
              .def( "set_action", ( void ( CScriptEntityAction::* )(
                                      CScriptActionCondition& ) )(
                                      &CScriptEntityAction::SetAction ) )
              .def( "set_action", ( void ( CScriptEntityAction::* )(
                                      CScriptMonsterAction& ) )(
                                      &CScriptEntityAction::SetAction ) )
              ...
              .def( "all", ( bool ( CScriptEntityAction::* )() )(
                               &CScriptEntityAction::CheckIfActionCompleted ) )
              .def( "completed",
                    ( bool ( CScriptEntityAction::* )() )(
                        &CScriptEntityAction::CheckIfActionCompleted ) ) ];
}
