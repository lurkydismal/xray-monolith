...
void CHelicopter::script_register( lua_State* L ) {
    module( L )
        [ class_< CHelicopter, CGameObject >( "CHelicopter" )
              .def( constructor<>() )
              .enum_( "state" )[ value( "eAlive", int( CHelicopter::eAlive ) ),
              ...
              .enum_(
                  "hunt_state" )[ value( "eEnemyNone", int( eEnemyNone ) ),
                                  value( "eEnemyPoint", int( eEnemyPoint ) ),
                                  value( "eEnemyEntity", int( eEnemyEntity ) ) ]
              .enum_(
                  "body_state" )[ value( "eBodyByPath", int( eBodyByPath ) ),
              ...
              .def( "GetDistanceToDestPosition",
                    &CHelicopter::GetDistanceToDestPosition )

              .def( "ClearEnemy", &CHelicopter::UnSetEnemy )
              .def( "SetEnemy",
                    ( void ( CHelicopter::* )(
                        CScriptGameObject* ) )&CHelicopter::SetEnemy )
              .def( "SetEnemy", ( void ( CHelicopter::* )(
                                    Fvector* ) )&CHelicopter::SetEnemy )
              ...
              .def( "SetBarrelDirTolerance",
                    &CHelicopter::SetBarrelDirTolerance )

              .def( "UseFireTrail", ( bool ( CHelicopter::* )(
                                        void ) )&CHelicopter::UseFireTrail )
              .def( "UseFireTrail", ( void ( CHelicopter::* )(
              ...
              .def_readwrite( "m_use_rocket_on_attack",
                              &CHelicopter::m_use_rocket_on_attack )
              .def_readwrite( "m_use_mgun_on_attack",
                              &CHelicopter::m_use_mgun_on_attack )
              .def_readwrite( "m_min_rocket_dist",
                              &CHelicopter::m_min_rocket_dist )
              .def_readwrite( "m_max_rocket_dist",
              ...
              .def_readwrite( "m_time_between_rocket_attack",
                              &CHelicopter::m_time_between_rocket_attack )
              .def_readwrite( "m_syncronize_rocket",
