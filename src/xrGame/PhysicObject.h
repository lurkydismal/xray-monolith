...
public:
    ...
    // virtual void
    // make_Interpolation	(); // interpolation from last visible to
    // corrected position/rotation
    virtual void Interpolate();
    float interpolate_states( net_update_PItem const& first,
...
public:
    static void PhysicContactCallback( bool& do_colide,
                                       bool bo1,
                                       dContact& c,
                                       SGameMtl* material_1,
                                       SGameMtl* material_2 );
