...
class stalker_movement_manager_smart_cover
    : public stalker_movement_manager_obstacles {
private:
...
public:
    ...
    bool in_fov( shared_str const& cover_id,
                 shared_str const& loophole_id,
                 Fvector const& position ) const;
    bool in_range( shared_str const& cover_id,
                   shared_str const& loophole_id,
                   Fvector const& position ) const;
...
private:
    ...
    // fov range checks
private:
    bool in_min_acceptable_range( shared_str const& cover_id,
                                  shared_str const& loophole_id,
...
private:
    ...
    loophole_type const& loophole( cover_type const& cover,
...
private:
    void loophole_path( smart_cover::cover const& cover,
    ...
    transition_action const& action( smart_cover::cover const& cover,
