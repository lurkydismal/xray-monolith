...
struct CSolverConditionValue {
    ...
    IC CSolverConditionValue( const _solver_condition_type& condition,
                              const _solver_value_type& value ) {
...
typedef COperatorConditionAbstract< _solver_condition_type, _solver_value_type >
    CWorldProperty;
...
typedef SBaseParameters< _solver_dist_type,
                         _solver_index_type,
                         _iteration_type >
    CSolverBaseParameters;
typedef SBaseParameters< _dist_type, _index_type, _iteration_type >
    CBaseParameters;

typedef SFlooder< _dist_type, _index_type, _iteration_type > CFlooder;
typedef SStraightLineParams< _dist_type, _index_type, _iteration_type >
    CStraightLineParams;
typedef SNearestVertex< _dist_type, _index_type, _iteration_type >
    CNearestVertexParameters;
typedef SGameLevel< _dist_type, _index_type, _iteration_type > CGameLevelParams;
typedef SGameVertex< _dist_type, _index_type, _iteration_type >
    CGameVertexParams;
}; // namespace GraphEngineSpace
