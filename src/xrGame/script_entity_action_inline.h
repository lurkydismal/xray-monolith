...
IC CScriptEntityAction::CScriptEntityAction(
    const CScriptEntityAction* entity_action ) {
    *this = *entity_action;
}
...
IC void CScriptEntityAction::SetAction(
    CScriptMovementAction& tMovementAction ) {
...
IC void CScriptEntityAction::SetAction(
    CScriptAnimationAction& tAnimationAction ) {
...
IC void CScriptEntityAction::SetAction(
    CScriptParticleAction& tParticleAction ) {
...
IC void CScriptEntityAction::SetAction(
    CScriptActionCondition& tActionCondition ) {
...
IC bool CScriptEntityAction::CheckIfActionCompleted(
    const CScriptAbstractAction& tAbstractAction ) const {
...
IC bool CScriptEntityAction::CheckIfActionCompleted() {
    ...
    if ( ( CScriptActionCondition::MOVEMENT_FLAG &
           m_tActionCondition.m_dwFlags ) &&
         CheckIfMovementCompleted() )
        l_dwFlags ^= CScriptActionCondition::MOVEMENT_FLAG;
    if ( ( CScriptActionCondition::WATCH_FLAG &
           m_tActionCondition.m_dwFlags ) &&
         CheckIfWatchCompleted() )
        l_dwFlags ^= CScriptActionCondition::WATCH_FLAG;
    if ( ( CScriptActionCondition::ANIMATION_FLAG &
           m_tActionCondition.m_dwFlags ) &&
         CheckIfAnimationCompleted() )
        l_dwFlags ^= CScriptActionCondition::ANIMATION_FLAG;
    if ( ( CScriptActionCondition::SOUND_FLAG &
           m_tActionCondition.m_dwFlags ) &&
         CheckIfSoundCompleted() )
        l_dwFlags ^= CScriptActionCondition::SOUND_FLAG;
    if ( ( CScriptActionCondition::PARTICLE_FLAG &
           m_tActionCondition.m_dwFlags ) &&
         CheckIfParticleCompleted() )
        l_dwFlags ^= CScriptActionCondition::PARTICLE_FLAG;
    if ( ( CScriptActionCondition::OBJECT_FLAG &
           m_tActionCondition.m_dwFlags ) &&
         CheckIfObjectCompleted() )
        l_dwFlags ^= CScriptActionCondition::OBJECT_FLAG;
    if ( ( CScriptActionCondition::TIME_FLAG & m_tActionCondition.m_dwFlags ) &&
         CheckIfTimeOver() )
        l_dwFlags ^= CScriptActionCondition::TIME_FLAG;
    if ( ( CScriptActionCondition::ACT_FLAG & m_tActionCondition.m_dwFlags ) &&
         CheckIfMonsterActionCompleted() )
        l_dwFlags ^= CScriptActionCondition::ACT_FLAG;

    if ( !m_tActionCondition.m_dwFlags &&
         ( m_tActionCondition.m_tLifeTime < 0 ) && CheckIfMovementCompleted() &&
         CheckIfWatchCompleted() && CheckIfAnimationCompleted() &&
         CheckIfSoundCompleted() && CheckIfParticleCompleted() &&
         CheckIfObjectCompleted() && CheckIfMonsterActionCompleted() )
        return ( true );
    else
        return ( !l_dwFlags );
}
