...
protected:
    ...
    IC bool critical_point( LevelGraph::CVertex* v,
                            u32 index,
                            u32 index0,
                            u32 index1 ) const;
...
public:
    ...
    IC const CCoverPoint* best_cover( const Fvector& position,
                                      float radius,
    ...
    Cover const* add_smart_cover( LPCSTR table_name,
