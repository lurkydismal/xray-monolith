...
IC CALifeMonsterPatrolPathManager::object_type&
CALifeMonsterPatrolPathManager::object() const {
    VERIFY( m_object );
    return ( *m_object );
}
...
IC void CALifeMonsterPatrolPathManager::start_type(
    const EPatrolStartType& start_type ) {
    m_start_type = start_type;
}

IC void CALifeMonsterPatrolPathManager::route_type(
    const EPatrolRouteType& route_type ) {
    m_route_type = route_type;
}

IC const CALifeMonsterPatrolPathManager::EPatrolStartType&
CALifeMonsterPatrolPathManager::start_type() const {
    return ( m_start_type );
}

IC const CALifeMonsterPatrolPathManager::EPatrolRouteType&
CALifeMonsterPatrolPathManager::route_type() const {
    return ( m_route_type );
}
...
IC void CALifeMonsterPatrolPathManager::start_vertex_index(
    const u32& start_vertex_index ) {
...
IC void CALifeMonsterPatrolPathManager::use_randomness(
