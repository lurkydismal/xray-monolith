...
class CALifeCommunicationManager : public virtual CALifeSimulatorBase {
    ...
    private:
            enum {
                    MAX_STACK_DEPTH					=
    u32(128), SUM_COUNT_THRESHOLD				= u32(30),
            };

            // temporary buffers for trading
            ALife::ITEM_P_VECTOR				m_tpItems1;
            ALife::ITEM_P_VECTOR				m_tpItems2;
            ALife::OBJECT_VECTOR m_tpBlockedItems1; ALife::OBJECT_VECTOR
    m_tpBlockedItems2;
    ...
    m_tpStack2[MAX_STACK_DEPTH]; protected: u32 dwfComputeItemCost
    (ALife::ITEM_P_VECTOR		&tpItemVector); void
    vfRunFunctionByIndex			(CSE_ALifeHumanAbstract
    *tpALifeHumanAbstract,		ALife::OBJECT_VECTOR
    &tpBlockedItems,				ALife::ITEM_P_VECTOR
    &tpItems,					int
    i,						int
    &j); void		vfAssignItemParents
    ...
    (CSE_ALifeHumanAbstract		*tpALifeHumanAbstract,
    ALife::ITEM_P_VECTOR			&tpItemVector); int
    ifComputeBalance				(CSE_ALifeHumanAbstract
    *tpALifeHumanAbstract,		ALife::ITEM_P_VECTOR
    &tpItemVector); void		vfFillTraderVector
    (CSE_ALifeHumanAbstract		*tpALifeHumanAbstract,		int
    iItemCount,						ALife::ITEM_P_VECTOR
    &tpItemVector); void		vfGenerateSums
    (ALife::ITEM_P_VECTOR		&tpTrader,
    ALife::INT_VECTOR				&tpSums); bool
    bfGetItemIndexes				(ALife::ITEM_P_VECTOR
    &tpTrader,					int
    iSum1,
    ALife::INT_VECTOR		&tpIndexes,
    ALife::SSumStackCell			*tpStack,
    int						iStartI,
    int				iStackPointer); bool
    bfCheckForInventoryCapacity		(CSE_ALifeHumanAbstract
    *tpALifeHumanAbstract1,		ALife::ITEM_P_VECTOR
    &tpTrader1,						ALife::INT_VECTOR
    &tpIndexes1,				CSE_ALifeHumanAbstract
    *tpALifeHumanAbstract2,	ALife::ITEM_P_VECTOR
    &tpTrader2,					ALife::INT_VECTOR
    &tpIndexes2); bool		bfCheckForInventoryCapacity
    (CSE_ALifeHumanAbstract		*tpALifeHumanAbstract1,
    ALife::ITEM_P_VECTOR			&tpTrader1,
    int				iSum1, int
    iMoney1,				CSE_ALifeHumanAbstract
    *tpALifeHumanAbstract2,				ALife::ITEM_P_VECTOR
    &tpTrader2,		int			iSum2,		int iMoney2, int
    iBalance); bool		bfCheckForTrade
    (CSE_ALifeHumanAbstract		*tpALifeHumanAbstract1,
    ALife::ITEM_P_VECTOR			&tpTrader1,
    ...
    *tpALifeHumanAbstract1,		CSE_ALifeHumanAbstract
    *tpALifeHumanAbstract2,			int
    iItemCount1,				int
    iItemCount2,			int
    iBalance); void		vfPerformTrading
    (CSE_ALifeHumanAbstract		*tpALifeHumanAbstract1,
    CSE_ALifeHumanAbstract	*tpALifeHumanAbstract2); void
    ...
    ALife::OBJECT_VECTOR	&tpObjectVector); #else void
    vfAttachGatheredItems			(CSE_ALifeTraderAbstract
    *tpALifeTraderAbstract1,	ALife::OBJECT_VECTOR
    &tpObjectVector); #endif #ifdef DEBUG void		vfPrintItems
    (CSE_ALifeHumanAbstract		*tpALifeHumanAbstract,
    ALife::ITEM_P_VECTOR			&tpItemVector); void
    vfPrintItems					(CSE_ALifeHumanAbstract
    *tpALifeHumanAbstract); #endif
    /**/
public:
