...
IC CPatrolPathManager::CPatrolPathManager( CRestrictedObject* object,
...
IC void CPatrolPathManager::set_path( const CPatrolPath* path,
...
IC void CPatrolPathManager::set_start_type(
...
IC void CPatrolPathManager::set_route_type(
...
IC void CPatrolPathManager::set_path( shared_str path_name ) {
    set_path( ai().patrol_paths().safe_path( path_name, false, true ),
              path_name );
}
...
IC CPatrolPathManager::CExtrapolateCallback&
CPatrolPathManager::extrapolate_callback() {
