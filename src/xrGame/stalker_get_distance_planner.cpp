...
CStalkerGetDistancePlanner::CStalkerGetDistancePlanner( CAI_Stalker* object,
                                                        LPCSTR action_name )
    : inherited( object, action_name ) {}

CStalkerGetDistancePlanner::~CStalkerGetDistancePlanner() {}

void CStalkerGetDistancePlanner::setup( CAI_Stalker* object,
                                        CPropertyStorage* storage ) {
    inherited::setup( object, storage );

    CActionPlanner< CScriptGameObject >::m_storage.set_property(
