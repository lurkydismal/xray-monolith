...
class CHARACTER_REPUTATION : public CIni_IdToIndex< 1,
                                                    REPUTATION_DATA,
                                                    shared_str,
                                                    int,
...
public:
    CHARACTER_REPUTATION()
        : m_current_value( NO_REPUTATION ), m_current_index( 0 ) {}
...
private:
    typedef CIni_Table< CHARACTER_GOODWILL, CHARACTER_REPUTATION >
        GOODWILL_TABLE;
