...
private:
    ...
    void legs_assign_direction( float switch_factor,
...
public:
    void add_script_animation( LPCSTR animation,
                               bool hand_usage = false,
                               bool use_movement_controller = false );
    void add_script_animation( LPCSTR animation,
                               bool hand_usage,
                               Fvector position,
                               Fvector rotation,
...
#ifdef DEBUG
private:
    void add_animation_stats( const ANIMATION_ID& animation_id,
