...
struct RPoint {
    ...
    bool operator==( const u16& ID ) const {
        return ( bBlocked && BlockedByID == ID );
    }
};
...
// [15.11.07] Alexander Maniluk: added next enumeratuion to solve problem with
// team identifiers
...
public:
    ...
    void SetEnvironmentGameTimeFactor( ALife::_TIME_ID GameTime,
