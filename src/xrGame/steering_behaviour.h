...
public:
    struct params {
        ...
        params( vec_arg factor,
            ...
            : enabled( true ),
              factor( factor ),
              min_factor_dist( min_factor_dist ) {}
...
public:
    struct params : base::params {
        ...
        vec ( *pf_random_dir )(); // randomizer func in case we're in 0 dist
                                  // from dest
        ...
        params( float max_evade_range,
            ...
            : base::params( factor, min_factor_dist ),
              max_evade_range( max_evade_range ),
...
public:
    struct params : base::params {
        ...
        float
            conservativeness; // how much we're taking current dir into account?
        ...
        params( plane_t plane,
                ...
                float angle_change,
                float factor )
            : base::params( cr_fvector3( factor, 0, 0 ) ),
              plane( plane ),
...
public:
    wander( params* params_ )
        : base( params_ ), m_p_params( params_ ), m_wander_angle( 0 ) {}
...
public:
    struct params : base::params {
        ...
        params( float turn_factor,
                vec_arg thrust_factor,
                float min_factor_dist = base::s_min_factor_dist )
            : base::params( thrust_factor, min_factor_dist ),
              turn_factor( turn_factor ),
              thrust_factor( thrust_factor ) {}

        virtual bool update() = 0;
        virtual bool test_obstacle( const vec& dest,
                                    vec& obstacle,
                                    vec& normal ) = 0;
...
public:
    struct params : base::params {
        ...
        virtual void next_nearest(
            vec& v ) = 0; // next nearest, false if finished
