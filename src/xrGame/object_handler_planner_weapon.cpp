...
void CObjectHandlerPlanner::add_evaluators( CWeapon* weapon ) {
    ...
    //.	add_evaluator		(uid(id,eWorldPropertyHidden)
    //,xr_new<CObjectPropertyEvaluatorState>(weapon,m_object,CWeapon::eHidden));
    add_evaluator(
        uid( id, eWorldPropertyHidden ),
        xr_new< CObjectPropertyEvaluatorWeaponHidden >( weapon, m_object ) );

    // dynamic member properties
    add_evaluator( uid( id, eWorldPropertyAimed1 ),
                   xr_new< CObjectPropertyEvaluatorMember >(
                       &m_storage, eWorldPropertyAimed1, true ) );
    add_evaluator( uid( id, eWorldPropertyAimed2 ),
                   xr_new< CObjectPropertyEvaluatorMember >(
                       &m_storage, eWorldPropertyAimed2, true ) );
    add_evaluator( uid( id, eWorldPropertyStrapped ),
                   xr_new< CObjectPropertyEvaluatorMember >(
                       &m_storage, eWorldPropertyStrapped, true ) );
    add_evaluator( uid( id, eWorldPropertyStrapped2Idle ),
                   xr_new< CObjectPropertyEvaluatorMember >(
                       &m_storage, eWorldPropertyStrapped2Idle, true ) );

    // dynamic properties
    add_evaluator(
        uid( id, eWorldPropertyAmmo1 ),
        xr_new< CObjectPropertyEvaluatorAmmo >( weapon, m_object, 0 ) );
    add_evaluator(
        uid( id, eWorldPropertyAmmo2 ),
        xr_new< CObjectPropertyEvaluatorAmmo >( weapon, m_object, 1 ) );
    add_evaluator(
        uid( id, eWorldPropertyEmpty1 ),
        xr_new< CObjectPropertyEvaluatorEmpty >( weapon, m_object, 0 ) );
    add_evaluator(
        uid( id, eWorldPropertyEmpty2 ),
        xr_new< CObjectPropertyEvaluatorEmpty >( weapon, m_object, 1 ) );
    add_evaluator(
        uid( id, eWorldPropertyFull1 ),
        xr_new< CObjectPropertyEvaluatorFull >( weapon, m_object, 0 ) );
    add_evaluator(
        uid( id, eWorldPropertyFull2 ),
        xr_new< CObjectPropertyEvaluatorFull >( weapon, m_object, 1 ) );
    add_evaluator(
        uid( id, eWorldPropertyReady1 ),
        xr_new< CObjectPropertyEvaluatorReady >( weapon, m_object, 0 ) );
    add_evaluator(
        uid( id, eWorldPropertyReady2 ),
        xr_new< CObjectPropertyEvaluatorReady >( weapon, m_object, 1 ) );
    add_evaluator(
        uid( id, eWorldPropertyQueueWait1 ),
        xr_new< CObjectPropertyEvaluatorQueue >( weapon, m_object, 0 ) );
    add_evaluator(
        uid( id, eWorldPropertyQueueWait2 ),
        xr_new< CObjectPropertyEvaluatorQueue >( weapon, m_object, 1 ) );

    // temporary const properties
    add_evaluator( uid( id, eWorldPropertySwitch1 ),
                   xr_new< CObjectPropertyEvaluatorConst >( true ) );
    add_evaluator( uid( id, eWorldPropertySwitch2 ),
                   xr_new< CObjectPropertyEvaluatorConst >( false ) );

    // const properties
    add_evaluator( uid( id, eWorldPropertyFiring1 ),
                   xr_new< CObjectPropertyEvaluatorConst >( false ) );
    add_evaluator( uid( id, eWorldPropertyFiringNoReload1 ),
                   xr_new< CObjectPropertyEvaluatorConst >( false ) );
    add_evaluator( uid( id, eWorldPropertyFiring2 ),
                   xr_new< CObjectPropertyEvaluatorConst >( false ) );
    add_evaluator( uid( id, eWorldPropertyIdle ),
                   xr_new< CObjectPropertyEvaluatorConst >( false ) );
    add_evaluator( uid( id, eWorldPropertyIdleStrap ),
                   xr_new< CObjectPropertyEvaluatorConst >( false ) );
    add_evaluator( uid( id, eWorldPropertyDropped ),
                   xr_new< CObjectPropertyEvaluatorConst >( false ) );
    add_evaluator( uid( id, eWorldPropertyAiming1 ),
                   xr_new< CObjectPropertyEvaluatorConst >( false ) );
    add_evaluator( uid( id, eWorldPropertyAiming2 ),
                   xr_new< CObjectPropertyEvaluatorConst >( false ) );
    add_evaluator( uid( id, eWorldPropertyAimingReady1 ),
                   xr_new< CObjectPropertyEvaluatorConst >( false ) );
    add_evaluator( uid( id, eWorldPropertyAimingReady2 ),
                   xr_new< CObjectPropertyEvaluatorConst >( false ) );
    add_evaluator( uid( id, eWorldPropertyAimForceFull1 ),
                   xr_new< CObjectPropertyEvaluatorConst >( false ) );
    add_evaluator( uid( id, eWorldPropertyAimForceFull2 ),
                   xr_new< CObjectPropertyEvaluatorConst >( false ) );
}
...
void CObjectHandlerPlanner::add_operators( CWeapon* weapon ) {
    ...
    // show
    action =
        xr_new< CObjectActionShow >( weapon, m_object, &m_storage, "show" );
    ...
    // hide
    action =
        xr_new< CObjectActionHide >( weapon, m_object, &m_storage, "hide" );
    ...
    // drop
    action =
        xr_new< CObjectActionDrop >( weapon, m_object, &m_storage, "drop" );
    add_condition( action, id, eWorldPropertyHidden, false );
    add_condition( action, id, eWorldPropertyStrapped, false );
    add_condition( action, id, eWorldPropertyStrapped2Idle, false );
    ...
    // idle
    action =
        xr_new< CSObjectActionBase >( weapon, m_object, &m_storage, "idle" );
    add_condition( action, id, eWorldPropertyHidden, false );
    add_condition( action, id, eWorldPropertyStrapped, false );
    add_condition( action, id, eWorldPropertyStrapped2Idle, false );
    ...
    // strapping
    action = xr_new< CObjectActionStrapping >( weapon, m_object, &m_storage,
                                               "strapping" );
    add_condition( action, id, eWorldPropertyHidden, false );
    add_condition( action, id, eWorldPropertyStrapped, false );
    ...
    action = xr_new< CObjectActionStrappingToIdle >(
        weapon, m_object, &m_storage, "strapping to idle" );
    add_condition( action, id, eWorldPropertyHidden, false );
    ...
    // unstrapping
    action = xr_new< CObjectActionUnstrapping >( weapon, m_object, &m_storage,
                                                 "unstrapping" );
    add_condition( action, id, eWorldPropertyHidden, false );
    add_condition( action, id, eWorldPropertyStrapped, true );
    ...
    action = xr_new< CObjectActionUnstrappingToIdle >(
        weapon, m_object, &m_storage, "unstrapping to idle" );
    add_condition( action, id, eWorldPropertyHidden, false );
    add_condition( action, id, eWorldPropertyStrapped, false );
    add_condition( action, id, eWorldPropertyStrapped2Idle, true );
    add_effect( action, id, eWorldPropertyStrapped2Idle, false );
    ...
    // strapped
    action = xr_new< CSObjectActionBase >( weapon, m_object, &m_storage,
                                           "strapped" );
    add_condition( action, id, eWorldPropertyHidden, false );
    add_condition( action, id, eWorldPropertyStrapped, true );
    add_condition( action, id, eWorldPropertyStrapped2Idle, false );
    ...
    // aim1
    action = xr_new< CObjectActionAim >( weapon, m_object, &m_storage,
                                         eWorldPropertyAimed1, true, "aim1" );
    add_condition( action, id, eWorldPropertyHidden, false );
    ...
    // aim2
    action = xr_new< CObjectActionAim >( weapon, m_object, &m_storage,
                                         eWorldPropertyAimed2, true, "aim2" );
    add_condition( action, id, eWorldPropertyHidden, false );
    ...
    // aim_queue1
    action = xr_new< CObjectActionQueueWait >(
        weapon, m_object, &m_storage, uid( id, eWorldPropertyQueueWait1 ),
        "aim_queue1" );
    add_condition( action, id, eWorldPropertyHidden, false );
    add_condition( action, id, eWorldPropertySwitch1, true );
    ...
    // aim_queue2
    action = xr_new< CObjectActionQueueWait >(
        weapon, m_object, &m_storage, uid( id, eWorldPropertyQueueWait2 ),
        "aim_queue2" );
    add_condition( action, id, eWorldPropertyHidden, false );
    add_condition( action, id, eWorldPropertySwitch1, true );
    ...
    // fire1
    action = xr_new< CObjectActionFire >( weapon, m_object, &m_storage,
                                          uid( id, eWorldPropertyQueueWait1 ),
                                          "fire1" );
    add_condition( action, id, eWorldPropertyHidden, false );
    ...
    // reload1
    action = xr_new< CObjectActionReload >( weapon, m_object, &m_storage, 0,
                                            "reload1" );
    add_condition( action, id, eWorldPropertyHidden, false );
    ...
    // reload2
    action = xr_new< CObjectActionReload >( weapon, m_object, &m_storage, 1,
                                            "reload2" );
    add_condition( action, id, eWorldPropertyHidden, false );
    ...
    // switch1
    action = xr_new< CObjectActionSwitch >( weapon, m_object, &m_storage, 0,
                                            "switch1" );
    ...
    // switch2
    action = xr_new< CObjectActionSwitch >( weapon, m_object, &m_storage, 1,
                                            "switch2" );
    add_condition( action, id, eWorldPropertySwitch1, true );
    ...
    // aiming ready1
    action =
        xr_new< CObjectActionAim >( weapon, m_object, &m_storage,
                                    eWorldPropertyAimed1, true, "aim_ready1" );
    add_condition( action, id, eWorldPropertyHidden, false );
    add_condition( action, id, eWorldPropertySwitch1, true );
    add_condition( action, id, eWorldPropertyReady1, true );
    add_condition( action, id, eWorldPropertyStrapped, false );
    ...
    action =
        xr_new< CObjectActionAim >( weapon, m_object, &m_storage,
                                    eWorldPropertyAimed2, true, "aim_ready2" );
    add_condition( action, id, eWorldPropertyHidden, false );
    add_condition( action, id, eWorldPropertySwitch2, true );
    add_condition( action, id, eWorldPropertyStrapped, false );
    add_condition( action, id, eWorldPropertyStrapped2Idle, false );
    ...
    //	add_effect
    //(action,id,eWorldPropertyAimingReady2,true);
    add_effect( action, id, eWorldPropertyAimed1, false );
    ...
    this->action( uid( id, eWorldOperatorAim1 ) )
        .set_inertia_time( g_ai_aim_inertia_time );
    this->action( uid( id, eWorldOperatorAim2 ) )
        .set_inertia_time( g_ai_aim_inertia_time );
    this->action( uid( id, eWorldOperatorAimingReady1 ) )
        .set_inertia_time( g_ai_aim_inertia_time );
    this->action( uid( id, eWorldOperatorAimingReady2 ) )
        .set_inertia_time( g_ai_aim_inertia_time );
    this->action( uid( id, eWorldOperatorAimForceFull1 ) )
        .set_inertia_time( g_ai_aim_inertia_time );
    this->action( uid( id, eWorldOperatorAimForceFull2 ) )
        .set_inertia_time( g_ai_aim_inertia_time );
    this->action( uid( id, eWorldOperatorQueueWait1 ) )
        .set_inertia_time( g_ai_aim_queue_inertia_time );
    this->action( uid( id, eWorldOperatorQueueWait2 ) )
        .set_inertia_time( g_ai_aim_queue_inertia_time );
}
