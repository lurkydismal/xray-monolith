...
public:
    CStalkerActionDangerBySoundListenTo( CAI_Stalker* object,
                                         LPCSTR action_name = "" );
...
public:
    CStalkerActionDangerBySoundCheck( CAI_Stalker* object,
                                      LPCSTR action_name = "" );
    virtual void initialize();
    virtual void execute();
    virtual void finalize();
...
public:
    CStalkerActionDangerBySoundTakeCover( CAI_Stalker* object,
                                          LPCSTR action_name = "" );
    virtual void initialize();
    virtual void execute();
    virtual void finalize();
...
public:
    CStalkerActionDangerBySoundLookOut( CAI_Stalker* object,
                                        LPCSTR action_name = "" );
    virtual void initialize();
    virtual void execute();
    virtual void finalize();
...
public:
    CStalkerActionDangerBySoundLookAround( CAI_Stalker* object,
                                           LPCSTR action_name = "" );
    virtual void initialize();
    virtual void execute();
    virtual void finalize();
