...
private:
    typedef associative_vector< dst_src_pair_t, filetransfer_node* >
        transfer_sessions_t;
    typedef associative_vector< ClientID, filereceiver_node* >
        receiving_sessions_t;

    transfer_sessions_t m_transfers;
    receiving_sessions_t m_receivers;
    void stop_transfer_sessions(
...
public:
    ...
    // this method used by proxies, to transmit file by portions through the
    // memory writer ...
    ...
    filereceiver_node* start_receive_file(
    ...
    bool is_transfer_active( ClientID const& to_client,
...
public:
    ...
    void start_transfer_file( shared_str const& file_name,
                              sending_state_callback_t& tstate_callback );
    void start_transfer_file( u8* data,
                              u32 size,
                              sending_state_callback_t& tstate_callback,
                              u32 size_to_allocate = 0 );
    ...
    inline bool is_transfer_active() const {
        return m_transfering ? true : false;
    };
