...
private:
    ...
    typedef associative_vector< shared_str, section_items* >
        respawn_sections_map;
    ...
    u32 load_section_items( CInifile& ini,
                            const char* section_name,
                            section_items* items );
    void clear_respawn_sections();

    CSE_Abstract* make_respawn_entity( shared_str const& section_name,
                                       u8 addons,
                                       u16 count_of_ammo );
