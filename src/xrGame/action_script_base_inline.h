...
IC CScriptBaseAction::CActionScriptBase(
    ...
    : inherited( conditions,
                 effects,
                 object ? object->lua_game_object() : 0,
                 action_name ) {
    m_object = object;
}

TEMPLATE_SPECIALIZATION
IC CScriptBaseAction::CActionScriptBase( _object_type* object,
                                         LPCSTR action_name )
...
TEMPLATE_SPECIALIZATION
void CScriptBaseAction::setup( _object_type* object,
...
TEMPLATE_SPECIALIZATION
void CScriptBaseAction::setup( CScriptGameObject* object,
                               CPropertyStorage* storage ) {
    VERIFY( object );
