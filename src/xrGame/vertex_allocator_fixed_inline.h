...
#define CFixedVertexAllocator \
    CVertexAllocatorFixed< reserved_vertex_count >::CDataStorage< _vertex >
...
IC CFixedVertexAllocator::CDataStorage() {
    ...
    //	m_vertices				=
    // xr_alloc<CGraphVertex>(reserved_vertex_count); 	ZeroMemory
    //(m_vertices,byte_count);
...
TEMPLATE_SPECIALIZATION
IC typename CFixedVertexAllocator::CGraphVertex&
CFixedVertexAllocator::create_vertex() {
