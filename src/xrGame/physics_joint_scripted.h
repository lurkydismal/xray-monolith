...
public:
    cphysics_joint_scripted( CPhysicsJoint* imp )
        : cphysics_game_scripted< CPhysicsJoint >( imp ) {}
    ...
    void SetAxisSDfactors( float spring_factor,
                           float damping_factor,
                           int axis_num ) {
        physics_impl().SetAxisSDfactors( spring_factor, damping_factor,
                                         axis_num );
    }
    ...
    void SetAnchor( const float x, const float y, const float z ) {
        physics_impl().SetAnchor( x, y, z );
    }

    void SetAnchorVsFirstElement( const float x,
                                  const float y,
                                  const float z ) {
        physics_impl().SetAnchorVsFirstElement( x, y, z );
    }

    void SetAnchorVsSecondElement( const float x,
                                   const float y,
                                   const float z ) {
    ...
    void SetAxisDirVsFirstElement( const float x,
                                   const float y,
                                   const float z,
                                   const int axis_num ) {
    ...
    void SetAxisDirVsSecondElement( const float x,
                                    const float y,
                                    const float z,
                                    const int axis_num ) {
    ...
    void SetForceAndVelocity( const float force,
    ...
    float GetAxisAngle( int axis_num ) {
        return physics_impl().GetAxisAngle( axis_num );
    }
