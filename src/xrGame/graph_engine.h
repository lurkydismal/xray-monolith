...
#ifndef AI_COMPILER
    typedef CVertexManagerHashFixed< u32, _solver_index_type, 256, 8 * 1024 >
        CSolverVertexManager;
    typedef CVertexManagerHashFixed< u32, shared_str, 128, 1024 >
...
#ifndef AI_COMPILER
    typedef CAStar< _solver_dist_type,
...
public:
    ...
    IC bool search( const _Graph& graph,
