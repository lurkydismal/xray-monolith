...
#define CVertexPathBuilder \
    CVertexPath< bEuclidianHeuristics >::CDataStorage< _vertex >
...
TEMPLATE_SPECIALIZATION
IC void CVertexPathBuilder::assign_parent( CGraphVertex& neighbour,
                                           CGraphVertex* parent ) {
...
TEMPLATE_SPECIALIZATION
IC void CVertexPathBuilder::get_node_path( xr_vector< _index_type >& path,
                                           CGraphVertex* best ) {
