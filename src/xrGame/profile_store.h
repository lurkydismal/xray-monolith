...
class profile_store : public ISheduled, private xray::noncopyable {
public:
...
private:
    ...
    queued_async_method< profile_store,
                         load_prof_params_t,
                         store_operation_cb,
                         &profile_store::load_current_profile_raw,
                         &profile_store::release_current_profile >
    ...
    static unsigned int const merged_fields_count =
        best_scores_store::fields_count + awards_store::fields_count;
    ...
    void __stdcall loaded_best_scores( bool const result,
                                       char const* err_descr );

    void __stdcall onlylog_operation( bool const result,
                                      char const* err_descr );
    void __stdcall onlylog_completion( bool const result,
                                       char const* err_descr );
