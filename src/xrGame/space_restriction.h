...
private:
    ...
    CBaseRestrictionPtr merge( CBaseRestrictionPtr bridge,
...
protected:
    ...
    bool affect( CBaseRestrictionPtr bridge,
                 u32 start_vertex_id,
                 float radius ) const;
    bool affect( CBaseRestrictionPtr bridge,
...
public:
    CSpaceRestriction( CSpaceRestrictionManager* space_restriction_manager,
