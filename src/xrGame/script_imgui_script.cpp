...
void ScriptImGui::script_register( ::lua_State* L ) {
    module( L, "ImGui" )
        [ def( "GetVersion", &ImGui_GetVersion ),
          ...
          def( "Begin", &ImGui::Begin, out_value< 2 >() ),
          def( "End", &ImGui::End ),
          ...
          def( "SetNextWindowPos",
               ( void ( * )( Fvector2& ) )&ImGui_SetNextWindowPos ),
          def( "SetNextWindowPos",
               ( void ( * )( Fvector2&, ImGuiCond ) )&ImGui_SetNextWindowPos ),
          def( "SetNextWindowPos",
               ( void ( * )( Fvector2&, ImGuiCond,
                             Fvector2& ) )&ImGui_SetNextWindowPos ),
          ...
          def( "SetWindowCollapsed",
               ( void ( * )( bool ) )&ImGui_SetWindowCollapsed ),
          def( "SetWindowCollapsed",
               ( void ( * )( bool, ImGuiCond ) )&ImGui::SetWindowCollapsed ),
          def( "SetWindowCollapsed",
               ( void ( * )( LPCSTR, bool,
                             ImGuiCond ) )&ImGui::SetWindowCollapsed ),
          def( "SetWindowFocus", ( void ( * )() )&ImGui::SetWindowFocus ),
          def( "SetWindowFocus",
               ( void ( * )( LPCSTR ) )&ImGui::SetWindowFocus ),
          ...
          def( "SetScrollFromPosX",
               ( void ( * )( float ) )&ImGui_SetScrollFromPosX ),
          def( "SetScrollFromPosX",
               ( void ( * )( float, float ) )&ImGui::SetScrollFromPosX ),
          def( "SetScrollFromPosY",
               ( void ( * )( float ) )&ImGui_SetScrollFromPosY ),
          def( "SetScrollFromPosY",
               ( void ( * )( float, float ) )&ImGui::SetScrollFromPosY ),

          def( "PushStyleColor",
               ( void ( * )( ImGuiCol, u32 ) )&ImGui::PushStyleColor ),
          ...
          def( "PushStyleVar",
               ( void ( * )( ImGuiStyleVar, float ) )&ImGui::PushStyleVar ),
          ...
          def( "NewLine", &ImGui::NewLine ), def( "Spacing", &ImGui::Spacing ),
          def( "Dummy", &ImGui_Dummy ), def( "Indent", &ImGui::Indent ),
          ...
          def( "GetTextLineHeightWithSpacing",
          ...
          def( "LabelText", &ImGui_LabelText ), def( "Bullet", &ImGui::Bullet ),
          ...
          def( "InvisibleButton",
               ( bool ( * )( LPCSTR ) )&ImGui_InvisibleButton ),
          def( "InvisibleButton",
               ( bool ( * )( LPCSTR, Fvector2 ) )&ImGui_InvisibleButton ),
          def( "InvisibleButton",
               ( bool ( * )( LPCSTR, Fvector2,
                             ImGuiButtonFlags ) )&ImGui_InvisibleButton ),
          def( "ArrowButton", &ImGui::ArrowButton ),
          def( "Checkbox", &ImGui::Checkbox, out_value< 2 >() ),
          def( "RadioButton",
               ( bool ( * )( LPCSTR, bool ) )&ImGui::RadioButton ),
          def( "ProgressBar", &ImGui_ProgressBar ),

          def( "BeginCombo", &ImGui::BeginCombo ),
          def( "EndCombo", &ImGui::EndCombo ),

          def( "DragFloat", &ImGui::DragFloat, out_value< 2 >() ),
          def( "DragFloat2", &ImGui_DragFloat2, out_value< 2 >() ),
          def( "DragFloat3", &ImGui_DragFloat3, out_value< 2 >() ),
          def( "DragFloat4", &ImGui_DragFloat4, out_value< 2 >() ),
          def( "DragFloatRange2", &ImGui::DragFloatRange2,
               out_value< 2 >() + out_value< 3 >() ),

          def( "SliderFloat", &ImGui::SliderFloat, out_value< 2 >() ),
          def( "SliderFloat2", &ImGui_SliderFloat2, out_value< 2 >() ),
          def( "SliderFloat3", &ImGui_SliderFloat3, out_value< 2 >() ),
          def( "SliderFloat4", &ImGui_SliderFloat4, out_value< 2 >() ),
          def( "SliderAngle", &ImGui::SliderAngle, out_value< 2 >() ),

          def( "InputText", &ImGui_InputText, out_value< 5 >() ),
          def( "InputTextMultiline", &ImGui_InputTextMultiline,
               out_value< 6 >() ),
          def( "InputTextWithHint", &ImGui_InputTextWithHint,
               out_value< 6 >() ),

          def( "InputFloat", &ImGui::InputFloat, out_value< 2 >() ),
          def( "InputFloat2", &ImGui_InputFloat2, out_value< 2 >() ),
          def( "InputFloat3", &ImGui_InputFloat3, out_value< 2 >() ),
          def( "InputFloat4", &ImGui_InputFloat4, out_value< 2 >() ),

          def( "ColorEdit3", &ImGui_ColorEdit3, out_value< 2 >() ),
          def( "ColorEdit4", &ImGui_ColorEdit4, out_value< 2 >() ),
          def( "ColorPicker3", &ImGui_ColorPicker3, out_value< 2 >() ),
          def( "ColorPicker4", &ImGui_ColorPicker4, out_value< 2 >() ),
          def( "ColorButton", &ImGui_ColorButton, out_value< 2 >() ),

          def( "TreeNode", ( bool ( * )( LPCSTR ) )&ImGui::TreeNode ),
          def( "TreeNodeEx",
               ( bool ( * )( LPCSTR, ImGuiTreeNodeFlags ) )&ImGui::TreeNodeEx ),
          ...
          def( "CollapsingHeader",
               ( bool ( * )( LPCSTR ) )&ImGui_CollapsingHeader ),
          def( "CollapsingHeader",
               ( bool ( * )( LPCSTR,
                             ImGuiTreeNodeFlags ) )&ImGui::CollapsingHeader ),
          def( "CollapsingHeader",
               ( bool ( * )( LPCSTR, bool* ) )&ImGui_CollapsingHeader,
               out_value< 2 >() ),
          def( "CollapsingHeader",
               ( bool ( * )( LPCSTR, bool*,
                             ImGuiTreeNodeFlags ) )&ImGui::CollapsingHeader,
          ...
          def( "MenuItem",
               ( bool ( * )( LPCSTR, LPCSTR, bool*, bool ) )&ImGui::MenuItem,
               out_value< 3 >() ),
          ...
          def( "OpenPopup",
               ( void ( * )( LPCSTR, ImGuiPopupFlags ) )&ImGui::OpenPopup ),
          def( "OpenPopup", ( void ( * )( ImGuiID ) )&ImGui_OpenPopup ),
          def( "OpenPopup",
               ( void ( * )( ImGuiID, ImGuiPopupFlags ) )&ImGui::OpenPopup ),
          ...
          def( "IsPopupOpen",
               ( bool ( * )( LPCSTR, ImGuiPopupFlags ) )&ImGui::IsPopupOpen ),
          ...
          def( "TableGetColumnName",
               ( LPCSTR ( * )( int ) )&ImGui::TableGetColumnName ),
          ...
          def( "BeginTabItem", &ImGui::BeginTabItem, out_value< 2 >() ),
          ...
          def( "IsItemDeactivatedAfterEdit",
          ...
          def( "IsKeyPressed",
               ( bool ( * )( ImGuiKey, bool ) )&ImGui::IsKeyPressed ),
          def( "IsKeyReleased",
               ( bool ( * )( ImGuiKey ) )&ImGui::IsKeyReleased ),
          def( "IsKeyChordPressed",
               ( bool ( * )( ImGuiKeyChord ) )&ImGui::IsKeyChordPressed ),
          def( "GetKeyPressedAmount", &ImGui::GetKeyPressedAmount ),
          def( "GetKeyName", &ImGui_GetKeyName ),
          def( "SetNextFrameWantCaptureKeyboard",
               &ImGui::SetNextFrameWantCaptureKeyboard ),

          def( "Shortcut", ( bool ( * )( ImGuiKeyChord ) )&ImGui_Shortcut ),
          def( "Shortcut", ( bool ( * )( ImGuiKeyChord,
                                         ImGuiInputFlags ) )&ImGui::Shortcut ),
          def( "SetNextItemShortcut", &ImGui::SetNextItemShortcut ),

          def( "SetItemKeyOwner",
               ( void ( * )( ImGuiKey ) )&ImGui::SetItemKeyOwner ),
          def( "SetItemKeyOwner",
               ( void ( * )( ImGuiKey,
                             ImGuiInputFlags ) )&ImGui::SetItemKeyOwner ),

          def( "CalcTextSize", &ImGui_CalcTextSize ),

          def( "IsMouseDown",
               ( bool ( * )( ImGuiMouseButton ) )&ImGui::IsMouseDown ),
          def( "IsMouseClicked",
               ( bool ( * )( ImGuiMouseButton, bool ) )&ImGui::IsMouseClicked ),
          def( "IsMouseReleased",
               ( bool ( * )( ImGuiMouseButton ) )&ImGui::IsMouseReleased ),
          def( "IsMouseDoubleClicked",
               ( bool ( * )( ImGuiMouseButton ) )&ImGui::IsMouseDoubleClicked ),
          def( "IsMouseReleasedWithDelay", &ImGui::IsMouseReleasedWithDelay ),
          def( "GetMouseClickedCount", &ImGui::GetMouseClickedCount ),
          def( "IsMouseHoveringRect",
               ( bool ( * )( Fvector2, Fvector2 ) )&ImGui_IsMouseHoveringRect ),
          def( "IsMouseHoveringRect",
               ( bool ( * )( Fvector2, Fvector2,
                             bool ) )&ImGui_IsMouseHoveringRect ),
          def( "IsMousePosValid", &ImGui_IsMousePosValid ),
          def( "IsAnyMouseDown", &ImGui::IsAnyMouseDown ),
          def( "GetMousePos", &ImGui_GetMousePos ),
          def( "GetMousePosOnOpeningCurrentPopup",
          ...
          def( "SetNextFrameWantCaptureMouse",
               &ImGui::SetNextFrameWantCaptureMouse ),

          def( "PushFont", &ImGui_PushFont ), def( "PopFont", &ImGui::PopFont ),
        ...
        module( L )
            [ class_< enum_exporter< ImGuiCond_ > >( "ImGuiCond" )
              ...
              class_< enum_exporter< ImGuiDir > >( "ImGuiDir" )
                  .enum_( "ImGuiDir" )[ value( "Left", ( int )ImGuiDir_Left ),
              ...
              class_< enum_exporter< ImGuiWindowFlags_ > >( "ImGuiWindowFlags" )
                  .enum_( "ImGuiWindowFlags" )
                      [ value( "NoTitleBar",
                        ...
                        value( "NoMouseInputs",
                               ( int )ImGuiWindowFlags_NoMouseInputs ),
                        value( "MenuBar", ( int )ImGuiWindowFlags_MenuBar ),
                        value( "HorizontalScrollbar",
                               ( int )ImGuiWindowFlags_HorizontalScrollbar ),
                        value( "NoFocusOnAppearing",
                               ( int )ImGuiWindowFlags_NoFocusOnAppearing ),
                        value( "NoBringToFrontOnFocus",
                               ( int )ImGuiWindowFlags_NoBringToFrontOnFocus ),
                        value(
                            "AlwaysVerticalScrollbar",
                            ( int )ImGuiWindowFlags_AlwaysVerticalScrollbar ),
                        value(
                        ...
                        value( "NoNavFocus",
                               ( int )ImGuiWindowFlags_NoNavFocus ),
                        value( "UnsavedDocument",
                               ( int )ImGuiWindowFlags_UnsavedDocument ),
              ...
              class_< enum_exporter< ImGuiItemFlags_ > >( "ImGuiItemFlags" )
                  .enum_( "ImGuiItemFlags" )
                      [ value( "NoTabStop", ( int )ImGuiItemFlags_NoTabStop ),
                        ...
                        value( "NoNavDefaultFocus",
                               ( int )ImGuiItemFlags_NoNavDefaultFocus ),
                        value( "ButtonRepeat",
                               ( int )ImGuiItemFlags_ButtonRepeat ),
                        value( "AutoClosePopups",
                               ( int )ImGuiItemFlags_AutoClosePopups ),
                        value( "AllowDuplicateId",
                               ( int )ImGuiItemFlags_AllowDuplicateId ) ],

              class_< enum_exporter< ImGuiSelectableFlags_ > >(
                  "ImGuiSelectableFlags" )
                  .enum_( "ImGuiSelectableFlags" )
                      [ value( "NoAutoClosePopups",
                               ( int )ImGuiSelectableFlags_NoAutoClosePopups ),
                        value( "SpanAllColumns",
                               ( int )ImGuiSelectableFlags_SpanAllColumns ),
                        value( "AllowDoubleClick",
                               ( int )ImGuiSelectableFlags_AllowDoubleClick ),
                        value( "Disabled",
                               ( int )ImGuiSelectableFlags_Disabled ),
                        value( "AllowOverlap",
                               ( int )ImGuiSelectableFlags_AllowOverlap ),
                        value( "Highlight",
                               ( int )ImGuiSelectableFlags_Highlight ) ],

              class_< enum_exporter< ImGuiInputTextFlags_ > >(
                  "ImGuiInputTextFlags" )
                  .enum_( "ImGuiInputTextFlags" )
                      [ value( "CharsDecimal",
                               ( int )ImGuiInputTextFlags_CharsDecimal ),
                        value( "CharsHexadecimal",
                               ( int )ImGuiInputTextFlags_CharsHexadecimal ),
                        value( "CharsScientific",
                               ( int )ImGuiInputTextFlags_CharsScientific ),
                        value( "CharsUppercase",
                               ( int )ImGuiInputTextFlags_CharsUppercase ),
                        value( "CharsNoBlank",
                               ( int )ImGuiInputTextFlags_CharsNoBlank ),
                        value( "AllowTabInput",
                               ( int )ImGuiInputTextFlags_AllowTabInput ),
                        value( "EnterReturnsTrue",
                               ( int )ImGuiInputTextFlags_EnterReturnsTrue ),
                        value( "EscapeClearsAll",
                               ( int )ImGuiInputTextFlags_EscapeClearsAll ),
                        value( "CtrlEnterForNewLine",
                               ( int )ImGuiInputTextFlags_CtrlEnterForNewLine ),
                        value( "ReadOnly",
                               ( int )ImGuiInputTextFlags_ReadOnly ),
                        value( "Password",
                               ( int )ImGuiInputTextFlags_Password ),
                        value( "AlwaysOverwrite",
                               ( int )ImGuiInputTextFlags_AlwaysOverwrite ),
                        value( "AutoSelectAll",
                               ( int )ImGuiInputTextFlags_AutoSelectAll ),
                        value( "ParseEmptyRefVal",
                               ( int )ImGuiInputTextFlags_ParseEmptyRefVal ),
                        value( "DisplayEmptyRefVal",
                               ( int )ImGuiInputTextFlags_DisplayEmptyRefVal ),
                        value( "NoHorizontalScroll",
                               ( int )ImGuiInputTextFlags_NoHorizontalScroll ),
                        value( "NoUndoRedo",
                               ( int )ImGuiInputTextFlags_NoUndoRedo ),
                        value( "ElideLeft",
                               ( int )ImGuiInputTextFlags_ElideLeft ),
                        value( "CallbackCompletion",
                               ( int )ImGuiInputTextFlags_CallbackCompletion ),
                        value( "CallbackHistory",
                               ( int )ImGuiInputTextFlags_CallbackHistory ),
                        value( "CallbackAlways",
                               ( int )ImGuiInputTextFlags_CallbackAlways ),
                        value( "CallbackCharFilter",
                               ( int )ImGuiInputTextFlags_CallbackCharFilter ),
                        value( "CallbackResize",
                               ( int )ImGuiInputTextFlags_CallbackResize ),
                        value( "CallbackEdit",
                               ( int )ImGuiInputTextFlags_CallbackEdit ) ],

              class_< enum_exporter< ImGuiTreeNodeFlags_ > >(
                  "ImGuiTreeNodeFlags" )
                  .enum_( "ImGuiTreeNodeFlags" )
                      [ value( "Selected", ( int )ImGuiTreeNodeFlags_Selected ),
                        value( "Framed", ( int )ImGuiTreeNodeFlags_Framed ),
                        value( "AllowOverlap",
                               ( int )ImGuiTreeNodeFlags_AllowOverlap ),
                        value( "NoTreePushOnOpen",
                               ( int )ImGuiTreeNodeFlags_NoTreePushOnOpen ),
                        value( "NoAutoOpenOnLog",
                               ( int )ImGuiTreeNodeFlags_NoAutoOpenOnLog ),
                        value( "DefaultOpen",
                               ( int )ImGuiTreeNodeFlags_DefaultOpen ),
                        value( "OpenOnDoubleClick",
                        ...
                        value( "FramePadding",
                               ( int )ImGuiTreeNodeFlags_FramePadding ),
                        value( "SpanAvailWidth",
                               ( int )ImGuiTreeNodeFlags_SpanAvailWidth ),
                        value( "SpanFullWidth",
                               ( int )ImGuiTreeNodeFlags_SpanFullWidth ),
                        value( "SpanLabelWidth",
                               ( int )ImGuiTreeNodeFlags_SpanLabelWidth ),
                        value( "SpanAllColumns",
                               ( int )ImGuiTreeNodeFlags_SpanAllColumns ),
                        value( "LabelSpanAllColumns",
                               ( int )ImGuiTreeNodeFlags_LabelSpanAllColumns ),
                        value( "NavLeftJumpsBackHere",
                               ( int )ImGuiTreeNodeFlags_NavLeftJumpsBackHere ),
                        value( "CollapsingHeader",
                               ( int )ImGuiTreeNodeFlags_CollapsingHeader ) ],

              class_< enum_exporter< ImGuiPopupFlags_ > >( "ImGuiPopupFlags" )
                  .enum_( "ImGuiPopupFlags" )
                      [ value( "MouseButtonLeft",
                               ( int )ImGuiPopupFlags_MouseButtonLeft ),
                        value( "MouseButtonRight",
                               ( int )ImGuiPopupFlags_MouseButtonRight ),
                        value( "MouseButtonMiddle",
                               ( int )ImGuiPopupFlags_MouseButtonMiddle ),
                        value( "NoReopen", ( int )ImGuiPopupFlags_NoReopen ),
                        value( "NoOpenOverExistingPopup",
                               ( int )ImGuiPopupFlags_NoOpenOverExistingPopup ),
                        value( "NoOpenOverItems",
                               ( int )ImGuiPopupFlags_NoOpenOverItems ),
                        value( "AnyPopupId",
                               ( int )ImGuiPopupFlags_AnyPopupId ),
                        value( "AnyPopupLevel",
                               ( int )ImGuiPopupFlags_AnyPopupLevel ),
                        value( "AnyPopup", ( int )ImGuiPopupFlags_AnyPopup ) ],

              class_< enum_exporter< ImGuiTableRowFlags_ > >(
                  "ImGuiTableRowFlags" )
                  .enum_( "ImGuiTableRowFlags" )[ value(
                      "Headers", ( int )ImGuiTableRowFlags_Headers ) ],

              class_< enum_exporter< ImGuiTableBgTarget_ > >(
                  "ImGuiTableBgTarget" )
              ...
              class_< enum_exporter< ImGuiTableFlags_ > >( "ImGuiTableFlags" )
                  .enum_( "ImGuiTableFlags" )
                      [ value( "Resizable", ( int )ImGuiTableFlags_Resizable ),
                        value( "Reorderable",
                               ( int )ImGuiTableFlags_Reorderable ),
                        value( "Hideable", ( int )ImGuiTableFlags_Hideable ),
                        value( "Sortable", ( int )ImGuiTableFlags_Sortable ),
                        value( "NoSavedSettings",
                               ( int )ImGuiTableFlags_NoSavedSettings ),
                        value( "ContextMenuInBody",
                               ( int )ImGuiTableFlags_ContextMenuInBody ),
                        value( "RowBg", ( int )ImGuiTableFlags_RowBg ),
                        value( "BordersInnerH",
                               ( int )ImGuiTableFlags_BordersInnerH ),
                        value( "BordersOuterH",
                               ( int )ImGuiTableFlags_BordersOuterH ),
                        value( "BordersInnerV",
                               ( int )ImGuiTableFlags_BordersInnerV ),
                        value( "BordersOuterV",
                               ( int )ImGuiTableFlags_BordersOuterV ),
                        value( "BordersH", ( int )ImGuiTableFlags_BordersH ),
                        value( "BordersV", ( int )ImGuiTableFlags_BordersV ),
                        value( "BordersInner",
                               ( int )ImGuiTableFlags_BordersInner ),
                        value( "BordersOuter",
                               ( int )ImGuiTableFlags_BordersOuter ),
                        value( "Borders", ( int )ImGuiTableFlags_Borders ),
                        value( "NoBordersInBody",
                               ( int )ImGuiTableFlags_NoBordersInBody ),
                        value(
                            "NoBordersInBodyUntilResize",
                            ( int )ImGuiTableFlags_NoBordersInBodyUntilResize ),
                        value( "SizingFixedFit",
                               ( int )ImGuiTableFlags_SizingFixedFit ),
                        value( "SizingFixedSame",
                               ( int )ImGuiTableFlags_SizingFixedSame ),
                        value( "SizingStretchProp",
                               ( int )ImGuiTableFlags_SizingStretchProp ),
                        value( "SizingStretchSame",
                               ( int )ImGuiTableFlags_SizingStretchSame ),
                        value( "NoHostExtendX",
                               ( int )ImGuiTableFlags_NoHostExtendX ),
                        value( "NoHostExtendY",
                               ( int )ImGuiTableFlags_NoHostExtendY ),
                        value( "NoKeepColumnsVisible",
                               ( int )ImGuiTableFlags_NoKeepColumnsVisible ),
                        value( "PreciseWidths",
                               ( int )ImGuiTableFlags_PreciseWidths ),
                        value( "NoClip", ( int )ImGuiTableFlags_NoClip ),
                        value( "PadOuterX", ( int )ImGuiTableFlags_PadOuterX ),
                        value( "NoPadOuterX",
                               ( int )ImGuiTableFlags_NoPadOuterX ),
                        value( "NoPadInnerX",
                               ( int )ImGuiTableFlags_NoPadInnerX ),
                        ...
                        value( "SortTristate",
                               ( int )ImGuiTableFlags_SortTristate ),
                        value(
                            "HighlightHoveredColumn",
                            ( int )ImGuiTableFlags_HighlightHoveredColumn ) ],

              class_< enum_exporter< ImGuiTableColumnFlags_ > >(
                  "ImGuiTableColumnFlags" )
                  .enum_( "ImGuiTableColumnFlags" )
                      [ value( "Disabled",
                               ( int )ImGuiTableColumnFlags_Disabled ),
                        value( "DefaultHide",
                               ( int )ImGuiTableColumnFlags_DefaultHide ),
                        value( "DefaultSort",
                               ( int )ImGuiTableColumnFlags_DefaultSort ),
                        value( "WidthStretch",
                               ( int )ImGuiTableColumnFlags_WidthStretch ),
                        value( "WidthFixed",
                               ( int )ImGuiTableColumnFlags_WidthFixed ),
                        value( "NoResize",
                               ( int )ImGuiTableColumnFlags_NoResize ),
                        value( "NoReorder",
                               ( int )ImGuiTableColumnFlags_NoReorder ),
                        ...
                        value( "NoSortAscending",
                               ( int )ImGuiTableColumnFlags_NoSortAscending ),
                        value( "NoSortDescending",
                               ( int )ImGuiTableColumnFlags_NoSortDescending ),
                        value( "NoHeaderLabel",
                               ( int )ImGuiTableColumnFlags_NoHeaderLabel ),
                        value( "NoHeaderWidth",
                               ( int )ImGuiTableColumnFlags_NoHeaderWidth ),
                        value(
                            "PreferSortAscending",
                            ( int )ImGuiTableColumnFlags_PreferSortAscending ),
                        value(
                            "PreferSortDescendin",
                            ( int )ImGuiTableColumnFlags_PreferSortDescending ),
                        value( "IndentEnable",
                               ( int )ImGuiTableColumnFlags_IndentEnable ),
                        value( "IndentDisable",
                               ( int )ImGuiTableColumnFlags_IndentDisable ),
                        value( "AngledHeader",
                               ( int )ImGuiTableColumnFlags_AngledHeader ),
                        value( "IsEnabled",
                               ( int )ImGuiTableColumnFlags_IsEnabled ),
                        value( "IsVisible",
                               ( int )ImGuiTableColumnFlags_IsVisible ),
                        value( "IsSorted",
                               ( int )ImGuiTableColumnFlags_IsSorted ),
                        value( "IsHovered",
                               ( int )ImGuiTableColumnFlags_IsHovered ) ],

              class_< enum_exporter< ImGuiTabBarFlags_ > >( "ImGuiTabBarFlags" )
                  .enum_( "ImGuiTabBarFlags" )
                      [ value( "Disabled",
                               ( int )ImGuiTabBarFlags_Reorderable ),
                        value( "DefaultHide",
                               ( int )ImGuiTabBarFlags_AutoSelectNewTabs ),
                        value( "DefaultSort",
                               ( int )ImGuiTabBarFlags_TabListPopupButton ),
                        value(
                            "WidthStretch",
                            ( int )
                        ...
                        value( "NoReorder",
                               ( int )ImGuiTabBarFlags_DrawSelectedOverline ),
                        value(
                            "NoHide",
                            ( int )ImGuiTabBarFlags_FittingPolicyResizeDown ),
                        value( "NoClip",
                               ( int )ImGuiTabBarFlags_FittingPolicyScroll ) ],

              class_< enum_exporter< ImGuiTabItemFlags_ > >(
                  "ImGuiTabItemFlags" )
                  .enum_( "ImGuiTabItemFlags" )
                      [ value( "UnsavedDocument",
                               ( int )ImGuiTabItemFlags_UnsavedDocument ),
                        value( "SetSelected",
                               ( int )ImGuiTabItemFlags_SetSelected ),
                        value(
                        ...
                        value( "NoTooltip",
                               ( int )ImGuiTabItemFlags_NoTooltip ),
                        value( "NoReorder",
                               ( int )ImGuiTabItemFlags_NoReorder ),
                        value( "Leading", ( int )ImGuiTabItemFlags_Leading ),
                        value( "Trailing", ( int )ImGuiTabItemFlags_Trailing ),
                        value( "NoAssumedClosure",
                               ( int )ImGuiTabItemFlags_NoAssumedClosure ) ],

              class_< enum_exporter< ImGuiHoveredFlags_ > >(
                  "ImGuiHoveredFlags" )
                  .enum_( "ImGuiHoveredFlags" )
                      [ value( "ChildWindows",
                               ( int )ImGuiHoveredFlags_ChildWindows ),
                        value( "RootWindow",
                               ( int )ImGuiHoveredFlags_RootWindow ),
                        value( "AnyWindow",
                               ( int )ImGuiHoveredFlags_AnyWindow ),
                        value( "NoPopupHierarchy",
                               ( int )ImGuiHoveredFlags_NoPopupHierarchy ),
                        value( "DockHierarchy",
                               ( int )ImGuiHoveredFlags_DockHierarchy ),
                        value(
                            "AllowWhenBlockedByPopup",
                            ( int )ImGuiHoveredFlags_AllowWhenBlockedByPopup ),
                        value(
                        ...
                        value( "AllowWhenDisabled",
                               ( int )ImGuiHoveredFlags_AllowWhenDisabled ),
                        value( "NoNavOverride",
                               ( int )ImGuiHoveredFlags_NoNavOverride ),
                        value( "AllowWhenOverlapped",
                               ( int )ImGuiHoveredFlags_AllowWhenOverlapped ),
                        value( "RectOnly", ( int )ImGuiHoveredFlags_RectOnly ),
                        value( "RootAndChildWindows",
                               ( int )ImGuiHoveredFlags_RootAndChildWindows ),
                        value( "ForTooltip",
                               ( int )ImGuiHoveredFlags_ForTooltip ),
                        value( "Stationary",
                               ( int )ImGuiHoveredFlags_Stationary ),
                        value( "_DelayNone",
                               ( int )ImGuiHoveredFlags_DelayNone ),
                        value( "DelayShort",
                               ( int )ImGuiHoveredFlags_DelayShort ),
                        value( "DelayNormal",
                               ( int )ImGuiHoveredFlags_DelayNormal ),
                        value( "NoSharedDelay",
                               ( int )ImGuiHoveredFlags_NoSharedDelay ) ],
              ...
              class_< enum_exporter< ImGuiCol_ > >( "ImGuiCol" )
                  .enum_( "ImGuiCol" )
                      [ value( "Text", ( int )ImGuiCol_Text ),
                        ...
                        value( "FrameBgHovered",
                               ( int )ImGuiCol_FrameBgHovered ),
                        ...
                        value( "SeparatorHovered",
                               ( int )ImGuiCol_SeparatorHovered ),
                        value( "SeparatorActive",
                               ( int )ImGuiCol_SeparatorActive ),
                        value( "ResizeGrip", ( int )ImGuiCol_ResizeGrip ),
                        value( "ResizeGripHovered",
                               ( int )ImGuiCol_ResizeGripHovered ),
                        value( "ResizeGripActive",
                               ( int )ImGuiCol_ResizeGripActive ),
                        value( "TabHovered", ( int )ImGuiCol_TabHovered ),
                        value( "Tab", ( int )ImGuiCol_Tab ),
                        value( "TabSelected", ( int )ImGuiCol_TabSelected ),
                        value( "TabSelectedOverline",
                               ( int )ImGuiCol_TabSelectedOverline ),
                        value( "TabDimmed", ( int )ImGuiCol_TabDimmed ),
                        value( "TabDimmedSelected",
                               ( int )ImGuiCol_TabDimmedSelected ),
                        value( "TabDimmedSelectedOverline",
                               ( int )ImGuiCol_TabDimmedSelectedOverline ),
                        value( "DockingPreview",
                               ( int )ImGuiCol_DockingPreview ),
                        value( "DockingEmptyBg",
                               ( int )ImGuiCol_DockingEmptyBg ),
                        value( "PlotLines", ( int )ImGuiCol_PlotLines ),
                        value( "PlotLinesHovered",
                               ( int )ImGuiCol_PlotLinesHovered ),
                        value( "PlotHistogram", ( int )ImGuiCol_PlotHistogram ),
                        value( "PlotHistogramHovered",
                               ( int )ImGuiCol_PlotHistogramHovered ),
                        value( "TableHeaderBg", ( int )ImGuiCol_TableHeaderBg ),
                        value( "TableBorderStrong",
                               ( int )ImGuiCol_TableBorderStrong ),
                        value( "TableBorderLight",
                               ( int )ImGuiCol_TableBorderLight ),
                        ...
                        value( "TextSelectedBg",
                               ( int )ImGuiCol_TextSelectedBg ),
                        value( "DragDropTarget",
                               ( int )ImGuiCol_DragDropTarget ),
                        value( "NavCursor", ( int )ImGuiCol_NavCursor ),
                        value( "NavWindowingHighlight",
                               ( int )ImGuiCol_NavWindowingHighlight ),
                        value( "NavWindowingDimBg",
                               ( int )ImGuiCol_NavWindowingDimBg ),
                        value( "ModalWindowDimBg",
                               ( int )ImGuiCol_ModalWindowDimBg ) ],

              class_< enum_exporter< ImGuiStyleVar_ > >( "ImGuiStyleVar" )
                  .enum_( "ImGuiStyleVar" )
                      [ value( "Alpha", ( int )ImGuiStyleVar_Alpha ),
                        value( "DisabledAlpha",
                               ( int )ImGuiStyleVar_DisabledAlpha ),
                        value( "WindowPadding",
                               ( int )ImGuiStyleVar_WindowPadding ),
                        value( "WindowRounding",
                               ( int )ImGuiStyleVar_WindowRounding ),
                        value( "WindowBorderSize",
                               ( int )ImGuiStyleVar_WindowBorderSize ),
                        value( "WindowMinSize",
                               ( int )ImGuiStyleVar_WindowMinSize ),
                        value( "WindowTitleAlign",
                               ( int )ImGuiStyleVar_WindowTitleAlign ),
                        value( "ChildRounding",
                               ( int )ImGuiStyleVar_ChildRounding ),
                        value( "ChildBorderSize",
                               ( int )ImGuiStyleVar_ChildBorderSize ),
                        value( "PopupRounding",
                               ( int )ImGuiStyleVar_PopupRounding ),
                        value( "PopupBorderSize",
                               ( int )ImGuiStyleVar_PopupBorderSize ),
                        value( "FramePadding",
                               ( int )ImGuiStyleVar_FramePadding ),
                        value( "FrameRounding",
                               ( int )ImGuiStyleVar_FrameRounding ),
                        value( "FrameBorderSize",
                               ( int )ImGuiStyleVar_FrameBorderSize ),
                        value( "ItemSpacing",
                               ( int )ImGuiStyleVar_ItemSpacing ),
                        value( "ItemInnerSpacing",
                               ( int )ImGuiStyleVar_ItemInnerSpacing ),
                        value( "IndentSpacing",
                               ( int )ImGuiStyleVar_IndentSpacing ),
                        value( "CellPadding",
                               ( int )ImGuiStyleVar_CellPadding ),
                        value( "ScrollbarSize",
                               ( int )ImGuiStyleVar_ScrollbarSize ),
                        value( "ScrollbarRounding",
                               ( int )ImGuiStyleVar_ScrollbarRounding ),
                        value( "GrabMinSize",
                               ( int )ImGuiStyleVar_GrabMinSize ),
                        value( "GrabRounding",
                               ( int )ImGuiStyleVar_GrabRounding ),
                        value( "TabRounding",
                               ( int )ImGuiStyleVar_TabRounding ),
                        value( "TabBorderSize",
                               ( int )ImGuiStyleVar_TabBorderSize ),
                        value( "TabBarBorderSize",
                               ( int )ImGuiStyleVar_TabBarBorderSize ),
                        value( "TabBarOverlineSize",
                               ( int )ImGuiStyleVar_TabBarOverlineSize ),
                        value( "TableAngledHeadersAngle",
                               ( int )ImGuiStyleVar_TableAngledHeadersAngle ),
                        value(
                            "TableAngledHeadersTextAlign",
                            ( int )ImGuiStyleVar_TableAngledHeadersTextAlign ),
                        value( "ButtonTextAlign",
                               ( int )ImGuiStyleVar_ButtonTextAlign ),
                        value( "SelectableTextAlign",
                               ( int )ImGuiStyleVar_SelectableTextAlign ),
                        value( "SeparatorTextBorderSize",
                               ( int )ImGuiStyleVar_SeparatorTextBorderSize ),
                        value( "SeparatorTextAlign",
                               ( int )ImGuiStyleVar_SeparatorTextAlign ),
                        value( "SeparatorTextPadding",
                               ( int )ImGuiStyleVar_SeparatorTextPadding ),
                        value( "DockingSeparatorSize",
                               ( int )ImGuiStyleVar_DockingSeparatorSize ) ],

              class_< enum_exporter< ImGuiComboFlags_ > >( "ImGuiComboFlags" )
                  .enum_( "ImGuiComboFlags" )
                      [ value( "PopupAlignLeft",
                               ( int )ImGuiComboFlags_PopupAlignLeft ),
                        value( "HeightSmall",
                               ( int )ImGuiComboFlags_HeightSmall ),
                        value( "HeightRegular",
                               ( int )ImGuiComboFlags_HeightRegular ),
                        value( "HeightLarge",
                               ( int )ImGuiComboFlags_HeightLarge ),
                        value( "HeightLargest",
                               ( int )ImGuiComboFlags_HeightLargest ),
                        value( "NoArrowButton",
                               ( int )ImGuiComboFlags_NoArrowButton ),
                        value( "NoPreview", ( int )ImGuiComboFlags_NoPreview ),
                        value( "WidthFitPreview",
                               ( int )ImGuiComboFlags_WidthFitPreview ) ],

              class_< enum_exporter< ImGuiSortDirection > >(
                  "ImGuiSortDirection" )
                  .enum_( "ImGuiSortDirection" )
                      [ value( "Ascending",
                               ( int )ImGuiSortDirection_Ascending ),
                        value( "Descending",
                               ( int )ImGuiSortDirection_Descending ) ],
              ...
              class_< enum_exporter< ImGuiButtonFlags_ > >( "ImGuiButtonFlags" )
                  .enum_( "ImGuiButtonFlags" )
                      [ value( "MouseButtonLeft",
                               ( int )ImGuiButtonFlags_MouseButtonLeft ),
                        value( "MouseButtonRight",
                               ( int )ImGuiButtonFlags_MouseButtonRight ),
                        value( "MouseButtonMiddle",
                               ( int )ImGuiButtonFlags_MouseButtonMiddle ),
                        value( "EnableNav",
                               ( int )ImGuiButtonFlags_EnableNav ) ],
              ...
              class_< enum_exporter< ImGuiKey > >( "ImGuiKey" )
                  .enum_( "ImGuiKey" )
                      [ value( "A", ( int )ImGuiKey_A ),
                        ...
                        value( "KeypadMultiply",
                               ( int )ImGuiKey_KeypadMultiply ),
                        value( "KeypadSubtract",
                               ( int )ImGuiKey_KeypadSubtract ),
              ...
              class_< enum_exporter< ImGuiInputFlagsPrivate_ > >(
                  "ImGuiInputFlags" )
                  .enum_( "ImGuiInputFlags" )
                      [ value( "RepeatRateDefault",
                               ( int )ImGuiInputFlags_RepeatRateDefault ),
                        value( "RepeatRateNavMove",
                               ( int )ImGuiInputFlags_RepeatRateNavMove ),
                        value( "RepeatRateNavTweak",
                               ( int )ImGuiInputFlags_RepeatRateNavTweak ),
                        value( "RepeatUntilRelease",
                               ( int )ImGuiInputFlags_RepeatUntilRelease ),
                        value(
                            "RepeatUntilKeyModsChange",
                            ( int )ImGuiInputFlags_RepeatUntilKeyModsChange ),
                        value(
                        ...
                        value(
                            ...
                            ( int )ImGuiInputFlags_RepeatUntilOtherKeyPress ),
                        value( "LockThisFrame",
                               ( int )ImGuiInputFlags_LockThisFrame ),
                        value( "LockUntilRelease",
                               ( int )ImGuiInputFlags_LockUntilRelease ),
                        value( "CondHovered",
                               ( int )ImGuiInputFlags_CondHovered ),
                        value( "CondActive",
                               ( int )ImGuiInputFlags_CondActive ) ],

              class_< enum_exporter< ImGuiColorEditFlags_ > >(
                  "ImGuiColorEditFlags" )
                  .enum_( "ImGuiColorEditFlags" )
                      [ value( "NoAlpha", ( int )ImGuiColorEditFlags_NoAlpha ),
                        value( "NoPicker",
                               ( int )ImGuiColorEditFlags_NoPicker ),
                        value( "NoOptions",
                               ( int )ImGuiColorEditFlags_NoOptions ),
                        value( "NoSmallPreview",
                               ( int )ImGuiColorEditFlags_NoSmallPreview ),
                        value( "NoInputs",
                               ( int )ImGuiColorEditFlags_NoInputs ),
                        value( "NoTooltip",
                               ( int )ImGuiColorEditFlags_NoTooltip ),
                        value( "NoLabel", ( int )ImGuiColorEditFlags_NoLabel ),
                        value( "NoSidePreview",
                               ( int )ImGuiColorEditFlags_NoSidePreview ),
                        value( "NoDragDrop",
                               ( int )ImGuiColorEditFlags_NoDragDrop ),
                        value( "NoBorder",
                               ( int )ImGuiColorEditFlags_NoBorder ),
                        value( "AlphaOpaque",
                               ( int )ImGuiColorEditFlags_AlphaOpaque ),
                        value( "AlphaNoBg",
                               ( int )ImGuiColorEditFlags_AlphaNoBg ),
                        value( "AlphaPreviewHalf",
                               ( int )ImGuiColorEditFlags_AlphaPreviewHalf ),
                        value( "AlphaBar",
                               ( int )ImGuiColorEditFlags_AlphaBar ),
                        value( "HDR", ( int )ImGuiColorEditFlags_HDR ),
                        value( "DisplayRGB",
                               ( int )ImGuiColorEditFlags_DisplayRGB ),
                        value( "DisplayHSV",
                               ( int )ImGuiColorEditFlags_DisplayHSV ),
                        value( "DisplayHex",
                               ( int )ImGuiColorEditFlags_DisplayHex ),
                        value( "Uint8", ( int )ImGuiColorEditFlags_Uint8 ),
                        value( "Float", ( int )ImGuiColorEditFlags_Float ),
                        value( "PickerHueBar",
                               ( int )ImGuiColorEditFlags_PickerHueBar ),
                        value( "PickerHueWheel",
                               ( int )ImGuiColorEditFlags_PickerHueWheel ),
                        value( "InputRGB",
                               ( int )ImGuiColorEditFlags_InputRGB ),
                        value( "InputHSV",
                               ( int )ImGuiColorEditFlags_InputHSV ) ],

              class_< enum_exporter< ImGuiSliderFlags_ > >( "ImGuiSliderFlags" )
                  .enum_( "ImGuiSliderFlags" )
                      [ value( "Logarithmic",
                               ( int )ImGuiSliderFlags_Logarithmic ),
                        value( "NoRoundToFormat",
                               ( int )ImGuiSliderFlags_NoRoundToFormat ),
                        value( "NoInput", ( int )ImGuiSliderFlags_NoInput ),
                        value( "WrapAround",
                               ( int )ImGuiSliderFlags_WrapAround ),
                        value( "ClampOnInput",
                               ( int )ImGuiSliderFlags_ClampOnInput ),
                        value( "ClampZeroRange",
                               ( int )ImGuiSliderFlags_ClampZeroRange ),
                        value( "NoSpeedTweaks",
                               ( int )ImGuiSliderFlags_NoSpeedTweaks ),
                        value( "AlwaysClamp",
                               ( int )ImGuiSliderFlags_AlwaysClamp ) ],

              class_< enum_exporter< ImGuiFocusedFlags_ > >(
                  "ImGuiFocusedFlags" )
                  .enum_( "ImGuiFocusedFlags" )
                      [ value( "ChildWindows",
                               ( int )ImGuiFocusedFlags_ChildWindows ),
                        value( "RootWindow",
                               ( int )ImGuiFocusedFlags_RootWindow ),
                        value( "AnyWindow",
                               ( int )ImGuiFocusedFlags_AnyWindow ),
                        value( "NoPopupHierarchy",
                               ( int )ImGuiFocusedFlags_NoPopupHierarchy ),
                        value( "DockHierarchy",
                               ( int )ImGuiFocusedFlags_DockHierarchy ),
                        value( "RootAndChildWindows",
