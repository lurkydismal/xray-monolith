...
struct FS_item {
    ...
    LPCSTR ModifDigitOnly() {
        ...
        time_t t = modif;
        newtime = localtime( &t );
        xr_sprintf( buff, "%02d/%02d/%4d %02d:%02d", newtime->tm_mday,
                    newtime->tm_mon + 1, newtime->tm_year + 1900,
...
void FS_file_list_ex::Sort( u32 flags ) {
    if ( flags == eSortByNameUp )
        std::sort( m_file_items.begin(), m_file_items.end(),
                   nameSorter< true > );
...
FS_file_list_ex file_list_open_ex( CLocatorAPI* fs,
                                   LPCSTR path,
                                   u32 flags,
                                   LPCSTR mask ) {
...
FS_file_list file_list_open_script( CLocatorAPI* fs,
                                    LPCSTR initial,
                                    u32 flags ) {
    return FS_file_list( fs->file_list_open( initial, flags ) );
}

FS_file_list file_list_open_script_2( CLocatorAPI* fs,
                                      LPCSTR initial,
                                      LPCSTR folder,
                                      u32 flags ) {
...
void dir_delete_script_2( CLocatorAPI* fs,
                          LPCSTR path,
                          LPCSTR nm,
                          int remove_files ) {
    ...
    module( L )[ class_< FS_item >( "FS_item" )
                 ...
                 */
                 class_< CLocatorAPI::file >( "fs_file" )
                     ...
                     .def_readonly( "size_compressed",
                                    &CLocatorAPI::file::size_compressed )
                     .def_readonly( "modif", &CLocatorAPI::file::modif ),

                 class_< CLocatorAPI >( "FS" )
                     .enum_( "FS_sort_mode" )
                         [ value( "FS_sort_by_name_up",
                                  int( FS_file_list_ex::eSortByNameUp ) ),
                           value( "FS_sort_by_name_down",
                                  int( FS_file_list_ex::eSortByNameDown ) ),
                           value( "FS_sort_by_size_up",
                                  int( FS_file_list_ex::eSortBySizeUp ) ),
                           value( "FS_sort_by_size_down",
                                  int( FS_file_list_ex::eSortBySizeDown ) ),
                           value( "FS_sort_by_modif_up",
                                  int( FS_file_list_ex::eSortByModifUp ) ),
                           value( "FS_sort_by_modif_down",
                                  int( FS_file_list_ex::eSortByModifDown ) ) ]
                     .enum_( "FS_List" )
                     ...
                     .def( "file_delete",
                           ( void ( CLocatorAPI::* )( LPCSTR, LPCSTR ) )(
                               &CLocatorAPI::file_delete ) )
                     .def( "file_delete", ( void ( CLocatorAPI::* )( LPCSTR ) )(
                                              &CLocatorAPI::file_delete ) )
                     ...
                     .def( "exist", ( const CLocatorAPI::file* (
                                        CLocatorAPI::* )( LPCSTR ) )(
                                        &CLocatorAPI::exist ) )
                     .def( "exist", ( const CLocatorAPI::file* (
                                        CLocatorAPI::* )( LPCSTR, LPCSTR ) )(
                                        &CLocatorAPI::exist ) )

                     .def( "get_file_age", &CLocatorAPI::get_file_age )
                     .def( "get_file_age_str", &get_file_age_str )
                     .def( "r_open",
                           ( IReader * ( CLocatorAPI::* )( LPCSTR, LPCSTR ) )(
                               &CLocatorAPI::r_open ) )
                     .def( "r_open", ( IReader * ( CLocatorAPI::* )( LPCSTR ) )(
                                         &CLocatorAPI::r_open ) )
                     .def( "r_close", ( void ( CLocatorAPI::* )( IReader*& ) )(
                                          &CLocatorAPI::r_close ) )

                     .def( "w_open",
                           ( IWriter * ( CLocatorAPI::* )( LPCSTR, LPCSTR ) )(
                               &CLocatorAPI::w_open ) )
                     .def( "w_open", ( IWriter * ( CLocatorAPI::* )( LPCSTR ) )(
                                         &CLocatorAPI::w_close ) )
