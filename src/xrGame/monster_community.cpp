...
//////////////////////////////////////////////////////////////////////////
MONSTER_COMMUNITY_DATA::MONSTER_COMMUNITY_DATA( MONSTER_COMMUNITY_INDEX idx,
                                                MONSTER_COMMUNITY_ID idn,
                                                LPCSTR team_str ) {
    index = idx;
    id = idn;
...
int MONSTER_COMMUNITY::relation( MONSTER_COMMUNITY_INDEX from,
