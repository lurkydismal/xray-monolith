...
protected:
    ...
    virtual void CheckItem( game_PlayerState* ps,
                            PIItem pItem,
...
public:
    ...
    virtual void OnPlayerHitPlayer( u16 id_hitter,
                                    u16 id_hitted,
                                    NET_Packet& P ); // игрок получил Hit
    ...
    virtual KILL_RES GetKillResult( game_PlayerState* pKiller,
                                    game_PlayerState* pVictim );
    virtual bool OnKillResult( KILL_RES KillResult,
                               game_PlayerState* pKiller,
                               game_PlayerState* pVictim );
    virtual void OnGiveBonus( KILL_RES KillResult,
                              game_PlayerState* pKiller,
                              game_PlayerState* pVictim,
                              KILL_TYPE KillType,
    ...
    virtual void LoadDefItemsForTeam(
        const shared_str& caSection, /*TEAM_WPN_LIST *pWpnList,*/
        DEF_ITEMS_LIST* pDefItems );

    virtual const char* GetAnomalySetBaseName() {
    ...
    virtual s32 GetMoneyAmount( const shared_str& caSection,
