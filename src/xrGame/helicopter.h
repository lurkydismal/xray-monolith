...
public:
    ...
    void CreateRoundPoints( Fvector center,
                            float radius,
                            float start_h,
                            float end_h,
...
public:
    enum EHeliState { eAlive = u32( 0 ), eDead, eForce = u32( -1 ) };
    ...
    u16 m_left_rocket_bone, m_right_rocket_bone, m_fire_bone, m_rotate_x_bone,
        m_rotate_y_bone;
