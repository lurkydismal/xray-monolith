...
IC const CVisualMemoryManager::VISIBLES* CVisualMemoryManager::objectsPtr()
    const {
    return m_objects;
}

IC const CVisualMemoryManager::RAW_VISIBLES& CVisualMemoryManager::raw_objects()
    const {
    return ( m_visible_objects );
}

IC const CVisualMemoryManager::NOT_YET_VISIBLES&
CVisualMemoryManager::not_yet_visible_objects() const {
