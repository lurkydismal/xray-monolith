...
CWeaponAK74::CWeaponAK74( ESoundTypes eSoundType )
    : CWeaponMagazinedWGrenade( eSoundType ) {}
    ...
    module( L )
        [ class_< CWeaponAK74, CGameObject >( "CWeaponAK74" )
          ...
          class_< CWeapon, CGameObject >( "CWeapon" )
              .def( constructor<>() )
              .def( "can_kill",
                    ( bool ( CWeapon::* )() const ) & CWeapon::can_kill )

              .def( "IsGrenadeLauncherAttached",
                    &CWeapon::IsGrenadeLauncherAttached )
              .def( "GrenadeLauncherAttachable",
                    &CWeapon::GrenadeLauncherAttachable )
              .def( "GetGrenadeLauncherName",
                    &CWeapon::GetGrenadeLauncherNameScript )
              ...
              .def( "GetMisfireStartCondition",
                    &CWeapon::GetMisfireStartCondition )
              ...
              .def( "GetAmmoCount_forType",
                    &CWeapon::GetAmmoCount_forType_Script )
              .def( "set_ef_main_weapon_type",
                    &CWeapon::set_ef_main_weapon_type )
              ...
              .def( "Get_Silencer_CrosshairInertion",
                    &CWeapon::Get_Silencer_CrosshairInertion )
              .def( "Get_Scope_CrosshairInertion",
                    &CWeapon::Get_Scope_CrosshairInertion )
              .def( "Get_Launcher_CrosshairInertion",
                    &CWeapon::Get_Launcher_CrosshairInertion )
              ...
              .def( "get_CurrentFirePointSilencer",
                    &CWeapon::get_CurrentFirePointSilencer )

              // Setters
              .def( "SetFireDispersion", &CWeapon::SetFireDispersionScript )
              .def( "SetMisfireStartCondition",
                    &CWeapon::SetMisfireStartCondition )
              ...
              .def( "Set_Silencer_CrosshairInertion",
                    &CWeapon::Set_Silencer_CrosshairInertion )
              .def( "Set_Scope_CrosshairInertion",
                    &CWeapon::Set_Scope_CrosshairInertion )
              .def( "Set_Launcher_CrosshairInertion",
                    &CWeapon::Set_Launcher_CrosshairInertion )
              ...
              .def( "Get_strapped_mode",
                    ( bool ( CWeapon::* )() const ) & CWeapon::strapped_mode )
              ...
              .def( "GetZoomCamRelaxSpeed_AI",
                    &CWeapon::GetZoomCamRelaxSpeed_AI )
              .def( "GetZoomCamDispersion", &CWeapon::GetZoomCamDispersion )
              .def( "GetZoomCamDispersionInc",
                    &CWeapon::GetZoomCamDispersionInc )
              .def( "GetZoomCamDispersionFrac",
                    &CWeapon::GetZoomCamDispersionFrac )
              .def( "GetZoomCamMaxAngleVert", &CWeapon::GetZoomCamMaxAngleVert )
              .def( "GetZoomCamMaxAngleHorz", &CWeapon::GetZoomCamMaxAngleHorz )
              .def( "GetZoomCamStepAngleHorz",
                    &CWeapon::GetZoomCamStepAngleHorz )
              ...
              .def( "SetZoomCamRelaxSpeed_AI",
                    &CWeapon::SetZoomCamRelaxSpeed_AI )
              .def( "SetZoomCamDispersion", &CWeapon::SetZoomCamDispersion )
              .def( "SetZoomCamDispersionInc",
                    &CWeapon::SetZoomCamDispersionInc )
              .def( "SetZoomCamDispersionFrac",
                    &CWeapon::SetZoomCamDispersionFrac )
              .def( "SetZoomCamMaxAngleVert", &CWeapon::SetZoomCamMaxAngleVert )
              .def( "SetZoomCamMaxAngleHorz", &CWeapon::SetZoomCamMaxAngleHorz )
              .def( "SetZoomCamStepAngleHorz",
                    &CWeapon::SetZoomCamStepAngleHorz )
              ...
              .enum_( "EWeaponSubStates" )
                  [ value( "eSubstateReloadBegin",
                           int( EWeaponSubStates::eSubstateReloadBegin ) ),
                    value( "eSubstateReloadInProcess",
                           int( EWeaponSubStates::eSubstateReloadInProcess ) ),
                    value( "eSubstateReloadEnd",
                           int( EWeaponSubStates::eSubstateReloadEnd ) ) ],

          class_< CWeaponMagazined, CWeapon >( "CWeaponMagazined" )
              .def( constructor<>() )
              .def( "SetFireMode", &CWeaponMagazined::SetFireMode ),

          class_< CWeaponMagazinedWGrenade, CWeaponMagazined >(
              "CWeaponMagazinedWGrenade" )
              .def( constructor<>() )
              .def( "GetGrenadeLauncherMode",
                    &CWeaponMagazinedWGrenade::GetGrenadeLauncherMode )
              .def( "SetGrenadeLauncherMode",
                    &CWeaponMagazinedWGrenade::SetGrenadeLauncherMode )

              .def( "SetAmmoElapsed2",
                    &CWeaponMagazinedWGrenade::SetAmmoElapsed2 )
              .def( "GetAmmoElapsed2",
                    &CWeaponMagazinedWGrenade::GetAmmoElapsed2 )
              .def( "GetAmmoMagSize2",
                    &CWeaponMagazinedWGrenade::GetAmmoMagSize2 )
              .def( "SetAmmoType2", &CWeaponMagazinedWGrenade::SetAmmoType2 )
              .def( "GetAmmoType2", &CWeaponMagazinedWGrenade::GetAmmoType2 )
              .def( "AmmoTypeForEach2",
                    &CWeaponMagazinedWGrenade::AmmoTypeForEach2 ) ];
}
