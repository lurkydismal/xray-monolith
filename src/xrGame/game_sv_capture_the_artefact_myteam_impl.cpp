...
void game_sv_CaptureTheArtefact::MyTeam::SetArtefactRPoint(
    const RPoint& rpoint ) {
...
void game_sv_CaptureTheArtefact::MyTeam::OnPlayerDetachArtefact(
    ...
    VERIFY2(
        ...
        make_string(
            "artefacts owners not equal: firstOwnerId = %d, secondOwnerId = %d",
...
void game_sv_CaptureTheArtefact::MyTeam::OnPlayerActivateArtefact(
    u16 eid_who ) {
