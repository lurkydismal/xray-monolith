...
public:
    ...
    void register_to_process() {
        ...
        Device.seqParallel.push_back(
            xr_make_delegate( this, &CDetailPathBuilder::process ) );
    }
    ...
    void process_impl( bool separate_computing = true ) {
        ...
        if ( m_object->detail().failed() )
            ...
            m_object->m_path_state =
                CMovementManager::ePathStatePathVerification;
    }

    void __stdcall process() { process_impl( true ); }
