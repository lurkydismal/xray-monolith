...
public:
    CPHScriptObjectCondition( const ::luabind::object& lua_object,
                              LPCSTR method );
...
public:
    CPHScriptObjectConditionN( const ::luabind::object& object,
...
public:
    CPHScriptObjectActionN( const ::luabind::object& object,
...
public:
    CPHScriptGameObjectCondition( const ::luabind::object& object,
                                  const ::luabind::functor< bool >& functor,
                                  CObject* gobj )
...
public:
    CPHScriptGameObjectAction( const ::luabind::object& object,
                               const ::luabind::functor< void >& functor,
                               CObject* gobj )
