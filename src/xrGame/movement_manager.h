...
protected:
    ...
    typedef CBaseLocationSelector< CGameGraph,
                                   SGameVertex< float, u32, u32 >,
                                   u32 >
        CGameLocationSelector;

    typedef CBasePathManager< CGameGraph,
                              SGameVertex< float, u32, u32 >,
                              u32,
                              u32 >
        CGamePathManager;
    typedef CBasePathManager< CLevelGraph,
...
public:
    ...
    virtual void on_frame( CPHMovementControl* movement_control,
    ...
    IC void set_body_orientation(
        const MonsterSpace::SBoneRotation& orientation );
    IC const CBoneRotation& body_orientation() const;
    void update_path();
    virtual void move_along_path( CPHMovementControl* movement_control,
                                  Fvector& dest_position,
                                  float time_delta );
    ...
    bool distance_to_destination_greater(
...
protected:
    ...
    Fvector path_position( const float& velocity,
...
public:
    ...
    Fvector predict_position( const float& time_delta,
                              const Fvector& position,
                              u32& current_travel_point,
