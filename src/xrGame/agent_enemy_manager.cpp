...
void CAgentEnemyManager::fill_enemies() {
    ...
    {
        CAgentMemberManager::iterator I =
            object().member().combat_members().begin();
        CAgentMemberManager::iterator E =
        ...
        for ( ; I != E; ++I ) {
            ...
            for ( ; i != e; ++i ) {
                ...
                if ( my_distance < best ) {
                    ...
                    for ( ; J; J &= J - 1 ) {
                        K = ( J & ( J - 1 ) ) ^ J;
                        CAgentMemberManager::iterator j =
                            object().member().member( K );
                        xr_vector< u32 >::iterator ii = std::find(
...
void CAgentEnemyManager::wounded_processed( const CEntityAlive* object,
                                            bool value ) {
    VERIFY( value );
    WOUNDED_ENEMIES::iterator I = std::find_if(
