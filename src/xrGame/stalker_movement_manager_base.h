...
public:
    ...
    IC EBodyState body_state_combat_override( EWorldOperators wo,
    ...
    void set_nearest_accessible_position( Fvector desired_position,
                                          u32 level_vertex_id );
...
public:
    ...
    void update_object_on_the_way( const CGameObject* object,
                                   const float& distance );
    bool is_object_on_the_way( const CGameObject* object,
                               const float& distance );
