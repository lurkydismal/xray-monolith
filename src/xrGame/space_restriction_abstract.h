...
private:
    template < typename T >
    IC bool accessible_neighbours( T& restriction,
                                   u32 level_vertex_id,
                                   bool out_restriction );

    template < typename T >
    IC void prepare_accessible_neighbour_border( T& restriction,
                                                 bool out_restriction );
...
public:
    template < typename T >
    IC const xr_vector< u32 >& accessible_neighbour_border(
        T& restriction,
        bool out_restriction );
