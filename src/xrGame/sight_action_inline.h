...
IC CSightAction::CSightAction( const ESightType& sight_type,
                               bool torso_look,
                               bool path )
...
IC CSightAction::CSightAction( const CGameObject* object_to_look,
                               bool torso_look,
                               bool fire_object,
                               bool no_pitch )
    : m_sight_type( fire_object ? SightManager::eSightTypeFireObject
                                : SightManager::eSightTypeObject ),
      m_torso_look( torso_look ),
      m_path( false ),
...
IC CSightAction::CSightAction( const CMemoryInfo* memory_object,
                               bool torso_look )
...
IC bool CSightAction::operator==( const CSightAction& sight_action ) const {
    ...
    switch ( m_sight_type ) {
        ...
        case SightManager::eSightTypeDirection:
            return ( ( m_torso_look == sight_action.m_torso_look ) &&
                     m_vector3d.similar( sight_action.m_vector3d ) );
        case SightManager::eSightTypePosition:
            return ( ( m_torso_look == sight_action.m_torso_look ) &&
                     m_vector3d.similar( sight_action.m_vector3d ) );
        case SightManager::eSightTypeObject:
            return ( ( m_torso_look == sight_action.m_torso_look ) &&
                     ( m_object_to_look == sight_action.m_object_to_look ) );
        case SightManager::eSightTypeCover:
            return ( ( m_path == sight_action.m_path ) &&
                     ( m_torso_look == sight_action.m_torso_look ) );
