...
IC CALifeMonsterDetailPathManager::object_type&
CALifeMonsterDetailPathManager::object() const {
    VERIFY( m_object );
    return ( *m_object );
}
...
IC const CALifeMonsterDetailPathManager::PATH&
CALifeMonsterDetailPathManager::path() const {
    return ( m_path );
}
