...
public:
    ...
    void AddSoundMessage( LPCSTR sound_name,
...
public:
    void __stdcall SendCollectedData( u8 const* buffer,
                                      u32 buffer_size,
                                      u32 uncompressed_size );
    void PrepareToReceiveFile( ClientID const& from_client,
...
public:
    ...
    void decompress_and_save_screenshot( LPCSTR file_name,
                                         ...
                                         u32 data_size,
                                         u32 file_size );
    void decompress_and_process_config( LPCSTR file_name,
                                        u8* data,
                                        u32 data_size,
                                        u32 file_size );
    ...
    void __stdcall sending_screenshot_callback(
        file_transfer::sending_status_t status,
        u32 bytes_sent,
        u32 data_size );
    //-------------------------------------------------------------------------------------------------
    static void generate_file_name( string_path& file_name,
                                    LPCSTR file_suffix,
