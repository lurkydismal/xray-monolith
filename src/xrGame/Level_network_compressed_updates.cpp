    ...
    while ( next_size ) {
        if ( compress_type & eto_ppmd_compression ) {
            ...
            uncompressed_packet.B.count = ppmd_trained_decompress(
                ...
                sizeof( uncompressed_packet.B.data ), P.B.data + P.r_tell(),
                next_size, m_trained_stream );
            ...
            lzo_decompress_dict(
                P.B.data + P.r_tell(), next_size, uncompressed_packet.B.data,
                ( lzo_uint* )&uncompressed_packet.B.count, m_lzo_working_memory,
