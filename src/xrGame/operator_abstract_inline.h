...
TEMPLATE_SPECIALIZATION
IC CAbstractOperator::COperatorAbstract( const CSConditionState& conditions,
...
TEMPLATE_SPECIALIZATION
IC const typename CAbstractOperator::CSConditionState&
CAbstractOperator::conditions() const {
    return ( m_conditions );
}

TEMPLATE_SPECIALIZATION
IC const typename CAbstractOperator::CSConditionState&
CAbstractOperator::effects() const {
    return ( m_effects );
}

TEMPLATE_SPECIALIZATION
IC void CAbstractOperator::add_condition(
...
TEMPLATE_SPECIALIZATION
IC void CAbstractOperator::remove_condition(
...
TEMPLATE_SPECIALIZATION
IC void CAbstractOperator::remove_effect(
    const typename COperatorCondition::_condition_type& effect ) {
    if ( !this )
        return;
    actual( false );
...
IC bool CAbstractOperator::applicable_reverse(
    ...
    typename xr_vector< COperatorCondition >::const_iterator i =
        self_condition.conditions().begin();
    typename xr_vector< COperatorCondition >::const_iterator e =
        self_condition.conditions().end();
    typename xr_vector< COperatorCondition >::const_iterator I =
...
TEMPLATE_SPECIALIZATION
template < typename T >
IC bool CAbstractOperator::applicable( const CSConditionState& current,
                                       const CSConditionState& start,
...
IC const typename CAbstractOperator::CSConditionState& CAbstractOperator::apply(
    ...
    typename xr_vector< COperatorCondition >::const_iterator E =
        current.conditions().end();
    typename xr_vector< COperatorCondition >::const_iterator i =
        effects.conditions().begin();
    typename xr_vector< COperatorCondition >::const_iterator e =
        effects.conditions().end();
    typename xr_vector< COperatorCondition >::const_iterator II =
        start.conditions().begin();
    typename xr_vector< COperatorCondition >::const_iterator EE =
        start.conditions().end();
...
TEMPLATE_SPECIALIZATION
IC typename CAbstractOperator::_edge_value_type CAbstractOperator::min_weight()
    const {
    if ( m_weight_actual )
        return ( m_min_weight );
