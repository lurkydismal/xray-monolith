...
protected:
    ...
    IC void difference_restrictions( shared_str& restrictions,
                                     shared_str update );
    CRestrictionPtr restriction( ALife::_OBJECT_ID id );
    CRestrictionPtr restriction( shared_str out_restrictors,
...
public:
    ...
    void restrict( ALife::_OBJECT_ID id,
                   shared_str out_restrictors,
                   shared_str in_restrictors );
    void unrestrict( ALife::_OBJECT_ID id );
    void add_restrictions( ALife::_OBJECT_ID id,
                           shared_str out_restrictions,
                           shared_str in_restrictions );
    void remove_restrictions( ALife::_OBJECT_ID id,
                              shared_str out_restrictions,
                              shared_str in_restrictions );
    void change_restrictions( ALife::_OBJECT_ID id,
    ...
    u32 accessible_nearest( ALife::_OBJECT_ID id,
                            const Fvector& position,
                            Fvector& result );

    bool restriction_presented( shared_str restrictions,
