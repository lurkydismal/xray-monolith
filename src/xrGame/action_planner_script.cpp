...
void set_goal_world_state( CScriptActionPlanner* action_planner,
                           CScriptActionPlanner::CState* world_state ) {
...
void CScriptActionPlanner::script_register( lua_State* L ) {
    module(
        L )[ class_< CScriptActionPlanner, CScriptActionPlannerWrapper >(
                 ...
                 .def( "setup", &CScriptActionPlanner::setup,
                       &CScriptActionPlannerWrapper::setup_static )
                 .def( "update", &CScriptActionPlanner::update,
                       &CScriptActionPlannerWrapper::update_static )
                 .def( "add_action", &CScriptActionPlanner::add_operator,
                       adopt< 3 >() )
                 .def( "remove_action",
                       ( void ( CScriptActionPlanner::* )(
                           const CScriptActionPlanner::_edge_type& ) )(
