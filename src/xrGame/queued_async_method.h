...
template < typename Class,
           ...
           void ( Class::*release_method )(
               typename DelegateType::param1_type,
               typename DelegateType::param2_type ) >
...
public:
    ...
    void execute( Class* obj_ptr,
                  ParametersTuple const& args,
                  DelegateType func ) {
        if ( current_delegate ) {
...
private:
    return_type __stdcall proxy_execution( param1_type arg1,
                                           param2_type arg2 ) {
        if ( pending_active ) {
...
struct parameters_tuple3 {
    ...
    parameters_tuple3( parameters_tuple3 const& copy )
        : m_t1( copy.m_t1 ), m_t2( copy.m_t2 ), m_t3( copy.m_t3 ) {};
