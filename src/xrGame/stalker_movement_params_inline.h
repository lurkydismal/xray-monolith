...
IC void stalker_movement_params::construct(
    stalker_movement_manager_smart_cover* manager ) {
    VERIFY( !m_manager );
    VERIFY( manager );
    m_manager = manager;
}
...
IC void stalker_movement_params::cover_fire_object(
    CGameObject const* object ) {
...
IC void stalker_movement_params::cover_fire_position(
...
IC void stalker_movement_params::cover_loophole_id(
