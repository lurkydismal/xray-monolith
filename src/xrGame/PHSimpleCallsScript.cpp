...
void CPHCallOnStepCondition::script_register( lua_State* L ) {
    module( L )[ class_< CPHCallOnStepCondition >( "phcondition_callonstep" )
                     ...
                     .def( "set_steps_interval",
                           &CPHCallOnStepCondition::set_steps_interval )
                     .def( "set_global_time_ms",
                           ( void ( CPHCallOnStepCondition::* )( u32 ) )(
                               &CPHCallOnStepCondition::set_global_time ) )
                     .def( "set_global_time_s",
                           ( void ( CPHCallOnStepCondition::* )( float ) )(
                               &CPHCallOnStepCondition::set_global_time ) )
                     .def( "set_time_interval_ms",
                           ( void ( CPHCallOnStepCondition::* )( u32 ) )(
                               &CPHCallOnStepCondition::set_time_interval ) )
...
void CPHExpireOnStepCondition::script_register( lua_State* L ) {
    module( L )[ class_< CPHExpireOnStepCondition, CPHCallOnStepCondition >(
                     "phcondition_expireonstep" )
                     .def( constructor<>() ) ];
}

void CPHConstForceAction::script_register( lua_State* L ) {
    module( L )[ class_< CPHConstForceAction >( "phaction_constforce" )
