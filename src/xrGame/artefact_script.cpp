...
void CArtefact::script_register( lua_State* L ) {
    module(
        L )[ class_< CArtefact, CGameObject >( "CArtefact" )
                 .def( constructor<>() )
                 .def( "ActivateArtefact", &CArtefact::ActivateArtefact )
                 .def( "CanBeActivated", &CArtefact::CanBeActivated )
                 .def( "AdditionalInventoryWeight",
                       &CArtefact::AdditionalInventoryWeight )
                 .def_readwrite( "m_bCanSpawnZone",
                                 &CArtefact::m_bCanSpawnZone )
