...
// typedef CALifeRegistryWrapper<CKnownContactsRegistry>
// KNOWN_CONTACTS_REGISTRY;
...
// {}; class CEncyclopediaRegistryWrapper :	public
// CALifeRegistryWrapperObject<CALifeRegistryWrapper<CEncyclopediaRegistry> >
// {};
class CGameNewsRegistryWrapper
    : public CALifeRegistryWrapperObject<
          CALifeRegistryWrapper< CGameNewsRegistry > > {};

class CInfoPortionWrapper
    : public CALifeRegistryWrapperObject<
          CALifeRegistryWrapper< CInfoPortionRegistry > > {};

class CRelationRegistryWrapper
    : public CALifeRegistryWrapperObject<
          CALifeRegistryWrapper< CRelationRegistry > > {};

class CMapLocationWrapper
    : public CALifeRegistryWrapperObject<
          CALifeRegistryWrapper< CMapLocationRegistry > > {};

class CGameTaskWrapper : public CALifeRegistryWrapperObject<
