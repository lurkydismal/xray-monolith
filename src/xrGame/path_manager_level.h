...
template < typename _DataStorage,
           typename _dist_type,
           typename _index_type,
           typename _iteration_type >
class CPathManager< CLevelGraph,
                    _DataStorage,
...
protected:
    ...
    typedef SBaseParameters< _dist_type, _index_type, _iteration_type >
        _Parameters;
    typedef typename CPathManagerGeneric< _Graph,
                                          _DataStorage,
                                          _Parameters,
                                          _dist_type,
                                          _index_type,
...
public:
    ...
    IC void setup( const _Graph* graph,
    ...
    IC void init();
    IC _dist_type evaluate( const _index_type& node_index1,
    ...
    IC void begin( const _index_type& vertex_id,
