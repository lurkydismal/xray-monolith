...
protected:
    ...
    void select_queue_params( const float& distance,
                              u32& min_queue_size,
                              u32& max_queue_size,
    ...
    void play_panic_sound( u32 max_start_time = 0,
                           u32 min_start_time = 0,
                           u32 max_stop_time = 0,
                           u32 min_stop_time = 0,
                           u32 id = u32( -1 ) );
    void play_attack_sound( u32 max_start_time = 0,
                            u32 min_start_time = 0,
                            u32 max_stop_time = 0,
                            u32 min_stop_time = 0,
                            u32 id = u32( -1 ) );
    void play_start_search_sound( u32 max_start_time = 0,
                                  u32 min_start_time = 0,
                                  u32 max_stop_time = 0,
                                  u32 min_stop_time = 0,
                                  u32 id = u32( -1 ) );
    void play_enemy_lost_sound( u32 max_start_time = 0,
                                u32 min_start_time = 0,
                                u32 max_stop_time = 0,
                                u32 min_stop_time = 0,
                                u32 id = u32( -1 ) );
