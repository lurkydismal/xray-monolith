...
_keyboard keyboards[] = {
	...
	// RavenAscendant: additional 100 entries, will let the bind console command bind actions to values that won't get triggered by keyboard input
	// but can be triggered from the level.press_action functions
	{"kCUSTOM0", 1000},
	{"kCUSTOM1", 1001},
	{"kCUSTOM2", 1002},
	{"kCUSTOM3", 1003},
