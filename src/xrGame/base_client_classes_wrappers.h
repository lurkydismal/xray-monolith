...
() {}; virtual	void			spatial_register ()
        ...
        static	void			spatial_register_static		(base
*self)
        {
        ...
        static	void			spatial_unregister_static	(base
*self)
        {
        ...
        static	void			spatial_move_static
(base *self)
        {
        ...
        static	Fvector			spatial_sector_point_static	(base
*self)
        {
        ...
        static	CObject*		dcast_CObject_static		(base
*self)
        {
...
public:
    ...
    virtual float shedule_Scale() override { return 1.f; }
...
// typedef ISheduledWrapper<CObjectDLL_Pure> CObjectISheduled; typedef
// IRenderableWrapper<CObjectISheduled>		CObjectIRenderable;
...
///**
//	virtual BOOL			Ready				();
//	virtual CObject*		H_SetParent (CObject* O); 	virtual void
//Center				(Fvector& C) const; 	virtual float
//Radius				() const; 	virtual const Fbox&
//BoundingBox			() const; 	virtual void			Load
//(LPCSTR section); 	virtual void			UpdateCL
//(); 	virtual BOOL			net_Spawn
//(CSE_Abstract* data); 	virtual void			net_Destroy
//(); 	virtual void			net_Export
//(NET_Packet& P); 	virtual void			net_Import
//(NET_Packet& P); 	virtual	void			net_ImportInput
//(NET_Packet& P); 	virtual BOOL			net_Relevant		();
//	virtual void			net_MigrateInactive	(NET_Packet& P);
//	virtual void			net_MigrateActive	(NET_Packet& P);
//	virtual void			net_Relcase (CObject* O); 	virtual
//SavedPosition	ps_Element			(u32 ID) const; 	virtual void
//ForceTransform		(const Fmatrix& m); 	virtual void
//OnHUDDraw			(CCustomHUD* hud); 	virtual void
//OnH_B_Chield		(); 	virtual void
//OnH_B_Independent	(bool just_before_destroy); 	virtual void
//OnH_A_Chield		(); 	virtual void OnH_A_Independent	();
///**/
//};
...
// typedef ISpatialWrapper<CGameObjectDLL_Pure>
// CGameObjectISpatial;
...
using CIRenderableWrapper =
    IRenderableWrapper< IRenderable, luabind::wrap_base >;
...
public:
    ...
    virtual void HitSignal( float P,
                            ...
                            CObject* who,
                            s16 element ) {
        ::luabind::call_member< void >( this, "HitSignal", P, local_dir, who,
                                        element );
    }

    static void HitSignal_static( CEntity* self,
                                  float P,
                                  Fvector& local_dir,
                                  CObject* who,
                                  s16 element ) {
        ai().script_engine().script_log(
            ...
            "You are trying to call a pure virtual function "
            "CEntity::HitSignal!" );
    }

    virtual void HitImpulse( float P, Fvector& vWorldDir, Fvector& vLocalDir ) {
        ::luabind::call_member< void >( this, "HitImpulse", P, vWorldDir,
                                        vLocalDir );
    }

    static void HitImpulse_static( float P,
                                   Fvector& vWorldDir,
                                   Fvector& vLocalDir ) {
        ai().script_engine().script_log(
            eLuaMessageTypeError,
