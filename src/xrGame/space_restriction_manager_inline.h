...
#ifdef DEBUG
IC const CSpaceRestrictionManager::SPACE_RESTRICTIONS&
CSpaceRestrictionManager::restrictions() const {
    return ( m_space_restrictions );
}
#endif

template < typename T1, typename T2 >
IC void CSpaceRestrictionManager::add_border( ALife::_OBJECT_ID id,
                                              T1 p1,
                                              T2 p2 ) {
