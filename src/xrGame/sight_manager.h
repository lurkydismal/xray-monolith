...
class CSightManager
    : public CSetupManager< CSightControlAction, CAI_Stalker, u32 > {
public:
...
private:
    bool aim_target( Fvector& my_position,
                     Fvector& aim_target,
...
public:
    ...
    void SetPointLookAngles( const Fvector& tPosition,
                             float& yaw,
                             float& pitch,
                             Fvector const& look_position,
                             const CGameObject* object = 0 );
    void SetFirePointLookAngles( const Fvector& tPosition,
                                 float& yaw,
                                 float& pitch,
                                 Fvector const& look_position,
                                 const CGameObject* object = 0 );
    void SetDirectionLook();
    void SetLessCoverLook( const LevelGraph::CVertex* tpNode,
...
public:
    IC void bone_aiming();
    IC void bone_aiming( shared_str const& animation_id,
