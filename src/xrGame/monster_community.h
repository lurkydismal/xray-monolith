...
struct MONSTER_COMMUNITY_DATA {
    MONSTER_COMMUNITY_DATA( MONSTER_COMMUNITY_INDEX,
...
class MONSTER_COMMUNITY : public CIni_IdToIndex< 1,
                                                 MONSTER_COMMUNITY_DATA,
                                                 MONSTER_COMMUNITY_ID,
                                                 MONSTER_COMMUNITY_INDEX,
                                                 MONSTER_COMMUNITY > {
private:
...
public:
    ...
    static int relation( MONSTER_COMMUNITY_INDEX from,
                         MONSTER_COMMUNITY_INDEX to );
