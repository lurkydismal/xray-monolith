...
protected:
    virtual void evaluate_smart_cover( smart_cover::cover const* smart_cover,
                                       float const& weight ) = 0;
    virtual void evaluate_cover( const CCoverPoint* cover_point,
                                 float weight ) = 0;
...
public:
    ...
    IC void initialize( const Fvector& start_position, bool fake_call = false );
    IC void setup( const Fvector& enemy_position,
...
public:
    ...
    void setup( const Fvector& my_position,
