...
public:
    ...
    virtual CInventoryItem* can_make_killing(
...
public:
    ...
    float interpolate_states( net_update_IItem const& first,
...
protected:
    ...
    template < typename T >
    IC static bool process_if_exists( LPCSTR section,
                                      LPCSTR name,
                                      T ( CInifile::*method )( LPCSTR, LPCSTR )
                                          const,
                                      T& value,
                                      bool test );

    template < typename T >
    IC static bool process_if_exists_set( LPCSTR section,
                                          LPCSTR name,
                                          T ( CInifile::*method )( LPCSTR,
                                                                   LPCSTR )
                                              const,
                                          T& value,
                                          bool test );

    void net_Export_PH_Params( NET_Packet& P,
                               SPHNetState& State,
                               mask_inv_num_items& num_items );
    void net_Import_PH_Params( NET_Packet& P,
                               net_update_IItem& N,
                               mask_inv_num_items& num_items );
