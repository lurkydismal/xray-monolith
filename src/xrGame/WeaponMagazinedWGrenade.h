...
public:
    ...
    IC int GetAmmoElapsed2() const { return iAmmoElapsed2; }

    IC int GetAmmoMagSize2() const { return iMagazineSize2; }

    IC bool GetGrenadeLauncherMode() const { return m_bGrenadeMode; }
