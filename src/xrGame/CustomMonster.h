...
public:
    ...
    virtual void g_WeaponBones( int& /**L/**/,
                                int& /**R1/**/,
                                int& /**R2/**/ ) {};
...
public:
    ...
    virtual float evaluate( const CEnemyManager* manager,
                            const CEntityAlive* object ) const;
    virtual bool useful( const CDangerManager* manager,
                         const CDangerObject& object ) const;
    virtual float evaluate( const CDangerManager* manager,
                            const CDangerObject& object ) const;
