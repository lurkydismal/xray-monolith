...
struct SGrenadeContact {
    ...
    bool contact; /* Set true on grenade contact callback, used for
                     ContactUpdateCL. */
...
public:
    ...
    virtual bool
    DropGrenade(); // in this case if grenade state is eReady, it should Throw
...
public:
    ...
    void Contact( const Fvector& pos,
                  const Fvector& vel,
                  const Fvector& nor,
                  const LPCSTR mtl );
    void ContactUpdateCL();
    static void GrenadeContactCallback( bool& do_colide,
                                        bool bo1,
                                        dContact& c,
                                        SGameMtl* mtl_1,
                                        SGameMtl* mtl_2 );
