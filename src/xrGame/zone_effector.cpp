...
void CZoneEffector::Activate() {
    ...
    m_pp_effector->SetFactorFunc(
        GET_KOEFF_FUNC( this, &CZoneEffector::GetFactor ) );
...
void CZoneEffector::Stop() {
    ...
    m_pActor->Cameras().RemovePPEffector(
        EEffectorPPType( u32( u64( this ) & u32( -1 ) ) ) );
    m_pp_effector = NULL;
    m_pActor = NULL;
};
