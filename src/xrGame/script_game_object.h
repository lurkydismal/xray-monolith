...
typedef CActionPlanner< CScriptGameObject,
                        false,
...
public:
    ...
    IC bool is_valid() const {
        ...
        // Check lua game object pointer back-reference. If it doesn't point to
        // this, then the object was likely deleted and the pointer is now
        // dangling.
        if ( m_game_object->lua_game_object() != this )
            return false;
    ...
    void Kill( CScriptGameObject* who,
               bool bypass_actor_check =
                   false /*AVO: added for actor before death callback*/ );
    ...
    void SetActorPosition(
        Fvector pos,
        bool bskip_collision_correct = false,
        bool bkeep_speed = false ); // momopate: allow movespeed to be kept if
    ...
    void SetMovementSpeed(
        Fvector vel ); // momopate: db.actor:set_movement_speed(vector vel)
    ...
    void bloodsucker_drag_jump( CScriptGameObject* e,
                                LPCSTR e_str,
    ...
    void set_home( LPCSTR name,
                   float r_min,
                   float r_max,
                   bool aggressive,
                   float r_mid );
    void set_home( u32 lv_ID,
                   float r_min,
                   float r_max,
                   bool aggressive,
                   float r_mid );
    ...
    void GiveGameNews( LPCSTR caption,
                       LPCSTR news,
                       LPCSTR texture_name,
                       int delay,
                       int show_time );
    ...
    void AddIconedTalkMessage_old( LPCSTR text,
                                   LPCSTR texture_name,
                                   LPCSTR templ_name ) {};
    void AddIconedTalkMessage( LPCSTR caption,
                               LPCSTR text,
                               LPCSTR texture_name,
                               LPCSTR templ_name );
    ...
    void GiveTaskToActor( CGameTask* t,
                          u32 dt,
                          bool bCheckExisting,
                          u32 t_timer );
    ...
    void IterateInventory( ::luabind::functor< bool > functor,
                           ::luabind::object object );
    void IterateRuck( ::luabind::functor< bool > functor,
                      ::luabind::object object );
    void IterateBelt( ::luabind::functor< bool > functor,
                      ::luabind::object object );
    void IterateInventoryBox( ::luabind::functor< bool > functor,
                              ::luabind::object object );
    ...
    void MoveItemToSlot( CScriptGameObject* pItem,
                         u16 slot_id,
                         bool doNotActivate );
    ...
    ///////////////////////////////////////////////////////////////////////////////////////////
    void set_fastcall( const ::luabind::functor< bool >& functor,
                       const ::luabind::object& object );
    ...
    u32 add_sound( LPCSTR prefix,
                   ...
                   LPCSTR bone_name,
                   LPCSTR head_anim );
    u32 add_combat_sound( LPCSTR prefix,
                          u32 max_count,
                          ESoundTypes type,
                          u32 priority,
                          u32 mask,
    ...
    void set_sight( SightManager::ESightType sight_type,
                    Fvector* vector3d,
                    u32 dwLookOverDelay );
    void set_sight( SightManager::ESightType sight_type,
                    bool torso_look,
    ...
    void set_sight( CScriptGameObject* object_to_look,
                    ...
                    bool fire_object,
                    bool no_pitch );
    void set_sight( const MemorySpace::CMemoryInfo* memory_object,
                    bool torso_look );
    ...
    void add_animation( LPCSTR animation,
                        bool hand_usage,
    ...
    const CCoverPoint* best_cover( const Fvector& position,
                                   const Fvector& enemy_position,
                                   float radius,
                                   float min_enemy_distance,
                                   float max_enemy_distance );
    const CCoverPoint* safe_cover( const Fvector& position,
                                   float radius,
                                   float min_distance );
    ...
    const xr_vector< MemorySpace::CVisibleObject >& memory_visible_objects()
        const;
    ...
    const xr_vector< MemorySpace::CNotYetVisibleObject >&
    not_yet_visible_objects() const;
    ...
    // Torch
    void set_color_animator( LPCSTR name,
                             bool bFlicker,
                             int flickerChance,
                             float flickerDelay,
                             int framerate );
    ...
    void set_max_ignore_monster_distance(
    ...
    void set_aim_params( float max_angle,
                         float min_angle,
                         float min_speed,
                         float predict_time );
    ...
    bool is_weapon_going_to_be_strapped(
    ...
    _DECLARE_FUNCTION14( cast_WeaponMagazinedWGrenade,
    ...
    // priler: returns true if a non-radioactive restrictor zone is currently
    // touching this character
    bool inside_anomaly();
    ...
    void set_bone_visible( u16 bone_id,
                           bool bVisibility,
                           bool bRecursive,
                           bool bHud );
    ...
    void set_bone_visible( LPCSTR bone_name,
                           bool bVisibility,
                           bool bRecursive ) {
        set_bone_visible( bone_id( bone_name ), bVisibility, bRecursive,
                          false );
    }
...
struct has_is_valid<
    T,
    std::void_t< decltype( std::declval< T >()->is_valid() ) > >
    : std::true_type {};
        ...
        if ( lua_busy_hands_debug ) {
            ...
            if ( instance != nullptr ) {
                if constexpr ( has_is_valid< InstanceT >::value )
                    ...
                    // The class does NOT have is_valid(), so being non-null is
                    // good enough
                    is_valid = true;
            }
...
#define SAFE_WRAP( func )                                             \
    static_cast< typename SafeWrap< decltype( func ), func >::type >( \
        SafeWrap< decltype( func ), func >::call )
