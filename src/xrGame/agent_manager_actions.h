...
public:
    CAgentManagerActionNoOrders( CAgentManager* object,
                                 LPCSTR action_name = "" );
...
public:
    CAgentManagerActionGatherItems( CAgentManager* object,
                                    LPCSTR action_name = "" );
};
...
public:
    CAgentManagerActionKillEnemy( CAgentManager* object,
                                  LPCSTR action_name = "" );
...
public:
    CAgentManagerActionReactOnDanger( CAgentManager* object,
                                      LPCSTR action_name = "" );
    virtual void initialize();
    virtual void execute();
};
