...
void CScriptMovementAction::script_register( lua_State* L ) {
    module( L )
        [ class_< CScriptMovementAction >( "move" )
              ...
              .enum_( "path" )
                  [ value( "line",
                           int( DetailPathManager::eDetailPathTypeSmooth ) ),
                    value(
                        "dodge",
                        int( DetailPathManager::eDetailPathTypeSmoothDodge ) ),
                    value( "criteria",
                           int( DetailPathManager::
                                    eDetailPathTypeSmoothCriteria ) ),
                    value( "curve",
                           int( DetailPathManager::eDetailPathTypeSmooth ) ),
                    value( "curve_criteria",
                           int( DetailPathManager::
                                    eDetailPathTypeSmoothCriteria ) ) ]
              .enum_( "input" )
                  [ value( "none",
                           int( CScriptMovementAction::eInputKeyNone ) ),
                    value( "fwd",
                           int( CScriptMovementAction::eInputKeyForward ) ),
                    value( "back",
                           int( CScriptMovementAction::eInputKeyBack ) ),
                    value( "left",
                           int( CScriptMovementAction::eInputKeyLeft ) ),
                    value( "right",
                           int( CScriptMovementAction::eInputKeyRight ) ),
                    value( "up",
                           int( CScriptMovementAction::eInputKeyShiftUp ) ),
                    value( "down",
                           int( CScriptMovementAction::eInputKeyShiftDown ) ),
                    value( "handbrake",
                           int( CScriptMovementAction::eInputKeyBreaks ) ),
                    value( "on",
                           int( CScriptMovementAction::eInputKeyEngineOn ) ),
                    value( "off",
                           int( CScriptMovementAction::eInputKeyEngineOff ) ) ]
              .enum_( "monster" )[
                  ...
                  value( "walk_with_leader",
                         int( MonsterSpace::eMA_WalkWithLeader ) ),
                  value( "run_with_leader",
                         int( MonsterSpace::eMA_RunWithLeader ) ) ]
              ...
              .def( constructor< const CScriptMovementAction::EInputKeys,
                                 float >() )
              .def( constructor<
                    MonsterSpace::EBodyState, MonsterSpace::EMovementType,
                    DetailPathManager::EDetailPathType, CScriptGameObject* >() )
              .def( constructor< MonsterSpace::EBodyState,
              ...
              // Monsters
              .def( constructor< MonsterSpace::EScriptMonsterMoveAction,
                                 Fvector* >() )
              .def( constructor< MonsterSpace::EScriptMonsterMoveAction,
                                 CPatrolPathParams* >() )
              .def( constructor< MonsterSpace::EScriptMonsterMoveAction,
              ...
              .def( constructor< MonsterSpace::EScriptMonsterMoveAction,
                                 Fvector*, float >() )
              .def( constructor< MonsterSpace::EScriptMonsterMoveAction, u32,
                                 Fvector* >() )
              .def( constructor< MonsterSpace::EScriptMonsterMoveAction, u32,
                                 Fvector*, float >() )
              .def( constructor< MonsterSpace::EScriptMonsterMoveAction,
              ...
              .def( "completed", ( bool ( CScriptMovementAction::* )() )(
                                     &CScriptMovementAction::completed ) ) ];
}
