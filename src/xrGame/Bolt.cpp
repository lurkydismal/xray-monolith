...
void CBolt::PutNextToSlot() {
    ...
    if ( smart_cast< CInventoryOwner* >( H_Parent() ) && m_pInventory ) {
        ...
        if ( !pNext )
            pNext = smart_cast< CBolt* >(
                m_pInventory->SameSlot( BOLT_SLOT, this, true ) );
        ...
        if ( pNext ) {
            ...
            if ( ai().script_engine().functor( "_g.CMissile__PutNextToSlot",
                ...
                if ( !obj || !smart_cast< CBolt* >( &obj->object() ) )
                    return;
        ...
        case eThrowEnd: {
            if ( m_thrown ) {
                ...
                if ( m_pInventory &&
                     ...
                     ai().script_engine().functor( "_G.CBolt__State",
                                                   funct ) ) {
                    CActor* pActor =
