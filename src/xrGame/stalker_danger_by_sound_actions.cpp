...
CStalkerActionDangerBySoundListenTo::CStalkerActionDangerBySoundListenTo(
    CAI_Stalker* object,
    LPCSTR action_name )
...
CStalkerActionDangerBySoundCheck::CStalkerActionDangerBySoundCheck(
    CAI_Stalker* object,
    LPCSTR action_name )
    : inherited( object, action_name ) {}
...
CStalkerActionDangerBySoundTakeCover::CStalkerActionDangerBySoundTakeCover(
    CAI_Stalker* object,
    LPCSTR action_name )
    : inherited( object, action_name ) {}
...
CStalkerActionDangerBySoundLookOut::CStalkerActionDangerBySoundLookOut(
    CAI_Stalker* object,
    LPCSTR action_name )
    : inherited( object, action_name ) {}
...
CStalkerActionDangerBySoundLookAround::CStalkerActionDangerBySoundLookAround(
    CAI_Stalker* object,
    LPCSTR action_name )
    : inherited( object, action_name ) {}
