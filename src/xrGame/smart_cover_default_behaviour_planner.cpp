...
default_behaviour_planner::default_behaviour_planner( animation_planner* object,
                                                      LPCSTR action_name )
    : inherited( object, action_name ) {}

void default_behaviour_planner::setup( animation_planner* object,
...
void default_behaviour_planner::add_actions() {
    ...
    action = xr_new< target_provider >( &object(), "idle",
