...
void CActionBase< CScriptGameObject >::script_register( lua_State* L ) {
    module(
        L )[ class_< CScriptActionBase, CScriptActionWrapper >( "action_base" )
                 ...
                 .def( "add_precondition",
                       ( void ( CScriptActionBase::* )(
                           const CScriptActionBase::COperatorCondition& ) )(
                 ...
                 .def( "setup", &CScriptActionBase::setup,
                       &CScriptActionWrapper::setup_static )
                 .def( "initialize", &CScriptActionBase::initialize,
                       &CScriptActionWrapper::initialize_static )
                 .def( "execute", &CScriptActionBase::execute,
                       &CScriptActionWrapper::execute_static )
                 .def( "finalize", &CScriptActionBase::finalize,
                       &CScriptActionWrapper::finalize_static )
                 //			.def("weight",
                 //&CScriptActionBase::weight,
