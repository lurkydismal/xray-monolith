...
class CHARACTER_COMMUNITY : public CIni_IdToIndex< 1,
                                                   COMMUNITY_DATA,
                                                   CHARACTER_COMMUNITY_ID,
                                                   CHARACTER_COMMUNITY_INDEX,
                                                   CHARACTER_COMMUNITY > {
private:
    typedef CIni_IdToIndex< 1,
                            COMMUNITY_DATA,
                            CHARACTER_COMMUNITY_ID,
                            CHARACTER_COMMUNITY_INDEX,
                            CHARACTER_COMMUNITY >
...
public:
    ...
    static CHARACTER_GOODWILL relation( CHARACTER_COMMUNITY_INDEX from,
                                        CHARACTER_COMMUNITY_INDEX to );
    CHARACTER_GOODWILL relation( CHARACTER_COMMUNITY_INDEX to );

    static void set_relation( CHARACTER_COMMUNITY_INDEX from,
                              CHARACTER_COMMUNITY_INDEX to,
...
private:
    typedef CIni_Table< CHARACTER_GOODWILL, CHARACTER_COMMUNITY >
        GOODWILL_TABLE;
