...
private:
    void add_lines( Fvector const* vertices,
...
public:
    IC void draw_line( const Fmatrix& matrix,
                       const Fvector& vertex0,
                       const Fvector& vertex1,
                       const u32& color,
                       bool bHud );
    IC void draw_aabb( const Fvector& center,
    ...
    void draw_obb( const Fmatrix& matrix,
                   const Fvector& half_size,
                   const u32& color,
                   bool bHud );
