...
private:
    ...
    // gray_wolf>Переменные для поддержки изменяющегося трения у персонажей во
    // время смерти
    ...
    float m_Pred_Time; // Для вычисления дельта времени между пересчётами
                       // сопротивления в джоинтах и коэффициента NPC
    float m_time_delta;
