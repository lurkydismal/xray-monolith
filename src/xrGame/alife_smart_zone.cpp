...
CSE_ALifeItemWeapon* CSE_ALifeSmartZone::tpfGetBestWeapon(
...
ALife::EMeetActionType CSE_ALifeSmartZone::tfGetActionType(
    ...
    CSE_ALifeObject* object =
        smart_cast< CSE_ALifeObject* >( tpALifeSchedulable->base() );
    VERIFY( object );
    return ( ( object->m_tGraphID == m_tGraphID )
                 ? ALife::eMeetActionSmartTerrain
