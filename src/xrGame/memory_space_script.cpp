...
CScriptGameObject* not_yet_visible_object(
    const MemorySpace::CNotYetVisibleObject& object ) {
...
template < typename T >
CScriptGameObject* get_memory_object(
    const MemorySpace::CMemoryObject< T >& memory_object ) {
...
CScriptGameObject* CDangerObject_dependent_object( const CDangerObject* self ) {
    ...
    const CGameObject* game_object =
        smart_cast< const CGameObject* >( self->dependent_object() );
    ...
    module( L )[
        ...
        class_< MemorySpace::SObjectParams >( "object_params" )
            ...
            .def_readonly( "orientation",
                           &MemorySpace::SObjectParams::m_orientation )
#endif
            .def_readonly( "level_vertex",
                           &MemorySpace::SObjectParams::m_level_vertex_id )
            .def_readonly( "position",
                           &MemorySpace::SObjectParams::m_position ),

        class_< MemorySpace::SMemoryObject >( "memory_object" )
#ifdef USE_GAME_TIME
            .def_readonly( "game_time",
                           &MemorySpace::SMemoryObject::m_game_time )
#endif
#ifdef USE_LEVEL_TIME
            .def_readonly( "level_time",
                           &MemorySpace::SMemoryObject::m_level_time )
#endif
#ifdef USE_LAST_GAME_TIME
            .def_readonly( "last_game_time",
                           &MemorySpace::SMemoryObject::m_last_game_time )
#endif
#ifdef USE_LAST_LEVEL_TIME
            .def_readonly( "last_level_time",
                           &MemorySpace::SMemoryObject::m_last_level_time )
#endif
#ifdef USE_FIRST_GAME_TIME
            .def_readonly( "first_game_time",
                           &MemorySpace::SMemoryObject::m_first_game_time )
#endif
#ifdef USE_FIRST_LEVEL_TIME
            .def_readonly( "first_level_time",
                           &MemorySpace::SMemoryObject::m_first_level_time )
#endif
#ifdef USE_UPDATE_COUNT
            .def_readonly( "update_count",
                           &MemorySpace::SMemoryObject::m_update_count )
#endif
            ,

        class_< MemorySpace::CMemoryObject< CEntityAlive >,
                MemorySpace::SMemoryObject >( "entity_memory_object" )
            .def_readonly(
                "object_info",
                &MemorySpace::CMemoryObject< CEntityAlive >::m_object_params )
            .def_readonly(
                "self_info",
                &MemorySpace::CMemoryObject< CEntityAlive >::m_self_params )
            .def( "object", &get_memory_object< CEntityAlive > ),

        class_< MemorySpace::CMemoryObject< CGameObject >,
                MemorySpace::SMemoryObject >( "game_memory_object" )
            .def_readonly(
                "object_info",
                &MemorySpace::CMemoryObject< CGameObject >::m_object_params )
            .def_readonly(
                "self_info",
                &MemorySpace::CMemoryObject< CGameObject >::m_self_params )
            .def( "object", &get_memory_object< CGameObject > ),

        class_< MemorySpace::CHitObject,
                MemorySpace::CMemoryObject< CEntityAlive > >(
            "hit_memory_object" )
            .def_readonly( "direction", &MemorySpace::CHitObject::m_direction )
            .def_readonly( "bone_index",
                           &MemorySpace::CHitObject::m_bone_index )
            .def_readonly( "amount", &MemorySpace::CHitObject::m_amount ),

        class_< MemorySpace::CVisibleObject,
                MemorySpace::CMemoryObject< CGameObject > >(
            "visible_memory_object" )
        //			.def("visible",
        //&MemorySpace_CVisibleObject_visible)
        ,

        class_< MemorySpace::CMemoryInfo, MemorySpace::CVisibleObject >(
            "memory_info" )
            .def_readonly( "visual_info",
                           &MemorySpace::CMemoryInfo::m_visual_info )
            .def_readonly( "sound_info",
                           &MemorySpace::CMemoryInfo::m_sound_info )
            .def_readonly( "hit_info", &MemorySpace::CMemoryInfo::m_hit_info ),

        class_< MemorySpace::CSoundObject,
                MemorySpace::CMemoryObject< CGameObject > >(
            "sound_memory_object" )
        ...
        class_< MemorySpace::CNotYetVisibleObject >( "not_yet_visible_object" )
            .def_readonly( "value",
                           &MemorySpace::CNotYetVisibleObject::m_value )
            .def( "object", &not_yet_visible_object ),

        class_< CDangerObject >( "danger_object" )
            .enum_( "danger_type" )
                [ value( "bullet_ricochet",
                         CDangerObject::eDangerTypeBulletRicochet ),
                  value( "attack_sound",
                         CDangerObject::eDangerTypeAttackSound ),
                  value( "entity_attacked",
                         CDangerObject::eDangerTypeEntityAttacked ),
                  value( "entity_death",
                         CDangerObject::eDangerTypeEntityDeath ),
                  value( "entity_corpse",
