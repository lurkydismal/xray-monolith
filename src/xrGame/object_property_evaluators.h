...
typedef CObjectPropertyEvaluatorBase< CGameObject >
    CSObjectPropertyEvaluatorBase;
...
class CObjectPropertyEvaluatorState
    : public CObjectPropertyEvaluatorBase< CWeapon > {
protected:
...
public:
    CObjectPropertyEvaluatorState( CWeapon* item,
                                   CAI_Stalker* owner,
                                   u32 state,
                                   bool equality = true );
...
class CObjectPropertyEvaluatorWeaponHidden
    : public CObjectPropertyEvaluatorBase< CWeapon > {
protected:
    typedef CObjectPropertyEvaluatorBase< CWeapon > inherited;
...
class CObjectPropertyEvaluatorAmmo
    : public CObjectPropertyEvaluatorBase< CWeapon > {
protected:
    typedef CObjectPropertyEvaluatorBase< CWeapon > inherited;
    u32 m_ammo_type;
...
public:
    CObjectPropertyEvaluatorAmmo( CWeapon* item,
                                  CAI_Stalker* owner,
                                  u32 ammo_type );
    virtual _value_type evaluate();
};
...
class CObjectPropertyEvaluatorEmpty
    : public CObjectPropertyEvaluatorBase< CWeapon > {
protected:
    typedef CObjectPropertyEvaluatorBase< CWeapon > inherited;
    u32 m_ammo_type;
...
public:
    CObjectPropertyEvaluatorEmpty( CWeapon* item,
                                   CAI_Stalker* owner,
                                   u32 ammo_type );
    virtual _value_type evaluate();
};
...
class CObjectPropertyEvaluatorFull
    : public CObjectPropertyEvaluatorBase< CWeapon > {
protected:
    typedef CObjectPropertyEvaluatorBase< CWeapon > inherited;
    u32 m_ammo_type;
...
public:
    CObjectPropertyEvaluatorFull( CWeapon* item,
                                  CAI_Stalker* owner,
                                  u32 ammo_type );
    virtual _value_type evaluate();
};
...
class CObjectPropertyEvaluatorReady
    : public CObjectPropertyEvaluatorBase< CWeapon > {
protected:
    typedef CObjectPropertyEvaluatorBase< CWeapon > inherited;
    u32 m_ammo_type;
...
public:
    CObjectPropertyEvaluatorReady( CWeapon* item,
                                   CAI_Stalker* owner,
                                   u32 ammo_type );
    virtual _value_type evaluate();
};
...
class CObjectPropertyEvaluatorQueue
    : public CObjectPropertyEvaluatorBase< CWeapon > {
protected:
    typedef CObjectPropertyEvaluatorBase< CWeapon > inherited;
...
public:
    CObjectPropertyEvaluatorQueue( CWeapon* item,
                                   CAI_Stalker* owner,
                                   u32 type );
    virtual _value_type evaluate();
};
...
class CObjectPropertyEvaluatorNoItems
    : public CPropertyEvaluator< CAI_Stalker > {
protected:
    typedef CPropertyEvaluator< CAI_Stalker > inherited;
...
class CObjectPropertyEvaluatorMissile
    : public CObjectPropertyEvaluatorBase< CMissile > {
protected:
...
public:
    CObjectPropertyEvaluatorMissile( CMissile* item,
                                     CAI_Stalker* owner,
                                     u32 state,
                                     bool equality = true );
    virtual _value_type evaluate();
...
class CObjectPropertyEvaluatorMissileStarted
    : public CObjectPropertyEvaluatorBase< CMissile > {
protected:
    typedef CObjectPropertyEvaluatorBase< CMissile > inherited;
    u32 m_state;
...
public:
    CObjectPropertyEvaluatorMissileStarted( CMissile* item,
                                            CAI_Stalker* owner );
    virtual _value_type evaluate();
};
...
class CObjectPropertyEvaluatorMissileHidden
    : public CObjectPropertyEvaluatorBase< CMissile > {
protected:
    typedef CObjectPropertyEvaluatorBase< CMissile > inherited;
    u32 m_state;
