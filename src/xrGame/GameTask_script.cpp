...
void CGameTask::script_register( lua_State* L ) {
    module(
        L )[ class_< enum_exporter< ETaskState > >( "task" )
                 .enum_( "task_state" )
             ...
             class_< CGameTask >( "CGameTask" )
                 ...
                 .def( "add_on_complete_info",
                       &CGameTask::AddOnCompleteInfo_script )
                 ...
                 .def( "add_on_complete_func",
                       &CGameTask::AddOnCompleteFunc_script )
