...
void static_obstacles_avoider::query( const Fvector& start_position,
...
bool static_obstacles_avoider::process_query( const bool& change_path_state ) {
    ...
    bool active_query_actual =
        change_path_state ? ( m_active_query == m_inactive_query ) : true;
