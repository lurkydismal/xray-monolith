...
void __stdcall PLC_calc3_x86( int& c0,
                              int& c1,
                              int& c2,
...
__forceinline float PLC_energy_SSE( Fvector& P,
                                    Fvector& N,
                                    light* L,
                                    float E ) {
    Fvector Ldir;
...
void __stdcall PLC_calc3_SSE( int& c0,
                              int& c1,
                              int& c2,
                              CRenderDevice& Device,
                              Fvector* P,
