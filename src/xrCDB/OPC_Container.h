...
public:
     ...
     * automatically resized if needed. The method is inline, not the resize.
     * The call overhead happens on resizes only, which is not a problem since
     ...
     * so that further calls don't need resizing again. That's a kind of
     * temporal coherence.
     *	\see		Empty()
     */
    ///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
...
private:
    ...
    float mGrowthFactor;  //!< Resize: _new_ number of entries = old number *
                          //!< mGrowthFactor
};
