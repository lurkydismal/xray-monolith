 ...
 *	- original code by Ville Miettinen, from Umbra/dPVS (released on the
 * GD-Algorithms mailing list)
 *	- almost used "as-is", I even left the comments (hence the
 * frustum-related notes)
 *
...
inline_ BOOL PlanesCollider::PlanesAABBOverlap( const Point& center,
    ...
    out_clip_mask =
        TmpOutClipMask; // copy output value (temp used to resolve aliasing!)
