...
public:
     ...
     */
    ///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    inline_ void SetPointers0( const IndexedTriangle* faces,
                               const Point* verts ) {
        mFaces0 = faces;
        mVerts0 = verts;
    }
     ...
     */
    ///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    inline_ void SetPointers1( const IndexedTriangle* faces,
                               const Point* verts ) {
        mFaces1 = faces;
        mVerts1 = verts;
    }
...
protected:
    ...
    bool mFullBoxBoxTest; //!< Perform full BV-BV tests (true) or SAT-lite tests
                          //!< (false)
    bool mFullPrimBoxTest; //!< Perform full Primitive-BV tests (true) or
                           //!< SAT-lite tests (false)
    // Internal methods
    ...
    void _Collide( const AABBQuantizedNoLeafNode* a,
    ...
    inline_ BOOL BoxBoxOverlap( const Point& ea,
                                const Point& ca,
                                const Point& eb,
                                const Point& cb );
    ...
    inline_ BOOL TriTriOverlap( const Point& V0,
                                ...
                                const Point& U2 );
    // Init methods
    void InitQuery( const Matrix4x4* world0 = null,
                    const Matrix4x4* world1 = null );
