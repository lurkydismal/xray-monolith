...
//////////////////////////////////////////////////////////////////////////
// Comment:
//		ordinal objects			- renderable?, collideable?,
...
class XRCDB_API ISpatial : public intrusive_base_strict {
...
public:
    virtual void spatial_create( ISpatial_DB* db,
                                 ISpatialOwner* owner,
                                 u32 type ) {
...
public:
    ...
    BOOL _empty() {
        return items.empty() &&
               ( 0 == ( ptrt( children[ 0 ] ) | ptrt( children[ 1 ] ) |
...
public:
    ...
    // query
    void q_ray( xr_vector< ISpatialShared >& R,
                u32 _o,
                u32 _mask_and,
                const Fvector& _start,
                const Fvector& _dir,
                float _range );
    void q_box( xr_vector< ISpatialShared >& R,
                u32 _o,
                u32 _mask_or,
                const Fvector& _center,
                const Fvector& _size );
    void q_sphere( xr_vector< ISpatialShared >& R,
                   u32 _o,
                   u32 _mask_or,
                   const Fvector& _center,
                   const float _radius );
    void q_frustum( xr_vector< ISpatialShared >& R,
                    u32 _o,
                    u32 _mask_or,
