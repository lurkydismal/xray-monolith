 ...
 *	\param		triangle_index	[in] face index for which the system is
 * requesting the vertices
 *	\param		triangle		[out] triangle's vertices (must
 * be provided by the user)
 *	\param		user_data		[in] user-defined data from
 * SetCallback()
 */
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
typedef void ( *OPC_CALLBACK )( udword triangle_index,
...
inline_ void TransformPoint( Point& dest,
                             ...
                             const Matrix3x3& rot,
                             const Point& trans ) {
    dest.x = trans.x + source.x * rot.m[ 0 ][ 0 ] + source.y * rot.m[ 1 ][ 0 ] +
             source.z * rot.m[ 2 ][ 0 ];
    dest.y = trans.y + source.x * rot.m[ 0 ][ 1 ] + source.y * rot.m[ 1 ][ 1 ] +
             source.z * rot.m[ 2 ][ 1 ];
    dest.z = trans.z + source.x * rot.m[ 0 ][ 2 ] + source.y * rot.m[ 1 ][ 2 ] +
             source.z * rot.m[ 2 ][ 2 ];
}
