...
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
/**
 *	A global function to invert a PR matrix. (which only contains a rotation
 * and a translation)
 *	\relates	Matrix4x4
 *	\fn			InvertPRMatrix(Matrix4x4& dest, const Matrix4x4&
 * src)
...
ICEMATHS_API void IceMaths::InvertPRMatrix( Matrix4x4& dest,
    ...
    dest.m[ 3 ][ 0 ] = -( src.m[ 3 ][ 0 ] * src.m[ 0 ][ 0 ] +
                          src.m[ 3 ][ 1 ] * src.m[ 0 ][ 1 ] +
                          src.m[ 3 ][ 2 ] * src.m[ 0 ][ 2 ] );
    ...
    dest.m[ 3 ][ 1 ] = -( src.m[ 3 ][ 0 ] * src.m[ 1 ][ 0 ] +
                          src.m[ 3 ][ 1 ] * src.m[ 1 ][ 1 ] +
                          src.m[ 3 ][ 2 ] * src.m[ 1 ][ 2 ] );
    ...
    dest.m[ 3 ][ 2 ] = -( src.m[ 3 ][ 0 ] * src.m[ 2 ][ 0 ] +
                          src.m[ 3 ][ 1 ] * src.m[ 2 ][ 1 ] +
                          src.m[ 3 ][ 2 ] * src.m[ 2 ][ 2 ] );
...
float Matrix4x4::Determinant() const {
    return m[ 0 ][ 0 ] * CoFactor( 0, 0 ) + m[ 0 ][ 1 ] * CoFactor( 0, 1 ) +
 ...
 *	\param		p0			[in] first point on the
 * projection plane.
 *	\param		p1			[in] second point on the
 * projection plane.
 *	\param		p2			[in] third point on the
 * projection plane.
 *	\return		Self-Reference
 */
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
Matrix4x4& Matrix4x4::Shadow( const Point& light,
                              const Point& p0,
                              const Point& p1,
                              const Point& p2 ) {
    ...
    float dot = PlaneEquation.n.x * light.x + PlaneEquation.n.y * light.y +
                PlaneEquation.n.z * light.z + PlaneEquation.d;
 ...
 */
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
Matrix4x4& Matrix4x4::Rotozoom( float angle,
                                float zoom,
                                float posx,
                                float posy ) {
    RotZ( angle );
...
Matrix::operator PRS() const {
    ...
    if ( IsIdentity() ) { // The special case of the identity matrix
        ...
        // Build the final PRS
        Cast.SetQuaternion( ( Quat )Orthonormal )
            .SetPosition( *GetRow( 3 ) )
            .SetScale( Scale );
    }
