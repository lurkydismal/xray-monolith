...
public:
    ...
    IC ERP_Result Pick2( const Tvector& origin,
                         const Tvector& dir,
                         Tvector& coord ) {
        BOOL Inside = TRUE;
        Tvector MaxT;
        ...
        // Find candidate planes.
        {
            if ( origin[ 0 ] < min[ 0 ] ) {
                ...
                if ( IR( dir[ 0 ] ) )
                    MaxT[ 0 ] =
                        ( min[ 0 ] - origin[ 0 ] ) /
                        dir[ 0 ]; // Calculate T distances to candidate planes
        ...
        }
        {
            if ( origin[ 1 ] < min[ 1 ] ) {
                ...
                if ( IR( dir[ 1 ] ) )
                    MaxT[ 1 ] =
                        ( min[ 1 ] - origin[ 1 ] ) /
                        dir[ 1 ]; // Calculate T distances to candidate planes
        ...
        }
        {
            if ( origin[ 2 ] < min[ 2 ] ) {
                ...
                if ( IR( dir[ 2 ] ) )
                    MaxT[ 2 ] =
                        ( min[ 2 ] - origin[ 2 ] ) /
                        dir[ 2 ]; // Calculate T distances to candidate planes
