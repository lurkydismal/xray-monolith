...
XRCORE_API LPCSTR _GetItem( LPCSTR src,
                            int,
                            AnsiString& p,
                            char separator = ',',
                            LPCSTR = "",
                            bool trim = true );
XRCORE_API LPCSTR _GetItems( LPCSTR src,
                             int idx_start,
                             int idx_end,
                             AnsiString& dst,
                             char separator );
...
XRCORE_API void _SequenceToList( AStringVec& lst,
                                 LPCSTR in,
                                 char separator = ',' );
XRCORE_API AnsiString& _ReplaceItem( LPCSTR src,
                                     int index,
                                     LPCSTR new_item,
                                     AnsiString& dst,
                                     char separator );
XRCORE_API AnsiString& _ReplaceItems( LPCSTR src,
                                      int idx_start,
                                      int idx_end,
                                      LPCSTR new_items,
                                      AnsiString& dst,
...
XRCORE_API LPSTR _GetItem( LPCSTR,
                           int,
                           LPSTR,
                           u32 const dst_size,
                           char separator = ',',
...
template < int count >
inline LPSTR _GetItem( LPCSTR src,
                       int index,
                       char ( &dst )[ count ],
                       char separator = ',',
                       LPCSTR def = "",
...
XRCORE_API LPCSTR _CopyVal( LPCSTR src,
                            LPSTR dst,
                            u32 const dst_size,
                            char separator = ',' );
...
XRCORE_API LPSTR _ReplaceItem( LPCSTR src,
                               int index,
                               LPCSTR new_item,
                               LPSTR dst,
                               char separator );
XRCORE_API LPSTR _ReplaceItems( LPCSTR src,
                                int idx_start,
                                int idx_end,
                                LPCSTR new_items,
                                LPSTR dst,
                                char separator );
XRCORE_API void _SequenceToList( LPSTRVec& lst,
                                 LPCSTR in,
                                 char separator = ',' );
XRCORE_API void _SequenceToList( RStringVec& lst,
                                 LPCSTR in,
                                 char separator = ',' );
XRCORE_API void _SequenceToList( SStringVec& lst,
                                 LPCSTR in,
                                 char separator = ',' );
