...
public:
    ...
    ICF SelfRef build( const _vector3< T >& v1,
                       const _vector3< T >& v2,
                       const _vector3< T >& v3 ) {
        _vector3< T > t1, t2;
    ...
    ICF SelfRef build_precise( const _vector3< T >& v1,
                               const _vector3< T >& v2,
                               const _vector3< T >& v3 ) {
        _vector3< T > t1, t2;
    ...
    ICF SelfRef build_unit_normal( const _vector3< T >& _p,
                                   const _vector3< T >& _n ) {
    ...
    IC SelfCRef project( _vector3< T >& pdest,
                         _vector3< T > const& psrc ) const {
    ...
    IC BOOL intersectRayDist( const _vector3< T >& P,
                              const _vector3< T >& D,
                              T& dist ) {
        T numer = classify( P );
        ...
        if ( _abs( denom ) <
             EPS_S ) // normal is orthogonal to vector3, cant intersect
            return FALSE;
    ...
    ICF BOOL intersectRayPoint( const _vector3< T >& P,
                                const _vector3< T >& D,
                                _vector3< T >& dest ) {
        T numer = classify( P );
        T denom = n.dotproduct( D );
