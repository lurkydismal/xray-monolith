...
typedef int( __LZO_ENTRY* lzo_decompress_t )( const lzo_byte* src,
                                              lzo_uint src_len,
                                              lzo_byte* dst,
                                              lzo_uintp dst_len,
                                              lzo_voidp wrkmem );

typedef int( __LZO_ENTRY* lzo_optimize_t )( lzo_byte* src,
                                            lzo_uint src_len,
                                            lzo_byte* dst,
                                            lzo_uintp dst_len,
                                            lzo_voidp wrkmem );

typedef int( __LZO_ENTRY* lzo_compress_dict_t )( const lzo_byte* src,
                                                 lzo_uint src_len,
                                                 lzo_byte* dst,
                                                 lzo_uintp dst_len,
                                                 lzo_voidp wrkmem,
...
typedef int( __LZO_ENTRY* lzo_decompress_dict_t )( const lzo_byte* src,
                                                   lzo_uint src_len,
                                                   lzo_byte* dst,
                                                   lzo_uintp dst_len,
                                                   lzo_voidp wrkmem,
...
typedef int( __LZO_CDECL* lzo_compress_asm_t )( const lzo_byte* src,
                                                lzo_uint src_len,
                                                lzo_byte* dst,
                                                lzo_uintp dst_len,
                                                lzo_voidp wrkmem );

typedef int( __LZO_CDECL* lzo_decompress_asm_t )( const lzo_byte* src,
                                                  lzo_uint src_len,
                                                  lzo_byte* dst,
                                                  lzo_uintp dst_len,
                                                  lzo_voidp wrkmem );
...
#define lzo_init()                                                          \
    __lzo_init2( LZO_VERSION, ( int )sizeof( short ), ( int )sizeof( int ), \
                 ( int )sizeof( long ), ( int )sizeof( lzo_uint32 ),        \
                 ( int )sizeof( lzo_uint ), ( int )lzo_sizeof_dict_t,       \
                 ( int )sizeof( char* ), ( int )sizeof( lzo_voidp ),        \
...
#define LZO_PTR_ALIGN_UP( _ptr, _size )                                    \
    ( ( _ptr ) + ( lzo_uint )__lzo_align_gap( ( const lzo_voidp )( _ptr ), \
                                              ( lzo_uint )( _size ) ) )
