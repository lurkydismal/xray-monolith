...
public:
    ...
    // SQ magnitude
    IC T magnitude_sqr_rgb( void ) const { return r * r + g * g + b * b; }

    // magnitude
    IC T magnitude_rgb( void ) const { return _sqrt( magnitude_sqr_rgb() ); }

    IC T intensity( void ) const { return ( r + g + b ) / 3.f; }
