...
public:
    ...
    IC BOOL intersectRayDist( const _vector2< T >& P,
                              const _vector2< T >& D,
                              T& dist ) {
        T numer = classify( P );
    ...
    IC BOOL intersectRayPoint( const _vector2< T >& P,
                               const _vector2< T >& D,
                               _vector2< T >& dest ) {
        T numer = classify( P );
        T denom = n.dotproduct( D );
    ...
    IC BOOL intersect( const _vector2< T >& u,
                       const _vector2< T >& v, // segment
    ...
    IC BOOL intersect_2( const _vector2< T >& u,
                         const _vector2< T >& v, // segment
                         _vector2< T >& isect )  // intersection point
    {
        T dist1, dist2;
