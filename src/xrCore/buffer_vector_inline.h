...
inline buffer_vector_specialized::buffer_vector( void* buffer,
...
TEMPLATE_SPECIALIZATION
inline typename buffer_vector_specialized::self_type&
buffer_vector_specialized::operator=( self_type const& other ) {
    assign( other.begin(), other.end() );
}

TEMPLATE_SPECIALIZATION
template < typename input_iterator >
inline void buffer_vector_specialized::assign( input_iterator begin,
                                               input_iterator const& end ) {
...
TEMPLATE_SPECIALIZATION
inline void buffer_vector_specialized::assign( size_type const& count,
...
TEMPLATE_SPECIALIZATION
template < typename input_iterator >
inline void buffer_vector_specialized::insert( iterator const& where,
...
TEMPLATE_SPECIALIZATION
inline void buffer_vector_specialized::erase( iterator const& begin,
                                              iterator const& end ) {
...
TEMPLATE_SPECIALIZATION
inline typename buffer_vector_specialized::reference
buffer_vector_specialized::at( size_type const& index ) {
    VERIFY( index < size() );
    return ( m_begin[ index ] );
}

TEMPLATE_SPECIALIZATION
inline typename buffer_vector_specialized::const_reference
buffer_vector_specialized::at( size_type const& index ) const {
    VERIFY( index < size() );
    return ( m_begin[ index ] );
}
...
TEMPLATE_SPECIALIZATION
inline typename buffer_vector_specialized::reference
buffer_vector_specialized::operator[]( size_type const& index ) {
    VERIFY( index < size() );
    return ( m_begin[ index ] );
}
...
TEMPLATE_SPECIALIZATION
inline typename buffer_vector_specialized::const_reference
buffer_vector_specialized::operator[]( size_type const& index ) const {
    VERIFY( index < size() );
    return ( m_begin[ index ] );
}
...
TEMPLATE_SPECIALIZATION
inline typename buffer_vector_specialized::reference
buffer_vector_specialized::back() {
    VERIFY( !empty() );
    return ( *( m_end - 1 ) );
}
...
TEMPLATE_SPECIALIZATION
inline typename buffer_vector_specialized::const_reference
buffer_vector_specialized::back() const {
    VERIFY( !empty() );
    return ( *( m_end - 1 ) );
}
...
TEMPLATE_SPECIALIZATION
inline typename buffer_vector_specialized::reference
buffer_vector_specialized::front() {
    VERIFY( !empty() );
    return ( *m_begin );
}
...
TEMPLATE_SPECIALIZATION
inline typename buffer_vector_specialized::const_reference
buffer_vector_specialized::front() const {
    VERIFY( !empty() );
    return ( *m_begin );
}

TEMPLATE_SPECIALIZATION
inline typename buffer_vector_specialized::iterator
buffer_vector_specialized::begin() {
    return ( m_begin );
}

TEMPLATE_SPECIALIZATION
inline typename buffer_vector_specialized::const_iterator
buffer_vector_specialized::begin() const {
    return ( m_begin );
}

TEMPLATE_SPECIALIZATION
inline typename buffer_vector_specialized::iterator
buffer_vector_specialized::end() {
    return ( m_end );
}

TEMPLATE_SPECIALIZATION
inline typename buffer_vector_specialized::const_iterator
buffer_vector_specialized::end() const {
    return ( m_end );
}

TEMPLATE_SPECIALIZATION
inline typename buffer_vector_specialized::reverse_iterator
buffer_vector_specialized::rbegin() {
    return ( reverse_iterator( end() ) );
}

TEMPLATE_SPECIALIZATION
inline typename buffer_vector_specialized::const_reverse_iterator
buffer_vector_specialized::rbegin() const {
    return ( const_reverse_iterator( end() ) );
}

TEMPLATE_SPECIALIZATION
inline typename buffer_vector_specialized::reverse_iterator
buffer_vector_specialized::rend() {
    return ( reverse_iterator( begin() ) );
}

TEMPLATE_SPECIALIZATION
inline typename buffer_vector_specialized::const_reverse_iterator
buffer_vector_specialized::rend() const {
...
TEMPLATE_SPECIALIZATION
inline typename buffer_vector_specialized::size_type
buffer_vector_specialized::size() const {
    return ( m_end - m_begin );
}

TEMPLATE_SPECIALIZATION
inline typename buffer_vector_specialized::size_type
buffer_vector_specialized::capacity() const {
    return ( m_max_end - m_begin );
}

TEMPLATE_SPECIALIZATION
inline typename buffer_vector_specialized::size_type
buffer_vector_specialized::max_size() const {
    return ( m_max_end - m_begin );
}
...
TEMPLATE_SPECIALIZATION
inline void buffer_vector_specialized::construct( iterator begin,
                                                  iterator const& end ) {
    for ( ; begin != end; ++begin )
        construct( begin );
}
...
TEMPLATE_SPECIALIZATION
inline void buffer_vector_specialized::destroy( iterator begin,
                                                iterator const& end ) {
    for ( ; begin != end; ++begin )
        destroy( begin );
}
...
TEMPLATE_SPECIALIZATION
inline void swap( buffer_vector_specialized& left,
                  buffer_vector_specialized& right ) {
    left.swap( right );
}
