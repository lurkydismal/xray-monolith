...
#undef ROT
	...
	IC SelfRef MxMpV(SelfCRef M1, SelfCRef M2, const Tvector& other)
	{
		m[0][0] = (M1.m[0][0] * M2.m[0][0] +
			M1.m[0][1] * M2.m[1][0] +
			M1.m[0][2] * M2.m[2][0] + other.x);
		m[1][0] = (M1.m[1][0] * M2.m[0][0] +
			M1.m[1][1] * M2.m[1][0] +
			M1.m[1][2] * M2.m[2][0] + other.y);
		m[2][0] = (M1.m[2][0] * M2.m[0][0] +
			M1.m[2][1] * M2.m[1][0] +
			M1.m[2][2] * M2.m[2][0] + other.z);
		m[0][1] = (M1.m[0][0] * M2.m[0][1] +
			M1.m[0][1] * M2.m[1][1] +
			M1.m[0][2] * M2.m[2][1] + other.x);
		m[1][1] = (M1.m[1][0] * M2.m[0][1] +
			M1.m[1][1] * M2.m[1][1] +
			M1.m[1][2] * M2.m[2][1] + other.y);
		m[2][1] = (M1.m[2][0] * M2.m[0][1] +
			M1.m[2][1] * M2.m[1][1] +
			M1.m[2][2] * M2.m[2][1] + other.z);
		m[0][2] = (M1.m[0][0] * M2.m[0][2] +
			M1.m[0][1] * M2.m[1][2] +
			M1.m[0][2] * M2.m[2][2] + other.x);
		m[1][2] = (M1.m[1][0] * M2.m[0][2] +
			M1.m[1][1] * M2.m[1][2] +
			M1.m[1][2] * M2.m[2][2] + other.y);
		m[2][2] = (M1.m[2][0] * M2.m[0][2] +
			M1.m[2][1] * M2.m[1][2] +
			M1.m[2][2] * M2.m[2][2] + other.z);
		return *this;
	}
