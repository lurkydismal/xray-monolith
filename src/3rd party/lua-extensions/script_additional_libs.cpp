...
const struct luaL_Reg bit_funcs[] = { { "tobit", bit_tobit },
                                      { "tohex", bit_tohex },
                                      { "bnot", bit_not },
                                      { "band", bit_and },
                                      { "bor", bit_or },
...
const luaL_Reg strlib[] = { { "trim", str_trim },
                            { "trim_l", str_trim_l },
                            { "trim_r", str_trim_r },
                            { "trim_w", str_trim_w },
                            { NULL, NULL } };
...
int math_randomseed( lua_State* L ) {
    switch ( lua_gettop( L ) ) {
        ...
        default:
            return luaL_error( L,
                               "math_randomseed: wrong number of arguments" );
    }
    return 0;
}
...
const luaL_Reg mathlib[] = { { "random", math_random },
...
const luaL_Reg tab_funcs[] = { { "keys", tab_keys },
                               { "values", tab_values },
                               { "size", get_size },
                               { "random", get_random },
                               { NULL, NULL } };
