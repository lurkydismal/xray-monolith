...
public:
    ...
    Result GetLobbyUpdateTransaction( LobbyId lobbyId,
    ...
    void DeleteLobby( LobbyId lobbyId,
                      std::function< void( Result ) > callback );
    ...
    Result GetMemberMetadataValue( LobbyId lobbyId,
                                   ...
                                   MetadataKey key,
                                   char value[ 4096 ] );
    Result GetMemberMetadataKey( LobbyId lobbyId,
                                 UserId userId,
                                 std::int32_t index,
                                 char key[ 256 ] );
    Result MemberMetadataCount( LobbyId lobbyId,
                                UserId userId,
                                std::int32_t* count );
