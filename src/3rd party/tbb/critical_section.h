...
#if !defined( __TBB_show_deprecation_message_critical_section_H ) && \
    defined( __TBB_show_deprecated_header_message )
#define __TBB_show_deprecation_message_critical_section_H
#pragma message( \
    "TBB Warning: tbb/critical_section.h is deprecated. For details, please see Deprecated Features appendix in the TBB reference manual." )
#endif
...
public:
    ...
    ~critical_section_v4() {
        __TBB_ASSERT( my_tid == tbb_thread::id(),
    ...
    void unlock() {
        ...
        __TBB_ASSERT_EX(
            !rval, "critical_section::unlock: pthread_mutex_unlock failed" );
#endif
    }
...
__TBB_DEPRECATED_VERBOSE_MSG(
    "tbb::critical_section is deprecated, use std::mutex" )
