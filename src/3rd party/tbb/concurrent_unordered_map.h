...
protected:
    ...
    typedef
        typename tbb::internal::allocator_rebind< Allocator, value_type >::type
            allocator_type;
#if __TBB_UNORDERED_NODE_HANDLE_PRESENT
    typedef tbb::internal::node_handle<
        key_type,
        value_type,
        typename internal::split_ordered_list< value_type,
                                               allocator_type >::node,
        allocator_type >
        node_type;
...
class concurrent_unordered_map
    : public internal::concurrent_unordered_base<
          concurrent_unordered_map_traits<
              Key,
              T,
              internal::hash_compare< Key, Hasher, Key_equality >,
              Allocator,
              false > > {
    // Base type definitions
    typedef internal::hash_compare< Key, Hasher, Key_equality > hash_compare;
    typedef concurrent_unordered_map_traits< Key,
                                             T,
                                             hash_compare,
                                             Allocator,
                                             false >
...
public:
    ...
    concurrent_unordered_map( size_type n_of_buckets,
                              const hasher& a_hasher,
                              const allocator_type& a )
        : base_type( n_of_buckets, key_compare( a_hasher, key_equal() ), a ) {}

    explicit concurrent_unordered_map( const Allocator& a )
        : base_type( base_type::initial_bucket_number, key_compare(), a ) {}
    ...
    template < typename Iterator >
    concurrent_unordered_map( Iterator first,
                              Iterator last,
    ...
    concurrent_unordered_map& operator=(
        ...
        return static_cast< concurrent_unordered_map& >(
    ...
    void merge( concurrent_unordered_map< Key, T, Hash, Equality, Allocator >&
                    source ) {
    ...
    template < typename Hash, typename Equality >
    void merge(
        concurrent_unordered_multimap< Key, T, Hash, Equality, Allocator >&
            source ) {
        this->internal_merge( source );
    }
    ...
    mapped_type& operator[]( const key_type& key ) {
        ...
        if ( where == end() ) {
            where = insert( std::pair< key_type, mapped_type >(
                                key, mapped_type() ) )
                        .first;
        }
...
using cu_map_t = Map<
    ...
    std::conditional_t< ( sizeof...( Args ) > 1 ) &&
                            !is_allocator_v< pack_element_t< 1, Args... > >,
                        pack_element_t< 1, Args... >,
                        std::equal_to< Key > >,
    std::conditional_t<
        ( sizeof...( Args ) > 0 ) &&
            is_allocator_v< pack_element_t< sizeof...( Args ) - 1, Args... > >,
        pack_element_t< sizeof...( Args ) - 1, Args... >,
        tbb_allocator< std::pair< const Key, Element > > > >;
} // namespace internal

// Deduction guide for the constructor from two iterators
template < typename I >
concurrent_unordered_map( I, I )
    ->internal::cu_map_t< concurrent_unordered_map,
                          internal::iterator_key_t< I >,
                          internal::iterator_mapped_t< I > >;

// Deduction guide for the constructor from two iterators and
// hasher/equality/allocator
...
concurrent_unordered_map(
    std::initializer_list< std::pair< const Key, Element > > )
...
public:
    ...
    concurrent_unordered_multimap( size_type n_of_buckets,
                                   const allocator_type& a )
        : base_type( n_of_buckets, key_compare( hasher(), key_equal() ), a ) {}
    ...
    explicit concurrent_unordered_multimap( const Allocator& a )
        : base_type( base_type::initial_bucket_number, key_compare(), a ) {}
    ...
    template < typename Iterator >
    concurrent_unordered_multimap( Iterator first,
                                   Iterator last,
                                   size_type n_of_buckets,
                                   const allocator_type& a )
        : base_type( n_of_buckets, key_compare( hasher(), key_equal() ), a ) {
    ...
    concurrent_unordered_multimap& operator=(
        ...
        return static_cast< concurrent_unordered_multimap& >(
            base_type::operator=( table ) );
    }
    ...
    concurrent_unordered_multimap& operator=(
        concurrent_unordered_multimap&& table ) {
        return static_cast< concurrent_unordered_multimap& >(
            base_type::operator=( std::move( table ) ) );
    }
#endif //__TBB_CPP11_RVALUE_REF_PRESENT && !__TBB_IMPLICIT_MOVE_PRESENT
...
concurrent_unordered_multimap( I, I )
    ->internal::cu_map_t< concurrent_unordered_multimap,
                          internal::iterator_key_t< I >,
                          internal::iterator_mapped_t< I > >;
...
concurrent_unordered_multimap(
    ...
    Args... )
    ->internal::
        cu_map_t< concurrent_unordered_multimap, Key, Element, Args... >;
