...
template < typename T, typename Input, typename Output >
struct body_types< Output ( T::* )( const Input& ) >
    : declare_body_types< Input, Output > {};

template < typename T, typename Input, typename Output >
struct body_types< Output ( T::* )( Input& ) const >
    : declare_body_types< Input, Output > {};

template < typename T, typename Input, typename Output >
struct body_types< Output ( T::* )( Input& ) >
    : declare_body_types< Input, Output > {};

template < typename Input, typename Output >
struct body_types< Output ( * )( Input& ) >
    : declare_body_types< Input, Output > {};

template < typename Input, typename Output >
struct body_types< Output ( * )( const Input& ) >
    : declare_body_types< Input, Output > {};
...
template < typename T, typename Input, typename Output >
auto decide_on_operator_overload( Output ( T::*name )( const Input& ) )
    -> decltype( name );

template < typename T, typename Input, typename Output >
auto decide_on_operator_overload( Output ( T::*name )( Input& ) const )
    -> decltype( name );

template < typename T, typename Input, typename Output >
auto decide_on_operator_overload( Output ( T::*name )( Input& ) )
    -> decltype( name );

template < typename Input, typename Output >
auto decide_on_operator_overload( Output ( *name )( const Input& ) )
    -> decltype( name );

template < typename Input, typename Output >
auto decide_on_operator_overload( Output ( *name )( Input& ) )
    -> decltype( name );
...
source_node( GraphOrSet&&, Body, bool = true ) -> source_node<
    input_t< decltype( decide_on_callable_type< Body >( 0 ) ) > >;
...
sequencer_node( GraphOrProxy&&, Sequencer ) -> sequencer_node<
    input_t< decltype( decide_on_callable_type< Sequencer >( 0 ) ) > >;
...
join_node(
    ...
    Policy ) -> join_node< typename Successor::input_type, Policy >;
...
split_node( const node_set< internal::order::following,
                            Predecessor,
                            Predecessors... >& )
...
function_node( GraphOrSet&&,
               ...
               __TBB_FLOW_GRAPH_PRIORITY_ARG1(
                   Policy,
                   node_priority_t = tbb::flow::internal::no_priority ) )
    -> function_node<
        input_t< decltype( decide_on_callable_type< Body >( 0 ) ) >,
        output_t< decltype( decide_on_callable_type< Body >( 0 ) ) >,
        Policy >;
...
continue_node( GraphOrSet&&,
               ...
               __TBB_FLOW_GRAPH_PRIORITY_ARG1(
                   ...
                   node_priority_t = tbb::flow::internal::no_priority ) )
    -> continue_node<
        continue_output_t< std::invoke_result_t< Body, continue_msg > >,
        Policy >;
