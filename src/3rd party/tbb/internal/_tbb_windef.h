...
// Do not increase the version in condition beyond 0x0500 without prior
// discussion!
...
#if TBB_USE_DEBUG
#if !defined( _DEBUG )
#pragma message( __FILE__ "(" __TBB_STRING( \
    __LINE__ ) ") : Warning: Recommend using /MDd if compiling with TBB_USE_DEBUG!=0" )
#endif
#else
#if defined( _DEBUG )
#pragma message( __FILE__ "(" __TBB_STRING( \
    __LINE__ ) ") : Warning: Recommend using /MD if compiling with TBB_USE_DEBUG==0" )
#endif
#endif
#endif
