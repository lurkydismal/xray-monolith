...
// the change to key_matching (adding a K and KHash template parameter, making
// it a class) means we have to pass this data to the key_matching_port.  All
// the ports have only one template parameter, so we have to wrap the following
// types in a trait:
//
//    . K == key_type
...
//
// The port will have an additional parameter on node construction, which is a
// function_body that accepts a const T& and returns a K which is the field in T
// which is its K.
...
// A wrapper that generates the traits needed for each port of a key-matching
// join, and the type of the tuple of input ports.
template < int N,
...
template < int N,
           ...
           typename KeyTraits,
           typename... Args >
struct wrap_key_tuple_elements< N,
                                PT,
                                KeyTraits,
                                tbb::flow::tuple< Args... > > {
    typedef typename KeyTraits::key_type K;
    typedef typename KeyTraits::hash_compare_type KHash;
    typedef typename tbb::flow::tuple< PT< KeyTrait< K, KHash, Args > >... >
        type;
};
#else
...
struct wrap_key_tuple_elements< 1, PT, KeyTraits, TypeTuple > {
    ...
    typedef KeyTrait< K,
                      KHash,
                      typename tbb::flow::tuple_element< 0, TypeTuple >::type >
        KeyTrait0;
...
struct wrap_key_tuple_elements< 2, PT, KeyTraits, TypeTuple > {
    ...
    typedef KeyTrait< K,
                      KHash,
                      typename tbb::flow::tuple_element< 1, TypeTuple >::type >
        KeyTrait1;
...
struct wrap_key_tuple_elements< 3, PT, KeyTraits, TypeTuple > {
    ...
    typedef KeyTrait< K,
                      KHash,
                      typename tbb::flow::tuple_element< 2, TypeTuple >::type >
        KeyTrait2;
    typedef typename tbb::flow::
        tuple< PT< KeyTrait0 >, PT< KeyTrait1 >, PT< KeyTrait2 > >
            type;
};
...
struct wrap_key_tuple_elements< 4, PT, KeyTraits, TypeTuple > {
    ...
    typedef KeyTrait< K,
                      KHash,
                      typename tbb::flow::tuple_element< 3, TypeTuple >::type >
        KeyTrait3;
    typedef typename tbb::flow::tuple< PT< KeyTrait0 >,
                                       PT< KeyTrait1 >,
                                       PT< KeyTrait2 >,
                                       PT< KeyTrait3 > >
        type;
...
struct wrap_key_tuple_elements< 5, PT, KeyTraits, TypeTuple > {
    ...
    typedef KeyTrait< K,
                      KHash,
                      typename tbb::flow::tuple_element< 4, TypeTuple >::type >
        KeyTrait4;
    typedef typename tbb::flow::tuple< PT< KeyTrait0 >,
                                       PT< KeyTrait1 >,
                                       PT< KeyTrait2 >,
...
struct wrap_key_tuple_elements< 6, PT, KeyTraits, TypeTuple > {
    ...
    typedef KeyTrait< K,
                      KHash,
                      typename tbb::flow::tuple_element< 5, TypeTuple >::type >
        KeyTrait5;
    typedef typename tbb::flow::tuple< PT< KeyTrait0 >,
                                       PT< KeyTrait1 >,
                                       PT< KeyTrait2 >,
...
struct wrap_key_tuple_elements< 7, PT, KeyTraits, TypeTuple > {
    ...
    typedef KeyTrait< K,
                      KHash,
                      typename tbb::flow::tuple_element< 6, TypeTuple >::type >
        KeyTrait6;
    typedef typename tbb::flow::tuple< PT< KeyTrait0 >,
                                       PT< KeyTrait1 >,
                                       PT< KeyTrait2 >,
...
struct wrap_key_tuple_elements< 8, PT, KeyTraits, TypeTuple > {
    ...
    typedef KeyTrait< K,
                      KHash,
                      typename tbb::flow::tuple_element< 7, TypeTuple >::type >
        KeyTrait7;
    typedef typename tbb::flow::tuple< PT< KeyTrait0 >,
                                       PT< KeyTrait1 >,
                                       PT< KeyTrait2 >,
...
struct wrap_key_tuple_elements< 9, PT, KeyTraits, TypeTuple > {
    ...
    typedef KeyTrait< K,
                      KHash,
                      typename tbb::flow::tuple_element< 8, TypeTuple >::type >
        KeyTrait8;
    typedef typename tbb::flow::tuple< PT< KeyTrait0 >,
                                       PT< KeyTrait1 >,
                                       PT< KeyTrait2 >,
...
struct wrap_key_tuple_elements< 10, PT, KeyTraits, TypeTuple > {
    ...
    typedef KeyTrait< K,
                      KHash,
                      typename tbb::flow::tuple_element< 9, TypeTuple >::type >
        KeyTrait9;
    typedef typename tbb::flow::tuple< PT< KeyTrait0 >,
                                       PT< KeyTrait1 >,
                                       PT< KeyTrait2 >,
...
// Until C++14 std::initializer_list does not guarantee life time of contained
// objects.
template < typename T >
...
public:
    ...
    initializer_list_wrapper( std::initializer_list< T > il )
        __TBB_NOEXCEPT( true )
        : my_begin( static_cast< T* >( malloc( il.size() * sizeof( T ) ) ) ) {
        iterator dst = my_begin;
        for ( typename std::initializer_list< T >::const_iterator src =
                  il.begin();
              src != il.end(); ++src )
            new ( dst++ ) T( *src );
        my_end = dst;
    ...
    initializer_list_wrapper( const initializer_list_wrapper< T >& ilw )
        __TBB_NOEXCEPT( true )
        : my_begin( static_cast< T* >( malloc( ilw.size() * sizeof( T ) ) ) ) {
        iterator dst = my_begin;
        for ( typename std::initializer_list< T >::const_iterator src =
                  ilw.begin();
              src != ilw.end(); ++src )
    ...
    initializer_list_wrapper( initializer_list_wrapper< T >&& ilw )
        __TBB_NOEXCEPT( true )
        : my_begin( ilw.my_begin ), my_end( ilw.my_end ) {
...
//! type mimicking std::pair but with trailing fill to ensure each element of an
//! array
...
// T1, T2 are actual types stored.  The space defined for T1 in the type
// returned is a char array of the correct size.  Type T2 should be
// trivially-constructible, T1 must be explicitly managed.
template < typename T1, typename T2 >
struct aligned_pair {
...
// references to it. internal::Wrapper<T>
...
// Wrapper<T> contains a T, with the ability to test what T is.  The Wrapper<T>
// can be constructed from a T, can be copy-constructed from another Wrapper<T>,
// and can be examined via value(), but not modified.
template < typename T >
...
private:
    ...
    // on exception will ensure the Wrapper will contain only a
    ...
    struct _unwind_space {
        ...
        ~_unwind_space() {
            if ( space )
                ( void )new ( space )
                    Wrapper< default_constructed >( default_constructed() );
        }
    };
...
private:
    ...
    // we placement new into each element, resulting in one construction per
    // element.
    ...
    // (the value_space is a char array, so it is already
...
public:
    ...
    explicit Wrapper( const Wrapper& other ) : WrapperBase() {
        ...
        pointer_type sp = reinterpret_cast< pointer_type >(
            const_cast< char* >( other.value_space ) );
    ...
    void CopyTo( void* newSpace ) const __TBB_override {
        ( void )new ( newSpace )
            Wrapper( *this ); // exceptions handled in copy constructor
    }
...
// given a tuple, return the type of the element that has the maximum alignment
// requirement. Given a tuple and that type, return the number of elements of
// the object with the max alignment requirement that is at least as big as the
// largest object in the tuple.
...
struct pick_max {
    typedef
        typename pick_one< ( Selector< T1 >::value > Selector< T2 >::value ),
                           T1,
                           T2 >::type type;
};
...
struct is_element_of {
    ...
    static const bool value = tbb::internal::is_same_type< Q, T_i >::value ||
                              is_element_of< Q, N - 1, Tuple >::value;
};
...
struct do_if< T, false > {
    static void construct( void* /*mySpace*/, const T& x ) {
        ...
        ERROR_Type_Not_allowed_In_Tagged_Msg_Not_Member_Of_Tuple< T >::bad_type(
            x );
    }
};

// Tuple tells us the allowed types that variant can hold.  It determines the
// alignment of the space in Wrapper, and how big Wrapper is.
//
...
template < typename TagType,
           ...
           typename T2 = tagged_null_type,
           typename T3 = tagged_null_type,
           typename T4 = tagged_null_type,
           typename T5 = tagged_null_type,
           typename T6 = tagged_null_type,
           typename T7 = tagged_null_type,
           typename T8 = tagged_null_type,
           typename T9 = tagged_null_type >
class tagged_msg {
    typedef tbb::flow::tuple< T0,
                              T1,
                              T2,
                              T3,
                              T4
...
private:
    class variant {
        ...
        typedef
            typename pick_tuple_max< N, Tuple, alignment_of >::type AlignType;
        typedef typename pick_tuple_max< N, Tuple, size_of >::type MaxSizeType;
        static const size_t MaxNBytes =
            ( sizeof( Wrapper< MaxSizeType > ) + sizeof( AlignType ) - 1 );
        static const size_t MaxNElements = MaxNBytes / sizeof( AlignType );
        typedef typename tbb::aligned_space< AlignType, MaxNElements >
            SpaceType;
        SpaceType my_space;
    ...
    public:
        ...
        template < typename T >
        variant( const T& x ) {
            do_if< T, is_element_of< T, N, Tuple >::value >::construct(
                &my_space, x );
        }

        variant( const variant& other ) {
            const WrapperBase* h =
                punned_cast< const WrapperBase* >( &( other.my_space ) );
            h->CopyTo( &my_space );
        }

        // assignment must destroy and re-create the Wrapper type, as there is
        // no way to create a Wrapper-to-Wrapper assign even if we find they
        // agree in type.
        void operator=( const variant& rhs ) {
            if ( &rhs != this ) {
                WrapperBase* h = punned_cast< WrapperBase* >( &my_space );
                h->~WrapperBase();
                const WrapperBase* ch =
                    punned_cast< const WrapperBase* >( &( rhs.my_space ) );
                ch->CopyTo( &my_space );
            }
        }
        ...
        const U& variant_cast_to() const {
            const Wrapper< U >* h = dynamic_cast< const Wrapper< U >* >(
                punned_cast< const WrapperBase* >( &my_space ) );
            if ( !h ) {
...
public:
    ...
    tagged_msg( T const& index, R const& value )
        : my_tag( index ), my_msg( value ) {}

#if __TBB_CONST_REF_TO_ARRAY_TEMPLATE_PARAM_BROKEN
    template < typename T, typename R, size_t N >
    tagged_msg( T const& index, R ( &value )[ N ] )
        : my_tag( index ), my_msg( value ) {}
#endif
