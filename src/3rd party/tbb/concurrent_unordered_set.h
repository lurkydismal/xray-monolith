...
class concurrent_unordered_set
    ...
    typedef concurrent_unordered_set_traits< Key,
                                             hash_compare,
                                             Allocator,
                                             false >
        traits_type;
...
public:
    ...
    concurrent_unordered_set( size_type n_of_buckets,
                              const hasher& a_hasher,
                              const allocator_type& a )
        : base_type( n_of_buckets, key_compare( a_hasher, key_equal() ), a ) {}

    explicit concurrent_unordered_set( const Allocator& a )
    ...
    template < typename Iterator >
    concurrent_unordered_set( Iterator first,
                              Iterator last,
    ...
    concurrent_unordered_set& operator=(
        ...
        return static_cast< concurrent_unordered_set& >(
    ...
    void merge(
        concurrent_unordered_set< Key, Hash, Equality, Allocator >& source ) {
    ...
    template < typename Hash, typename Equality >
    void merge( concurrent_unordered_multiset< Key, Hash, Equality, Allocator >&
                    source ) {
        this->internal_merge( source );
    }
    ...
    template < typename Hash, typename Equality >
    void merge(
        concurrent_unordered_multiset< Key, Hash, Equality, Allocator >&&
            source ) {
        this->internal_merge( source );
    }
...
concurrent_unordered_set( I, I )
    ->internal::cu_set_t< concurrent_unordered_set,
                          internal::iterator_value_t< I > >;
...
public:
    ...
    concurrent_unordered_multiset( size_type n_of_buckets,
                                   const allocator_type& a )
        : base_type( n_of_buckets, key_compare( hasher(), key_equal() ), a ) {}
    ...
    explicit concurrent_unordered_multiset( const Allocator& a )
        : base_type( base_type::initial_bucket_number, key_compare(), a ) {}
    ...
    template < typename Iterator >
    concurrent_unordered_multiset( Iterator first,
                                   Iterator last,
                                   size_type n_of_buckets,
                                   const allocator_type& a )
        : base_type( n_of_buckets, key_compare( hasher(), key_equal() ), a ) {
    ...
    concurrent_unordered_multiset& operator=(
        ...
        return static_cast< concurrent_unordered_multiset& >(
            base_type::operator=( table ) );
    }
    ...
    concurrent_unordered_multiset& operator=(
        concurrent_unordered_multiset&& table ) {
        return static_cast< concurrent_unordered_multiset& >(
            base_type::operator=( std::move( table ) ) );
    }
#endif //__TBB_CPP11_RVALUE_REF_PRESENT && !__TBB_IMPLICIT_MOVE_PRESENT
...
concurrent_unordered_multiset( I, I )
    ->internal::cu_set_t< concurrent_unordered_multiset,
                          internal::iterator_value_t< I > >;
