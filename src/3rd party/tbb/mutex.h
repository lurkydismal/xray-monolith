...
#if !defined( __TBB_show_deprecation_message_mutex_H ) && \
    defined( __TBB_show_deprecated_header_message )
#define __TBB_show_deprecation_message_mutex_H
#pragma message( \
    "TBB Warning: tbb/mutex.h is deprecated. For details, please see Deprecated Features appendix in the TBB reference manual." )
#endif
...
class __TBB_DEPRECATED_VERBOSE_MSG(
    "tbb::critical_section is deprecated, use std::mutex" ) mutex
...
public:
    ...
    mutex() {
        ...
        if ( error_code )
            tbb::internal::handle_perror( error_code,
    ...
    public:
        ...
        scoped_lock( mutex& mutex ) { acquire( mutex ); }
