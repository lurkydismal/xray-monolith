...
static inline int64_t __TBB_machine_cmpswp8_OsX( volatile void* ptr,
                                                 int64_t value,
                                                 int64_t comparand ) {
    __TBB_ASSERT( tbb::internal::is_aligned( ptr, 8 ),
                  "address not properly aligned for macOS* atomics" );
...
static inline int32_t __TBB_machine_cmpswp4( volatile void* ptr,
                                             int32_t value,
                                             int32_t comparand ) {
    __TBB_ASSERT( tbb::internal::is_aligned( ptr, 4 ),
                  "address not properly aligned for macOS atomics" );
