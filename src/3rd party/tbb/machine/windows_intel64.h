...
#include <intrin.h>
#pragma intrinsic( _InterlockedCompareExchange, _InterlockedExchangeAdd, \
                   _InterlockedExchange )
#pragma intrinsic( _InterlockedCompareExchange64, _InterlockedExchangeAdd64, \
...
inline long __TBB_machine_cmpswp4( volatile void* ptr,
                                   __int32 value,
                                   __int32 comparand ) {
...
inline __int64 __TBB_machine_cmpswp8( volatile void* ptr,
                                      __int64 value,
                                      __int64 comparand ) {
