...
#define __TBB_control_consistency_helper() __TBB_compiler_fence()
// Even though GCC imbues volatile loads with acquire semantics, it sometimes
// moves loads over the acquire fence. The following helpers stop such incorrect
// code motion.
...
// TODO: revise dynamic_link, memory pools and etc. if the library dependency is
// removed.
...
// Mapping old entry points to the names corresponding to the new full_fence
// identifier.
#define __TBB_machine_fetchadd1full_fence \
    __TBB_machine_fetchadd1__TBB_full_fence
#define __TBB_machine_fetchadd2full_fence \
    __TBB_machine_fetchadd2__TBB_full_fence
#define __TBB_machine_fetchadd4full_fence \
    __TBB_machine_fetchadd4__TBB_full_fence
#define __TBB_machine_fetchadd8full_fence \
    __TBB_machine_fetchadd8__TBB_full_fence
#define __TBB_machine_fetchstore1full_fence \
    __TBB_machine_fetchstore1__TBB_full_fence
#define __TBB_machine_fetchstore2full_fence \
    __TBB_machine_fetchstore2__TBB_full_fence
#define __TBB_machine_fetchstore4full_fence \
    __TBB_machine_fetchstore4__TBB_full_fence
#define __TBB_machine_fetchstore8full_fence \
