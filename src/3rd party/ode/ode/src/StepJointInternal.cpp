...
static void MultiplyAdd2_sym_3p8p( dReal* A, dReal* B, dReal* C ) {
    A[ 0 ] += DOT6( B, C ); /// 2*
    C += 8;
    dReal add;
    add = DOT6( B, C );
...
static void Multiply0_3p81( dReal* A, dReal* B, dReal* C ) {
    A[ 0 ] = DOT6( B, C );
    B += 8;
    A[ 1 ] = DOT6( B, C );
    B += 8;
...
static void MultiplyAdd0_3p81( dReal* A, dReal* B, dReal* C ) {
    A[ 0 ] += DOT6( B, C );
    B += 8;
    A[ 1 ] += DOT6( B, C );
    B += 8;
...
static void Multiply1_3p8q1( dReal* A, dReal* B, dReal* C ) {
    A[ 0 ] = DOTs6( B, C );
    B++;
    A[ 1 ] = DOTs6( B, C );
    B++;
