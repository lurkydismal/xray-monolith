...
void dMassSetParameters( dMass* m,
                         dReal themass,
                         dReal cgx,
                         dReal cgy,
                         dReal cgz,
...
void dMassSetCappedCylinder( dMass* m,
                             dReal density,
                             int direction,
                             dReal radius,
                             dReal length ) {
    ...
    M2 = ( REAL( 4.0 ) / REAL( 3.0 ) ) * M_PI * radius * radius * radius *
         density; // total cap mass
    m->mass = M1 + M2;
    Ia =
        M1 * ( REAL( 0.25 ) * radius * radius +
               ( REAL( 1.0 ) / REAL( 12.0 ) ) * length * length ) +
        M2 * ( REAL( 0.4 ) * radius * radius + REAL( 0.375 ) * radius * length +
               REAL( 0.25 ) * length * length );
...
void dMassSetCappedCylinderTotal( dMass* m,
                                  dReal total_mass,
                                  int direction,
                                  dReal a,
                                  dReal b ) {
...
void dMassSetCylinderTotal( dMass* m,
                            dReal total_mass,
                            int direction,
                            dReal radius,
                            dReal length ) {
