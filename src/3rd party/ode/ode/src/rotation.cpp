...
void dQFromAxisAndAngle( dQuaternion q,
                         dReal ax,
                         dReal ay,
                         dReal az,
                         dReal angle ) {
...
void dQMultiply0( dQuaternion qa, const dQuaternion qb, const dQuaternion qc ) {
    dAASSERT( qa && qb && qc );
    qa[ 0 ] = qb[ 0 ] * qc[ 0 ] - qb[ 1 ] * qc[ 1 ] - qb[ 2 ] * qc[ 2 ] -
              qb[ 3 ] * qc[ 3 ];
    qa[ 1 ] = qb[ 0 ] * qc[ 1 ] + qb[ 1 ] * qc[ 0 ] + qb[ 2 ] * qc[ 3 ] -
              qb[ 3 ] * qc[ 2 ];
    qa[ 2 ] = qb[ 0 ] * qc[ 2 ] + qb[ 2 ] * qc[ 0 ] + qb[ 3 ] * qc[ 1 ] -
              qb[ 1 ] * qc[ 3 ];
    qa[ 3 ] = qb[ 0 ] * qc[ 3 ] + qb[ 3 ] * qc[ 0 ] + qb[ 1 ] * qc[ 2 ] -
              qb[ 2 ] * qc[ 1 ];
}
...
// dRfromQ(), dQfromR() and dDQfromW() are derived from equations in "An
// Introduction to Physically Based Modeling: Rigid Body Simulation - 1:
// Unconstrained Rigid Body Dynamics" by David Baraff, Robotics Institute,
...
void dDQfromW( dReal dq[ 4 ], const dVector3 w, const dQuaternion q ) {
    dAASSERT( w && q && dq );
    dq[ 0 ] =
        REAL( 0.5 ) * ( -w[ 0 ] * q[ 1 ] - w[ 1 ] * q[ 2 ] - w[ 2 ] * q[ 3 ] );
    dq[ 1 ] =
        REAL( 0.5 ) * ( w[ 0 ] * q[ 0 ] + w[ 1 ] * q[ 3 ] - w[ 2 ] * q[ 2 ] );
    dq[ 2 ] =
        REAL( 0.5 ) * ( -w[ 0 ] * q[ 3 ] + w[ 1 ] * q[ 0 ] + w[ 2 ] * q[ 1 ] );
    dq[ 3 ] =
        REAL( 0.5 ) * ( w[ 0 ] * q[ 2 ] - w[ 1 ] * q[ 1 ] + w[ 2 ] * q[ 0 ] );
}
