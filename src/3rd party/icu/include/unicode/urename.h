...
// Disable Renaming for Visual Studio's IntelliSense feature, so that
// 'Go-to-Definition' (F12) will work.
#if !( defined( _MSC_VER ) && defined( __INTELLISENSE__ ) )

/* We need the U_ICU_ENTRY_POINT_RENAME definition. There's a default one in
   unicode/uvernum.h we can use, but we will give the platform a chance to
   define it first. Normally (if utypes.h or umachine.h was included first) this
   will not be necessary as it will already be defined.
 */
...
/* Error out before the following defines cause very strange and unexpected code
 * breakage */
#ifndef U_ICU_ENTRY_POINT_RENAME
...
#define T_CString_int64ToString \
    U_ICU_ENTRY_POINT_RENAME( T_CString_int64ToString )
#define T_CString_integerToString \
    U_ICU_ENTRY_POINT_RENAME( T_CString_integerToString )
#define T_CString_stringToInteger \
    U_ICU_ENTRY_POINT_RENAME( T_CString_stringToInteger )
...
#define UCNV_FROM_U_CALLBACK_ESCAPE \
    U_ICU_ENTRY_POINT_RENAME( UCNV_FROM_U_CALLBACK_ESCAPE )
#define UCNV_FROM_U_CALLBACK_SKIP \
    U_ICU_ENTRY_POINT_RENAME( UCNV_FROM_U_CALLBACK_SKIP )
#define UCNV_FROM_U_CALLBACK_STOP \
    U_ICU_ENTRY_POINT_RENAME( UCNV_FROM_U_CALLBACK_STOP )
...
#define UCNV_TO_U_CALLBACK_ESCAPE \
    U_ICU_ENTRY_POINT_RENAME( UCNV_TO_U_CALLBACK_ESCAPE )
#define UCNV_TO_U_CALLBACK_SKIP \
    U_ICU_ENTRY_POINT_RENAME( UCNV_TO_U_CALLBACK_SKIP )
#define UCNV_TO_U_CALLBACK_STOP \
    U_ICU_ENTRY_POINT_RENAME( UCNV_TO_U_CALLBACK_STOP )
#define UCNV_TO_U_CALLBACK_SUBSTITUTE \
    U_ICU_ENTRY_POINT_RENAME( UCNV_TO_U_CALLBACK_SUBSTITUTE )
#define UDataMemory_createNewInstance \
    U_ICU_ENTRY_POINT_RENAME( UDataMemory_createNewInstance )
...
#define UDataMemory_normalizeDataPointer \
    U_ICU_ENTRY_POINT_RENAME( UDataMemory_normalizeDataPointer )
...
#define _isUnicodeLocaleTypeSubtag \
    U_ICU_ENTRY_POINT_RENAME( _isUnicodeLocaleTypeSubtag )
...
#define gTimeZoneFilesInitOnce \
    U_ICU_ENTRY_POINT_RENAME( gTimeZoneFilesInitOnce )
...
#define izrule_getDynamicClassID \
    U_ICU_ENTRY_POINT_RENAME( izrule_getDynamicClassID )
...
#define izrule_getPreviousStart \
    U_ICU_ENTRY_POINT_RENAME( izrule_getPreviousStart )
#define izrule_getRawOffset U_ICU_ENTRY_POINT_RENAME( izrule_getRawOffset )
#define izrule_getStaticClassID \
    U_ICU_ENTRY_POINT_RENAME( izrule_getStaticClassID )
...
#define locale_getKeywordsStart \
    U_ICU_ENTRY_POINT_RENAME( locale_getKeywordsStart )
...
#define pl_getFontRunLastLimit \
    U_ICU_ENTRY_POINT_RENAME( pl_getFontRunLastLimit )
...
#define pl_getLocaleRunLastLimit \
    U_ICU_ENTRY_POINT_RENAME( pl_getLocaleRunLastLimit )
...
#define pl_getValueRunLastLimit \
    U_ICU_ENTRY_POINT_RENAME( pl_getValueRunLastLimit )
...
#define pl_getVisualRunDescent \
    U_ICU_ENTRY_POINT_RENAME( pl_getVisualRunDescent )
#define pl_getVisualRunDirection \
    U_ICU_ENTRY_POINT_RENAME( pl_getVisualRunDirection )
#define pl_getVisualRunFont U_ICU_ENTRY_POINT_RENAME( pl_getVisualRunFont )
#define pl_getVisualRunGlyphCount \
    U_ICU_ENTRY_POINT_RENAME( pl_getVisualRunGlyphCount )
#define pl_getVisualRunGlyphToCharMap \
    U_ICU_ENTRY_POINT_RENAME( pl_getVisualRunGlyphToCharMap )
#define pl_getVisualRunGlyphs U_ICU_ENTRY_POINT_RENAME( pl_getVisualRunGlyphs )
#define pl_getVisualRunLeading \
    U_ICU_ENTRY_POINT_RENAME( pl_getVisualRunLeading )
#define pl_getVisualRunPositions \
    U_ICU_ENTRY_POINT_RENAME( pl_getVisualRunPositions )
...
#define pl_openEmptyLocaleRuns \
    U_ICU_ENTRY_POINT_RENAME( pl_openEmptyLocaleRuns )
...
#define res_getIntVectorNoTrace \
    U_ICU_ENTRY_POINT_RENAME( res_getIntVectorNoTrace )
...
#define res_getTableItemByIndex \
    U_ICU_ENTRY_POINT_RENAME( res_getTableItemByIndex )
...
#define u_caseInsensitivePrefixMatch \
    U_ICU_ENTRY_POINT_RENAME( u_caseInsensitivePrefixMatch )
...
#define u_flushDefaultConverter \
    U_ICU_ENTRY_POINT_RENAME( u_flushDefaultConverter )
...
#define u_formatMessageWithError \
    U_ICU_ENTRY_POINT_RENAME( u_formatMessageWithError )
...
#define u_getBidiPairedBracket \
    U_ICU_ENTRY_POINT_RENAME( u_getBidiPairedBracket )
#define u_getBinaryPropertySet \
    U_ICU_ENTRY_POINT_RENAME( u_getBinaryPropertySet )
...
#define u_getIntPropertyMaxValue \
    U_ICU_ENTRY_POINT_RENAME( u_getIntPropertyMaxValue )
#define u_getIntPropertyMinValue \
    U_ICU_ENTRY_POINT_RENAME( u_getIntPropertyMinValue )
...
#define u_getPropertyValueEnum \
    U_ICU_ENTRY_POINT_RENAME( u_getPropertyValueEnum )
#define u_getPropertyValueName \
    U_ICU_ENTRY_POINT_RENAME( u_getPropertyValueName )
#define u_getTimeZoneFilesDirectory \
    U_ICU_ENTRY_POINT_RENAME( u_getTimeZoneFilesDirectory )
#define u_getUnicodeProperties \
    U_ICU_ENTRY_POINT_RENAME( u_getUnicodeProperties )
...
#define u_locbund_getNumberFormat \
    U_ICU_ENTRY_POINT_RENAME( u_locbund_getNumberFormat )
...
#define u_memcmpCodePointOrder \
    U_ICU_ENTRY_POINT_RENAME( u_memcmpCodePointOrder )
...
#define u_parseMessageWithError \
    U_ICU_ENTRY_POINT_RENAME( u_parseMessageWithError )
...
#define u_releaseDefaultConverter \
    U_ICU_ENTRY_POINT_RENAME( u_releaseDefaultConverter )
#define u_scanf_parse U_ICU_ENTRY_POINT_RENAME( u_scanf_parse )
#define u_setAtomicIncDecFunctions \
    U_ICU_ENTRY_POINT_RENAME( u_setAtomicIncDecFunctions )
...
#define u_setTimeZoneFilesDirectory \
    U_ICU_ENTRY_POINT_RENAME( u_setTimeZoneFilesDirectory )
...
#define u_strFromJavaModifiedUTF8WithSub \
    U_ICU_ENTRY_POINT_RENAME( u_strFromJavaModifiedUTF8WithSub )
...
#define u_strHasMoreChar32Than \
    U_ICU_ENTRY_POINT_RENAME( u_strHasMoreChar32Than )
#define u_strToJavaModifiedUTF8 \
    U_ICU_ENTRY_POINT_RENAME( u_strToJavaModifiedUTF8 )
...
#define u_strcmpCodePointOrder \
    U_ICU_ENTRY_POINT_RENAME( u_strcmpCodePointOrder )
...
#define u_strncmpCodePointOrder \
    U_ICU_ENTRY_POINT_RENAME( u_strncmpCodePointOrder )
...
#define u_vformatMessageWithError \
    U_ICU_ENTRY_POINT_RENAME( u_vformatMessageWithError )
...
#define u_vparseMessageWithError \
    U_ICU_ENTRY_POINT_RENAME( u_vparseMessageWithError )
...
#define u_writeIdenticalLevelRun \
    U_ICU_ENTRY_POINT_RENAME( u_writeIdenticalLevelRun )
#define ubidi_addPropertyStarts \
    U_ICU_ENTRY_POINT_RENAME( ubidi_addPropertyStarts )
...
#define ubidi_getBaseDirection \
    U_ICU_ENTRY_POINT_RENAME( ubidi_getBaseDirection )
#define ubidi_getClass U_ICU_ENTRY_POINT_RENAME( ubidi_getClass )
#define ubidi_getClassCallback \
    U_ICU_ENTRY_POINT_RENAME( ubidi_getClassCallback )
#define ubidi_getCustomizedClass \
    U_ICU_ENTRY_POINT_RENAME( ubidi_getCustomizedClass )
...
#define ubidi_getPairedBracket \
    U_ICU_ENTRY_POINT_RENAME( ubidi_getPairedBracket )
#define ubidi_getPairedBracketType \
    U_ICU_ENTRY_POINT_RENAME( ubidi_getPairedBracketType )
#define ubidi_getParaLevel U_ICU_ENTRY_POINT_RENAME( ubidi_getParaLevel )
#define ubidi_getParaLevelAtIndex \
    U_ICU_ENTRY_POINT_RENAME( ubidi_getParaLevelAtIndex )
#define ubidi_getParagraph U_ICU_ENTRY_POINT_RENAME( ubidi_getParagraph )
#define ubidi_getParagraphByIndex \
    U_ICU_ENTRY_POINT_RENAME( ubidi_getParagraphByIndex )
#define ubidi_getProcessedLength \
    U_ICU_ENTRY_POINT_RENAME( ubidi_getProcessedLength )
#define ubidi_getReorderingMode \
    U_ICU_ENTRY_POINT_RENAME( ubidi_getReorderingMode )
#define ubidi_getReorderingOptions \
    U_ICU_ENTRY_POINT_RENAME( ubidi_getReorderingOptions )
...
#define ubidi_isOrderParagraphsLTR \
    U_ICU_ENTRY_POINT_RENAME( ubidi_isOrderParagraphsLTR )
...
#define ubidi_orderParagraphsLTR \
    U_ICU_ENTRY_POINT_RENAME( ubidi_orderParagraphsLTR )
...
#define ubidi_setClassCallback \
    U_ICU_ENTRY_POINT_RENAME( ubidi_setClassCallback )
...
#define ubidi_setReorderingMode \
    U_ICU_ENTRY_POINT_RENAME( ubidi_setReorderingMode )
#define ubidi_setReorderingOptions \
    U_ICU_ENTRY_POINT_RENAME( ubidi_setReorderingOptions )
...
#define ubiditransform_transform \
    U_ICU_ENTRY_POINT_RENAME( ubiditransform_transform )
...
#define ucal_getCanonicalTimeZoneID \
    U_ICU_ENTRY_POINT_RENAME( ucal_getCanonicalTimeZoneID )
...
#define ucal_getDefaultTimeZone \
    U_ICU_ENTRY_POINT_RENAME( ucal_getDefaultTimeZone )
#define ucal_getFieldDifference \
    U_ICU_ENTRY_POINT_RENAME( ucal_getFieldDifference )
...
#define ucal_getKeywordValuesForLocale \
    U_ICU_ENTRY_POINT_RENAME( ucal_getKeywordValuesForLocale )
...
#define ucal_getTimeZoneDisplayName \
    U_ICU_ENTRY_POINT_RENAME( ucal_getTimeZoneDisplayName )
#define ucal_getTimeZoneID U_ICU_ENTRY_POINT_RENAME( ucal_getTimeZoneID )
#define ucal_getTimeZoneIDForWindowsID \
    U_ICU_ENTRY_POINT_RENAME( ucal_getTimeZoneIDForWindowsID )
#define ucal_getTimeZoneTransitionDate \
    U_ICU_ENTRY_POINT_RENAME( ucal_getTimeZoneTransitionDate )
#define ucal_getType U_ICU_ENTRY_POINT_RENAME( ucal_getType )
#define ucal_getWeekendTransition \
    U_ICU_ENTRY_POINT_RENAME( ucal_getWeekendTransition )
#define ucal_getWindowsTimeZoneID \
    U_ICU_ENTRY_POINT_RENAME( ucal_getWindowsTimeZoneID )
...
#define ucal_openCountryTimeZones \
    U_ICU_ENTRY_POINT_RENAME( ucal_openCountryTimeZones )
#define ucal_openTimeZoneIDEnumeration \
    U_ICU_ENTRY_POINT_RENAME( ucal_openTimeZoneIDEnumeration )
...
#define ucal_setDefaultTimeZone \
    U_ICU_ENTRY_POINT_RENAME( ucal_setDefaultTimeZone )
#define ucal_setGregorianChange \
    U_ICU_ENTRY_POINT_RENAME( ucal_setGregorianChange )
...
#define ucase_addPropertyStarts \
    U_ICU_ENTRY_POINT_RENAME( ucase_addPropertyStarts )
#define ucase_addStringCaseClosure \
    U_ICU_ENTRY_POINT_RENAME( ucase_addStringCaseClosure )
...
#define ucase_getTypeOrIgnorable \
    U_ICU_ENTRY_POINT_RENAME( ucase_getTypeOrIgnorable )
#define ucase_hasBinaryProperty \
    U_ICU_ENTRY_POINT_RENAME( ucase_hasBinaryProperty )
...
#define ucasemap_getBreakIterator \
    U_ICU_ENTRY_POINT_RENAME( ucasemap_getBreakIterator )
#define ucasemap_getLocale U_ICU_ENTRY_POINT_RENAME( ucasemap_getLocale )
#define ucasemap_getOptions U_ICU_ENTRY_POINT_RENAME( ucasemap_getOptions )
#define ucasemap_internalUTF8ToTitle \
    U_ICU_ENTRY_POINT_RENAME( ucasemap_internalUTF8ToTitle )
#define ucasemap_open U_ICU_ENTRY_POINT_RENAME( ucasemap_open )
#define ucasemap_setBreakIterator \
    U_ICU_ENTRY_POINT_RENAME( ucasemap_setBreakIterator )
...
#define ucfpos_constrainCategory \
    U_ICU_ENTRY_POINT_RENAME( ucfpos_constrainCategory )
...
#define ucfpos_getInt64IterationContext \
    U_ICU_ENTRY_POINT_RENAME( ucfpos_getInt64IterationContext )
...
#define ucfpos_setInt64IterationContext \
    U_ICU_ENTRY_POINT_RENAME( ucfpos_setInt64IterationContext )
#define ucfpos_setState U_ICU_ENTRY_POINT_RENAME( ucfpos_setState )
#define uchar_addPropertyStarts \
    U_ICU_ENTRY_POINT_RENAME( uchar_addPropertyStarts )
...
#define ucln_common_registerCleanup \
    U_ICU_ENTRY_POINT_RENAME( ucln_common_registerCleanup )
#define ucln_i18n_registerCleanup \
    U_ICU_ENTRY_POINT_RENAME( ucln_i18n_registerCleanup )
#define ucln_io_registerCleanup \
    U_ICU_ENTRY_POINT_RENAME( ucln_io_registerCleanup )
...
#define ucnv_MBCSFromUnicodeWithOffsets \
    U_ICU_ENTRY_POINT_RENAME( ucnv_MBCSFromUnicodeWithOffsets )
#define ucnv_MBCSGetFilteredUnicodeSetForUnicode \
    U_ICU_ENTRY_POINT_RENAME( ucnv_MBCSGetFilteredUnicodeSetForUnicode )
#define ucnv_MBCSGetType U_ICU_ENTRY_POINT_RENAME( ucnv_MBCSGetType )
#define ucnv_MBCSGetUnicodeSetForUnicode \
    U_ICU_ENTRY_POINT_RENAME( ucnv_MBCSGetUnicodeSetForUnicode )
#define ucnv_MBCSIsLeadByte U_ICU_ENTRY_POINT_RENAME( ucnv_MBCSIsLeadByte )
#define ucnv_MBCSSimpleGetNextUChar \
    U_ICU_ENTRY_POINT_RENAME( ucnv_MBCSSimpleGetNextUChar )
#define ucnv_MBCSToUnicodeWithOffsets \
    U_ICU_ENTRY_POINT_RENAME( ucnv_MBCSToUnicodeWithOffsets )
#define ucnv_bld_countAvailableConverters \
    U_ICU_ENTRY_POINT_RENAME( ucnv_bld_countAvailableConverters )
#define ucnv_bld_getAvailableConverter \
    U_ICU_ENTRY_POINT_RENAME( ucnv_bld_getAvailableConverter )
#define ucnv_canCreateConverter \
    U_ICU_ENTRY_POINT_RENAME( ucnv_canCreateConverter )
#define ucnv_cbFromUWriteBytes \
    U_ICU_ENTRY_POINT_RENAME( ucnv_cbFromUWriteBytes )
#define ucnv_cbFromUWriteSub U_ICU_ENTRY_POINT_RENAME( ucnv_cbFromUWriteSub )
#define ucnv_cbFromUWriteUChars \
    U_ICU_ENTRY_POINT_RENAME( ucnv_cbFromUWriteUChars )
...
#define ucnv_createAlgorithmicConverter \
    U_ICU_ENTRY_POINT_RENAME( ucnv_createAlgorithmicConverter )
#define ucnv_createConverter U_ICU_ENTRY_POINT_RENAME( ucnv_createConverter )
#define ucnv_createConverterFromPackage \
    U_ICU_ENTRY_POINT_RENAME( ucnv_createConverterFromPackage )
#define ucnv_createConverterFromSharedData \
    U_ICU_ENTRY_POINT_RENAME( ucnv_createConverterFromSharedData )
#define ucnv_detectUnicodeSignature \
    U_ICU_ENTRY_POINT_RENAME( ucnv_detectUnicodeSignature )
#define ucnv_enableCleanup U_ICU_ENTRY_POINT_RENAME( ucnv_enableCleanup )
#define ucnv_extContinueMatchFromU \
    U_ICU_ENTRY_POINT_RENAME( ucnv_extContinueMatchFromU )
#define ucnv_extContinueMatchToU \
    U_ICU_ENTRY_POINT_RENAME( ucnv_extContinueMatchToU )
#define ucnv_extGetUnicodeSet U_ICU_ENTRY_POINT_RENAME( ucnv_extGetUnicodeSet )
#define ucnv_extInitialMatchFromU \
    U_ICU_ENTRY_POINT_RENAME( ucnv_extInitialMatchFromU )
#define ucnv_extInitialMatchToU \
    U_ICU_ENTRY_POINT_RENAME( ucnv_extInitialMatchToU )
#define ucnv_extSimpleMatchFromU \
    U_ICU_ENTRY_POINT_RENAME( ucnv_extSimpleMatchFromU )
#define ucnv_extSimpleMatchToU \
    U_ICU_ENTRY_POINT_RENAME( ucnv_extSimpleMatchToU )
...
#define ucnv_fromUCountPending \
    U_ICU_ENTRY_POINT_RENAME( ucnv_fromUCountPending )
...
#define ucnv_fromUnicode_UTF8_OFFSETS_LOGIC \
    U_ICU_ENTRY_POINT_RENAME( ucnv_fromUnicode_UTF8_OFFSETS_LOGIC )
...
#define ucnv_getCompleteUnicodeSet \
    U_ICU_ENTRY_POINT_RENAME( ucnv_getCompleteUnicodeSet )
...
#define ucnv_getNonSurrogateUnicodeSet \
    U_ICU_ENTRY_POINT_RENAME( ucnv_getNonSurrogateUnicodeSet )
...
#define ucnv_incrementRefCount \
    U_ICU_ENTRY_POINT_RENAME( ucnv_incrementRefCount )
#define ucnv_io_countKnownConverters \
    U_ICU_ENTRY_POINT_RENAME( ucnv_io_countKnownConverters )
#define ucnv_io_getConverterName \
    U_ICU_ENTRY_POINT_RENAME( ucnv_io_getConverterName )
#define ucnv_io_stripASCIIForCompare \
    U_ICU_ENTRY_POINT_RENAME( ucnv_io_stripASCIIForCompare )
#define ucnv_io_stripEBCDICForCompare \
    U_ICU_ENTRY_POINT_RENAME( ucnv_io_stripEBCDICForCompare )
...
#define ucnv_openStandardNames \
    U_ICU_ENTRY_POINT_RENAME( ucnv_openStandardNames )
...
#define ucnv_toUWriteCodePoint \
    U_ICU_ENTRY_POINT_RENAME( ucnv_toUWriteCodePoint )
...
#define ucnv_unloadSharedDataIfReady \
    U_ICU_ENTRY_POINT_RENAME( ucnv_unloadSharedDataIfReady )
...
#define ucnvsel_openFromSerialized \
    U_ICU_ENTRY_POINT_RENAME( ucnvsel_openFromSerialized )
#define ucnvsel_selectForString \
    U_ICU_ENTRY_POINT_RENAME( ucnvsel_selectForString )
...
#define ucol_getContractionsAndExpansions \
    U_ICU_ENTRY_POINT_RENAME( ucol_getContractionsAndExpansions )
#define ucol_getDisplayName U_ICU_ENTRY_POINT_RENAME( ucol_getDisplayName )
#define ucol_getEquivalentReorderCodes \
    U_ICU_ENTRY_POINT_RENAME( ucol_getEquivalentReorderCodes )
#define ucol_getFunctionalEquivalent \
    U_ICU_ENTRY_POINT_RENAME( ucol_getFunctionalEquivalent )
#define ucol_getKeywordValues U_ICU_ENTRY_POINT_RENAME( ucol_getKeywordValues )
#define ucol_getKeywordValuesForLocale \
    U_ICU_ENTRY_POINT_RENAME( ucol_getKeywordValuesForLocale )
...
#define ucol_getShortDefinitionString \
    U_ICU_ENTRY_POINT_RENAME( ucol_getShortDefinitionString )
...
#define ucol_looksLikeCollationBinary \
    U_ICU_ENTRY_POINT_RENAME( ucol_looksLikeCollationBinary )
...
#define ucol_normalizeShortDefinitionString \
    U_ICU_ENTRY_POINT_RENAME( ucol_normalizeShortDefinitionString )
#define ucol_open U_ICU_ENTRY_POINT_RENAME( ucol_open )
#define ucol_openAvailableLocales \
    U_ICU_ENTRY_POINT_RENAME( ucol_openAvailableLocales )
...
#define ucol_openFromShortString \
    U_ICU_ENTRY_POINT_RENAME( ucol_openFromShortString )
#define ucol_openRules U_ICU_ENTRY_POINT_RENAME( ucol_openRules )
#define ucol_prepareShortStringOpen \
    U_ICU_ENTRY_POINT_RENAME( ucol_prepareShortStringOpen )
...
#define ucol_restoreVariableTop \
    U_ICU_ENTRY_POINT_RENAME( ucol_restoreVariableTop )
...
#define ucptrie_internalGetRange \
    U_ICU_ENTRY_POINT_RENAME( ucptrie_internalGetRange )
#define ucptrie_internalSmallIndex \
    U_ICU_ENTRY_POINT_RENAME( ucptrie_internalSmallIndex )
#define ucptrie_internalSmallU8Index \
    U_ICU_ENTRY_POINT_RENAME( ucptrie_internalSmallU8Index )
#define ucptrie_internalU8PrevIndex \
    U_ICU_ENTRY_POINT_RENAME( ucptrie_internalU8PrevIndex )
#define ucptrie_openFromBinary \
    U_ICU_ENTRY_POINT_RENAME( ucptrie_openFromBinary )
...
#define ucsdet_enableInputFilter \
    U_ICU_ENTRY_POINT_RENAME( ucsdet_enableInputFilter )
...
#define ucsdet_getDetectableCharsets \
    U_ICU_ENTRY_POINT_RENAME( ucsdet_getDetectableCharsets )
...
#define ucsdet_isInputFilterEnabled \
    U_ICU_ENTRY_POINT_RENAME( ucsdet_isInputFilterEnabled )
#define ucsdet_open U_ICU_ENTRY_POINT_RENAME( ucsdet_open )
#define ucsdet_setDeclaredEncoding \
    U_ICU_ENTRY_POINT_RENAME( ucsdet_setDeclaredEncoding )
#define ucsdet_setDetectableCharset \
    U_ICU_ENTRY_POINT_RENAME( ucsdet_setDetectableCharset )
...
#define ucurr_forLocaleAndDate \
    U_ICU_ENTRY_POINT_RENAME( ucurr_forLocaleAndDate )
#define ucurr_getDefaultFractionDigits \
    U_ICU_ENTRY_POINT_RENAME( ucurr_getDefaultFractionDigits )
#define ucurr_getDefaultFractionDigitsForUsage \
    U_ICU_ENTRY_POINT_RENAME( ucurr_getDefaultFractionDigitsForUsage )
#define ucurr_getKeywordValuesForLocale \
    U_ICU_ENTRY_POINT_RENAME( ucurr_getKeywordValuesForLocale )
...
#define ucurr_getRoundingIncrement \
    U_ICU_ENTRY_POINT_RENAME( ucurr_getRoundingIncrement )
#define ucurr_getRoundingIncrementForUsage \
    U_ICU_ENTRY_POINT_RENAME( ucurr_getRoundingIncrementForUsage )
#define ucurr_isAvailable U_ICU_ENTRY_POINT_RENAME( ucurr_isAvailable )
#define ucurr_openISOCurrencies \
    U_ICU_ENTRY_POINT_RENAME( ucurr_openISOCurrencies )
...
#define udat_adoptNumberFormat \
    U_ICU_ENTRY_POINT_RENAME( udat_adoptNumberFormat )
#define udat_adoptNumberFormatForFields \
    U_ICU_ENTRY_POINT_RENAME( udat_adoptNumberFormatForFields )
#define udat_applyPattern U_ICU_ENTRY_POINT_RENAME( udat_applyPattern )
#define udat_applyPatternRelative \
    U_ICU_ENTRY_POINT_RENAME( udat_applyPatternRelative )
...
#define udat_getNumberFormatForField \
    U_ICU_ENTRY_POINT_RENAME( udat_getNumberFormatForField )
...
#define udat_set2DigitYearStart \
    U_ICU_ENTRY_POINT_RENAME( udat_set2DigitYearStart )
#define udat_setBooleanAttribute \
    U_ICU_ENTRY_POINT_RENAME( udat_setBooleanAttribute )
...
#define udat_toCalendarDateField \
    U_ICU_ENTRY_POINT_RENAME( udat_toCalendarDateField )
#define udat_toPattern U_ICU_ENTRY_POINT_RENAME( udat_toPattern )
#define udat_toPatternRelativeDate \
    U_ICU_ENTRY_POINT_RENAME( udat_toPatternRelativeDate )
...
#define udata_openSwapperForInputData \
    U_ICU_ENTRY_POINT_RENAME( udata_openSwapperForInputData )
...
#define udata_swapInvStringBlock \
    U_ICU_ENTRY_POINT_RENAME( udata_swapInvStringBlock )
...
#define udatpg_getAppendItemFormat \
    U_ICU_ENTRY_POINT_RENAME( udatpg_getAppendItemFormat )
#define udatpg_getAppendItemName \
    U_ICU_ENTRY_POINT_RENAME( udatpg_getAppendItemName )
#define udatpg_getBaseSkeleton \
    U_ICU_ENTRY_POINT_RENAME( udatpg_getBaseSkeleton )
#define udatpg_getBestPattern U_ICU_ENTRY_POINT_RENAME( udatpg_getBestPattern )
#define udatpg_getBestPatternWithOptions \
    U_ICU_ENTRY_POINT_RENAME( udatpg_getBestPatternWithOptions )
#define udatpg_getDateTimeFormat \
    U_ICU_ENTRY_POINT_RENAME( udatpg_getDateTimeFormat )
#define udatpg_getDecimal U_ICU_ENTRY_POINT_RENAME( udatpg_getDecimal )
#define udatpg_getFieldDisplayName \
    U_ICU_ENTRY_POINT_RENAME( udatpg_getFieldDisplayName )
#define udatpg_getPatternForSkeleton \
    U_ICU_ENTRY_POINT_RENAME( udatpg_getPatternForSkeleton )
...
#define udatpg_openBaseSkeletons \
    U_ICU_ENTRY_POINT_RENAME( udatpg_openBaseSkeletons )
...
#define udatpg_replaceFieldTypes \
    U_ICU_ENTRY_POINT_RENAME( udatpg_replaceFieldTypes )
...
#define udatpg_setAppendItemFormat \
    U_ICU_ENTRY_POINT_RENAME( udatpg_setAppendItemFormat )
#define udatpg_setAppendItemName \
    U_ICU_ENTRY_POINT_RENAME( udatpg_setAppendItemName )
#define udatpg_setDateTimeFormat \
    U_ICU_ENTRY_POINT_RENAME( udatpg_setDateTimeFormat )
...
#define udtitvfmt_formatToResult \
    U_ICU_ENTRY_POINT_RENAME( udtitvfmt_formatToResult )
...
#define udtitvfmt_resultAsValue \
    U_ICU_ENTRY_POINT_RENAME( udtitvfmt_resultAsValue )
...
#define uenum_openCharStringsEnumeration \
    U_ICU_ENTRY_POINT_RENAME( uenum_openCharStringsEnumeration )
#define uenum_openFromStringEnumeration \
    U_ICU_ENTRY_POINT_RENAME( uenum_openFromStringEnumeration )
#define uenum_openUCharStringsEnumeration \
    U_ICU_ENTRY_POINT_RENAME( uenum_openUCharStringsEnumeration )
...
#define ufmt_getArrayItemByIndex \
    U_ICU_ENTRY_POINT_RENAME( ufmt_getArrayItemByIndex )
...
#define uhash_compareCaselessUnicodeString \
    U_ICU_ENTRY_POINT_RENAME( uhash_compareCaselessUnicodeString )
...
#define uhash_compareScriptSet \
    U_ICU_ENTRY_POINT_RENAME( uhash_compareScriptSet )
#define uhash_compareUChars U_ICU_ENTRY_POINT_RENAME( uhash_compareUChars )
#define uhash_compareUnicodeString \
    U_ICU_ENTRY_POINT_RENAME( uhash_compareUnicodeString )
...
#define uhash_hashCaselessUnicodeString \
    U_ICU_ENTRY_POINT_RENAME( uhash_hashCaselessUnicodeString )
...
#define uhash_hashUnicodeString \
    U_ICU_ENTRY_POINT_RENAME( uhash_hashUnicodeString )
...
#define uhash_setKeyComparator \
    U_ICU_ENTRY_POINT_RENAME( uhash_setKeyComparator )
...
#define uhash_setValueComparator \
    U_ICU_ENTRY_POINT_RENAME( uhash_setValueComparator )
...
#define uidna_labelToASCII_UTF8 \
    U_ICU_ENTRY_POINT_RENAME( uidna_labelToASCII_UTF8 )
#define uidna_labelToUnicode U_ICU_ENTRY_POINT_RENAME( uidna_labelToUnicode )
#define uidna_labelToUnicodeUTF8 \
    U_ICU_ENTRY_POINT_RENAME( uidna_labelToUnicodeUTF8 )
#define uidna_nameToASCII U_ICU_ENTRY_POINT_RENAME( uidna_nameToASCII )
#define uidna_nameToASCII_UTF8 \
    U_ICU_ENTRY_POINT_RENAME( uidna_nameToASCII_UTF8 )
#define uidna_nameToUnicode U_ICU_ENTRY_POINT_RENAME( uidna_nameToUnicode )
#define uidna_nameToUnicodeUTF8 \
    U_ICU_ENTRY_POINT_RENAME( uidna_nameToUnicodeUTF8 )
...
#define uiter_setCharacterIterator \
    U_ICU_ENTRY_POINT_RENAME( uiter_setCharacterIterator )
...
#define uldn_getDialectHandling \
    U_ICU_ENTRY_POINT_RENAME( uldn_getDialectHandling )
...
#define uldn_keyValueDisplayName \
    U_ICU_ENTRY_POINT_RENAME( uldn_keyValueDisplayName )
#define uldn_languageDisplayName \
    U_ICU_ENTRY_POINT_RENAME( uldn_languageDisplayName )
#define uldn_localeDisplayName \
    U_ICU_ENTRY_POINT_RENAME( uldn_localeDisplayName )
...
#define uldn_regionDisplayName \
    U_ICU_ENTRY_POINT_RENAME( uldn_regionDisplayName )
#define uldn_scriptCodeDisplayName \
    U_ICU_ENTRY_POINT_RENAME( uldn_scriptCodeDisplayName )
#define uldn_scriptDisplayName \
    U_ICU_ENTRY_POINT_RENAME( uldn_scriptDisplayName )
#define uldn_variantDisplayName \
    U_ICU_ENTRY_POINT_RENAME( uldn_variantDisplayName )
#define ulist_addItemBeginList \
    U_ICU_ENTRY_POINT_RENAME( ulist_addItemBeginList )
#define ulist_addItemEndList U_ICU_ENTRY_POINT_RENAME( ulist_addItemEndList )
#define ulist_close_keyword_values_iterator \
    U_ICU_ENTRY_POINT_RENAME( ulist_close_keyword_values_iterator )
#define ulist_containsString U_ICU_ENTRY_POINT_RENAME( ulist_containsString )
#define ulist_count_keyword_values \
    U_ICU_ENTRY_POINT_RENAME( ulist_count_keyword_values )
...
#define ulist_next_keyword_value \
    U_ICU_ENTRY_POINT_RENAME( ulist_next_keyword_value )
...
#define ulist_reset_keyword_values_iterator \
    U_ICU_ENTRY_POINT_RENAME( ulist_reset_keyword_values_iterator )
...
#define ulistfmt_formatStringsToResult \
    U_ICU_ENTRY_POINT_RENAME( ulistfmt_formatStringsToResult )
...
#define ulistfmt_resultAsValue \
    U_ICU_ENTRY_POINT_RENAME( ulistfmt_resultAsValue )
#define uloc_acceptLanguage U_ICU_ENTRY_POINT_RENAME( uloc_acceptLanguage )
#define uloc_acceptLanguageFromHTTP \
    U_ICU_ENTRY_POINT_RENAME( uloc_acceptLanguageFromHTTP )
...
#define uloc_getCharacterOrientation \
    U_ICU_ENTRY_POINT_RENAME( uloc_getCharacterOrientation )
#define uloc_getCountry U_ICU_ENTRY_POINT_RENAME( uloc_getCountry )
#define uloc_getCurrentCountryID \
    U_ICU_ENTRY_POINT_RENAME( uloc_getCurrentCountryID )
#define uloc_getCurrentLanguageID \
    U_ICU_ENTRY_POINT_RENAME( uloc_getCurrentLanguageID )
#define uloc_getDefault U_ICU_ENTRY_POINT_RENAME( uloc_getDefault )
#define uloc_getDisplayCountry \
    U_ICU_ENTRY_POINT_RENAME( uloc_getDisplayCountry )
#define uloc_getDisplayKeyword \
    U_ICU_ENTRY_POINT_RENAME( uloc_getDisplayKeyword )
#define uloc_getDisplayKeywordValue \
    U_ICU_ENTRY_POINT_RENAME( uloc_getDisplayKeywordValue )
#define uloc_getDisplayLanguage \
    U_ICU_ENTRY_POINT_RENAME( uloc_getDisplayLanguage )
...
#define uloc_getDisplayScriptInContext \
    U_ICU_ENTRY_POINT_RENAME( uloc_getDisplayScriptInContext )
#define uloc_getDisplayVariant \
    U_ICU_ENTRY_POINT_RENAME( uloc_getDisplayVariant )
...
#define uloc_getLineOrientation \
    U_ICU_ENTRY_POINT_RENAME( uloc_getLineOrientation )
...
#define uloc_getTableStringWithFallback \
    U_ICU_ENTRY_POINT_RENAME( uloc_getTableStringWithFallback )
...
#define uloc_openAvailableByType \
    U_ICU_ENTRY_POINT_RENAME( uloc_openAvailableByType )
...
#define uloc_toUnicodeLocaleKey \
    U_ICU_ENTRY_POINT_RENAME( uloc_toUnicodeLocaleKey )
#define uloc_toUnicodeLocaleType \
    U_ICU_ENTRY_POINT_RENAME( uloc_toUnicodeLocaleType )
#define ulocdata_close U_ICU_ENTRY_POINT_RENAME( ulocdata_close )
#define ulocdata_getCLDRVersion \
    U_ICU_ENTRY_POINT_RENAME( ulocdata_getCLDRVersion )
#define ulocdata_getDelimiter U_ICU_ENTRY_POINT_RENAME( ulocdata_getDelimiter )
#define ulocdata_getExemplarSet \
    U_ICU_ENTRY_POINT_RENAME( ulocdata_getExemplarSet )
#define ulocdata_getLocaleDisplayPattern \
    U_ICU_ENTRY_POINT_RENAME( ulocdata_getLocaleDisplayPattern )
#define ulocdata_getLocaleSeparator \
    U_ICU_ENTRY_POINT_RENAME( ulocdata_getLocaleSeparator )
#define ulocdata_getMeasurementSystem \
    U_ICU_ENTRY_POINT_RENAME( ulocdata_getMeasurementSystem )
#define ulocdata_getNoSubstitute \
    U_ICU_ENTRY_POINT_RENAME( ulocdata_getNoSubstitute )
...
#define ulocdata_setNoSubstitute \
    U_ICU_ENTRY_POINT_RENAME( ulocdata_setNoSubstitute )
#define ulocimp_addLikelySubtags \
    U_ICU_ENTRY_POINT_RENAME( ulocimp_addLikelySubtags )
#define ulocimp_forLanguageTag \
    U_ICU_ENTRY_POINT_RENAME( ulocimp_forLanguageTag )
#define ulocimp_getCountry U_ICU_ENTRY_POINT_RENAME( ulocimp_getCountry )
#define ulocimp_getLanguage U_ICU_ENTRY_POINT_RENAME( ulocimp_getLanguage )
#define ulocimp_getRegionForSupplementalData \
    U_ICU_ENTRY_POINT_RENAME( ulocimp_getRegionForSupplementalData )
#define ulocimp_getScript U_ICU_ENTRY_POINT_RENAME( ulocimp_getScript )
#define ulocimp_minimizeSubtags \
    U_ICU_ENTRY_POINT_RENAME( ulocimp_minimizeSubtags )
...
#define ultag_isExtensionSubtags \
    U_ICU_ENTRY_POINT_RENAME( ultag_isExtensionSubtags )
#define ultag_isLanguageSubtag \
    U_ICU_ENTRY_POINT_RENAME( ultag_isLanguageSubtag )
#define ultag_isPrivateuseValueSubtags \
    U_ICU_ENTRY_POINT_RENAME( ultag_isPrivateuseValueSubtags )
...
#define ultag_isTransformedExtensionSubtags \
    U_ICU_ENTRY_POINT_RENAME( ultag_isTransformedExtensionSubtags )
#define ultag_isUnicodeExtensionSubtags \
    U_ICU_ENTRY_POINT_RENAME( ultag_isUnicodeExtensionSubtags )
#define ultag_isUnicodeLocaleAttribute \
    U_ICU_ENTRY_POINT_RENAME( ultag_isUnicodeLocaleAttribute )
#define ultag_isUnicodeLocaleAttributes \
    U_ICU_ENTRY_POINT_RENAME( ultag_isUnicodeLocaleAttributes )
#define ultag_isUnicodeLocaleKey \
    U_ICU_ENTRY_POINT_RENAME( ultag_isUnicodeLocaleKey )
#define ultag_isUnicodeLocaleType \
    U_ICU_ENTRY_POINT_RENAME( ultag_isUnicodeLocaleType )
#define ultag_isVariantSubtags \
    U_ICU_ENTRY_POINT_RENAME( ultag_isVariantSubtags )
#define umsg_applyPattern U_ICU_ENTRY_POINT_RENAME( umsg_applyPattern )
#define umsg_autoQuoteApostrophe \
    U_ICU_ENTRY_POINT_RENAME( umsg_autoQuoteApostrophe )
...
#define umutablecptrie_buildImmutable \
    U_ICU_ENTRY_POINT_RENAME( umutablecptrie_buildImmutable )
...
#define umutablecptrie_fromUCPMap \
    U_ICU_ENTRY_POINT_RENAME( umutablecptrie_fromUCPMap )
#define umutablecptrie_fromUCPTrie \
    U_ICU_ENTRY_POINT_RENAME( umutablecptrie_fromUCPTrie )
#define umutablecptrie_get U_ICU_ENTRY_POINT_RENAME( umutablecptrie_get )
#define umutablecptrie_getRange \
    U_ICU_ENTRY_POINT_RENAME( umutablecptrie_getRange )
...
#define umutablecptrie_setRange \
    U_ICU_ENTRY_POINT_RENAME( umutablecptrie_setRange )
#define uniset_getUnicode32Instance \
    U_ICU_ENTRY_POINT_RENAME( uniset_getUnicode32Instance )
...
#define unorm2_getCombiningClass \
    U_ICU_ENTRY_POINT_RENAME( unorm2_getCombiningClass )
#define unorm2_getDecomposition \
    U_ICU_ENTRY_POINT_RENAME( unorm2_getDecomposition )
...
#define unorm2_getNFKCCasefoldInstance \
    U_ICU_ENTRY_POINT_RENAME( unorm2_getNFKCCasefoldInstance )
#define unorm2_getNFKCInstance \
    U_ICU_ENTRY_POINT_RENAME( unorm2_getNFKCInstance )
#define unorm2_getNFKDInstance \
    U_ICU_ENTRY_POINT_RENAME( unorm2_getNFKDInstance )
#define unorm2_getRawDecomposition \
    U_ICU_ENTRY_POINT_RENAME( unorm2_getRawDecomposition )
#define unorm2_hasBoundaryAfter \
    U_ICU_ENTRY_POINT_RENAME( unorm2_hasBoundaryAfter )
#define unorm2_hasBoundaryBefore \
    U_ICU_ENTRY_POINT_RENAME( unorm2_hasBoundaryBefore )
...
#define unorm2_normalizeSecondAndAppend \
    U_ICU_ENTRY_POINT_RENAME( unorm2_normalizeSecondAndAppend )
...
#define unorm2_spanQuickCheckYes \
    U_ICU_ENTRY_POINT_RENAME( unorm2_spanQuickCheckYes )
...
#define unorm_isNormalizedWithOptions \
    U_ICU_ENTRY_POINT_RENAME( unorm_isNormalizedWithOptions )
...
#define unorm_quickCheckWithOptions \
    U_ICU_ENTRY_POINT_RENAME( unorm_quickCheckWithOptions )
...
#define unum_formatDoubleCurrency \
    U_ICU_ENTRY_POINT_RENAME( unum_formatDoubleCurrency )
#define unum_formatDoubleForFields \
    U_ICU_ENTRY_POINT_RENAME( unum_formatDoubleForFields )
#define unum_formatInt64 U_ICU_ENTRY_POINT_RENAME( unum_formatInt64 )
#define unum_formatUFormattable \
    U_ICU_ENTRY_POINT_RENAME( unum_formatUFormattable )
...
#define unum_getDoubleAttribute \
    U_ICU_ENTRY_POINT_RENAME( unum_getDoubleAttribute )
...
#define unum_parseDoubleCurrency \
    U_ICU_ENTRY_POINT_RENAME( unum_parseDoubleCurrency )
#define unum_parseInt64 U_ICU_ENTRY_POINT_RENAME( unum_parseInt64 )
#define unum_parseToUFormattable \
    U_ICU_ENTRY_POINT_RENAME( unum_parseToUFormattable )
...
#define unum_setDoubleAttribute \
    U_ICU_ENTRY_POINT_RENAME( unum_setDoubleAttribute )
...
#define unumf_openForSkeletonAndLocale \
    U_ICU_ENTRY_POINT_RENAME( unumf_openForSkeletonAndLocale )
#define unumf_openForSkeletonAndLocaleWithError \
    U_ICU_ENTRY_POINT_RENAME( unumf_openForSkeletonAndLocaleWithError )
...
#define unumf_resultGetAllFieldPositions \
    U_ICU_ENTRY_POINT_RENAME( unumf_resultGetAllFieldPositions )
#define unumf_resultNextFieldPosition \
    U_ICU_ENTRY_POINT_RENAME( unumf_resultNextFieldPosition )
...
#define unumsys_getDescription \
    U_ICU_ENTRY_POINT_RENAME( unumsys_getDescription )
...
#define unumsys_openAvailableNames \
    U_ICU_ENTRY_POINT_RENAME( unumsys_openAvailableNames )
...
#define uplrules_selectFormatted \
    U_ICU_ENTRY_POINT_RENAME( uplrules_selectFormatted )
#define uplrules_selectWithFormat \
    U_ICU_ENTRY_POINT_RENAME( uplrules_selectWithFormat )
...
#define uplug_getConfiguration \
    U_ICU_ENTRY_POINT_RENAME( uplug_getConfiguration )
...
#define uplug_getPlugLoadStatus \
    U_ICU_ENTRY_POINT_RENAME( uplug_getPlugLoadStatus )
...
#define uplug_loadPlugFromEntrypoint \
    U_ICU_ENTRY_POINT_RENAME( uplug_loadPlugFromEntrypoint )
#define uplug_loadPlugFromLibrary \
    U_ICU_ENTRY_POINT_RENAME( uplug_loadPlugFromLibrary )
...
#define uprops_addPropertyStarts \
    U_ICU_ENTRY_POINT_RENAME( uprops_addPropertyStarts )
#define uprops_getSource U_ICU_ENTRY_POINT_RENAME( uprops_getSource )
#define upropsvec_addPropertyStarts \
    U_ICU_ENTRY_POINT_RENAME( upropsvec_addPropertyStarts )
...
#define uprv_compareASCIIPropertyNames \
    U_ICU_ENTRY_POINT_RENAME( uprv_compareASCIIPropertyNames )
#define uprv_compareEBCDICPropertyNames \
    U_ICU_ENTRY_POINT_RENAME( uprv_compareEBCDICPropertyNames )
...
#define uprv_compareInvEbcdicAsAscii \
    U_ICU_ENTRY_POINT_RENAME( uprv_compareInvEbcdicAsAscii )
#define uprv_convertToLCID U_ICU_ENTRY_POINT_RENAME( uprv_convertToLCID )
#define uprv_convertToLCIDPlatform \
    U_ICU_ENTRY_POINT_RENAME( uprv_convertToLCIDPlatform )
...
#define uprv_decContextClearStatus \
    U_ICU_ENTRY_POINT_RENAME( uprv_decContextClearStatus )
#define uprv_decContextDefault \
    U_ICU_ENTRY_POINT_RENAME( uprv_decContextDefault )
#define uprv_decContextGetRounding \
    U_ICU_ENTRY_POINT_RENAME( uprv_decContextGetRounding )
#define uprv_decContextGetStatus \
    U_ICU_ENTRY_POINT_RENAME( uprv_decContextGetStatus )
#define uprv_decContextRestoreStatus \
    U_ICU_ENTRY_POINT_RENAME( uprv_decContextRestoreStatus )
#define uprv_decContextSaveStatus \
    U_ICU_ENTRY_POINT_RENAME( uprv_decContextSaveStatus )
#define uprv_decContextSetRounding \
    U_ICU_ENTRY_POINT_RENAME( uprv_decContextSetRounding )
#define uprv_decContextSetStatus \
    U_ICU_ENTRY_POINT_RENAME( uprv_decContextSetStatus )
#define uprv_decContextSetStatusFromString \
    U_ICU_ENTRY_POINT_RENAME( uprv_decContextSetStatusFromString )
#define uprv_decContextSetStatusFromStringQuiet \
    U_ICU_ENTRY_POINT_RENAME( uprv_decContextSetStatusFromStringQuiet )
#define uprv_decContextSetStatusQuiet \
    U_ICU_ENTRY_POINT_RENAME( uprv_decContextSetStatusQuiet )
#define uprv_decContextStatusToString \
    U_ICU_ENTRY_POINT_RENAME( uprv_decContextStatusToString )
#define uprv_decContextTestSavedStatus \
    U_ICU_ENTRY_POINT_RENAME( uprv_decContextTestSavedStatus )
#define uprv_decContextTestStatus \
    U_ICU_ENTRY_POINT_RENAME( uprv_decContextTestStatus )
#define uprv_decContextZeroStatus \
    U_ICU_ENTRY_POINT_RENAME( uprv_decContextZeroStatus )
...
#define uprv_decNumberCompareSignal \
    U_ICU_ENTRY_POINT_RENAME( uprv_decNumberCompareSignal )
#define uprv_decNumberCompareTotal \
    U_ICU_ENTRY_POINT_RENAME( uprv_decNumberCompareTotal )
#define uprv_decNumberCompareTotalMag \
    U_ICU_ENTRY_POINT_RENAME( uprv_decNumberCompareTotalMag )
...
#define uprv_decNumberCopyNegate \
    U_ICU_ENTRY_POINT_RENAME( uprv_decNumberCopyNegate )
#define uprv_decNumberCopySign \
    U_ICU_ENTRY_POINT_RENAME( uprv_decNumberCopySign )
#define uprv_decNumberDivide U_ICU_ENTRY_POINT_RENAME( uprv_decNumberDivide )
#define uprv_decNumberDivideInteger \
    U_ICU_ENTRY_POINT_RENAME( uprv_decNumberDivideInteger )
...
#define uprv_decNumberFromInt32 \
    U_ICU_ENTRY_POINT_RENAME( uprv_decNumberFromInt32 )
#define uprv_decNumberFromString \
    U_ICU_ENTRY_POINT_RENAME( uprv_decNumberFromString )
#define uprv_decNumberFromUInt32 \
    U_ICU_ENTRY_POINT_RENAME( uprv_decNumberFromUInt32 )
...
#define uprv_decNumberIsNormal \
    U_ICU_ENTRY_POINT_RENAME( uprv_decNumberIsNormal )
#define uprv_decNumberIsSubnormal \
    U_ICU_ENTRY_POINT_RENAME( uprv_decNumberIsSubnormal )
...
#define uprv_decNumberMultiply \
    U_ICU_ENTRY_POINT_RENAME( uprv_decNumberMultiply )
#define uprv_decNumberNextMinus \
    U_ICU_ENTRY_POINT_RENAME( uprv_decNumberNextMinus )
#define uprv_decNumberNextPlus \
    U_ICU_ENTRY_POINT_RENAME( uprv_decNumberNextPlus )
#define uprv_decNumberNextToward \
    U_ICU_ENTRY_POINT_RENAME( uprv_decNumberNextToward )
#define uprv_decNumberNormalize \
    U_ICU_ENTRY_POINT_RENAME( uprv_decNumberNormalize )
...
#define uprv_decNumberQuantize \
    U_ICU_ENTRY_POINT_RENAME( uprv_decNumberQuantize )
#define uprv_decNumberReduce U_ICU_ENTRY_POINT_RENAME( uprv_decNumberReduce )
#define uprv_decNumberRemainder \
    U_ICU_ENTRY_POINT_RENAME( uprv_decNumberRemainder )
#define uprv_decNumberRemainderNear \
    U_ICU_ENTRY_POINT_RENAME( uprv_decNumberRemainderNear )
...
#define uprv_decNumberSameQuantum \
    U_ICU_ENTRY_POINT_RENAME( uprv_decNumberSameQuantum )
...
#define uprv_decNumberSquareRoot \
    U_ICU_ENTRY_POINT_RENAME( uprv_decNumberSquareRoot )
#define uprv_decNumberSubtract \
    U_ICU_ENTRY_POINT_RENAME( uprv_decNumberSubtract )
#define uprv_decNumberToEngString \
    U_ICU_ENTRY_POINT_RENAME( uprv_decNumberToEngString )
#define uprv_decNumberToInt32 U_ICU_ENTRY_POINT_RENAME( uprv_decNumberToInt32 )
#define uprv_decNumberToIntegralExact \
    U_ICU_ENTRY_POINT_RENAME( uprv_decNumberToIntegralExact )
#define uprv_decNumberToIntegralValue \
    U_ICU_ENTRY_POINT_RENAME( uprv_decNumberToIntegralValue )
#define uprv_decNumberToString \
    U_ICU_ENTRY_POINT_RENAME( uprv_decNumberToString )
#define uprv_decNumberToUInt32 \
    U_ICU_ENTRY_POINT_RENAME( uprv_decNumberToUInt32 )
...
#define uprv_deleteConditionalCE32 \
    U_ICU_ENTRY_POINT_RENAME( uprv_deleteConditionalCE32 )
...
#define uprv_getCharNameCharacters \
    U_ICU_ENTRY_POINT_RENAME( uprv_getCharNameCharacters )
#define uprv_getDefaultLocaleID \
    U_ICU_ENTRY_POINT_RENAME( uprv_getDefaultLocaleID )
#define uprv_getInfinity U_ICU_ENTRY_POINT_RENAME( uprv_getInfinity )
#define uprv_getMaxCharNameLength \
    U_ICU_ENTRY_POINT_RENAME( uprv_getMaxCharNameLength )
...
#define uprv_getStaticCurrencyName \
    U_ICU_ENTRY_POINT_RENAME( uprv_getStaticCurrencyName )
...
#define uprv_isInvariantString \
    U_ICU_ENTRY_POINT_RENAME( uprv_isInvariantString )
#define uprv_isInvariantUString \
    U_ICU_ENTRY_POINT_RENAME( uprv_isInvariantUString )
#define uprv_isNaN U_ICU_ENTRY_POINT_RENAME( uprv_isNaN )
#define uprv_isNegativeInfinity \
    U_ICU_ENTRY_POINT_RENAME( uprv_isNegativeInfinity )
#define uprv_isPositiveInfinity \
    U_ICU_ENTRY_POINT_RENAME( uprv_isPositiveInfinity )
...
#define uprv_stableBinarySearch \
    U_ICU_ENTRY_POINT_RENAME( uprv_stableBinarySearch )
...
#define uprv_tzname_clear_cache \
    U_ICU_ENTRY_POINT_RENAME( uprv_tzname_clear_cache )
...
#define upvec_compactToUTrie2Handler \
    U_ICU_ENTRY_POINT_RENAME( upvec_compactToUTrie2Handler )
#define upvec_compactToUTrie2WithRowIndexes \
    U_ICU_ENTRY_POINT_RENAME( upvec_compactToUTrie2WithRowIndexes )
...
#define uregex_appendReplacement \
    U_ICU_ENTRY_POINT_RENAME( uregex_appendReplacement )
#define uregex_appendReplacementUText \
    U_ICU_ENTRY_POINT_RENAME( uregex_appendReplacementUText )
#define uregex_appendTail U_ICU_ENTRY_POINT_RENAME( uregex_appendTail )
#define uregex_appendTailUText \
    U_ICU_ENTRY_POINT_RENAME( uregex_appendTailUText )
...
#define uregex_getFindProgressCallback \
    U_ICU_ENTRY_POINT_RENAME( uregex_getFindProgressCallback )
#define uregex_getMatchCallback \
    U_ICU_ENTRY_POINT_RENAME( uregex_getMatchCallback )
...
#define uregex_groupNumberFromCName \
    U_ICU_ENTRY_POINT_RENAME( uregex_groupNumberFromCName )
#define uregex_groupNumberFromName \
    U_ICU_ENTRY_POINT_RENAME( uregex_groupNumberFromName )
#define uregex_groupUText U_ICU_ENTRY_POINT_RENAME( uregex_groupUText )
#define uregex_hasAnchoringBounds \
    U_ICU_ENTRY_POINT_RENAME( uregex_hasAnchoringBounds )
#define uregex_hasTransparentBounds \
    U_ICU_ENTRY_POINT_RENAME( uregex_hasTransparentBounds )
...
#define uregex_setFindProgressCallback \
    U_ICU_ENTRY_POINT_RENAME( uregex_setFindProgressCallback )
#define uregex_setMatchCallback \
    U_ICU_ENTRY_POINT_RENAME( uregex_setMatchCallback )
...
#define uregex_setRegionAndStart \
    U_ICU_ENTRY_POINT_RENAME( uregex_setRegionAndStart )
...
#define uregex_ucstr_unescape_charAt \
    U_ICU_ENTRY_POINT_RENAME( uregex_ucstr_unescape_charAt )
#define uregex_useAnchoringBounds \
    U_ICU_ENTRY_POINT_RENAME( uregex_useAnchoringBounds )
#define uregex_useTransparentBounds \
    U_ICU_ENTRY_POINT_RENAME( uregex_useTransparentBounds )
#define uregex_utext_unescape_charAt \
    U_ICU_ENTRY_POINT_RENAME( uregex_utext_unescape_charAt )
...
#define uregion_getContainedRegions \
    U_ICU_ENTRY_POINT_RENAME( uregion_getContainedRegions )
#define uregion_getContainedRegionsOfType \
    U_ICU_ENTRY_POINT_RENAME( uregion_getContainedRegionsOfType )
#define uregion_getContainingRegion \
    U_ICU_ENTRY_POINT_RENAME( uregion_getContainingRegion )
#define uregion_getContainingRegionOfType \
    U_ICU_ENTRY_POINT_RENAME( uregion_getContainingRegionOfType )
#define uregion_getNumericCode \
    U_ICU_ENTRY_POINT_RENAME( uregion_getNumericCode )
#define uregion_getPreferredValues \
    U_ICU_ENTRY_POINT_RENAME( uregion_getPreferredValues )
#define uregion_getRegionCode U_ICU_ENTRY_POINT_RENAME( uregion_getRegionCode )
#define uregion_getRegionFromCode \
    U_ICU_ENTRY_POINT_RENAME( uregion_getRegionFromCode )
#define uregion_getRegionFromNumericCode \
    U_ICU_ENTRY_POINT_RENAME( uregion_getRegionFromNumericCode )
...
#define ureldatefmt_closeResult \
    U_ICU_ENTRY_POINT_RENAME( ureldatefmt_closeResult )
#define ureldatefmt_combineDateAndTime \
...
#define ureldatefmt_formatNumeric \
    U_ICU_ENTRY_POINT_RENAME( ureldatefmt_formatNumeric )
#define ureldatefmt_formatNumericToResult \
    U_ICU_ENTRY_POINT_RENAME( ureldatefmt_formatNumericToResult )
#define ureldatefmt_formatToResult \
    U_ICU_ENTRY_POINT_RENAME( ureldatefmt_formatToResult )
#define ureldatefmt_open U_ICU_ENTRY_POINT_RENAME( ureldatefmt_open )
#define ureldatefmt_openResult \
    U_ICU_ENTRY_POINT_RENAME( ureldatefmt_openResult )
#define ureldatefmt_resultAsValue \
    U_ICU_ENTRY_POINT_RENAME( ureldatefmt_resultAsValue )
...
#define ures_getAllItemsWithFallback \
    U_ICU_ENTRY_POINT_RENAME( ures_getAllItemsWithFallback )
...
#define ures_getByKeyWithFallback \
    U_ICU_ENTRY_POINT_RENAME( ures_getByKeyWithFallback )
#define ures_getFunctionalEquivalent \
    U_ICU_ENTRY_POINT_RENAME( ures_getFunctionalEquivalent )
...
#define ures_getLocaleInternal \
    U_ICU_ENTRY_POINT_RENAME( ures_getLocaleInternal )
...
#define ures_getStringByKeyWithFallback \
    U_ICU_ENTRY_POINT_RENAME( ures_getStringByKeyWithFallback )
...
#define ures_getUTF8StringByIndex \
    U_ICU_ENTRY_POINT_RENAME( ures_getUTF8StringByIndex )
#define ures_getUTF8StringByKey \
    U_ICU_ENTRY_POINT_RENAME( ures_getUTF8StringByKey )
#define ures_getValueWithFallback \
    U_ICU_ENTRY_POINT_RENAME( ures_getValueWithFallback )
...
#define ures_getVersionNumberInternal \
    U_ICU_ENTRY_POINT_RENAME( ures_getVersionNumberInternal )
...
#define ures_openAvailableLocales \
    U_ICU_ENTRY_POINT_RENAME( ures_openAvailableLocales )
...
#define uscript_breaksBetweenLetters \
    U_ICU_ENTRY_POINT_RENAME( uscript_breaksBetweenLetters )
...
#define uscript_getSampleString \
    U_ICU_ENTRY_POINT_RENAME( uscript_getSampleString )
#define uscript_getSampleUnicodeString \
    U_ICU_ENTRY_POINT_RENAME( uscript_getSampleUnicodeString )
#define uscript_getScript U_ICU_ENTRY_POINT_RENAME( uscript_getScript )
#define uscript_getScriptExtensions \
    U_ICU_ENTRY_POINT_RENAME( uscript_getScriptExtensions )
...
#define usearch_getBreakIterator \
    U_ICU_ENTRY_POINT_RENAME( usearch_getBreakIterator )
#define usearch_getCollator U_ICU_ENTRY_POINT_RENAME( usearch_getCollator )
#define usearch_getMatchedLength \
    U_ICU_ENTRY_POINT_RENAME( usearch_getMatchedLength )
#define usearch_getMatchedStart \
    U_ICU_ENTRY_POINT_RENAME( usearch_getMatchedStart )
#define usearch_getMatchedText \
    U_ICU_ENTRY_POINT_RENAME( usearch_getMatchedText )
...
#define usearch_handleNextCanonical \
    U_ICU_ENTRY_POINT_RENAME( usearch_handleNextCanonical )
#define usearch_handleNextExact \
    U_ICU_ENTRY_POINT_RENAME( usearch_handleNextExact )
#define usearch_handlePreviousCanonical \
    U_ICU_ENTRY_POINT_RENAME( usearch_handlePreviousCanonical )
#define usearch_handlePreviousExact \
    U_ICU_ENTRY_POINT_RENAME( usearch_handlePreviousExact )
...
#define usearch_openFromCollator \
    U_ICU_ENTRY_POINT_RENAME( usearch_openFromCollator )
...
#define usearch_searchBackwards \
    U_ICU_ENTRY_POINT_RENAME( usearch_searchBackwards )
#define usearch_setAttribute U_ICU_ENTRY_POINT_RENAME( usearch_setAttribute )
#define usearch_setBreakIterator \
    U_ICU_ENTRY_POINT_RENAME( usearch_setBreakIterator )
...
#define uset_applyIntPropertyValue \
    U_ICU_ENTRY_POINT_RENAME( uset_applyIntPropertyValue )
#define uset_applyPattern U_ICU_ENTRY_POINT_RENAME( uset_applyPattern )
#define uset_applyPropertyAlias \
    U_ICU_ENTRY_POINT_RENAME( uset_applyPropertyAlias )
...
#define uset_containsAllCodePoints \
...
#define uset_getSerializedRange \
    U_ICU_ENTRY_POINT_RENAME( uset_getSerializedRange )
#define uset_getSerializedRangeCount \
    U_ICU_ENTRY_POINT_RENAME( uset_getSerializedRangeCount )
...
#define uset_openPatternOptions \
...
#define uset_serializedContains \
    U_ICU_ENTRY_POINT_RENAME( uset_serializedContains )
#define uset_set U_ICU_ENTRY_POINT_RENAME( uset_set )
#define uset_setSerializedToOne \
    U_ICU_ENTRY_POINT_RENAME( uset_setSerializedToOne )
...
#define uspoof_areConfusableUTF8 \
    U_ICU_ENTRY_POINT_RENAME( uspoof_areConfusableUTF8 )
...
#define uspoof_check2UnicodeString \
    U_ICU_ENTRY_POINT_RENAME( uspoof_check2UnicodeString )
#define uspoof_checkUTF8 U_ICU_ENTRY_POINT_RENAME( uspoof_checkUTF8 )
#define uspoof_checkUnicodeString \
    U_ICU_ENTRY_POINT_RENAME( uspoof_checkUnicodeString )
#define uspoof_clone U_ICU_ENTRY_POINT_RENAME( uspoof_clone )
#define uspoof_close U_ICU_ENTRY_POINT_RENAME( uspoof_close )
#define uspoof_closeCheckResult \
    U_ICU_ENTRY_POINT_RENAME( uspoof_closeCheckResult )
#define uspoof_getAllowedChars \
    U_ICU_ENTRY_POINT_RENAME( uspoof_getAllowedChars )
#define uspoof_getAllowedLocales \
    U_ICU_ENTRY_POINT_RENAME( uspoof_getAllowedLocales )
#define uspoof_getAllowedUnicodeSet \
    U_ICU_ENTRY_POINT_RENAME( uspoof_getAllowedUnicodeSet )
#define uspoof_getCheckResultChecks \
    U_ICU_ENTRY_POINT_RENAME( uspoof_getCheckResultChecks )
#define uspoof_getCheckResultNumerics \
    U_ICU_ENTRY_POINT_RENAME( uspoof_getCheckResultNumerics )
#define uspoof_getCheckResultRestrictionLevel \
    U_ICU_ENTRY_POINT_RENAME( uspoof_getCheckResultRestrictionLevel )
#define uspoof_getChecks U_ICU_ENTRY_POINT_RENAME( uspoof_getChecks )
#define uspoof_getInclusionSet \
    U_ICU_ENTRY_POINT_RENAME( uspoof_getInclusionSet )
#define uspoof_getInclusionUnicodeSet \
    U_ICU_ENTRY_POINT_RENAME( uspoof_getInclusionUnicodeSet )
#define uspoof_getRecommendedSet \
    U_ICU_ENTRY_POINT_RENAME( uspoof_getRecommendedSet )
#define uspoof_getRecommendedUnicodeSet \
    U_ICU_ENTRY_POINT_RENAME( uspoof_getRecommendedUnicodeSet )
#define uspoof_getRestrictionLevel \
    U_ICU_ENTRY_POINT_RENAME( uspoof_getRestrictionLevel )
#define uspoof_getSkeleton U_ICU_ENTRY_POINT_RENAME( uspoof_getSkeleton )
#define uspoof_getSkeletonUTF8 \
    U_ICU_ENTRY_POINT_RENAME( uspoof_getSkeletonUTF8 )
#define uspoof_getSkeletonUnicodeString \
    U_ICU_ENTRY_POINT_RENAME( uspoof_getSkeletonUnicodeString )
#define uspoof_internalInitStatics \
    U_ICU_ENTRY_POINT_RENAME( uspoof_internalInitStatics )
#define uspoof_open U_ICU_ENTRY_POINT_RENAME( uspoof_open )
#define uspoof_openCheckResult \
    U_ICU_ENTRY_POINT_RENAME( uspoof_openCheckResult )
#define uspoof_openFromSerialized \
    U_ICU_ENTRY_POINT_RENAME( uspoof_openFromSerialized )
...
#define uspoof_setAllowedChars \
    U_ICU_ENTRY_POINT_RENAME( uspoof_setAllowedChars )
#define uspoof_setAllowedLocales \
    U_ICU_ENTRY_POINT_RENAME( uspoof_setAllowedLocales )
#define uspoof_setAllowedUnicodeSet \
    U_ICU_ENTRY_POINT_RENAME( uspoof_setAllowedUnicodeSet )
#define uspoof_setChecks U_ICU_ENTRY_POINT_RENAME( uspoof_setChecks )
#define uspoof_setRestrictionLevel \
    U_ICU_ENTRY_POINT_RENAME( uspoof_setRestrictionLevel )
...
#define ustrcase_getCaseLocale \
    U_ICU_ENTRY_POINT_RENAME( ustrcase_getCaseLocale )
#define ustrcase_getTitleBreakIterator \
    U_ICU_ENTRY_POINT_RENAME( ustrcase_getTitleBreakIterator )
#define ustrcase_internalFold U_ICU_ENTRY_POINT_RENAME( ustrcase_internalFold )
#define ustrcase_internalToLower \
    U_ICU_ENTRY_POINT_RENAME( ustrcase_internalToLower )
#define ustrcase_internalToTitle \
    U_ICU_ENTRY_POINT_RENAME( ustrcase_internalToTitle )
#define ustrcase_internalToUpper \
    U_ICU_ENTRY_POINT_RENAME( ustrcase_internalToUpper )
#define ustrcase_map U_ICU_ENTRY_POINT_RENAME( ustrcase_map )
#define ustrcase_mapWithOverlap \
    U_ICU_ENTRY_POINT_RENAME( ustrcase_mapWithOverlap )
...
#define utext_getPreviousNativeIndex \
    U_ICU_ENTRY_POINT_RENAME( utext_getPreviousNativeIndex )
#define utext_hasMetaData U_ICU_ENTRY_POINT_RENAME( utext_hasMetaData )
#define utext_isLengthExpensive \
    U_ICU_ENTRY_POINT_RENAME( utext_isLengthExpensive )
...
#define utext_openCharacterIterator \
    U_ICU_ENTRY_POINT_RENAME( utext_openCharacterIterator )
#define utext_openConstUnicodeString \
    U_ICU_ENTRY_POINT_RENAME( utext_openConstUnicodeString )
...
#define utext_openUnicodeString \
    U_ICU_ENTRY_POINT_RENAME( utext_openUnicodeString )
...
#define utf8_appendCharSafeBody \
    U_ICU_ENTRY_POINT_RENAME( utf8_appendCharSafeBody )
...
#define utmscale_getTimeScaleValue \
    U_ICU_ENTRY_POINT_RENAME( utmscale_getTimeScaleValue )
...
#define utrans_countAvailableIDs \
    U_ICU_ENTRY_POINT_RENAME( utrans_countAvailableIDs )
...
#define utrans_rep_caseContextIterator \
    U_ICU_ENTRY_POINT_RENAME( utrans_rep_caseContextIterator )
...
#define utrans_transIncremental \
    U_ICU_ENTRY_POINT_RENAME( utrans_transIncremental )
#define utrans_transIncrementalUChars \
    U_ICU_ENTRY_POINT_RENAME( utrans_transIncrementalUChars )
#define utrans_transUChars U_ICU_ENTRY_POINT_RENAME( utrans_transUChars )
#define utrans_transliterator_cleanup \
    U_ICU_ENTRY_POINT_RENAME( utrans_transliterator_cleanup )
...
#define utrie2_enumForLeadSurrogate \
    U_ICU_ENTRY_POINT_RENAME( utrie2_enumForLeadSurrogate )
...
#define utrie2_get32FromLeadSurrogateCodeUnit \
    U_ICU_ENTRY_POINT_RENAME( utrie2_get32FromLeadSurrogateCodeUnit )
#define utrie2_internalU8NextIndex \
    U_ICU_ENTRY_POINT_RENAME( utrie2_internalU8NextIndex )
#define utrie2_internalU8PrevIndex \
    U_ICU_ENTRY_POINT_RENAME( utrie2_internalU8PrevIndex )
...
#define utrie2_openFromSerialized \
    U_ICU_ENTRY_POINT_RENAME( utrie2_openFromSerialized )
...
#define utrie2_set32ForLeadSurrogateCodeUnit \
    U_ICU_ENTRY_POINT_RENAME( utrie2_set32ForLeadSurrogateCodeUnit )
...
#define utrie_defaultGetFoldingOffset \
    U_ICU_ENTRY_POINT_RENAME( utrie_defaultGetFoldingOffset )
...
#define utrie_unserializeDummy \
    U_ICU_ENTRY_POINT_RENAME( utrie_unserializeDummy )
...
#define vzone_countTransitionRules \
    U_ICU_ENTRY_POINT_RENAME( vzone_countTransitionRules )
...
#define vzone_getNextTransition \
    U_ICU_ENTRY_POINT_RENAME( vzone_getNextTransition )
...
#define vzone_getPreviousTransition \
    U_ICU_ENTRY_POINT_RENAME( vzone_getPreviousTransition )
#define vzone_getRawOffset U_ICU_ENTRY_POINT_RENAME( vzone_getRawOffset )
#define vzone_getStaticClassID \
    U_ICU_ENTRY_POINT_RENAME( vzone_getStaticClassID )
...
#define ztrans_getDynamicClassID \
    U_ICU_ENTRY_POINT_RENAME( ztrans_getDynamicClassID )
#define ztrans_getFrom U_ICU_ENTRY_POINT_RENAME( ztrans_getFrom )
#define ztrans_getStaticClassID \
    U_ICU_ENTRY_POINT_RENAME( ztrans_getStaticClassID )
