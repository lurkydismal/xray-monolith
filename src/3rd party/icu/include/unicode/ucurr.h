 ...
 * @stable ICU 2.8
 */
U_STABLE int32_t U_EXPORT2 ucurr_forLocale( const char* locale,
                                            UChar* buff,
 ...
 * @return a registry key that can be used to unregister this currency code, or
 * NULL if there was an error.
 * @stable ICU 2.6
 */
U_STABLE UCurrRegistryKey U_EXPORT2 ucurr_register( const UChar* isoCode,
                                                    const char* locale,
                                                    UErrorCode* status );
/**
 ...
 * @stable ICU 2.6
 */
U_STABLE UBool U_EXPORT2 ucurr_unregister( UCurrRegistryKey key,
                                           UErrorCode* status );
 ...
 * @stable ICU 4.2
 */
U_STABLE const UChar* U_EXPORT2 ucurr_getPluralName( const UChar* currency,
                                                     const char* locale,
                                                     UBool* isChoiceFormat,
 ...
 * ucurr_getDefaultFractionDigitsForUsage(currency,UCURR_USAGE_STANDARD,ec);
 *
 ...
 * This is equivalent to
 * ucurr_getRoundingIncrementForUsage(currency,UCURR_USAGE_STANDARD,ec);
 * @param currency null-terminated 3-letter ISO 4217 code
 * @param ec input-output error code
 ...
 *      currencies. Most people will want to use the
 * (UCURR_COMMON|UCURR_NON_DEPRECATED) value to get a list of current
 * currencies.
...
/**
 * Queries if the given ISO 4217 3-letter code is available on the specified
 * date range.
 *
 * Note: For checking availability of a currency on a specific date, specify the
 * date on both 'from' and 'to'
 *
 * When 'from' is U_DATE_MIN and 'to' is U_DATE_MAX, this method checks if the
 * specified currency is available any time. If 'from' and 'to' are same UDate
 * value, this method checks if the specified currency is available on that
 * date.
 *
 * @param isoCode
 ...
 *
 * @param from
 *            The lower bound of the date range, inclusive. When 'from' is
 * U_DATE_MIN, check the availability of the currency any date before 'to'
 *
 * @param to
 *            The upper bound of the date range, inclusive. When 'to' is
 * U_DATE_MAX, check the availability of the currency any date after 'from'
 *
 * @param errorCode
 *            ICU error code
 *
 * @return TRUE if the given ISO 4217 3-letter code is supported on the
 * specified date range.
 *
 * @stable ICU 4.8
 */
U_STABLE UBool U_EXPORT2 ucurr_isAvailable( const UChar* isoCode,
                                            UDate from,
                                            UDate to,
 ...
 * @stable ICU 4.0
 */
U_STABLE int32_t U_EXPORT2 ucurr_countCurrencies( const char* locale,
                                                  UDate date,
                                                  UErrorCode* ec );
 ...
 * @stable ICU 4.0
 */
U_STABLE int32_t U_EXPORT2 ucurr_forLocaleAndDate( const char* locale,
                                                   UDate date,
                                                   int32_t index,
                                                   UChar* buff,
                                                   int32_t buffCapacity,
 ...
 * @stable ICU 49
 */
U_STABLE int32_t U_EXPORT2 ucurr_getNumericCode( const UChar* currency );
