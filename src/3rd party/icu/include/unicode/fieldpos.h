 ...
 * <pre>
 * \code
 *       double doubleNum[] = {123456789.0, -12345678.9, 1234567.89,
 * -123456.789, 12345.6789, -1234.56789, 123.456789, -12.3456789, 1.23456789};
...
public:
     ...
     * @return        TRUE if the two field positions are equal, FALSE
     * otherwise.
     * @stable ICU 2.0
     */
     ...
     * Equality operator.
     * @param that    the object to be compared with.
     * @return        TRUE if the two field positions are not equal, FALSE
     * otherwise.
     * @stable ICU 2.0
     */
    UBool operator!=( const FieldPosition& that ) const;
...
inline FieldPosition& FieldPosition::operator=( const FieldPosition& copy ) {
    fField = copy.fField;
    fEndIndex = copy.fEndIndex;
    fBeginIndex = copy.fBeginIndex;
    return *this;
...
inline UBool FieldPosition::operator==( const FieldPosition& copy ) const {
    return ( fField == copy.fField && fEndIndex == copy.fEndIndex &&
             fBeginIndex == copy.fBeginIndex );
}
