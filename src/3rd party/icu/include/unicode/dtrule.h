...
public:
    ...
    enum DateRuleType {
        ...
        DOW_GEQ_DOM, /**< The first occurence of the day of week on or after the
                        day of monnth, for example, first Sunday on or after
                        March 8. */
        DOW_LEQ_DOM  /**< The last occurence of the day of week on or before the
                        day of month,  for example, first Sunday on or before
                        March 14. */
    };
     ...
     *
     * @param month         The rule month, for example,
     * <code>Calendar::JANUARY</code>
     * @param dayOfMonth    The day of month, 1-based.
     * @param millisInDay   The milliseconds in the rule date.
     * @param timeType      The time type, <code>WALL_TIME</code> or
     * <code>STANDARD_TIME</code> or <code>UTC_TIME</code>.
     * @stable ICU 3.8
     */
    DateTimeRule( int32_t month,
                  int32_t dayOfMonth,
                  int32_t millisInDay,
                  TimeRuleType timeType );

    /**
     * Constructs a <code>DateTimeRule</code> by the day of week and its
     * oridinal number and the time rule.  The date rule type for an instance
     * created by this constructor is <code>DOW</code>.
     *
     * @param month         The rule month, for example,
     * <code>Calendar::JANUARY</code>.
     * @param weekInMonth   The ordinal number of the day of week.  Negative
     * number may be used for specifying a rule date counted from the end of the
     * rule month.
     * @param dayOfWeek     The day of week, for example,
     ...
     * @param dayOfWeek     The day of week, for example,
     * <code>Calendar::SUNDAY</code>.
     * @param after         true if the rule date is on or after the day of
     * month.
     * @param millisInDay   The milliseconds in the rule date.
     * @param timeType      The time type, <code>WALL_TIME</code> or
     * <code>STANDARD_TIME</code> or <code>UTC_TIME</code>.
    ...
    /**
     * Clone this DateTimeRule object polymorphically. The caller owns the
     ...
     * @return The time rule type, either <code>WALL_TIME</code> or
     * <code>STANDARD_TIME</code> or <code>UTC_TIME</code>.
     * @stable ICU 3.8
     */
