 ...
 * <string.h> functions. (For example, they do not check for bad arguments like
 * NULL string pointers.) In some cases, only the thread-safe variant of such a
 * function is implemented here (see u_strtok_r()).
 *
 * Other functions provide more Unicode-specific functionality like
 * locale-specific upper/lower-casing and string comparison in code point order.
 *
 ...
 * extension of the original, fixed-width form that was known as UCS-2. UTF-16
 * superseded UCS-2 with Unicode 2.0 in 1996.)
 *
 * Some APIs accept a 32-bit UChar32 value for a single code point.
 *
 * ICU also handles 16-bit Unicode text with unpaired surrogates.
 * Such text is not well-formed UTF-16.
 * Code-point-related functions treat unpaired surrogates as surrogate code
 * points, i.e., as separate units.
 *
 * Although UTF-16 is a variable-width encoding form (like some legacy
 * multi-byte encodings), it is much more efficient even for random access
 * because the code unit values for single-unit characters vs. lead units vs.
 * trail units are completely disjoint. This means that it is easy to determine
 * character (code point) boundaries from random offsets in the string.
 *
 ...
 * (http://icu-project.org/userguide/strings.html). For a discussion of the
 * handling of unpaired surrogates see also Jitterbug 2145 and its icu mailing
 * list proposal on 2002-sep-18.
 */
 ...
 * @param length The number of UChar code units to be checked, or -1 to count
 * all code points before the first NUL (U+0000).
 * @return The number of code points in the specified code units.
 * @stable ICU 2.0
 */
U_STABLE int32_t U_EXPORT2 u_countChar32( const UChar* s, int32_t length );
 ...
 * @stable ICU 2.4
 */
U_STABLE UBool U_EXPORT2 u_strHasMoreChar32Than( const UChar* s,
                                                 int32_t length,
                                                 int32_t number );
 ...
 * character from <code>src</code> overwrites the null terminator in
 * <code>dst</code>.
 *
 ...
 * @stable ICU 2.0
 */
U_STABLE UChar* U_EXPORT2 u_strcat( UChar* dst, const UChar* src );

/**
 * Concatenate two ustrings.
 * Appends at most <code>n</code> characters from <code>src</code> to
 * <code>dst</code>. Adds a terminating NUL. If src is too long, then only
 * <code>n-1</code> characters will be copied before the terminating NUL. If
 * <code>n&lt;=0</code> then dst is not modified.
 *
 * @param dst The destination string.
 ...
 * @stable ICU 2.0
 */
U_STABLE UChar* U_EXPORT2 u_strncat( UChar* dst, const UChar* src, int32_t n );
 ...
 * @return A pointer to the first occurrence of <code>substring</code> in
 * <code>s</code>, or <code>s</code> itself if the <code>substring</code> is
 * empty, or <code>NULL</code> if <code>substring</code> is not in
 * <code>s</code>.
 * @stable ICU 2.0
 *
 * @see u_strrstr
 ...
 * @see u_strFindLast
 */
U_STABLE UChar* U_EXPORT2 u_strstr( const UChar* s, const UChar* substring );
 ...
 * @param length The length of s (number of UChars), or -1 if it is
 * NUL-terminated.
 * @param substring The substring to find (NUL-terminated).
 * @param subLength The length of substring (number of UChars), or -1 if it is
 * NUL-terminated.
 * @return A pointer to the first occurrence of <code>substring</code> in
 * <code>s</code>, or <code>s</code> itself if the <code>substring</code> is
 * empty, or <code>NULL</code> if <code>substring</code> is not in
 ...
 * @see u_strFindFirst
 */
U_STABLE UChar* U_EXPORT2 u_strchr( const UChar* s, UChar c );
 ...
 * @see u_strFindFirst
 */
U_STABLE UChar* U_EXPORT2 u_strchr32( const UChar* s, UChar32 c );
 ...
 * @param s The string to search (NUL-terminated).
 * @param substring The substring to find (NUL-terminated).
 * @return A pointer to the last occurrence of <code>substring</code> in
 * <code>s</code>, or <code>s</code> itself if the <code>substring</code> is
 * empty, or <code>NULL</code> if <code>substring</code> is not in
 * <code>s</code>.
 * @stable ICU 2.4
 ...
 * @see u_strFindLast
 */
U_STABLE UChar* U_EXPORT2 u_strrstr( const UChar* s, const UChar* substring );
 ...
 * @see u_strFindLast
 */
U_STABLE UChar* U_EXPORT2 u_strrchr( const UChar* s, UChar c );
 ...
 * @see u_strFindLast
 */
U_STABLE UChar* U_EXPORT2 u_strrchr32( const UChar* s, UChar32 c );

/**
 * Locates the first occurrence in the string <code>string</code> of any of the
 * characters in the string <code>matchSet</code>. Works just like C's strpbrk
 * but with Unicode.
 *
 ...
 * @return A pointer to the  character in <code>string</code> that matches one
 * of the characters in <code>matchSet</code>, or NULL if no such character is
 * found.
 * @stable ICU 2.0
 */
U_STABLE UChar* U_EXPORT2 u_strpbrk( const UChar* string,
                                     const UChar* matchSet );

/**
 * Returns the number of consecutive characters in <code>string</code>,
 * beginning with the first, that do not occur somewhere in
 * <code>matchSet</code>. Works just like C's strcspn but with Unicode.
 *
 * @param string The string in which to search, NUL-terminated.
 * @param matchSet A NUL-terminated string defining a set of code points
 *                 for which to search in the text string.
 ...
 * @stable ICU 2.0
 */
U_STABLE UChar* U_EXPORT2 u_strtok_r( UChar* src,
                                      const UChar* delim,
                                      UChar** saveState );
 ...
 * @return 0 if <code>s1</code> and <code>s2</code> are bitwise equal; a
 * negative value if <code>s1</code> is bitwise less than <code>s2,</code>; a
 * positive value if <code>s1</code> is bitwise greater than <code>s2</code>.
 * @stable ICU 2.0
 */
U_STABLE int32_t U_EXPORT2 u_strcmp( const UChar* s1, const UChar* s2 );
 ...
 * @stable ICU 2.0
 */
U_STABLE int32_t U_EXPORT2 u_strcmpCodePointOrder( const UChar* s1,
                                                   const UChar* s2 );
 ...
 * @param n The maximum number of characters to compare; always returns 0 if
 * n<=0.
 * @return 0 if <code>s1</code> and <code>s2</code> are bitwise equal; a
 * negative value if <code>s1</code> is bitwise less than <code>s2</code>; a
 * positive value if <code>s1</code> is bitwise greater than <code>s2</code>.
...
/**
 * Compare two Unicode strings in code point order.
 * This is different in UTF-16 from u_strncmp() if supplementary characters are
 * present. For details, see u_strCompare().
 *
 * @param s1 A string to compare.
 * @param s2 A string to compare.
 ...
 * @stable ICU 2.0
 */
U_STABLE int32_t U_EXPORT2 u_strncmpCodePointOrder( const UChar* s1,
                                                    const UChar* s2,
                                                    int32_t n );

/**
 * Compare two strings case-insensitively using full case folding.
 * This is equivalent to u_strcmp(u_strFoldCase(s1, options), u_strFoldCase(s2,
 * options)).
 *
 * @param s1 A string to compare.
 * @param s2 A string to compare.
 ...
 * @param s1 A string to compare.
 * @param s2 A string to compare.
 * @param n The maximum number of characters each string to case-fold and then
 * compare.
 * @param options A bit set of options:
 *   - U_FOLD_CASE_DEFAULT or 0 is used for default options:
 *     Comparison in code unit order with default case folding.
 ...
 * @stable ICU 2.0
 */
U_STABLE int32_t U_EXPORT2 u_strncasecmp( const UChar* s1,
                                          const UChar* s2,
                                          int32_t n,
                                          uint32_t options );
 ...
 * @param s1 A string to compare.
 * @param s2 A string to compare.
 * @param length The number of characters in each string to case-fold and then
 * compare.
 * @param options A bit set of options:
 *   - U_FOLD_CASE_DEFAULT or 0 is used for default options:
 *     Comparison in code unit order with default case folding.
 ...
 * @stable ICU 2.0
 */
U_STABLE UChar* U_EXPORT2 u_strcpy( UChar* dst, const UChar* src );
 ...
 * @stable ICU 2.0
 */
U_STABLE UChar* U_EXPORT2 u_strncpy( UChar* dst, const UChar* src, int32_t n );
 ...
 * @stable ICU 2.0
 */
U_STABLE UChar* U_EXPORT2 u_uastrcpy( UChar* dst, const char* src );
 ...
 * @stable ICU 2.0
 */
U_STABLE UChar* U_EXPORT2 u_uastrncpy( UChar* dst, const char* src, int32_t n );
 ...
 * @stable ICU 2.0
 */
U_STABLE char* U_EXPORT2 u_austrcpy( char* dst, const UChar* src );
 ...
 * @stable ICU 2.0
 */
U_STABLE char* U_EXPORT2 u_austrncpy( char* dst, const UChar* src, int32_t n );
 ...
 * @stable ICU 2.0
 */
U_STABLE UChar* U_EXPORT2 u_memcpy( UChar* dest,
                                    const UChar* src,
                                    int32_t count );
 ...
 * @stable ICU 2.0
 */
U_STABLE UChar* U_EXPORT2 u_memmove( UChar* dest,
                                     const UChar* src,
                                     int32_t count );

/**
 * Initialize <code>count</code> characters of <code>dest</code> to
 * <code>c</code>.
 *
 * @param dest The destination string.
 ...
 * @stable ICU 2.0
 */
U_STABLE UChar* U_EXPORT2 u_memset( UChar* dest, UChar c, int32_t count );
...
/**
 * Compare two Unicode strings in code point order.
 * This is different in UTF-16 from u_memcmp() if supplementary characters are
 * present. For details, see u_strCompare().
 *
 * @param s1 A string to compare.
 * @param s2 A string to compare.
 ...
 * @stable ICU 2.0
 */
U_STABLE int32_t U_EXPORT2 u_memcmpCodePointOrder( const UChar* s1,
                                                   const UChar* s2,
                                                   int32_t count );
 ...
 * @see u_strFindFirst
 */
U_STABLE UChar* U_EXPORT2 u_memchr( const UChar* s, UChar c, int32_t count );
 ...
 * @see u_strFindLast
 */
U_STABLE UChar* U_EXPORT2 u_memrchr( const UChar* s, UChar c, int32_t count );
 ...
 * @see u_strFindLast
 */
U_STABLE UChar* U_EXPORT2 u_memrchr32( const UChar* s,
                                       UChar32 c,
                                       int32_t count );
 ...
 * and a second macro to dynamically initialize such a string variable if
 * necessary.
 *
...
#define U_STRING_DECL( var, cs, length ) \
    static const UChar* var = ( const UChar* )U_DECLARE_UTF16( cs )
/**@stable ICU 2.0 */
#define U_STRING_INIT( var, cs, length )
#elif U_SIZEOF_WCHAR_T == U_SIZEOF_UCHAR && \
...
#define U_STRING_DECL( var, cs, length ) \
    static const UChar var[ ( length ) + 1 ] = cs
/**@stable ICU 2.0 */
#define U_STRING_INIT( var, cs, length )
#else
 ...
 * @stable ICU 2.0
 */
U_STABLE UChar32 U_EXPORT2 u_unescapeAt( UNESCAPE_CHAR_AT charAt,
                                         int32_t* offset,
                                         int32_t length,
                                         void* context );
 ...
 * zero-terminated if the buffer is large enough.
 ...
 * zero-terminated.
 * @param locale    The locale to consider, or "" for the root locale or NULL
 * for the default locale.
 * @param pErrorCode Must be a valid pointer to an error code value,
 *                  which must not indicate a failure before the function call.
 * @return The length of the result string. It may be greater than destCapacity.
 * In that case, only some of the result was written to the destination buffer.
 * @stable ICU 2.0
 */
 ...
 * @stable ICU 2.0
 */
U_STABLE int32_t U_EXPORT2 u_strToLower( UChar* dest,
                                         int32_t destCapacity,
                                         const UChar* src,
                                         int32_t srcLength,
                                         const char* locale,
 ...
 * @stable ICU 2.0
 */
U_STABLE int32_t U_EXPORT2 u_strFoldCase( UChar* dest,
                                          int32_t destCapacity,
                                          const UChar* src,
                                          int32_t srcLength,
                                          uint32_t options,
 ...
 * If it is known at compile time that wchar_t strings are in UTF-16 or UTF-32,
 * then this function simply calls the fast, dedicated function for that.
 * Otherwise, two conversions UTF-16 -> default charset -> wchar_t* are
 * performed.
 *
 * @param dest          A buffer for the result string. The result will be
 * zero-terminated if the buffer is large enough.
 * @param destCapacity  The size of the buffer (number of wchar_t's). If it is
 * 0, then dest may be NULL and the function will only return the length of the
 *                      result without writing any of the result string
 * (pre-flighting).
 * @param pDestLength   A pointer to receive the number of units written to the
 * destination. If pDestLength!=NULL then *pDestLength is always set to the
 *                      number of output units corresponding to the
 * transformation of all the input units, even in case of a buffer overflow.
 ...
 * @stable ICU 2.0
 */
U_STABLE wchar_t* U_EXPORT2 u_strToWCS( wchar_t* dest,
                                        int32_t destCapacity,
                                        int32_t* pDestLength,
                                        const UChar* src,
                                        int32_t srcLength,
 ...
 * If it is known at compile time that wchar_t strings are in UTF-16 or UTF-32,
 * then this function simply calls the fast, dedicated function for that.
 * Otherwise, two conversions wchar_t* -> default charset -> UTF-16 are
 * performed.
 *
 * @param dest          A buffer for the result string. The result will be
 * zero-terminated if the buffer is large enough.
 ...
 * @stable ICU 2.0
 */
U_STABLE UChar* U_EXPORT2 u_strFromWCS( UChar* dest,
                                        int32_t destCapacity,
                                        int32_t* pDestLength,
                                        const wchar_t* src,
                                        int32_t srcLength,
                                        UErrorCode* pErrorCode );
#endif /* defined(U_WCHAR_IS_UTF16) || defined(U_WCHAR_IS_UTF32) || \
          !UCONFIG_NO_CONVERSION */

/**
 * Convert a UTF-16 string to UTF-8.
 * If the input string is not well-formed, then the U_INVALID_CHAR_FOUND error
 * code is set.
 *
 * @param dest          A buffer for the result string. The result will be
 * zero-terminated if the buffer is large enough.
 * @param destCapacity  The size of the buffer (number of chars). If it is 0,
 * then dest may be NULL and the function will only return the length of the
 *                      result without writing any of the result string
 * (pre-flighting).
 * @param pDestLength   A pointer to receive the number of units written to the
 ...
 * @see u_strFromUTF8
 */
U_STABLE char* U_EXPORT2 u_strToUTF8( char* dest,
                                      int32_t destCapacity,
                                      int32_t* pDestLength,
                                      const UChar* src,
                                      int32_t srcLength,
 ...
 */
U_STABLE UChar* U_EXPORT2 u_strFromUTF8( UChar* dest,
                                         int32_t destCapacity,
                                         int32_t* pDestLength,
                                         const char* src,
                                         int32_t srcLength,
 ...
 * illegal input sequences, instead of stopping with the U_INVALID_CHAR_FOUND
 * error code. With subchar==U_SENTINEL, this function behaves exactly like
 * u_strToUTF8().
 *
 * @param dest          A buffer for the result string. The result will be
 * zero-terminated if the buffer is large enough.
 ...
 * @param srcLength     The length of the original string. If -1, then src must
 * be zero-terminated.
 * @param subchar       The substitution character to use in place of an illegal
 * input sequence, or U_SENTINEL if the function is to return with
 * U_INVALID_CHAR_FOUND instead. A substitution character can be any valid
 * Unicode code point (up to U+10FFFF) except for surrogate code points
 * (U+D800..U+DFFF). The recommended value is U+FFFD "REPLACEMENT CHARACTER".
 * @param pNumSubstitutions Output parameter receiving the number of
 * substitutions if subchar>=0. Set to 0 if no substitutions occur or subchar<0.
 *                      pNumSubstitutions can be NULL.
 * @param pErrorCode    Pointer to a standard ICU error code. Its input value
 * must pass the U_SUCCESS() test, or else the function returns immediately.
 * Check for U_FAILURE() on output or use with function chaining. (See User
 * Guide for details.)
 * @return The pointer to destination buffer.
 * @see u_strToUTF8
 * @see u_strFromUTF8WithSub
 * @stable ICU 3.6
 */
U_STABLE char* U_EXPORT2 u_strToUTF8WithSub( char* dest,
                                             int32_t destCapacity,
                                             int32_t* pDestLength,
                                             const UChar* src,
                                             int32_t srcLength,
 ...
 * Convert a UTF-8 string to UTF-16.
 *
 * Same as u_strFromUTF8() except that this function is designed to be very
 * fast, which it achieves by being lenient about malformed UTF-8 sequences.
 ...
 *
 * There is no inverse u_strToUTF8Lenient() function because there is
 * practically no performance gain from not checking that a UTF-16 string is
 * well-formed.
 *
 * @param dest          A buffer for the result string. The result will be
 * zero-terminated if the buffer is large enough.
 ...
 * then dest may be NULL and the function will only return the length of the
 *                      result without writing any of the result string
 * (pre-flighting). Unlike for other ICU functions, if srcLength>=0 then it must
 * be destCapacity>=srcLength.
 * @param pDestLength   A pointer to receive the number of units written to the
 * destination. If pDestLength!=NULL then *pDestLength is always set to the
 *                      number of output units corresponding to the
 * transformation of all the input units, even in case of a buffer overflow.
 *                      Unlike for other ICU functions, if srcLength>=0 but
 *                      destCapacity<srcLength, then *pDestLength will be set to
 * srcLength (and U_BUFFER_OVERFLOW_ERROR will be set) regardless of the actual
 * result length.
 * @param src           The original source string
 * @param srcLength     The length of the original string. If -1, then src must
 * be zero-terminated.
 ...
 * @param dest          A buffer for the result string. The result will be
 * zero-terminated if the buffer is large enough.
 * @param destCapacity  The size of the buffer (number of UChar32s). If it is 0,
 * then dest may be NULL and the function will only return the length of the
 *                      result without writing any of the result string
 * (pre-flighting).
 * @param pDestLength   A pointer to receive the number of units written to the
 ...
 * @stable ICU 2.0
 */
U_STABLE UChar* U_EXPORT2 u_strFromUTF32( UChar* dest,
                                          int32_t destCapacity,
                                          int32_t* pDestLength,
                                          const UChar32* src,
                                          int32_t srcLength,
 ...
 * Convert a UTF-32 string to UTF-16.
 *
 * Same as u_strFromUTF32() except for the additional subchar which is output
 * for illegal input sequences, instead of stopping with the
 * U_INVALID_CHAR_FOUND error code. With subchar==U_SENTINEL, this function
 * behaves exactly like u_strFromUTF32().
 *
 * @param dest          A buffer for the result string. The result will be
 * zero-terminated if the buffer is large enough.
 * @param destCapacity  The size of the buffer (number of UChars). If it is 0,
 ...
 * @stable ICU 4.2
 */
U_STABLE UChar* U_EXPORT2 u_strFromUTF32WithSub( UChar* dest,
                                                 int32_t destCapacity,
                                                 int32_t* pDestLength,
                                                 const UChar32* src,
                                                 int32_t srcLength,
 ...
 *
 * This function behaves according to the documentation for Java
 * DataOutput.writeUTF() except that it does not encode the output length in the
 * destination buffer and does not have an output length restriction. See
 ...
 */
U_STABLE char* U_EXPORT2 u_strToJavaModifiedUTF8( char* dest,
                                                  int32_t destCapacity,
                                                  int32_t* pDestLength,
                                                  const UChar* src,
                                                  int32_t srcLength,
 ...
 *
 * This function behaves according to the documentation for Java
 * DataInput.readUTF() except that it takes a length parameter rather than
...
u_strFromJavaModifiedUTF8WithSub( UChar* dest,
                                  int32_t destCapacity,
                                  int32_t* pDestLength,
                                  const char* src,
                                  int32_t srcLength,
