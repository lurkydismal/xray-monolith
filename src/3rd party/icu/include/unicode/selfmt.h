 ...
 * When names or nouns are inserted into sentences, their gender can  affect
 * pronouns, verb forms, articles, and adjectives. Special care needs to be
 ...
 * arbitrary, even for nouns referring to people ("M&#x00E4;dchen", girl, is
 * neutral). The gender affects pronouns ("er", "sie", "es"), articles ("der",
 * "die", "das"), and adjective forms ("guter Mann", "gute Frau", "gutes
 * M&#x00E4;dchen").
 *
 ...
 * we usually need to distinguish only between female, male and
 * other/unknown.</p>
 *
 ...
 *
 * <ul>
 * <li>For people, natural gender information should be maintained  for each
 * person. Keywords like "male", "female", "mixed" (for groups of people) and
 * "unknown" could be used.
 *
 ...
 * <pre>{0} went to {2}.</pre>
 *
 * <p><b>Note:</b> The entire sentence should be included (and partially
 * repeated) inside each phrase. Otherwise translators would have to be trained
 * on how to move bits of the sentence in and out of the select argument of a
 * message. (The examples below do not follow this recommendation!)</p>
 *
 * <p>The sentence pattern for French, where the gender of the person affects
 * the form of the participle, uses a select format based on argument 1:</p>
 *
 * \htmlonly<pre>{0} est {1, select, female {all&#x00E9;e} other {all&#x00E9;}}
 * &#x00E0; {2}.</pre>\endhtmlonly
 *
 ...
 * \htmlonly
 * <pre>{0} {1, plural,
 *                 one {est {2, select, female {all&#x00E9;e} other
 * {all&#x00E9;}}} other {sont {2, select, female {all&#x00E9;es} other
 * {all&#x00E9;s}}}
 *          }&#x00E0; {3}.</pre>
 * \endhtmlonly
 *
 ...
 * [^[[:Pattern_Syntax:][:Pattern_White_Space:]]]+</p>
 *
 ...
 * MessageFormat *msgFmt = new MessageFormat(UnicodeString("{0} est  {1, select,
 * female {all&#x00E9;e} other {all&#x00E9;}} &#x00E0; Paris."), Locale("fr"),
...
private:
    ...
    /**
     * Finds the SelectFormat sub-message for the given keyword, or the "other"
     * sub-message.
     * @param pattern A MessagePattern.
     * @param partIndex the index of the first SelectFormat argument style part.
     * @param keyword a keyword to be matched to one of the SelectFormat
     * argument's keywords.
     * @param ec Error code.
