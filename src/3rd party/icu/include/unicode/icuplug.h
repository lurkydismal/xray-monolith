 ...
 *
 * <p>C API allowing run-time loadable modules that extend or modify ICU
 * functionality.</p>
 *
 ...
 * Plugins are otherwise loaded in the order listed in the configuration
 * file.</p>
 *
 ...
 * SHOULD call uplug_setPlugName to indicate a human readable plugin
 * name.</li></ol>
 *
 *
 ...
 */
typedef enum {
    UPLUG_LEVEL_INVALID = 0, /**< The plugin is invalid, hasn't called
                                uplug_setLevel, or can't load. **/
 ...
 * @internal ICU 4.4 Technology Preview
 */
U_INTERNAL void U_EXPORT2 uplug_setPlugNoUnload( UPlugData* plug,
                                                 UBool dontUnload );
 ...
 * @internal ICU 4.4 Technology Preview
 */
U_INTERNAL void U_EXPORT2 uplug_setPlugLevel( UPlugData* plug,
                                              UPlugLevel level );
 ...
 * @internal ICU 4.4 Technology Preview
 */
U_INTERNAL UPlugLevel U_EXPORT2 uplug_getPlugLevel( UPlugData* plug );
 ...
 * @internal ICU 4.4 Technology Preview
 */
U_INTERNAL UErrorCode U_EXPORT2 uplug_getPlugLoadStatus( UPlugData* plug );
 ...
 * @internal ICU 4.4 Technology Preview
 */
U_INTERNAL void U_EXPORT2 uplug_setPlugName( UPlugData* plug,
                                             const char* name );
 ...
 * @internal ICU 4.4 Technology Preview
 */
U_INTERNAL const char* U_EXPORT2 uplug_getPlugName( UPlugData* plug );
 ...
 * @internal ICU 4.4 Technology Preview
 */
U_INTERNAL const char* U_EXPORT2 uplug_getSymbolName( UPlugData* plug );
 ...
 * @internal ICU 4.4 Technology Preview
 */
U_INTERNAL const char* U_EXPORT2 uplug_getLibraryName( UPlugData* plug,
                                                       UErrorCode* status );
 ...
 * @internal ICU 4.4 Technology Preview
 */
U_INTERNAL void* U_EXPORT2 uplug_getLibrary( UPlugData* plug );
 ...
 * @internal ICU 4.4 Technology Preview
 */
U_INTERNAL void* U_EXPORT2 uplug_getContext( UPlugData* plug );
 ...
 * @internal ICU 4.4 Technology Preview
 */
U_INTERNAL void U_EXPORT2 uplug_setContext( UPlugData* plug, void* context );
 ...
 * @internal ICU 4.4 Technology Preview
 */
U_INTERNAL const char* U_EXPORT2 uplug_getConfiguration( UPlugData* plug );
 ...
 * @internal ICU 4.4 Technology Preview
 */
U_INTERNAL UPlugData* U_EXPORT2 uplug_nextPlug( UPlugData* prior );
...
uplug_loadPlugFromEntrypoint( UPlugEntrypoint* entrypoint,
                              const char* config,
                              UErrorCode* status );

/**
 * Inject a plugin from a library, as if the information came from a config
 * file. Low level plugins may not be able to load, and ordering can't be
 * enforced.
 ...
 * @internal ICU 4.4 Technology Preview
 */
U_INTERNAL UPlugData* U_EXPORT2 uplug_loadPlugFromLibrary( const char* libName,
                                                           const char* sym,
                                                           const char* config,
                                                           UErrorCode* status );
 ...
 * @internal ICU 4.4 Technology Preview
 */
U_INTERNAL void U_EXPORT2 uplug_removePlug( UPlugData* plug,
                                            UErrorCode* status );
