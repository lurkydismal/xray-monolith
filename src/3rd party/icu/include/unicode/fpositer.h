...
/**
 * FieldPositionIterator returns the field ids and their start/limit positions
 * generated by a call to Format::format.  See Format, NumberFormat,
 * DecimalFormat.
 * @stable ICU 4.4
 */
...
public:
    ...
    /**
     * Copy constructor.  If the copy failed for some reason, the new iterator
     * will be empty.
     * @stable ICU 4.4
     */
    ...
    /**
     * If the current position is valid, updates the FieldPosition values,
