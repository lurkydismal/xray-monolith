 ...
 * &lt;set_num&gt;%&lt;msg_num&gt; where set_num is the set number and msg_num
 * is the message number, formatted as decimal strings.
 *
 ...
 * @stable ICU 2.6
 */
U_STABLE u_nl_catd U_EXPORT2 u_catopen( const char* name,
                                        const char* locale,
                                        UErrorCode* ec );
 ...
 * @stable ICU 2.6
 */
U_STABLE void U_EXPORT2 u_catclose( u_nl_catd catd );
 ...
 * @stable ICU 2.6
 */
U_STABLE const UChar* U_EXPORT2 u_catgets( u_nl_catd catd,
                                           int32_t set_num,
                                           int32_t msg_num,
                                           const UChar* s,
                                           int32_t* len,
