 ...
 * <pre>
 * .       "<ae ligature>b"-> the first key is key('a'), the second key is
 * key('e'), and .       the third key is key('b').
 * </pre>
 ...
 * @stable ICU 2.0
 */
U_STABLE UCollationElements* U_EXPORT2 ucol_openElements( const UCollator* coll,
                                                          const UChar* text,
                                                          int32_t textLength,
                                                          UErrorCode* status );
 ...
 * @stable ICU 2.0
 */
U_STABLE int32_t U_EXPORT2 ucol_keyHashCode( const uint8_t* key,
                                             int32_t length );
 ...
 * UCOL_NULLORDER if an error has occured or if the end of string has been
 * reached
 * @stable ICU 2.0
 */
U_STABLE int32_t U_EXPORT2 ucol_next( UCollationElements* elems,
                                      UErrorCode* status );
 ...
 * @stable ICU 2.0
 */
U_STABLE int32_t U_EXPORT2 ucol_previous( UCollationElements* elems,
                                          UErrorCode* status );
 ...
 * @stable ICU 2.0
 */
U_STABLE void U_EXPORT2 ucol_setOffset( UCollationElements* elems,
                                        int32_t offset,
                                        UErrorCode* status );
