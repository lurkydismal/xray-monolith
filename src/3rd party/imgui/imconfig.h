...
#define IMGUI_DISABLE_DEFAULT_ALLOCATORS // Don't implement default allocators
                                         // calling malloc()/free() to avoid
...
// - lunasvg is currently easier to acquire/install, as e.g. it is part of
// vcpkg.
// - plutosvg will support more fonts and may load them faster. It currently
// requires to be built manually but it is fairly easy. See misc/freetype/README
// for instructions.
