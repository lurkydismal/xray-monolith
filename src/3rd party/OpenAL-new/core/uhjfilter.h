...
enum class UhjQualityType : uint8_t { IIR = 0, FIR256, FIR512, Default = IIR };
...
struct UhjAllPassFilter {
    ...
    void process( const al::span< const float, 4 > coeffs,
...
struct UhjEncoderBase {
     ...
     */
    virtual void encode( float* LeftOut,
                         float* RightOut,
                         const al::span< const float* const, 3 > InSamples,
                         const size_t SamplesToDo ) = 0;
};
...
struct UhjEncoder final : public UhjEncoderBase {
    ...
    alignas(
        16 ) std::array< std::array< float, sFilterDelay >, 2 > mDirectDelay{};
...
struct DecoderBase {
    ...
    virtual void decode( const al::span< float* > samples,
...
struct UhjDecoder final : public DecoderBase {
    ...
    alignas(
        16 ) std::array< float, BufferLineSize + sInputPadding * 2 > mTemp{};
     ...
     */
    void decode( const al::span< float* > samples,
                 const size_t samplesToDo,
