 ...
 */
constexpr std::array< std::array< float, MaxAmbiOrder + 1 >, MaxAmbiOrder + 1 >
    HFScales{ {
        { { 4.000000000e+00f, 2.309401077e+00f, 1.192569588e+00f,
            7.189495850e-01f } },
        { { 4.000000000e+00f, 2.309401077e+00f, 1.192569588e+00f,
            7.189495850e-01f } },
        { { 2.981423970e+00f, 2.309401077e+00f, 1.192569588e+00f,
            7.189495850e-01f } },
        { { 2.359168820e+00f, 2.031565936e+00f, 1.444598386e+00f,
            7.189495850e-01f } },
        /* 1.947005434e+00f, 1.764337084e+00f, 1.424707344e+00f, 9.755104127e-01f,
           4.784482742e-01f */
    } };
...
constexpr std::array< std::array< float, MaxAmbiOrder + 1 >, MaxAmbiOrder + 1 >
    HFScales2D{ {
        { { 2.236067977e+00f, 1.581138830e+00f, 9.128709292e-01f,
            6.050756345e-01f } },
        { { 2.236067977e+00f, 1.581138830e+00f, 9.128709292e-01f,
            6.050756345e-01f } },
        { { 1.825741858e+00f, 1.581138830e+00f, 9.128709292e-01f,
            6.050756345e-01f } },
        { { 1.581138830e+00f, 1.460781803e+00f, 1.118033989e+00f,
            6.050756345e-01f } },
        /* 1.414213562e+00f, 1.344997024e+00f, 1.144122806e+00f, 8.312538756e-01f,
           4.370160244e-01f */
    } };
...
static_assert( FirstOrderDecoder.size() == FirstOrderEncoder.size(),
...
static_assert( FirstOrder2DDecoder.size() == FirstOrder2DEncoder.size(),
               "First-order 2D mismatch" );
...
static_assert( SecondOrderDecoder.size() == SecondOrderEncoder.size(),
               "Second-order mismatch" );
...
static_assert( ThirdOrderDecoder.size() == ThirdOrderEncoder.size(),
               "Third-order mismatch" );
...
static_assert( ThirdOrder2DDecoder.size() == ThirdOrder2DEncoder.size(),
               "Third-order 2D mismatch" );
...
static_assert( FourthOrder2DDecoder.size() == FourthOrder2DEncoder.size(),
               "Fourth-order 2D mismatch" );

template < size_t N, size_t M >
auto CalcAmbiUpsampler(
    const std::array< std::array< float, N >, M >& decoder,
...
const std::array< AmbiChannelFloatArray, 4 > AmbiScale::FirstOrderUp{
    CalcAmbiUpsampler( FirstOrderDecoder, FirstOrderEncoder ) };
const std::array< AmbiChannelFloatArray, 4 > AmbiScale::FirstOrder2DUp{
    CalcAmbiUpsampler( FirstOrder2DDecoder, FirstOrder2DEncoder ) };
const std::array< AmbiChannelFloatArray, 9 > AmbiScale::SecondOrderUp{
    CalcAmbiUpsampler( SecondOrderDecoder, SecondOrderEncoder ) };
const std::array< AmbiChannelFloatArray, 9 > AmbiScale::SecondOrder2DUp{
    CalcAmbiUpsampler( SecondOrder2DDecoder, SecondOrder2DEncoder ) };
const std::array< AmbiChannelFloatArray, 16 > AmbiScale::ThirdOrderUp{
    CalcAmbiUpsampler( ThirdOrderDecoder, ThirdOrderEncoder ) };
const std::array< AmbiChannelFloatArray, 16 > AmbiScale::ThirdOrder2DUp{
    CalcAmbiUpsampler( ThirdOrder2DDecoder, ThirdOrder2DEncoder ) };
const std::array< AmbiChannelFloatArray, 25 > AmbiScale::FourthOrder2DUp{
    CalcAmbiUpsampler( FourthOrder2DDecoder, FourthOrder2DEncoder ) };

std::array< float, MaxAmbiOrder + 1 > AmbiScale::GetHFOrderScales(
    ...
    if ( !horizontalOnly ) {
        ...
        for ( size_t i{ 0 }; i < MaxAmbiOrder + 1; ++i )
            res[ i ] =
                HFScales2D[ src_order ][ i ] / HFScales2D[ dev_order ][ i ];
    }
