...
void NfcFilter::process1( const al::span< const float > src,
                          float* RESTRICT dst ) {
    const float gain{ first.gain };
    const float b1{ first.b1 };
    const float a1{ first.a1 };
    float z1{ first.z[ 0 ] };
    auto proc_sample = [ gain, b1, a1,
                         &z1 ]( const float in ) noexcept -> float {
...
void NfcFilter::process2( const al::span< const float > src,
                          float* RESTRICT dst ) {
    ...
    float z1{ second.z[ 0 ] };
    float z2{ second.z[ 1 ] };
    auto proc_sample = [ gain, b1, b2, a1, a2, &z1,
                         &z2 ]( const float in ) noexcept -> float {
...
void NfcFilter::process3( const al::span< const float > src,
                          float* RESTRICT dst ) {
    ...
    float z2{ third.z[ 1 ] };
    float z3{ third.z[ 2 ] };
    auto proc_sample = [ gain, b1, b2, b3, a1, a2, a3, &z1, &z2,
                         &z3 ]( const float in ) noexcept -> float {
...
void NfcFilter::process4( const al::span< const float > src,
                          float* RESTRICT dst ) {
    ...
    float z3{ fourth.z[ 2 ] };
    float z4{ fourth.z[ 3 ] };
    auto proc_sample = [ gain, b1, b2, b3, b4, a1, a2, a3, a4, &z1, &z2, &z3,
                         &z4 ]( const float in ) noexcept -> float {
        float y{ in * gain - a1 * z1 - a2 * z2 };
        float out{ y + b1 * z1 + b2 * z2 };
        z2 += z1;
        z1 += y;
