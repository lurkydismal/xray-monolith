...
class BiquadFilterR {
    ...
    static Real rcpQFromSlope( Real gain, Real slope ) {
        return std::sqrt( ( gain + Real{ 1 } / gain ) *
                              ( Real{ 1 } / slope - Real{ 1 } ) +
                          Real{ 2 } );
    }
    ...
    static Real rcpQFromBandwidth( Real f0norm, Real bandwidth ) {
        ...
        return 2.0f * std::sinh( std::log( Real{ 2 } ) / Real{ 2 } * bandwidth *
                                 w0 / std::sin( w0 ) );
    }
...
public:
     ...
     */
    void setParamsFromSlope( BiquadType type,
                             Real f0norm,
                             Real gain,
                             Real slope ) {
     ...
     */
    void setParamsFromBandwidth( BiquadType type,
                                 Real f0norm,
                                 Real gain,
                                 Real bandwidth ) {
    ...
    void dualProcess( BiquadFilterR& other,
