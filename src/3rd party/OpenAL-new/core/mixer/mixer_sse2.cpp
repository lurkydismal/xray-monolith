...
template <>
void Resample_< LerpTag, SSE2Tag >( const InterpState*,
    ...
    const __m128i increment4{
        _mm_set1_epi32( static_cast< int >( increment * 4 ) ) };
    ...
    __m128i frac4{ _mm_setr_epi32(
        static_cast< int >( frac_[ 0 ] ), static_cast< int >( frac_[ 1 ] ),
        static_cast< int >( frac_[ 2 ] ), static_cast< int >( frac_[ 3 ] ) ) };
    __m128i pos4{ _mm_setr_epi32(
        static_cast< int >( pos_[ 0 ] ), static_cast< int >( pos_[ 1 ] ),
    ...
    for ( size_t todo{ dst.size() >> 2 }; todo; --todo ) {
        ...
        const __m128 val1{
            _mm_setr_ps( src[ pos0 ], src[ pos1 ], src[ pos2 ], src[ pos3 ] ) };
        const __m128 val2{ _mm_setr_ps( src[ pos0 + 1 ], src[ pos1 + 1 ],
