...
semaphore::semaphore( unsigned int initial ) {
    ...
    mSem = CreateSemaphore( nullptr, initial, std::numeric_limits< int >::max(),
                            nullptr );
    if ( mSem == nullptr )
        throw std::system_error(
...
bool semaphore::try_wait() noexcept {
    return WaitForSingleObject( static_cast< HANDLE >( mSem ), 0 ) ==
           WAIT_OBJECT_0;
}
...
void setname_caller( setname_t4 func, const char* name ) {
    func( pthread_self(), "%s",
          static_cast< void* >( const_cast< char* >( name ) ) );
}
...
void althrd_setname( const char* name ) {
    ...
    std::ignore = name;
    std::ignore =
        static_cast< void ( * )( setname_t1, const char* ) >( &setname_caller );
    std::ignore =
        static_cast< void ( * )( setname_t2, const char* ) >( &setname_caller );
    std::ignore =
        static_cast< void ( * )( setname_t3, const char* ) >( &setname_caller );
    std::ignore =
        static_cast< void ( * )( setname_t4, const char* ) >( &setname_caller );
}
