...
struct ALsource {
     ...
     */
    std::array< float, 2 > StereoPan{ { al::numbers::pi_v< float > / 6.0f,
                                        -al::numbers::pi_v< float > / 6.0f } };
...
private:
    ...
    using EaxSpeakerLevels =
        std::array< EAXSPEAKERLEVELPROPERTIES, eax_max_speakers >;
    ...
    struct Eax1SourceReverbMixValidator {
        void operator()( float reverb_mix ) const {
            ...
            eax_validate_range< Exception >( "Reverb Mix", reverb_mix,
    ...
    struct Eax2SourceDirectValidator {
        void operator()( long lDirect ) const {
            eax_validate_range< Exception >(
                "Direct", lDirect, EAXSOURCE_MINDIRECT, EAXSOURCE_MAXDIRECT );
        }
    };

    struct Eax2SourceDirectHfValidator {
        void operator()( long lDirectHF ) const {
            eax_validate_range< Exception >( "Direct HF", lDirectHF,
    ...
    struct Eax2SourceRoomValidator {
        void operator()( long lRoom ) const {
            eax_validate_range< Exception >( "Room", lRoom, EAXSOURCE_MINROOM,
                                             EAXSOURCE_MAXROOM );
        }
    };
    ...
    struct Eax2SourceRoomHfValidator {
        void operator()( long lRoomHF ) const {
            eax_validate_range< Exception >(
                "Room HF", lRoomHF, EAXSOURCE_MINROOMHF, EAXSOURCE_MAXROOMHF );
        }
    };

    struct Eax2SourceRoomRolloffFactorValidator {
        void operator()( float flRoomRolloffFactor ) const {
            eax_validate_range< Exception >( "Room Rolloff Factor",
                                             flRoomRolloffFactor,
    ...
    struct Eax2SourceObstructionValidator {
        void operator()( long lObstruction ) const {
            eax_validate_range< Exception >( "Obstruction", lObstruction,
    ...
    struct Eax2SourceObstructionLfRatioValidator {
        void operator()( float flObstructionLFRatio ) const {
            eax_validate_range< Exception >( "Obstruction LF Ratio",
    ...
    struct Eax2SourceOcclusionValidator {
        void operator()( long lOcclusion ) const {
            eax_validate_range< Exception >( "Occlusion", lOcclusion,
    ...
    struct Eax2SourceOcclusionLfRatioValidator {
        void operator()( float flOcclusionLFRatio ) const {
            eax_validate_range< Exception >(
                "Occlusion LF Ratio", flOcclusionLFRatio,
                EAXSOURCE_MINOCCLUSIONLFRATIO, EAXSOURCE_MAXOCCLUSIONLFRATIO );
        }
    };

    struct Eax2SourceOcclusionRoomRatioValidator {
        void operator()( float flOcclusionRoomRatio ) const {
            eax_validate_range< Exception >( "Occlusion Room Ratio",
    ...
    struct Eax2SourceOutsideVolumeHfValidator {
        void operator()( long lOutsideVolumeHF ) const {
            eax_validate_range< Exception >(
                "Outside Volume HF", lOutsideVolumeHF,
                EAXSOURCE_MINOUTSIDEVOLUMEHF, EAXSOURCE_MAXOUTSIDEVOLUMEHF );
        }
    };

    struct Eax2SourceAirAbsorptionFactorValidator {
        void operator()( float flAirAbsorptionFactor ) const {
            eax_validate_range< Exception >( "Air Absorption Factor",
    ...
    struct Eax2SourceFlagsValidator {
        void operator()( unsigned long dwFlags ) const {
            eax_validate_range< Exception >( "Flags", dwFlags, 0UL,
    ...
    struct Eax3SourceOcclusionDirectRatioValidator {
        void operator()( float flOcclusionDirectRatio ) const {
            eax_validate_range< Exception >(
                "Occlusion Direct Ratio", flOcclusionDirectRatio,
    ...
    struct Eax3SourceExclusionValidator {
        void operator()( long lExclusion ) const {
            eax_validate_range< Exception >( "Exclusion", lExclusion,
    ...
    struct Eax3SourceExclusionLfRatioValidator {
        void operator()( float flExclusionLFRatio ) const {
            eax_validate_range< Exception >(
                "Exclusion LF Ratio", flExclusionLFRatio,
                EAXSOURCE_MINEXCLUSIONLFRATIO, EAXSOURCE_MAXEXCLUSIONLFRATIO );
        }
    };

    struct Eax3SourceDopplerFactorValidator {
        void operator()( float flDopplerFactor ) const {
            eax_validate_range< Exception >( "Doppler Factor", flDopplerFactor,
    ...
    struct Eax3SourceRolloffFactorValidator {
        void operator()( float flRolloffFactor ) const {
            eax_validate_range< Exception >( "Rolloff Factor", flRolloffFactor,
    ...
    struct Eax5SourceMacroFXFactorValidator {
        void operator()( float flMacroFXFactor ) const {
            eax_validate_range< Exception >( "Macro FX Factor", flMacroFXFactor,
    ...
    struct Eax5SourceAllValidator {
        void operator()( const EAX50SOURCEPROPERTIES& props ) const {
            Eax3SourceAllValidator{}(
                static_cast< const Eax3Props& >( props ) );
    ...
    struct Eax4SendSendValidator {
        void operator()( long lSend ) const {
            eax_validate_range< Exception >( "Send", lSend, EAXSOURCE_MINSEND,
                                             EAXSOURCE_MAXSEND );
        }
    };
    ...
    struct Eax4SendSendHfValidator {
        void operator()( long lSendHF ) const {
            eax_validate_range< Exception >(
                "Send HF", lSendHF, EAXSOURCE_MINSENDHF, EAXSOURCE_MAXSENDHF );
        }
    };
    ...
    struct Eax5ActiveFxSlotIdValidator {
        void operator()( const GUID& guid ) const {
            if ( guid != EAX_NULL_GUID && guid != EAX_PrimaryFXSlotID &&
                 ...
                 guid != EAXPROPERTYID_EAX50_FXSlot3 ) {
                eax_fail_unknown_active_fx_slot_id();
            }
        }
    };
    ...
    void eax_set_sends_defaults( EaxSends& sends,
    ...
    void eax4_set_active_fx_slots_defaults(
    ...
    void eax5_set_active_fx_slots_defaults(
        EAX50ACTIVEFXSLOTS& slots ) noexcept;
    void eax5_set_speaker_levels_defaults(
    ...
    static float eax_calculate_dst_occlusion_mb( long src_occlusion_mb,
                                                 float path_ratio,
    ...
    void eax_get_active_fx_slot_id( const EaxCall& call,
                                    const GUID* ids,
                                    size_t max_count );
    ...
    void eax5_get_all_2d( const EaxCall& call,
                          const EAX50SOURCEPROPERTIES& props );
    void eax5_get_speaker_levels( const EaxCall& call,
    ...
    void eax_defer_sends( const EaxCall& call, EaxSends& dst_sends ) {
        const auto src_sends =
            call.get_values< const TSrcSend >( EAX_MAX_FXSLOTS );
        ...
        for ( auto i = decltype( count ){}; i < count; ++i ) {
            ...
            const auto dst_index =
                index_getter( src_send.guidReceivingFXSlotID );
    ...
    void eax4_defer_sends( const EaxCall& call, EaxSends& dst_sends ) {
        eax_defer_sends< TValidator, Eax4SendIndexGetter, TSrcSend >(
            call, dst_sends );
    }

    template < typename TValidator, typename TSrcSend >
    void eax5_defer_sends( const EaxCall& call, EaxSends& dst_sends ) {
        eax_defer_sends< TValidator, Eax5SendIndexGetter, TSrcSend >(
            call, dst_sends );
    }

    template < typename TValidator, size_t TIdCount >
    void eax_defer_active_fx_slot_id( const EaxCall& call,
                                      GUID ( &dst_ids )[ TIdCount ] ) {
    ...
    void eax4_defer_active_fx_slot_id( const EaxCall& call,
                                       GUID ( &dst_ids )[ TIdCount ] ) {
        eax_defer_active_fx_slot_id< Eax4ActiveFxSlotIdValidator >( call,
                                                                    dst_ids );
    }

    template < size_t TIdCount >
    void eax5_defer_active_fx_slot_id( const EaxCall& call,
                                       GUID ( &dst_ids )[ TIdCount ] ) {
        eax_defer_active_fx_slot_id< Eax5ActiveFxSlotIdValidator >( call,
                                                                    dst_ids );
    }
    ...
    void eax_defer_sub( const EaxCall& call, TProperty& property ) {
        const auto& src_props =
            call.get_value< Exception, const TSubproperty >();
    ...
    void eax5_defer_speaker_levels( const EaxCall& call,
    ...
    void eax_set_al_source_send( ALeffectslot* slot,
                                 size_t sendidx,
