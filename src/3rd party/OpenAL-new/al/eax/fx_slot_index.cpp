...
public:
    explicit EaxFxSlotIndexException( const char* message )
...
void EaxFxSlotIndex::set( const GUID& guid ) {
    if ( false ) {
        ...
        reset();
    } else if ( guid == EAXPROPERTYID_EAX40_FXSlot0 ||
                guid == EAXPROPERTYID_EAX50_FXSlot0 ) {
        emplace( 0u );
    } else if ( guid == EAXPROPERTYID_EAX40_FXSlot1 ||
                guid == EAXPROPERTYID_EAX50_FXSlot1 ) {
        emplace( 1u );
    } else if ( guid == EAXPROPERTYID_EAX40_FXSlot2 ||
                guid == EAXPROPERTYID_EAX50_FXSlot2 ) {
        emplace( 2u );
    } else if ( guid == EAXPROPERTYID_EAX40_FXSlot3 ||
