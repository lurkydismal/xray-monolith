...
public:
    ...
    void setAll() { m_bitArray.setAll(); }

    void toggleAll() { m_bitArray.toggleAll(); }
...
NVIMAGE_API void fillExtrapolate( int passCount,
                                  FloatImage* img,
                                  BitMap* bmap );
NVIMAGE_API void fillQuadraticExtrapolate( int passCount,
                                           FloatImage* img,
                                           BitMap* bmap,
                                           int coverageIndex = -1 );
