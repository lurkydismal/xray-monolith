...
struct Basis {
    ...
    Basis( Vector3::Arg n, Vector3::Arg t, float sign ) { build( n, t, sign ); }
    ...
    float handness() const { return determinant() > 0.0f ? 1.0f : -1.0f; }
    ...
    float determinant() const {
        return tangent.x() * bitangent.y() * normal.z() -
               ...
               tangent.y() * bitangent.z() * normal.x() -
               tangent.y() * bitangent.x() * normal.z() +
               tangent.z() * bitangent.x() * normal.y() -
