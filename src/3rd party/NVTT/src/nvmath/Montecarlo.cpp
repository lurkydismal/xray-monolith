...
void SampleDistribution::redistribute(
    Method method /*=Method_NRook*/,
...
void SampleDistribution::redistributeStratified( const Distribution dist ) {
    ...
    nvDebugCheck( sqrtSampleCount * sqrtSampleCount ==
                  sampleCount ); // Must use exact powers!

    // Create a uniform distribution of points on the hemisphere with low
    // variance.
