 ...
 *
 * Special thanks to Troels Knakkergaard for new features, enhancements and
 * bugfixes
 *
...
#define EXIF_READ_ALL 0x03
    ...
    protected:
        ...
        bool ProcessExifDir( unsigned char* DirStart,
    ...
    public:
        ...
        static void TermSource( j_decompress_ptr /*cinfo*/ ) { return; }
