...
/// <summary>
/// Converts the specified format <paramref name="value"/> to its equivalent
/// typeless variant.
/// </summary>
...
inline format format_to_typeless( format value ) {
    switch ( value ) {
        ...
        case format::d24_unorm_s8_uint: // Do not also convert
                                        // 'd24_unorm_x8_uint' here, to keep it
...
/// <summary>
/// Converts the specified format <paramref name="value"/> to its equivalent
/// typed variant ("unorm" or "float").
/// </summary>
/// <param name="value">The format to convert.</param>
/// <param name="srgb_variant">Set to 1 to get sRGB variant, 0 to get linear
/// variant and -1 to preserve existing one.</param>
inline format format_to_default_typed( format value, int srgb_variant = -1 ) {
    switch ( value ) {
        ...
        case format::r8g8b8_unorm:
            return srgb_variant == 1 ? format::r8g8b8_unorm_srgb
                                     : format::r8g8b8_unorm;
        case format::r8g8b8_unorm_srgb:
            return srgb_variant != 0 ? format::r8g8b8_unorm_srgb
                                     : format::r8g8b8_unorm;
        case format::b8g8r8_typeless:
        case format::b8g8r8_unorm:
            return srgb_variant == 1 ? format::b8g8r8_unorm_srgb
                                     : format::b8g8r8_unorm;
        case format::b8g8r8_unorm_srgb:
            return srgb_variant != 0 ? format::b8g8r8_unorm_srgb
                                     : format::b8g8r8_unorm;
        case format::r8g8b8a8_typeless:
        case format::r8g8b8a8_unorm:
            return srgb_variant == 1 ? format::r8g8b8a8_unorm_srgb
                                     : format::r8g8b8a8_unorm;
        case format::r8g8b8a8_unorm_srgb:
            return srgb_variant != 0 ? format::r8g8b8a8_unorm_srgb
                                     : format::r8g8b8a8_unorm;
        case format::r8g8b8x8_unorm:
            return srgb_variant == 1 ? format::r8g8b8x8_unorm_srgb
                                     : format::r8g8b8x8_unorm;
        case format::r8g8b8x8_unorm_srgb:
            return srgb_variant != 0 ? format::r8g8b8x8_unorm_srgb
                                     : format::r8g8b8x8_unorm;
        case format::b8g8r8a8_typeless:
        case format::b8g8r8a8_unorm:
            return srgb_variant == 1 ? format::b8g8r8a8_unorm_srgb
                                     : format::b8g8r8a8_unorm;
        case format::b8g8r8a8_unorm_srgb:
            return srgb_variant != 0 ? format::b8g8r8a8_unorm_srgb
                                     : format::b8g8r8a8_unorm;
        case format::b8g8r8x8_typeless:
        case format::b8g8r8x8_unorm:
            return srgb_variant == 1 ? format::b8g8r8x8_unorm_srgb
        ...
        case format::bc1_typeless:
        case format::bc1_unorm:
            return srgb_variant == 1 ? format::bc1_unorm_srgb
                                     : format::bc1_unorm;
        case format::bc1_unorm_srgb:
            return srgb_variant != 0 ? format::bc1_unorm_srgb
                                     : format::bc1_unorm;
        case format::bc2_typeless:
        case format::bc2_unorm:
            return srgb_variant == 1 ? format::bc2_unorm_srgb
                                     : format::bc2_unorm;
        case format::bc2_unorm_srgb:
            return srgb_variant != 0 ? format::bc2_unorm_srgb
                                     : format::bc2_unorm;
        case format::bc3_typeless:
        case format::bc3_unorm:
            return srgb_variant == 1 ? format::bc3_unorm_srgb
                                     : format::bc3_unorm;
        case format::bc3_unorm_srgb:
        ...
        case format::bc7_typeless:
        case format::bc7_unorm:
            return srgb_variant == 1 ? format::bc7_unorm_srgb
                                     : format::bc7_unorm;
        case format::bc7_unorm_srgb:
            return srgb_variant != 0 ? format::bc7_unorm_srgb
                                     : format::bc7_unorm;
        default:
            return value;
    }
...
/// <summary>
/// Gets the average component bit depth of the specified format <paramref
/// name="value"/>.
/// </summary>
...
/// <summary>
/// Gets the number of bytes a texture row of the specified format <paramref
/// name="value"/> occupies.
/// </summary>
inline const uint32_t format_row_pitch( format value, uint32_t width ) {
    ...
    if ( value <= format::x24_unorm_g8_uint || value == format::l16a16_unorm )
        return 4 * width;
    if ( value <= format::r16_sint || value == format::b5g6r5_unorm ||
         value == format::b5g5r5a1_unorm || value == format::b5g5r5x1_unorm ||
         value == format::l8a8_unorm || value == format::l16_unorm )
        return 2 * width;
    if ( value <= format::a8_unorm || value == format::l8_unorm )
        return 1 * width;
    if ( value <= format::g8r8_g8b8_unorm ||
         ( value >= format::b8g8r8a8_unorm &&
           value <= format::b8g8r8x8_unorm_srgb ) ||
         ( value == format::r8g8b8x8_unorm ||
           value == format::r8g8b8x8_unorm_srgb ) ||
         ( value >= format::b10g10r10a2_typeless &&
           value <= format::b10g10r10a2_uint ) )
        return 4 * width;

    // Block compressed formats are bytes per block, rather than per pixel
    if ( ( value >= format::bc2_typeless && value <= format::bc2_unorm_srgb ) ||
         ( value >= format::bc3_typeless && value <= format::bc3_unorm_srgb ) ||
         ( value >= format::bc5_typeless && value <= format::bc7_unorm_srgb ) )
        return 16 * ( ( width + 3 ) / 4 );
    if ( ( value >= format::bc1_typeless && value <= format::bc1_unorm_srgb ) ||
         ( value >= format::bc4_typeless && value <= format::bc4_snorm ) )
        return 8 * ( ( width + 3 ) / 4 );

    // Unusual formats
    if ( ( value >= format::r16g16b16_typeless &&
           value <= format::r16g16b16_float ) )
        return 6 * width;
    if ( ( value >= format::r8g8b8_typeless &&
           value <= format::r8g8b8_unorm_srgb ) ||
         ( value >= format::b8g8r8_typeless &&
           value <= format::b8g8r8_unorm_srgb ) )
        return 3 * width;
...
/// <summary>
/// Gets the number of bytes a texture slice of the specified format <paramref
/// name="value"/> occupies.
/// </summary>
inline const uint32_t format_slice_pitch( format value,
                                          uint32_t row_pitch,
                                          uint32_t height ) {
    if ( ( value >= format::bc1_typeless && value <= format::bc5_snorm ) ||
         ( value >= format::bc6h_typeless && value <= format::bc7_unorm_srgb ) )
