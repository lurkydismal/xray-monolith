...
enum class addon_event : uint32_t {
    ...
    /// </list>
    /// <para>Callback function signature: <c>void (api::device
    /// *device)</c></para>
    /// </summary>
    init_device,
    ...
    /// </list>
    /// <para>Callback function signature: <c>void (api::command_list
    /// *cmd_list)</c></para>
    /// </summary>
    /// <remarks>
    /// In case of D3D9, D3D10, D3D11 and OpenGL this is called during device
    /// initialization as well and behaves as if an implicit immediate command
    /// list was created.
    /// </remarks>
    init_command_list,
    ...
    /// <item><description>vkCreateDevice (for every queue associated with the
    /// device)</description></item>
    /// </list>
    /// <para>Callback function signature: <c>void (api::command_queue
    /// *queue)</c></para>
    /// </summary>
    /// <remarks>
    /// In case of D3D9, D3D10, D3D11 and OpenGL this is called during device
    /// initialization as well and behaves as if an implicit command queue was
    /// created.
    /// </remarks>
    init_command_queue,
    ...
    /// <item><description>vkDestroyDevice (for every queue associated with the
    /// device)</description></item>
    /// </list>
    /// <para>Callback function signature: <c>void (api::command_queue
    /// *queue)</c></para>
    ...
    /// <summary>
    /// Called after successful swap chain creation (with the resize argument
    /// set to <see langword="false"/>), from: <list type="bullet">
    /// <item><description>IDirect3D9::CreateDevice (for the implicit swap
    /// chain)</description></item>
    /// <item><description>IDirect3D9Ex::CreateDeviceEx (for the implicit swap
    /// chain)</description></item>
    ...
    /// </list>
    /// In addition, called when swap chain is resized (with the resize argument
    /// set to <see langword="true"/>, in which case the object is reused),
    /// after: <list type="bullet"> <item><description>IDirect3DDevice9::Reset
    /// (for the implicit swap chain)</description></item>
    /// <item><description>IDirect3DDevice9Ex::ResetEx (for the implicit swap
    /// chain)</description></item>
    ...
    /// <item><description>wglSwapBuffers (after window was
    /// resized)</description></item>
    /// </list>
    /// <para>Callback function signature: <c>void (api::swapchain *swapchain,
    /// bool resize)</c></para>
    /// </summary>
    init_swapchain,
    ...
    /// chain)</description></item>
    /// <item><description>IDirect3D9Device::CreateAdditionalSwapChain</description></item>
    /// <item><description>IDirect3D9Device::Reset (for the implicit swap
    /// chain)</description></item>
    /// <item><description>IDirect3D9DeviceEx::ResetEx (for the implicit swap
    /// chain)</description></item>
    /// <item><description>IDXGIFactory::CreateSwapChain</description></item>
    /// <item><description>IDXGIFactory2::CreateSwapChain(...)</description></item>
    /// <item><description>IDXGISwapChain::ResizeBuffers</description></item>
    ...
    /// <item><description>vkCreateSwapchainKHR</description></item>
    /// </list>
    /// <para>Callback function signature: <c>bool (api::swapchain_desc
    /// &amp;desc, void *hwnd)</c></para>
    /// </summary>
    /// <remarks>
    /// To overwrite the swap chain description, modify <c>desc</c> in the
    /// callback and return <see langword="true"/>, otherwise return <see
    /// langword="false"/>.
    /// </remarks>
    create_swapchain,

    /// <summary>
    /// Called on swap chain destruction (with the resize argument set to <see
    /// langword="false"/>), before: <list type="bullet">
    /// <item><description>IDirect3DDevice9::Release (for the implicit swap
    /// chain)</description></item>
    ...
    /// </list>
    /// In addition, called when swap chain is resized (with the resize argument
    /// set to <see langword="true"/>, in which case the object will be reused),
    /// before: <list type="bullet"> <item><description>IDirect3DDevice9::Reset
    /// (for the implicit swap chain)</description></item>
    /// <item><description>IDirect3DDevice9Ex::ResetEx (for the implicit swap
    /// chain)</description></item>
    /// <item><description>IDXGISwapChain::ResizeBuffers</description></item>
    ...
    /// <summary>
    /// Called after effect runtime initialization (which happens after swap
    /// chain creation or a swap chain buffer resize). <para>Callback function
    /// signature: <c>void (api::effect_runtime *runtime)</c></para>
    /// </summary>
    init_effect_runtime,

    /// <summary>
    /// Called when an effect runtime is reset or destroyed.
    /// <para>Callback function signature: <c>void (api::effect_runtime
    /// *runtime)</c></para>
    /// </summary>
    ...
    /// </list>
    /// <para>Callback function signature: <c>void (api::device *device, const
    /// api::sampler_desc &amp;desc, api::sampler sampler)</c></para>
    /// </summary>
    /// <remarks>
    ...
    /// <item><description>vkCreateSampler</description></item>
    /// </list>
    /// <para>Callback function signature: <c>bool (api::device *device,
    /// api::sampler_desc &amp;desc)</c></para>
    /// </summary>
    /// <remarks>
    /// To overwrite the sampler description, modify <c>desc</c> in the callback
    /// and return <see langword="true"/>, otherwise return <see
    /// langword="false"/>. Is not called in D3D9 (since samplers are loose
    /// state there) or OpenGL.
    /// </remarks>
    create_sampler,
    ...
    /// </list>
    /// <para>Callback function signature: <c>void (api::device *device,
    /// api::sampler sampler)</c></para>
    /// </summary>
    /// <remarks>
    /// Is not called in D3D9 (since samplers are loose state there), D3D12
    /// (since samplers are descriptor handles instead of objects there) or
    /// OpenGL.
    /// </remarks>
    destroy_sampler,
    ...
    /// </list>
    /// <para>Callback function signature: <c>void (api::device *device, const
    /// api::resource_desc &amp;desc, const api::subresource_data *initial_data,
    /// api::resource_usage initial_state, api::resource resource)</c></para>
    /// </summary>
    /// <remarks>
    /// May be called multiple times with the same resource handle (whenever the
    /// resource is updated or its reference count is incremented).
    /// </remarks>
    init_resource,
    ...
    /// </list>
    /// <para>Callback function signature: <c>bool (api::device *device,
    /// api::resource_desc &amp;desc, api::subresource_data *initial_data,
    /// api::resource_usage initial_state)</c></para>
    /// </summary>
    /// <remarks>
    /// To overwrite the resource description, modify <c>desc</c> in the
    /// callback and return <see langword="true"/>, otherwise return <see
    /// langword="false"/>.
    /// </remarks>
    create_resource,
    ...
    /// </list>
    /// <para>Callback function signature: <c>void (api::device *device,
    /// api::resource resource, api::resource_usage usage_type, const
    /// api::resource_view_desc &amp;desc, api::resource_view view)</c></para>
    /// </summary>
    /// <remarks>
    /// May be called multiple times with the same resource view handle
    /// (whenever the resource view is updated).
    /// </remarks>
    init_resource_view,
    ...
    /// </list>
    /// <para>Callback function signature: <c>bool (api::device *device,
    /// api::resource resource, api::resource_usage usage_type,
    /// api::resource_view_desc &amp;desc)</c></para>
    /// </summary>
    /// <remarks>
    /// To overwrite the resource view description, modify <c>desc</c> in the
    /// callback and return <see langword="true"/>, otherwise return <see
    /// langword="false"/>. Is not called in D3D9 (since resource views are tied
    /// to resources there).
    /// </remarks>
    ...
    /// </list>
    /// <para>Callback function signature: <c>void (api::device *device,
    /// api::resource_view view)</c></para>
    /// </summary>
    /// <remarks>
    /// Is not called in D3D12 (since resource views are descriptor handles
    /// instead of objects there).
    /// </remarks>
    ...
    /// </list>
    /// <para>Callback function signature: <c>void (api::device *device,
    /// api::resource resource, uint64_t offset, uint64_t size, api::map_access
    /// access, void **data)</c></para>
    /// </summary>
    map_buffer_region,
    ...
    /// </list>
    /// <para>Callback function signature: <c>void (api::device *device,
    /// api::resource resource, uint32_t subresource, const api::subresource_box
    /// *box, api::map_access access, api::subresource_data *data)</c></para>
    /// </summary>
    map_texture_region,
    ...
    /// </list>
    /// <para>Callback function signature: <c>void (api::device *device,
    /// api::resource resource, uint32_t subresource)</c></para>
    /// </summary>
    ...
    /// </list>
    /// <para>Callback function signature: <c>bool (api::device *device, const
    /// void *data, api::resource resource, uint64_t offset, uint64_t
    /// size)</c></para>
    /// </summary>
    /// <remarks>
    /// To prevent this command from being executed, return <see
    /// langword="true"/>, otherwise return <see langword="false"/>. Destination
    /// resource will be in the <see cref="api::resource_usage::copy_dest"/>
    /// state.
    /// </remarks>
    ...
    /// </list>
    /// <para>Callback function signature: <c>bool (api::device *device, const
    /// api::subresource_data &amp;data, api::resource resource, uint32_t
    /// subresource, const api::subresource_box *box)</c></para>
    /// </summary>
    /// <remarks>
    /// To prevent this command from being executed, return <see
    /// langword="true"/>, otherwise return <see langword="false"/>. Destination
    ...
    /// </list>
    /// <para>Callback function signature: <c>void (api::device *device,
    /// api::pipeline_layout layout, uint32_t subobject_count, const
    /// api::pipeline_subobject *subobjects, api::pipeline pipeline)</c></para>
    /// </summary>
    /// <remarks>
    /// May be called multiple times with the same pipeline handle (whenever the
    /// pipeline is updated or its reference count is incremented).
    /// </remarks>
    init_pipeline,
    ...
    /// <para>Callback function signature: <c>bool (api::device *device,
    /// api::pipeline_layout layout, uint32_t subobject_count, const
    /// api::pipeline_subobject *subobjects)</c></para>
    /// </summary>
    /// <remarks>
    /// To overwrite the pipeline description, modify <c>desc</c> in the
    /// callback and return <see langword="true"/>, otherwise return <see
    /// langword="false"/>.
    /// </remarks>
    create_pipeline,
    ...
    /// </list>
    /// <para>Callback function signature: <c>void (api::device *device,
    /// uint32_t param_count, const api::pipeline_layout_param *params,
    /// api::pipeline_layout layout)</c></para>
    /// </summary>
    /// <remarks>
    /// In case of D3D9, D3D10, D3D11 and OpenGL this is called during device
    /// initialization as well and behaves as if an implicit global pipeline
    /// layout was created.
    /// </remarks>
    ...
    /// </list>
    /// <para>Callback function signature: <c>bool (api::device *device,
    /// uint32_t &amp;param_count, api::pipeline_layout_param
    /// *&amp;params)</c></para>
    /// </summary>
    /// <remarks>
    ...
    /// </list>
    /// <para>Callback function signature: <c>bool (api::device *device,
    /// uint32_t count, const api::descriptor_table_copy *copies)</c></para>
    /// </summary>
    /// <remarks>
    /// To prevent this command from being executed, return <see
    /// langword="true"/>, otherwise return <see langword="false"/>.
    /// </remarks>
    ...
    /// </list>
    /// <para>Callback function signature: <c>bool (api::device *device,
    /// uint32_t count, const api::descriptor_table_update *updates)</c></para>
    /// </summary>
    /// <remarks>
    /// To prevent this command from being executed, return <see
    /// langword="true"/>, otherwise return <see langword="false"/>.
    ...
    /// </list>
    /// <para>Callback function signature: <c>void (api::device *device,
    /// api::query_type type, uint32_t count, api::query_heap heap)</c></para>
    /// </summary>
    init_query_heap,
    ...
    /// </list>
    /// <para>Callback function signature: <c>bool (api::device *device,
    /// api::query_type type, uint32_t &amp;count)</c></para>
    /// </summary>
    create_query_heap,
    ...
    /// </list>
    /// <para>Callback function signature: <c>bool (api::device *device,
    /// api::query_heap heap, uint32_t first, uint32_t count, void *results,
    /// uint32_t stride)</c></para>
    /// </summary>
    ...
    /// </list>
    /// <para>Callback function signature: <c>void (api::command_list *cmd_list,
    /// uint32_t count, const api::resource *resources, const
    /// api::resource_usage *old_states, const api::resource_usage
    /// *new_states)</c></para>
    /// </summary>
    barrier,
    ...
    /// </list>
    /// <para>Callback function signature: <c>void (api::command_list *cmd_list,
    /// uint32_t count, const api::render_pass_render_target_desc *rts, const
    /// api::render_pass_depth_stencil_desc *ds)</c></para>
    /// </summary>
    /// <remarks>
    /// The depth-stencil description argument is optional and may be <see
    /// langword="nullptr"/> (which indicates that no depth-stencil is used).
    /// </remarks>
    begin_render_pass,
    ...
    /// </list>
    /// <para>Callback function signature: <c>void (api::command_list *cmd_list,
    /// uint32_t count, const api::resource_view *rtvs, api::resource_view
    /// dsv)</c></para>
    /// </summary>
    ...
    /// </list>
    /// <para>Callback function signature: <c>void (api::command_list *cmd_list,
    /// api::pipeline_stage stages, api::pipeline pipeline)</c></para>
    /// </summary>
    bind_pipeline,
    ...
    /// </list>
    /// <para>Callback function signature: <c>void (api::command_list *cmd_list,
    /// uint32_t count, const api::dynamic_state *states, const uint32_t
    /// *values)</c></para>
    /// </summary>
    ...
    /// <item><description>IDirect3DDevice9::SetRenderTarget (implicitly updates
    /// the viewport)</description></item>
    ...
    /// </list>
    /// <para>Callback function signature: <c>void (api::command_list *cmd_list,
    /// uint32_t first, uint32_t count, const api::viewport
    /// *viewports)</c></para>
    /// </summary>
    bind_viewports,
    ...
    /// </list>
    /// <para>Callback function signature: <c>void (api::command_list *cmd_list,
    /// uint32_t first, uint32_t count, const api::rect *rects)</c></para>
    /// </summary>
    bind_scissor_rects,
    ...
    /// </list>
    /// <para>Callback function signature: <c>void (api::command_list *cmd_list,
    /// api::shader_stage stages, api::pipeline_layout layout, uint32_t
    /// layout_param, uint32_t first, uint32_t count, const void
    /// *values)</c></para>
    /// </summary>
    push_constants,
    ...
    /// <para>Callback function signature: <c>void (api::command_list *cmd_list,
    /// api::shader_stage stages, api::pipeline_layout layout, uint32_t
    /// layout_param, const api::descriptor_table_update &amp;update)</c></para>
    /// </summary>
    push_descriptors,
    ...
    /// uint32_t count, const api::descriptor_table *tables)</c></para>
    /// </summary>
    ...
    /// </list>
    /// <para>Callback function signature: <c>void (api::command_list *cmd_list,
    /// api::resource buffer, uint64_t offset, uint32_t index_size)</c></para>
    /// </summary>
    bind_index_buffer,
    ...
    /// </list>
    /// <para>Callback function signature: <c>void (api::command_list *cmd_list,
    /// uint32_t first, uint32_t count, const api::resource *buffers, const
    /// uint64_t *offsets, const uint32_t *strides)</c></para>
    /// </summary>
    /// <remarks>
    ...
    /// <para>Callback function signature: <c>void (api::command_list *cmd_list,
    /// uint32_t first, uint32_t count, const api::resource *buffers, const
    /// uint64_t *offsets, const uint64_t *max_sizes, const api::resource
    /// *counter_buffers, const uint64_t *counter_offsets)</c></para>
    /// </summary>
    /// <remarks>
    ...
    /// </list>
    /// <para>Callback function signature: <c>bool (api::command_list *cmd_list,
    /// uint32_t vertex_count, uint32_t instance_count, uint32_t first_vertex,
    /// uint32_t first_instance)</c></para>
    /// </summary>
    /// <remarks>
    /// To prevent this command from being executed, return <see
    /// langword="true"/>, otherwise return <see langword="false"/>.
    ...
    /// int32_t vertex_offset, uint32_t first_instance)</c></para>
    /// </summary>
    /// <remarks>
    /// To prevent this command from being executed, return <see
    /// langword="true"/>, otherwise return <see langword="false"/>.
    ...
    /// </list>
    /// <para>Callback function signature: <c>bool (api::command_list *cmd_list,
    /// uint32_t group_count_x, uint32_t group_count_y, uint32_t
    /// group_count_z)</c></para>
    /// </summary>
    /// <remarks>
    /// To prevent this command from being executed, return <see
    /// langword="true"/>, otherwise return <see langword="false"/>.
    ...
    /// </list>
    /// <para>Callback function signature: <c>bool (api::command_list *cmd_list,
    /// api::resource raygen, uint64_t raygen_offset, uint64_t raygen_size,
    /// api::resource miss, uint64_t miss_offset, uint64_t miss_size, uint64_t
    /// miss_stride, api::resource hit_group, uint64_t hit_group_offset,
    /// uint64_t hit_group_size, uint64_t hit_group_stride, api::resource
    /// callable, uint64_t callable_offset, uint64_t callable_size, uint64_t
    /// callable_stride, uint32_t width, uint32_t height, uint32_t
    /// depth)</c></para>
    /// </summary>
    /// <remarks>
    /// To prevent this command from being executed, return <see
    /// langword="true"/>, otherwise return <see langword="false"/>. In case of
    /// D3D12 and Vulkan, the shader handle buffer handles may be zero with the
    /// buffers instead referred to via a device address passed in the related
    /// offset argument.
    /// </remarks>
    dispatch_rays = 90,
    ...
    /// </list>
    /// <para>Callback function signature: <c>bool (api::command_list *cmd_list,
    /// api::indirect_command type, api::resource buffer, uint64_t offset,
    /// uint32_t draw_count, uint32_t stride)</c></para>
    /// </summary>
    /// <remarks>
    /// To prevent this command from being executed, return <see
    /// langword="true"/>, otherwise return <see langword="false"/>.
    ...
    /// </list>
    /// <para>Callback function signature: <c>bool (api::command_list *cmd_list,
    /// api::resource source, api::resource dest)</c></para>
    /// </summary>
    /// <remarks>
    /// To prevent this command from being executed, return <see
    /// langword="true"/>, otherwise return <see langword="false"/>. Source
    /// resource will be in the <see cref="api::resource_usage::copy_source"/>
    /// state. Destination resource will be in the <see
    /// cref="api::resource_usage::copy_dest"/> state.
    /// </remarks>
    copy_resource,
    ...
    /// </list>
    /// <para>Callback function signature: <c>bool (api::command_list *cmd_list,
    /// api::resource source, uint64_t source_offset, api::resource dest,
    /// uint64_t dest_offset, uint64_t size)</c></para>
    /// </summary>
    /// <remarks>
    /// To prevent this command from being executed, return <see
    /// langword="true"/>, otherwise return <see langword="false"/>. Source
    ...
    /// </list>
    /// <para>Callback function signature: <c>bool (api::command_list *cmd_list,
    /// api::resource source, uint64_t source_offset, uint32_t row_length,
    /// uint32_t slice_height, api::resource dest, uint32_t dest_subresource,
    /// const api::subresource_box *dest_box)</c></para>
    /// </summary>
    /// <remarks>
    /// To prevent this command from being executed, return <see
    /// langword="true"/>, otherwise return <see langword="false"/>. Source
    /// resource will be in the <see cref="api::resource_usage::copy_source"/>
    /// state. Destination resource will be in the <see
    /// cref="api::resource_usage::copy_dest"/> state. The subresource box
    /// argument is optional and may be <see langword="nullptr"/> (which
    /// indicates the entire subresource is referenced).
    /// </remarks>
    ...
    /// </list>
    /// <para>Callback function signature: <c>bool (api::command_list *cmd_list,
    /// api::resource source, uint32_t source_subresource, const
    /// api::subresource_box *source_box, api::resource dest, uint32_t
    /// dest_subresource, const api::subresource_box *dest_box, api::filter_mode
    /// filter)</c></para>
    /// </summary>
    /// <remarks>
    /// To prevent this command from being executed, return <see
    ...
    /// state. Destination resource will be in the <see
    /// cref="api::resource_usage::copy_dest"/> state. The subresource box
    /// arguments are optional and may be <see langword="nullptr"/> (which
    /// indicates the entire subresource is used).
    /// </remarks>
    copy_texture_region,
    ...
    /// <para>Callback function signature: <c>bool (api::command_list *cmd_list,
    /// api::resource source, uint32_t source_subresource, const
    /// api::subresource_box *source_box, api::resource dest, uint64_t
    /// dest_offset, uint32_t row_length, uint32_t slice_height)</c></para>
    /// </summary>
    /// <remarks>
    /// To prevent this command from being executed, return <see
    /// langword="true"/>, otherwise return <see langword="false"/>. Source
    ...
    /// api::resource source, uint32_t source_subresource, const
    /// api::subresource_box *source_box, api::resource dest, uint32_t
    /// dest_subresource, uint32_t dest_x, uint32_t dest_y, uint32_t dest_z,
    /// api::format format)</c></para>
    /// </summary>
    /// <remarks>
    /// To prevent this command from being executed, return <see
    /// langword="true"/>, otherwise return <see langword="false"/>. Source
    /// resource will be in the <see
    /// cref="api::resource_usage::resolve_source"/> state. Destination resource
    /// will be in the <see cref="api::resource_usage::resolve_dest"/> state.
    /// The subresource box argument is optional and may be <see
    /// langword="nullptr"/> (which indicates the entire subresource is used).
    /// </remarks>
    ...
    /// <item><description>ID3D11DeviceContext1::ClearView (for depth-stencil
    /// views)</description></item>
    ...
    /// </list>
    /// <para>Callback function signature: <c>bool (api::command_list *cmd_list,
    /// api::resource_view dsv, const float *depth, const uint8_t *stencil,
    /// uint32_t rect_count, const api::rect *rects)</c></para>
    /// </summary>
    /// <remarks>
    /// To prevent this command from being executed, return <see
    /// langword="true"/>, otherwise return <see langword="false"/>. Resource
    /// will be in the <see cref="api::resource_usage::depth_stencil_write"/>
    /// state. One of the depth or stencil clear value arguments may be <see
    /// langword="nullptr"/> when the respective component is not cleared.
    /// </remarks>
    ...
    /// <item><description>ID3D11DeviceContext1::ClearView (for render target
    /// views)</description></item>
    ...
    /// </list>
    /// <para>Callback function signature: <c>bool (api::command_list *cmd_list,
    /// api::resource_view rtv, const float color[4], uint32_t rect_count, const
    /// api::rect *rects)</c></para>
    /// </summary>
    /// <remarks>
    /// To prevent this command from being executed, return <see
    /// langword="true"/>, otherwise return <see langword="false"/>. Resources
    /// will be in the <see cref="api::resource_usage::render_target"/> state.
    /// </remarks>
    ...
    /// </list>
    /// <para>Callback function signature: <c>bool (api::command_list *cmd_list,
    /// api::resource_view uav, const uint32_t values[4], uint32_t rect_count,
    /// const api::rect *rects)</c></para>
    /// </summary>
    /// <remarks>
    /// To prevent this command from being executed, return <see
    /// langword="true"/>, otherwise return <see langword="false"/>. Resource
    /// will be in the <see cref="api::resource_usage::unordered_access"/>
    /// state.
    /// </remarks>
    ...
    /// <item><description>ID3D11DeviceContext1::ClearView (for unordered access
    /// views)</description></item>
    /// <item><description>ID3D12GraphicsCommandList::ClearUnorderedAccessViewFloat</description></item>
    /// </list>
    /// <para>Callback function signature: <c>bool (api::command_list *cmd_list,
    /// api::resource_view uav, const float values[4], uint32_t rect_count,
    /// const api::rect *rects)</c></para>
    /// </summary>
    /// <remarks>
    /// To prevent this command from being executed, return <see
    ...
    /// </list>
    /// <para>Callback function signature: <c>bool (api::command_list *cmd_list,
    /// api::query_heap heap, api::query_type type, uint32_t index)</c></para>
    /// </summary>
    /// <remarks>
    /// To prevent this command from being executed, return <see
    /// langword="true"/>, otherwise return <see langword="false"/>.
    ...
    /// </list>
    /// <para>Callback function signature: <c>bool (api::command_list *cmd_list,
    /// api::query_heap heap, api::query_type type, uint32_t first, uint32_t
    /// count, api::resource dest, uint64_t dest_offset, uint32_t
    /// stride)</c></para>
    /// </summary>
    /// <remarks>
    /// To prevent this command from being executed, return <see
    ...
    /// </list>
    /// <para>Callback function signature: <c>bool (api::command_list *cmd_list,
    /// api::resource_view source, api::resource_view dest,
    /// api::acceleration_structure_copy_mode mode)</c></para>
    /// </summary>
    /// <remarks>
    /// To prevent this command from being executed, return <see
    /// langword="true"/>, otherwise return <see langword="false"/>.
    ...
    /// const api::acceleration_structure_build_input *inputs, api::resource
    /// scratch, uint64_t scratch_offset, api::resource_view source,
    /// api::resource_view dest, api::acceleration_structure_build_mode
    /// mode)</c></para>
    /// </summary>
    /// <remarks>
    /// To prevent this command from being executed, return <see
    /// langword="true"/>, otherwise return <see langword="false"/>. In case of
    /// D3D12 and Vulkan, the scratch buffer handle may be zero with the buffer
    /// instead referred to via a device address passed in the related offset
    /// argument. Scratch buffer will be in the <see
    /// cref="api::resource_usage::unordered_access"/> resource state.
    /// </remarks>
    ...
    /// </list>
    /// <para>Callback function signature: <c>bool (api::command_list *cmd_list,
    /// uint32_t count, const api::resource_view *acceleration_structures,
    /// api::query_heap heap, api::query_type type, uint32_t first)</c></para>
    /// </summary>
    ...
    /// <summary>
    /// Called when a command list is submitted to a command queue (or an
    /// immediate command list is flushed), before: <list type="bullet">
    ...
    /// </list>
    /// <para>Callback function signature: <c>void (api::command_queue *queue,
    /// api::command_list *cmd_list)</c></para>
    /// </summary>
    execute_command_list,

    /// <summary>
    /// Called when a secondary command list is executed on a primary command
    /// list, before: <list type="bullet">
    ...
    /// </list>
    /// <para>Callback function signature: <c>void (api::command_list *cmd_list,
    /// api::command_list *secondary_cmd_list)</c></para>
    /// </summary>
    ...
    /// </list>
    /// <para>Callback function signature: <c>void (api::command_queue *queue,
    /// api::swapchain *swapchain, const api::rect *source_rect, const api::rect
    /// *dest_rect, uint32_t dirty_rect_count, const api::rect
    /// *dirty_rects)</c></para>
    /// </summary>
    /// <remarks>
    /// The source and destination rectangle arguments are optional and may be
    /// <see langword="nullptr"/> (which indicates the swap chain is presented
    /// in its entirety).
    /// </remarks>
    present,
    ...
    /// </list>
    /// <para>Callback function signature: <c>bool (api::swapchain *swapchain,
    /// bool fullscreen, void *hmonitor)</c></para>
    /// </summary>
    /// <remarks>
    /// To prevent the fullscreen state from being changed, return <see
    /// langword="true"/>, otherwise return <see langword="false"/>.
    /// </remarks>
    ...
    /// <para>Callback function signature: <c>void (api::effect_runtime
    /// *runtime, api::command_list *cmd_list, api::resource_view rtv,
    /// api::resource_view rtv_srgb)</c></para>
    /// </summary>
    ...
    /// This occurs during effect runtime initialization or because the user
    /// pressed the "Reload" button in the overlay. Any <see
    /// cref="api::effect_technique"/>, <see
    /// cref="api::effect_texture_variable"/> and <see
    /// cref="api::effect_uniform_variable"/> handles are invalidated when this
    /// event occurs and need to be queried again. <para>Callback function
    /// signature: <c>void (api::effect_runtime *runtime)</c></para>
    /// </summary>
    ...
    /// <para>Callback function signature: <c>bool (api::effect_runtime
    /// *runtime, api::effect_uniform_variable variable, const void *new_value,
    /// size_t new_value_size)</c></para>
    /// </summary>
    /// <remarks>
    /// To prevent the variable value from being changed, return <see
    /// langword="true"/>, otherwise return <see langword="false"/>. The new
    /// value has the data type reported by <see
    /// cref="api::effect_runtime::get_uniform_variable_type"/>. The new value
    /// size is in bytes.
    /// </remarks>
    ...
    /// <para>Callback function signature: <c>bool (api::effect_runtime
    /// *runtime, api::effect_technique technique, bool enabled)</c></para>
    /// </summary>
    /// <remarks>
    /// To prevent the technique state from being changed, return <see
    /// langword="true"/>, otherwise return <see langword="false"/>.
    /// </remarks>
    reshade_set_technique_state,

    /// <summary>
    /// Called between the <c>ImGui::NewFrame</c> and <c>ImGui::EndFrame</c>
    /// calls for the ReShade overlay. Can be used to perform custom Dear ImGui
    /// calls, but it is recommended to instead use <see
    /// cref="register_overlay"/> to register a dedicated overlay.
    /// <para>Callback function signature: <c>void (api::effect_runtime
    /// *runtime)</c></para>
    /// </summary>
    /// <remarks>
    ...
    /// <summary>
    /// Called after a screenshot was taken and saved to disk, with the path to
    /// the saved image file. <para>Callback function signature: <c>void
    /// (api::effect_runtime *runtime, const char *path)</c></para>
    /// </summary>
    reshade_screenshot,

    /// <summary>
    /// Called for each technique after it was rendered, usually between <see
    /// cref="reshade_begin_effects"/> and <see cref="reshade_finish_effects"/>.
    /// <para>Callback function signature: <c>void (api::effect_runtime
    /// *runtime, api::effect_technique technique, api::command_list *cmd_list,
    /// api::resource_view rtv, api::resource_view rtv_srgb)</c></para>
    /// </summary>
    ...
    /// <para>Callback function signature: <c>bool (api::effect_runtime
    /// *runtime, bool enabled)</c></para>
    /// </summary>
    /// <remarks>
    /// To prevent the effects state from being changed, return <see
    /// langword="true"/>, otherwise return <see langword="false"/>.
    /// </remarks>
    ...
    /// This occurs after effect reloading or when the user chooses a new preset
    /// in the overlay. <para>Callback function signature: <c>void
    /// (api::effect_runtime *runtime, const char *path)</c></para>
    /// </summary>
    reshade_set_current_preset_path = 84,

    /// <summary>
    /// Called when the rendering order of loaded techniques is changed, with a
    /// handle array specifying the new order. <para>Callback function
    /// signature: <c>bool (api::effect_runtime *runtime, size_t count,
    /// api::effect_technique *techniques)</c></para>
    /// </summary>
    /// <remarks>
    /// To prevent the order from being changed, return <see langword="true"/>,
    ...
    /// <para>Callback function signature: <c>bool (api::effect_runtime
    /// *runtime, bool open, api::input_source source)</c></para>
    /// </summary>
    /// <remarks>
    /// To prevent the overlay state from being changed, return <see
    /// langword="true"/>, otherwise return <see langword="false"/>.
    /// </remarks>
    reshade_open_overlay,

    /// <summary>
    /// Called when a uniform variable widget is added to the variable list in
    /// the overlay. Can be used to replace with custom one or add widgets for
    /// specific uniform variables. <para>Callback function signature: <c>bool
    /// (api::effect_runtime *runtime, api::effect_uniform_variable
    /// variable)</c></para>
    /// </summary>
    /// <remarks>
    /// To prevent the normal widget from being added to the overlay, return
    /// <see langword="true"/>, otherwise return <see langword="false"/>.
    /// </remarks>
    reshade_overlay_uniform_variable,

    /// <summary>
    /// Called when a technique is added to the technique list in the overlay.
    /// Can be used to replace with custom one or add widgets for specific
    /// techniques. <para>Callback function signature: <c>bool
    /// (api::effect_runtime *runtime, api::effect_technique
    /// technique)</c></para>
    /// </summary>
    /// <remarks>
    /// To prevent the normal widget from being added to the overlay, return
...
#if RESHADE_ADDON
    max = 96 // Last value used internally by ReShade to determine number of
             // events in this enum
#endif
};
...
RESHADE_DEFINE_ADDON_EVENT_TRAITS( addon_event::init_device,
                                   void,
                                   api::device* device );
RESHADE_DEFINE_ADDON_EVENT_TRAITS( addon_event::destroy_device,
                                   void,
                                   api::device* device );

RESHADE_DEFINE_ADDON_EVENT_TRAITS( addon_event::init_command_list,
                                   void,
                                   api::command_list* cmd_list );
RESHADE_DEFINE_ADDON_EVENT_TRAITS( addon_event::destroy_command_list,
                                   void,
                                   api::command_list* cmd_list );

RESHADE_DEFINE_ADDON_EVENT_TRAITS( addon_event::init_command_queue,
                                   void,
                                   api::command_queue* queue );
RESHADE_DEFINE_ADDON_EVENT_TRAITS( addon_event::destroy_command_queue,
                                   void,
                                   api::command_queue* queue );

RESHADE_DEFINE_ADDON_EVENT_TRAITS( addon_event::init_swapchain,
                                   void,
                                   api::swapchain* swapchain,
                                   bool resize );
RESHADE_DEFINE_ADDON_EVENT_TRAITS( addon_event::create_swapchain,
                                   bool,
                                   api::swapchain_desc& desc,
                                   void* hwnd );
RESHADE_DEFINE_ADDON_EVENT_TRAITS( addon_event::destroy_swapchain,
                                   void,
                                   api::swapchain* swapchain,
                                   bool resize );

RESHADE_DEFINE_ADDON_EVENT_TRAITS( addon_event::init_effect_runtime,
                                   void,
                                   api::effect_runtime* runtime );
RESHADE_DEFINE_ADDON_EVENT_TRAITS( addon_event::destroy_effect_runtime,
                                   void,
                                   api::effect_runtime* runtime );

RESHADE_DEFINE_ADDON_EVENT_TRAITS( addon_event::init_sampler,
                                   void,
                                   api::device* device,
                                   const api::sampler_desc& desc,
                                   api::sampler sampler );
RESHADE_DEFINE_ADDON_EVENT_TRAITS( addon_event::create_sampler,
                                   bool,
                                   api::device* device,
                                   api::sampler_desc& desc );
RESHADE_DEFINE_ADDON_EVENT_TRAITS( addon_event::destroy_sampler,
                                   void,
                                   api::device* device,
                                   api::sampler sampler );

RESHADE_DEFINE_ADDON_EVENT_TRAITS( addon_event::init_resource,
                                   void,
                                   api::device* device,
                                   const api::resource_desc& desc,
                                   const api::subresource_data* initial_data,
                                   api::resource_usage initial_state,
                                   api::resource resource );
RESHADE_DEFINE_ADDON_EVENT_TRAITS( addon_event::create_resource,
                                   bool,
                                   api::device* device,
                                   api::resource_desc& desc,
                                   api::subresource_data* initial_data,
                                   api::resource_usage initial_state );
RESHADE_DEFINE_ADDON_EVENT_TRAITS( addon_event::destroy_resource,
                                   void,
                                   api::device* device,
                                   api::resource resource );

RESHADE_DEFINE_ADDON_EVENT_TRAITS( addon_event::init_resource_view,
                                   void,
                                   api::device* device,
                                   api::resource resource,
                                   api::resource_usage usage_type,
                                   const api::resource_view_desc& desc,
                                   api::resource_view view );
RESHADE_DEFINE_ADDON_EVENT_TRAITS( addon_event::create_resource_view,
                                   bool,
                                   api::device* device,
                                   api::resource resource,
                                   api::resource_usage usage_type,
                                   api::resource_view_desc& desc );
RESHADE_DEFINE_ADDON_EVENT_TRAITS( addon_event::destroy_resource_view,
                                   void,
                                   api::device* device,
                                   api::resource_view view );

RESHADE_DEFINE_ADDON_EVENT_TRAITS( addon_event::map_buffer_region,
                                   void,
                                   api::device* device,
                                   api::resource resource,
                                   uint64_t offset,
                                   ...
                                   void** data );
RESHADE_DEFINE_ADDON_EVENT_TRAITS( addon_event::unmap_buffer_region,
                                   void,
                                   api::device* device,
                                   api::resource resource );
RESHADE_DEFINE_ADDON_EVENT_TRAITS( addon_event::map_texture_region,
                                   void,
                                   api::device* device,
                                   api::resource resource,
                                   uint32_t subresource,
                                   const api::subresource_box* box,
                                   api::map_access access,
                                   api::subresource_data* data );
RESHADE_DEFINE_ADDON_EVENT_TRAITS( addon_event::unmap_texture_region,
                                   void,
                                   api::device* device,
                                   api::resource resource,
                                   uint32_t subresource );

RESHADE_DEFINE_ADDON_EVENT_TRAITS( addon_event::update_buffer_region,
                                   bool,
                                   api::device* device,
                                   const void* data,
                                   api::resource resource,
                                   uint64_t offset,
                                   uint64_t size );
RESHADE_DEFINE_ADDON_EVENT_TRAITS( addon_event::update_texture_region,
                                   bool,
                                   api::device* device,
...
RESHADE_DEFINE_ADDON_EVENT_TRAITS( addon_event::init_pipeline,
                                   void,
                                   api::device* device,
...
RESHADE_DEFINE_ADDON_EVENT_TRAITS( addon_event::create_pipeline,
                                   bool,
                                   api::device* device,
                                   api::pipeline_layout layout,
                                   uint32_t subobject_count,
                                   const api::pipeline_subobject* subobjects );
RESHADE_DEFINE_ADDON_EVENT_TRAITS( addon_event::destroy_pipeline,
                                   void,
                                   api::device* device,
                                   api::pipeline pipeline );

RESHADE_DEFINE_ADDON_EVENT_TRAITS( addon_event::init_pipeline_layout,
                                   void,
                                   api::device* device,
                                   uint32_t param_count,
                                   const api::pipeline_layout_param* params,
                                   api::pipeline_layout layout );
RESHADE_DEFINE_ADDON_EVENT_TRAITS( addon_event::create_pipeline_layout,
                                   bool,
                                   api::device* device,
                                   uint32_t& param_count,
                                   api::pipeline_layout_param*& params );
RESHADE_DEFINE_ADDON_EVENT_TRAITS( addon_event::destroy_pipeline_layout,
                                   void,
                                   api::device* device,
                                   api::pipeline_layout layout );

RESHADE_DEFINE_ADDON_EVENT_TRAITS( addon_event::copy_descriptor_tables,
                                   bool,
                                   api::device* device,
                                   uint32_t count,
                                   const api::descriptor_table_copy* copies );
RESHADE_DEFINE_ADDON_EVENT_TRAITS(
    addon_event::update_descriptor_tables,
    bool,
    api::device* device,
    uint32_t count,
    const api::descriptor_table_update* updates );

RESHADE_DEFINE_ADDON_EVENT_TRAITS( addon_event::init_query_heap,
                                   void,
                                   api::device* device,
                                   api::query_type type,
                                   uint32_t count,
                                   api::query_heap heap );
RESHADE_DEFINE_ADDON_EVENT_TRAITS( addon_event::create_query_heap,
                                   bool,
                                   api::device* device,
                                   api::query_type type,
                                   uint32_t& count );
RESHADE_DEFINE_ADDON_EVENT_TRAITS( addon_event::destroy_query_heap,
                                   void,
                                   api::device* device,
                                   api::query_heap heap );

RESHADE_DEFINE_ADDON_EVENT_TRAITS( addon_event::get_query_heap_results,
                                   bool,
                                   api::device* device,
                                   api::query_heap heap,
                                   uint32_t first,
...
RESHADE_DEFINE_ADDON_EVENT_TRAITS( addon_event::barrier,
                                   void,
                                   api::command_list* cmd_list,
                                   uint32_t count,
                                   const api::resource* resources,
                                   const api::resource_usage* old_states,
                                   const api::resource_usage* new_states );

RESHADE_DEFINE_ADDON_EVENT_TRAITS(
    addon_event::begin_render_pass,
    void,
    api::command_list* cmd_list,
    uint32_t count,
    const api::render_pass_render_target_desc* rts,
    const api::render_pass_depth_stencil_desc* ds );
RESHADE_DEFINE_ADDON_EVENT_TRAITS( addon_event::end_render_pass,
                                   void,
                                   api::command_list* cmd_list );
RESHADE_DEFINE_ADDON_EVENT_TRAITS(
    addon_event::bind_render_targets_and_depth_stencil,
    void,
    api::command_list* cmd_list,
    uint32_t count,
...
RESHADE_DEFINE_ADDON_EVENT_TRAITS( addon_event::bind_pipeline,
                                   void,
                                   api::command_list* cmd_list,
                                   api::pipeline_stage stages,
                                   api::pipeline pipeline );
RESHADE_DEFINE_ADDON_EVENT_TRAITS( addon_event::bind_pipeline_states,
                                   void,
                                   api::command_list* cmd_list,
                                   uint32_t count,
                                   const api::dynamic_state* states,
                                   const uint32_t* values );
RESHADE_DEFINE_ADDON_EVENT_TRAITS( addon_event::bind_viewports,
                                   void,
                                   api::command_list* cmd_list,
                                   uint32_t first,
                                   uint32_t count,
                                   const api::viewport* viewports );
RESHADE_DEFINE_ADDON_EVENT_TRAITS( addon_event::bind_scissor_rects,
                                   void,
                                   api::command_list* cmd_list,
                                   uint32_t first,
                                   uint32_t count,
                                   const api::rect* rects );
RESHADE_DEFINE_ADDON_EVENT_TRAITS( addon_event::push_constants,
                                   void,
                                   api::command_list* cmd_list,
                                   ...
                                   uint32_t count,
                                   const void* values );
RESHADE_DEFINE_ADDON_EVENT_TRAITS( addon_event::push_descriptors,
                                   void,
                                   api::command_list* cmd_list,
                                   api::shader_stage stages,
                                   api::pipeline_layout layout,
...
RESHADE_DEFINE_ADDON_EVENT_TRAITS( addon_event::bind_descriptor_tables,
                                   void,
                                   api::command_list* cmd_list,
                                   api::shader_stage stages,
                                   api::pipeline_layout layout,
...
RESHADE_DEFINE_ADDON_EVENT_TRAITS( addon_event::bind_index_buffer,
                                   void,
                                   api::command_list* cmd_list,
                                   api::resource buffer,
                                   uint64_t offset,
                                   uint32_t index_size );
RESHADE_DEFINE_ADDON_EVENT_TRAITS( addon_event::bind_vertex_buffers,
                                   void,
                                   api::command_list* cmd_list,
                                   uint32_t first,
                                   uint32_t count,
...
RESHADE_DEFINE_ADDON_EVENT_TRAITS( addon_event::bind_stream_output_buffers,
                                   void,
                                   api::command_list* cmd_list,
                                   uint32_t first,
                                   uint32_t count,
...
RESHADE_DEFINE_ADDON_EVENT_TRAITS( addon_event::draw,
                                   bool,
                                   api::command_list* cmd_list,
...
RESHADE_DEFINE_ADDON_EVENT_TRAITS( addon_event::draw_indexed,
                                   bool,
                                   api::command_list* cmd_list,
                                   ...
                                   uint32_t first_instance );
RESHADE_DEFINE_ADDON_EVENT_TRAITS( addon_event::dispatch,
                                   bool,
                                   api::command_list* cmd_list,
                                   uint32_t group_count_x,
                                   uint32_t group_count_y,
                                   uint32_t group_count_z );
RESHADE_DEFINE_ADDON_EVENT_TRAITS( addon_event::dispatch_mesh,
                                   bool,
                                   api::command_list* cmd_list,
                                   uint32_t group_count_x,
                                   uint32_t group_count_y,
                                   uint32_t group_count_z );
RESHADE_DEFINE_ADDON_EVENT_TRAITS( addon_event::dispatch_rays,
                                   bool,
                                   api::command_list* cmd_list,
                                   api::resource raygen,
                                   ...
                                   uint32_t height,
                                   uint32_t depth );
RESHADE_DEFINE_ADDON_EVENT_TRAITS( addon_event::draw_or_dispatch_indirect,
                                   bool,
                                   api::command_list* cmd_list,
                                   api::indirect_command type,
                                   api::resource buffer,
                                   uint64_t offset,
                                   uint32_t draw_count,
                                   uint32_t stride );

RESHADE_DEFINE_ADDON_EVENT_TRAITS( addon_event::copy_resource,
                                   bool,
                                   api::command_list* cmd_list,
                                   api::resource source,
                                   api::resource dest );
RESHADE_DEFINE_ADDON_EVENT_TRAITS( addon_event::copy_buffer_region,
                                   bool,
                                   api::command_list* cmd_list,
                                   api::resource source,
                                   ...
                                   uint64_t size );
RESHADE_DEFINE_ADDON_EVENT_TRAITS( addon_event::copy_buffer_to_texture,
                                   bool,
                                   api::command_list* cmd_list,
                                   api::resource source,
                                   uint64_t source_offset,
                                   ...
                                   const api::subresource_box* dest_box );
RESHADE_DEFINE_ADDON_EVENT_TRAITS( addon_event::copy_texture_region,
                                   bool,
                                   api::command_list* cmd_list,
                                   api::resource source,
...
RESHADE_DEFINE_ADDON_EVENT_TRAITS( addon_event::copy_texture_to_buffer,
                                   bool,
                                   api::command_list* cmd_list,
                                   api::resource source,
                                   uint32_t source_subresource,
                                   ...
                                   uint32_t row_length,
                                   uint32_t slice_height );
RESHADE_DEFINE_ADDON_EVENT_TRAITS( addon_event::resolve_texture_region,
                                   bool,
                                   api::command_list* cmd_list,
                                   api::resource source,
                                   uint32_t source_subresource,
...
RESHADE_DEFINE_ADDON_EVENT_TRAITS( addon_event::clear_depth_stencil_view,
                                   bool,
                                   api::command_list* cmd_list,
                                   api::resource_view dsv,
                                   const float* depth,
                                   ...
                                   uint32_t rect_count,
                                   const api::rect* rects );
RESHADE_DEFINE_ADDON_EVENT_TRAITS( addon_event::clear_render_target_view,
                                   bool,
                                   api::command_list* cmd_list,
                                   ...
                                   const api::rect* rects );
RESHADE_DEFINE_ADDON_EVENT_TRAITS(
    addon_event::clear_unordered_access_view_uint,
    bool,
    api::command_list* cmd_list,
    ...
    const api::rect* rects );
RESHADE_DEFINE_ADDON_EVENT_TRAITS(
    addon_event::clear_unordered_access_view_float,
    bool,
    api::command_list* cmd_list,
    api::resource_view uav,
...
RESHADE_DEFINE_ADDON_EVENT_TRAITS( addon_event::generate_mipmaps,
                                   bool,
                                   api::command_list* cmd_list,
                                   api::resource_view srv );

RESHADE_DEFINE_ADDON_EVENT_TRAITS( addon_event::begin_query,
                                   bool,
                                   api::command_list* cmd_list,
                                   api::query_heap heap,
                                   api::query_type type,
                                   uint32_t index );
RESHADE_DEFINE_ADDON_EVENT_TRAITS( addon_event::end_query,
                                   bool,
                                   api::command_list* cmd_list,
                                   api::query_heap heap,
                                   api::query_type type,
                                   uint32_t index );
RESHADE_DEFINE_ADDON_EVENT_TRAITS( addon_event::copy_query_heap_results,
                                   bool,
                                   api::command_list* cmd_list,
                                   api::query_heap heap,
                                   api::query_type type,
...
RESHADE_DEFINE_ADDON_EVENT_TRAITS( addon_event::copy_acceleration_structure,
                                   bool,
                                   api::command_list* cmd_list,
                                   api::resource_view source,
                                   api::resource_view dest,
                                   api::acceleration_structure_copy_mode mode );
RESHADE_DEFINE_ADDON_EVENT_TRAITS(
    addon_event::build_acceleration_structure,
    bool,
    api::command_list* cmd_list,
    api::acceleration_structure_type type,
    api::acceleration_structure_build_flags flags,
    uint32_t input_count,
    const api::acceleration_structure_build_input* inputs,
...
RESHADE_DEFINE_ADDON_EVENT_TRAITS(
    addon_event::query_acceleration_structures,
    bool,
    api::command_list* cmd_list,
    uint32_t count,
    const api::resource_view* acceleration_structures,
    api::query_heap heap,
    api::query_type type,
    uint32_t first );

RESHADE_DEFINE_ADDON_EVENT_TRAITS( addon_event::reset_command_list,
                                   void,
                                   api::command_list* cmd_list );
RESHADE_DEFINE_ADDON_EVENT_TRAITS( addon_event::close_command_list,
                                   void,
                                   api::command_list* cmd_list );

RESHADE_DEFINE_ADDON_EVENT_TRAITS( addon_event::execute_command_list,
                                   void,
                                   api::command_queue* queue,
                                   api::command_list* cmd_list );
RESHADE_DEFINE_ADDON_EVENT_TRAITS( addon_event::execute_secondary_command_list,
                                   void,
                                   api::command_list* cmd_list,
                                   api::command_list* secondary_cmd_list );

RESHADE_DEFINE_ADDON_EVENT_TRAITS( addon_event::present,
                                   void,
                                   api::command_queue* queue,
                                   api::swapchain* swapchain,
                                   const api::rect* source_rect,
                                   const api::rect* dest_rect,
                                   uint32_t dirty_rect_count,
                                   const api::rect* dirty_rects );
RESHADE_DEFINE_ADDON_EVENT_TRAITS( addon_event::set_fullscreen_state,
                                   bool,
                                   api::swapchain* swapchain,
                                   bool fullscreen,
                                   void* hmonitor );

RESHADE_DEFINE_ADDON_EVENT_TRAITS( addon_event::reshade_present,
                                   void,
                                   api::effect_runtime* runtime );
RESHADE_DEFINE_ADDON_EVENT_TRAITS( addon_event::reshade_begin_effects,
                                   void,
                                   api::effect_runtime* runtime,
                                   api::command_list* cmd_list,
                                   api::resource_view rtv,
                                   api::resource_view rtv_srgb );
RESHADE_DEFINE_ADDON_EVENT_TRAITS( addon_event::reshade_finish_effects,
                                   void,
                                   api::effect_runtime* runtime,
                                   api::command_list* cmd_list,
                                   api::resource_view rtv,
                                   api::resource_view rtv_srgb );
RESHADE_DEFINE_ADDON_EVENT_TRAITS( addon_event::reshade_reloaded_effects,
                                   void,
                                   api::effect_runtime* runtime );

RESHADE_DEFINE_ADDON_EVENT_TRAITS( addon_event::reshade_set_uniform_value,
                                   bool,
                                   api::effect_runtime* runtime,
                                   api::effect_uniform_variable variable,
                                   const void* data,
                                   size_t size );
RESHADE_DEFINE_ADDON_EVENT_TRAITS( addon_event::reshade_set_technique_state,
                                   bool,
                                   api::effect_runtime* runtime,
                                   api::effect_technique technique,
                                   bool enabled );

RESHADE_DEFINE_ADDON_EVENT_TRAITS( addon_event::reshade_overlay,
                                   void,
                                   api::effect_runtime* runtime );
RESHADE_DEFINE_ADDON_EVENT_TRAITS( addon_event::reshade_screenshot,
                                   void,
                                   api::effect_runtime* runtime,
                                   const char* path );

RESHADE_DEFINE_ADDON_EVENT_TRAITS( addon_event::reshade_render_technique,
                                   void,
                                   api::effect_runtime* runtime,
                                   api::effect_technique technique,
                                   api::command_list* cmd_list,
...
RESHADE_DEFINE_ADDON_EVENT_TRAITS( addon_event::reshade_set_effects_state,
                                   ...
                                   api::effect_runtime* runtime,
                                   bool enabled );
RESHADE_DEFINE_ADDON_EVENT_TRAITS( addon_event::reshade_set_current_preset_path,
                                   void,
                                   api::effect_runtime* runtime,
                                   const char* path );
RESHADE_DEFINE_ADDON_EVENT_TRAITS( addon_event::reshade_reorder_techniques,
                                   bool,
                                   api::effect_runtime* runtime,
                                   size_t count,
                                   api::effect_technique* techniques );

RESHADE_DEFINE_ADDON_EVENT_TRAITS( addon_event::reshade_open_overlay,
                                   bool,
                                   api::effect_runtime* runtime,
                                   bool open,
                                   api::input_source source );

RESHADE_DEFINE_ADDON_EVENT_TRAITS(
    addon_event::reshade_overlay_uniform_variable,
    bool,
    api::effect_runtime* runtime,
    api::effect_uniform_variable variable );
RESHADE_DEFINE_ADDON_EVENT_TRAITS( addon_event::reshade_overlay_technique,
                                   bool,
                                   api::effect_runtime* runtime,
                                   api::effect_technique technique );
} // namespace reshade
