...
// Check that the 'ImTextureID' type has the same size as
// 'reshade::api::resource_view'
static_assert(
    sizeof( ImTextureID ) == 8,
    "missing \"#define ImTextureID ImU64\" before \"#include <imgui.h>\"" );
...
struct imgui_function_table_19180 {
    ...
    void ( *SetWindowPos2 )( const char* name,
                             const ImVec2& pos,
                             ImGuiCond cond );
    void ( *SetWindowSize2 )( const char* name,
                              const ImVec2& size,
                              ImGuiCond cond );
    void ( *SetWindowCollapsed2 )( const char* name,
                                   bool collapsed,
                                   ImGuiCond cond );
    ...
    bool ( *CheckboxFlags2 )( const char* label,
                              unsigned int* flags,
    ...
    void ( *TableSetBgColor )( ImGuiTableBgTarget target,
                               ImU32 color,
                               int column_n );
    ...
    bool ( *IsMouseHoveringRect )( const ImVec2& r_min,
                                   const ImVec2& r_max,
                                   bool clip );
    ...
    int ( *ImGuiStorage_GetInt )( const ImGuiStorage* _this,
                                  ImGuiID key,
                                  int default_val );
    void ( *ImGuiStorage_SetInt )( ImGuiStorage* _this, ImGuiID key, int val );
    bool ( *ImGuiStorage_GetBool )( const ImGuiStorage* _this,
                                    ImGuiID key,
                                    bool default_val );
    void ( *ImGuiStorage_SetBool )( ImGuiStorage* _this,
                                    ImGuiID key,
                                    bool val );
    float ( *ImGuiStorage_GetFloat )( const ImGuiStorage* _this,
                                      ImGuiID key,
                                      float default_val );
    void ( *ImGuiStorage_SetFloat )( ImGuiStorage* _this,
                                     ImGuiID key,
                                     float val );
    void* ( *ImGuiStorage_GetVoidPtr )( const ImGuiStorage* _this,
                                        ImGuiID key );
    void ( *ImGuiStorage_SetVoidPtr )( ImGuiStorage* _this,
                                       ImGuiID key,
                                       void* val );
    int* ( *ImGuiStorage_GetIntRef )( ImGuiStorage* _this,
                                      ImGuiID key,
                                      int default_val );
    bool* ( *ImGuiStorage_GetBoolRef )( ImGuiStorage* _this,
                                        ImGuiID key,
                                        bool default_val );
    float* ( *ImGuiStorage_GetFloatRef )( ImGuiStorage* _this,
                                          ImGuiID key,
                                          float default_val );
    void** ( *ImGuiStorage_GetVoidPtrRef )( ImGuiStorage* _this,
                                            ImGuiID key,
                                            void* default_val );
    ...
    void ( *ImGuiListClipper_Begin )( ImGuiListClipper* _this,
                                      int items_count,
                                      float items_height );
    void ( *ImGuiListClipper_End )( ImGuiListClipper* _this );
    bool ( *ImGuiListClipper_Step )( ImGuiListClipper* _this );
    void ( *ImGuiListClipper_IncludeItemsByIndex )( ImGuiListClipper* _this,
                                                    int item_begin,
                                                    int item_end );
    void ( *ImGuiListClipper_SeekCursorForItem )( ImGuiListClipper* _this,
                                                  int item_index );
    void ( *ConstructImDrawList )( ImDrawList* _this,
                                   ImDrawListSharedData* shared_data );
    void ( *DestructImDrawList )( ImDrawList* _this );
    void ( *ImDrawList_PushClipRect )( ImDrawList* _this,
    ...
    void ( *ImDrawList_AddLine )( ImDrawList* _this,
                                  const ImVec2& p1,
                                  const ImVec2& p2,
                                  ImU32 col,
                                  float thickness );
    void ( *ImDrawList_AddRect )( ImDrawList* _this,
                                  const ImVec2& p_min,
                                  const ImVec2& p_max,
                                  ImU32 col,
                                  float rounding,
                                  ImDrawFlags flags,
                                  float thickness );
    void ( *ImDrawList_AddRectFilled )( ImDrawList* _this,
                                        const ImVec2& p_min,
                                        const ImVec2& p_max,
                                        ImU32 col,
                                        float rounding,
                                        ImDrawFlags flags );
    void ( *ImDrawList_AddRectFilledMultiColor )( ImDrawList* _this,
                                                  const ImVec2& p_min,
                                                  const ImVec2& p_max,
                                                  ImU32 col_upr_left,
                                                  ImU32 col_upr_right,
                                                  ImU32 col_bot_right,
                                                  ImU32 col_bot_left );
    void ( *ImDrawList_AddQuad )( ImDrawList* _this,
                                  const ImVec2& p1,
                                  const ImVec2& p2,
                                  const ImVec2& p3,
                                  const ImVec2& p4,
                                  ImU32 col,
                                  float thickness );
    void ( *ImDrawList_AddQuadFilled )( ImDrawList* _this,
                                        const ImVec2& p1,
                                        const ImVec2& p2,
                                        const ImVec2& p3,
                                        const ImVec2& p4,
                                        ImU32 col );
    void ( *ImDrawList_AddTriangle )( ImDrawList* _this,
                                      const ImVec2& p1,
                                      const ImVec2& p2,
                                      const ImVec2& p3,
                                      ImU32 col,
                                      float thickness );
    void ( *ImDrawList_AddTriangleFilled )( ImDrawList* _this,
                                            const ImVec2& p1,
                                            const ImVec2& p2,
                                            const ImVec2& p3,
                                            ImU32 col );
    void ( *ImDrawList_AddCircle )( ImDrawList* _this,
                                    const ImVec2& center,
                                    float radius,
                                    ImU32 col,
                                    int num_segments,
                                    float thickness );
    void ( *ImDrawList_AddCircleFilled )( ImDrawList* _this,
                                          const ImVec2& center,
                                          float radius,
                                          ImU32 col,
                                          int num_segments );
    void ( *ImDrawList_AddNgon )( ImDrawList* _this,
                                  const ImVec2& center,
                                  float radius,
                                  ImU32 col,
                                  int num_segments,
                                  float thickness );
    void ( *ImDrawList_AddNgonFilled )( ImDrawList* _this,
                                        const ImVec2& center,
                                        float radius,
                                        ImU32 col,
                                        int num_segments );
    void ( *ImDrawList_AddEllipse )( ImDrawList* _this,
                                     const ImVec2& center,
                                     const ImVec2& radius,
                                     ImU32 col,
                                     float rot,
                                     int num_segments,
                                     float thickness );
    void ( *ImDrawList_AddEllipseFilled )( ImDrawList* _this,
                                           const ImVec2& center,
                                           const ImVec2& radius,
                                           ImU32 col,
                                           float rot,
                                           int num_segments );
    void ( *ImDrawList_AddText )( ImDrawList* _this,
                                  const ImVec2& pos,
                                  ImU32 col,
                                  const char* text_begin,
                                  const char* text_end );
    void ( *ImDrawList_AddText2 )( ImDrawList* _this,
                                   ImFont* font,
                                   float font_size,
                                   const ImVec2& pos,
                                   ImU32 col,
    ...
    void ( *ImDrawList_AddBezierCubic )( ImDrawList* _this,
                                         const ImVec2& p1,
                                         const ImVec2& p2,
                                         const ImVec2& p3,
                                         const ImVec2& p4,
                                         ...
                                         float thickness,
                                         int num_segments );
    void ( *ImDrawList_AddBezierQuadratic )( ImDrawList* _this,
                                             const ImVec2& p1,
                                             const ImVec2& p2,
                                             const ImVec2& p3,
                                             ImU32 col,
                                             float thickness,
                                             int num_segments );
    void ( *ImDrawList_AddPolyline )( ImDrawList* _this,
                                      const ImVec2* points,
                                      int num_points,
                                      ImU32 col,
                                      ImDrawFlags flags,
                                      float thickness );
    void ( *ImDrawList_AddConvexPolyFilled )( ImDrawList* _this,
                                              const ImVec2* points,
                                              int num_points,
                                              ImU32 col );
    void ( *ImDrawList_AddConcavePolyFilled )( ImDrawList* _this,
                                               const ImVec2* points,
                                               int num_points,
                                               ImU32 col );
    void ( *ImDrawList_AddImage )( ImDrawList* _this,
                                   ImTextureID user_texture_id,
                                   const ImVec2& p_min,
                                   const ImVec2& p_max,
                                   const ImVec2& uv_min,
                                   const ImVec2& uv_max,
                                   ImU32 col );
    void ( *ImDrawList_AddImageQuad )( ImDrawList* _this,
                                       ImTextureID user_texture_id,
                                       const ImVec2& p1,
                                       const ImVec2& p2,
                                       const ImVec2& p3,
    ...
    void ( *ImDrawList_AddImageRounded )( ImDrawList* _this,
                                          ...
                                          float rounding,
                                          ImDrawFlags flags );
    void ( *ImDrawList_PathArcTo )( ImDrawList* _this,
                                    const ImVec2& center,
                                    float radius,
                                    float a_min,
                                    float a_max,
                                    int num_segments );
    void ( *ImDrawList_PathArcToFast )( ImDrawList* _this,
                                        const ImVec2& center,
                                        float radius,
                                        int a_min_of_12,
                                        int a_max_of_12 );
    void ( *ImDrawList_PathEllipticalArcTo )( ImDrawList* _this,
                                              const ImVec2& center,
                                              const ImVec2& radius,
                                              float rot,
                                              float a_min,
                                              float a_max,
                                              int num_segments );
    void ( *ImDrawList_PathBezierCubicCurveTo )( ImDrawList* _this,
                                                 const ImVec2& p2,
                                                 const ImVec2& p3,
                                                 const ImVec2& p4,
                                                 int num_segments );
    void ( *ImDrawList_PathBezierQuadraticCurveTo )( ImDrawList* _this,
                                                     const ImVec2& p2,
                                                     const ImVec2& p3,
                                                     int num_segments );
    void ( *ImDrawList_PathRect )( ImDrawList* _this,
                                   const ImVec2& rect_min,
                                   const ImVec2& rect_max,
                                   float rounding,
                                   ImDrawFlags flags );
    void ( *ImDrawList_AddCallback )( ImDrawList* _this,
    ...
    void ( *ImDrawList_PrimReserve )( ImDrawList* _this,
                                      int idx_count,
                                      int vtx_count );
    void ( *ImDrawList_PrimUnreserve )( ImDrawList* _this,
                                        int idx_count,
                                        int vtx_count );
    void ( *ImDrawList_PrimRect )( ImDrawList* _this,
                                   const ImVec2& a,
                                   const ImVec2& b,
                                   ImU32 col );
    void ( *ImDrawList_PrimRectUV )( ImDrawList* _this,
                                     const ImVec2& a,
                                     const ImVec2& b,
                                     const ImVec2& uv_a,
                                     const ImVec2& uv_b,
                                     ImU32 col );
    void ( *ImDrawList_PrimQuadUV )( ImDrawList* _this,
                                     const ImVec2& a,
                                     const ImVec2& b,
                                     const ImVec2& c,
                                     const ImVec2& d,
    ...
    const ImFontGlyph* ( *ImFont_FindGlyphNoFallback )( ImFont* _this,
                                                        ImWchar c );
    ImVec2 ( *ImFont_CalcTextSizeA )( ImFont* _this,
                                      float size,
                                      float max_width,
                                      float wrap_width,
                                      const char* text_begin,
    ...
    const char* ( *ImFont_CalcWordWrapPositionA )( ImFont* _this,
                                                   float scale,
                                                   const char* text,
                                                   const char* text_end,
                                                   float wrap_width );
    void ( *ImFont_RenderChar )( ImFont* _this,
                                 ImDrawList* draw_list,
                                 float size,
                                 const ImVec2& pos,
                                 ImU32 col,
                                 ImWchar c );
    void ( *ImFont_RenderText )( ImFont* _this,
                                 ImDrawList* draw_list,
                                 float size,
                                 const ImVec2& pos,
                                 ImU32 col,
...
inline bool Combo( const char* label,
                   ...
                   const char* items_separated_by_zeros,
                   int popup_max_height_in_items ) {
    return imgui_function_table_instance()->Combo2( label, current_item,
...
inline bool Combo( const char* label,
                   ...
                   int items_count,
                   int popup_max_height_in_items ) {
    return imgui_function_table_instance()->Combo3( label, current_item, getter,
...
inline bool DragFloatRange2( const char* label,
                             ...
                             const char* format_max,
                             ImGuiSliderFlags flags ) {
    return imgui_function_table_instance()->DragFloatRange2(
...
inline bool DragIntRange2( const char* label,
                           ...
                           const char* format_max,
                           ImGuiSliderFlags flags ) {
    return imgui_function_table_instance()->DragIntRange2(
        label, v_current_min, v_current_max, v_speed, v_min, v_max, format,
        format_max, flags );
}
...
inline bool DragScalarN( const char* label,
                         ...
                         const char* format,
                         ImGuiSliderFlags flags ) {
    return imgui_function_table_instance()->DragScalarN(
...
inline bool InputScalarN( const char* label,
                          ...
                          const char* format,
                          ImGuiInputTextFlags flags ) {
    return imgui_function_table_instance()->InputScalarN(
...
inline void PlotLines( const char* label,
                       ...
                       ImVec2 graph_size,
                       int stride ) {
    imgui_function_table_instance()->PlotLines(
...
inline void PlotLines( const char* label,
                       ...
                       float scale_max,
                       ImVec2 graph_size ) {
    imgui_function_table_instance()->PlotLines2(
...
inline void PlotHistogram( const char* label,
                           ...
                           ImVec2 graph_size,
                           int stride ) {
    imgui_function_table_instance()->PlotHistogram(
        label, values, values_count, values_offset, overlay_text, scale_min,
        scale_max, graph_size, stride );
}
inline void PlotHistogram( const char* label,
                           ...
                           float scale_max,
                           ImVec2 graph_size ) {
    imgui_function_table_instance()->PlotHistogram2(
        label, values_getter, data, values_count, values_offset, overlay_text,
        scale_min, scale_max, graph_size );
}
...
inline void ImDrawList::AddRectFilledMultiColor( const ImVec2& p_min,
                                                 ...
                                                 ImU32 col_bot_right,
                                                 ImU32 col_bot_left ) {
    imgui_function_table_instance()->ImDrawList_AddRectFilledMultiColor(
...
inline void ImDrawList::AddText( ImFont* font,
                                 ...
                                 float wrap_width,
                                 const ImVec4* cpu_fine_clip_rect ) {
    imgui_function_table_instance()->ImDrawList_AddText2(
...
inline void ImDrawList::AddImageRounded( ImTextureID user_texture_id,
                                         ...
                                         float rounding,
                                         ImDrawFlags flags ) {
    imgui_function_table_instance()->ImDrawList_AddImageRounded(
...
inline void ImFont::RenderText( ImDrawList* draw_list,
                                ...
                                float wrap_width,
                                bool cpu_fine_clip ) {
    imgui_function_table_instance()->ImFont_RenderText(
        this, draw_list, size, pos, col, clip_rect, text_begin, text_end,
