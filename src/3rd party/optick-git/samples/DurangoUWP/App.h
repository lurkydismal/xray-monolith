...
namespace BrofilerDurangoTest {
// Main entry point for our app. Connects the app with the Windows shell and
...
protected:
    ...
    void OnOrientationChanged( Windows::Graphics::Display::DisplayInformation ^
                                   sender,
                               Platform::Object ^ args );
...
private:
    ...
    std::unique_ptr< BrofilerDurangoTestMain > m_main;
    bool m_windowClosed;
