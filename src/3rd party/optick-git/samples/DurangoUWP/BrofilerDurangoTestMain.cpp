...
// Updates application state when the window size changes (e.g. device
// orientation change)
void BrofilerDurangoTestMain::CreateWindowSizeDependentResources() {
    // TODO: Replace this with the size-dependent initialization of your app's
    // content.
...
void BrofilerDurangoTestMain::Update() {
    BROFILER_CATEGORY( "BrofilerDurangoTestMain::Update",
