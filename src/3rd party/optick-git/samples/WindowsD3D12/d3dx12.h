    ...
    explicit CD3DX12_VIEWPORT( _In_ ID3D12Resource* pResource,
        ...
        switch ( Desc.Dimension ) {
            ...
            case D3D12_RESOURCE_DIMENSION_TEXTURE1D:
                ...
                TopLeftY = 0.0f;
                Width =
                    ( SubresourceWidth ? SubresourceWidth : 1.0f ) - topLeftX;
                Height = 1.0f;
                break;
            ...
            case D3D12_RESOURCE_DIMENSION_TEXTURE3D:
                ...
                Width =
                    ( SubresourceWidth ? SubresourceWidth : 1.0f ) - topLeftX;
                Height =
                    ( SubresourceHeight ? SubresourceHeight : 1.0f ) - topLeftY;
                break;
            default:
                break;
        }
...
struct CD3DX12_BOX : public D3D12_BOX {
    ...
    explicit CD3DX12_BOX( LONG Left,
                          LONG Top,
                          LONG Front,
                          LONG Right,
                          LONG Bottom,
...
struct CD3DX12_HEAP_DESC : public D3D12_HEAP_DESC {
    ...
    CD3DX12_HEAP_DESC( UINT64 size,
        ...
        SizeInBytes = size;
        Properties =
            CD3DX12_HEAP_PROPERTIES( cpuPageProperty, memoryPoolPreference );
        Alignment = alignment;
        Flags = flags;
    }
...
struct CD3DX12_TILED_RESOURCE_COORDINATE
    ...
    CD3DX12_TILED_RESOURCE_COORDINATE( UINT x,
                                       UINT y,
                                       UINT z,
                                       UINT subresource ) {
        X = x;
...
struct CD3DX12_TILE_SHAPE : public D3D12_TILE_SHAPE {
    ...
    explicit CD3DX12_TILE_SHAPE( const D3D12_TILE_SHAPE& o )
        : D3D12_TILE_SHAPE( o ) {}
    CD3DX12_TILE_SHAPE( UINT widthInTexels,
                        UINT heightInTexels,
                        UINT depthInTexels ) {
...
struct CD3DX12_DESCRIPTOR_RANGE : public D3D12_DESCRIPTOR_RANGE {
    ...
    inline void Init( D3D12_DESCRIPTOR_RANGE_TYPE rangeType,
                      ...
                      UINT offsetInDescriptorsFromTableStart =
                          D3D12_DESCRIPTOR_RANGE_OFFSET_APPEND ) {
        Init( *this, rangeType, numDescriptors, baseShaderRegister,
...
struct CD3DX12_STATIC_SAMPLER_DESC : public D3D12_STATIC_SAMPLER_DESC {
    ...
    inline void Init(
        ...
        Init( *this, shaderRegister, filter, addressU, addressV, addressW,
              mipLODBias, maxAnisotropy, comparisonFunc, borderColor, minLOD,
...
struct CD3DX12_ROOT_DESCRIPTOR_TABLE1 : public D3D12_ROOT_DESCRIPTOR_TABLE1 {
    ...
    explicit CD3DX12_ROOT_DESCRIPTOR_TABLE1(
        const D3D12_ROOT_DESCRIPTOR_TABLE1& o )
...
struct CD3DX12_VERSIONED_ROOT_SIGNATURE_DESC
    ...
    CD3DX12_VERSIONED_ROOT_SIGNATURE_DESC(
        ...
        _In_reads_opt_( numStaticSamplers )
            const D3D12_STATIC_SAMPLER_DESC* _pStaticSamplers = NULL,
        D3D12_ROOT_SIGNATURE_FLAGS flags = D3D12_ROOT_SIGNATURE_FLAG_NONE ) {
        Init_1_0( numParameters, _pParameters, numStaticSamplers,
                  _pStaticSamplers, flags );
    }
    CD3DX12_VERSIONED_ROOT_SIGNATURE_DESC(
        UINT numParameters,
        ...
        _In_reads_opt_( numStaticSamplers )
            const D3D12_STATIC_SAMPLER_DESC* _pStaticSamplers = NULL,
        D3D12_ROOT_SIGNATURE_FLAGS flags = D3D12_ROOT_SIGNATURE_FLAG_NONE ) {
        Init_1_1( numParameters, _pParameters, numStaticSamplers,
                  _pStaticSamplers, flags );
    }
...
struct CD3DX12_CPU_DESCRIPTOR_HANDLE : public D3D12_CPU_DESCRIPTOR_HANDLE {
    ...
    inline void InitOffsetted( _In_ const D3D12_CPU_DESCRIPTOR_HANDLE& base,
                               INT offsetInDescriptors,
                               UINT descriptorIncrementSize ) {
        InitOffsetted( *this, base, offsetInDescriptors,
...
struct CD3DX12_GPU_DESCRIPTOR_HANDLE : public D3D12_GPU_DESCRIPTOR_HANDLE {
    ...
    CD3DX12_GPU_DESCRIPTOR_HANDLE(
        _In_ const D3D12_GPU_DESCRIPTOR_HANDLE& other,
        INT offsetScaledByIncrementSize ) {
        InitOffsetted( other, offsetScaledByIncrementSize );
    }
    CD3DX12_GPU_DESCRIPTOR_HANDLE(
    ...
    inline bool operator==(
        _In_ const D3D12_GPU_DESCRIPTOR_HANDLE& other ) const {
        return ( ptr == other.ptr );
    }
    inline bool operator!=(
        _In_ const D3D12_GPU_DESCRIPTOR_HANDLE& other ) const {
    ...
    static inline void InitOffsetted(
        _Out_ D3D12_GPU_DESCRIPTOR_HANDLE& handle,
...
struct CD3DX12_RESOURCE_DESC : public D3D12_RESOURCE_DESC {
    ...
    static inline CD3DX12_RESOURCE_DESC Buffer(
        ...
        UINT64 alignment = 0 ) {
        return CD3DX12_RESOURCE_DESC(
            D3D12_RESOURCE_DIMENSION_BUFFER, alignment, width, 1, 1, 1,
    ...
    static inline CD3DX12_RESOURCE_DESC Tex1D(
        ...
        return CD3DX12_RESOURCE_DESC( D3D12_RESOURCE_DIMENSION_TEXTURE1D,
                                      alignment, width, 1, arraySize, mipLevels,
    ...
    inline UINT16 Depth() const {
        return ( Dimension == D3D12_RESOURCE_DIMENSION_TEXTURE3D
                     ? DepthOrArraySize
                     : 1 );
    }
    ...
    inline UINT CalcSubresource( UINT MipSlice,
                                 UINT ArraySlice,
                                 UINT PlaneSlice ) {
        return D3D12CalcSubresource( MipSlice, ArraySlice, PlaneSlice,
                                     MipLevels, ArraySize() );
    }
};
...
inline UINT64 UpdateSubresources(
    ...
    for ( UINT i = 0; i < NumSubresources; ++i ) {
        ...
        MemcpySubresource( &DestData, &pSrcData[ i ],
                           ( SIZE_T )pRowSizesInBytes[ i ], pNumRows[ i ],
...
inline ID3D12CommandList* const* CommandListCast(
...
inline HRESULT D3DX12SerializeVersionedRootSignature(
    ...
    switch ( MaxVersion ) {
            ...
            switch ( pRootSignatureDesc->Version ) {
                case D3D_ROOT_SIGNATURE_VERSION_1_0:
                    return D3D12SerializeRootSignature(
                        ...
                        D3D_ROOT_SIGNATURE_VERSION_1, ppBlob, ppErrorBlob );
                ...
                case D3D_ROOT_SIGNATURE_VERSION_1_1: {
                    ...
                    D3D12_ROOT_PARAMETER* pParameters_1_0 =
                        reinterpret_cast< D3D12_ROOT_PARAMETER* >(
                            pParameters );

                    if ( SUCCEEDED( hr ) ) {
                        for ( UINT n = 0; n < desc_1_1.NumParameters; n++ ) {
                            __analysis_assume( ParametersSize ==
                            ...
                            switch ( desc_1_1.pParameters[ n ].ParameterType ) {
                                ...
                                case D3D12_ROOT_PARAMETER_TYPE_DESCRIPTOR_TABLE:
                                    const D3D12_ROOT_DESCRIPTOR_TABLE1&
                                        table_1_1 = desc_1_1.pParameters[ n ]
                                                        .DescriptorTable;
                    ...
                    if ( SUCCEEDED( hr ) ) {
                        ...
                        hr = D3D12SerializeRootSignature(
                            &desc_1_0, D3D_ROOT_SIGNATURE_VERSION_1, ppBlob,
                            ppErrorBlob );
                    }
        ...
        case D3D_ROOT_SIGNATURE_VERSION_1_1:
            return D3D12SerializeVersionedRootSignature( pRootSignatureDesc,
                                                         ppBlob, ppErrorBlob );
    }
...
struct CD3DX12_PIPELINE_STATE_STREAM1 {
    ...
    CD3DX12_PIPELINE_STATE_STREAM1(
        ...
        : Flags( Desc.Flags ),
          ...
          DepthStencilState(
              CD3DX12_DEPTH_STENCIL_DESC1( Desc.DepthStencilState ) ),
          DSVFormat( Desc.DSVFormat ),
          RasterizerState( CD3DX12_RASTERIZER_DESC( Desc.RasterizerState ) ),
          RTVFormats( CD3DX12_RT_FORMAT_ARRAY( Desc.RTVFormats,
    ...
    CD3DX12_PIPELINE_STATE_STREAM1(
        ...
        : Flags( Desc.Flags ),
          ...
          CachedPSO( Desc.CachedPSO ) {
        static_cast< D3D12_DEPTH_STENCIL_DESC1& >( DepthStencilState )
            .DepthEnable = false;
    }
...
struct CD3DX12_PIPELINE_STATE_STREAM_PARSE_HELPER
    ...
    CD3DX12_PIPELINE_STATE_STREAM_PARSE_HELPER() : SeenDSS( false ) {
        ...
        static_cast< D3D12_DEPTH_STENCIL_DESC1& >(
    ...
    void DepthStencilState1Cb(
        const D3D12_DEPTH_STENCIL_DESC1& DepthStencilState ) {
        PipelineStream.DepthStencilState =
            CD3DX12_DEPTH_STENCIL_DESC1( DepthStencilState );
        SeenDSS = true;
    }
    ...
    void RasterizerStateCb( const D3D12_RASTERIZER_DESC& RasterizerState ) {
        PipelineStream.RasterizerState =
    ...
    void ViewInstancingCb(
        const D3D12_VIEW_INSTANCING_DESC& ViewInstancingDesc ) {
...
inline HRESULT D3DX12ParsePipelineStream(
    ...
    if ( Desc.SizeInBytes == 0 ||
         Desc.pPipelineStateSubobjectStream == nullptr ) {
    ...
    for ( SIZE_T CurOffset = 0, SizeOfSubobject = 0;
          CurOffset < Desc.SizeInBytes; CurOffset += SizeOfSubobject ) {
        BYTE* pStream =
            static_cast< BYTE* >( Desc.pPipelineStateSubobjectStream ) +
            CurOffset;
        auto SubobjectType =
            *reinterpret_cast< D3D12_PIPELINE_STATE_SUBOBJECT_TYPE* >(
                pStream );
        ...
        switch ( SubobjectType ) {
            ...
            case D3D12_PIPELINE_STATE_SUBOBJECT_TYPE_VS:
                pCallbacks->VSCb(
                    *reinterpret_cast<
                        decltype( CD3DX12_PIPELINE_STATE_STREAM::VS )* >(
                        pStream ) );
            ...
            case D3D12_PIPELINE_STATE_SUBOBJECT_TYPE_PS:
                pCallbacks->PSCb(
                    *reinterpret_cast<
                        decltype( CD3DX12_PIPELINE_STATE_STREAM::PS )* >(
                        pStream ) );
            ...
            case D3D12_PIPELINE_STATE_SUBOBJECT_TYPE_DS:
                pCallbacks->DSCb(
                    *reinterpret_cast<
                        decltype( CD3DX12_PIPELINE_STATE_STREAM::DS )* >(
                        pStream ) );
            ...
            case D3D12_PIPELINE_STATE_SUBOBJECT_TYPE_HS:
                pCallbacks->HSCb(
                    *reinterpret_cast<
                        decltype( CD3DX12_PIPELINE_STATE_STREAM::HS )* >(
                        pStream ) );
            ...
            case D3D12_PIPELINE_STATE_SUBOBJECT_TYPE_GS:
                pCallbacks->GSCb(
                    *reinterpret_cast<
                        decltype( CD3DX12_PIPELINE_STATE_STREAM::GS )* >(
                        pStream ) );
            ...
            case D3D12_PIPELINE_STATE_SUBOBJECT_TYPE_CS:
                pCallbacks->CSCb(
                    *reinterpret_cast<
                        decltype( CD3DX12_PIPELINE_STATE_STREAM::CS )* >(
                        pStream ) );
            ...
            case D3D12_PIPELINE_STATE_SUBOBJECT_TYPE_BLEND:
                pCallbacks->BlendStateCb(
                    *reinterpret_cast< decltype( CD3DX12_PIPELINE_STATE_STREAM::
                        ...
                        pStream ) );
                SizeOfSubobject =
                    sizeof( CD3DX12_PIPELINE_STATE_STREAM::BlendState );
                break;
            case D3D12_PIPELINE_STATE_SUBOBJECT_TYPE_SAMPLE_MASK:
                pCallbacks->SampleMaskCb(
                    *reinterpret_cast< decltype( CD3DX12_PIPELINE_STATE_STREAM::
                        ...
                        pStream ) );
                SizeOfSubobject =
                    sizeof( CD3DX12_PIPELINE_STATE_STREAM::SampleMask );
                break;
            ...
            case D3D12_PIPELINE_STATE_SUBOBJECT_TYPE_RENDER_TARGET_FORMATS:
                pCallbacks->RTVFormatsCb(
                    *reinterpret_cast< decltype( CD3DX12_PIPELINE_STATE_STREAM::
                        ...
                        pStream ) );
                SizeOfSubobject =
                    sizeof( CD3DX12_PIPELINE_STATE_STREAM::RTVFormats );
                break;
            case D3D12_PIPELINE_STATE_SUBOBJECT_TYPE_DEPTH_STENCIL_FORMAT:
                pCallbacks->DSVFormatCb(
                    *reinterpret_cast<
                        ...
                        pStream ) );
                SizeOfSubobject =
                    sizeof( CD3DX12_PIPELINE_STATE_STREAM::DSVFormat );
                break;
            case D3D12_PIPELINE_STATE_SUBOBJECT_TYPE_SAMPLE_DESC:
                pCallbacks->SampleDescCb(
                    *reinterpret_cast< decltype( CD3DX12_PIPELINE_STATE_STREAM::
                        ...
                        pStream ) );
                SizeOfSubobject =
                    sizeof( CD3DX12_PIPELINE_STATE_STREAM::SampleDesc );
                break;
            case D3D12_PIPELINE_STATE_SUBOBJECT_TYPE_NODE_MASK:
                pCallbacks->NodeMaskCb(
                    *reinterpret_cast<
                        ...
                        pStream ) );
                SizeOfSubobject =
                    sizeof( CD3DX12_PIPELINE_STATE_STREAM::NodeMask );
                break;
            case D3D12_PIPELINE_STATE_SUBOBJECT_TYPE_CACHED_PSO:
                pCallbacks->CachedPSOCb(
                    *reinterpret_cast<
                        ...
                        pStream ) );
                SizeOfSubobject =
                    sizeof( CD3DX12_PIPELINE_STATE_STREAM::CachedPSO );
                break;
            case D3D12_PIPELINE_STATE_SUBOBJECT_TYPE_FLAGS:
                pCallbacks->FlagsCb(
                    *reinterpret_cast<
                        decltype( CD3DX12_PIPELINE_STATE_STREAM::Flags )* >(
                        pStream ) );
                SizeOfSubobject =
                    sizeof( CD3DX12_PIPELINE_STATE_STREAM::Flags );
                break;
            case D3D12_PIPELINE_STATE_SUBOBJECT_TYPE_VIEW_INSTANCING:
                pCallbacks->ViewInstancingCb(
                    *reinterpret_cast<
                        decltype( CD3DX12_PIPELINE_STATE_STREAM1::
                                      ViewInstancingDesc )* >( pStream ) );
                SizeOfSubobject = sizeof(
                    CD3DX12_PIPELINE_STATE_STREAM1::ViewInstancingDesc );
                break;
            default:
                pCallbacks->ErrorUnknownSubobject( SubobjectType );
                return E_INVALIDARG;
