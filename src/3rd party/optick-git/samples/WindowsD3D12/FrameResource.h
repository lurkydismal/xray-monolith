...
private:
    ...
    SceneConstantBuffer*
        mp_shadowConstantBufferWO; // WRITE-ONLY pointer to the shadow pass
                                   // constant buffer.
    SceneConstantBuffer*
        mp_sceneConstantBufferWO; // WRITE-ONLY pointer to the scene pass
                                  // constant buffer.
    D3D12_GPU_DESCRIPTOR_HANDLE
    m_nullSrvHandle; // Null SRV for out of bounds behavior.
