...
public:
    ...
    /// Create a texture_cube_array and allocate a new storage_linear with a
    ...
    explicit texture_cube_array( texture const& Texture );
    ...
    /// Create a texture view, reference a subset of an exiting
    /// texture_cube_array instance
    texture_cube_array( texture_cube_array const& Texture,
                        size_type BaseLayer,
                        size_type MaxLayer,
                        size_type BaseFace,
                        size_type MaxFace,
    ...
    /// Return the dimensions of a texture instance: width and height where both
    /// should be equal.
