...
public:
    ...
    /// Create a texture2d and allocate a new storage_linear with a complete
    /// mipmap chain.
    texture2d( format_type Format,
               extent_type const& Extent,
               swizzles_type const& Swizzles = swizzles_type( SWIZZLE_RED,
    ...
    /// Create a texture2d view with an existing storage_linear.
    texture2d( texture const& Texture,
               format_type Format,
               size_type BaseLayer,
               size_type MaxLayer,
               size_type BaseFace,
    ...
    /// Create a texture2d view, reference a subset of an existing texture2d
    /// instance.
