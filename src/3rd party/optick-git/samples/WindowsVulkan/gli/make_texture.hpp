...
gli::texture make_texture1d( format Format,
...
gli::texture make_texture1d_array( format Format,
                                   extent1d const& Extent,
                                   size_t Layers,
                                   size_t Levels );
...
gli::texture make_texture2d( format Format,
...
gli::texture make_texture2d_array( format Format,
                                   extent2d const& Extent,
                                   size_t Layer,
                                   size_t Levels );
...
gli::texture make_texture3d( format Format,
...
gli::texture make_texture_cube( format Format,
                                extent2d const& Extent,
                                size_t Levels );
...
// Helper function to create a cube array texture with a specific number of
// levels
gli::texture make_texture_cube_array( format Format,
                                      extent2d const& Extent,
                                      size_t Layer,
                                      size_t Levels );
