...
public:
    ...
    /// Create a texture2d_array and allocate a new storage_linear with a
    ...
    /// Create a texture view, reference a subset of an exiting texture2d_array
    /// instance
    texture2d_array( texture2d_array const& Texture,
                     size_type BaseLayer,
                     size_type MaxLayer,
                     size_type BaseLevel,
                     size_type MaxLevel );
