/// @brief Include to duplicate textures, images or a subset of either textures
/// or an image. These operations will cause memory allocations.
...
namespace gli {
/// Duplicate an image and create a new image with a new storage_linear
/// allocation.
image duplicate( image const& Image );

/// Duplicate a texture and create a new texture with a new storage_linear
/// allocation.
template < typename texType >
texture duplicate( texType const& Texture );

/// Duplicate a texture and create a new texture with a new storage_linear
/// allocation but a different format. The format must be a compatible format, a
/// format which block size match the original format.
template < typename texType >
texture duplicate( texType const& Texture, format Format );

/// Duplicate a subset of a texture and create a new texture with a new
/// storage_linear allocation.
texture duplicate( texture1d const& Texture,
                   texture1d::size_type BaseLevel,
                   texture1d::size_type MaxLevel );

/// Duplicate a subset of a texture and create a new texture with a new
/// storage_linear allocation.
texture duplicate( texture1d_array const& Texture,
...
/// Duplicate a subset of a texture and create a new texture with a new
/// storage_linear allocation.
texture duplicate( texture2d const& Texture,
                   texture2d::size_type BaseLevel,
                   texture2d::size_type MaxLevel );

/// Duplicate a subset of a texture and create a new texture with a new
/// storage_linear allocation.
texture duplicate( texture2d_array const& Texture,
...
/// Duplicate a subset of a texture and create a new texture with a new
/// storage_linear allocation.
texture duplicate( texture3d const& Texture,
                   texture3d::size_type BaseLevel,
                   texture3d::size_type MaxLevel );

/// Duplicate a subset of a texture and create a new texture with a new
/// storage_linear allocation.
texture duplicate( texture_cube const& Texture,
...
/// Duplicate a subset of a texture and create a new texture with a new
/// storage_linear allocation.
texture duplicate( texture_cube_array const& Texture,
