...
inline bool save_kmg( texture const& Texture, std::vector< char >& Memory ) {
    ...
    Memory.resize( sizeof( detail::FOURCC_KMG100 ) +
                   sizeof( detail::kmgHeader10 ) + Texture.size() );

    std::memcpy( &Memory[ 0 ], detail::FOURCC_KMG100,
                 sizeof( detail::FOURCC_KMG100 ) );
    ...
    detail::kmgHeader10& Header =
        *reinterpret_cast< detail::kmgHeader10* >( &Memory[ 0 ] + Offset );
