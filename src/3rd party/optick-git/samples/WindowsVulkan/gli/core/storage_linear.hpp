...
public:
    ...
    storage_linear( format_type Format,
    ...
    /// Compute the relative memory offset to access the data for a specific
    /// layer, face and level
    size_type base_offset( size_type Layer,
                           size_type Face,
                           size_type Level ) const;

    size_type image_offset( extent1d const& Coord,
                            extent1d const& Extent ) const;

    size_type image_offset( extent2d const& Coord,
                            extent2d const& Extent ) const;

    size_type image_offset( extent3d const& Coord,
                            extent3d const& Extent ) const;

    /// Copy a subset of a specific image of a texture
    void copy( storage_linear const& StorageSrc,
               size_t LayerSrc,
               size_t FaceSrc,
               size_t LevelSrc,
    ...
    size_type layer_size( size_type BaseFace,
                          size_type MaxFace,
                          size_type BaseLevel,
