...
static unsigned char const FOURCC_KTX20[] = {
...
inline texture load_ktx10( char const* Data, std::size_t Size ) {
    detail::ktx_header10 const& Header(
        *reinterpret_cast< detail::ktx_header10 const* >( Data ) );
    ...
    texture Texture(
        detail::get_target( Header ), Format,
        texture::extent_type(
            Header.PixelWidth,
...
inline texture load_ktx( char const* Data, std::size_t Size ) {
    ...
    // KTX10
    {
        if ( memcmp( Data, detail::FOURCC_KTX10,
                     sizeof( detail::FOURCC_KTX10 ) ) == 0 )
            return detail::load_ktx10( Data + sizeof( detail::FOURCC_KTX10 ),
                                       Size - sizeof( detail::FOURCC_KTX10 ) );
    }
