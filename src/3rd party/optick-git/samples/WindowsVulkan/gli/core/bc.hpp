...
glm::vec4 decompress_bc1( const bc1_block& Block,
                          const extent2d& BlockTexelCoord );
texel_block4x4 decompress_dxt1_block( const dxt1_block& Block );

glm::vec4 decompress_bc2( const bc2_block& Block,
                          const extent2d& BlockTexelCoord );
texel_block4x4 decompress_dxt3_block( const bc2_block& Block );

glm::vec4 decompress_bc3( const bc3_block& Block,
                          const extent2d& BlockTexelCoord );
texel_block4x4 decompress_bc3_block( const dxt5_block& Block );

glm::vec4 decompress_bc4unorm( const bc4_block& Block,
                               const extent2d& BlockTexelCoord );
glm::vec4 decompress_bc4snorm( const bc4_block& Block,
                               const extent2d& BlockTexelCoord );
...
glm::vec4 decompress_bc5unorm( const bc5_block& Block,
                               const extent2d& BlockTexelCoord );
glm::vec4 decompress_bc5snorm( const bc5_block& Block,
                               const extent2d& BlockTexelCoord );
