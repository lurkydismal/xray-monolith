...
inline texture1d_array generate_mipmaps( texture1d_array const& Texture,
    ...
    Sampler.generate_mipmaps( BaseLayer, MaxLayer, BaseLevel, MaxLevel,
                              Minification );
    return Sampler();
}
...
inline texture2d_array generate_mipmaps( texture2d_array const& Texture,
...
inline texture_cube generate_mipmaps( texture_cube const& Texture,
    ...
    Sampler.generate_mipmaps( BaseFace, MaxFace, BaseLevel, MaxLevel,
                              Minification );
    return Sampler();
}
...
inline texture_cube_array generate_mipmaps(
    ...
    Sampler.generate_mipmaps( BaseLayer, MaxLayer, BaseFace, MaxFace, BaseLevel,
                              MaxLevel, Minification );
    return Sampler();
}

template <>
inline texture1d generate_mipmaps< texture1d >( texture1d const& Texture,
                                                filter Minification ) {
...
template <>
inline texture1d_array generate_mipmaps< texture1d_array >(
    texture1d_array const& Texture,
    filter Minification ) {
    return generate_mipmaps( Texture, Texture.base_layer(), Texture.max_layer(),
                             Texture.base_level(), Texture.max_level(),
                             Minification );
}

template <>
inline texture2d generate_mipmaps< texture2d >( texture2d const& Texture,
                                                filter Minification ) {
    return generate_mipmaps( Texture, Texture.base_level(), Texture.max_level(),
                             Minification );
}
...
template <>
inline texture2d_array generate_mipmaps< texture2d_array >(
...
template <>
inline texture3d generate_mipmaps< texture3d >( texture3d const& Texture,
                                                filter Minification ) {
    return generate_mipmaps( Texture, Texture.base_level(), Texture.max_level(),
                             Minification );
}
...
template <>
inline texture_cube generate_mipmaps< texture_cube >(
    texture_cube const& Texture,
    filter Minification ) {
    return generate_mipmaps( Texture, Texture.base_face(), Texture.max_face(),
                             Texture.base_level(), Texture.max_level(),
                             Minification );
}

template <>
inline texture_cube_array generate_mipmaps< texture_cube_array >(
    texture_cube_array const& Texture,
    filter Minification ) {
    return generate_mipmaps( Texture, Texture.base_layer(), Texture.max_layer(),
