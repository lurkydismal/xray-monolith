...
struct compute_transform_1d {
    ...
    static void call( texture1d& Output,
                      texture1d const& A,
                      texture1d const& B,
                      func_type Func ) {
        ...
        for ( size_type LevelIndex = 0, LevelCount = A.levels();
            ...
            for ( TexelIndex.x = 0; TexelIndex.x < TexelCount.x;
                ...
                Output.store< vec_type >(
                    ...
                    Func( A.load< vec_type >( TexelIndex, LevelIndex ),
...
struct compute_transform_1d_array {
    ...
    static void call( texture1d_array& Output,
                      texture1d_array const& A,
            ...
            for ( size_type LevelIndex = 0, LevelCount = A.levels();
                ...
                for ( TexelIndex.x = 0; TexelIndex.x < TexelCount.x;
                    ...
                    Output.store< vec_type >(
                        ...
                        Func( A.load< vec_type >( TexelIndex, LayerIndex,
                                                  LevelIndex ),
                              B.load< vec_type >( TexelIndex, LayerIndex,
                                                  LevelIndex ) ) );
                }
            }
    }
...
struct compute_transform_2d {
    ...
    static void call( texture2d& Output,
                      texture2d const& A,
                      texture2d const& B,
                      func_type Func ) {
        GLI_ASSERT( all( equal( A.extent(), B.extent() ) ) );
...
struct compute_transform_2d_array {
    ...
    static void call( texture2d_array& Output,
                      texture2d_array const& A,
...
struct compute_transform_3d {
    ...
    static void call( texture3d& Output,
                      texture3d const& A,
                      texture3d const& B,
                      func_type Func ) {
        GLI_ASSERT( all( equal( A.extent(), B.extent() ) ) );
...
struct compute_transform_cube {
    ...
    static void call( texture_cube& Output,
                      texture_cube const& A,
                ...
                for ( TexelIndex.y = 0; TexelIndex.y < TexelCount.y;
                    ...
                    for ( TexelIndex.x = 0; TexelIndex.x < TexelCount.x;
                        ...
                        Output.store< vec_type >(
                            ...
                            Func( A.load< vec_type >( TexelIndex, FaceIndex,
                                                      LevelIndex ),
                                  B.load< vec_type >( TexelIndex, FaceIndex,
                                                      LevelIndex ) ) );
                    }
            }
    }
...
struct compute_transform_cube_array {
    ...
    static void call( texture_cube_array& Output,
                      texture_cube_array const& A,
                ...
                for ( size_type LevelIndex = 0, LevelCount = A.levels();
                    ...
                    for ( TexelIndex.y = 0; TexelIndex.y < TexelCount.y;
                        ...
                        for ( TexelIndex.x = 0; TexelIndex.x < TexelCount.x;
                              ++TexelIndex.x ) {
                            Output.store< vec_type >(
                                TexelIndex, LayerIndex, FaceIndex, LevelIndex,
                                Func(
                                    A.load< vec_type >( TexelIndex, LayerIndex,
...
template < typename vec_type >
inline void transform( texture1d& Out,
                       texture1d const& In0,
                       texture1d const& In1,
...
template < typename vec_type >
inline void transform( texture1d_array& Out,
...
template < typename vec_type >
inline void transform( texture2d& Out,
                       texture2d const& In0,
                       texture2d const& In1,
                       typename transform_func< vec_type >::type Func ) {
...
template < typename vec_type >
inline void transform( texture2d_array& Out,
...
template < typename vec_type >
inline void transform( texture3d& Out,
                       texture3d const& In0,
                       texture3d const& In1,
                       typename transform_func< vec_type >::type Func ) {
...
template < typename vec_type >
inline void transform( texture_cube& Out,
...
template < typename vec_type >
inline void transform( texture_cube_array& Out,
                       texture_cube_array const& In0,
                       texture_cube_array const& In1,
                       typename transform_func< vec_type >::type Func ) {
    detail::compute_transform_cube_array< vec_type >::call( Out, In0, In1,
                                                            Func );
}
} // namespace gli
