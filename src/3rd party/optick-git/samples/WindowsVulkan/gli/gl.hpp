...
public:
    enum internal_format {
        ...
        INTERNAL_RGBA_PVRTC_4BPPV2 =
            0x9137, // GL_COMPRESSED_RGBA_PVRTC_4BPPV2_IMG
        INTERNAL_RGBA_PVRTC_2BPPV2 =
            0x9138,                // GL_COMPRESSED_RGBA_PVRTC_2BPPV2_IMG
        ...
        INTERNAL_RGBA_PUNCHTHROUGH_ETC2 =
        ...
        INTERNAL_SRGB_ALPHA_PVRTC_2BPPV2 =
        ...
        INTERNAL_SRGB8_PUNCHTHROUGH_ALPHA1_ETC2 =
            0x9277, // GL_COMPRESSED_SRGB8_PUNCHTHROUGH_ALPHA1_ETC2
        INTERNAL_SRGB8_ALPHA8_ETC2_EAC =
    ...
    gli::format find( internal_format InternalFormat,
...
private:
    ...
    gl::swizzles compute_swizzle( format_desc const& FormatDesc,
                                  gli::swizzles const& Swizzle ) const;
