...
#define GLI_MAKEFOURCC( ch0, ch1, ch2, ch3 )                                  \
    ( std::uint32_t )( ( ( ( std::uint32_t )( std::uint8_t )( ch3 ) << 24 ) & \
                         0xFF000000 ) |                                       \
    ...
    union dxgiFormat {
        ...
        dxgiFormat( dxgi_format_gli GLI ) : GLI( GLI ) {}
...
/// Evaluate whether a target and format combinaison is only supported by the
/// DDS container through GLI DDS extension.
