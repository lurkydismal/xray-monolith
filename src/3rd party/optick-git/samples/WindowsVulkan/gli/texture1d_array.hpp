...
public:
    ...
    /// Create a texture1d_array and allocate a new storage_linear with a
    ...
    explicit texture1d_array( texture const& Texture );
    ...
    texture1d_array( texture1d_array const& Texture,
                     size_type BaseLayer,
                     size_type MaxLayer,
                     size_type BaseLevel,
                     size_type MaxLevel );
