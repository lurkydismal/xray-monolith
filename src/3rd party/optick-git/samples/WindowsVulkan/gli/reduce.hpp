...
template < typename vec_type >
vec_type reduce( texture1d const& In0,
                 texture1d const& In1,
...
/// @param ReduceFunc Pointer to a binary function to reduce texels.
template < typename vec_type >
vec_type reduce( texture1d_array const& In0,
...
/// @param ReduceFunc Pointer to a binary function to reduce texels.
template < typename vec_type >
vec_type reduce( texture2d const& In0,
                 texture2d const& In1,
                 typename reduce_func< vec_type >::type TexelFunc,
                 typename reduce_func< vec_type >::type ReduceFunc );
...
/// @param ReduceFunc Pointer to a binary function to reduce texels.
template < typename vec_type >
vec_type reduce( texture2d_array const& In0,
...
/// @param ReduceFunc Pointer to a binary function to reduce texels.
template < typename vec_type >
vec_type reduce( texture3d const& In0,
                 texture3d const& In1,
                 typename reduce_func< vec_type >::type TexelFunc,
                 typename reduce_func< vec_type >::type ReduceFunc );
...
/// @param ReduceFunc Pointer to a binary function to reduce texels.
template < typename vec_type >
vec_type reduce( texture_cube const& In0,
...
/// @param ReduceFunc Pointer to a binary function to reduce texels.
template < typename vec_type >
vec_type reduce( texture_cube_array const& In0,
...
vec_type reduce( texture_type const& In0,
