...
public:
    ...
    /// Create a texture1d and allocate a new storage_linear with a complete
    /// mipmap chain
    texture1d( format_type Format,
               extent_type const& Extent,
               swizzles_type const& Swizzles = swizzles_type( SWIZZLE_RED,
    ...
    /// Create a texture1d view, reference a subset of an existing texture1d
    /// instance
    texture1d( texture1d const& Texture,
               size_type BaseLevel,
               size_type MaxLevel );
