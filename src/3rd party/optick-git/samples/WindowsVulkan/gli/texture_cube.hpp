...
public:
    ...
    /// Create a texture_cube and allocate a new storage_linear with a complete
    /// mipmap chain
    texture_cube(
        format_type Format,
        extent_type const& Extent,
    ...
    /// Create a texture_cube view, reference a subset of an existing
    /// texture_cube instance
