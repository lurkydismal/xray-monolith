/// @brief Include to include everything in GLI which is not recommendated due
/// to compilation time cost.
/// @file gli/gli.hpp
/// @mainpage OpenGL Image (GLI)
///
/// [OpenGL Image](http://gli.g-truc.net/) (*GLI*) is a header only C++ image
/// library for graphics software.
/// (*GLI*) provides classes and functions to load image files
/// ([KTX](https://www.khronos.org/opengles/sdk/tools/KTX/) and
...
///
/// This library works perfectly with [OpenGL](https://www.opengl.org) or
/// [Vulkan](https://www.khronos.org/vulkan) but it also ensures
...
///
/// *GLI* is written in C++11. It is a platform independent library with no
/// dependence and it supports the following compilers:
/// - [Apple
/// Clang 4.0](https://developer.apple.com/library/mac/documentation/CompilerTools/Conceptual/LLVMCompilerOverview/index.html)
/// and higher
...
///
/// For more information about *GLI*, please have a look at the [API reference
/// documentation](http://gli.g-truc.net/0.8.0/api/index.html). The source code
/// and the documentation are licensed under the [Happy Bunny License (Modified
/// MIT) or the MIT License](copying.md).
///
/// Thanks for contributing to the project by [submitting
/// issues](https://github.com/g-truc/gli/issues) for bug reports and feature
/// requests. Any feedback is welcome at
/// [gli@g-truc.net](mailto://gli@g-truc.net).
