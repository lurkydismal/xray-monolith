/// @brief Include to use operators to compare whether two textures or images
/// are equal
...
/// Compare two textures. Two textures are the same when the data, the format
/// and the targets are the same.
