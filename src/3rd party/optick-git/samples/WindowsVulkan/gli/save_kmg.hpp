...
/// @param Path Path for where to save the file. It must include the filaname
/// and filename extension. This function ignores the filename extension in the
/// path and save to KMG anyway but keep the requested filename extension.
...
///
/// @param Texture Source texture to save
/// @param Memory Storage for the KMG container. The function resizes the
/// containers to fit the necessary storage_linear.
/// @return Returns false if the function fails to save the file.
