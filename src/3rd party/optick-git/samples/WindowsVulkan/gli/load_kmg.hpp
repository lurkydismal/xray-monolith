...
namespace gli {
/// Loads a texture storage_linear from KMG (Khronos Image) file. Returns an
/// empty storage_linear in case of failure.
///
/// @param Path Path of the file to open including filaname and filename
/// extension
...
/// Loads a texture storage_linear from KMG (Khronos Image) memory. Returns an
/// empty storage_linear in case of failure.
///
