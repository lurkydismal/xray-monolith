...
namespace gli {
/// Loads a texture storage_linear from DDS file. Returns an empty
/// storage_linear in case of failure.
///
...
/// Loads a texture storage_linear from DDS memory. Returns an empty
/// storage_linear in case of failure.
///
