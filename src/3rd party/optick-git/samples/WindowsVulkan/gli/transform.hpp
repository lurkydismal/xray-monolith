...
/// @param TexelFunc Pointer to a binary function.
template < typename vec_type >
void transform( texture1d_array& Out,
...
/// @param TexelFunc Pointer to a binary function.
template < typename vec_type >
void transform( texture2d_array& Out,
...
/// @param TexelFunc Pointer to a binary function.
template < typename vec_type >
void transform( texture_cube& Out,
...
/// @param TexelFunc Pointer to a binary function.
template < typename vec_type >
void transform( texture_cube_array& Out,
