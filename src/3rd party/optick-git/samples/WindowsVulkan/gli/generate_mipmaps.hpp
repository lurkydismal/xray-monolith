...
namespace gli {
/// Allocate a texture and generate all the mipmaps of the texture using the
/// Minification filter.
template < typename texture_type >
texture_type generate_mipmaps( texture_type const& Texture,
                               filter Minification );

/// Allocate a texture and generate the mipmaps of the texture from the
/// BaseLevel to the MaxLevel included using the Minification filter.
...
/// Allocate a texture and generate the mipmaps of the texture from the
/// BaseLayer to the MaxLayer and from the BaseLevel to the MaxLevel included
/// levels using the Minification filter.
texture1d_array generate_mipmaps( texture1d_array const& Texture,
...
/// BaseLayer to the MaxLayer and from the BaseLevel to the MaxLevel included
/// levels using the Minification filter.
texture2d_array generate_mipmaps( texture2d_array const& Texture,
...
/// Allocate a texture and generate the mipmaps of the texture from the
/// BaseLayer to the MaxLayer, from the BaseFace to the MaxFace and from the
/// BaseLevel to the MaxLevel included levels using the Minification filter.
texture_cube generate_mipmaps( texture_cube const& Texture,
...
/// BaseLayer to the MaxLayer and from the BaseLevel to the MaxLevel included
/// levels using the Minification filter.
texture_cube_array generate_mipmaps( texture_cube_array const& Texture,
