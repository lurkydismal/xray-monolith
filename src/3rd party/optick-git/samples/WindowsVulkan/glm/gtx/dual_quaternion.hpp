...
struct tdualquat {
    ...
    GLM_FUNC_DECL GLM_CONSTEXPR tdualquat( tquat< T, P > const& orientation,
                                           vec< 3, T, P > const& translation );
    GLM_FUNC_DECL GLM_CONSTEXPR tdualquat( tquat< T, P > const& real,
    ...
    GLM_FUNC_DECL GLM_CONSTEXPR GLM_EXPLICIT
...
template < typename T, precision P >
GLM_FUNC_DECL vec< 3, T, P > operator*( tdualquat< T, P > const& q,
                                        vec< 3, T, P > const& v );
...
template < typename T, precision P >
GLM_FUNC_DECL vec< 4, T, P > operator*( tdualquat< T, P > const& q,
                                        vec< 4, T, P > const& v );
...
template < typename T, precision P >
GLM_FUNC_DECL bool operator==( tdualquat< T, P > const& q1,
...
template < typename T, precision P >
GLM_FUNC_DECL tdualquat< T, P > lerp( tdualquat< T, P > const& x,
