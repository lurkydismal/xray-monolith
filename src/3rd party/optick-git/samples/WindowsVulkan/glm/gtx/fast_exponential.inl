...
GLM_FUNC_QUALIFIER vecType< L, T, P > fastPow( vecType< L, T, P > const& x,
...
GLM_FUNC_QUALIFIER T fastExp( T x ) {
    ...
    // following code. However, in debug mode it's slower. return 1.0f + x *
    // (1.0f + x * 0.5f * (1.0f + x * 0.3333333333f * (1.0f + x * 0.25 * (1.0f +
    // x * 0.2f))));
    T x2 = x * x;
    T x3 = x2 * x;
    T x4 = x3 * x;
