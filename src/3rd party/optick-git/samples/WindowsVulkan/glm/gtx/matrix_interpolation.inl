...
GLM_FUNC_QUALIFIER void axisAngle( mat< 4, 4, T, P > const& mat,
                                   vec< 3, T, P >& axis,
                                   T& angle ) {
    T epsilon = ( T )0.01;
    T epsilon2 = ( T )0.1;
    ...
    if ( ( abs( mat[ 1 ][ 0 ] - mat[ 0 ][ 1 ] ) < epsilon ) &&
        ...
        if ( ( abs( mat[ 1 ][ 0 ] + mat[ 0 ][ 1 ] ) < epsilon2 ) &&
             ...
             ( abs( mat[ 0 ][ 0 ] + mat[ 1 ][ 1 ] + mat[ 2 ][ 2 ] - ( T )3.0 ) <
               epsilon2 ) ) {
            angle = ( T )0.0;
            axis.x = ( T )1.0;
            axis.y = ( T )0.0;
    ...
    if ( glm::abs( s ) < T( 0.001 ) )
        s = ( T )1.0;
    T const angleCos =
        ( mat[ 0 ][ 0 ] + mat[ 1 ][ 1 ] + mat[ 2 ][ 2 ] - ( T )1.0 ) * ( T )0.5;
...
GLM_FUNC_QUALIFIER mat< 4, 4, T, P > axisAngleMatrix(
    ...
    return mat< 4, 4, T, P >(
        ...
        T( 0 ), t * n.x * n.y - n.z * s, t * n.y * n.y + c,
        t * n.y * n.z + n.x * s, T( 0 ), t * n.x * n.z + n.y * s,
        t * n.y * n.z - n.x * s, t * n.z * n.z + c, T( 0 ), T( 0 ), T( 0 ),
        T( 0 ), T( 1 ) );
}
...
GLM_FUNC_QUALIFIER mat< 4, 4, T, P > extractMatrixRotation(
    mat< 4, 4, T, P > const& m ) {
    return mat< 4, 4, T, P >( m[ 0 ][ 0 ], m[ 0 ][ 1 ], m[ 0 ][ 2 ], 0.0,
...
template < typename T, precision P >
GLM_FUNC_QUALIFIER mat< 4, 4, T, P > interpolate( mat< 4, 4, T, P > const& m1,
