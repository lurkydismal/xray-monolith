...
GLM_FUNC_DECL vec< 3, T, P > cross( tquat< T, P > const& q,
                                    vec< 3, T, P > const& v );
...
/// @see gtx_quaternion
template < typename T, precision P >
GLM_FUNC_DECL vec< 3, T, P > cross( vec< 3, T, P > const& v,
                                    tquat< T, P > const& q );
...
/// @see gtx_quaternion
template < typename T, precision P >
GLM_FUNC_DECL tquat< T, P > squad( tquat< T, P > const& q1,
                                   tquat< T, P > const& q2,
                                   tquat< T, P > const& s1,
                                   tquat< T, P > const& s2,
                                   T const& h );
...
/// @see gtx_quaternion
template < typename T, precision P >
GLM_FUNC_DECL tquat< T, P > intermediate( tquat< T, P > const& prev,
...
/// @see gtx_quaternion
template < typename T, precision P >
GLM_FUNC_DECL vec< 3, T, P > rotate( tquat< T, P > const& q,
                                     vec< 3, T, P > const& v );
...
/// @see gtx_quaternion
template < typename T, precision P >
GLM_FUNC_DECL vec< 4, T, P > rotate( tquat< T, P > const& q,
                                     vec< 4, T, P > const& v );
...
/// @see gtx_quaternion
template < typename T, precision P >
GLM_FUNC_DECL tquat< T, P > shortMix( tquat< T, P > const& x,
                                      tquat< T, P > const& y,
                                      T const& a );
...
/// @see gtx_quaternion
template < typename T, precision P >
GLM_FUNC_DECL tquat< T, P > fastMix( tquat< T, P > const& x,
                                     tquat< T, P > const& y,
                                     T const& a );
...
/// @see gtx_quaternion
template < typename T, precision P >
GLM_FUNC_DECL tquat< T, P > rotation( vec< 3, T, P > const& orig,
