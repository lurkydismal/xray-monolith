...
tdualquat< T, P >::operator[](
    typename tdualquat< T, P >::length_type i ) const {
    assert( i >= 0 && i < this->length() );
    return ( &real )[ i ];
}
...
template < typename T, precision P >
GLM_FUNC_QUALIFIER GLM_CONSTEXPR
tdualquat< T, P >::tdualquat( tquat< T, P > const& q, vec< 3, T, P > const& p )
    : real( q ),
...
template < typename T, precision P >
GLM_FUNC_QUALIFIER tdualquat< T, P > operator*( tdualquat< T, P > const& p,
                                                tdualquat< T, P > const& o ) {
    return tdualquat< T, P >( p.real * o.real,
                              p.real * o.dual + p.dual * o.real );
}

template < typename T, precision P >
GLM_FUNC_QUALIFIER vec< 3, T, P > operator*( tdualquat< T, P > const& q,
                                             vec< 3, T, P > const& v ) {
...
template < typename T, precision P >
GLM_FUNC_QUALIFIER vec< 4, T, P > operator*( tdualquat< T, P > const& q,
                                             vec< 4, T, P > const& v ) {
...
template < typename T, precision P >
GLM_FUNC_QUALIFIER tdualquat< T, P > operator*( T const& s,
                                                tdualquat< T, P > const& q ) {
    return q * s;
}
...
template < typename T, precision P >
GLM_FUNC_QUALIFIER bool operator==( tdualquat< T, P > const& q1,
...
template < typename T, precision P >
GLM_FUNC_QUALIFIER tdualquat< T, P > lerp( tdualquat< T, P > const& x,
...
GLM_FUNC_QUALIFIER mat< 3, 4, T, P > mat3x4_cast( tdualquat< T, P > const& x ) {
    ...
    tquat< T, P > const rr( r.w * x.real.w, r.x * x.real.x, r.y * x.real.y,
                            r.z * x.real.z );
    r *= static_cast< T >( 2 );
    ...
    vec< 4, T, P > const a( rr.w + rr.x - rr.y - rr.z, xy - wz, xz + wy,
                            -( x.dual.w * r.x - x.dual.x * r.w +
                               x.dual.y * r.z - x.dual.z * r.y ) );

    vec< 4, T, P > const b( xy + wz, rr.w + rr.y - rr.x - rr.z, yz - wx,
                            -( x.dual.w * r.y - x.dual.x * r.z -
                               x.dual.y * r.w + x.dual.z * r.x ) );

    vec< 4, T, P > const c( xz - wy, yz + wx, rr.w + rr.z - rr.x - rr.y,
                            -( x.dual.w * r.z + x.dual.x * r.y -
                               x.dual.y * r.x - x.dual.z * r.w ) );
...
GLM_FUNC_QUALIFIER tdualquat< T, P > dualquat_cast(
    ...
    dual.x = static_cast< T >( 0.5 ) *
             ( x[ 0 ].w * real.w + x[ 1 ].w * real.z - x[ 2 ].w * real.y );
    dual.y = static_cast< T >( 0.5 ) *
             ( -x[ 0 ].w * real.z + x[ 1 ].w * real.w + x[ 2 ].w * real.x );
    dual.z = static_cast< T >( 0.5 ) *
             ( x[ 0 ].w * real.y - x[ 1 ].w * real.x + x[ 2 ].w * real.w );
    dual.w = -static_cast< T >( 0.5 ) *
             ( x[ 0 ].w * real.x + x[ 1 ].w * real.y + x[ 2 ].w * real.z );
