...
GLM_FUNC_DECL vecType< L, T, P > highestBitValue(
...
template < length_t L,
           ...
           precision P,
           template < length_t, typename, precision > class vecType >
GLM_DEPRECATED GLM_FUNC_DECL vecType< L, T, P > powerOfTwoAbove(
    vecType< L, T, P > const& value );
...
template < length_t L,
           ...
           precision P,
           template < length_t, typename, precision > class vecType >
GLM_DEPRECATED GLM_FUNC_DECL vecType< L, T, P > powerOfTwoBelow(
    vecType< L, T, P > const& value );
...
template < length_t L,
           ...
           precision P,
           template < length_t, typename, precision > class vecType >
GLM_DEPRECATED GLM_FUNC_DECL vecType< L, T, P > powerOfTwoNearest(
    vecType< L, T, P > const& value );
