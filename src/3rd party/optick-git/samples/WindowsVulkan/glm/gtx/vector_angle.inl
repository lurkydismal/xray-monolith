...
GLM_FUNC_QUALIFIER T angle( vecType< L, T, P > const& x,
...
GLM_FUNC_QUALIFIER T orientedAngle( vec< 2, T, P > const& x,
                                    vec< 2, T, P > const& y ) {
    GLM_STATIC_ASSERT( std::numeric_limits< T >::is_iec559,
...
template < typename T, precision P >
GLM_FUNC_QUALIFIER T orientedAngle( vec< 3, T, P > const& x,
                                    vec< 3, T, P > const& y,
                                    vec< 3, T, P > const& ref ) {
    GLM_STATIC_ASSERT( std::numeric_limits< T >::is_iec559,
                       "'orientedAngle' only accept floating-point inputs" );
