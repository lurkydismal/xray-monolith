...
GLM_FUNC_QUALIFIER mat< 2, 2, T, P > rowMajor2( vec< 2, T, P > const& v1,
                                                vec< 2, T, P > const& v2 ) {
    mat< 2, 2, T, P > Result;
    Result[ 0 ][ 0 ] = v1.x;
    Result[ 1 ][ 0 ] = v1.y;
...
template < typename T, precision P >
GLM_FUNC_QUALIFIER mat< 3, 3, T, P > rowMajor3( const vec< 3, T, P >& v1,
                                                const vec< 3, T, P >& v2,
                                                const vec< 3, T, P >& v3 ) {
    mat< 3, 3, T, P > Result;
    Result[ 0 ][ 0 ] = v1.x;
...
template < typename T, precision P >
GLM_FUNC_QUALIFIER mat< 4, 4, T, P > rowMajor4( const vec< 4, T, P >& v1,
                                                const vec< 4, T, P >& v2,
                                                const vec< 4, T, P >& v3,
                                                const vec< 4, T, P >& v4 ) {
    mat< 4, 4, T, P > Result;
...
template < typename T, precision P >
GLM_FUNC_QUALIFIER mat< 2, 2, T, P > colMajor2( const vec< 2, T, P >& v1,
                                                const vec< 2, T, P >& v2 ) {
...
template < typename T, precision P >
GLM_FUNC_QUALIFIER mat< 3, 3, T, P > colMajor3( const vec< 3, T, P >& v1,
                                                const vec< 3, T, P >& v2,
                                                const vec< 3, T, P >& v3 ) {
...
template < typename T, precision P >
GLM_FUNC_QUALIFIER mat< 4, 4, T, P > colMajor4( const vec< 4, T, P >& v1,
                                                const vec< 4, T, P >& v2,
                                                const vec< 4, T, P >& v3,
                                                const vec< 4, T, P >& v4 ) {
