...
/// format are represented in an alternate, denormalized format. This format is
/// less precise but can represent values closer to zero.
///
...
///
/// @see <a
/// href="http://stackoverflow.com/questions/7610631/glsl-mod-vs-hlsl-fmod">GLSL
/// mod vs HLSL fmod</a>
