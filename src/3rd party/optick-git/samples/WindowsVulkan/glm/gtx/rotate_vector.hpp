...
GLM_FUNC_DECL vec< 3, T, P > slerp( vec< 3, T, P > const& x,
                                    vec< 3, T, P > const& y,
                                    T const& a );
...
//! From GLM_GTX_rotate_vector extension.
template < typename T, precision P >
GLM_FUNC_DECL vec< 3, T, P > rotate( vec< 3, T, P > const& v,
                                     T const& angle,
...
//! From GLM_GTX_rotate_vector extension.
template < typename T, precision P >
GLM_FUNC_DECL vec< 4, T, P > rotate( vec< 4, T, P > const& v,
                                     T const& angle,
                                     vec< 3, T, P > const& normal );
...
//! From GLM_GTX_rotate_vector extension.
template < typename T, precision P >
GLM_FUNC_DECL mat< 4, 4, T, P > orientation( vec< 3, T, P > const& Normal,
                                             vec< 3, T, P > const& Up );
