...
GLM_FUNC_QUALIFIER genType fastInverseSqrt( genType x ) {
    ...
    vec< 1, T, P > tmp(
        detail::compute_inversesqrt< tvec1, genType, lowp,
                                     detail::is_aligned< lowp >::value >::
            call( vec< 1, genType, lowp >( x ) ) );
    return tmp.x;
#else
    return detail::compute_inversesqrt< 1, genType, lowp,
                                        detail::is_aligned< lowp >::value >::
        call( vec< 1, genType, lowp >( x ) )
            .x;
#endif
...
template < length_t L,
           ...
           precision P,
           template < length_t, typename, precision > class vecType >
GLM_FUNC_QUALIFIER vecType< L, T, P > fastInverseSqrt(
...
template < length_t L,
           ...
           precision P,
           template < length_t, typename, precision > class vecType >
GLM_FUNC_QUALIFIER T fastDistance( vecType< L, T, P > const& x,
...
template < length_t L,
           ...
           precision P,
           template < length_t, typename, precision > class vecType >
GLM_FUNC_QUALIFIER vecType< L, T, P > fastNormalize(
    vecType< L, T, P > const& x ) {
