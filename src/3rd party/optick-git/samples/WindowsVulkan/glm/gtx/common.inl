...
GLM_FUNC_QUALIFIER typename vec< 1, T, P >::bool_type isdenormal(
    ...
    return typename vec< 1, T, P >::bool_type( isdenormal( x.x ) );
}
...
GLM_FUNC_QUALIFIER typename vec< 2, T, P >::bool_type isdenormal(
    ...
    return typename vec< 2, T, P >::bool_type( isdenormal( x.x ),
                                               isdenormal( x.y ) );
}
...
GLM_FUNC_QUALIFIER typename vec< 3, T, P >::bool_type isdenormal(
    ...
    return typename vec< 3, T, P >::bool_type(
        isdenormal( x.x ), isdenormal( x.y ), isdenormal( x.z ) );
}
...
GLM_FUNC_QUALIFIER vecType< L, T, P > fmod( vecType< L, T, P > const& x, T y ) {
    return detail::compute_fmod<
        L, T, P, vecType,
        std::numeric_limits< T >::is_iec559 >::call( x,
                                                     vecType< L, T, P >( y ) );
}
...
template < length_t L,
           ...
           precision P,
           template < length_t, typename, precision > class vecType >
GLM_FUNC_QUALIFIER vecType< L, T, P > fmod( vecType< L, T, P > const& x,
                                            vecType< L, T, P > const& y ) {
    return detail::compute_fmod<
        L, T, P, vecType, std::numeric_limits< T >::is_iec559 >::call( x, y );
}
} // namespace glm
