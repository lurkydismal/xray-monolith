...
GLM_FUNC_QUALIFIER vec< 2, U, P > associatedMin( vecType< L, T, P > const& x,
...
GLM_FUNC_QUALIFIER vecType< L, U, P > associatedMin(
    ...
    vecType< L, U, P > Result( uninitialize );
    for ( length_t i = 0, n = Result.length(); i < n; ++i )
        Result[ i ] = x[ i ] < y[ i ] ? ( x[ i ] < z[ i ] ? a[ i ] : c[ i ] )
                                      : ( y[ i ] < z[ i ] ? b[ i ] : c[ i ] );
    return Result;
}
...
template < length_t L,
           ...
           precision P,
           template < length_t, typename, precision > class vecType >
GLM_FUNC_QUALIFIER vec< 2, U, P > associatedMax( vecType< L, T, P > const& x,
                                                 vecType< L, U, P > const& a,
                                                 vecType< L, T, P > const& y,
                                                 vecType< L, U, P > const& b ) {
    vecType< L, U, P > Result( uninitialize );
