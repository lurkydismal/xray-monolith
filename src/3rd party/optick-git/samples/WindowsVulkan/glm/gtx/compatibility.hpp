...
GLM_FUNC_QUALIFIER T atan2( T x, T y ) {
    return atan( x, y );
} //!< \brief Arc tangent. Returns an angle whose tangent is y/x. The signs of x
...
template < typename T, precision P >
GLM_FUNC_DECL vec< 1, bool, P > isfinite(
    const vec< 1, T, P >&
        x ); //!< \brief Test whether or not a scalar or each vector component
             //!< is a finite value. (From GLM_GTX_compatibility)
template < typename T, precision P >
GLM_FUNC_DECL vec< 2, bool, P > isfinite(
    const vec< 2, T, P >&
        x ); //!< \brief Test whether or not a scalar or each vector component
             //!< is a finite value. (From GLM_GTX_compatibility)
template < typename T, precision P >
GLM_FUNC_DECL vec< 3, bool, P > isfinite(
    const vec< 3, T, P >&
        x ); //!< \brief Test whether or not a scalar or each vector component
             //!< is a finite value. (From GLM_GTX_compatibility)
template < typename T, precision P >
GLM_FUNC_DECL vec< 4, bool, P > isfinite(
    const vec< 4, T, P >&
        x ); //!< \brief Test whether or not a scalar or each vector component
             //!< is a finite value. (From GLM_GTX_compatibility)
...
typedef vec< 2, bool, highp > bool2; //!< \brief boolean type with 2 components.
                                     //!< (From GLM_GTX_compatibility extension)
typedef vec< 3, bool, highp > bool3; //!< \brief boolean type with 3 components.
                                     //!< (From GLM_GTX_compatibility extension)
typedef vec< 4, bool, highp > bool4; //!< \brief boolean type with 4 components.
                                     //!< (From GLM_GTX_compatibility extension)
...
typedef int int1; //!< \brief integer vector with 1 component. (From
                  //!< GLM_GTX_compatibility extension)
typedef vec< 2, int, highp > int2; //!< \brief integer vector with 2 components.
                                   //!< (From GLM_GTX_compatibility extension)
typedef vec< 3, int, highp > int3; //!< \brief integer vector with 3 components.
                                   //!< (From GLM_GTX_compatibility extension)
typedef vec< 4, int, highp > int4; //!< \brief integer vector with 4 components.
                                   //!< (From GLM_GTX_compatibility extension)
...
typedef float float1x1; //!< \brief single-precision floating-point matrix with
                        //!< 1 component. (From GLM_GTX_compatibility extension)
...
typedef double double1; //!< \brief double-precision floating-point vector with
                        //!< 1 component. (From GLM_GTX_compatibility extension)
typedef vec< 2, double, highp >
    double2; //!< \brief double-precision floating-point vector with 2
             //!< components. (From GLM_GTX_compatibility extension)
typedef vec< 3, double, highp >
    double3; //!< \brief double-precision floating-point vector with 3
             //!< components. (From GLM_GTX_compatibility extension)
typedef vec< 4, double, highp >
