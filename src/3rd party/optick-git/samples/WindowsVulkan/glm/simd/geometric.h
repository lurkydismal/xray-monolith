...
GLM_FUNC_QUALIFIER glm_vec4 glm_vec4_dot( glm_vec4 v1, glm_vec4 v2 ) {
    ...
    glm_vec4 const swp1 =
        _mm_shuffle_ps( add0, add0, _MM_SHUFFLE( 0, 1, 2, 3 ) );
...
GLM_FUNC_QUALIFIER glm_vec4 glm_vec4_faceforward( glm_vec4 N,
                                                  glm_vec4 I,
                                                  glm_vec4 Nref ) {
...
GLM_FUNC_QUALIFIER __m128 glm_vec4_refract( glm_vec4 I,
                                            glm_vec4 N,
                                            glm_vec4 eta ) {
    glm_vec4 const dot0 = glm_vec4_dot( N, I );
