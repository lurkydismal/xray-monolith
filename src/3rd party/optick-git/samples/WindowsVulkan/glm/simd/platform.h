...
// Report platform detection
    ...
    !defined( GLM_MESSAGE_PLATFORM_DISPLAYED )
...
// User defines: GLM_FORCE_PURE GLM_FORCE_SSE2 GLM_FORCE_SSE3 GLM_FORCE_AVX
// GLM_FORCE_AVX2 GLM_FORCE_AVX2
...
#define GLM_ARCH_AVX512 \
    ( GLM_ARCH_AVX512_BIT | GLM_ARCH_AVX2 ) // Skylake subset
...
#elif ( GLM_COMPILER & ( GLM_COMPILER_CLANG | GLM_COMPILER_GCC ) ) || \
    ( ( GLM_COMPILER & GLM_COMPILER_INTEL ) &&                        \
      ( GLM_PLATFORM & GLM_PLATFORM_LINUX ) )
