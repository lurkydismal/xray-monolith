...
GLM_FUNC_QUALIFIER glm_vec4 glm_vec4_clamp( glm_vec4 v,
                                            glm_vec4 minVal,
                                            glm_vec4 maxVal ) {
...
GLM_FUNC_QUALIFIER glm_vec4 glm_vec4_mix( glm_vec4 v1,
                                          glm_vec4 v2,
                                          glm_vec4 a ) {
...
GLM_FUNC_QUALIFIER glm_vec4 glm_vec4_smoothstep( glm_vec4 edge0,
                                                 glm_vec4 edge1,
                                                 glm_vec4 x ) {
...
GLM_FUNC_QUALIFIER glm_vec4 glm_vec4_inf( glm_vec4 x ) {
    ...
    return _mm_castsi128_ps( _mm_cmpeq_epi32(
        t2, _mm_set1_epi32(
                int( 0xFF000000 ) ) ) ); // exponent is all 1s, fraction is 0
}
