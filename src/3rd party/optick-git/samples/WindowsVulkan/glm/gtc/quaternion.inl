...
struct compute_dot< tquat< T, P >, T, Aligned > {
    static GLM_FUNC_QUALIFIER T call( tquat< T, P > const& a,
                                      tquat< T, P > const& b ) {
...
struct compute_quat_add {
    static tquat< T, P > call( tquat< T, P > const& q,
                               tquat< T, P > const& p ) {
...
struct compute_quat_mul_vec4 {
    static vec< 4, T, P > call( tquat< T, P > const& q,
                                vec< 4, T, P > const& v ) {
...
GLM_FUNC_QUALIFIER T& tquat< T, P >::operator[](
    typename tquat< T, P >::length_type i ) {
    assert( i >= 0 && i < this->length() );
    return ( &x )[ i ];
}

template < typename T, precision P >
GLM_FUNC_QUALIFIER T const& tquat< T, P >::operator[](
    typename tquat< T, P >::length_type i ) const {
    assert( i >= 0 && i < this->length() );
    return ( &x )[ i ];
}
...
template < typename T, precision P >
GLM_FUNC_QUALIFIER GLM_CONSTEXPR tquat< T, P >::tquat( T s,
                                                       vec< 3, T, P > const& v )
...
//)
//{
//	vec<3, valType> eulerAngle(pitch * valType(0.5), yaw * valType(0.5),
// roll * valType(0.5)); 	vec<3, valType> c = glm::cos(eulerAngle *
// valType(0.5)); 	vec<3, valType> s = glm::sin(eulerAngle * valType(0.5));
//
...
template < typename T, precision P >
GLM_FUNC_QUALIFIER tquat< T, P >::tquat( vec< 3, T, P > const& u,
                                         vec< 3, T, P > const& v ) {
    vec< 3, T, P > const LocalW( cross( u, v ) );
    T Dot = detail::compute_dot< vec< 3, T, P >, T,
                                 detail::is_aligned< P >::value >::call( u, v );
...
GLM_FUNC_QUALIFIER tquat< T, P >& tquat< T, P >::operator+=(
    tquat< U, P > const& q ) {
    return ( *this = detail::compute_quat_add<
                 T, P, detail::is_aligned< P >::value >::call( *this,
                                                               tquat< T, P >(
                                                                   q ) ) );
}
...
GLM_FUNC_QUALIFIER tquat< T, P >& tquat< T, P >::operator-=(
    tquat< U, P > const& q ) {
    return ( *this = detail::compute_quat_sub<
                 T, P, detail::is_aligned< P >::value >::call( *this,
                                                               tquat< T, P >(
                                                                   q ) ) );
}
...
GLM_FUNC_QUALIFIER tquat< T, P >& tquat< T, P >::operator*=( U s ) {
    return ( *this = detail::compute_quat_mul_scalar<
                 T, P, detail::is_aligned< P >::value >::call( *this,
                                                               static_cast< U >(
                                                                   s ) ) );
}
...
template < typename U >
GLM_FUNC_QUALIFIER tquat< T, P >& tquat< T, P >::operator/=( U s ) {
    return ( *this = detail::compute_quat_div_scalar<
                 T, P, detail::is_aligned< P >::value >::call( *this,
                                                               static_cast< U >(
                                                                   s ) ) );
}
...
template < typename T, precision P >
GLM_FUNC_QUALIFIER vec< 3, T, P > operator*( tquat< T, P > const& q,
                                             vec< 3, T, P > const& v ) {
...
template < typename T, precision P >
GLM_FUNC_QUALIFIER vec< 4, T, P > operator*( tquat< T, P > const& q,
                                             vec< 4, T, P > const& v ) {
    return detail::compute_quat_mul_vec4<
        T, P, detail::is_aligned< P >::value >::call( q, v );
}
...
template < typename T, precision P >
GLM_FUNC_QUALIFIER tquat< T, P > operator*( T const& s,
                                            tquat< T, P > const& q ) {
    return q * s;
}
...
template < typename T, precision P >
GLM_FUNC_QUALIFIER bool operator==( tquat< T, P > const& q1,
                                    tquat< T, P > const& q2 ) {
...
GLM_FUNC_QUALIFIER tquat< T, P > normalize( tquat< T, P > const& q ) {
    ...
    return tquat< T, P >( q.w * oneOverLen, q.x * oneOverLen, q.y * oneOverLen,
                          q.z * oneOverLen );
}

template < typename T, precision P >
GLM_FUNC_QUALIFIER tquat< T, P > cross( tquat< T, P > const& q1,
                                        tquat< T, P > const& q2 ) {
    return tquat< T, P >(
...
/*
   ...
   mix(tquat<T, P> const & x, tquat<T, P> const & y, T const & a)
        {
                if(a <= T(0)) return x;
                if(a >= T(1)) return y;
...
template < typename T, precision P >
GLM_FUNC_QUALIFIER tquat< T, P > mix( tquat< T, P > const& x,
                                      tquat< T, P > const& y,
                                      T a ) {
    T cosTheta = dot( x, y );
    ...
    if ( cosTheta > T( 1 ) - epsilon< T >() ) {
        ...
        return tquat< T, P >( mix( x.w, y.w, a ), mix( x.x, y.x, a ),
                              mix( x.y, y.y, a ), mix( x.z, y.z, a ) );
    } else {
        // Essential Mathematics, page 467
        T angle = acos( cosTheta );
        return ( sin( ( T( 1 ) - a ) * angle ) * x + sin( a * angle ) * y ) /
               sin( angle );
    }
}

template < typename T, precision P >
GLM_FUNC_QUALIFIER tquat< T, P > lerp( tquat< T, P > const& x,
                                       tquat< T, P > const& y,
                                       T a ) {
...
template < typename T, precision P >
GLM_FUNC_QUALIFIER tquat< T, P > slerp( tquat< T, P > const& x,
                                        tquat< T, P > const& y,
                                        T a ) {
    tquat< T, P > z = y;
    ...
    if ( cosTheta > T( 1 ) - epsilon< T >() ) {
        // Linear interpolation
        return tquat< T, P >( mix( x.w, z.w, a ), mix( x.x, z.x, a ),
                              mix( x.y, z.y, a ), mix( x.z, z.z, a ) );
    } else {
        // Essential Mathematics, page 467
        T angle = acos( cosTheta );
        return ( sin( ( T( 1 ) - a ) * angle ) * x + sin( a * angle ) * z ) /
               sin( angle );
    }
}

template < typename T, precision P >
GLM_FUNC_QUALIFIER tquat< T, P > rotate( tquat< T, P > const& q,
                                         T const& angle,
                                         vec< 3, T, P > const& v ) {
    vec< 3, T, P > Tmp = v;
    ...
    return q * tquat< T, P >( cos( AngleRad * T( 0.5 ) ), Tmp.x * Sin,
                              Tmp.y * Sin, Tmp.z * Sin );
    // return gtc::quaternion::cross(q, tquat<T, P>(cos(AngleRad * T(0.5)),
    // Tmp.x * fSin, Tmp.y * fSin, Tmp.z * fSin));
}
...
GLM_FUNC_QUALIFIER T pitch( tquat< T, P > const& q ) {
    // return T(atan(T(2) * (q.y * q.z + q.w * q.x), q.w * q.w - q.x * q.x - q.y
    // * q.y + q.z * q.z));
    const T y = T( 2 ) * ( q.y * q.z + q.w * q.x );
    const T x = q.w * q.w - q.x * q.x - q.y * q.y + q.z * q.z;
    if ( y == T( 0 ) &&
         x == T( 0 ) ) // avoid atan2(0,0) - handle singularity - Matiis
...
GLM_FUNC_QUALIFIER T yaw( tquat< T, P > const& q ) {
    return asin(
        clamp( T( -2 ) * ( q.x * q.z - q.w * q.y ), T( -1 ), T( 1 ) ) );
}
...
template < typename T, precision P >
GLM_FUNC_QUALIFIER tquat< T, P > angleAxis( T const& angle,
                                            vec< 3, T, P > const& v ) {
    tquat< T, P > Result( uninitialize );
...
template < typename T, precision P >
GLM_FUNC_QUALIFIER vec< 4, bool, P > lessThan( tquat< T, P > const& x,
                                               tquat< T, P > const& y ) {
...
template < typename T, precision P >
GLM_FUNC_QUALIFIER vec< 4, bool, P > lessThanEqual( tquat< T, P > const& x,
                                                    tquat< T, P > const& y ) {
    vec< 4, bool, P > Result( uninitialize );
    for ( length_t i = 0; i < x.length(); ++i )
        Result[ i ] = x[ i ] <= y[ i ];
...
template < typename T, precision P >
GLM_FUNC_QUALIFIER vec< 4, bool, P > greaterThan( tquat< T, P > const& x,
                                                  tquat< T, P > const& y ) {
    vec< 4, bool, P > Result( uninitialize );
    for ( length_t i = 0; i < x.length(); ++i )
        Result[ i ] = x[ i ] > y[ i ];
...
template < typename T, precision P >
GLM_FUNC_QUALIFIER vec< 4, bool, P > greaterThanEqual(
    tquat< T, P > const& x,
    tquat< T, P > const& y ) {
    vec< 4, bool, P > Result( uninitialize );
    for ( length_t i = 0; i < x.length(); ++i )
...
template < typename T, precision P >
GLM_FUNC_QUALIFIER vec< 4, bool, P > equal( tquat< T, P > const& x,
                                            tquat< T, P > const& y ) {
    vec< 4, bool, P > Result( uninitialize );
    for ( length_t i = 0; i < x.length(); ++i )
        Result[ i ] = x[ i ] == y[ i ];
...
template < typename T, precision P >
GLM_FUNC_QUALIFIER vec< 4, bool, P > notEqual( tquat< T, P > const& x,
                                               tquat< T, P > const& y ) {
    vec< 4, bool, P > Result( uninitialize );
    for ( length_t i = 0; i < x.length(); ++i )
        Result[ i ] = x[ i ] != y[ i ];
...
GLM_FUNC_QUALIFIER vec< 4, bool, P > isnan( tquat< T, P > const& q ) {
    ...
    return vec< 4, bool, P >( isnan( q.x ), isnan( q.y ), isnan( q.z ),
                              isnan( q.w ) );
}
...
GLM_FUNC_QUALIFIER vec< 4, bool, P > isinf( tquat< T, P > const& q ) {
    ...
    return vec< 4, bool, P >( isinf( q.x ), isinf( q.y ), isinf( q.z ),
                              isinf( q.w ) );
}
} // namespace glm
