...
template < typename T, precision P >
GLM_FUNC_DECL vec< 3, T, P > operator*( tquat< T, P > const& q,
                                        vec< 3, T, P > const& v );
...
template < typename T, precision P >
GLM_FUNC_DECL vec< 4, T, P > operator*( tquat< T, P > const& q,
                                        vec< 4, T, P > const& v );
...
template < typename T, precision P >
GLM_FUNC_DECL bool operator==( tquat< T, P > const& q1,
                               tquat< T, P > const& q2 );
...
template < typename T, precision P >
GLM_FUNC_DECL tquat< T, P > mix( tquat< T, P > const& x,
                                 tquat< T, P > const& y,
                                 T a );
...
/// @see gtc_quaternion
template < typename T, precision P >
GLM_FUNC_DECL tquat< T, P > lerp( tquat< T, P > const& x,
                                  tquat< T, P > const& y,
                                  T a );
...
/// @see gtc_quaternion
template < typename T, precision P >
GLM_FUNC_DECL tquat< T, P > slerp( tquat< T, P > const& x,
                                   tquat< T, P > const& y,
                                   T a );
...
/// @see gtc_quaternion
template < typename T, precision P >
GLM_FUNC_DECL tquat< T, P > rotate( tquat< T, P > const& q,
                                    T const& angle,
...
/// @see gtc_quaternion
template < typename T, precision P >
GLM_FUNC_DECL tquat< T, P > angleAxis( T const& angle,
                                       vec< 3, T, P > const& axis );
...
/// @see gtc_quaternion
template < typename T, precision P >
GLM_FUNC_DECL vec< 4, bool, P > lessThan( tquat< T, P > const& x,
                                          tquat< T, P > const& y );
...
/// @see gtc_quaternion
template < typename T, precision P >
GLM_FUNC_DECL vec< 4, bool, P > lessThanEqual( tquat< T, P > const& x,
                                               tquat< T, P > const& y );
...
/// @see gtc_quaternion
template < typename T, precision P >
GLM_FUNC_DECL vec< 4, bool, P > greaterThan( tquat< T, P > const& x,
                                             tquat< T, P > const& y );
...
/// @see gtc_quaternion
template < typename T, precision P >
GLM_FUNC_DECL vec< 4, bool, P > greaterThanEqual( tquat< T, P > const& x,
                                                  tquat< T, P > const& y );
...
/// @see gtc_quaternion
template < typename T, precision P >
GLM_FUNC_DECL vec< 4, bool, P > equal( tquat< T, P > const& x,
                                       tquat< T, P > const& y );
...
/// @see gtc_quaternion
template < typename T, precision P >
GLM_FUNC_DECL vec< 4, bool, P > notEqual( tquat< T, P > const& x,
                                          tquat< T, P > const& y );
