...
GLM_FUNC_DECL mat< 4, 4, T, P > translate( mat< 4, 4, T, P > const& m,
                                           vec< 3, T, P > const& v );
...
template < typename T, precision P >
GLM_FUNC_DECL mat< 4, 4, T, P > rotate( mat< 4, 4, T, P > const& m,
                                        T angle,
...
template < typename T, precision P >
GLM_FUNC_DECL mat< 4, 4, T, P > scale( mat< 4, 4, T, P > const& m,
                                       vec< 3, T, P > const& v );
...
/// & top)
template < typename T >
GLM_FUNC_DECL mat< 4, 4, T, defaultp > ortho( T left,
                                              T right,
                                              T bottom,
                                              T top,
                                              T zNear,
...
/// & top)
template < typename T >
GLM_FUNC_DECL mat< 4, 4, T, defaultp > orthoLH( T left,
                                                T right,
                                                T bottom,
                                                T top,
                                                T zNear,
...
/// & top)
template < typename T >
GLM_FUNC_DECL mat< 4, 4, T, defaultp > orthoRH( T left,
                                                T right,
                                                T bottom,
                                                T top,
                                                T zNear,
...
/// @see gtc_matrix_transform
template < typename T >
GLM_FUNC_DECL mat< 4, 4, T, defaultp > frustum( T left,
                                                T right,
                                                T bottom,
                                                T top,
                                                T near,
...
/// @see gtc_matrix_transform
template < typename T >
GLM_FUNC_DECL mat< 4, 4, T, defaultp > frustumLH( T left,
                                                  T right,
                                                  T bottom,
                                                  T top,
                                                  T near,
...
/// @see gtc_matrix_transform
template < typename T >
GLM_FUNC_DECL mat< 4, 4, T, defaultp > frustumRH( T left,
                                                  T right,
                                                  T bottom,
                                                  T top,
                                                  T near,
...
/// @see gtc_matrix_transform
template < typename T >
GLM_FUNC_DECL mat< 4, 4, T, defaultp > perspective( T fovy,
                                                    T aspect,
                                                    T near,
                                                    T far );
...
/// @see gtc_matrix_transform
template < typename T >
GLM_FUNC_DECL mat< 4, 4, T, defaultp > perspectiveRH( T fovy,
                                                      T aspect,
                                                      T near,
                                                      T far );
...
/// @see gtc_matrix_transform
template < typename T >
GLM_FUNC_DECL mat< 4, 4, T, defaultp > perspectiveLH( T fovy,
                                                      T aspect,
                                                      T near,
                                                      T far );
...
/// @see gtc_matrix_transform
template < typename T >
GLM_FUNC_DECL mat< 4, 4, T, defaultp > perspectiveFov( T fov,
                                                       T width,
                                                       T height,
                                                       T near,
                                                       T far );
...
/// @see gtc_matrix_transform
template < typename T >
GLM_FUNC_DECL mat< 4, 4, T, defaultp > perspectiveFovRH( T fov,
                                                         T width,
                                                         T height,
                                                         T near,
                                                         T far );
...
/// @see gtc_matrix_transform
template < typename T >
GLM_FUNC_DECL mat< 4, 4, T, defaultp > perspectiveFovLH( T fov,
                                                         T width,
                                                         T height,
                                                         T near,
                                                         T far );
...
/// @see gtc_matrix_transform
template < typename T >
GLM_FUNC_DECL mat< 4, 4, T, defaultp > infinitePerspective( T fovy,
                                                            T aspect,
                                                            T near );
...
/// @see gtc_matrix_transform
template < typename T >
GLM_FUNC_DECL mat< 4, 4, T, defaultp > infinitePerspectiveLH( T fovy,
                                                              T aspect,
                                                              T near );
...
/// @see gtc_matrix_transform
template < typename T >
GLM_FUNC_DECL mat< 4, 4, T, defaultp > infinitePerspectiveRH( T fovy,
                                                              T aspect,
                                                              T near );
...
/// @see gtc_matrix_transform
template < typename T >
GLM_FUNC_DECL mat< 4, 4, T, defaultp > tweakedInfinitePerspective( T fovy,
                                                                   T aspect,
                                                                   T near );
...
GLM_FUNC_DECL vec< 3, T, P > project( vec< 3, T, P > const& obj,
...
/// @see gtc_matrix_transform
template < typename T, typename U, precision P >
GLM_FUNC_DECL vec< 3, T, P > unProject( vec< 3, T, P > const& win,
                                        mat< 4, 4, T, P > const& model,
                                        mat< 4, 4, T, P > const& proj,
                                        vec< 4, U, P > const& viewport );
...
GLM_FUNC_DECL mat< 4, 4, T, P > pickMatrix( vec< 2, T, P > const& center,
...
template < typename T, precision P >
GLM_FUNC_DECL mat< 4, 4, T, P > lookAt( vec< 3, T, P > const& eye,
...
/// right, T const & bottom, T const & top, T const & nearVal, T const & farVal)
template < typename T, precision P >
GLM_FUNC_DECL mat< 4, 4, T, P > lookAtRH( vec< 3, T, P > const& eye,
                                          vec< 3, T, P > const& center,
                                          vec< 3, T, P > const& up );
...
/// right, T const & bottom, T const & top, T const & nearVal, T const & farVal)
template < typename T, precision P >
GLM_FUNC_DECL mat< 4, 4, T, P > lookAtLH( vec< 3, T, P > const& eye,
                                          vec< 3, T, P > const& center,
                                          vec< 3, T, P > const& up );
