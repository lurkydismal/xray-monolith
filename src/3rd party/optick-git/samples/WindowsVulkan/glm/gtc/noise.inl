...
GLM_FUNC_QUALIFIER vec< 4, T, P > grad4( T const& j,
                                         vec< 4, T, P > const& ip ) {
    vec< 3, T, P > pXYZ =
        floor( fract( vec< 3, T, P >( j ) * vec< 3, T, P >( ip ) ) * T( 7 ) ) *
            ip[ 2 ] -
        T( 1 );
    T pW = static_cast< T >( 1.5 ) - dot( abs( pXYZ ), vec< 3, T, P >( 1 ) );
    vec< 4, T, P > s = vec< 4, T, P >(
        lessThan( vec< 4, T, P >( pXYZ, pW ), vec< 4, T, P >( 0.0 ) ) );
...
GLM_FUNC_QUALIFIER T perlin( vec< 2, T, P > const& Position ) {
    vec< 4, T, P > Pi = glm::floor( vec< 4, T, P >( Position.x, Position.y,
                                                    Position.x, Position.y ) ) +
                        vec< 4, T, P >( 0.0, 0.0, 1.0, 1.0 );
    vec< 4, T, P > Pf = glm::fract( vec< 4, T, P >( Position.x, Position.y,
                                                    Position.x, Position.y ) ) -
                        vec< 4, T, P >( 0.0, 0.0, 1.0, 1.0 );
    Pi = mod( Pi, vec< 4, T, P >(
    ...
    vec< 4, T, P > gx =
        static_cast< T >( 2 ) * glm::fract( i / T( 41 ) ) - T( 1 );
    ...
    vec< 4, T, P > norm = detail::taylorInvSqrt( vec< 4, T, P >(
    ...
    vec< 2, T, P > n_x = mix( vec< 2, T, P >( n00, n01 ),
                              vec< 2, T, P >( n10, n11 ), fade_xy.x );
...
GLM_FUNC_QUALIFIER T perlin( vec< 3, T, P > const& Position ) {
    ...
    vec< 4, T, P > iy =
        vec< 4, T, P >( vec< 2, T, P >( Pi0.y ), vec< 2, T, P >( Pi1.y ) );
    vec< 4, T, P > iz0( Pi0.z );
    vec< 4, T, P > iz1( Pi1.z );
    ...
    vec< 4, T, P > norm0 = detail::taylorInvSqrt(
        vec< 4, T, P >( dot( g000, g000 ), dot( g010, g010 ), dot( g100, g100 ),
                        dot( g110, g110 ) ) );
    g000 *= norm0.x;
    g010 *= norm0.y;
    g100 *= norm0.z;
    g110 *= norm0.w;
    vec< 4, T, P > norm1 = detail::taylorInvSqrt(
        vec< 4, T, P >( dot( g001, g001 ), dot( g011, g011 ), dot( g101, g101 ),
                        dot( g111, g111 ) ) );
    g001 *= norm1.x;
    g011 *= norm1.y;
    g101 *= norm1.z;
    ...
    vec< 4, T, P > n_z =
        mix( vec< 4, T, P >( n000, n100, n010, n110 ),
             vec< 4, T, P >( n001, n101, n011, n111 ), fade_xyz.z );
    vec< 2, T, P > n_yz = mix( vec< 2, T, P >( n_z.x, n_z.y ),
...
GLM_FUNC_QUALIFIER T perlin(vec<3, T, P> const & P)
{
        ...
        vec<4, T, P> norm0 = taylorInvSqrt(vec<4, T, P>(dot(g000, g000),
dot(g010, g010), dot(g100, g100), dot(g110, g110))); g000 *= norm0.x; g010 *=
norm0.y; g100 *= norm0.z; g110 *= norm0.w; vec<4, T, P> norm1 =
taylorInvSqrt(vec<4, T, P>(dot(g001, g001), dot(g011, g011), dot(g101, g101),
dot(g111, g111))); g001 *= norm1.x; g011 *= norm1.y; g101 *= norm1.z; g111 *=
norm1.w;
        ...
        vec<4, T, P> n_z = mix(vec<4, T, P>(n000, n100, n010, n110), vec<4, T,
P>(n001, n101, n011, n111), fade_xyz.z); vec<2, T, P> n_yz = mix( vec<2, T,
P>(n_z.x, n_z.y), vec<2, T, P>(n_z.z, n_z.w), fade_xyz.y); T n_xyz = mix(n_yz.x,
n_yz.y, fade_xyz.x); return T(2.2) * n_xyz;
}
*/
// Classic Perlin noise
template < typename T, precision P >
GLM_FUNC_QUALIFIER T perlin( vec< 4, T, P > const& Position ) {
    ...
    vec< 4, T, P > gw00 =
        vec< 4, T, P >( 0.75 ) - abs( gx00 ) - abs( gy00 ) - abs( gz00 );
    ...
    vec< 4, T, P > gw01 =
        vec< 4, T, P >( 0.75 ) - abs( gx01 ) - abs( gy01 ) - abs( gz01 );
    ...
    vec< 4, T, P > gw10 =
        vec< 4, T, P >( 0.75 ) - abs( gx10 ) - abs( gy10 ) - abs( gz10 );
    ...
    vec< 4, T, P > gw11 =
        vec< 4, T, P >( 0.75 ) - abs( gx11 ) - abs( gy11 ) - abs( gz11 );
    ...
    vec< 4, T, P > norm00 = detail::taylorInvSqrt(
        vec< 4, T, P >( dot( g0000, g0000 ), dot( g0100, g0100 ),
    ...
    vec< 4, T, P > norm01 = detail::taylorInvSqrt(
        vec< 4, T, P >( dot( g0001, g0001 ), dot( g0101, g0101 ),
    ...
    vec< 4, T, P > norm10 = detail::taylorInvSqrt(
        vec< 4, T, P >( dot( g0010, g0010 ), dot( g0110, g0110 ),
    ...
    vec< 4, T, P > norm11 = detail::taylorInvSqrt(
        vec< 4, T, P >( dot( g0011, g0011 ), dot( g0111, g0111 ),
    ...
    vec< 4, T, P > n_0w =
        mix( vec< 4, T, P >( n0000, n1000, n0100, n1100 ),
             vec< 4, T, P >( n0001, n1001, n0101, n1101 ), fade_xyzw.w );
    vec< 4, T, P > n_1w =
        mix( vec< 4, T, P >( n0010, n1010, n0110, n1110 ),
             vec< 4, T, P >( n0011, n1011, n0111, n1111 ), fade_xyzw.w );
    vec< 4, T, P > n_zw = mix( n_0w, n_1w, fade_xyzw.z );
    vec< 2, T, P > n_yzw = mix( vec< 2, T, P >( n_zw.x, n_zw.y ),
                                vec< 2, T, P >( n_zw.z, n_zw.w ), fade_xyzw.y );
...
GLM_FUNC_QUALIFIER T perlin( vec< 2, T, P > const& Position,
                             vec< 2, T, P > const& rep ) {
    vec< 4, T, P > Pi = floor( vec< 4, T, P >( Position.x, Position.y,
                                               Position.x, Position.y ) ) +
                        vec< 4, T, P >( 0.0, 0.0, 1.0, 1.0 );
    vec< 4, T, P > Pf = fract( vec< 4, T, P >( Position.x, Position.y,
                                               Position.x, Position.y ) ) -
                        vec< 4, T, P >( 0.0, 0.0, 1.0, 1.0 );
    Pi = mod( Pi,
              vec< 4, T, P >( rep.x, rep.y, rep.x,
...
GLM_FUNC_QUALIFIER T simplex( glm::vec< 2, T, P > const& v ) {
    vec< 4, T, P > const C =
        vec< 4, T, P >( T( 0.211324865405187 ),   // (3.0 -  sqrt(3.0)) / 6.0
    ...
    // i1.y = 1.0 - i1.x;
    vec< 2, T, P > i1 =
        ( x0.x > x0.y ) ? vec< 2, T, P >( 1, 0 ) : vec< 2, T, P >( 0, 1 );
    // x0 = x0 - 0.0 + 0.0 * C.xx ;
    // x1 = x0 - i1 + 1.0 * C.xx ;
    // x2 = x0 - 1.0 + 2.0 * C.xx ;
    vec< 4, T, P > x12 = vec< 4, T, P >( x0.x, x0.y, x0.x, x0.y ) +
                         vec< 4, T, P >( C.x, C.x, C.z, C.z );
    x12 = vec< 4, T, P >( vec< 2, T, P >( x12 ) - i1, x12.z, x12.w );

    // Permutations
    i = mod( i,
             vec< 2, T, P >( 289 ) ); // Avoid truncation effects in permutation
    vec< 3, T, P > p = detail::permute(
        detail::permute( i.y + vec< 3, T, P >( T( 0 ), i1.y, T( 1 ) ) ) + i.x +
        vec< 3, T, P >( T( 0 ), i1.x, T( 1 ) ) );

    vec< 3, T, P > m =
        max( vec< 3, T, P >( 0.5 ) -
                 vec< 3, T, P >( dot( x0, x0 ),
                                 dot( vec< 2, T, P >( x12.x, x12.y ),
                                      vec< 2, T, P >( x12.x, x12.y ) ),
                                 dot( vec< 2, T, P >( x12.z, x12.w ),
                                      vec< 2, T, P >( x12.z, x12.w ) ) ),
             vec< 3, T, P >( 0 ) );
    m = m * m;
    m = m * m;
...
GLM_FUNC_QUALIFIER T simplex( vec< 3, T, P > const& v ) {
    ...
    // Permutations
    i = detail::mod289( i );
    vec< 4, T, P > p( detail::permute(
        detail::permute(
            detail::permute( i.z +
                             vec< 4, T, P >( T( 0 ), i1.z, i2.z, T( 1 ) ) ) +
    ...
    vec< 3, T, P > ns( n_ * vec< 3, T, P >( D.w, D.y, D.z ) -
                       vec< 3, T, P >( D.x, D.z, D.x ) );
    ...
    vec< 4, T, P > a0 = vec< 4, T, P >( b0.x, b0.z, b0.y, b0.w ) +
                        vec< 4, T, P >( s0.x, s0.z, s0.y, s0.w ) *
                            vec< 4, T, P >( sh.x, sh.x, sh.y, sh.y );
    vec< 4, T, P > a1 = vec< 4, T, P >( b1.x, b1.z, b1.y, b1.w ) +
                        vec< 4, T, P >( s1.x, s1.z, s1.y, s1.w ) *
                            vec< 4, T, P >( sh.z, sh.z, sh.w, sh.w );
    ...
    vec< 4, T, P > m =
        max( T( 0.6 ) - vec< 4, T, P >( dot( x0, x0 ), dot( x1, x1 ),
                                        dot( x2, x2 ), dot( x3, x3 ) ),
             vec< 4, T, P >( 0 ) );
    m = m * m;
    return T( 42 ) *
           dot( m * m, vec< 4, T, P >( dot( p0, x0 ), dot( p1, x1 ),
                                       dot( p2, x2 ), dot( p3, x3 ) ) );
}

template < typename T, precision P >
GLM_FUNC_QUALIFIER T simplex( vec< 4, T, P > const& v ) {
    vec< 4, T, P > const C( 0.138196601125011,    // (5 - sqrt(5))/20  G4
    ...
    vec< 4, T, P > i0;
    vec< 3, T, P > isX =
        step( vec< 3, T, P >( x0.y, x0.z, x0.w ), vec< 3, T, P >( x0.x ) );
    vec< 3, T, P > isYZ = step( vec< 3, T, P >( x0.z, x0.w, x0.w ),
                                vec< 3, T, P >( x0.y, x0.y, x0.z ) );
    ...
    T j0 = detail::permute(
        detail::permute( detail::permute( detail::permute( i.w ) + i.z ) +
                         i.y ) +
        i.x );
    vec< 4, T, P > j1 = detail::permute(
        detail::permute(
            detail::permute(
                detail::permute( i.w +
                                 vec< 4, T, P >( i1.w, i2.w, i3.w, T( 1 ) ) ) +
    ...
    vec< 4, T, P > ip = vec< 4, T, P >( T( 1 ) / T( 294 ), T( 1 ) / T( 49 ),
                                        T( 1 ) / T( 7 ), T( 0 ) );
    ...
    vec< 3, T, P > m0 =
        max( T( 0.6 ) -
                 vec< 3, T, P >( dot( x0, x0 ), dot( x1, x1 ), dot( x2, x2 ) ),
             vec< 3, T, P >( 0 ) );
    vec< 2, T, P > m1 =
        max( T( 0.6 ) - vec< 2, T, P >( dot( x3, x3 ), dot( x4, x4 ) ),
             vec< 2, T, P >( 0 ) );
    m0 = m0 * m0;
    m1 = m1 * m1;
    return T( 49 ) *
           ( dot( m0 * m0, vec< 3, T, P >( dot( p0, x0 ), dot( p1, x1 ),
                                           dot( p2, x2 ) ) ) +
