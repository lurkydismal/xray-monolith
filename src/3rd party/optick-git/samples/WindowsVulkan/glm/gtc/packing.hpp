...
/// Returns an unsigned integer vector obtained by converting the components of
/// a floating-point vector to the 16-bit floating-point representation found in
/// the OpenGL Specification. The first vector component specifies the 16
/// least-significant bits of the result; the forth component specifies the 16
/// most-significant bits.
///
/// @see gtc_packing
...
/// Returns a floating-point vector with components obtained by reinterpreting
/// an integer vector as 16-bit floating-point numbers and converting them to
/// 32-bit floating-point values. The first component of the vector is obtained
/// from the 16 least-significant bits of v; the forth component is obtained
...
GLM_FUNC_DECL vecType< L, uint16, P > packHalf(
...
template < length_t L,
           precision P,
           template < length_t, typename, precision > class vecType >
GLM_FUNC_DECL vecType< L, float, P > unpackHalf(
    vecType< L, uint16, P > const& p );

/// Convert each component of the normalized floating-point vector into unsigned
/// integer values.
///
/// @see gtc_packing
...
GLM_FUNC_DECL vec< L, uintType, P > packUnorm(
...
GLM_FUNC_DECL vec< L, floatType, P > unpackUnorm(
    vec< L, uintType, P > const& v );

/// Convert each component of the normalized floating-point vector into signed
/// integer values.
///
/// @see gtc_packing
...
GLM_FUNC_DECL vec< L, floatType, P > unpackSnorm(
...
/// Convert each component from an integer vector into a packed unsigned
/// integer.
///
/// @see gtc_packing
