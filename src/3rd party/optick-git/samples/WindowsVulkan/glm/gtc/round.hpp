...
GLM_FUNC_DECL vecType< L, bool, P > isPowerOfTwo(
...
template < length_t L,
           ...
           precision P,
           template < length_t, typename, precision > class vecType >
GLM_FUNC_DECL vecType< L, T, P > ceilPowerOfTwo(
    vecType< L, T, P > const& value );
...
template < length_t L,
           ...
           precision P,
           template < length_t, typename, precision > class vecType >
GLM_FUNC_DECL vecType< L, T, P > floorPowerOfTwo(
    vecType< L, T, P > const& value );
...
template < length_t L,
           ...
           precision P,
           template < length_t, typename, precision > class vecType >
GLM_FUNC_DECL vecType< L, T, P > roundPowerOfTwo(
    vecType< L, T, P > const& value );
...
template < length_t L,
           ...
           precision P,
           template < length_t, typename, precision > class vecType >
GLM_FUNC_DECL vecType< L, bool, P > isMultiple( vecType< L, T, P > const& Value,
                                                T Multiple );
...
template < length_t L,
           ...
           precision P,
           template < length_t, typename, precision > class vecType >
GLM_FUNC_DECL vecType< L, bool, P > isMultiple(
    vecType< L, T, P > const& Value,
...
template < length_t L,
           ...
           precision P,
           template < length_t, typename, precision > class vecType >
GLM_FUNC_DECL vecType< L, T, P > ceilMultiple(
