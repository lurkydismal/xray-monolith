...
namespace glm {
template <>
GLM_FUNC_QUALIFIER bool epsilonEqual( float const& x,
                                      float const& y,
                                      float const& epsilon ) {
...
template <>
GLM_FUNC_QUALIFIER bool epsilonEqual( double const& x,
                                      double const& y,
...
template <>
GLM_FUNC_QUALIFIER bool epsilonNotEqual( float const& x,
                                         float const& y,
                                         float const& epsilon ) {
    return abs( x - y ) >= epsilon;
}
...
template <>
GLM_FUNC_QUALIFIER bool epsilonNotEqual( double const& x,
                                         double const& y,
                                         double const& epsilon ) {
    return abs( x - y ) >= epsilon;
}
...
GLM_FUNC_QUALIFIER vec< 4, bool, P > epsilonEqual( tquat< T, P > const& x,
                                                   tquat< T, P > const& y,
                                                   T const& epsilon ) {
...
template < typename T, precision P >
GLM_FUNC_QUALIFIER vec< 4, bool, P > epsilonNotEqual( tquat< T, P > const& x,
                                                      tquat< T, P > const& y,
                                                      T const& epsilon ) {
    vec< 4, T, P > v( x.x - y.x, x.y - y.y, x.z - y.z, x.w - y.w );
