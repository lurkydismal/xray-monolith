...
namespace glm {
namespace detail {
template < template < length_t, length_t, typename, precision > class matType,
           length_t C,
           length_t R,
           typename T,
           precision P,
...
struct compute_matrixCompMult {
    GLM_FUNC_QUALIFIER static matType< C, R, T, P > call(
        matType< C, R, T, P > const& x,
...
struct compute_transpose< mat, 2, 2, T, P, Aligned > {
    GLM_FUNC_QUALIFIER static mat< 2, 2, T, P > call(
        mat< 2, 2, T, P > const& m ) {
...
struct compute_transpose< mat, 2, 3, T, P, Aligned > {
    GLM_FUNC_QUALIFIER static mat< 3, 2, T, P > call(
        mat< 2, 3, T, P > const& m ) {
...
struct compute_transpose< mat, 2, 4, T, P, Aligned > {
    GLM_FUNC_QUALIFIER static mat< 4, 2, T, P > call(
        mat< 2, 4, T, P > const& m ) {
...
struct compute_transpose< mat, 3, 2, T, P, Aligned > {
    GLM_FUNC_QUALIFIER static mat< 2, 3, T, P > call(
        mat< 3, 2, T, P > const& m ) {
...
struct compute_transpose< mat, 3, 3, T, P, Aligned > {
    GLM_FUNC_QUALIFIER static mat< 3, 3, T, P > call(
        mat< 3, 3, T, P > const& m ) {
...
struct compute_transpose< mat, 3, 4, T, P, Aligned > {
    GLM_FUNC_QUALIFIER static mat< 4, 3, T, P > call(
        mat< 3, 4, T, P > const& m ) {
...
struct compute_transpose< mat, 4, 2, T, P, Aligned > {
    GLM_FUNC_QUALIFIER static mat< 2, 4, T, P > call(
        mat< 4, 2, T, P > const& m ) {
...
struct compute_transpose< mat, 4, 3, T, P, Aligned > {
    GLM_FUNC_QUALIFIER static mat< 3, 4, T, P > call(
        mat< 4, 3, T, P > const& m ) {
...
struct compute_transpose< mat, 4, 4, T, P, Aligned > {
    GLM_FUNC_QUALIFIER static mat< 4, 4, T, P > call(
        mat< 4, 4, T, P > const& m ) {
...
struct compute_determinant< mat, 4, 4, T, P, Aligned > {
    GLM_FUNC_QUALIFIER static T call( mat< 4, 4, T, P > const& m ) {
        ...
        vec< 4, T, P > DetCof(
            +( m[ 1 ][ 1 ] * SubFactor00 - m[ 1 ][ 2 ] * SubFactor01 +
               m[ 1 ][ 3 ] * SubFactor02 ),
...
struct compute_inverse< mat, 2, 2, T, P, Aligned > {
    GLM_FUNC_QUALIFIER static mat< 2, 2, T, P > call(
        ...
        mat< 2, 2, T, P > Inverse( +m[ 1 ][ 1 ] * OneOverDeterminant,
...
struct compute_inverse< mat, 4, 4, T, P, Aligned > {
    GLM_FUNC_QUALIFIER static mat< 4, 4, T, P > call(
        ...
        vec< 4, T, P > Vec0( m[ 1 ][ 0 ], m[ 0 ][ 0 ], m[ 0 ][ 0 ],
                             m[ 0 ][ 0 ] );
        vec< 4, T, P > Vec1( m[ 1 ][ 1 ], m[ 0 ][ 1 ], m[ 0 ][ 1 ],
                             m[ 0 ][ 1 ] );
        vec< 4, T, P > Vec2( m[ 1 ][ 2 ], m[ 0 ][ 2 ], m[ 0 ][ 2 ],
                             m[ 0 ][ 2 ] );
        vec< 4, T, P > Vec3( m[ 1 ][ 3 ], m[ 0 ][ 3 ], m[ 0 ][ 3 ],
                             m[ 0 ][ 3 ] );
        ...
        mat< 4, 4, T, P > Inverse( Inv0 * SignA, Inv1 * SignB, Inv2 * SignA,
                                   Inv3 * SignB );

        vec< 4, T, P > Row0( Inverse[ 0 ][ 0 ], Inverse[ 1 ][ 0 ],
...
template < length_t C,
           ...
           typename T,
           precision P,
           template < length_t, length_t, typename, precision > class matType >
GLM_FUNC_QUALIFIER matType< C, R, T, P > matrixCompMult(
    matType< C, R, T, P > const& x,
    matType< C, R, T, P > const& y ) {
    GLM_STATIC_ASSERT(
        std::numeric_limits< T >::is_iec559 || GLM_UNRESTRICTED_GENTYPE,
        "'matrixCompMult' only accept floating-point inputs" );
    return detail::compute_matrixCompMult<
        matType, C, R, T, P, detail::is_aligned< P >::value >::call( x, y );
}

template < length_t DA,
           length_t DB,
           typename T,
           precision P,
           template < length_t, typename, precision > class vecTypeA,
           template < length_t, typename, precision > class vecTypeB >
GLM_FUNC_QUALIFIER typename detail::
    outerProduct_trait< DA, DB, T, P, vecTypeA, vecTypeB >::type
    outerProduct( vecTypeA< DA, T, P > const& c,
                  vecTypeB< DB, T, P > const& r ) {
    GLM_STATIC_ASSERT(
        std::numeric_limits< T >::is_iec559 || GLM_UNRESTRICTED_GENTYPE,
        "'outerProduct' only accept floating-point inputs" );

    typename detail::outerProduct_trait< DA, DB, T, P, vecTypeA,
                                         vecTypeB >::type m( uninitialize );
...
template < length_t C,
           ...
           precision P,
           template < length_t, length_t, typename, precision > class matType >
GLM_FUNC_QUALIFIER typename matType< C, R, T, P >::transpose_type transpose(
    matType< C, R, T, P > const& m ) {
    GLM_STATIC_ASSERT(
        std::numeric_limits< T >::is_iec559 || GLM_UNRESTRICTED_GENTYPE,
        "'transpose' only accept floating-point inputs" );
    return detail::compute_transpose<
        matType, C, R, T, P, detail::is_aligned< P >::value >::call( m );
}
...
GLM_FUNC_QUALIFIER T determinant( matType< C, R, T, P > const& m ) {
    ...
    return detail::compute_determinant<
        matType, C, R, T, P, detail::is_aligned< P >::value >::call( m );
}
...
template < length_t C,
           ...
           precision P,
           template < length_t, length_t, typename, precision > class matType >
GLM_FUNC_QUALIFIER matType< C, R, T, P > inverse(
    matType< C, R, T, P > const& m ) {
    GLM_STATIC_ASSERT(
        std::numeric_limits< T >::is_iec559 || GLM_UNRESTRICTED_GENTYPE,
        "'inverse' only accept floating-point inputs" );
    return detail::compute_inverse< matType, C, R, T, P,
                                    detail::is_aligned< P >::value >::call( m );
}
} // namespace glm
