...
template < typename T, precision P >
GLM_FUNC_QUALIFIER mat< 4, 3, T, P >::mat( T const& x0,
                                           T const& y0,
                                           T const& z0,
                                           T const& x1,
                                           T const& y1,
...
template < typename T, precision P >
GLM_FUNC_QUALIFIER mat< 4, 3, T, P >::mat( col_type const& v0,
                                           col_type const& v1,
                                           col_type const& v2,
                                           col_type const& v3 ) {
    this->value[ 0 ] = v0;
...
template < typename X1,
           ...
           typename Y4,
           typename Z4 >
GLM_FUNC_QUALIFIER mat< 4, 3, T, P >::mat( X1 const& x1,
                                           Y1 const& y1,
                                           Z1 const& z1,
                                           X2 const& x2,
                                           Y2 const& y2,
    ...
    this->value[ 3 ] =
        col_type( static_cast< T >( x4 ), value_type( y4 ), value_type( z4 ) );
}

template < typename T, precision P >
template < typename V1, typename V2, typename V3, typename V4 >
GLM_FUNC_QUALIFIER mat< 4, 3, T, P >::mat( vec< 3, V1, P > const& v1,
                                           vec< 3, V2, P > const& v2,
                                           vec< 3, V3, P > const& v3,
                                           vec< 3, V4, P > const& v4 ) {
...
template < typename T, precision P >
GLM_FUNC_QUALIFIER typename mat< 4, 3, T, P >::col_type&
mat< 4, 3, T, P >::operator[]( typename mat< 4, 3, T, P >::length_type i ) {
    assert( i < this->length() );
    return this->value[ i ];
}

template < typename T, precision P >
GLM_FUNC_QUALIFIER typename mat< 4, 3, T, P >::col_type const&
mat< 4, 3, T, P >::operator[](
    typename mat< 4, 3, T, P >::length_type i ) const {
    assert( i < this->length() );
    return this->value[ i ];
}
...
template < typename T, precision P >
GLM_FUNC_QUALIFIER mat< 4, 3, T, P > operator-( mat< 4, 3, T, P > const& m ) {
    return mat< 4, 3, T, P >( -m[ 0 ], -m[ 1 ], -m[ 2 ], -m[ 3 ] );
}
...
GLM_FUNC_QUALIFIER mat< 4, 3, T, P > operator+( mat< 4, 3, T, P > const& m,
                                                T const& s ) {
    return mat< 4, 3, T, P >( m[ 0 ] + s, m[ 1 ] + s, m[ 2 ] + s, m[ 3 ] + s );
}

template < typename T, precision P >
GLM_FUNC_QUALIFIER mat< 4, 3, T, P > operator+( mat< 4, 3, T, P > const& m1,
                                                mat< 4, 3, T, P > const& m2 ) {
    return mat< 4, 3, T, P >( m1[ 0 ] + m2[ 0 ], m1[ 1 ] + m2[ 1 ],
                              m1[ 2 ] + m2[ 2 ], m1[ 3 ] + m2[ 3 ] );
}
...
template < typename T, precision P >
GLM_FUNC_QUALIFIER mat< 4, 3, T, P > operator*( T const& s,
                                                mat< 4, 3, T, P > const& m ) {
    return mat< 4, 3, T, P >( m[ 0 ] * s, m[ 1 ] * s, m[ 2 ] * s, m[ 3 ] * s );
}
...
template < typename T, precision P >
GLM_FUNC_QUALIFIER mat< 2, 3, T, P > operator*( mat< 4, 3, T, P > const& m1,
...
template < typename T, precision P >
GLM_FUNC_QUALIFIER mat< 3, 3, T, P > operator*( mat< 4, 3, T, P > const& m1,
...
GLM_FUNC_QUALIFIER mat< 4, 3, T, P > operator/( T const& s,
                                                mat< 4, 3, T, P > const& m ) {
    return mat< 4, 3, T, P >( s / m[ 0 ], s / m[ 1 ], s / m[ 2 ], s / m[ 3 ] );
}

// -- Boolean operators --

template < typename T, precision P >
GLM_FUNC_QUALIFIER bool operator==( mat< 4, 3, T, P > const& m1,
                                    mat< 4, 3, T, P > const& m2 ) {
