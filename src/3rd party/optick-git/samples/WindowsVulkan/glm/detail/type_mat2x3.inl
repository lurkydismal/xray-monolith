...
template < typename T, precision P >
GLM_FUNC_QUALIFIER mat< 2, 3, T, P >::mat( T x0,
                                           T y0,
                                           T z0,
                                           T x1,
                                           T y1,
...
template < typename T, precision P >
GLM_FUNC_QUALIFIER mat< 2, 3, T, P >::mat( col_type const& v0,
                                           col_type const& v1 ) {
    this->value[ 0 ] = v0;
    this->value[ 1 ] = v1;
}
...
template < typename X1,
           ...
           typename Y2,
           typename Z2 >
GLM_FUNC_QUALIFIER mat< 2, 3, T, P >::mat( X1 x1,
                                           Y1 y1,
                                           Z1 z1,
                                           X2 x2,
                                           Y2 y2,
...
GLM_FUNC_QUALIFIER mat< 2, 3, T, P >::mat( vec< 3, V1, P > const& v1,
                                           vec< 3, V2, P > const& v2 ) {
...
template < typename T, precision P >
GLM_FUNC_QUALIFIER typename mat< 2, 3, T, P >::col_type&
mat< 2, 3, T, P >::operator[]( typename mat< 2, 3, T, P >::length_type i ) {
    assert( i < this->length() );
    return this->value[ i ];
}

template < typename T, precision P >
GLM_FUNC_QUALIFIER typename mat< 2, 3, T, P >::col_type const&
mat< 2, 3, T, P >::operator[](
    typename mat< 2, 3, T, P >::length_type i ) const {
    assert( i < this->length() );
    return this->value[ i ];
}
...
GLM_FUNC_QUALIFIER mat< 2, 3, T, P > operator+( mat< 2, 3, T, P > const& m,
                                                T scalar ) {
    return mat< 2, 3, T, P >( m[ 0 ] + scalar, m[ 1 ] + scalar );
}

template < typename T, precision P >
GLM_FUNC_QUALIFIER mat< 2, 3, T, P > operator+( mat< 2, 3, T, P > const& m1,
                                                mat< 2, 3, T, P > const& m2 ) {
    return mat< 2, 3, T, P >( m1[ 0 ] + m2[ 0 ], m1[ 1 ] + m2[ 1 ] );
}
...
template < typename T, precision P >
GLM_FUNC_QUALIFIER mat< 2, 3, T, P > operator*( T scalar,
                                                mat< 2, 3, T, P > const& m ) {
    return mat< 2, 3, T, P >( m[ 0 ] * scalar, m[ 1 ] * scalar );
}
...
template < typename T, precision P >
GLM_FUNC_QUALIFIER mat< 3, 3, T, P > operator*( mat< 2, 3, T, P > const& m1,
...
template < typename T, precision P >
GLM_FUNC_QUALIFIER mat< 4, 3, T, P > operator*( mat< 2, 3, T, P > const& m1,
...
GLM_FUNC_QUALIFIER mat< 2, 3, T, P > operator/( T scalar,
                                                mat< 2, 3, T, P > const& m ) {
    return mat< 2, 3, T, P >( scalar / m[ 0 ], scalar / m[ 1 ] );
}

// -- Boolean operators --

template < typename T, precision P >
GLM_FUNC_QUALIFIER bool operator==( mat< 2, 3, T, P > const& m1,
                                    mat< 2, 3, T, P > const& m2 ) {
