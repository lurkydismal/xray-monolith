...
struct compute_distance< vec, 4, float, P, true > {
    GLM_FUNC_QUALIFIER static float call( vec< 4, float, P > const& p0,
                                          vec< 4, float, P > const& p1 ) {
...
struct compute_dot< vec< 4, float, P >, float, true > {
    GLM_FUNC_QUALIFIER static float call( vec< 4, float, P > const& x,
...
struct compute_cross< float, P, true > {
    GLM_FUNC_QUALIFIER static vec< 3, float, P > call(
        vec< 3, float, P > const& a,
        vec< 3, float, P > const& b ) {
...
struct compute_faceforward< 4, float, P, vec, true > {
    GLM_FUNC_QUALIFIER static vec< 4, float, P > call(
        vec< 4, float, P > const& N,
        vec< 4, float, P > const& I,
        vec< 4, float, P > const& Nref ) {
        vec< 4, float, P > result( uninitialize );
