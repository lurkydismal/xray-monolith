...
#error \
    "Both GLM_FORCE_SWIZZLE and GLM_FORCE_UNRESTRICTED_GENTYPE can't be defined at the same time"
#endif
...
#if GLM_MESSAGES == GLM_MESSAGES_ENABLED && \
    !defined( GLM_MESSAGE_VERSION_DISPLAYED )
...
#if GLM_MESSAGES == GLM_MESSAGES_ENABLED && \
    !defined( GLM_MESSAGE_COMPILER_DISPLAYED )
...
#if GLM_MESSAGES == GLM_MESSAGES_ENABLED && \
    !defined( GLM_MESSAGE_MODEL_DISPLAYED )
...
#if GLM_MESSAGES == GLM_MESSAGES_ENABLED && \
    !defined( GLM_MESSAGE_ARCH_DISPLAYED )
...
#define GLM_LANG_CXXGNU GLM_LANG_CXXGNU_FLAG
      ...
      ( GLM_COMPILER <= GLM_COMPILER_GCC50 ) ) || \
    ( ( GLM_COMPILER & GLM_COMPILER_CLANG ) &&    \
      ( GLM_COMPILER <= GLM_COMPILER_CLANG34 ) )
#pragma message( \
    "GLM: Using GLM_FORCE_CXX14 with a compiler that doesn't fully support C++14" )
#elif GLM_COMPILER & GLM_COMPILER_VC
#pragma message( \
    "GLM: Using GLM_FORCE_CXX14 but there is no known version of Visual C++ compiler that fully supports C++14" )
#elif GLM_COMPILER & GLM_COMPILER_INTEL
#pragma message( \
    "GLM: Using GLM_FORCE_CXX14 but there is no known version of ICC compiler that fully supports C++14" )
#endif
#define GLM_LANG GLM_LANG_CXX14
#define GLM_LANG_STL11_FORCED
#elif defined( GLM_FORCE_CXX11 )
#if ( ( GLM_COMPILER & GLM_COMPILER_GCC ) &&      \
      ( GLM_COMPILER <= GLM_COMPILER_GCC48 ) ) || \
    ( ( GLM_COMPILER & GLM_COMPILER_CLANG ) &&    \
      ( GLM_COMPILER <= GLM_COMPILER_CLANG33 ) )
#pragma message( \
    "GLM: Using GLM_FORCE_CXX11 with a compiler that doesn't fully support C++11" )
#elif GLM_COMPILER & GLM_COMPILER_VC
#pragma message( \
    "GLM: Using GLM_FORCE_CXX11 but there is no known version of Visual C++ compiler that fully supports C++11" )
#elif GLM_COMPILER & GLM_COMPILER_INTEL
#pragma message( \
    "GLM: Using GLM_FORCE_CXX11 but there is no known version of ICC compiler that fully supports C++11" )
#endif
...
#define GLM_LANG GLM_LANG_CXX14
    ...
    __has_feature( cxx_aggregate_nsdmi ) // GLM_COMPILER_CLANG33 + -std=c++1y
...
#if GLM_MESSAGES == GLM_MESSAGES_ENABLED && \
    !defined( GLM_MESSAGE_LANG_DISPLAYED )
...
#define GLM_HAS_CONSTEXPR                            \
    ( ( GLM_LANG & GLM_LANG_CXX0X_FLAG ) &&          \
      ( ( ( GLM_COMPILER & GLM_COMPILER_VC ) &&      \
          ( GLM_COMPILER >= GLM_COMPILER_VC15 ) ) || \
        ( ( GLM_COMPILER & GLM_COMPILER_GCC ) &&     \
          ( GLM_COMPILER >=                          \
            GLM_COMPILER_GCC48 ) ) ) ) // GCC 4.6 support constexpr but there is
                                       // a compiler bug causing a crash
#define GLM_HAS_CONSTEXPR_PARTIAL                                  \
    ( GLM_HAS_CONSTEXPR || ( ( GLM_COMPILER & GLM_COMPILER_VC ) && \
                             ( GLM_COMPILER >= GLM_COMPILER_VC14 ) ) )
#endif
    ...
    ( ( GLM_LANG & GLM_LANG_CXX0X_FLAG ) &&          \
      ( ( ( GLM_COMPILER & GLM_COMPILER_GCC ) ) ||   \
        ( ( GLM_COMPILER & GLM_COMPILER_VC ) &&      \
          ( GLM_COMPILER >= GLM_COMPILER_VC12 ) ) || \
        ( ( GLM_COMPILER & GLM_COMPILER_CUDA ) &&    \
          ( GLM_COMPILER >= GLM_COMPILER_CUDA75 ) ) ) )
#endif
...
#define GLM_HAS_EXPLICIT_CONVERSION_OPERATORS           \
    ( ( GLM_LANG & GLM_LANG_CXX0X_FLAG ) &&             \
      ( ( ( GLM_COMPILER & GLM_COMPILER_GCC ) ) ||      \
        ( ( GLM_COMPILER & GLM_COMPILER_INTEL ) &&      \
          ( GLM_COMPILER >= GLM_COMPILER_INTEL14 ) ) || \
        ( ( GLM_COMPILER & GLM_COMPILER_VC ) &&         \
          ( GLM_COMPILER >= GLM_COMPILER_VC12 ) ) ||    \
        ( ( GLM_COMPILER & GLM_COMPILER_CUDA ) ) ) )
#endif
...
#define GLM_HAS_TEMPLATE_ALIASES                      \
    ( ( GLM_LANG & GLM_LANG_CXX0X_FLAG ) &&           \
      ( ( ( GLM_COMPILER & GLM_COMPILER_INTEL ) ) ||  \
        ( ( GLM_COMPILER & GLM_COMPILER_GCC ) &&      \
          ( GLM_COMPILER >= GLM_COMPILER_GCC47 ) ) || \
        ( ( GLM_COMPILER & GLM_COMPILER_VC ) &&       \
          ( GLM_COMPILER >= GLM_COMPILER_VC12 ) ) ||  \
        ( ( GLM_COMPILER & GLM_COMPILER_CUDA ) ) ) )
#endif
    ...
    ( ( GLM_LANG & GLM_LANG_CXX0X_FLAG ) &&             \
      ( ( ( GLM_COMPILER & GLM_COMPILER_GCC ) &&        \
        ...
        ( ( GLM_COMPILER & GLM_COMPILER_VC ) &&         \
          ( GLM_COMPILER >= GLM_COMPILER_VC14 ) ) ||    \
        ( ( GLM_COMPILER & GLM_COMPILER_CUDA ) &&       \
          ( GLM_COMPILER >= GLM_COMPILER_CUDA70 ) ) ) )
#endif
...
#pragma message( \
    "GLM: GCC older than 4.6 has a bug presenting the use of rgba and stpq components" )
#endif
...
#define GLM_HAS_ASSIGNABLE                           \
    ( ( GLM_LANG & GLM_LANG_CXX0X_FLAG ) &&          \
      ( ( ( GLM_COMPILER & GLM_COMPILER_VC ) &&      \
          ( GLM_COMPILER >= GLM_COMPILER_VC15 ) ) || \
        ( ( GLM_COMPILER & GLM_COMPILER_GCC ) &&     \
          ( GLM_COMPILER >= GLM_COMPILER_GCC49 ) ) ) )
#endif
...
#if GLM_MESSAGES == GLM_MESSAGES_ENABLED && \
    !defined( GLM_MESSAGE_SWIZZLE_DISPLAYED )
...
#if GLM_MESSAGES == GLM_MESSAGES_ENABLED && \
    !defined( GLM_MESSAGE_UNRESTRICTED_GENTYPE_DISPLAYED )
...
#if GLM_MESSAGES == GLM_MESSAGES_ENABLED && \
    !defined( GLM_MESSAGE_DEPTH_DISPLAYED )
...
#if GLM_MESSAGES == GLM_MESSAGES_ENABLED && \
    !defined( GLM_MESSAGE_HANDED_DISPLAYED )
...
#define GLM_ALIGNED_TYPEDEF( type, name, alignment ) \
    typedef __declspec( align( alignment ) ) type name
...
#endif
#elif GLM_COMPILER & \
    ( GLM_COMPILER_GCC | GLM_COMPILER_CLANG | GLM_COMPILER_INTEL )
...
#if GLM_COMPILER & GLM_COMPILER_VC // Visual C++ has a bug #594
                                   // https://github.com/g-truc/glm/issues/594
...
#if GLM_MESSAGES == GLM_MESSAGES_ENABLED && \
    !defined( GLM_MESSAGE_FORCE_SIZE_T_LENGTH )
...
// Check inclusions of different versions of GLM
        ...
        !defined( GLM_FORCE_IGNORE_VERSION ) )
#error \
