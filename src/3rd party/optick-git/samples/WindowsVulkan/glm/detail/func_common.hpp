...
template < length_t L,
           ...
           precision P,
           template < length_t, typename, precision > class vecType >
GLM_FUNC_DECL vecType< L, T, P > mod( vecType< L, T, P > const& x,
...
template < length_t L,
           ...
           precision P,
           template < length_t, typename, precision > class vecType >
GLM_FUNC_DECL vecType< L, T, P > min( vecType< L, T, P > const& x,
                                      vecType< L, T, P > const& y );
...
template < length_t L,
           ...
           precision P,
           template < length_t, typename, precision > class vecType >
GLM_FUNC_DECL vecType< L, T, P > max( vecType< L, T, P > const& x,
                                      vecType< L, T, P > const& y );
...
template < length_t L,
           ...
           precision P,
           template < length_t, typename, precision > class vecType >
GLM_FUNC_DECL vecType< L, T, P > clamp( vecType< L, T, P > const& x,
                                        T minVal,
                                        T maxVal );
...
/// two vectors. glm::vec4 s = glm::mix(g, h, b); // Returns g or h; glm::dvec3
...
template < length_t L,
           ...
           precision P,
           template < length_t, typename, precision > class vecType >
GLM_FUNC_DECL vecType< L, T, P > mix( vecType< L, T, P > const& x,
                                      vecType< L, T, P > const& y,
...
template < template < length_t, typename, precision > class vecType,
           ...
           typename T,
           precision P >
GLM_FUNC_DECL vecType< L, T, P > step( vecType< L, T, P > const& edge,
...
template < length_t L,
           ...
           precision P,
           template < length_t, typename, precision > class vecType >
GLM_FUNC_DECL vecType< L, T, P > smoothstep( T edge0,
                                             T edge1,
                                             vecType< L, T, P > const& x );
...
template < length_t L,
           ...
           precision P,
           template < length_t, typename, precision > class vecType >
GLM_FUNC_DECL vecType< L, T, P > smoothstep( vecType< L, T, P > const& edge0,
...
template < template < length_t, typename, precision > class vecType,
           length_t L,
           precision P >
GLM_FUNC_DECL vecType< L, int, P > floatBitsToInt(
...
template < template < length_t, typename, precision > class vecType,
           length_t L,
           precision P >
GLM_FUNC_DECL vecType< L, uint, P > floatBitsToUint(
    vecType< L, float, P > const& v );
...
template < template < length_t, typename, precision > class vecType,
           length_t L,
           precision P >
GLM_FUNC_DECL vecType< L, float, P > intBitsToFloat(
...
template < template < length_t, typename, precision > class vecType,
           length_t L,
           precision P >
GLM_FUNC_DECL vecType< L, float, P > uintBitsToFloat(
...
/// specification, section 8.3 Common Functions</a>
template < typename genType >
GLM_FUNC_DECL genType fma( genType const& a,
                           genType const& b,
                           genType const& c );
