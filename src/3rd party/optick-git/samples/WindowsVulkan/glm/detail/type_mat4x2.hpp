...
public:
    ...
    GLM_FUNC_DECL mat( T x0, T y0, T x1, T y1, T x2, T y2, T x3, T y3 );
    GLM_FUNC_DECL mat( col_type const& v0,
                       col_type const& v1,
                       col_type const& v2,
                       col_type const& v3 );
    ...
    template < typename X1,
               ...
               typename X4,
               typename Y4 >
    GLM_FUNC_DECL mat( X1 x1, Y1 y1, X2 x2, Y2 y2, X3 x3, Y3 y3, X4 x4, Y4 y4 );

    template < typename V1, typename V2, typename V3, typename V4 >
    GLM_FUNC_DECL mat( vec< 2, V1, P > const& v1,
                       vec< 2, V2, P > const& v2,
                       vec< 2, V3, P > const& v3,
                       vec< 2, V4, P > const& v4 );
...
template < typename T, precision P >
GLM_FUNC_DECL mat< 4, 2, T, P > operator+( mat< 4, 2, T, P > const& m1,
...
template < typename T, precision P >
GLM_FUNC_DECL mat< 4, 2, T, P > operator*( T scalar,
                                           mat< 4, 2, T, P > const& m );

template < typename T, precision P >
GLM_FUNC_DECL typename mat< 4, 2, T, P >::col_type operator*(
    mat< 4, 2, T, P > const& m,
    typename mat< 4, 2, T, P >::row_type const& v );

template < typename T, precision P >
GLM_FUNC_DECL typename mat< 4, 2, T, P >::row_type operator*(
    typename mat< 4, 2, T, P >::col_type const& v,
    mat< 4, 2, T, P > const& m );

template < typename T, precision P >
GLM_FUNC_DECL mat< 2, 2, T, P > operator*( mat< 4, 2, T, P > const& m1,
                                           mat< 2, 4, T, P > const& m2 );

template < typename T, precision P >
GLM_FUNC_DECL mat< 3, 2, T, P > operator*( mat< 4, 2, T, P > const& m1,
...
template < typename T, precision P >
GLM_FUNC_DECL bool operator==( mat< 4, 2, T, P > const& m1,
                               mat< 4, 2, T, P > const& m2 );
