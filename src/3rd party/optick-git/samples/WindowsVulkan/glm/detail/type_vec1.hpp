...
#pragma clang diagnostic ignored "-Wnested-anon-types"
    ...
    union {
        ...
        /*
        #				if GLM_SWIZZLE == GLM_SWIZZLE_ENABLED
                                                _GLM_SWIZZLE1_2_MEMBERS(T, P,
        tvec2, x) _GLM_SWIZZLE1_2_MEMBERS(T, P, tvec2, r)
                                                _GLM_SWIZZLE1_2_MEMBERS(T, P,
        tvec2, s) _GLM_SWIZZLE1_3_MEMBERS(T, P, tvec3, x)
                                                _GLM_SWIZZLE1_3_MEMBERS(T, P,
        tvec3, r) _GLM_SWIZZLE1_3_MEMBERS(T, P, tvec3, s)
                                                _GLM_SWIZZLE1_4_MEMBERS(T, P,
        tvec4, x) _GLM_SWIZZLE1_4_MEMBERS(T, P, tvec4, r)
                                                _GLM_SWIZZLE1_4_MEMBERS(T, P,
        tvec4, s) #				endif//GLM_SWIZZLE*/
    };
...
tvec2, tvec3, tvec4) #			endif//GLM_SWIZZLE*/
#endif
    ...
    vec( vec< 2, U, Q > const& v );
    /// Explicit conversions (From section 5.4.1 Conversion and scalar
    /// constructors of GLSL 1.30.08 specification)
    template < typename U, precision Q >
    GLM_FUNC_DECL GLM_CONSTEXPR_CTOR GLM_EXPLICIT
    vec( vec< 3, U, Q > const& v );
    /// Explicit conversions (From section 5.4.1 Conversion and scalar
    /// constructors of GLSL 1.30.08 specification)
    template < typename U, precision Q >
    GLM_FUNC_DECL GLM_CONSTEXPR_CTOR GLM_EXPLICIT
    ...
    template < typename U, precision Q >
    GLM_FUNC_DECL GLM_CONSTEXPR_CTOR GLM_EXPLICIT
    vec( vec< 1, U, Q > const& v );

    // -- Swizzle constructors --
    /*
    #		if(GLM_HAS_UNRESTRICTED_UNIONS && (GLM_SWIZZLE ==
    GLM_SWIZZLE_ENABLED)) template<int E0> GLM_FUNC_DECL
    tvec(detail::_swizzle<1, T, P, tvec1, E0, -1,-2,-3> const & that)
                            {
                                    *this = that();
                            }
    #		endif//(GLM_HAS_UNRESTRICTED_UNIONS && (GLM_SWIZZLE ==
    GLM_SWIZZLE_ENABLED))
    */
...
template < typename T, precision P >
GLM_FUNC_DECL vec< 1, T, P > operator+( vec< 1, T, P > const& v1,
                                        vec< 1, T, P > const& v2 );
...
template < typename T, precision P >
GLM_FUNC_DECL bool operator==( vec< 1, T, P > const& v1,
                               vec< 1, T, P > const& v2 );
...
GLM_FUNC_DECL vec< 1, bool, P > operator&&( vec< 1, bool, P > const& v1,
