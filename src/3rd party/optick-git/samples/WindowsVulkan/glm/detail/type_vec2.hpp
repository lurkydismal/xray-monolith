...
#pragma GCC diagnostic pop
    ...
    template < typename A, typename B >
    GLM_FUNC_DECL GLM_CONSTEXPR_CTOR vec( vec< 1, A, P > const& x,
                                          vec< 1, B, P > const& y );
    ...
    GLM_FUNC_DECL vec(
        detail::_swizzle< 2, T, P, E0, E1, -1, -2 > const& that ) {
        *this = that();
    }
...
template < typename T, precision P >
GLM_FUNC_DECL vec< 2, T, P > operator+( vec< 2, T, P > const& v1,
                                        vec< 1, T, P > const& v2 );
...
template < typename T, precision P >
GLM_FUNC_DECL vec< 2, T, P > operator+( vec< 1, T, P > const& v1,
                                        vec< 2, T, P > const& v2 );
...
template < typename T, precision P >
GLM_FUNC_DECL bool operator==( vec< 2, T, P > const& v1,
                               vec< 2, T, P > const& v2 );
...
GLM_FUNC_DECL vec< 2, bool, P > operator&&( vec< 2, bool, P > const& v1,
