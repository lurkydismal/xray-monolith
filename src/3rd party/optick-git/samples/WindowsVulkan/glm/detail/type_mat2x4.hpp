...
public:
    ...
    GLM_FUNC_DECL mat( T x0, T y0, T z0, T w0, T x1, T y1, T z1, T w1 );
    GLM_FUNC_DECL mat( col_type const& v0, col_type const& v1 );
    ...
    template < typename X1,
               ...
               typename Z2,
               typename W2 >
    GLM_FUNC_DECL mat( X1 x1, Y1 y1, Z1 z1, W1 w1, X2 x2, Y2 y2, Z2 z2, W2 w2 );

    template < typename U, typename V >
    GLM_FUNC_DECL mat( vec< 4, U, P > const& v1, vec< 4, V, P > const& v2 );
...
template < typename T, precision P >
GLM_FUNC_DECL mat< 2, 4, T, P > operator+( mat< 2, 4, T, P > const& m1,
...
template < typename T, precision P >
GLM_FUNC_DECL mat< 2, 4, T, P > operator*( T scalar,
                                           mat< 2, 4, T, P > const& m );

template < typename T, precision P >
GLM_FUNC_DECL typename mat< 2, 4, T, P >::col_type operator*(
    mat< 2, 4, T, P > const& m,
    typename mat< 2, 4, T, P >::row_type const& v );

template < typename T, precision P >
GLM_FUNC_DECL typename mat< 2, 4, T, P >::row_type operator*(
    typename mat< 2, 4, T, P >::col_type const& v,
    mat< 2, 4, T, P > const& m );

template < typename T, precision P >
GLM_FUNC_DECL mat< 4, 4, T, P > operator*( mat< 2, 4, T, P > const& m1,
...
template < typename T, precision P >
GLM_FUNC_DECL mat< 3, 4, T, P > operator*( mat< 2, 4, T, P > const& m1,
...
template < typename T, precision P >
GLM_FUNC_DECL bool operator==( mat< 2, 4, T, P > const& m1,
                               mat< 2, 4, T, P > const& m2 );
