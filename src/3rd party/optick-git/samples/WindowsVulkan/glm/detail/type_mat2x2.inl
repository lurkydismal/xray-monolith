...
template < typename T, precision P >
GLM_FUNC_QUALIFIER mat< 2, 2, T, P >::mat( T const& x0,
                                           T const& y0,
                                           T const& x1,
                                           T const& y1 ) {
...
template < typename T, precision P >
GLM_FUNC_QUALIFIER mat< 2, 2, T, P >::mat( col_type const& v0,
                                           col_type const& v1 ) {
    this->value[ 0 ] = v0;
    this->value[ 1 ] = v1;
}
...
GLM_FUNC_QUALIFIER mat< 2, 2, T, P >::mat( X1 const& x1,
                                           Y1 const& y1,
                                           X2 const& x2,
                                           Y2 const& y2 ) {
...
GLM_FUNC_QUALIFIER mat< 2, 2, T, P >::mat( vec< 2, V1, P > const& v1,
                                           vec< 2, V2, P > const& v2 ) {
...
template < typename T, precision P >
GLM_FUNC_QUALIFIER typename mat< 2, 2, T, P >::col_type&
mat< 2, 2, T, P >::operator[]( typename mat< 2, 2, T, P >::length_type i ) {
    assert( i < this->length() );
    return this->value[ i ];
}

template < typename T, precision P >
GLM_FUNC_QUALIFIER typename mat< 2, 2, T, P >::col_type const&
mat< 2, 2, T, P >::operator[](
    typename mat< 2, 2, T, P >::length_type i ) const {
    assert( i < this->length() );
    return this->value[ i ];
}
...
GLM_FUNC_QUALIFIER mat< 2, 2, T, P > operator+( mat< 2, 2, T, P > const& m,
                                                T scalar ) {
    return mat< 2, 2, T, P >( m[ 0 ] + scalar, m[ 1 ] + scalar );
}

template < typename T, precision P >
GLM_FUNC_QUALIFIER mat< 2, 2, T, P > operator+( T scalar,
                                                mat< 2, 2, T, P > const& m ) {
    return mat< 2, 2, T, P >( m[ 0 ] + scalar, m[ 1 ] + scalar );
}

template < typename T, precision P >
GLM_FUNC_QUALIFIER mat< 2, 2, T, P > operator+( mat< 2, 2, T, P > const& m1,
                                                mat< 2, 2, T, P > const& m2 ) {
    return mat< 2, 2, T, P >( m1[ 0 ] + m2[ 0 ], m1[ 1 ] + m2[ 1 ] );
}
...
GLM_FUNC_QUALIFIER mat< 2, 2, T, P > operator-( T scalar,
                                                mat< 2, 2, T, P > const& m ) {
    return mat< 2, 2, T, P >( scalar - m[ 0 ], scalar - m[ 1 ] );
}
...
GLM_FUNC_QUALIFIER typename mat< 2, 2, T, P >::col_type operator*(
    ...
    return vec< 2, T, P >( m[ 0 ][ 0 ] * v.x + m[ 1 ][ 0 ] * v.y,
                           m[ 0 ][ 1 ] * v.x + m[ 1 ][ 1 ] * v.y );
}
...
GLM_FUNC_QUALIFIER typename mat< 2, 2, T, P >::row_type operator*(
    ...
    mat< 2, 2, T, P > const& m ) {
    return vec< 2, T, P >( v.x * m[ 0 ][ 0 ] + v.y * m[ 0 ][ 1 ],
                           v.x * m[ 1 ][ 0 ] + v.y * m[ 1 ][ 1 ] );
}
...
template < typename T, precision P >
GLM_FUNC_QUALIFIER mat< 3, 2, T, P > operator*( mat< 2, 2, T, P > const& m1,
...
template < typename T, precision P >
GLM_FUNC_QUALIFIER mat< 4, 2, T, P > operator*( mat< 2, 2, T, P > const& m1,
...
template < typename T, precision P >
GLM_FUNC_QUALIFIER bool operator==( mat< 2, 2, T, P > const& m1,
                                    mat< 2, 2, T, P > const& m2 ) {
