...
GLM_FUNC_DECL vecType< L, bool, P > lessThan( vecType< L, T, P > const& x,
...
template < length_t L,
           ...
           precision P,
           template < length_t, typename, precision > class vecType >
GLM_FUNC_DECL vecType< L, bool, P > lessThanEqual(
...
template < length_t L,
           ...
           precision P,
           template < length_t, typename, precision > class vecType >
GLM_FUNC_DECL vecType< L, bool, P > greaterThan( vecType< L, T, P > const& x,
                                                 vecType< L, T, P > const& y );
...
template < length_t L,
           ...
           precision P,
           template < length_t, typename, precision > class vecType >
GLM_FUNC_DECL vecType< L, bool, P > greaterThanEqual(
    vecType< L, T, P > const& x,
    vecType< L, T, P > const& y );
...
template < length_t L,
           ...
           precision P,
           template < length_t, typename, precision > class vecType >
GLM_FUNC_DECL vecType< L, bool, P > equal( vecType< L, T, P > const& x,
                                           vecType< L, T, P > const& y );
...
template < length_t L,
           ...
           precision P,
           template < length_t, typename, precision > class vecType >
GLM_FUNC_DECL vecType< L, bool, P > notEqual( vecType< L, T, P > const& x,
                                              vecType< L, T, P > const& y );
