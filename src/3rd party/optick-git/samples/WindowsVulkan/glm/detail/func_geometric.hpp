...
GLM_FUNC_DECL T length( vecType< L, T, P > const& x );
...
template < length_t L,
           ...
           precision P,
           template < length_t, typename, precision > class vecType >
GLM_FUNC_DECL T distance( vecType< L, T, P > const& p0,
...
template < length_t L,
           ...
           precision P,
           template < length_t, typename, precision > class vecType >
GLM_FUNC_DECL vecType< L, T, P > normalize( vecType< L, T, P > const& x );
...
template < length_t L,
           ...
           precision P,
           template < length_t, typename, precision > class vecType >
GLM_FUNC_DECL vecType< L, T, P > faceforward( vecType< L, T, P > const& N,
...
template < length_t L,
           ...
           precision P,
           template < length_t, typename, precision > class vecType >
GLM_FUNC_DECL vecType< L, T, P > refract( vecType< L, T, P > const& I,
