...
public:
    ...
    GLM_FUNC_DECL mat( T x0, T y0, T z0, T x1, T y1, T z1, T x2, T y2, T z2 );
    ...
    GLM_FUNC_DECL mat( vec< 3, V1, P > const& v1,
                       vec< 3, V2, P > const& v2,
                       vec< 3, V3, P > const& v3 );
...
template < typename T, precision P >
GLM_FUNC_DECL mat< 3, 3, T, P > operator+( T scalar,
                                           mat< 3, 3, T, P > const& m );

template < typename T, precision P >
GLM_FUNC_DECL mat< 3, 3, T, P > operator+( mat< 3, 3, T, P > const& m1,
...
template < typename T, precision P >
GLM_FUNC_DECL typename mat< 3, 3, T, P >::col_type operator*(
    mat< 3, 3, T, P > const& m,
    typename mat< 3, 3, T, P >::row_type const& v );

template < typename T, precision P >
GLM_FUNC_DECL typename mat< 3, 3, T, P >::row_type operator*(
...
template < typename T, precision P >
GLM_FUNC_DECL mat< 2, 3, T, P > operator*( mat< 3, 3, T, P > const& m1,
                                           mat< 2, 3, T, P > const& m2 );

template < typename T, precision P >
GLM_FUNC_DECL mat< 4, 3, T, P > operator*( mat< 3, 3, T, P > const& m1,
...
template < typename T, precision P >
GLM_FUNC_DECL bool operator==( mat< 3, 3, T, P > const& m1,
                               mat< 3, 3, T, P > const& m2 );
