...
typedef std::uint64_t uint64;
      ...
      ( __STDC_VERSION__ >=          \
        199901L ) ) // C99 detected, 64 bit types available
...
#else
#error \
    "GLM error: multiple default precision requested for signed integer types"
#endif
...
#else
#error \
    "GLM error: multiple default precision requested for unsigned integer types"
#endif
