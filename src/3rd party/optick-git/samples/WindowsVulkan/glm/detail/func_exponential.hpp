...
/// of 'base' defined in the range (inf-, inf+) in the limit of the type
/// precision.
...
GLM_FUNC_DECL vecType< L, T, P > pow( vecType< L, T, P > const& base,
                                      vecType< L, T, P > const& exponent );

/// Returns the natural exponentiation of x, i.e., e^x.
///
/// @param v exp function is defined for input values of v defined in the range
...
///
/// @param v log function is defined for input values of v defined in the range
...
///
/// @param v exp2 function is defined for input values of v defined in the range
/// (inf-, inf+) in the limit of the type precision.
/// @tparam genType Floating-point scalar or vector types.
///
...
///
/// @param v log2 function is defined for input values of v defined in the range
/// (0, inf+) in the limit of the type precision.
/// @tparam genType Floating-point scalar or vector types.
///
...
///
/// @param v sqrt function is defined for input values of v defined in the range
/// [0, inf+) in the limit of the type precision.
/// @tparam genType Floating-point scalar or vector types.
///
...
///
/// @param v inversesqrt function is defined for input values of v defined in
