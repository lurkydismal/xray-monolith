...
public:
    ...
    GLM_FUNC_DECL mat( T x0, T y0, T x1, T y1, T x2, T y2 );
    ...
    template < typename X1,
               ...
               typename X3,
               typename Y3 >
    GLM_FUNC_DECL mat( X1 x1, Y1 y1, X2 x2, Y2 y2, X3 x3, Y3 y3 );
...
template < typename T, precision P >
GLM_FUNC_DECL mat< 3, 2, T, P > operator+( mat< 3, 2, T, P > const& m1,
...
template < typename T, precision P >
GLM_FUNC_DECL mat< 3, 2, T, P > operator*( T scalar,
                                           mat< 3, 2, T, P > const& m );

template < typename T, precision P >
GLM_FUNC_DECL typename mat< 3, 2, T, P >::col_type operator*(
    mat< 3, 2, T, P > const& m,
    typename mat< 3, 2, T, P >::row_type const& v );

template < typename T, precision P >
GLM_FUNC_DECL typename mat< 3, 2, T, P >::row_type operator*(
    typename mat< 3, 2, T, P >::col_type const& v,
    mat< 3, 2, T, P > const& m );

template < typename T, precision P >
GLM_FUNC_DECL mat< 2, 2, T, P > operator*( mat< 3, 2, T, P > const& m1,
...
template < typename T, precision P >
GLM_FUNC_DECL mat< 4, 2, T, P > operator*( mat< 3, 2, T, P > const& m1,
...
template < typename T, precision P >
GLM_FUNC_DECL bool operator==( mat< 3, 2, T, P > const& m1,
                               mat< 3, 2, T, P > const& m2 );
