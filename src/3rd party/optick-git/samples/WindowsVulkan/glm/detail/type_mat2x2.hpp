...
public:
    ...
    GLM_FUNC_DECL mat( T const& x1, T const& y1, T const& x2, T const& y2 );
    GLM_FUNC_DECL mat( col_type const& v1, col_type const& v2 );

    // -- Conversions --

    template < typename U, typename V, typename M, typename N >
    GLM_FUNC_DECL mat( U const& x1, V const& y1, M const& x2, N const& y2 );

    template < typename U, typename V >
    GLM_FUNC_DECL mat( vec< 2, U, P > const& v1, vec< 2, V, P > const& v2 );
    ...
    GLM_FUNC_DECL mat< 2, 2, T, P >& operator=( mat< 2, 2, T, P > const& v )
        GLM_DEFAULT;
...
template < typename T, precision P >
GLM_FUNC_DECL mat< 2, 2, T, P > operator+( T scalar,
                                           mat< 2, 2, T, P > const& m );

template < typename T, precision P >
GLM_FUNC_DECL mat< 2, 2, T, P > operator+( mat< 2, 2, T, P > const& m1,
...
template < typename T, precision P >
GLM_FUNC_DECL typename mat< 2, 2, T, P >::col_type operator*(
    mat< 2, 2, T, P > const& m,
    typename mat< 2, 2, T, P >::row_type const& v );

template < typename T, precision P >
GLM_FUNC_DECL typename mat< 2, 2, T, P >::row_type operator*(
...
template < typename T, precision P >
GLM_FUNC_DECL mat< 3, 2, T, P > operator*( mat< 2, 2, T, P > const& m1,
                                           mat< 3, 2, T, P > const& m2 );

template < typename T, precision P >
GLM_FUNC_DECL mat< 4, 2, T, P > operator*( mat< 2, 2, T, P > const& m1,
...
template < typename T, precision P >
GLM_FUNC_DECL bool operator==( mat< 2, 2, T, P > const& m1,
                               mat< 2, 2, T, P > const& m2 );
