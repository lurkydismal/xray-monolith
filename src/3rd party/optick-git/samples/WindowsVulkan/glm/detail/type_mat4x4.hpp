...
public:
    ...
    GLM_FUNC_DECL mat( vec< 4, V1, P > const& v1,
                       vec< 4, V2, P > const& v2,
                       vec< 4, V3, P > const& v3,
                       vec< 4, V4, P > const& v4 );
...
template < typename T, precision P >
GLM_FUNC_DECL mat< 4, 4, T, P > operator+( T const& s,
                                           mat< 4, 4, T, P > const& m );

template < typename T, precision P >
GLM_FUNC_DECL mat< 4, 4, T, P > operator+( mat< 4, 4, T, P > const& m1,
...
template < typename T, precision P >
GLM_FUNC_DECL typename mat< 4, 4, T, P >::col_type operator*(
    mat< 4, 4, T, P > const& m,
    typename mat< 4, 4, T, P >::row_type const& v );

template < typename T, precision P >
GLM_FUNC_DECL typename mat< 4, 4, T, P >::row_type operator*(
    typename mat< 4, 4, T, P >::col_type const& v,
    mat< 4, 4, T, P > const& m );

template < typename T, precision P >
GLM_FUNC_DECL mat< 2, 4, T, P > operator*( mat< 4, 4, T, P > const& m1,
                                           mat< 2, 4, T, P > const& m2 );

template < typename T, precision P >
GLM_FUNC_DECL mat< 3, 4, T, P > operator*( mat< 4, 4, T, P > const& m1,
...
template < typename T, precision P >
GLM_FUNC_DECL bool operator==( mat< 4, 4, T, P > const& m1,
                               mat< 4, 4, T, P > const& m2 );
