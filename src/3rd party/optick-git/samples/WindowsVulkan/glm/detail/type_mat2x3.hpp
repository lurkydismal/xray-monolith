...
public:
    ...
    GLM_FUNC_DECL mat( T x0, T y0, T z0, T x1, T y1, T z1 );
    ...
    template < typename X1,
               ...
               typename Y2,
               typename Z2 >
    GLM_FUNC_DECL mat( X1 x1, Y1 y1, Z1 z1, X2 x2, Y2 y2, Z2 z2 );

    template < typename U, typename V >
    GLM_FUNC_DECL mat( vec< 3, U, P > const& v1, vec< 3, V, P > const& v2 );
...
template < typename T, precision P >
GLM_FUNC_DECL mat< 2, 3, T, P > operator+( mat< 2, 3, T, P > const& m1,
...
template < typename T, precision P >
GLM_FUNC_DECL mat< 2, 3, T, P > operator*( T scalar,
                                           mat< 2, 3, T, P > const& m );

template < typename T, precision P >
GLM_FUNC_DECL typename mat< 2, 3, T, P >::col_type operator*(
    mat< 2, 3, T, P > const& m,
    typename mat< 2, 3, T, P >::row_type const& v );

template < typename T, precision P >
GLM_FUNC_DECL typename mat< 2, 3, T, P >::row_type operator*(
...
template < typename T, precision P >
GLM_FUNC_DECL mat< 3, 3, T, P > operator*( mat< 2, 3, T, P > const& m1,
                                           mat< 3, 2, T, P > const& m2 );

template < typename T, precision P >
GLM_FUNC_DECL mat< 4, 3, T, P > operator*( mat< 2, 3, T, P > const& m1,
...
template < typename T, precision P >
GLM_FUNC_DECL bool operator==( mat< 2, 3, T, P > const& m1,
                               mat< 2, 3, T, P > const& m2 );
