...
#pragma GCC diagnostic pop
    ...
    /// Explicit converions (From section 5.4.1 Conversion and scalar
    ...
    GLM_FUNC_DECL vec(
        detail::_swizzle< 3, T, P, E0, E1, E2, -1 > const& that ) {
        *this = that();
    }
    ...
    template < int E0, int E1 >
    GLM_FUNC_DECL vec( T const& scalar,
...
template < typename T, precision P >
GLM_FUNC_DECL vec< 3, T, P > operator+( vec< 1, T, P > const& v1,
                                        vec< 3, T, P > const& v2 );

template < typename T, precision P >
GLM_FUNC_DECL vec< 3, T, P > operator+( vec< 3, T, P > const& v1,
                                        vec< 3, T, P > const& v2 );
...
template < typename T, precision P >
GLM_FUNC_DECL vec< 3, T, P > operator%( T const& scalar,
                                        vec< 3, T, P > const& v );
...
template < typename T, precision P >
GLM_FUNC_DECL bool operator==( vec< 3, T, P > const& v1,
                               vec< 3, T, P > const& v2 );
...
GLM_FUNC_DECL vec< 3, bool, P > operator&&( vec< 3, bool, P > const& v1,
