...
GLM_FUNC_DECL vecType< L, uint, P > uaddCarry( vecType< L, uint, P > const& x,
...
template < length_t L,
           precision P,
           template < length_t, typename, precision > class vecType >
GLM_FUNC_DECL vecType< L, uint, P > usubBorrow( vecType< L, uint, P > const& x,
                                                vecType< L, uint, P > const& y,
...
template < length_t L,
           precision P,
           template < length_t, typename, precision > class vecType >
GLM_FUNC_DECL void umulExtended( vecType< L, uint, P > const& x,
                                 vecType< L, uint, P > const& y,
...
template < length_t L,
           precision P,
           template < length_t, typename, precision > class vecType >
GLM_FUNC_DECL void imulExtended( vecType< L, int, P > const& x,
