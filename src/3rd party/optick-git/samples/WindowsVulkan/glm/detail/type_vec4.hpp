...
#pragma GCC diagnostic pop
    ...
    template < typename X, typename Y, typename Z, typename W >
    GLM_FUNC_DECL GLM_CONSTEXPR_CTOR vec( vec< 1, X, P > const& _x,
                                          vec< 1, Y, P > const& _Y,
                                          vec< 1, Z, P > const& _z,
                                          vec< 1, W, P > const& _w );
    ...
    GLM_FUNC_DECL GLM_CONSTEXPR_CTOR vec( vec< 2, A, Q > const& _xy,
                                          B _z,
                                          C _w );
    /// Explicit conversions (From section 5.4.1 Conversion and scalar
    /// constructors of GLSL 1.30.08 specification)
    ...
    /// constructors of GLSL 1.30.08 specification)
    template < typename A, typename B, typename C, precision Q >
    GLM_FUNC_DECL GLM_CONSTEXPR_CTOR vec( A _x,
                                          vec< 2, B, Q > const& _yz,
                                          C _w );
    /// Explicit conversions (From section 5.4.1 Conversion and scalar
    /// constructors of GLSL 1.30.08 specification)
    template < typename A, typename B, typename C, precision Q >
    GLM_FUNC_DECL GLM_CONSTEXPR_CTOR vec( vec< 1, A, Q > const& _x,
                                          vec< 2, B, Q > const& _yz,
                                          vec< 1, C, Q > const& _w );
    /// Explicit conversions (From section 5.4.1 Conversion and scalar
    /// constructors of GLSL 1.30.08 specification)
    ...
    /// constructors of GLSL 1.30.08 specification)
    template < typename A, typename B, precision Q >
    GLM_FUNC_DECL GLM_CONSTEXPR_CTOR vec( vec< 3, A, Q > const& _xyz,
                                          vec< 1, B, Q > const& _w );
    /// Explicit conversions (From section 5.4.1 Conversion and scalar
    /// constructors of GLSL 1.30.08 specification)
    template < typename A, typename B, precision Q >
    ...
    GLM_FUNC_DECL GLM_CONSTEXPR_CTOR GLM_EXPLICIT
    vec( vec< 4, U, Q > const& v );

    // -- Swizzle constructors --
#if GLM_HAS_UNRESTRICTED_UNIONS && ( GLM_SWIZZLE == GLM_SWIZZLE_ENABLED )
    template < int E0, int E1, int E2, int E3 >
    GLM_FUNC_DECL vec(
        detail::_swizzle< 4, T, P, E0, E1, E2, E3 > const& that ) {
        *this = that();
    }

    template < int E0, int E1, int F0, int F1 >
    GLM_FUNC_DECL vec( detail::_swizzle< 2, T, P, E0, E1, -1, -2 > const& v,
                       detail::_swizzle< 2, T, P, F0, F1, -1, -2 > const& u ) {
        *this = vec< 4, T, P >( v(), u() );
    }

    template < int E0, int E1 >
    GLM_FUNC_DECL vec( T const& x,
                       T const& y,
                       detail::_swizzle< 2, T, P, E0, E1, -1, -2 > const& v ) {
    ...
    GLM_FUNC_DECL vec( detail::_swizzle< 3, T, P, E0, E1, E2, -1 > const& v,
                       T const& w ) {
        *this = vec< 4, T, P >( v(), w );
    }
    ...
    template < int E0, int E1, int E2 >
    GLM_FUNC_DECL vec( T const& x,
                       detail::_swizzle< 3, T, P, E0, E1, E2, -1 > const& v ) {
        *this = vec< 4, T, P >( x, v() );
    }
...
template < typename T, precision P >
GLM_FUNC_DECL vec< 4, T, P > operator+( vec< 4, T, P > const& v1,
                                        vec< 1, T, P > const& v2 );
...
template < typename T, precision P >
GLM_FUNC_DECL vec< 4, T, P > operator+( vec< 1, T, P > const& v1,
                                        vec< 4, T, P > const& v2 );
...
template < typename T, precision P >
GLM_FUNC_DECL vec< 4, T, P > operator%( vec< 1, T, P > const& scalar,
                                        vec< 4, T, P > const& v );
...
template < typename T, precision P >
GLM_FUNC_DECL bool operator==( vec< 4, T, P > const& v1,
                               vec< 4, T, P > const& v2 );
...
GLM_FUNC_DECL vec< 4, bool, P > operator&&( vec< 4, bool, P > const& v1,
