...
GLM_FUNC_DECL GLM_CONSTEXPR vecType< L, T, P > radians(
    vecType< L, T, P > const& degrees );
...
template < length_t L,
           ...
           precision P,
           template < length_t, typename, precision > class vecType >
GLM_FUNC_DECL GLM_CONSTEXPR vecType< L, T, P > degrees(
    vecType< L, T, P > const& radians );
...
template < length_t L,
           ...
           precision P,
           template < length_t, typename, precision > class vecType >
GLM_FUNC_DECL vecType< L, T, P > atan( vecType< L, T, P > const& y,
