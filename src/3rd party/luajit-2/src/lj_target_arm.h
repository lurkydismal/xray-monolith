...
#define FPRDEF( _ )                                                          \
    _( D0 )                                                                  \
    _( D1 )                                                                  \
    _( D2 ) _( D3 ) _( D4 ) _( D5 ) _( D6 ) _( D7 ) _( D8 ) _( D9 ) _( D10 ) \
        _( D11 ) _( D12 ) _( D13 ) _( D14 ) _( D15 )
#endif
#define VRIDDEF( _ )
...
#define RSET_GPREVEN                                                 \
    ( RID2RSET( RID_R0 ) | RID2RSET( RID_R2 ) | RID2RSET( RID_R4 ) | \
      RID2RSET( RID_R6 ) | RID2RSET( RID_R8 ) | RID2RSET( RID_R10 ) )
#define RSET_GPRODD                                                  \
    ( RID2RSET( RID_R1 ) | RID2RSET( RID_R3 ) | RID2RSET( RID_R5 ) | \
      RID2RSET( RID_R7 ) | RID2RSET( RID_R9 ) | RID2RSET( RID_R11 ) )
#if LJ_SOFTFP
#define RSET_FPR 0
#else
...
#define RSET_SCRATCH_GPR_ \
    ( RSET_RANGE( RID_R0, RID_R3 + 1 ) | RID2RSET( RID_R12 ) )
#ifdef __APPLE__
