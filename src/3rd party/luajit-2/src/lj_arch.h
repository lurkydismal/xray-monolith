...
#elif defined( __arm__ ) || defined( __arm ) || defined( __ARM__ ) || \
    defined( __ARM )
...
#elif __ARM_ARCH_7__ || __ARM_ARCH_7A__ || __ARM_ARCH_7R__ || \
    __ARM_ARCH_7S__ || __ARM_ARCH_7VE__
#define LJ_ARCH_VERSION 70
#elif __ARM_ARCH_6T2__
#define LJ_ARCH_VERSION 61
#elif __ARM_ARCH_6__ || __ARM_ARCH_6J__ || __ARM_ARCH_6K__ || \
...
#if ( defined( __ANDROID__ ) && !defined( LJ_TARGET_X86ORX64 ) ) || \
    defined( __symbian__ ) || LJ_TARGET_XBOX360
...
#if defined( LUAJIT_NO_UNWIND ) || defined( __symbian__ ) || LJ_TARGET_IOS || \
    LJ_TARGET_PS3
