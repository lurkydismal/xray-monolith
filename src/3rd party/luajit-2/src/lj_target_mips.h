...
#define GPRDEF( _ )                                                          \
    _( R0 )                                                                  \
    _( R1 )                                                                  \
    _( R2 ) _( R3 ) _( R4 ) _( R5 ) _( R6 ) _( R7 ) _( R8 ) _( R9 ) _( R10 ) \
        _( R11 ) _( R12 ) _( R13 ) _( R14 ) _( R15 ) _( R16 ) _( R17 )       \
            _( R18 ) _( R19 ) _( R20 ) _( R21 ) _( R22 ) _( R23 ) _( R24 )   \
                _( R25 ) _( SYS1 ) _( SYS2 ) _( R28 ) _( SP ) _( R30 ) _( RA )
#define FPRDEF( _ )                                                          \
    _( F0 )                                                                  \
    _( F1 )                                                                  \
    _( F2 ) _( F3 ) _( F4 ) _( F5 ) _( F6 ) _( F7 ) _( F8 ) _( F9 ) _( F10 ) \
        _( F11 ) _( F12 ) _( F13 ) _( F14 ) _( F15 ) _( F16 ) _( F17 )       \
            _( F18 ) _( F19 ) _( F20 ) _( F21 ) _( F22 ) _( F23 ) _( F24 )   \
                _( F25 ) _( F26 ) _( F27 ) _( F28 ) _( F29 ) _( F30 ) _( F31 )
#define VRIDDEF( _ )
...
#define RSET_FPR                                                        \
    ( RID2RSET( RID_F0 ) | RID2RSET( RID_F2 ) | RID2RSET( RID_F4 ) |    \
      RID2RSET( RID_F6 ) | RID2RSET( RID_F8 ) | RID2RSET( RID_F10 ) |   \
      RID2RSET( RID_F12 ) | RID2RSET( RID_F14 ) | RID2RSET( RID_F16 ) | \
      RID2RSET( RID_F18 ) | RID2RSET( RID_F20 ) | RID2RSET( RID_F22 ) | \
      RID2RSET( RID_F24 ) | RID2RSET( RID_F26 ) | RID2RSET( RID_F28 ) | \
      RID2RSET( RID_F30 ) )
#define RSET_ALL ( RSET_GPR | RSET_FPR )
#define RSET_INIT RSET_ALL

#define RSET_SCRATCH_GPR                                        \
    ( RSET_RANGE( RID_R1, RID_R15 + 1 ) | RID2RSET( RID_R24 ) | \
      RID2RSET( RID_R25 ) | RID2RSET( RID_R28 ) )
