...
static LJ_AINLINE GCcdata* lj_cdata_new_( lua_State* L,
                                          CTypeID id,
                                          CTSize sz ) {
...
LJ_FUNC GCcdata* lj_cdata_newv( CTState* cts,
                                CTypeID id,
                                CTSize sz,
                                CTSize align );
...
LJ_FUNC CType* lj_cdata_index( CTState* cts,
                               GCcdata* cd,
                               cTValue* key,
                               uint8_t** pp,
                               CTInfo* qual );
LJ_FUNC int lj_cdata_get( CTState* cts, CType* s, TValue* o, uint8_t* sp );
LJ_FUNC void lj_cdata_set( CTState* cts,
                           CType* d,
                           uint8_t* dp,
                           TValue* o,
                           CTInfo qual );
