...
#define GPRDEF( _ )                                                          \
    ...
    _( ECX )                                                                 \
    _( EDX )                                                                 \
    _( EBX ) _( ESP ) _( EBP ) _( ESI ) _( EDI ) _( R8D ) _( R9D ) _( R10D ) \
        _( R11D ) _( R12D ) _( R13D ) _( R14D ) _( R15D )
#define FPRDEF( _ )                                                       \
    _( XMM0 )                                                             \
    _( XMM1 )                                                             \
    _( XMM2 )                                                             \
    _( XMM3 ) _( XMM4 ) _( XMM5 ) _( XMM6 ) _( XMM7 ) _( XMM8 ) _( XMM9 ) \
        _( XMM10 ) _( XMM11 ) _( XMM12 ) _( XMM13 ) _( XMM14 ) _( XMM15 )
#else
#define GPRDEF( _ ) \
...
#define RSET_GPR \
    ( RSET_RANGE( RID_MIN_GPR, RID_MAX_GPR ) - RID2RSET( RID_ESP ) )
...
#define RSET_ACD \
    ( RID2RSET( RID_EAX ) | RID2RSET( RID_ECX ) | RID2RSET( RID_EDX ) )
#if LJ_64
#if LJ_ABI_WIN
/* Windows x64 ABI. */
#define RSET_SCRATCH                                   \
    ( RSET_ACD | RSET_RANGE( RID_R8D, RID_R11D + 1 ) | \
      RSET_RANGE( RID_XMM0, RID_XMM5 + 1 ) )
#define REGARG_GPRS \
...
#define XO_FPU( a, b ) \
    ( ( uint32_t )( 0x00fd + ( 0x##a << 16 ) + ( 0x##b << 24 ) ) )
...
#define XG_( i8, i, g ) \
    ( ( x86Group )( ( ( i8 ) << 16 ) + ( ( i ) << 8 ) + ( g ) ) )
#define XG_ARITHi( g ) XG_( XI_ARITHi8, XI_ARITHi, g )
#define XG_TOXOi( xg ) \
    ( ( x86Op )( 0x000000fe + ( ( ( xg ) << 16 ) & 0xff000000 ) ) )
#define XG_TOXOi8( xg ) \
    ( ( x86Op )( 0x000000fe + ( ( ( xg ) << 8 ) & 0xff000000 ) ) )
