...
#define GPRDEF( _ )                                                            \
    _( R0 )                                                                    \
    _( SP )                                                                    \
    _( SYS1 ) _( R3 ) _( R4 ) _( R5 ) _( R6 ) _( R7 ) _( R8 ) _( R9 ) _( R10 ) \
        _( R11 ) _( R12 ) _( SYS2 ) _( R14 ) _( R15 ) _( R16 ) _( R17 )        \
            _( R18 ) _( R19 ) _( R20 ) _( R21 ) _( R22 ) _( R23 ) _( R24 )     \
                _( R25 ) _( R26 ) _( R27 ) _( R28 ) _( R29 ) _( R30 ) _( R31 )
#define FPRDEF( _ )                                                          \
    _( F0 )                                                                  \
    _( F1 )                                                                  \
...
#define exitstub_trace_addr( T, exitno ) \
    exitstub_trace_addr_(                \
        ( MCode* )( ( char* )( T )->mcode + ( T )->szmcode ), ( exitno ) )
