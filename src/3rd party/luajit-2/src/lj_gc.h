...
#define makewhite( g, x ) \
    ( ( x )->gch.marked = \
          ( ( x )->gch.marked & ( uint8_t )~LJ_GC_COLORS ) | curwhite( g ) )
...
LJ_FUNC void* lj_mem_grow( lua_State* L,
                           void* p,
                           MSize* szp,
                           MSize lim,
                           MSize esz );
...
#define lj_mem_newvec( L, n, t ) \
    ( ( t* )lj_mem_new( L, ( MSize )( ( n ) * sizeof( t ) ) ) )
#define lj_mem_reallocvec( L, p, on, n, t )                     \
    ( ( p ) = ( t* )lj_mem_realloc( L, p, ( on ) * sizeof( t ), \
                                    ( MSize )( ( n ) * sizeof( t ) ) ) )
#define lj_mem_growvec( L, p, n, m, t ) \
    ( ( p ) =                           \
          ( t* )lj_mem_grow( L, ( p ), &( n ), ( m ), ( MSize )sizeof( t ) ) )
#define lj_mem_freevec( g, p, n, t ) \
    lj_mem_free( g, ( p ), ( n ) * sizeof( t ) )
