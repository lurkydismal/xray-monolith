...
#define frame_prev( f ) \
    ( frame_islua( f ) ? frame_prevl( f ) : frame_prevd( f ) )
...
#define cframe_errfunc( cf ) \
    ( *( int32_t* )( ( ( char* )( cf ) ) + CFRAME_OFS_ERRF ) )
#define cframe_nres( cf ) \
    ( *( int32_t* )( ( ( char* )( cf ) ) + CFRAME_OFS_NRES ) )
#define cframe_prev( cf ) \
    ( *( void** )( ( ( char* )( cf ) ) + CFRAME_OFS_PREV ) )
#define cframe_multres( cf ) \
    ( *( uint32_t* )( ( ( char* )( cf ) ) + CFRAME_OFS_MULTRES ) )
#define cframe_multres_n( cf ) \
    ( cframe_multres( ( cf ) ) >> CFRAME_SHIFT_MULTRES )
#define cframe_L( cf ) \
