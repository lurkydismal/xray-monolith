...
LJ_STATIC_ASSERT( ( int )BC_IST - ( int )BC_ISTC ==
                  ( int )BC_ISF - ( int )BC_ISFC );
LJ_STATIC_ASSERT( ( int )BC_CALLT - ( int )BC_CALL ==
                  ( int )BC_CALLMT - ( int )BC_CALLM );
...
#define bcmode_hasd( op ) \
    ( ( lj_bc_mode[ op ] & ( 15 << 3 ) ) == ( BCMnone << 3 ) )
