...
#else
        int32_t b = ( x >> 32 )
                        ? 32 + ( int32_t )lj_fls( ( uint32_t )( x >> 32 ) )
...
static StrScanFmt strscan_hex( const uint8_t* p,
                               TValue* o,
                               StrScanFmt fmt,
                               uint32_t opt,
                               int32_t ex2,
...
/* Parse octal number. */
static StrScanFmt strscan_oct( const uint8_t* p,
                               TValue* o,
                               StrScanFmt fmt,
                               int32_t neg,
                               uint32_t dig ) {
...
static StrScanFmt strscan_dec( const uint8_t* p,
                               TValue* o,
                               StrScanFmt fmt,
                               uint32_t opt,
                               int32_t ex10,
