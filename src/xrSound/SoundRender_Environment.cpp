...
void CSoundRender_Environment::lerp( CSoundRender_Environment& A,
    ...
    EnvironmentDiffusion =
        fi * A.EnvironmentDiffusion + f * B.EnvironmentDiffusion;
...
void CSoundRender_Environment::clamp() {
    ::clamp( Room, ( float )AL_EAXREVERB_MIN_GAIN,
             ( float )AL_EAXREVERB_MAX_GAIN );
    ::clamp( RoomHF, ( float )AL_EAXREVERB_MIN_GAINHF,
             ( float )AL_EAXREVERB_MAX_GAINHF );
    ::clamp( RoomLF, ( float )AL_EAXREVERB_MIN_GAINLF,
             ( float )AL_EAXREVERB_MAX_GAINLF );
    ::clamp( RoomRolloffFactor, AL_EAXREVERB_MIN_ROOM_ROLLOFF_FACTOR,
             AL_EAXREVERB_MAX_ROOM_ROLLOFF_FACTOR );
    ::clamp( DecayTime, AL_EAXREVERB_MIN_DECAY_TIME,
             AL_EAXREVERB_MAX_DECAY_TIME );
    ::clamp( DecayHFRatio, AL_EAXREVERB_MIN_DECAY_HFRATIO,
             AL_EAXREVERB_MAX_DECAY_HFRATIO );
    ::clamp( DecayLFRatio, AL_EAXREVERB_MIN_DECAY_LFRATIO,
             AL_EAXREVERB_MAX_DECAY_LFRATIO );
    ::clamp( Reflections, ( float )AL_EAXREVERB_MIN_REFLECTIONS_GAIN,
             ( float )AL_EAXREVERB_MAX_REFLECTIONS_GAIN );
    ::clamp( ReflectionsDelay, AL_EAXREVERB_MIN_REFLECTIONS_DELAY,
             ( float )AL_EAXREVERB_MAX_REFLECTIONS_DELAY );
    ::clamp( EchoTime, AL_EAXREVERB_MIN_ECHO_TIME, AL_EAXREVERB_MAX_ECHO_TIME );
    ::clamp( EchoDepth, AL_EAXREVERB_MIN_ECHO_DEPTH,
             AL_EAXREVERB_MAX_ECHO_DEPTH );
    ::clamp( Reverb, ( float )AL_EAXREVERB_MIN_LATE_REVERB_GAIN,
             ( float )AL_EAXREVERB_MAX_LATE_REVERB_GAIN );
    ::clamp( ReverbDelay, AL_EAXREVERB_MIN_LATE_REVERB_DELAY,
             AL_EAXREVERB_MAX_LATE_REVERB_DELAY );
    ::clamp( EnvironmentDiffusion, AL_EAXREVERB_MIN_DIFFUSION,
             AL_EAXREVERB_MAX_DIFFUSION );
    ::clamp( AirAbsorptionHF, AL_EAXREVERB_MIN_AIR_ABSORPTION_GAINHF,
             AL_EAXREVERB_MAX_AIR_ABSORPTION_GAINHF );
    ::clamp( ModulationTime, AL_EAXREVERB_MIN_MODULATION_TIME,
             AL_EAXREVERB_MAX_MODULATION_TIME );
    ::clamp( ModulationDepth, AL_EAXREVERB_MIN_MODULATION_DEPTH,
             AL_EAXREVERB_MAX_MODULATION_DEPTH );
    ::clamp( Density, AL_EAXREVERB_MIN_DENSITY, AL_EAXREVERB_MAX_DENSITY );
    ::clamp( HFReference, AL_EAXREVERB_MIN_HFREFERENCE,
             AL_EAXREVERB_MAX_HFREFERENCE );
    ::clamp( LFReference, AL_EAXREVERB_MIN_LFREFERENCE,
             AL_EAXREVERB_MAX_LFREFERENCE );
    ::clamp( DecayHFLimit, AL_EAXREVERB_MIN_DECAY_HFLIMIT,
...
CSoundRender_Environment* SoundEnvironment_LIB::Append(
    CSoundRender_Environment* parent ) {
