...
const float s_f_def_source_footer =
    0.0f; // sec of silence after buffer data, just for rendering
const u32 sdef_env_version = 4; // current version of env-def
const u32 sndenv_ver_extended =
    5; // Extended version for EFX/EAX compatibility (IX-Ray)
