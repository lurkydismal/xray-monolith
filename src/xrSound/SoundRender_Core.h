...
class CSoundRender_Core : public CSound_manager_interface {
    ...
    void finish_source_prepare( SoundPrefetchJob& job,
                                PreparedSoundSource&& prepared,
                                xr_string&& error );
...
public:
    ...
    BOOL bReady;
    bool m_is_supported; // Boolean variable to indicate presence of EFX
                         // Extension
...
public:
    ...
    // listener
    virtual void update_listener( const Fvector& P,
                                  const Fvector& D,
                                  const Fvector& N,
                                  float dt ) = 0;
...
public:
    ...
    virtual void source_prefetch_prepare(
        const xr_vector< xr_string >& sources ) override;
