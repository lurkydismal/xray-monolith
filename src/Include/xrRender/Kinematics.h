...
public:
    ...
    virtual void Bone_GetAnimPos( Fmatrix& pos,
                                  u16 id,
                                  u8 channel_mask,
                                  bool ignore_callbacks ) = 0;

    virtual bool PickBone( const Fmatrix& parent_xform,
                           pick_result& r,
                           float dist,
                           const Fvector& start,
                           const Fvector& dir,
    ...
    virtual ICF void _BCL LL_GetBoneLocalPosition( u16 bone_id,
                                                   Fvector& result ) {}
    virtual ICF void _BCL LL_GetBoneLocalTransform( u16 bone_id,
                                                    Fmatrix& result ) {}
    virtual ICF void _BCL LL_GetBoneWorldPosition( u16 bone_id,
                                                   const Fmatrix& xform,
                                                   Fvector& result ) {}
    virtual ICF void _BCL LL_GetBoneWorldTransform( u16 bone_id,
                                                    const Fmatrix& xform,
                                                    Fmatrix& result ) {}
    ...
    virtual void LL_SetBoneVisible( u16 bone_id,
                                    BOOL val,
                                    BOOL bRecursive ) = 0;
    ...
    virtual void CalculateBones(
        BOOL bForceExact = FALSE ) = 0; // Recalculate skeleton
...
IC IKinematics* PKinematics( IRenderVisual* V ) {
