...
public:
    enum DeviceState { dsOK = 0, dsLost, dsNeedReset };
...
public:
    ...
    virtual void Create( HWND hWnd,
                         ...
                         float& fHeight_2,
                         bool ) = 0;
    virtual void SetupGPU( BOOL bForceGPU_SW,
                           BOOL bForceGPU_NonPure,
                           BOOL bForceGPU_REF ) = 0;
    //	Overdraw
    ...
    virtual void ResourcesGetMemoryUsage( u32& m_base,
                                          u32& c_base,
                                          u32& m_lmaps,
                                          u32& c_lmaps ) = 0;
    ...
    virtual void ResourcesPrefetchCreateTexture(
        LPCSTR name,
        LPCSTR canonical_level_path = nullptr ) = 0;
    ...
    virtual bool SwitchOutputMonitor( HMONITOR hTargetMon,
                                      HWND hWnd,
                                      u32 g_screenmode,
                                      u32& vidModeW,
                                      u32& vidModeH ) {
