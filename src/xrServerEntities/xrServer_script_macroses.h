...
#define INHERIT_ZONE                                                          \
    ...
    DEFINE_LUA_WRAPPER_CONST_METHOD_1( enabled, bool,                         \
                                       CSE_ALifeMonsterAbstract* )            \
    DEFINE_LUA_WRAPPER_CONST_METHOD_1( suitable, float,                       \
                                       CSE_ALifeMonsterAbstract* )            \
    ...
    DEFINE_LUA_WRAPPER_METHOD_1( task, CALifeSmartTerrainTask*,               \
                                 CSE_ALifeMonsterAbstract* )                  \
...
struct CWrapperAbstractOnlineOfflineGroup : public T,
    ...
    CWrapperAbstractOnlineOfflineGroup( LPCSTR section )
        : inherited( section ) {}
...
#define luabind_virtual_alife( a, b )                                          \
    DEFINE_LUABIND_VIRTUAL_FUNCTION_EXPLICIT_CONST_0( a, b, can_switch_online, \
                                                      bool )                   \
    DEFINE_LUABIND_VIRTUAL_FUNCTION_EXPLICIT_CONST_0(                          \
        a, b, can_switch_offline, bool )                                       \
    DEFINE_LUABIND_VIRTUAL_FUNCTION_EXPLICIT_CONST_0( a, b, interactive,       \
                                                      bool )                   \
...
#define luabind_virtual_Abstract( a, b ) \
    luabind_virtual_Pure( a, b ) luabind_virtual_abstract( a, b )

#define luabind_virtual_Alife( a, b ) \
    luabind_virtual_Abstract( a, b ) luabind_virtual_alife( a, b )

#define luabind_virtual_DynamicAlife( a, b ) \
    luabind_virtual_Alife( a, b ) luabind_virtual_dynamic_alife( a, b )

#define luabind_virtual_Creature( a, b ) \
    luabind_virtual_DynamicAlife( a, b ) luabind_virtual_creature( a, b )

#define luabind_virtual_Zone( a, b ) \
    luabind_virtual_DynamicAlife( a, b ) luabind_virtual_zone( a, b )
...
#define luabind_virtual_Monster( a, b ) \
    luabind_virtual_Creature( a, b ) luabind_virtual_monster( a, b )

#define luabind_virtual_Item( a, b ) \
    luabind_virtual_DynamicAlife( a, b ) luabind_virtual_item( a, b )
...
#define luabind_class_dynamic_alife1( a, b, c )                              \
    DEFINE_LUABIND_CLASS_WRAPPER_1( a, CWrapperAbstractDynamicALife< a >, b, \
                                    c )                                      \
    luabind_virtual_DynamicAlife( a, CWrapperAbstractDynamicALife< a > )
...
#define luabind_class_dynamic_alife2( a, b, c, d )                           \
    DEFINE_LUABIND_CLASS_WRAPPER_2( a, CWrapperAbstractDynamicALife< a >, b, \
                                    c, d )                                   \
    luabind_virtual_DynamicAlife( a, CWrapperAbstractDynamicALife< a > )
...
#define luabind_class_online_offline_group2( a, b, c, d )     \
    DEFINE_LUABIND_CLASS_WRAPPER_2(                           \
        a, CWrapperAbstractOnlineOfflineGroup< a >, b, c, d ) \
    luabind_virtual_OnlineOfflineGroup(                       \
        a, CWrapperAbstractOnlineOfflineGroup< a > )

#define luabind_class_creature2( a, b, c, d )                               \
    DEFINE_LUABIND_CLASS_WRAPPER_2( a, CWrapperAbstractCreature< a >, b, c, \
                                    d )                                     \
    luabind_virtual_Creature( a, CWrapperAbstractCreature< a > )
...
#define luabind_class_alife3( a, b, c, d, e )                               \
    DEFINE_LUABIND_CLASS_WRAPPER_3( a, CWrapperAbstractALife< a >, b, c, d, \
                                    e )                                     \
    luabind_virtual_Alife( a, CWrapperAbstractALife< a > )

#define luabind_class_dynamic_alife3( a, b, c, d, e )                        \
    DEFINE_LUABIND_CLASS_WRAPPER_3( a, CWrapperAbstractDynamicALife< a >, b, \
                                    c, d, e )                                \
    luabind_virtual_DynamicAlife( a, CWrapperAbstractDynamicALife< a > )
...
#define luabind_class_creature3( a, b, c, d, e )                               \
    DEFINE_LUABIND_CLASS_WRAPPER_3( a, CWrapperAbstractCreature< a >, b, c, d, \
                                    e )                                        \
    luabind_virtual_Creature( a, CWrapperAbstractCreature< a > )

#define luabind_class_monster3( a, b, c, d, e )                               \
    DEFINE_LUABIND_CLASS_WRAPPER_3( a, CWrapperAbstractMonster< a >, b, c, d, \
                                    e )                                       \
    luabind_virtual_Monster( a, CWrapperAbstractMonster< a > )
...
#define luabind_class_alife4( a, b, c, d, e, f )                               \
    DEFINE_LUABIND_CLASS_WRAPPER_4( a, CWrapperAbstractALife< a >, b, c, d, e, \
                                    f )                                        \
    luabind_virtual_Alife( a, CWrapperAbstractALife< a > )

#define luabind_class_dynamic_alife4( a, b, c, d, e, f )                     \
    DEFINE_LUABIND_CLASS_WRAPPER_4( a, CWrapperAbstractDynamicALife< a >, b, \
                                    c, d, e, f )                             \
    luabind_virtual_DynamicAlife( a, CWrapperAbstractDynamicALife< a > )

#define luabind_class_zone4( a, b, c, d, e, f )                               \
    DEFINE_LUABIND_CLASS_WRAPPER_4( a, CWrapperAbstractZone< a >, b, c, d, e, \
                                    f )                                       \
    luabind_virtual_Zone( a, CWrapperAbstractZone< a > )

#define luabind_class_creature4( a, b, c, d, e, f )                            \
    DEFINE_LUABIND_CLASS_WRAPPER_4( a, CWrapperAbstractCreature< a >, b, c, d, \
                                    e, f )                                     \
    luabind_virtual_Creature( a, CWrapperAbstractCreature< a > )

#define luabind_class_monster4( a, b, c, d, e, f )                            \
    DEFINE_LUABIND_CLASS_WRAPPER_4( a, CWrapperAbstractMonster< a >, b, c, d, \
                                    e, f )                                    \
    luabind_virtual_Monster( a, CWrapperAbstractMonster< a > )

#define luabind_class_item4( a, b, c, d, e, f )                               \
    DEFINE_LUABIND_CLASS_WRAPPER_4( a, CWrapperAbstractItem< a >, b, c, d, e, \
                                    f )                                       \
    luabind_virtual_Item( a, CWrapperAbstractItem< a > )
