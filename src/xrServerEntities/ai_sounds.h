...
enum ESoundTypes {
    ...
    SOUND_TYPE_WEAPON_EMPTY_CLICKING =
        SOUND_TYPE_WEAPON | SOUND_TYPE_EMPTY_CLICKING,
    ...
    SOUND_TYPE_WORLD_OBJECT_BREAKING =
        SOUND_TYPE_WORLD | SOUND_TYPE_OBJECT_BREAKING,
    SOUND_TYPE_WORLD_OBJECT_COLLIDING =
        SOUND_TYPE_WORLD | SOUND_TYPE_OBJECT_COLLIDING,
    SOUND_TYPE_WORLD_OBJECT_EXPLODING =
        SOUND_TYPE_WORLD | SOUND_TYPE_OBJECT_EXPLODING,
