...
SERVER_ENTITY_DECLARE_BEGIN2( CSE_ALifeTrader,
...
SERVER_ENTITY_DECLARE_BEGIN2( CSE_ALifeTorridZone,
                              CSE_ALifeCustomZone,
                              CSE_Motion )
...
SERVER_ENTITY_DECLARE_BEGIN2( CSE_ALifeZoneVisual,
...
SERVER_ENTITY_DECLARE_BEGIN( CSE_ALifeCreatureAbstract,
                             CSE_ALifeDynamicObjectVisual )
private:
float fHealth;
...
SERVER_ENTITY_DECLARE_BEGIN3( CSE_ALifeMonsterAbstract,
...
// if monster on the way then (m_smart_terrain_id != 0xffff) &&
// (!m_task_reached)
bool m_task_reached;
//---------------------------------------------------------
...
SERVER_ENTITY_DECLARE_BEGIN3( CSE_ALifeCreatureActor,
                              CSE_ALifeCreatureAbstract,
                              CSE_ALifeTraderAbstract,
                              CSE_PHSkeleton )
...
// статический массив - 6 float(вектора пределов квантизации) + m_u16NumItems*(7
// u8) (позиция и поворот кости)
u8 m_BoneDataSize;
...
SERVER_ENTITY_DECLARE_BEGIN( CSE_ALifeCreaturePhantom,
                             CSE_ALifeCreatureAbstract )
...
SERVER_ENTITY_DECLARE_BEGIN2( CSE_ALifeMonsterRat,
...
SERVER_ENTITY_DECLARE_BEGIN2( CSE_ALifeMonsterBase,
                              CSE_ALifeMonsterAbstract,
                              CSE_PHSkeleton )
...
//-------------------------------
SERVER_ENTITY_DECLARE_BEGIN2( CSE_ALifeHumanAbstract,
                              CSE_ALifeTraderAbstract,
                              CSE_ALifeMonsterAbstract )
...
SERVER_ENTITY_DECLARE_BEGIN2( CSE_ALifeHumanStalker,
...
// void
// force_change_game_vertex_id(GameGraph::_GRAPH_ID game_vertex_id);
