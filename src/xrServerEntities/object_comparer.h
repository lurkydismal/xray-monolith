...
struct CComparer {
    ...
    IC static bool compare( const shared_str& _1,
                            const shared_str& _2,
                            const P& p ) {
        return ( p( _1, _2 ) );
    }
    ...
    IC static bool compare( const std::pair< T1, T2 >& _1,
                            const std::pair< T1, T2 >& _2,
                            const P& p ) {
        return ( compare( _1.first, _2.first, p ) &&
                 compare( _1.second, _2.second, p ) );
    }

    template < typename T, int size >
    IC static bool compare( const svector< T, size >& _1,
                            const svector< T, size >& _2,
                            const P& p ) {
        if ( _1.size() != _2.size() )
            return ( p() );
    ...
    template < typename T1, typename T2 >
    IC static bool compare( const std::queue< T1, T2 >& __1,
                            const std::queue< T1, T2 >& __2,
                            const P& p ) {
    ...
    template < template < typename _1, typename _2 > class T1,
               typename T2,
               typename T3 >
    IC static bool compare( const T1< T2, T3 >& __1,
                            const T1< T2, T3 >& __2,
                            const P& p,
                            bool ) {
        T1< T2, T3 > _1 = __1;
    ...
    template < template < typename _1, typename _2, typename _3 > class T1,
               ...
               typename T3,
               typename T4 >
    IC static bool compare( const T1< T2, T3, T4 >& __1,
                            const T1< T2, T3, T4 >& __2,
                            const P& p,
                            bool ) {
        T1< T2, T3, T4 > _1 = __1;
        T1< T2, T3, T4 > _2 = __2;
    ...
    template < typename T1, typename T2 >
    IC static bool compare( const xr_stack< T1, T2 >& _1,
                            const xr_stack< T1, T2 >& _2,
                            const P& p ) {
        return ( compare( _1, _2, p, true ) );
    }

    template < typename T1, typename T2, typename T3 >
    IC static bool compare( const std::priority_queue< T1, T2, T3 >& _1,
                            const std::priority_queue< T1, T2, T3 >& _2,
                            const P& p ) {
        return ( compare( _1, _2, p, true ) );
    }
    ...
    struct CHelper4 {
        ...
        IC static bool compare( const T& _1, const T& _2, const P& p ) {
            if constexpr ( a ) {
                ...
                return CHelper< T >::template compare<
                    object_type_traits::is_pointer< T >::value >( _1, _2, p );
            }
        }
    };
    ...
    template < typename T >
    IC static bool compare( const T& _1, const T& _2, const P& p ) {
        return CHelper4< T >::template compare<
            object_type_traits::is_stl_container< T >::value >( _1, _2, p );
    }
};
...
#define declare_comparer( a, b )                                           \
    ...
    IC bool a( const T1& p0, const T2& p1 ) {                              \
        return (                                                           \
            compare( p0, p1, object_comparer::detail::comparer< b >() ) ); \
    }
