    ...
    module( L )
        [ def( "script_server_object_version", &script_server_object_version ),
          ...
          class_< NET_Packet >( "net_packet" )
              ...
              .def( "w_stringZ", ( void ( NET_Packet::* )( LPCSTR ) )(
                                     &NET_Packet::w_stringZ ) )
              ...
              .def(
                  "r_vec3",
                  ( void ( NET_Packet::* )( Fvector& ) )( &NET_Packet::r_vec3 ),
                  pure_out_value< 2 >() )
              .def( "r_float", ( void ( NET_Packet::* )( float& ) )(
                                   &NET_Packet::r_float ) )
              .def( "r_u64",
                    ( void ( NET_Packet::* )( u64& ) )( &NET_Packet::r_u64 ) )
              .def( "r_s64",
                    ( void ( NET_Packet::* )( s64& ) )( &NET_Packet::r_s64 ) )
              .def( "r_u32",
                    ( void ( NET_Packet::* )( u32& ) )( &NET_Packet::r_u32 ) )
              .def( "r_s32",
                    ( void ( NET_Packet::* )( s32& ) )( &NET_Packet::r_s32 ) )
              .def( "r_u16",
                    ( void ( NET_Packet::* )( u16& ) )( &NET_Packet::r_u16 ) )
              .def( "r_s16",
                    ( void ( NET_Packet::* )( s16& ) )( &NET_Packet::r_s16 ) )
              .def( "r_u8",
                    ( void ( NET_Packet::* )( u8& ) )( &NET_Packet::r_u8 ) )
              .def( "r_s8",
                    ( void ( NET_Packet::* )( s8& ) )( &NET_Packet::r_s8 ) )
              .def( "r_bool", &r_bool )
              .def( "r_float",
                    ( float ( NET_Packet::* )() )( &NET_Packet::r_float ) )
              ...
              .def( "r_float_q16",
                    ( void ( NET_Packet::* )( float&, float, float ) )(
                        &NET_Packet::r_float_q16 ) )
              .def( "r_float_q8",
                    ( void ( NET_Packet::* )( float&, float, float ) )(
                        &NET_Packet::r_float_q8 ) )
