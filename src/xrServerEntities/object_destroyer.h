...
struct CDestroyer {
    ...
    struct CHelper2 {
        ...
        IC static void delete_data( T& data ) {
            CHelper1< T >::delete_data< object_type_traits::is_base_and_derived<
                IPureDestroyableObject, T >::value >( data );
        }
    ...
    struct CHelper4 {
        template < bool a >
        IC static void delete_data( T& data ) {
            CHelper2< T >::delete_data<
                object_type_traits::is_pointer< T >::value >( data );
        }
    ...
    template < typename T >
    IC static void delete_data( T& data ) {
        CHelper4< T >::delete_data<
            object_type_traits::is_stl_container< T >::value >( data );
    }
};
