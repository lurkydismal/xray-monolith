...
#define _associative_vector_compare_predicate                     \
    associative_vector_compare_predicate< _key_type, _value_type, \
                                          _compare_predicate_type >

TEMPLATE_SPECIALIZATION
IC _associative_vector_compare_predicate::
...
TEMPLATE_SPECIALIZATION
IC bool _associative_vector_compare_predicate::operator()(
    const _key_type& lhs,
    const _key_type& rhs ) const {
