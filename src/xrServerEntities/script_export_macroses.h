...
#define DEFINE_LUABIND_CLASS_WRAPPER_3( type, wrapper, name, base1, base2, \
                                        base3 )                            \
    luabind::class_< type, bases< base1, base2, base3 >, wrapper >( name )

#define DEFINE_LUABIND_CLASS_WRAPPER_4( type, wrapper, name, base1, base2, \
                                        base3, base4 )                     \
    luabind::class_< type, bases< base1, base2, base3, base4 >, wrapper >( \
        name )
...
#define CAST_FAILED( v_func_name, ret_type )                              \
        ...
        ai().script_engine().script_log(                                  \
            ...
            "SCRIPT RUNTIME ERROR : luabind::cast_failed in function %s " \
            "(%s)!",                                                      \
