...
#define _associative_vector \
    associative_vector< _key_type, _data_type, _compare_predicate_type >
...
IC _associative_vector::associative_vector( _iterator_type first,
                                            _iterator_type last,
...
TEMPLATE_SPECIALIZATION
IC typename _associative_vector::const_iterator _associative_vector::begin()
    const {
    actualize();
    return ( inherited::begin() );
}
...
TEMPLATE_SPECIALIZATION
IC typename _associative_vector::const_iterator _associative_vector::end()
    const {
    actualize();
    return ( inherited::end() );
}
...
TEMPLATE_SPECIALIZATION
IC typename _associative_vector::reverse_iterator
_associative_vector::rbegin() {
    actualize();
...
TEMPLATE_SPECIALIZATION
IC typename _associative_vector::const_reverse_iterator
_associative_vector::rbegin() const {
    actualize();
    return ( inherited::rbegin() );
}
...
TEMPLATE_SPECIALIZATION
IC typename _associative_vector::const_reverse_iterator
_associative_vector::rend() const {
    actualize();
    return ( inherited::rend() );
}
...
TEMPLATE_SPECIALIZATION
IC typename _associative_vector::size_type _associative_vector::max_size()
    const {
...
TEMPLATE_SPECIALIZATION
IC typename _associative_vector::allocator_type
_associative_vector::get_allocator() const {
    return ( inherited::get_allocator() );
}

TEMPLATE_SPECIALIZATION
IC typename _associative_vector::mapped_type& _associative_vector::operator[](
    const key_type& key ) {
    iterator I = find( key );
    if ( I != end() )
        return ( ( *I ).second );
...
TEMPLATE_SPECIALIZATION
IC typename _associative_vector::key_compare _associative_vector::key_comp()
    const {
    return ( key_compare() );
}

TEMPLATE_SPECIALIZATION
IC typename _associative_vector::value_compare _associative_vector::value_comp()
    const {
...
TEMPLATE_SPECIALIZATION
IC typename _associative_vector::size_type _associative_vector::erase(
    const key_type& key ) {
    iterator I = find( key );
    if ( I == end() )
        return ( 0 );
...
TEMPLATE_SPECIALIZATION
IC typename _associative_vector::iterator _associative_vector::lower_bound(
    const key_type& key ) {
    actualize();
...
TEMPLATE_SPECIALIZATION
IC typename _associative_vector::const_iterator
_associative_vector::lower_bound( const key_type& key ) const {
    actualize();
...
TEMPLATE_SPECIALIZATION
IC typename _associative_vector::iterator _associative_vector::upper_bound(
    const key_type& key ) {
    actualize();
    value_compare& self = *this;
...
TEMPLATE_SPECIALIZATION
IC typename _associative_vector::const_iterator
_associative_vector::upper_bound( const key_type& key ) const {
    actualize();
    const value_compare& self = *this;
    return ( std::upper_bound( begin(), end(), key, self ) );
}
...
TEMPLATE_SPECIALIZATION
IC typename _associative_vector::insert_result _associative_vector::insert(
...
TEMPLATE_SPECIALIZATION
IC typename _associative_vector::iterator _associative_vector::insert(
    iterator where,
    const value_type& value ) {
    if ( ( where != end() ) && ( this->operator()( *where, value ) ) &&
         ( ( where - begin() ) == size() ) &&
         ( !this->operator()( value, *( where + 1 ) ) ) &&
         ( this->operator()( *( where + 1 ), value ) ) )
...
IC void _associative_vector::insert( _iterator_type first,
                                     _iterator_type last ) {
...
TEMPLATE_SPECIALIZATION
IC typename _associative_vector::iterator _associative_vector::find(
    const key_type& key ) {
    actualize();
...
TEMPLATE_SPECIALIZATION
IC typename _associative_vector::const_iterator _associative_vector::find(
...
TEMPLATE_SPECIALIZATION
IC typename _associative_vector::size_type _associative_vector::count(
    const key_type& key ) const {
    actualize();
...
TEMPLATE_SPECIALIZATION
IC typename _associative_vector::equal_range_result
_associative_vector::equal_range( const key_type& key ) {
    actualize();
    iterator I = lower_bound( key );
    if ( I == end() )
    ...
    VERIFY( !this->operator()( key, ( *I ).first ) );
    return ( equal_range_result( I, I + 1 ) );
}

TEMPLATE_SPECIALIZATION
IC typename _associative_vector::const_equal_range_result
_associative_vector::equal_range( const key_type& key ) const {
    actualize();
    const_iterator I = lower_bound( key );
    if ( I == end() )
...
TEMPLATE_SPECIALIZATION
IC typename _associative_vector::self_type& _associative_vector::operator=(
