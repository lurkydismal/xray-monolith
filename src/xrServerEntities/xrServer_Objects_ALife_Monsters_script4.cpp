...
void current_level_travel_speed2( CSE_ALifeMonsterAbstract* self,
                                  float travel_speed ) {
    self->m_fCurrentLevelGoingSpeed = travel_speed;
}

void ForceSetGoodwill( CSE_ALifeMonsterAbstract* self,
                       int goodwill,
                       ALife::_OBJECT_ID pWhoToSet ) {
...
void CSE_ALifeMonsterAbstract::script_register( lua_State* L ) {
    module( L )
        [ luabind_class_monster2(
              CSE_ALifeMonsterAbstract, "cse_alife_monster_abstract",
              ...
              .def_readwrite( "m_smart_terrain_id",
                              &CSE_ALifeMonsterAbstract::m_smart_terrain_id )
              .def( "clear_smart_terrain", &clear_smart_terrain )
              .def( "brain", &monster_brain )
              .def( "rank", &CSE_ALifeMonsterAbstract::Rank )
              .def( "smart_terrain_task_activate",
                    &smart_terrain_task_activate )
              .def( "smart_terrain_task_deactivate",
...
void CSE_ALifeHumanAbstract::script_register( lua_State* L ) {
    module( L )[ luabind_class_monster2(
                     CSE_ALifeHumanAbstract, "cse_alife_human_abstract",
...
void CSE_ALifePsyDogPhantom::script_register( lua_State* L ) {
    module( L )[ luabind_class_monster1( CSE_ALifePsyDogPhantom,
