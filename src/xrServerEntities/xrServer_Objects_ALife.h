...
public:
    CSE_ALifeGroupTemplate( LPCSTR caSection )
        : __A( pSettings->line_exist( caSection, "monster_section" )
...
virtual bool redundant() const;
void attach( CSE_ALifeInventoryItem* tpALifeInventoryItem,
             bool bALifeRequest,
             bool bAddChildren = true );
void detach( CSE_ALifeInventoryItem* tpALifeInventoryItem,
             ALife::OBJECT_IT* I = 0,
             bool bALifeRequest = true,
...
SERVER_ENTITY_DECLARE_BEGIN2( CSE_ALifePHSkeletonObject,
...
SERVER_ENTITY_DECLARE_BEGIN2( CSE_ALifeSpaceRestrictor,
                              CSE_ALifeDynamicObject,
                              CSE_Shape )
...
SERVER_ENTITY_DECLARE_BEGIN2( CSE_ALifeObjectPhysic,
                              CSE_ALifeDynamicObjectVisual,
                              CSE_PHSkeleton )
u32 type;
f32 mass;
...
SERVER_ENTITY_DECLARE_BEGIN2( CSE_ALifeObjectHangingLamp,
                              CSE_ALifeDynamicObjectVisual,
                              CSE_PHSkeleton )
...
#ifdef PROJECTOR_NEW
SERVER_ENTITY_DECLARE_BEGIN2( CSE_ALifeObjectProjector,
                              CSE_ALifeDynamicObjectVisual,
                              CSE_PHSkeleton )
#else
SERVER_ENTITY_DECLARE_BEGIN( CSE_ALifeObjectProjector,
                             CSE_ALifeDynamicObjectVisual )
#endif
...
SERVER_ENTITY_DECLARE_BEGIN3( CSE_ALifeHelicopter,
                              CSE_ALifeDynamicObjectVisual,
                              CSE_Motion,
                              CSE_PHSkeleton )
...
SERVER_ENTITY_DECLARE_BEGIN2( CSE_ALifeCar,
                              CSE_ALifeDynamicObjectVisual,
                              CSE_PHSkeleton )
...
SERVER_ENTITY_DECLARE_BEGIN( CSE_ALifeObjectBreakable,
                             CSE_ALifeDynamicObjectVisual )
float m_health;
...
SERVER_ENTITY_DECLARE_BEGIN2( CSE_ALifeObjectClimable,
                              CSE_Shape,
                              CSE_ALifeDynamicObject )
...
SERVER_ENTITY_DECLARE_BEGIN( CSE_ALifeMountedWeapon,
                             CSE_ALifeDynamicObjectVisual )
...
SERVER_ENTITY_DECLARE_BEGIN2( CSE_ALifeStationaryMgun,
                              CSE_ALifeDynamicObjectVisual,
                              CSE_PHSkeleton )
#else
SERVER_ENTITY_DECLARE_BEGIN( CSE_ALifeStationaryMgun,
                             CSE_ALifeDynamicObjectVisual )
#endif
bool m_bWorking;
...
SERVER_ENTITY_DECLARE_BEGIN( CSE_ALifeInventoryBox,
                             CSE_ALifeDynamicObjectVisual )
bool m_can_take;
bool m_closed;
