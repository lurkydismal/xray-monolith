...
struct CLoader {
    ...
    struct CHelper {
        ...
        IC static void load_data( T& data, M& stream, const P& p ) {
            CHelper1< T >::load_data<
                object_type_traits::is_base_and_derived_or_same_from_template<
                    IPureLoadableObject, T >::value >( data, stream, p );
        }
        ...
        IC static void load_data< true >( T& data, M& stream, const P& p ) {
            CLoader< M, P >::load_data(
                *( data = xr_new<
                       object_type_traits::remove_pointer< T >::type >() ),
                stream, p );
        }
    };
    ...
    struct CHelper3 {
        ...
        template < typename T1, typename T2 >
        IC static void add( T1& data, T2& value ) {
            add_helper< T1, T2 >::add< is_tree_structure< T1 >::value >(
                data, value );
        }
    ...
    struct CHelper4 {
        ...
        IC static void load_data( T& data, M& stream, const P& p ) {
            CHelper< T >::load_data<
                object_type_traits::is_pointer< T >::value >( data, stream, p );
        }
