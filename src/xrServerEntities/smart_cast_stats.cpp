...
//		IC	bool	operator()	(const CStats &_1, const CStats
//&_2) const
//		{
//			return					(_1.m_count <
//_2.m_count);
...
// #endif
//
// IC	void CSmartCastStats::add					(LPCSTR
// from, LPCSTR to)
//{
...
//	if (m_stats.empty()) {
//		Msg
//("CONGRATULATIONS : SmartCast stats is empty!!!"); 		return;
//	}
//
//	m_temp.clear						();
//	m_temp.insert
...
//
//	Msg
//("SmartCast stats (different %d, total %d) : ",(u32)m_stats.size(),total);
//
