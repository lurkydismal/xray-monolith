...
protected:
    struct CObjectItemPredicate {
        IC bool operator()( const CObjectItemAbstract* item1,
                            const CObjectItemAbstract* item2 ) const;
        IC bool operator()( const CObjectItemAbstract* item,
...
#else
    IC const CObjectItemAbstract* item( const CLASS_ID& clsid,
...
public:
    ...
    IC SERVER_BASE_CLASS* server_object( const CLASS_ID& clsid,
    ...
    void register_script_class( LPCSTR client_class,
                                LPCSTR server_class,
                                LPCSTR clsid,
                                LPCSTR script_clsid );
    void register_script_class( LPCSTR unknown_class,
                                LPCSTR clsid,
                                LPCSTR script_clsid );
