...
static luabind::internal_string r_file_as_string( const char* path ) {
    ...
    if ( fileIter == nullptr ) {
        lua_pushfstring( ai().script_engine().lua(), "Not found file: %s",
                         path );
    ...
    std::memcpy( result.data(), reader->pointer(),
...
void CScriptReader::script_register( lua_State* L ) {
    module( L )
        [ class_< IReader >( "reader" )
              ...
              .def( "r_float",
                    ( void ( IReader::* )( float& ) )( &IReader::r_float ) )
              .def( "r_u64",
                    ( void ( IReader::* )( u64& ) )( &IReader::r_u64 ) )
              .def( "r_s64",
                    ( void ( IReader::* )( s64& ) )( &IReader::r_s64 ) )
              .def( "r_u32",
                    ( void ( IReader::* )( u32& ) )( &IReader::r_u32 ) )
              .def( "r_s32",
                    ( void ( IReader::* )( s32& ) )( &IReader::r_s32 ) )
              .def( "r_u16",
                    ( void ( IReader::* )( u16& ) )( &IReader::r_u16 ) )
              .def( "r_s16",
                    ( void ( IReader::* )( s16& ) )( &IReader::r_s16 ) )
