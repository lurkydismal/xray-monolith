...
void section_for_each( CScriptIniFile* self,
...
bool r_line( CScriptIniFile* self,
             LPCSTR S,
             int L,
             ::luabind::internal_string& N,
             ::luabind::internal_string& V ) {
...
int get_modded_exes_version() {
    LPCSTR month_id[ 12 ] = { "Jan", "Feb", "Mar", "Apr", "May", "Jun",
...
void CScriptIniFile::script_register( lua_State* L ) {
    ...
    // Alundaio: Extend script ini file
              ...
              .def( "dltx_get_filename_of_line",
                    &CScriptIniFile::DLTX_getFilenameOfLine )
