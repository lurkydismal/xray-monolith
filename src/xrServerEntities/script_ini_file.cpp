...
CScriptIniFile::CScriptIniFile( LPCSTR szFileName,
                                BOOL ReadOnly,
                                BOOL bLoadAtStart,
                                BOOL SaveAtEnd,
                                LPCSTR path )
    : inherited( path ? path : update( szFileName ),
                 ReadOnly,
                 bLoadAtStart,
                 SaveAtEnd ) {}
...
int CScriptIniFile::r_token( LPCSTR S,
                             LPCSTR L,
                             const CScriptTokenList& token_list ) {
...
void CScriptIniFile::w_fcolor( LPCSTR S,
                               LPCSTR L,
                               const Fcolor& V,
                               LPCSTR comment ) {
    THROW3( inherited::section_exist( S ), "Cannot find section", S );
...
void CScriptIniFile::w_fvector2( LPCSTR S,
                                 LPCSTR L,
                                 const Fvector2& V,
                                 LPCSTR comment ) {
    THROW3( inherited::section_exist( S ), "Cannot find section", S );
...
void CScriptIniFile::w_fvector3( LPCSTR S,
                                 LPCSTR L,
                                 const Fvector3& V,
                                 LPCSTR comment ) {
    THROW3( inherited::section_exist( S ), "Cannot find section", S );
...
void CScriptIniFile::w_fvector4( LPCSTR S,
                                 LPCSTR L,
                                 const Fvector4& V,
                                 LPCSTR comment ) {
    THROW3( inherited::section_exist( S ), "Cannot find section", S );
