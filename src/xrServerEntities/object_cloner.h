...
struct CCloner {
    ...
    struct CHelper {
        ...
        IC static void clone( const T& _1, T& _2 ) {
            if constexpr ( a ) {
                _2 = xr_new<
                    typename object_type_traits::remove_pointer< T >::type >(
                    *_1 );
                CCloner::clone( *_1, *_2 );
            } else {
                _2 = _1;
    ...
    IC static void clone( const std::pair< T1, T2 >& _1,
                          std::pair< T1, T2 >& _2 ) {
        clone( const_cast< object_type_traits::remove_const< T1 >::type& >(
                   _1.first ),
    ...
    IC static void clone( const svector< T, size >& _1,
                          svector< T, size >& _2 ) {
        _2.resize( _1.size() );
    ...
    template < typename T1, typename T2 >
    IC static void clone( const std::queue< T1, T2 >& __1,
                          std::queue< T1, T2 >& __2 ) {
    ...
    template < template < typename _1, typename _2, typename _3 > class T1,
               ...
               typename T3,
               typename T4 >
    IC static void clone( const T1< T2, T3, T4 >& __1,
                          T1< T2, T3, T4 >& __2,
                          bool ) {
        T1< T2, T3, T4 > _1 = __1;
        T1< T2, T3, T4 > _2;
    ...
    template < typename T1, typename T2 >
    IC static void clone( const xr_stack< T1, T2 >& _1,
                          xr_stack< T1, T2 >& _2 ) {
        return ( clone( _1, _2, true ) );
    }

    template < typename T1, typename T2, typename T3 >
    IC static void clone( const std::priority_queue< T1, T2, T3 >& _1,
                          std::priority_queue< T1, T2, T3 >& _2 ) {
        return ( clone( _1, _2, true ) );
    }

    struct CHelper3 {
        template < template < typename _1 > class T1, typename T2 >
        IC static void add( T1< T2 >& data,
                            typename T1< T2 >::value_type& value ) {
    ...
    struct CHelper4 {
        ...
        IC static void clone( const T& _1, T& _2 ) {
            if constexpr ( a ) {
                ...
                CHelper< T >::template clone<
                    object_type_traits::is_pointer< T >::value >( _1, _2 );
            }
        }
    };
