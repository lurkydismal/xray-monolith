...
#define CLSID_OBJECT_PROJECTOR \
    MK_CLSID( 'O', '_', 'S', 'E', 'A', 'R', 'C', 'H' )
...
#define CLSID_AI_DOG_PSY_PHANTOM \
    MK_CLSID( 'A', 'I', '_', 'D', 'O', 'G', '_', 'F' )
...
#define CLSID_VEHICLE_HELICOPTER \
    MK_CLSID( 'C', '_', 'H', 'L', 'C', 'P', 'T', 'R' )
...
#define CLSID_AF_ELECTRIC_BALL \
    MK_CLSID( 'A', 'F', '_', 'E', 'B', 'A', 'L', 'L' )
...
#define CLSID_OBJECT_W_BINOCULAR \
    MK_CLSID( 'W', '_', 'B', 'I', 'N', 'O', 'C', ' ' )
#define CLSID_OBJECT_W_SHOTGUN \
    MK_CLSID( 'W', '_', 'S', 'H', 'O', 'T', 'G', 'N' )
#define CLSID_OBJECT_W_ASHOTGUN \
    MK_CLSID( 'W', '_', 'A', 'S', 'H', 'T', 'G', 'N' )
//  [8/15/2006]
#define CLSID_OBJECT_W_MAGAZINED \
    MK_CLSID( 'W', '_', 'W', 'M', 'A', 'G', 'A', 'Z' )
//  [8/15/2006]
//  [8/17/2006]
#define CLSID_OBJECT_W_MAGAZWGL \
    MK_CLSID( 'W', '_', 'W', 'M', 'A', 'G', 'G', 'L' )
//  [8/17/2006]
...
#define CLSID_OBJECT_W_VINTOREZ \
    MK_CLSID( 'W', '_', 'V', 'I', 'N', 'T', ' ', ' ' )
#define CLSID_OBJECT_W_WALTHER \
    MK_CLSID( 'W', '_', 'W', 'A', 'L', 'T', 'H', 'R' )
...
#define CLSID_OBJECT_W_STATMGUN \
    MK_CLSID( 'W', '_', 'S', 'T', 'M', 'G', 'U', 'N' )
// Weapons Ammo
...
#define CLSID_OBJECT_W_SILENCER \
    MK_CLSID( 'W', '_', 'S', 'I', 'L', 'E', 'N', 'C' )
#define CLSID_OBJECT_W_GLAUNCHER \
    MK_CLSID( 'W', '_', 'G', 'L', 'A', 'U', 'N', 'C' )

// Modifiers
#define CLSID_OBJECT_M_QDAMAGE \
    MK_CLSID( 'O', '_', 'Q', 'D', 'M', 'G', ' ', ' ' )
#define CLSID_OBJECT_M_IMMORTAL \
    MK_CLSID( 'O', '_', 'I', 'M', 'M', 'O', 'R', 'T' )
...
#define CLSID_OBJECT_BREAKABLE \
    MK_CLSID( 'O', '_', 'B', 'R', 'K', 'B', 'L', ' ' )
#define CLSID_OBJECT_CLIMABLE MK_CLSID( 'O', '_', 'C', 'L', 'M', 'B', 'L', ' ' )
#define CLSID_OBJECT_HOLDER_ENT \
    MK_CLSID( 'O', '_', 'H', 'L', 'D', 'R', '_', 'E' )
//
#define CLSID_PH_SKELETON_OBJECT \
    MK_CLSID( 'P', '_', 'S', 'K', 'E', 'L', 'E', 'T' )
#define CLSID_OBJECT_PHYSIC MK_CLSID( 'O', '_', 'P', 'H', 'Y', 'S', 'I', 'C' )
#define CLSID_PHYSICS_DESTROYABLE \
    MK_CLSID( 'P', '_', 'D', 'S', 'T', 'R', 'B', 'L' )
...
#define CLSID_SPACE_RESTRICTOR \
    MK_CLSID( 'S', 'P', 'A', 'C', 'E', '_', 'R', 'S' )
...
#define CLSID_DETECTOR_ADVANCED \
    MK_CLSID( 'D', '_', 'A', 'D', 'V', 'A', 'N', 'C' )
#define CLSID_DETECTOR_ELITE MK_CLSID( 'D', '_', 'E', 'L', 'I', 'T', 'E', ' ' )
#define CLSID_DETECTOR_SCIENTIFIC \
    MK_CLSID( 'D', '_', 'S', 'C', 'I', 'E', 'N', 'T' )
#define CLSID_DEVICE_DOSIMETER \
    MK_CLSID( 'D', '_', 'D', 'S', 'M', 'E', 'T', 'R' )
...
#define CLSID_DEVICE_AF_MERGER \
    MK_CLSID( 'D', '_', 'A', 'F', 'M', 'E', 'R', 'G' )
#define CLSID_DEVICE_FLARE MK_CLSID( 'D', '_', 'F', 'L', 'A', 'R', 'E', ' ' )
#define CLSID_DEVICE_FLASHLIGHT \
    MK_CLSID( 'D', '_', 'F', 'L', 'A', 'L', 'I', 'T' )
...
//---------------------------------------------------------------------------------
#define CLSID_OBJECT_PLAYERS_BAG \
    MK_CLSID( 'M', 'P', '_', 'P', 'L', 'B', 'A', 'G' )
//---------------------------------------------------------------------------------

// Equipment
#define CLSID_EQUIPMENT_SIMPLE \
    MK_CLSID( 'E', 'Q', 'U', '_', 'S', 'M', 'P', 'L' )
#define CLSID_EQUIPMENT_SCIENTIFIC \
    MK_CLSID( 'E', 'Q', 'U', '_', 'S', 'C', 'I', 'E' )
#define CLSID_EQUIPMENT_STALKER \
    MK_CLSID( 'E', 'Q', 'U', '_', 'S', 'T', 'L', 'K' )
#define CLSID_EQUIPMENT_MILITARY \
    MK_CLSID( 'E', 'Q', 'U', '_', 'M', 'L', 'T', 'R' )
#define CLSID_EQUIPMENT_EXO MK_CLSID( 'E', 'Q', 'U', '_', 'E', 'X', 'O', ' ' )
#define CLSID_EQUIPMENT_HELMET \
    MK_CLSID( 'E', 'Q', '_', 'H', 'L', 'M', 'E', 'T' )
#define CLSID_EQUIPMENT_BACKPACK \
    MK_CLSID( 'E', 'Q', '_', 'B', 'A', 'K', 'P', 'K' )

// Game types
#define CLSID_SV_GAME_SINGLE MK_CLSID( 'S', 'V', '_', 'S', 'I', 'N', 'G', 'L' )
#define CLSID_SV_GAME_DEATHMATCH \
    MK_CLSID( 'S', 'V', '_', 'D', 'M', ' ', ' ', ' ' )
#define CLSID_SV_GAME_TEAMDEATHMATCH \
    MK_CLSID( 'S', 'V', '_', 'T', 'D', 'M', ' ', ' ' )
#define CLSID_SV_GAME_ARTEFACTHUNT \
    MK_CLSID( 'S', 'V', '_', 'A', 'H', 'U', 'N', 'T' )
#define CLSID_SV_GAME_CAPTURETHEARTEFACT \
    MK_CLSID( 'S', 'V', '_', 'C', 'T', 'A', ' ', ' ' )
// #define CLSID_GAME_CS
// MK_CLSID('S','V','_','C','S',' ',' ',' ')
#define CLSID_CL_GAME_SINGLE MK_CLSID( 'C', 'L', '_', 'S', 'I', 'N', 'G', 'L' )
#define CLSID_CL_GAME_DEATHMATCH \
    MK_CLSID( 'C', 'L', '_', 'D', 'M', ' ', ' ', ' ' )
#define CLSID_CL_GAME_TEAMDEATHMATCH \
    MK_CLSID( 'C', 'L', '_', 'T', 'D', 'M', ' ', ' ' )
#define CLSID_CL_GAME_ARTEFACTHUNT \
    MK_CLSID( 'C', 'L', '_', 'A', 'H', 'U', 'N', 'T' )
#define CLSID_CL_GAME_CAPTURETHEARTEFACT \
    MK_CLSID( 'C', 'L', '_', 'C', 'T', 'A', ' ', ' ' )

// Game UI types
#define CLSID_GAME_UI_SINGLE MK_CLSID( 'U', 'I', '_', 'S', 'I', 'N', 'G', 'L' )
#define CLSID_GAME_UI_DEATHMATCH \
    MK_CLSID( 'U', 'I', '_', 'D', 'M', ' ', ' ', ' ' )
#define CLSID_GAME_UI_TEAMDEATHMATCH \
    MK_CLSID( 'U', 'I', '_', 'T', 'D', 'M', ' ', ' ' )
#define CLSID_GAME_UI_ARTEFACTHUNT \
    MK_CLSID( 'U', 'I', '_', 'A', 'H', 'U', 'N', 'T' )
#define CLSID_GAME_UI_CAPTURETHEARTEFACT \
    MK_CLSID( 'U', 'I', '_', 'C', 'T', 'A', ' ', ' ' )

#define CLSID_ONLINE_OFFLINE_GROUP \
    MK_CLSID( 'O', 'N', '_', 'O', 'F', 'F', '_', 'G' )
