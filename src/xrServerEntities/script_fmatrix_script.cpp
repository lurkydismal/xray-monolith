...
void CScriptFmatrix::script_register( lua_State* L ) {
    module( L )
        [ class_< Fmatrix >( "matrix" )
              ...
              .def( "set",
                    ( Fmatrix &
                      ( Fmatrix::* )( const Fmatrix& ))( &Fmatrix::set ),
                    return_reference_to< 1 >() )
              .def(
                  "set",
                  ( Fmatrix & ( Fmatrix::* )( const Fvector&, const Fvector&,
              ...
              .def( "translate",
                    ( Fmatrix & ( Fmatrix::* )( float, float, float ))(
                        &Fmatrix::translate ),
                    return_reference_to< 1 >() )
              .def( "translate",
                    ( Fmatrix &
              ...
              .def( "translate_add",
                    ...
                    return_reference_to< 1 >() )
              .def( "translate_add",
                    ( Fmatrix & ( Fmatrix::* )( const Fvector& ))(
                        &Fmatrix::translate_add ),
                    return_reference_to< 1 >() )
              .def( "translate_over",
                    ( Fmatrix & ( Fmatrix::* )( float, float, float ))(
                        &Fmatrix::translate_over ),
                    return_reference_to< 1 >() )
              .def( "translate_over",
                    ( Fmatrix & ( Fmatrix::* )( const Fvector& ))(
                        &Fmatrix::translate_over ),
                    return_reference_to< 1 >() )
              .def( "transform",
                    ( void ( Fmatrix::* )( Fvector&, const Fvector& )
              ...
              .def( "transform_tiny", ( void ( Fmatrix::* )( Fvector& ) const )(
                                          &Fmatrix::transform_tiny ) )
              .def( "transform_dir",
                    ( void ( Fmatrix::* )( Fvector&, const Fvector& )
                          const )( &Fmatrix::transform_dir ) )
              .def( "transform_dir", ( void ( Fmatrix::* )( Fvector& )
                                           const )( &Fmatrix::transform_dir ) )
              .def(
                  "mul",
                  ( Fmatrix & ( Fmatrix::* )( const Fmatrix&, const Fmatrix& ))(
                      &Fmatrix::mul ),
                  return_reference_to< 1 >() )
              .def( "mul",
                    ( Fmatrix &
                      ( Fmatrix::* )( const Fmatrix&, float ))( &Fmatrix::mul ),
                    return_reference_to< 1 >() )
              .def( "mul",
                    ( Fmatrix & ( Fmatrix::* )( float ))( &Fmatrix::mul ),
                    return_reference_to< 1 >() )
              .def( "invert",
                    ( Fmatrix & ( Fmatrix::* )() )( &Fmatrix::invert ),
                    return_reference_to< 1 >() )
              .def( "invert",
                    ( Fmatrix &
                      ( Fmatrix::* )( const Fmatrix& ))( &Fmatrix::invert ),
                    return_reference_to< 1 >() )
              .def( "invert_b", &Fmatrix::invert_b, return_reference_to< 1 >() )
              .def( "div",
                    ( Fmatrix &
                      ( Fmatrix::* )( const Fmatrix&, float ))( &Fmatrix::div ),
                    return_reference_to< 1 >() )
              .def( "div",
                    ( Fmatrix & ( Fmatrix::* )( float ))( &Fmatrix::div ),
                    return_reference_to< 1 >() )
              .def( "scale",
                    ( Fmatrix &
              ...
              .def( "scale",
                    ( Fmatrix &
                      ( Fmatrix::* )( const Fvector& ))( &Fmatrix::scale ),
                    return_reference_to< 1 >() )
              .def( "setHPB",
                    ( Fmatrix & ( Fmatrix::* )( float, float, float ))(
                        &Fmatrix::setHPB ),
              ...
              .def( "setHPB",
                    ( Fmatrix &
                      ( Fmatrix::* )( const Fvector& ))( &Fmatrix::setHPB ),
                    return_reference_to< 1 >() )
              .def( "setXYZ",
                    ( Fmatrix & ( Fmatrix::* )( float, float, float ))(
                        &Fmatrix::setXYZ ),
              ...
              .def( "setXYZ",
                    ( Fmatrix &
                      ( Fmatrix::* )( const Fvector& ))( &Fmatrix::setXYZ ),
                    return_reference_to< 1 >() )
              .def( "setXYZi",
                    ( Fmatrix & ( Fmatrix::* )( float, float, float ))(
                        &Fmatrix::setXYZi ),
              ...
              .def( "setXYZi",
                    ( Fmatrix &
                      ( Fmatrix::* )( const Fvector& ))( &Fmatrix::setXYZi ),
                    return_reference_to< 1 >() )
              .def( "getHPB", &get_matrix_hpb )
              .def( "hud_to_world", &Fmatrix::hud_to_world,
                    return_reference_to< 1 >() )
              .def( "world_to_hud", &Fmatrix::world_to_hud,
                    return_reference_to< 1 >() ) ];
}
