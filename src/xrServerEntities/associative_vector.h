...
class associative_vector
    : protected xr_vector< std::pair< _key_type, _data_type > >,
      protected associative_vector_compare_predicate<
          _key_type,
          _data_type,
          _compare_predicate_type > {
private:
    typedef associative_vector< _key_type, _data_type, _compare_predicate_type >
        self_type;

    using inherited = xr_vector< std::pair< _key_type, _data_type > >;

public:
    typedef associative_vector_compare_predicate< _key_type,
                                                  _data_type,
                                                  _compare_predicate_type >
        value_compare;
...
public:
    ...
    IC associative_vector( _iterator_type first,
                           _iterator_type last,
...
IC void swap(
    associative_vector< _key_type, _data_type, _compare_predicate_type >& left,
