...
void tonemap( out half4 low, out half4 high, half3 rgb, half scale ) {
    ...
    if ( HDR10_IS_ENABLED ) {
        ...
        low = half4(
            ( ( rgb * ( 1 + rgb / fWhiteIntensitySQR ) ) / ( rgb + 1 ) ), 0 );
        high = half4( rgb / def_hdr, 0 );
    }
}

float3 compute_colored_ao(
    float ao,
    float3
        albedo ) { // https://www.activision.com/cdn/research/s2016_pbs_activision_occlusion.pptx
...
float2 unpack_tc_base( float2 tc, float du, float dv ) {
    return ( tc.xy + float2( du, dv ) ) *
           ( 32.0 / 32768.0 ); //! Increase from 32bit to 64bit floating point
}
...
float3 calc_model_lq_lighting( float3 norm_w ) {
    return L_material.x * calc_model_hemi_r1( norm_w ) + L_ambient +
...
float hash( float2 intro ) {
    return frac( 1.0e4 * sin( 17.0 * intro.x + 0.1 * intro.y ) *
...
float noise( float2 tc ) {
    return frac( sin( dot( tc, float2( 12.0, 78.0 ) + ( timers.x ) ) ) *
                 43758.0 ) *
           0.25f;
}
...
#if ( defined( MSAA_ALPHATEST_DX10_1_ATOC ) || \
...
uint alpha_to_coverage( float alpha, float2 pos2d ) {
    ...
    if ( alpha < 0.4444 ) {
        if ( alpha < 0.2222 ) {
            ...
            if ( alpha <
                 0.3333 ) // 2 bits set0=> 10000001 + 11000000 .. 00000011 : 8
                          // // 0.2222
                          //        set1=> 10100000 .. 00000101 + 10000010 +
                          //        01000001 : 8
                          //		set2=> 10010000 .. 00001001 + 10000100 +
                          // 01000010 + 00100001 : 8 		set3=> 10001000
                          // .. 00010001
                          //+ 10001000 + 01000100 + 00100010 + 00010001 : 8
            {
                mask = 3;
            } else // 3 bits set0 => 11100000 .. 00000111 + 10000011 + 11000001
                   // : 8 ? 0.4444 // 0.3333
                   //        set1 => 10110000 .. 00001011 + 10000101 + 11000010
                   //        + 01100001: 8 set2 => 11010000 .. 00001101 +
                   //        10000110 + 01000011 + 10100001: 8 set3 => 10011000
                   //        .. 00010011 + 10001001 + 11000100 + 01100010 +
                   //        00110001 : 8 set4 => 11001000 .. 00011001 +
                   //        10001100 + 01000110 + 00100011 + 10010001 : 8
            {
                mask = 0x7;
            }
        }
        ...
        if ( alpha < 0.6666 ) {
            if ( alpha <
                 0.5555 ) // 4 bits set0 => 11110000 .. 00001111 + 10000111 +
                          // 11000011 + 11100001 : 8 // 0.5555
                          //        set1 => 11011000 .. 00011011 + 10001101 +
                          //        11000110 + 01100011 + 10110001 : 8 set2 =>
                          //        11001100 .. 00110011 + 10011001 : 4 make 8
                          //        set3 => 11000110 + 01100011 + 10110001 +
                          //        11011000 + 01101100 + 00110110 + 00011011 +
                          //        10001101 : 8 set4 => 10111000 .. 00010111 +
                          //        10001011 + 11000101 + 11100010 + 01110001 :
                          //        8 set5 => 10011100 .. 00100111 + 10010011 +
                          //        11001001 + 11100100 + 01110010 + 00111001 :
                          //        8 set6 => 10101010 .. 01010101 : 2 make 8
                          //        set7 => 10110100 +  01011010 + 00101101 +
                          //        10010110 + 01001011 + 10100101 + 11010010 +
                          //        01101001 : 8 set8 => 10011010 +  01001101 +
                          //        10100110 + 01010011 + 10101001 + 11010100 +
                          //        01101010 + 00110101 : 8
            {
                mask = 0xf;
            } else // 5 bits set0 => 11111000 01111100 00111110 00011111
                   // 10001111 11000111 11100011 11110001 : 8  // 0.6666
                   //        set1 => 10111100 : 8
                   //        set2 => 10011110 : 8
                   //        set3 => 11011100 : 8
                   //        set4 => 11001110 : 8
            ...
            if ( alpha <
                 0.7777 ) // 6 bits set0 => 11111100 01111110 00111111 10011111
                          // 11001111 11100111 11110011 11111001 : 8
                          //        set1 => 10111110 : 8
                          //        set2 => 11011110 : 8
            {
                mask = 0x3F;
