...
typedef enum {
    ...
    /**Chroma decimation by 2 in the X direction (4:2:2).
       The Cb and Cr chroma planes are half the width of the luma plane, but
       full height.*/
    TH_PF_422,
...
typedef struct {
     ...
     *  but it cannot be set larger than the amount permitted by this field
     * after the headers have been output.*/
...
extern void th_comment_add_tag( th_comment* _tc,
                                const char* _tag,
                                const char* _val );
