...
#define OC_LOOP_FILTER_V_MMX( _pix, _ystride, _ll )                          \
    do {                                                                     \
        /*Used local variable pix__ in order to fix compilation errors like: \
           "error C2425: 'SHL' : non-constant expression in 'second          \
           operand'".*/                                                      \
        unsigned char* pix__;                                                \
        unsigned char* ll__;                                                 \
        ll__ = ( _ll );                                                      \
        pix__ = ( _pix );                                                    \
        __asm mov YSTRIDE, _ystride __asm mov LL, ll__ __asm mov PIX,        \
            pix__ __asm sub PIX, YSTRIDE __asm sub PIX,                      \
            YSTRIDE /*mm0={a0,...,a7}*/                                      \
            __asm movq mm0,                                                  \
            [PIX] /*ystride3=_ystride*3*/                                    \
            __asm lea YSTRIDE3,                                              \
            [YSTRIDE + YSTRIDE * 2] /*mm3={d0,...,d7}*/                      \
            __asm movq mm3,                                                  \
            [PIX + YSTRIDE3] /*mm1={b0,...,b7}*/                             \
            __asm movq mm1,                                                  \
            [PIX + YSTRIDE] /*mm2={c0,...,c7}*/                              \
            __asm movq mm2,                                                  \
            [PIX + YSTRIDE * 2] OC_LOOP_FILTER8_MMX /*Write it back out.*/   \
            __asm movq[PIX + YSTRIDE],                                       \
            mm1 __asm movq[PIX + YSTRIDE * 2], mm2                           \
    } while ( 0 )
...
#define OC_LOOP_FILTER_H_MMX( _pix, _ystride, _ll )                         \
    do {                                                                    \
        ...
        ll__ = ( _ll );                                                     \
        pix__ = ( _pix ) - 2;                                               \
        __asm mov PIX, pix__ __asm mov YSTRIDE, _ystride __asm mov LL,      \
            ll__ /*x x x x d0 c0 b0 a0*/                                    \
            __asm movd mm0,                                                 \
            [PIX] /*x x x x d1 c1 b1 a1*/                                   \
            __asm movd mm1,                                                 \
            [PIX + YSTRIDE] /*ystride3=_ystride*3*/                         \
            __asm lea YSTRIDE3,                                             \
            [YSTRIDE + YSTRIDE * 2] /*x x x x d2 c2 b2 a2*/                 \
            __asm movd mm2,                                                 \
            [PIX + YSTRIDE * 2] /*x x x x d3 c3 b3 a3*/                     \
            __asm lea D,                                                    \
            [PIX + YSTRIDE * 4] __asm movd mm3,                             \
            [PIX + YSTRIDE3] /*x x x x d4 c4 b4 a4*/                        \
            __asm movd mm4,                                                 \
            [D] /*x x x x d5 c5 b5 a5*/                                     \
            __asm movd mm5,                                                 \
            [D + YSTRIDE] /*x x x x d6 c6 b6 a6*/                           \
            __asm movd mm6,                                                 \
            [D + YSTRIDE * 2] /*x x x x d7 c7 b7 a7*/                       \
            __asm movd mm7,                                                 \
            [D + YSTRIDE3] /*mm0=d1 d0 c1 c0 b1 b0 a1 a0*/                  \
            __asm punpcklbw mm0,                                            \
            mm1 /*mm2=d3 d2 c3 c2 b3 b2 a3 a2*/                             \
            __asm punpcklbw mm2,                                            \
            mm3 /*mm3=d1 d0 c1 c0 b1 b0 a1 a0*/                             \
            __asm movq mm3,                                                 \
            mm0 /*mm0=b3 b2 b1 b0 a3 a2 a1 a0*/                             \
            __asm punpcklwd mm0,                                            \
            mm2 /*mm3=d3 d2 d1 d0 c3 c2 c1 c0*/                             \
            __asm punpckhwd mm3,                                            \
            mm2 /*mm1=b3 b2 b1 b0 a3 a2 a1 a0*/                             \
            __asm movq mm1,                                                 \
            mm0 /*mm4=d5 d4 c5 c4 b5 b4 a5 a4*/                             \
            __asm punpcklbw mm4,                                            \
            mm5 /*mm6=d7 d6 c7 c6 b7 b6 a7 a6*/                             \
            __asm punpcklbw mm6,                                            \
            mm7 /*mm5=d5 d4 c5 c4 b5 b4 a5 a4*/                             \
            __asm movq mm5,                                                 \
            mm4 /*mm4=b7 b6 b5 b4 a7 a6 a5 a4*/                             \
            __asm punpcklwd mm4,                                            \
            mm6 /*mm5=d7 d6 d5 d4 c7 c6 c5 c4*/                             \
            __asm punpckhwd mm5,                                            \
            mm6 /*mm2=d3 d2 d1 d0 c3 c2 c1 c0*/                             \
            __asm movq mm2,                                                 \
            mm3 /*mm0=a7 a6 a5 a4 a3 a2 a1 a0*/                             \
            __asm punpckldq mm0,                                            \
            mm4 /*mm1=b7 b6 b5 b4 b3 b2 b1 b0*/                             \
            __asm punpckhdq mm1,                                            \
            mm4 /*mm2=c7 c6 c5 c4 c3 c2 c1 c0*/                             \
            __asm punpckldq mm2,                                            \
            mm5 /*mm3=d7 d6 d5 d4 d3 d2 d1 d0*/                             \
            __asm punpckhdq mm3,                                            \
            mm5 OC_LOOP_FILTER8_MMX /*mm2={b0+R_0'',...,b7+R_7''}*/         \
            __asm movq mm0,                                                 \
            mm1 /*mm1={b0+R_0'',c0-R_0'',...,b3+R_3'',c3-R_3''}*/           \
            __asm punpcklbw mm1,                                            \
            mm2 /*mm2={b4+R_4'',c4-R_4'',...,b7+R_7'',c7-R_7''}*/           \
            __asm punpckhbw mm0,                                            \
            mm2 /*[d]=c1 b1 c0 b0*/                                         \
            __asm movd D,                                                   \
            mm1 __asm mov[PIX + 1], D_WORD __asm psrlq mm1, 32 __asm shr D, \
            16 __asm mov[PIX + YSTRIDE + 1],                                \
            D_WORD /*[d]=c3 b3 c2 b2*/                                      \
            __asm movd D,                                                   \
            mm1 __asm mov[PIX + YSTRIDE * 2 + 1], D_WORD __asm shr D,       \
            16 __asm mov[PIX + YSTRIDE3 + 1], D_WORD __asm lea PIX,         \
            [PIX + YSTRIDE * 4] /*[d]=c5 b5 c4 b4*/                         \
            __asm movd D,                                                   \
            mm0 __asm mov[PIX + 1], D_WORD __asm psrlq mm0, 32 __asm shr D, \
            16 __asm mov[PIX + YSTRIDE + 1],                                \
            D_WORD /*[d]=c7 b7 c6 b6*/                                      \
            __asm movd D,                                                   \
            mm0 __asm mov[PIX + YSTRIDE * 2 + 1], D_WORD __asm shr D,       \
            16 __asm mov[PIX + YSTRIDE3 + 1], D_WORD                        \
    } while ( 0 )
