...
#define OC_LOOP_FILTER_V_MMX( _pix, _ystride, _ll )                                               \
    do {                                                                                          \
        ...
        __asm__ __volatile__(                           /*mm0={a0,...,a7}*/                       \
                              "movq (%[pix]),%%mm0\n\t" /*ystride3=_ystride*3*/                   \
...
#define OC_LOOP_FILTER_H_MMX( _pix, _ystride, _ll )                                                           \
    do {                                                                                                      \
        ...
        ptrdiff_t d__;                                                                                        \
        pix__ = ( _pix ) - 2;                                                                                 \
        __asm__ __volatile__( /*x x x x d0 c0 b0 a0*/                                                         \
                              "movd (%[pix]),%%mm0\n\t" /*x x x x d1 c1 b1                                    \
                                                           a1*/                                               \
                              ...
                              "punpcklbw %%mm3,%%mm2\n\t" /*mm3=d1 d0 c1 c0 b1                                \
                                                             b0 a1 a0*/                                       \
                              "movq %%mm0,%%mm3\n\t" /*mm0=b3 b2 b1 b0 a3 a2                                  \
                                                        a1 a0*/                                               \
                              "punpcklwd %%mm2,%%mm0\n\t" /*mm3=d3 d2 d1 d0 c3                                \
                                                             c2 c1 c0*/                                       \
                              "punpckhwd %%mm2,%%mm3\n\t" /*mm1=b3 b2 b1 b0 a3                                \
                                                             a2 a1 a0*/                                       \
                              "movq %%mm0,%%mm1\n\t" /*mm4=d5 d4 c5 c4 b5 b4                                  \
                                                        a5 a4*/                                               \
                              "punpcklbw %%mm5,%%mm4\n\t" /*mm6=d7 d6 c7 c6 b7                                \
                                                             b6 a7 a6*/                                       \
                              "punpcklbw %%mm7,%%mm6\n\t" /*mm5=d5 d4 c5 c4 b5                                \
                                                             b4 a5 a4*/                                       \
                              "movq %%mm4,%%mm5\n\t" /*mm4=b7 b6 b5 b4 a7 a6                                  \
                                                        a5 a4*/                                               \
                              "punpcklwd %%mm6,%%mm4\n\t" /*mm5=d7 d6 d5 d4 c7                                \
                                                             c6 c5 c4*/                                       \
                              "punpckhwd %%mm6,%%mm5\n\t" /*mm2=d3 d2 d1 d0 c3                                \
                                                             c2 c1 c0*/                                       \
                              "movq %%mm3,%%mm2\n\t" /*mm0=a7 a6 a5 a4 a3 a2                                  \
                                                        a1 a0*/                                               \
                              "punpckldq %%mm4,%%mm0\n\t" /*mm1=b7 b6 b5 b4 b3                                \
                                                             b2 b1 b0*/                                       \
                              "punpckhdq %%mm4,%%mm1\n\t" /*mm2=c7 c6 c5 c4 c3                                \
                              ...
                              "punpckldq %%mm5,%%mm2\n\t" /*mm3=d7 d6 d5 d4 d3                                \
                                                             d2 d1 d0*/                                       \
                              "punpckhdq %%mm5,%%mm3\n\t" OC_LOOP_FILTER8_MMX /*mm2={b0+R_0'',...,b7+R_7''}*/ \
