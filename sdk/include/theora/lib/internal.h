...
#define TH_VERSION_CHECK( _info, _maj, _min, _sub ) \
    ( ( _info )->version_major > ( _maj ) ||        \
      ( _info )->version_major == ( _maj ) &&       \
          ( ( _info )->version_minor > ( _min ) ||  \
            ( _info )->version_minor == ( _min ) && \
...
#define OC_FRAME_FOR_MODE( _x )                                      \
    OC_UNIBBLE_TABLE32( OC_FRAME_PREV, OC_FRAME_SELF, OC_FRAME_PREV, \
                        OC_FRAME_PREV, OC_FRAME_PREV, OC_FRAME_GOLD, \
                        OC_FRAME_GOLD, OC_FRAME_PREV, ( _x ) )
...
struct oc_base_opt_vtable {
    void ( *frag_copy )( unsigned char* _dst,
                         ...
                         int _ystride );
    void ( *frag_recon_intra )( unsigned char* _dst,
                                int _ystride,
...
void oc_state_fill_buffer_ptrs( oc_theora_state* _state,
                                int _buf_idx,
...
void oc_frag_copy( const oc_theora_state* _state,
                   unsigned char* _dst,
                   const unsigned char* _src,
                   int _ystride );
...
void oc_frag_copy_c( unsigned char* _dst,
                     const unsigned char* _src,
                     int _src_ystride );
void oc_frag_recon_intra_c( unsigned char* _dst,
                            int _dst_ystride,
                            const ogg_int16_t _residue[ 64 ] );
void oc_frag_recon_inter_c( unsigned char* _dst,
                            ...
                            int _ystride,
                            const ogg_int16_t _residue[ 64 ] );
void oc_frag_recon_inter2_c( unsigned char* _dst,
                             const unsigned char* _src1,
                             const unsigned char* _src2,
                             int _ystride,
                             const ogg_int16_t _residue[ 64 ] );
...
typedef int ( *oc_state_control_func )( theora_state* th,
                                        int _req,
                                        void* _buf,
                                        size_t _buf_sz );
