...
#define OC_STATIC_ILOG2( _v )                               \
    ( ( ( _v ) & 0xC ) ? 2 + OC_STATIC_ILOG1( ( _v ) >> 2 ) \
                       : OC_STATIC_ILOG1( _v ) )
#define OC_STATIC_ILOG3( _v )                                \
    ( ( ( _v ) & 0xF0 ) ? 4 + OC_STATIC_ILOG2( ( _v ) >> 4 ) \
                        : OC_STATIC_ILOG2( _v ) )
#define OC_STATIC_ILOG4( _v )                                  \
    ( ( ( _v ) & 0xFF00 ) ? 8 + OC_STATIC_ILOG3( ( _v ) >> 8 ) \
                          : OC_STATIC_ILOG3( _v ) )
#define OC_STATIC_ILOG5( _v )                                        \
    ( ( ( _v ) & 0xFFFF0000 ) ? 16 + OC_STATIC_ILOG4( ( _v ) >> 16 ) \
                              : OC_STATIC_ILOG4( _v ) )
#define OC_STATIC_ILOG6( _v )                    \
    ( ( ( _v ) & 0xFFFFFFFF00000000ULL )         \
          ? 32 + OC_STATIC_ILOG5( ( _v ) >> 32 ) \
          : OC_STATIC_ILOG5( _v ) )
/**
