...
HRESULT WINAPI
D3DX10CreateDeviceAndSwapChain( IDXGIAdapter* pAdapter,
                                D3D10_DRIVER_TYPE DriverType,
                                HMODULE Software,
                                UINT Flags,
...
DECLARE_INTERFACE_( ID3DX10Sprite, IUnknown ) {
    ...
    STDMETHOD( DrawSpritesBuffered )( THIS_ D3DX10_SPRITE * pSprites,
                                      UINT cSprites ) PURE;
    STDMETHOD( Flush )( THIS ) PURE;

    STDMETHOD( DrawSpritesImmediate )( THIS_ D3DX10_SPRITE * pSprites,
                                       UINT cSprites, UINT cbSprite,
                                       UINT flags ) PURE;
    ...
    STDMETHOD( GetProjectionTransform )( THIS_ D3DXMATRIX *
                                         pProjectionTransform ) PURE;
    STDMETHOD( SetProjectionTransform )( THIS_ D3DXMATRIX *
                                         pProjectionTransform ) PURE;
...
DECLARE_INTERFACE_( ID3DX10ThreadPump, IUnknown ) {
    ...
    // ID3DX10ThreadPump
    STDMETHOD( AddWorkItem )( THIS_ ID3DX10DataLoader * pDataLoader,
                              ID3DX10DataProcessor * pDataProcessor,
                              HRESULT * pHResult, void** ppDeviceObject ) PURE;
    ...
    STDMETHOD( GetQueueStatus )( THIS_ UINT * pIoQueue, UINT * pProcessQueue,
...
DECLARE_INTERFACE_( ID3DX10Font, IUnknown ) {
    ...
    STDMETHOD( GetGlyphData )( THIS_ UINT Glyph,
                               ID3D10ShaderResourceView * *ppTexture,
                               RECT * pBlackBox, POINT * pCellInc ) PURE;
    ...
    STDMETHOD_( INT, DrawTextA )( THIS_ LPD3DX10SPRITE pSprite, LPCSTR pString,
                                  INT Count, LPRECT pRect, UINT Format,
                                  D3DXCOLOR Color ) PURE;
    STDMETHOD_( INT, DrawTextW )( THIS_ LPD3DX10SPRITE pSprite, LPCWSTR pString,
                                  INT Count, LPRECT pRect, UINT Format,
                                  D3DXCOLOR Color ) PURE;

#ifdef __cplusplus
#ifdef UNICODE
    HRESULT WINAPI_INLINE GetDesc( D3DX10_FONT_DESCW * pDesc ) {
        return GetDescW( pDesc );
    }
    HRESULT WINAPI_INLINE PreloadText( LPCWSTR pString, INT Count ) {
        return PreloadTextW( pString, Count );
    }
#else
    HRESULT WINAPI_INLINE GetDesc( D3DX10_FONT_DESCA * pDesc ) {
        return GetDescA( pDesc );
    }
    HRESULT WINAPI_INLINE PreloadText( LPCSTR pString, INT Count ) {
