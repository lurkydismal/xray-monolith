...
// binary operators
D3DXINLINE BOOL D3DXFLOAT16::operator==( CONST D3DXFLOAT16& f ) const {
...
D3DXINLINE D3DXVECTOR2& D3DXVECTOR2::operator+=( CONST D3DXVECTOR2& v ) {
    x += v.x;
    y += v.y;
    return *this;
}
...
D3DXINLINE D3DXVECTOR2& D3DXVECTOR2::operator*=( FLOAT f ) {
    x *= f;
    y *= f;
    return *this;
}
...
// unary operators
D3DXINLINE D3DXVECTOR2 D3DXVECTOR2::operator+() const {
    return *this;
}
...
// binary operators
D3DXINLINE D3DXVECTOR2 D3DXVECTOR2::operator+( CONST D3DXVECTOR2& v ) const {
...
D3DXINLINE D3DXVECTOR2 D3DXVECTOR2::operator*( FLOAT f ) const {
...
D3DXINLINE D3DXVECTOR2 operator*( FLOAT f, CONST D3DXVECTOR2& v ) {
    return D3DXVECTOR2( f * v.x, f * v.y );
}

D3DXINLINE BOOL D3DXVECTOR2::operator==( CONST D3DXVECTOR2& v ) const {
    return x == v.x && y == v.y;
}
...
D3DXINLINE
D3DXVECTOR2_16F::D3DXVECTOR2_16F( CONST D3DXFLOAT16& fx,
                                  CONST D3DXFLOAT16& fy ) {
    x = fx;
    y = fy;
}
...
// binary operators
D3DXINLINE BOOL D3DXVECTOR2_16F::operator==( CONST D3DXVECTOR2_16F& v ) const {
...
D3DXINLINE D3DXVECTOR3& D3DXVECTOR3::operator*=( FLOAT f ) {
    x *= f;
    y *= f;
    z *= f;
    return *this;
...
// unary operators
D3DXINLINE D3DXVECTOR3 D3DXVECTOR3::operator+() const {
    return *this;
}
...
// binary operators
D3DXINLINE D3DXVECTOR3 D3DXVECTOR3::operator+( CONST D3DXVECTOR3& v ) const {
...
D3DXINLINE D3DXVECTOR3 D3DXVECTOR3::operator*( FLOAT f ) const {
...
D3DXINLINE BOOL D3DXVECTOR3::operator==( CONST D3DXVECTOR3& v ) const {
...
D3DXINLINE
D3DXVECTOR3_16F::D3DXVECTOR3_16F( CONST D3DXFLOAT16& fx,
                                  CONST D3DXFLOAT16& fy,
                                  CONST D3DXFLOAT16& fz ) {
    x = fx;
    y = fy;
    z = fz;
}
...
// binary operators
D3DXINLINE BOOL D3DXVECTOR3_16F::operator==( CONST D3DXVECTOR3_16F& v ) const {
    return *( ( DWORD* )&x ) == *( ( DWORD* )&v.x ) &&
           *( ( WORD* )&z ) == *( ( WORD* )&v.z );
}
...
// assignment operators
D3DXINLINE D3DXVECTOR4& D3DXVECTOR4::operator+=( CONST D3DXVECTOR4& v ) {
    x += v.x;
    y += v.y;
    z += v.z;
    w += v.w;
...
D3DXINLINE D3DXVECTOR4& D3DXVECTOR4::operator*=( FLOAT f ) {
    x *= f;
    y *= f;
    z *= f;
    w *= f;
...
// unary operators
D3DXINLINE D3DXVECTOR4 D3DXVECTOR4::operator+() const {
    return *this;
}
...
// binary operators
D3DXINLINE D3DXVECTOR4 D3DXVECTOR4::operator+( CONST D3DXVECTOR4& v ) const {
...
D3DXINLINE D3DXVECTOR4 D3DXVECTOR4::operator*( FLOAT f ) const {
...
D3DXINLINE D3DXVECTOR4 operator*( FLOAT f, CONST D3DXVECTOR4& v ) {
    return D3DXVECTOR4( f * v.x, f * v.y, f * v.z, f * v.w );
}

D3DXINLINE BOOL D3DXVECTOR4::operator==( CONST D3DXVECTOR4& v ) const {
...
D3DXINLINE
D3DXVECTOR4_16F::D3DXVECTOR4_16F( CONST D3DXVECTOR3_16F& v,
                                  CONST D3DXFLOAT16& f ) {
    x = v.x;
    y = v.y;
    z = v.z;
...
D3DXINLINE
D3DXVECTOR4_16F::D3DXVECTOR4_16F( CONST D3DXFLOAT16& fx,
                                  CONST D3DXFLOAT16& fy,
                                  CONST D3DXFLOAT16& fz,
                                  CONST D3DXFLOAT16& fw ) {
    x = fx;
    y = fy;
    z = fz;
    w = fw;
...
// binary operators
D3DXINLINE BOOL D3DXVECTOR4_16F::operator==( CONST D3DXVECTOR4_16F& v ) const {
    return *( ( DWORD* )&x ) == *( ( DWORD* )&v.x ) &&
           *( ( DWORD* )&z ) == *( ( DWORD* )&v.z );
}
...
D3DXINLINE
D3DXMATRIX::D3DXMATRIX( FLOAT f11,
                        FLOAT f12,
                        FLOAT f13,
                        FLOAT f14,
                        FLOAT f21,
...
// access grants
D3DXINLINE FLOAT& D3DXMATRIX::operator()( UINT iRow, UINT iCol ) {
    return m[ iRow ][ iCol ];
}

D3DXINLINE FLOAT D3DXMATRIX::operator()( UINT iRow, UINT iCol ) const {
    return m[ iRow ][ iCol ];
}
...
// assignment operators
D3DXINLINE D3DXMATRIX& D3DXMATRIX::operator*=( CONST D3DXMATRIX& mat ) {
...
D3DXINLINE D3DXMATRIX& D3DXMATRIX::operator*=( FLOAT f ) {
    _11 *= f;
    _12 *= f;
    _13 *= f;
    _14 *= f;
...
D3DXINLINE D3DXMATRIX D3DXMATRIX::operator-() const {
    return D3DXMATRIX( -_11, -_12, -_13, -_14, -_21, -_22, -_23, -_24, -_31,
                       -_32, -_33, -_34, -_41, -_42, -_43, -_44 );
}

// binary operators
D3DXINLINE D3DXMATRIX D3DXMATRIX::operator*( CONST D3DXMATRIX& mat ) const {
    D3DXMATRIX matT;
...
D3DXINLINE D3DXMATRIX D3DXMATRIX::operator*( FLOAT f ) const {
    return D3DXMATRIX( _11 * f, _12 * f, _13 * f, _14 * f, _21 * f, _22 * f,
                       _23 * f, _24 * f, _31 * f, _32 * f, _33 * f, _34 * f,
...
D3DXINLINE D3DXMATRIX operator*( FLOAT f, CONST D3DXMATRIX& mat ) {
...
D3DXINLINE BOOL D3DXMATRIX::operator==( CONST D3DXMATRIX& mat ) const {
...
D3DXINLINE
_D3DXMATRIXA16::_D3DXMATRIXA16( CONST D3DMATRIX& m ) : D3DXMATRIX( m ) {}

D3DXINLINE
_D3DXMATRIXA16::_D3DXMATRIXA16( CONST D3DXFLOAT16* f ) : D3DXMATRIX( f ) {}

D3DXINLINE
_D3DXMATRIXA16::_D3DXMATRIXA16( FLOAT _11,
                                FLOAT _12,
                                FLOAT _13,
                                FLOAT _14,
                                FLOAT _21,
...
D3DXINLINE void* _D3DXMATRIXA16::operator new( size_t s ) {
    if ( s > ( SIZE_MAX - 16 ) )
        return NULL;
...
D3DXINLINE void _D3DXMATRIXA16::operator delete( void* p ) {
    if ( p ) {
...
D3DXINLINE _D3DXMATRIXA16& _D3DXMATRIXA16::operator=( CONST D3DXMATRIX& rhs ) {
...
// assignment operators
D3DXINLINE D3DXQUATERNION& D3DXQUATERNION::operator+=(
...
D3DXINLINE D3DXQUATERNION& D3DXQUATERNION::operator*=( FLOAT f ) {
    x *= f;
    y *= f;
    z *= f;
    w *= f;
...
// unary operators
D3DXINLINE D3DXQUATERNION D3DXQUATERNION::operator+() const {
    return *this;
}
...
D3DXINLINE D3DXQUATERNION D3DXQUATERNION::operator*( FLOAT f ) const {
...
D3DXINLINE D3DXQUATERNION operator*( FLOAT f, CONST D3DXQUATERNION& q ) {
    return D3DXQUATERNION( f * q.x, f * q.y, f * q.z, f * q.w );
}

D3DXINLINE BOOL D3DXQUATERNION::operator==( CONST D3DXQUATERNION& q ) const {
...
// assignment operators
D3DXINLINE D3DXPLANE& D3DXPLANE::operator*=( FLOAT f ) {
    a *= f;
    b *= f;
    c *= f;
    d *= f;
...
// unary operators
D3DXINLINE D3DXPLANE D3DXPLANE::operator+() const {
    return *this;
}
...
// binary operators
D3DXINLINE D3DXPLANE D3DXPLANE::operator*( FLOAT f ) const {
...
D3DXINLINE D3DXPLANE operator*( FLOAT f, CONST D3DXPLANE& p ) {
    return D3DXPLANE( f * p.a, f * p.b, f * p.c, f * p.d );
}

D3DXINLINE BOOL D3DXPLANE::operator==( CONST D3DXPLANE& p ) const {
...
D3DXCOLOR::operator DWORD() const {
    DWORD dwR = r >= 1.0f   ? 0xff
                : r <= 0.0f ? 0x00
                            : ( DWORD )( r * 255.0f + 0.5f );
    DWORD dwG = g >= 1.0f   ? 0xff
                : g <= 0.0f ? 0x00
                            : ( DWORD )( g * 255.0f + 0.5f );
    DWORD dwB = b >= 1.0f   ? 0xff
                : b <= 0.0f ? 0x00
                            : ( DWORD )( b * 255.0f + 0.5f );
    DWORD dwA = a >= 1.0f   ? 0xff
                : a <= 0.0f ? 0x00
                            : ( DWORD )( a * 255.0f + 0.5f );
...
// assignment operators
D3DXINLINE D3DXCOLOR& D3DXCOLOR::operator+=( CONST D3DXCOLOR& c ) {
    r += c.r;
    g += c.g;
    b += c.b;
    a += c.a;
...
D3DXINLINE D3DXCOLOR& D3DXCOLOR::operator*=( FLOAT f ) {
    r *= f;
    g *= f;
    b *= f;
    a *= f;
...
// unary operators
D3DXINLINE D3DXCOLOR D3DXCOLOR::operator+() const {
    return *this;
}
...
// binary operators
D3DXINLINE D3DXCOLOR D3DXCOLOR::operator+( CONST D3DXCOLOR& c ) const {
...
D3DXINLINE D3DXCOLOR D3DXCOLOR::operator*( FLOAT f ) const {
...
D3DXINLINE D3DXCOLOR operator*( FLOAT f, CONST D3DXCOLOR& c ) {
    return D3DXCOLOR( f * c.r, f * c.g, f * c.b, f * c.a );
}

D3DXINLINE BOOL D3DXCOLOR::operator==( CONST D3DXCOLOR& c ) const {
...
D3DXINLINE BOOL D3DXMatrixIsIdentity( CONST D3DXMATRIX* pM ) {
    ...
    return pM->m[ 0 ][ 0 ] == 1.0f && pM->m[ 0 ][ 1 ] == 0.0f &&
           pM->m[ 0 ][ 2 ] == 0.0f && pM->m[ 0 ][ 3 ] == 0.0f &&
           pM->m[ 1 ][ 0 ] == 0.0f && pM->m[ 1 ][ 1 ] == 1.0f &&
           pM->m[ 1 ][ 2 ] == 0.0f && pM->m[ 1 ][ 3 ] == 0.0f &&
           pM->m[ 2 ][ 0 ] == 0.0f && pM->m[ 2 ][ 1 ] == 0.0f &&
           pM->m[ 2 ][ 2 ] == 1.0f && pM->m[ 2 ][ 3 ] == 0.0f &&
           pM->m[ 3 ][ 0 ] == 0.0f && pM->m[ 3 ][ 1 ] == 0.0f &&
           pM->m[ 3 ][ 2 ] == 0.0f && pM->m[ 3 ][ 3 ] == 1.0f;
}
...
#ifdef __cplusplus
    return sqrtf( pQ->x * pQ->x + pQ->y * pQ->y + pQ->z * pQ->z +
                  pQ->w * pQ->w );
#else
    return ( FLOAT )sqrt( pQ->x * pQ->x + pQ->y * pQ->y + pQ->z * pQ->z +
                          pQ->w * pQ->w );
#endif
}
