...
//  ResourceDimension
//      D3D10_RESOURCE_DIMENSION representing the dimension of texture stored in
//      the file. D3D10_RESOURCE_DIMENSION_TEXTURE1D, 2D, 3D
//  ImageFileFormat
...
HRESULT WINAPI D3DX10CreateShaderResourceViewFromFileA(
...
HRESULT WINAPI D3DX10CreateShaderResourceViewFromFileW(
    ID3D10Device* pDevice,
    LPCWSTR pSrcFile,
    D3DX10_IMAGE_LOAD_INFO* pLoadInfo,
    ID3DX10ThreadPump* pPump,
...
#ifdef UNICODE
#define D3DX10CreateShaderResourceViewFromFile \
...
HRESULT WINAPI D3DX10CreateShaderResourceViewFromResourceA(
    ID3D10Device* pDevice,
    HMODULE hSrcModule,
    LPCSTR pSrcResource,
    D3DX10_IMAGE_LOAD_INFO* pLoadInfo,
...
HRESULT WINAPI D3DX10CreateShaderResourceViewFromResourceW(
    ID3D10Device* pDevice,
    HMODULE hSrcModule,
    LPCWSTR pSrcResource,
    D3DX10_IMAGE_LOAD_INFO* pLoadInfo,
...
#ifdef UNICODE
#define D3DX10CreateShaderResourceViewFromResource \
...
HRESULT WINAPI
D3DX10CreateTextureFromResourceA( ID3D10Device* pDevice,
                                  HMODULE hSrcModule,
                                  LPCSTR pSrcResource,
                                  D3DX10_IMAGE_LOAD_INFO* pLoadInfo,
                                  ID3DX10ThreadPump* pPump,
...
HRESULT WINAPI
D3DX10CreateTextureFromResourceW( ID3D10Device* pDevice,
                                  HMODULE hSrcModule,
                                  LPCWSTR pSrcResource,
                                  D3DX10_IMAGE_LOAD_INFO* pLoadInfo,
                                  ID3DX10ThreadPump* pPump,
...
HRESULT WINAPI
D3DX10LoadTextureFromTexture( ID3D10Resource* pSrcTexture,
