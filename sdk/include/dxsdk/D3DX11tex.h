...
//  ResourceDimension
//      D3D11_RESOURCE_DIMENSION representing the dimension of texture stored in
//      the file. D3D11_RESOURCE_DIMENSION_TEXTURE1D, 2D, 3D
//  ImageFileFormat
...
HRESULT WINAPI
D3DX11CreateTextureFromResourceA( ID3D11Device* pDevice,
                                  HMODULE hSrcModule,
                                  LPCSTR pSrcResource,
                                  D3DX11_IMAGE_LOAD_INFO* pLoadInfo,
                                  ID3DX11ThreadPump* pPump,
...
HRESULT WINAPI
D3DX11CreateTextureFromResourceW( ID3D11Device* pDevice,
                                  HMODULE hSrcModule,
                                  LPCWSTR pSrcResource,
                                  D3DX11_IMAGE_LOAD_INFO* pLoadInfo,
                                  ID3DX11ThreadPump* pPump,
...
HRESULT WINAPI
D3DX11LoadTextureFromTexture( ID3D11DeviceContext* pContext,
