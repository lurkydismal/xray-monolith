 ...
 ********************************************************************
 ...
 last mod: $Id: floor_all.h 16227 2009-07-08 06:58:46Z xiphmont $
...
static const static_codebook* const* const _floor_books[ 10 ] = {
    _floor_128x4_books,    _floor_256x4_books,   _floor_128x7_books,
    _floor_256x7_books,    _floor_128x11_books,  _floor_128x17_books,
    _floor_256x4low_books, _floor_1024x27_books, _floor_2048x27_books,
    _floor_512x17_books,
};
...
static const vorbis_info_floor1 _floor[ 10 ] = {
    ...
    { 6,
      ...
      { { 3 }, { 4, 5 }, { -1, 6, 7, 8 }, { -1, 9, 10, 11 } },
      2,
      { 0, 128, 12, 46, 4, 8, 16, 23, 33, 70, 2, 6, 10, 14, 19, 28, 39, 58,
        90 },
    ...
    /* 2048 x 27 */
    {
        ...
        { { 4 }, { 5, 6 }, { 7, 8 }, { -1, 9, 10, 11 }, { -1, 12, 13, 14 } },
        2,
        { 0,   2048, 186, 46,  744,  12,  92,  372,  1500, 28,
          66,  130,  260, 520, 1112, 6,   20,  36,   56,   78,
    ...
    /* 512 x 17 */
    {
        ...
        { { 3 }, { 4, 5 }, { -1, 6, 7, 8 }, { -1, 9, 10, 11 } },
        2,
        { 0, 512, 46, 186, 16, 33, 65, 93, 130, 278, 7, 23, 39, 55, 79, 110,
          156, 232, 360 },
