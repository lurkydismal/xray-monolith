...
STATIC_CHECK(
    false,
    CS_STRING_CONCAT_or_CS_STRING_CONCAT_HELPER_or_CS_STRING_CONCAT4_macro_already_defined );
...
STATIC_CHECK( false,
              CS_MAKE_STRING_or_CS_MAKE_STRING_HELPER_macro_already_defined );
...
#define CS_LIBRARY_NAME( library, extension )                   \
    CS_MAKE_STRING( CS_STRING_CONCAT(                           \
        CS_LIBRARY_PREFIX,                                      \
        CS_STRING_CONCAT(                                       \
            library,                                            \
            CS_STRING_CONCAT(                                   \
                CS_PLATFORM_ID,                                 \
                CS_STRING_CONCAT( CS_SOLUTION_CONFIGURATION_ID, \
