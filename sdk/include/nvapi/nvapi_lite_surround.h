...
//! \retval ::NVAPI_NVIDIA_DEVICE_NOT_FOUND:     GDI Primary not on an NVIDIA
//! GPU.
...
//!
//! \param [in]      displayId       Display ID of a single display in the
//! active
...
//! \retval ::NVAPI_API_NOT_INTIALIZED          The NvAPI API needs to be
//! initialized first
//! \retval ::NVAPI_MOSAIC_NOT_ACTIVE           The display does not belong to
//! an active Mosaic Topology
//! \retval ::NVAPI_NO_IMPLEMENTATION           This entrypoint not available
//! \retval ::NVAPI_ERROR                       Miscellaneous error occurred
//!
//! \ingroup mosaicapi
