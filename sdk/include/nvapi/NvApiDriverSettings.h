...
#define OGL_DEFAULT_SWAP_INTERVAL_STRING                                       \
    L"Controls the number of vblank signals from the display to wait before "  \
    L"rendering a frame (SwapInterval) on OpenGL. In order to force VSYNC ON " \
    L"or OFF, use VSYNCMODE."
#define OGL_DEFAULT_SWAP_INTERVAL_FRACTIONAL_STRING                         \
    L"Controls if we evaluate the current scan line for a (un)synced flip " \
    L"with negative intervals. A value in the range of 0 - 100%"
#define OGL_DEFAULT_SWAP_INTERVAL_SIGN_STRING                                 \
    L"Controls if the number of SwapIntervals set is treated as negative or " \
    L"positive values on OpenGL."
#define OGL_EVENT_LOG_SEVERITY_THRESHOLD_STRING \
    L"Event Log Severity Threshold. This controls which events are logged."
...
#define OGL_QUALITY_ENHANCEMENTS_STRING \
    L"High level control of the rendering quality on OpenGL"
...
#define AA_MODE_ALPHATOCOVERAGE_STRING \
    L"Antialiasing - Transparency Multisampling"
...
#define APPLICATION_PROFILE_NOTIFICATION_TIMEOUT_STRING \
    L"Application Profile Notification Popup Timeout"
#define APPLICATION_STEAM_ID_STRING L"Steam Application ID"
#define CPL_HIDDEN_PROFILE_STRING \
    L"Do not display this profile in the Control Panel"
...
#define OPTIMUS_MAXAA_STRING \
    L"Maximum AA samples allowed for a given application"
...
#define SHIM_RENDERING_OPTIONS_STRING \
    L"Shim Rendering Mode Options per application for Optimus"
#define SLI_GPU_COUNT_STRING L"Number of GPUs to use on SLI rendering mode"
#define SLI_PREDEFINED_GPU_COUNT_STRING \
    L"NVIDIA predefined number of GPUs to use on SLI rendering mode"
#define SLI_PREDEFINED_GPU_COUNT_DX10_STRING                             \
    L"NVIDIA predefined number of GPUs to use on SLI rendering mode on " \
    L"DirectX 10"
#define SLI_PREDEFINED_MODE_STRING L"NVIDIA predefined SLI mode"
#define SLI_PREDEFINED_MODE_DX10_STRING \
    L"NVIDIA predefined SLI mode on DirectX 10"
...
#define AUTO_LODBIASADJUST_STRING \
    L"Texture filtering - Driver Controlled LOD Bias"
...
#define PS_TEXFILTER_ANISO_OPTS2_STRING \
    L"Texture filtering - Anisotropic sample optimization"
#define PS_TEXFILTER_BILINEAR_IN_ANISO_STRING \
    L"Texture filtering - Anisotropic filter optimization"
#define PS_TEXFILTER_DISABLE_TRILIN_SLOPE_STRING \
    L"Texture filtering - Trilinear optimization"
#define PS_TEXFILTER_NO_NEG_LODBIAS_STRING \
    L"Texture filtering - Negative LOD bias"
...
enum EValues_SHIM_RENDERING_OPTIONS {
    ...
    SHIM_RENDERING_OPTIONS_DEFAULT =
