...
struct NvShaderExtnStruct {
    ...
    uint markUavRef;     // the next store to UAV is fake and is used only to
                         // identify the uav slot
...
// should be set using NvAPI_D3D11_SetNvShaderExtnSlot() call before creating
// the first shader that uses nvidia shader extensions. E.g before including
// this file in shader define it as: #define NV_SHADER_EXTN_SLOT u7
