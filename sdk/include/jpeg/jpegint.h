...
EXTERN( void )
jinit_c_prep_controller JPP( ( j_compress_ptr cinfo,
                               boolean need_full_buffer ) );
EXTERN( void )
jinit_c_coef_controller JPP( ( j_compress_ptr cinfo,
                               boolean need_full_buffer ) );
...
EXTERN( void )
jinit_d_main_controller JPP( ( j_decompress_ptr cinfo,
                               boolean need_full_buffer ) );
EXTERN( void )
jinit_d_coef_controller JPP( ( j_decompress_ptr cinfo,
                               boolean need_full_buffer ) );
EXTERN( void )
jinit_d_post_controller JPP( ( j_decompress_ptr cinfo,
                               boolean need_full_buffer ) );
...
EXTERN( void )
jcopy_sample_rows JPP( ( JSAMPARRAY input_array,
                         int source_row,
                         ...
                         JDIMENSION num_cols ) );
EXTERN( void )
jcopy_block_row JPP( ( JBLOCKROW input_row,
