 ...
 */
{
     ...
     * jpeg_add_quant_table to make all the table entries 1 (hence, minimum
     * quantization loss). Qualities 1..50 are converted to scaling percentage
     * 5000/Q.
     */
    if ( quality < 50 )
...
jpeg_default_colorspace( j_compress_ptr cinfo ) {
    switch ( cinfo->in_color_space ) {
        ...
        case JCS_YCbCr:
            ...
            break;
        case JCS_CMYK:
            jpeg_set_colorspace( cinfo,
                                 JCS_CMYK ); /* By default, no translation */
            break;
        case JCS_YCCK:
    ...
    switch ( colorspace ) {
        ...
        case JCS_RGB:
            cinfo->write_Adobe_marker =
                TRUE; /* write Adobe marker to flag RGB */
        ...
        case JCS_CMYK:
            cinfo->write_Adobe_marker =
                TRUE; /* write Adobe marker to flag CMYK */
