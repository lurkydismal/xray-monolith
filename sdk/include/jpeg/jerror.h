            ...
            JMESSAGE(
                ...
                "supported" ) JMESSAGE( JERR_BAD_HUFF_TABLE,
                                        ...
                                        "n" ) JMESSAGE( JERR_BAD_IN_COLORSPACE,
                                                        "Bogus input "
                                                        "colorspace" ) JMESSAGE( JERR_BAD_J_COLORSPACE,
                                                                                 "Bogus JPEG colorspace" )
                JMESSAGE( JERR_BAD_LENGTH, "Bogus marker length" ) JMESSAGE(
                    ...
                    "%d" ) JMESSAGE( JERR_BAD_MCU_SIZE,
                                     ...
                                     "interle"
                                     "aved "
                                     "scan" ) JMESSAGE( JERR_BAD_POOL_ID,
                                                        "Invalid "
                                                        "memory "
                                                        "pool code "
                    ...
                    JMESSAGE(
                        ...
                        "d" ) JMESSAGE( JERR_BAD_PROG_SCRIPT,
                                        ...
                                        "scan script entry %d" ) JMESSAGE( JERR_BAD_SAMPLING,
                                                                           "Bog"
                                                                           "us "
                                                                           "sam"
                                                                           "pli"
                        ...
                        JMESSAGE(
                            ...
                            "%d" ) JMESSAGE( JERR_BAD_STATE,
                                             ...
                                             "%d" ) JMESSAGE( JERR_BAD_STRUCT_SIZE,
                                                              ...
                                                              "size is %u, "
                                                              "caller expects "
                                                              "%u" ) JMESSAGE( JERR_BAD_VIRTUAL_ACCESS,
                                                                               "Bogus "
                                                                               "virtual "
                                                                               "array "
                                                                               "access" )
                                                                ...
                                                                JMESSAGE(
                                                                    ...
                                                                    JMESSAGE( JERR_NO_BACKING_STORE,
                                                                        ...
                                                                        JMESSAGE( JERR_QUANT_MANY_COLORS,
                                                                                  "Cannot quantize to more than %d colors" ) JMESSAGE( JERR_SOF_DUPLICATE,
