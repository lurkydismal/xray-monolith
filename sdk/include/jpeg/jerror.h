        ...
        JMESSAGE( JERR_BAD_ALLOC_CHUNK, "MAX_ALLOC_CHUNK is wrong, please fix" ) JMESSAGE(
            ...
            JMESSAGE( JERR_BAD_DCT_COEF,
                      ...
                      "e" ) JMESSAGE( JERR_BAD_DCTSIZE,
                                      "IDCT output block size %d not "
                                      "supported" ) JMESSAGE( JERR_BAD_HUFF_TABLE,
                                                              "Bogus Huffman "
                                                              "table "
                                                              "definition" ) JMESSAGE( JERR_BAD_IN_COLORSPACE,
                                ...
                                JMESSAGE(
                                    ...
                                    JMESSAGE(
                                        ...
                                        JMESSAGE(
                                            JERR_DAC_INDEX,
                                            "Bogus DAC "
                                            "index %d" ) JMESSAGE( JERR_DAC_VALUE,
                                                                   "Bogus DAC "
                                                                   "value "
                                                                                                                                                                                                ...
                                                                                                                                                                                                JMESSAGE(
                                                                                                                                                                                                    ...
                                                                                                                                                                                                    "Warning: unknown JFIF revision number %d.%02d" ) JMESSAGE( JWRN_JPEG_EOF,
                                                                                                                                                                                                                                                                "Premature end of JPEG file" ) JMESSAGE( JWRN_MUST_RESYNC,
                                                                                                                                                                                                                                                                                                         "Corrupt JPEG data: found marker 0x%02x instead of RST%d" ) JMESSAGE( JWRN_NOT_SEQUENTIAL,
