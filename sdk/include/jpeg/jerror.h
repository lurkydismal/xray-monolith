...
#define JMESSAGE( code, string ) code,
    ...
    JMESSAGE(
        ...
        "Sorry, there are legal restrictions on arithmetic coding" ) JMESSAGE( JERR_BAD_ALIGN_TYPE,
                                                                               "ALIGN_TYPE is wrong, please fix" ) JMESSAGE( JERR_BAD_ALLOC_CHUNK,
                                                                                                                             "MAX_ALLOC_CHUNK is wrong, please fix" )
        JMESSAGE( JERR_BAD_BUFFER_MODE, "Bogus buffer control mode" ) JMESSAGE(
            JERR_BAD_COMPONENT_ID,
            "Invalid component ID %d "
            "in SOS" ) JMESSAGE( JERR_BAD_DCT_COEF,
                                 "DCT "
                                 "coeff"
                                 "icien"
                                 "t "
                                 ...
                                 "of "
                                 "rang"
                                 "e" ) JMESSAGE( JERR_BAD_DCTSIZE,
                                                 "IDCT output block size %d "
                                                 "not "
                                                 "supported" ) JMESSAGE( JERR_BAD_HUFF_TABLE,
                                                                         "Bogus"
                                                                         " Huff"
                                                                         "man "
                                                                         "table"
            ...
            JMESSAGE( JERR_BAD_J_COLORSPACE, "Bogus JPEG colorspace" ) JMESSAGE(
                ...
                JMESSAGE(
                    ...
                    "memory "
                    "pool code "
                    "%d" ) JMESSAGE( JERR_BAD_PRECISION,
                                     "Unsupported JPEG data "
                                     "precision %d" ) JMESSAGE( JERR_BAD_PROGRESSION,
                                                                "Inva"
                                                                "lid "
                                                                "prog"
                                                                "ress"
                                                                ...
                                                                "d "
                                                                "Al=%"
                                                                "d" ) JMESSAGE( JERR_BAD_PROG_SCRIPT,
                                                                                "Invalid progressive parameters at "
                                                                                "scan script entry %d" )
                    JMESSAGE(
                        JERR_BAD_SAMPLING,
                        "Bogus sampling "
                        "factors" ) JMESSAGE( JERR_BAD_SCAN_SCRIPT,
                                              "Invalid scan script at entry "
                                              "%d" ) JMESSAGE( JERR_BAD_STATE,
                                                               "Impr"
                                                               "oper"
                                                               " cal"
                                                               "l "
                                                               ...
                                                               "stat"
                                                               "e "
                                                               "%d" ) JMESSAGE( JERR_BAD_STRUCT_SIZE,
                                                                                "JPEG parameter struct "
                                                                                "mismatch: library thinks "
                                                                                "size is %u, caller expects "
                                                                                "%u" )
                        JMESSAGE(
                            ...
                            "virtual "
                            "array "
                            "access" ) JMESSAGE( JERR_BUFFER_SIZE,
                                                 "Buffe"
                                                 "r "
                                                 "passe"
                                                 "d to "
                                                 ...
                                                 "too "
                                                 "smal"
                                                 "l" ) JMESSAGE( JERR_CANT_SUSPEND,
                                                                 "Suspension "
                                                                 "not allowed "
                                                                 "here" ) JMESSAGE( JERR_CCIR601_NOTIMPL,
                                                                                    "CCIR601"
                                                                                    " sampli"
                                                                                    "ng not "
                                                                                    "impleme"
                            ...
                            JMESSAGE(
                                ...
                                "Too many color "
                                "components: %d, "
                                "max %d" ) JMESSAGE( JERR_CONVERSION_NOTIMPL,
                                                     "Unsupported "
                                                     "color conversion "
                                                     "request" ) JMESSAGE( JERR_DAC_INDEX,
                                                                           "Bog"
                                                                           "us "
                                                                           "DAC"
                                                                           " "
                                                                           ...
                                                                           "ex "
                                                                           "%"
                                                                           "d" ) JMESSAGE( JERR_DAC_VALUE,
                                                                                           "Bogus DAC "
                                                                                           "value "
                                                                                           "0x%x" )
                                JMESSAGE( JERR_DHT_INDEX, "Bogus DHT index %d" ) JMESSAGE(
                                    JERR_DQT_INDEX,
                                    "B"
                                    "o"
                                    "g"
                                    ...
                                    JMESSAGE(
                                        ...
                                        JMESSAGE(
                                            ...
                                            JMESSAGE(
                                                ...
                                                "fl"
                                                "o"
                                                "w" ) JMESSAGE( JERR_HUFF_MISSING_CODE,
                                                                "Missing "
                                                                "Huffman code "
                                                                "table entry" )
                                                JMESSAGE(
                                                    ...
                                                    "dimension "
                                                    "is %u "
                                                    "pixels" ) JMESSAGE( JERR_INPUT_EMPTY,
                                                                         "Empty"
                                                                         " "
                                                                         "input"
                                                                         " "
                                                        ...
                                                        JMESSAGE(
                                                            ...
                                                            JMESSAGE(
                                                                ...
                                                                JMESSAGE(
                                                                    ...
                                                                    "at "
                                                                    "compile "
                                                                    "time" ) JMESSAGE( JERR_NO_BACKING_STORE,
                                                                                       "Backing store not supported" ) JMESSAGE( JERR_NO_HUFF_TABLE,
                                                                                                                                 "Huffman table 0x%02x was not defined" ) JMESSAGE( JERR_NO_IMAGE,
                                                                                                                                                                                    "JPEG datastream contains no image" ) JMESSAGE( JERR_NO_QUANT_TABLE,
                                                                                                                                                                                                                                    "Quantization table 0x%02x was not defined" ) JMESSAGE( JERR_NO_SOI,
                                                                                                                                     ...
                                                                                                                                     "Virtual array controller messed up" ) JMESSAGE( JERR_WIDTH_OVERFLOW,
                                                                                                                                                                                      "Image too wide for this implementation" ) JMESSAGE( JERR_XMS_READ,
                                                                                                                                                                                                                                           "Read from XMS failed" ) JMESSAGE( JERR_XMS_WRITE,
                                                                                                                                                                                                                                                                              "Write to XMS failed" ) JMESSAGE( JMSG_COPYRIGHT, JCOPYRIGHT ) JMESSAGE( JMSG_VERSION,
                                                                                                                                                                                                                                                                                                                                                       JVERSION ) JMESSAGE( JTRC_16BIT_TABLES,
                                                                                                            ...
                                                                                                            JMESSAGE(
                                                                                                                ...
                                                                                                                JMESSAGE( JTRC_XMS_OPEN,
                                                                                                                          "Obtained XMS handle %u" ) JMESSAGE( JWRN_ADOBE_XFORM,
                                                                                                                                                               "Unknown Adobe color transform code %d" ) JMESSAGE( JWRN_BOGUS_PROGRESSION,
...
#define TRACEMS( cinfo, lvl, code )                                 \
    ( ( cinfo )->err->msg_code = ( code ),                          \
      ( *( cinfo )->err->emit_message )( ( j_common_ptr )( cinfo ), \
                                         ( lvl ) ) )
...
#define TRACEMS3( cinfo, lvl, code, p1, p2, p3 )                            \
    MAKESTMT( int* _mp = ( cinfo )->err->msg_parm.i; _mp[ 0 ] = ( p1 );     \
              _mp[ 1 ] = ( p2 ); _mp[ 2 ] = ( p3 );                         \
              ( cinfo )->err->msg_code = ( code );                          \
              ( *( cinfo )->err->emit_message )( ( j_common_ptr )( cinfo ), \
                                                 ( lvl ) ); )
...
#define TRACEMS5( cinfo, lvl, code, p1, p2, p3, p4, p5 )                    \
    MAKESTMT( int* _mp = ( cinfo )->err->msg_parm.i; _mp[ 0 ] = ( p1 );     \
              _mp[ 1 ] = ( p2 ); _mp[ 2 ] = ( p3 ); _mp[ 3 ] = ( p4 );      \
              _mp[ 4 ] = ( p5 ); ( cinfo )->err->msg_code = ( code );       \
              ( *( cinfo )->err->emit_message )( ( j_common_ptr )( cinfo ), \
                                                 ( lvl ) ); )
#define TRACEMS8( cinfo, lvl, code, p1, p2, p3, p4, p5, p6, p7, p8 )        \
    MAKESTMT( int* _mp = ( cinfo )->err->msg_parm.i; _mp[ 0 ] = ( p1 );     \
              _mp[ 1 ] = ( p2 ); _mp[ 2 ] = ( p3 ); _mp[ 3 ] = ( p4 );      \
              _mp[ 4 ] = ( p5 ); _mp[ 5 ] = ( p6 ); _mp[ 6 ] = ( p7 );      \
              _mp[ 7 ] = ( p8 ); ( cinfo )->err->msg_code = ( code );       \
              ( *( cinfo )->err->emit_message )( ( j_common_ptr )( cinfo ), \
                                                 ( lvl ) ); )
