    ...
    for ( ci = 0, compptr = cinfo->comp_info; ci < cinfo->num_components;
        ...
        switch ( method ) {
            ...
            case JDCT_ISLOW: {
                 ...
                 * quantization coefficients, but are stored as ints to ensure
                 * access efficiency.
                 */
                ISLOW_MULT_TYPE* ismtbl =
                    ( ISLOW_MULT_TYPE* )compptr->dct_table;
            ...
            case JDCT_IFAST: {
                 ...
                 * sqrt(2)    for k=1..7 For integer operation, the multiplier
                 * table is to be scaled by IFAST_SCALE_BITS.
                 */
                IFAST_MULT_TYPE* ifmtbl =
                    ( IFAST_MULT_TYPE* )compptr->dct_table;
